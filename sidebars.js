...
const sidebars = {
  userGuideSidebar: [
    {
      ...
      items: [
        ...
        'user-guide/getting-started/sovereign-migration-workflow',
    ...
    },
    {
      ...
      items: [
        ...
        'user-guide/configuration/multi-tenancy-isolation',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
    ...
    },
     {
       ...
       items: [
         ...
         'user-guide/host-integrations/hostinger',
    ...
    },
    {
      ...
      items: [
        ...
        'user-guide/customization/hostinger-multi-tenancy',
    ...
    },
    {
      ...
      items: [
        ...
        'user-guide/troubleshooting/sovereign-migration-verification',
  ...
  developerSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'developer/integration-guide/multi-tenancy',
  ...
  addonsSidebar: [
    ...
    },
    {
      ...
      items: [{type: 'autogenerated', dirName: 'addons/ultimate-ai-connector-webllm'}],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [{type: 'autogenerated', dirName: 'addons/superdav-ai-agent'}],
    },
    {
      type: 'category',
      label: 'Analytics',
    ...
    },
    {
      type: 'category',
      label: 'Emails',
      items: [{type: 'autogenerated', dirName: 'addons/ultimate-multisite-emails'}],
    },
    {
      type: 'category',
      label: 'Fluent Forms',
    ...
    },
    {
      ...
      items: [{type: 'autogenerated', dirName: 'addons/multi-currency'}],
    },
  ],

  businessGuideSidebar: [
    'business-guide/index',
    {
      type: 'category',
      label: 'The Course',
      items: [
        'business-guide/lesson-1-why-niche',
        'business-guide/lesson-2-picking-your-niche',
        'business-guide/lesson-3-setting-up',
        'business-guide/lesson-4-templates',
        'business-guide/lesson-5-plans',
        'business-guide/lesson-6-checkout',
        'business-guide/lesson-7-branding',
        'business-guide/lesson-8-onboarding',
        'business-guide/lesson-9-pricing',
        'business-guide/lesson-10-launch',
        'business-guide/lesson-11-customers',
        'business-guide/lesson-12-operations',
        'business-guide/lesson-13-growth',
        'business-guide/lesson-14-whats-next',
      ],
    },
  ],
};
