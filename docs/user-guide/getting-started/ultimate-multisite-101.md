...
In _subdirectory_ configuration, network sites inherit a path based upon the main domain name. For example a network site labelled ‘site1’ will have it’s full URL as https://domain.com/site1. In _subdomain_ configuration, the network site will have its own _subdomain_ derived from the main domain name. Thus a site labelled ‘site1’ will have its full URL as https://site1.domain.com/.
