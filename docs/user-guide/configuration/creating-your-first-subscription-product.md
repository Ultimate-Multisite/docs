---
title: "Creating Your First Subscription Product"
sidebar_position: 6
---

# Creating your First Subscription Product (v2)

_**IMPORTANT NOTE: This article is only for Ultimate Multisite version 2.x users. If you are using version 1.x,**_ **_**see this article**_**.
