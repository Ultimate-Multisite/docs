...
_Multisite (subdomain or subdirectory) also needs to be activated._ [How to Install WordPress Multisite](/user-guide/getting-started/how-to-install-wordpress-multisite).
...
Yes, Ultimate Multisite now offers you [a helpful tool to get you to migrate](https://ultimatemultisite.com/addons/wp-ultimo-pro-sites-migrator/) your Pro Sites network.
