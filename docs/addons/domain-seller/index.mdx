...
Six registrars are fully supported: **OpenSRS**, **Namecheap**, **GoDaddy**, **ResellerClub**, **NameSilo**, and **Enom**. The addon's Integration Registry architecture makes it straightforward to add custom providers — see the [developer guide](/developer/integration-guide/custom-registrar).
