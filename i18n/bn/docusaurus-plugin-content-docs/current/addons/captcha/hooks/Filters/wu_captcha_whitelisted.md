...
title: ফিল্টার - wu_captcha_whitelisted
...
ফিল্টার করে যে বর্তমান ব্যবহারকারী বা অনুরোধটি হোয়াইটলিস্টেড করা উচিত কিনা।

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $whitelisted | `bool` | ক্যাপচা ভ্যালিডেশন এড়িয়ে যাওয়া হবে কিনা। |
