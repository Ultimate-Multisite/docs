...
### ১. পরিকল্পনা তৈরি (Plan Generation) {#1-plan-generation}
...
### ২. প্লাগইন আবিষ্কার (Plugin Discovery) {#2-plugin-discovery}
...
### ৩. প্ল্যান কার্যকর করা (Plan Execution) {#3-plan-execution}
...
### ৪. অগ্রগতি ট্র্যাকিং (Progress Tracking) {#4-progress-tracking}
...
### ৫. ত্রুটি পুনরুদ্ধার (Error Recovery) {#5-error-recovery}
...
## v1 এবং v2 এর তুলনা {#comparing-v1-and-v2}
