...
এটি এক্সপোর্ট বা ইমপোর্ট করার জন্য ব্যবহারকারীর ডেটার ডিফল্ট সেটটিকে ফিল্টার করে।

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $custom_user_data | `array` | কাস্টম ব্যবহারকারীর ডেটা অ্যারে। |
