...
---
# আপনার Registration Form কাস্টমাইজ করা {#customizing-your-registration-form}
...
## Login এবং registration পেজ: {#login-and-registration-pages}
...
## একাধিক registration form ব্যবহার করা: {#using-multiple-registration-forms}
...
### একটি Checkout Form সম্পাদনা করা: {#editing-a-checkout-form}
...
## URL প্যারামিটারের মাধ্যমে পণ্য ও টেমপ্লেট আগে থেকে নির্বাচন করা: {#pre-selecting-products-and-templates-via-url-parameters}
