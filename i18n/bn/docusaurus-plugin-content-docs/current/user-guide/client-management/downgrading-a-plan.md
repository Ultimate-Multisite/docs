...
---
# একটি plan ডাউনগ্রেড করা (v2) {#downgrading-a-plan-v2}
...
## কীভাবে একটি plan ডাউনগ্রেড করবেন {#how-to-downgrade-a-plan}
...
### একজন user তাদের plan ডাউনগ্রেড করলে কী ঘটে {#what-happens-when-a-user-downgrades-their-plan}
...
### payment-এর কী হয় {#what-happens-to-the-payment}
