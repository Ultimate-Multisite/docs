...
## মূল প্লাগইন অনুবাদ {#core-plugin-translations}
...
### Loco Translate ব্যবহার করে {#using-loco-translate}
