...
---
# Domain Mapping (v2) কীভাবে কনফিগার করবেন
...
### আপনার Ultimate Multisite Network-এ domain mapping কীভাবে সেট আপ করবেন
...
### ডোমেইনের DNS settings সঠিকভাবে কনফিগার করা আছে কি না নিশ্চিত করা
...
### Super Admin হিসেবে কাস্টম ডোমেইন নাম ম্যাপ করা
...
### Subsite ব্যবহারকারী হিসেবে কাস্টম ডোমেইন নাম ম্যাপ করা
