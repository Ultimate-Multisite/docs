...
---
# কিভাবে WordPress Multisite ইনস্টল করবেন? {#how-do-i-install-wordpress-multisite}
...
# /wp-admin-এ trailing slash যোগ করুন {#add-a-trailing-slash-to-wp-admin}
...
## সাধারণ সমস্যা: {#common-problems}

### ১. নতুন সাইট তৈরি করতে পারছি কিন্তু সেগুলো অ্যাক্সেস করা যাচ্ছে না। {#1-i-can-create-new-sites-but-they-are-not-accessible}
