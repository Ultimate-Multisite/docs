...
## উইজার্ড কখন দেখা যায়? {#when-does-the-wizard-appear}
...
## ধাপ ২: নেটওয়ার্ক কনফিগারেশন {#step-2-network-configuration}

এই ধাপে আপনাকে নেটওয়ার্ক সেটিংস কনফিগার করতে বলা হবে।

### সাইট স্ট্রাকচার {#site-structure}
...
### নেটওয়ার্ক টাইটেল {#network-title}
...
### নেটওয়ার্ক অ্যাডমিন ইমেইল {#network-admin-email}
...
## ধাপ ৩: ইনস্টলেশন {#step-3-installation}
...
## ম্যানুয়াল সেটআপ ফলব্যাক {#manual-setup-fallback}
...
### উইজার্ড বলছে wp-config.php লেখার যোগ্য নয় {#the-wizard-says-wp-configphp-is-not-writable}
...
### সেটআপের পর সাইটগুলো অ্যাক্সেসযোগ্য নয় (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### সেটআপের পর authentication সমস্যা {#authentication-issues-after-setup}
