...
## এন্ডপয়েন্ট body parameters {#endpoint-body-parameters}
...
## Zapier-এ একটি action তৈরি করা {#creating-an-action-in-zapier}
...
### একটি action তৈরি করা {#creating-an-action}
...
### সম্পূর্ণ এন্ডপয়েন্ট parameters {#complete-endpoint-parameters}
