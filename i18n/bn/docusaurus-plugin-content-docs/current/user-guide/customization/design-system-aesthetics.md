...
---
# ডিজাইন সিস্টেম নান্দনিকতা দক্ষতা {#design-system-aesthetics-skill}
...
## ডিজাইন সিস্টেম নান্দনিকতা কী? {#what-is-design-system-aesthetics}
...
## ডিজাইন সিস্টেম নান্দনিকতা কেন ব্যবহার করবেন? {#why-use-design-system-aesthetics}

### সামঞ্জস্যতা (Consistency) {#consistency}
...
## ডিজাইন সিস্টেম নান্দনিকতা দক্ষতা সক্রিয় করা {#triggering-the-design-system-aesthetics-skill}

### ম্যানুয়াল সক্রিয়করণ {#manual-activation}
...
### স্বয়ংক্রিয় পরামর্শ (Automatic Suggestions) {#automatic-suggestions}
...
## ডিজাইন সিস্টেম নান্দনিকতা প্রক্রিয়া {#the-design-system-aesthetics-process}

### ধাপ ১: টাইপোগ্রাফি {#step-1-typography}
...
### ধাপ ২: কালার প্যালেট {#step-2-color-palette}
...
### ধাপ ৪: বর্ডার এবং শ্যাডো {#step-4-borders-and-shadows}
...
### ধাপ ৫: মোশন এবং অ্যানিমেশন {#step-5-motion-and-animation}
...
## ডিজাইন সিস্টেম নান্দনিকতা প্রয়োগ করা {#applying-design-system-aesthetics}

### স্বয়ংক্রিয় প্রয়োগ (Automatic Application) {#automatic-application}
...
### ম্যানুয়াল প্রয়োগ (Manual Application) {#manual-application}
...
## আপনার ডিজাইন সিস্টেম দেখা {#viewing-your-design-system}

### এজেন্টের কাছে জিজ্ঞাসা করুন {#ask-the-agent}
...
### theme.json দেখুন {#view-themejson}

টেক্সট এডিটরে `/wp-content/themes/[theme-name]/theme.json` খুলুন যাতে আপনি কাঁচা টোকেন সংজ্ঞাগুলো দেখতে পারেন।

## আপনার ডিজাইন সিস্টেম আপডেট করা {#updating-your-design-system}

### দ্রুত আপডেট {#quick-updates}
...
### সম্পূর্ণ রিডিজাইন {#full-redesign}
...
## ডিজাইন সিস্টেমের সেরা অভ্যাস (Best Practices) {#design-system-best-practices}

### সামঞ্জস্যতা (Consistency) {#consistency-1}

- সব জায়গায় একই টোকেন ব্যবহার করুন
- এককালীন রঙ বা আকার তৈরি করবেন না
- মানগুলো হার্ডকোড করার পরিবর্তে টোকেন রেফারেন্স করুন

### নামকরণ (Naming) {#naming}
...
### স্কেলেবিলিটি (Scalability) {#scalability}
...
## সাধারণ ডিজাইন সিস্টেম প্যাটার্ন {#common-design-system-patterns}

### আধুনিক মিনিমালিস্ট (Modern Minimalist) {#modern-minimalist}
...
### উষ্ণ এবং বন্ধুত্বপূর্ণ (Warm and Friendly) {#warm-and-friendly}
...
### পেশাদার কর্পোরেট (Professional Corporate) {#professional-corporate}
...
### সৃজনশীল এবং সাহসী (Creative and Bold) {#creative-and-bold}
