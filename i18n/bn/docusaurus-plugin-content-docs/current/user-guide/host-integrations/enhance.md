...
---
# Enhance Control Panel ইন্টিগ্রেশন {#enhance-control-panel-integration}
...
### সিস্টেম প্রয়োজনীয়তা {#system-requirements}
...
## আপনার API Credentials সংগ্রহ করা {#getting-your-api-credentials}

### ১. একটি API Token তৈরি করুন {#1-create-an-api-token}
...
### ২. আপনার Organization ID পান {#2-get-your-organization-id}
...
### ৩. আপনার Server ID পান {#3-get-your-server-id}
...
### ৪. আপনার API URL পান {#4-get-your-api-url}
...
### প্রয়োজনীয় Constants {#required-constants}
...
### Integration Wizard-এর মাধ্যমে সেটআপ {#setup-via-integration-wizard}
...
## অতিরিক্ত WordPress কনফিগারেশন {#additional-wordpress-configuration}
...
### .htaccess কনফিগারেশন {#htaccess-configuration}
...
### যখন একটি Domain Map করা হয় {#when-a-domain-is-mapped}
...
### যখন একটি Domain সরানো হয় {#when-a-domain-is-removed}
...
### DNS এবং SSL চেকিং {#dns-and-ssl-checking}
...
## সেটআপ যাচাই করা {#verifying-setup}

### Connection টেস্ট করুন {#test-the-connection}
...
### Domain Map করার পরে {#after-mapping-a-domain}
...
### API Connection সমস্যা {#api-connection-issues}
...
### Domain যোগ হচ্ছে না {#domain-not-added}
...
### SSL Certificate সমস্যা {#ssl-certificate-issues}
...
### সাধারণভাবে ব্যবহৃত Endpoints {#common-endpoints-used}
