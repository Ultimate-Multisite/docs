...
### ১. আপনার ServerPilot API ক্রেডেনশিয়াল সংগ্রহ করুন {#1-get-your-serverpilot-api-credentials}
...
### ২. আপনার App ID সংগ্রহ করুন {#2-get-your-app-id}
...
### ৩. wp-config.php-এ Constant যোগ করুন {#3-add-constants-to-wp-configphp}
...
### ৪. ইন্টিগ্রেশন সক্রিয় করুন {#4-enable-the-integration}
...
## SSL সার্টিফিকেট যাচাইকরণ {#ssl-certificate-verification}
...
### ডোমেইন যোগ হচ্ছে না {#domain-not-added}
