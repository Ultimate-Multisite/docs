...
---
# cPanel ইন্টিগ্রেশন {#cpanel-integration}
...
### ১. আপনার cPanel ক্রেডেনশিয়াল সংগ্রহ করুন {#1-get-your-cpanel-credentials}
...
### ২. wp-config.php-এ Constant যোগ করুন {#2-add-constants-to-wp-configphp}
...
### ৩. ইন্টিগ্রেশন সক্রিয় করুন {#3-enable-the-integration}
...
## গুরুত্বপূর্ণ বিষয়গুলো {#important-notes}
...
### API কানেকশন সমস্যা {#api-connection-issues}
