...
## দৃশ্যমানতা স্তরসমূহ (Visibility Levels)
...
## Ability Visibility পরিচালনা করা

### Ability Visibility সেটিংসে অ্যাক্সেস করা
...
### পার্টনার অ্যাক্সেস প্রত্যাহার করা
...
## Unclassified Abilities (শ্রেণীবদ্ধ নয় এমন ক্ষমতা)
...
### Unclassified Abilities এর জন্য অ্যাডমিন নোটিশ
...
### Unclassified Abilities পর্যালোচনা করা
...
### Unclassified Abilities কেন শ্রেণীবদ্ধ করা উচিত?
...
## বিভিন্ন প্ল্যাটফর্মে দৃশ্যমানতা (Visibility in Different Surfaces)
...
## নিরাপত্তা সেরা অনুশীলন (Security Best Practices)

### Principle of Least Privilege (সর্বনিম্ন সুযোগের নীতি)
...
### থার্ড-পার্টি ক্ষমতা (Third-Party Abilities)
...
## Legacy Mode থেকে মাইগ্রেশন (Migration from Legacy Mode)
