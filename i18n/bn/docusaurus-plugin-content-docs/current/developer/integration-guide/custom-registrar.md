...
---
# কাস্টম রেজিস্ট্রার ইন্টিগ্রেশন তৈরি করা {#building-a-custom-registrar-integration}
...
### ঐচ্ছিক মেথডগুলো {#optional-methods}
...
### রিটার্ন ভ্যালু কনভেনশন {#return-value-convention}
...
## আপনার ক্যাপাবিলিটি রেজিস্টার করা {#registering-your-capability}
...
## উইজার্ডে ক্রেডেনশিয়াল ফিল্ড যোগ করা {#adding-credential-fields-to-the-wizard}
...
## পোস্ট-রেজিস্ট্রেশন অ্যাকশনের জন্য হুকস {#hooks-for-post-registration-actions}
