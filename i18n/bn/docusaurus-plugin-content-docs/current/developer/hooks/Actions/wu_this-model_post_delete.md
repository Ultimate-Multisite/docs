...
যখন একটি অবজেক্ট ডেটাবেসে সংরক্ষণ করা হয়, তার পরে এটি কার্যকর হয়।

## Parameters

| Name | Type | Description |
|------|------|-------------|
| $result | `bool` | যদি অবজেক্টটি সফলভাবে মুছে ফেলা হয় তবে এটি `True` হবে। |
| $this | `\Base_Model` | অবজেক্টের উদাহরণটি (object instance)। |
