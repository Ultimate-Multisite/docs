...
## אײַנשטעל־אינסטרוקציעס

### 1. באַקומען אײַערע GridPane API קרעדענציאַלן
...
### 2. באַקומען אײַערע סערווער־און־וועבזײַט IDs
...
### 3. צולייגן Constants צו wp-config.php
...
## SUNRISE Constant פֿאַרוואַלטונג
