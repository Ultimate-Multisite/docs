...
## פֿאָרויסזעצונגען {#prerequisites}
...
## קאָנפֿיגוראַציע (וויזאַרד → אינטעגראַציעס → Hestia) {#configuration-wizard--integrations--hestia}
...
## באַמערקונגען און עצות {#notes--tips}
...
## בײַשפּיל API רוף (cURL) {#example-api-call-curl}
