...
## איינשטעל־אנווייזונגען

### 1. דזשענערירט אייער Hostinger API Token
...
### 3. לייגט צו קאָנסטאַנטן אין wp-config.php
...
- [Ultimate Multisite דאָקומענטאַציע](/docs)
