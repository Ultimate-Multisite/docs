...
---
# פּלוגין־פֿאַרוואַלטונג־פֿעיִקייטן {#plugin-management-abilities}
...
## פּלוגין־אינסטאַלירער API {#plugin-installer-api}
...
### רעגיסטרירן אַ אייגענעם אינסטאַליר־באַהאַנדלער {#registering-a-custom-install-handler}
...
## עקאָסיסטעם־רעגיסטרי {#ecosystem-registry}
...
## HookScanner־אינטעגראַציע {#hookscanner-integration}
...
## אַסינכראָנע דזשאָב־אַרכיטעקטור {#async-job-architecture}
