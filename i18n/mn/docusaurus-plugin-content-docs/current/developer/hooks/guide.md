---
title: Hook-уудыг ашиглах гарын авлага
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks ашиглах гарын авлага {#hooks-usage-guide}

Ultimate Multisite нь 200+ action hook болон 280+ filter hook-оор хангадаг. Энэ хуудсанд хамгийн түгээмэл ашиглагддаг hook-уудыг практик жишээнүүдтэй хамарсан. Бүрэн, автоматаар үүсгэсэн лавлагааг энэ хэсгийн бусад хуудсаас үзнэ үү.

## Action Hooks {#action-hooks}

### Үйлчлүүлэгчийн амьдралын мөчлөг {#customer-lifecycle}

#### Үйлчлүүлэгч үүсгэсний дараа {#after-customer-creation}
...
#### Үйлчлүүлэгчийн төлөвийн өөрчлөлт {#customer-status-change}
...
### Сайтын Hooks {#site-hooks}

#### Сайт нийтлэгдсэний дараа {#after-site-published}
...
#### Загвар хэрэглэхээс өмнө {#before-template-application}
...
### Гишүүнчлэлийн Hooks {#membership-hooks}

#### Төлөвийн шилжилтүүд {#status-transitions}
...
### Төлбөрийн Hooks {#payment-hooks}

#### Төлбөр амжилттай болсон / амжилтгүй болсон {#payment-completed--failed}
...
#### Боловсруулахаас өмнө / дууссаны дараа {#before-processing--after-completion}
...
### Үнийн шүүлтүүрүүд {#pricing-filters}

#### Сагсны нийт дүн {#cart-total}
...
#### Татварын хувь хэмжээ {#tax-rates}
...
### Загварын шүүлтүүрүүд {#template-filters}
...
### Хязгаарлалтын шүүлтүүрүүд {#limitation-filters}
...
### Gateway шүүлтүүрүүд {#gateway-filters}
...
### Checkout маягтын талбарууд {#checkout-form-fields}
...
### Имэйлийн агуулга {#email-content}
