---
title: Дэвшилтэт кодын жишээнүүд
sidebar_position: 1
...
Зэрэг ирсэн хоёр хүсэлт ижил утгыг уншаад хоёулаа ижил нэмэгдсэн үр дүнг буцаан бичиж, нэг тооллыг алдаж болно. `increment_item()` нь арифметик үйлдлийг өгөгдлийн сангийн хөдөлгүүрт ганц `UPDATE ... SET column = column + ?` statement-аар даатгаж, үйлдлийг үндсэндээ атомар болгодог.
