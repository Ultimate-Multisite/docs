...
---
# Нийлүүлэгчийг харгалздаг сануулгын кэшлэлт {#provider-aware-prompt-caching}
...
### Кэшлэгдсэн сануулга үүсгэх {#creating-a-cached-prompt}
...
### Кэшлэгдсэн сануулга ашиглах {#using-a-cached-prompt}
...
### Кэшийн амьдралын мөчлөг {#cache-lifecycle}
...
### Gemini-д зориулсан шилдэг туршлагууд {#best-practices-for-gemini}
...
## Azure OpenAI: Сануулгын кэшлэлт {#azure-openai-prompt-caching}

Azure OpenAI нь автомат TTL удирдлагатай сануулгын кэшлэлтийг дэмждэг.

### Тохиргоо {#configuration-1}
...
### Кэшлэлтийг идэвхжүүлэх {#enabling-caching}
...
### Кэшийн толгойнууд {#cache-headers}
...
### Кэшийн хэрэглээг хянах {#monitoring-cache-usage}
...
### Azure OpenAI-д зориулсан шилдэг туршлагууд {#best-practices-for-azure-openai}
...
## OpenRouter: Нийлүүлэгчид тусгайлсан кэшлэлт {#openrouter-provider-specific-caching}

OpenRouter нь суурь нийлүүлэгчдээр (OpenAI, Anthropic гэх мэт) дамжуулан кэшлэлтийг дэмждэг.

### Тохиргоо {#configuration-2}
...
### OpenRouter кэшлэлт ашиглах {#using-openrouter-caching}
...
### Нийлүүлэгчид тусгайлсан сонголтууд {#provider-specific-options}
...
### OpenRouter-д зориулсан шилдэг туршлагууд {#best-practices-for-openrouter}
...
## Vertex Anthropic: Кэшийн хяналттай сануулгын кэшлэлт {#vertex-anthropic-prompt-caching-with-cache-control}

Vertex Anthropic (Google Cloud) нь ил тод кэшийн хяналттай сануулгын кэшлэлтийг дэмждэг.

### Тохиргоо {#configuration-3}
...
### Vertex Anthropic кэшийг ашиглах {#using-vertex-anthropic-caching}
...
### Vertex Anthropic-д зориулсан шилдэг туршлагууд {#best-practices-for-vertex-anthropic}
...
## Нийлүүлэгч хоорондын кэшлэлтийн стратеги {#cross-provider-caching-strategy}

### Нэгдсэн тохиргоо {#unified-configuration}
...
### Нийлүүлэгчийг илрүүлэх {#provider-detection}
...
### Нөөц стратеги {#fallback-strategy}
...
## Зардлын оновчлол {#cost-optimization}

### Хэмнэлтийг тооцоолох {#calculate-savings}
...
### Оновчлолын зөвлөмжүүд {#optimization-tips}
...
### Кэш ашиглагдахгүй байна {#cache-not-being-used}
...
### Кэш үүсгэхэд алдаа гарч байна {#cache-creation-failing}
...
### Гэнэтийн зардал {#unexpected-costs}
...
## Нийлүүлэгчдийн харьцуулалт {#provider-comparison}
