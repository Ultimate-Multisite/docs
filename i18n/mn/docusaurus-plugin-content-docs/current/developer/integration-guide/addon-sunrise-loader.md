...
---
# Addon Sunrise файл ачаалагч {#addon-sunrise-file-loader}
...
## Хэзээ ашиглах вэ {#when-to-use-it}
...
## Файл нэрлэх дүрэм {#file-naming-convention}
...
## Файлыг хаана байрлуулах вэ {#where-to-place-the-file}
...
## Боломжтой hook болон filter-үүд {#hooks-and-filters-available}
...
## Хамгийн бага жишээ {#minimal-example}
