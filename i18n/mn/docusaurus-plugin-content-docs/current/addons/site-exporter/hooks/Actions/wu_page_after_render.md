...
Хуудас дүрслэгдсэний дараа ажиллана.
...
[`inc/admin-pages/class-base-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/admin-pages/class-base-admin-page.php#L382) дотор 382-р мөрөнд тодорхойлогдсон.
