...
## Cap Captcha: Өөрөө хостолдог, шууд ажилладаг хамгаалалт {#cap-captcha-self-hosted-protection-that-just-works}
...
## WooCommerce карт тестлэхээс хамгаалах {#woocommerce-card-testing-protection}
...
## Google reCAPTCHA эсвэл hCaptcha хэрэгтэй хэвээр байна уу? {#still-need-google-recaptcha-or-hcaptcha}
...
## Өргөтгөхөд зориулж бүтээгдсэн {#built-for-scale}
...
## Би ямар нэг зүйл тохируулах хэрэгтэй юу? {#do-i-need-to-configure-anything}
...
## Би өөр өөр сайтууд дээр өөр өөр captcha provider ашиглаж болох уу? {#can-i-use-different-captcha-providers-on-different-sites}
...
## Энэ GDPR-д нийцэх үү? {#is-this-gdpr-compliant}
...
## Client IP Detection ба Trusted Proxies {#client-ip-detection--trusted-proxies}
...
#### Cloudflare толгойд итгэх {#cloudflare-header-trust}
...
#### Итгэмжлэгдсэн прокси тохиргоо {#trusted-proxy-configuration}
...
#### Анх идэвхжүүлэх үеийн автомат илрүүлэлт {#first-enable-auto-detection}
...
### Энэ яагаад чухал вэ {#why-this-matters}
