...
---
# Боломжит байхны харагдахуй (Ability Visibility) {#ability-visibility}
...
## Ability Visibility гэж юу вэ? {#what-is-ability-visibility}
...
## Харагдах түвшинүүд (Visibility Levels) {#visibility-levels}

### Public (Улбарласан/Хуучин) {#public}
...
## Способгуу багтлагын харагдах чадварыг удирдах {#managing-ability-visibility}

### Багтлагын харагдах тохиргоо руу орох {#accessing-ability-visibility-settings}
...
### Багтлагын дэлгэрэнгүй мэдээллийг үзэх {#viewing-ability-details}
...
### Харагдах түвшинг өөрчлөх {#changing-visibility-levels}
...
### Олон тооны үйлдлүүд (Bulk Operations) {#bulk-operations}
...
### Багтлагуудыг партнерт тохируулах {#assigning-abilities-to-partners}
...
### Партнерээс хандах эрхийг цуцлах {#revoking-partner-access}
...
## Ангилагдаагүй чадварууд (Unclassified Abilities) {#unclassified-abilities}

Superdav AI Agent тань танихгүй гуравдагч талын чадварыг суултсан үед, тэр **Ангилагдаагүй** гэж тэмдэглэгдэнэ.

### Ангилагдаагүй чадваруудтай администраторын мэдэгдэл (Admin Notice for Unclassified Abilities) {#admin-notice-for-unclassified-abilities}
...
### Ангилагдаагүй чадваруудыг шалгах (Reviewing Unclassified Abilities) {#reviewing-unclassified-abilities}
...
### Ангилагдаагүй чадваруудыг яага ангилах вэ? (Why Classify Unclassified Abilities?) {#why-classify-unclassified-abilities}
...
## Өгөгдлийн харагдах байдал өөр гадаргуу дээр {#visibility-in-different-surfaces}
...
### WooCommerce Нэгтгэл {#woocommerce-integration}
...
## Аюулгүй байдлын хамгийн сайн практик {#security-best-practices}

### Хамгийн бага эрх зүйтэй зарчим (Principle of Least Privilege) {#principle-of-least-privilege}
...
### Үр дүнг шалгах (Regular Audits) {#regular-audits}
...
### Логчлалт ба Мониторинг (Logging and Monitoring) {#logging-and-monitoring}
...
### Гуравдагч талын Боломжууд (Third-Party Abilities) {#third-party-abilities}
...
## Хуучин горимоос шилжих (Migration from Legacy Mode) {#migration-from-legacy-mode}
