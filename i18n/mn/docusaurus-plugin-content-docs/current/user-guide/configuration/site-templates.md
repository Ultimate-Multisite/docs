...
---
# Сайт загварууд (v2) {#site-templates-v2}
...
## Сайт загвар гэж юу вэ? {#what-is-a-site-template}
...
## Шинэ Сайт загвар үүсгэх ба өөрчлөх {#creating-and-editing-a-new-site-template}
...
### Сайт шаблоны агуулгыг тохируулах {#customizing-the-contents-of-a-site-template}
...
### Гүнзгийрүүлсэн сонголтууд (Advanced Options) {#advanced-options}
...
### Сайт шаблоны ашиглах {#using-site-templates}
...
#### Мод 1: Сайт Шаблоны тохируулах {#mode-1-assign-site-template}
...
#### Режим 2: Боломжит Сайт Загварыг Сонгох {#mode-2-choose-available-site-template}
...
### Анхны режим: Checkout form дээрх сайт шаблоны сонголт {#default-mode-site-template-selection-on-the-checkout-form}
...
### Варіанти шаблонів сайту {#site-template-options}
...
#### Копіювання медіа при дублюванні шаблону {#copy-media-on-template-duplication}
...
#### **Запобігання індексації сайтів-шаблонів пошуковими системами** {#prevent-search-engines-from-indexing-site-templates}
...
## Автозаповнення сайтів-шаблонів за допомогою автопошуку та заміни {#pre-populating-site-templates-with-auto-search-and-replace}
...
### "бүхэл сайт загвар нь оролтын талбараар дүүрэн" асуудлыг шийдэх {#solving-the-template-full-of-placeholders-problem}
