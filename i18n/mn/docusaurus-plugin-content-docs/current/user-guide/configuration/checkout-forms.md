...
#### Checkout Form Editor-ийн ерөнхий өгөгдөл {#checkout-form-editor-overview}
...
### Checkout Form-ийг засах {#editing-a-checkout-form}
...
### Үнийн хүснэгтийн талбар (The Pricing Table Field) {#the-pricing-table-field}
...
### Хугацаа сонгох товчлуур нэмэх {#adding-a-period-selection-toggle}
...
#### Алхам 1: Бүтээгдэхүүнд Үнийн өөрчлөлтийг тохируулах {#step-1-set-up-price-variations-on-your-products}
...
#### Алхам 2: Төлбөрийн маягт Хугацаа сонгох талбарыг нэмэх {#step-2-add-the-period-selection-field-to-your-checkout-form}
...
#### Қадам 3: Тавсифий жадвалдан олдин тавсифи коршуучу (Pricing Table) талабарын жойланг {#step-3-position-the-field-above-the-pricing-table}
...
#### Frontend дээр ажиллах байдал {#how-it-works-on-the-frontend}
...
#### URL-ээр төлбөрийн хугацааг урьдчилан сонгох {#pre-selecting-a-billing-period-via-url}
...
### Template Selection (Тэмдэглэгээний сонголт) талбар {#the-template-selection-field}
...
#### Талбарыг гараар нэмэх {#adding-the-field-manually}
...
#### Талбарыг арилгах {#removing-the-field}
