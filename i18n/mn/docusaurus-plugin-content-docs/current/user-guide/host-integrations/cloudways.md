...
### 1. Cloudways API Зарлагыг авах {#1-get-your-cloudways-api-credentials}
...
### 2. Server ба Application ID-г авах {#2-get-your-server-and-application-ids}
...
### 4. Интеграцийг идэвшүүлэх {#4-enable-the-integration}
...
### Домен синхронируулга (Domain Syncing) {#domain-syncing}
...
### SSL Сертификатын удирдлага (SSL Certificate Management) {#ssl-certificate-management}
...
## Нэмэлт Доменүүд (Extra Domains) {#extra-domains}
...
## Чухал — Wildcard SSL-ийн асуудал (Pitfall) {#important--wildcard-ssl-pitfall}
...
### Ultimate Multisite сүлжээнд Cloudways-ийн зөв SSL тохиргоо {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
