...
### 1. Таны cPanel-ийн мэдээллийг авах
...
### 2. wp-config.php дотор тогтмол утгуудыг нэмэх
...
### Domain Not Added (Домен нэмэгдээгүй)
