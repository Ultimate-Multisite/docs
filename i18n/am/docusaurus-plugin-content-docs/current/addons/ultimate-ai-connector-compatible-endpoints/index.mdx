...
### ጥያቄዎች ለሁሉም አቅራቢዎች እየሳሳቱ ነው (Requests are failing for all providers)
...
### አቅራቢ በአቅራቢነት (fallback) ጥቅም ላይ አይውልም (A provider is not being used for fallback)
...
### አዲስ የአቅራቢ ካርድ በራስ-ሰር አይከፈትም (New provider card does not expand automatically)
