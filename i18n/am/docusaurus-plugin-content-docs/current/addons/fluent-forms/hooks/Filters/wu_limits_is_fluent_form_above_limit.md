...
title: ማጣሪያ - wu_limits_is_fluent_form_above_limit
...
|------|------|-------------|
| $value | `bool` | የፎርምው አይነት ከገደቡ በላይ ከሆነ ወይስ አይደለም። |
| $form_type | `string` | እየተፈተሸ ያለው የፎርም አይነት። |
| $form_count | `int` | የአሁኑ የፎርም ብዛት። |
| $quota | `int` | የተፈቀደው የብዛት ገደብ (quota)። |
