...
### 1. የዕቅድ መፍጠር (Plan Generation) {#1-plan-generation}
...
### 2. የplugin ፍለጋ (Plugin Discovery) {#2-plugin-discovery}
...
### 3. የዕቅድ አፈጻጸም (Plan Execution) {#3-plan-execution}
...
### 4. የሂደት ክትትል (Progress Tracking) {#4-progress-tracking}
...
### 5. ስህተት መቋቋም (Error Recovery) {#5-error-recovery}
...
## v1 እና v2 ን ማነጻጸር {#comparing-v1-and-v2}
