...
## Custom Post Types (စိတ်ကြိုက်ပို့စ်အမျိုးအစားများ) {#custom-post-types}
...
## Custom Taxonomies (စိတ်ကြိုက်အမျိုးအစားများ) {#custom-taxonomies}
...
## Design System (ဒီဇိုင်းစနစ်) {#design-system}
...
## مدیریت محتوا (Content Management) {#content-management}
...
## காட்சி পর্যালোচনা (Visual Review) {#visual-review}
...
## நிறுவக்கூடிய திறன்கள் (Installable Abilities) {#installable-abilities}
