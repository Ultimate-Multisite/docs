...
በኤክስፖርት ወይም በኢምፖርት ጊዜ የሚላኩትን መደበኛ የተጠቃሚ መረጃ ርዕሶችን (headers) የሚያስተካክል/የሚቆጣጠር ነው።

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $custom_headers | `array` | የተጠቃሚው የራሱ የሆነ (custom) የርዕሶች ስብስብ (array)። |
...
## Returns {#returns}
የዳታ ርዕሶች (data headers) ስብስብ (array)።
