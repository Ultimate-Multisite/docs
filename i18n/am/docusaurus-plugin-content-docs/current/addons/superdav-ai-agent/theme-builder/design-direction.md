...
የዳሰሳ ቃለ-መጠይቅ (Discovery Interview) ከተጠናቀቀ በኋላ፣ Theme Builder የንድፍ አቅጣጫዎን በ**ዴስክቶፕ እና በሞባይል ቅድመ እይታ (preview rendering)** ያቀርባል። ይህ ደግሞ ወደ ንድፉ ከመግባታችሁ በፊት ንድፍዎ በተለያዩ መሳሪያዎች ላይ በትክክል ምን እንደሚመስል እንድታዩ ያስችላችኋል።

## የንድፍ አቅጣጫ ክፍሎች (Design Direction Components) {#design-direction-components}

### 1. የቀለም ቤተ-ስዕል (Color Palette) {#1-color-palette}
...
### 2. የፊደል አጻጻፍ (Typography) {#2-typography}
...
### 3. አቀማመጥ እና ክፍተት (Layout and Spacing) {#3-layout-and-spacing}
...
### 4. የእይታ አካላት (Visual Elements) {#4-visual-elements}
...
## ቅድመ እይታ መፍጠር (Preview Rendering) {#preview-rendering}

### የዴስክቶፕ ቅድመ እይታ (Desktop Preview) {#desktop-preview}
...
### የሞባይል ቅድመ እይታ (Mobile Preview) {#mobile-preview}
...
### ተስተካከለ የብሬክፖይንቶች (Responsive Breakpoints) {#responsive-breakpoints}
...
## ንድፍዎን ማሻሻል (Refining Your Design) {#refining-your-design}

### ማስተካከያዎችን ማድረግ (Making Adjustments) {#making-adjustments}
...
### የቅድመ እይታ ዝመናዎች (Preview Updates) {#preview-updates}
...
### የማነፃፀሪያ እይታ (Comparison View) {#comparison-view}
...
## የንድፍ አቅጣጫ ማጽደቅ (Design Direction Approval) {#design-direction-approval}
...
4. ወደ [Hospitality Menus](./hospitality-menus.md) ወይም ወደ ሌሎች ባህሪያት ይቀጥሉ።
...
- **ንፅፅርን ማረጋገጥ (Verify contrast)** — ለተደራሽነት [Validate Palette Contrast](../abilities/validate-palette-contrast.md) ይጠቀሙ።
...
### ቅድመ እይታ የማይዘመን ከሆነ (Preview Not Updating) {#preview-not-updating}
...
### ቀለሞች የተለያየ መምሰል ከሆነ (Colors Look Different) {#colors-look-different}
...
### የፊደል አጻጻፍ ችግሮች (Typography Issues) {#typography-issues}
...
- [Hospitality Menus](./hospitality-menus.md) — መዋቅራዊ የሜኑ ገጾችን መፍጠር።
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — የቀለም ተደራሽነትን መፈተሽ።
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — ብጁ አርማዎችን መፍጠር።
