...
## ለየጤና ዘርፉ ማዋቀር (Configuring for the Fitness Niche)

Ultimate Multisite ከተጫነ በኋላ፣ እነዚህን niche-specific የቅንብር ምርጫዎችን ያድርጉ፦

### አጠቃላይ ቅንብሮች (General Settings)
...
### የኢሜይል ቅንብር (Email Configuration)
...
### የዶሜን ቅንብር (Domain Configuration)
