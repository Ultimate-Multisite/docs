...
### የውጤት እሴት ስምምነት (Return value convention)
...
## የችሎታዎን ምዝገባ (Registering your capability)
...
## ለዊዛርድ የቅረንቲያል መስኮች መጨመር (Adding credential fields to the wizard)
...
## ለድህረ-ምዝገባ ድርጊቶች Hooks (Hooks for post-registration actions)
