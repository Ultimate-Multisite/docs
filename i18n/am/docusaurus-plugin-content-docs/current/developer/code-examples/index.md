...
ሁለት ተከታይ ጥያቄዎች አንድን ዋጋ ሊያነቡ እና ሁለቱም ተመሳሳይ የጨመረበትን ውጤት ሊጽፉ ይችላሉ፣ ይህም አንድ 카운ት እንዲጠፋ ያደርጋል። `increment_item()` ስሌቱን ወደ database engine ይልካል፣ ይህም በአንድ `UPDATE ... SET column = column + ?` statement ስለሚሰራ፣ ስራው በተፈጥሮው አቶሚክ (atomic) ይሆናል።
