...
አንድ ነገር (object) በዳታቤዝ ውስጥ ከተቀመጠ በኋላ የሚሰራ (action) ነው።

## መረጃዎች (Parameters) {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $data | `array` | በዳታቤዝ ውስጥ ሊቀመጥ የሚገባው የነገሩ መረጃ (object data)። |
| $this | `\Base_Model` | የነገሩ (object) ምሳሌ (instance)። |
| $new | `bool` | ነገር ከሆነ (object) አዲስ ከሆነ እውነት (True)። |
