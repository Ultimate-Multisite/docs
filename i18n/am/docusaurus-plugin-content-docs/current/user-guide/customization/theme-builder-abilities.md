...
## ብሎክ ንድፍ መቅረጽ (Scaffold Block Theme)
...
## የስራ ሂደት፡ መቅረጽ እና ማንቃት (Workflow: Scaffold and Activate)
...
## የንድፍ ምልክቶች እና ማበጀት (Design Tokens and Customization)
...
## ገደቦች እና ማስታወሻዎች (Limitations and Notes)
