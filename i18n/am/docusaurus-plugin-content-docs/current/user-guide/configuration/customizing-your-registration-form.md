...
---
# የምዝገባ ቅጽዎን ማበጀት {#customizing-your-registration-form}
...
## የመግቢያ እና የምዝገባ ገጾች፦ {#login-and-registration-pages}
...
## በርካታ የምዝገባ ቅጾችን መጠቀም፦ {#using-multiple-registration-forms}
...
### Checkout Form ማስተካከል፦ {#editing-a-checkout-form}
...
## በURL መለኪያዎች በኩል ምርቶችን እና አብነቶችን ቀድሞ መምረጥ፦ {#pre-selecting-products-and-templates-via-url-parameters}
