...
## ሊመጡ የሚችሉ ትዕዛዞች {#commands-to-run}
...
## የተለመዱ ውድቀቶች (Common failures) {#common-failures}

### የዳታቤዝ ስጦታዎች (Database grants) ከ호ስት ጋር አይዛመዱም {#database-grants-do-not-match-the-host}
...
### Bedrock ወይም የአካባቢ ጭነቶች መገናኘት አይችሉም {#bedrock-or-local-installs-cannot-connect}
...
### የአሲንክ ፑሽ መደብ (Async push queue) አይፈስም {#async-push-queue-does-not-drain}
...
## ሲያደርጉ እንደገና መሞከር (When to retry) {#when-to-retry}
