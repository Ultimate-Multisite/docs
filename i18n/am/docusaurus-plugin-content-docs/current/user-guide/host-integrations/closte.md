...
### 1. የCloste API Keyዎን ማረጋገጥ {#1-verify-your-closte-api-key}
...
### 2. ውህደቱን ማብራት (Enable the Integration) {#2-enable-the-integration}
...
## የዶሜይን መዝገብ መፍጠር (Domain Record Creation) {#domain-record-creation}
...
### የSSL Certificate ችግሮች (SSL Certificate Issues) {#ssl-certificate-issues}
...
### ዶሜይን አልተጨመረም (Domain Not Added) {#domain-not-added}
