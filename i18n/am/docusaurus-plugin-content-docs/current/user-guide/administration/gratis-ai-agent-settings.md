...
## ቅንብሮችን መድረስ {#accessing-settings}

1. በ WordPress አስተዳዳሪ ውስጥ ወደ **Gratis AI Agent → ቅንብሮች** ይሂዱ።
2. **የላቀ** ትርን ጠቅ ያድርጉ።

## የአስተያየት መጨረሻ ነጥብ ውቅር {#feedback-endpoint-configuration}
...
### የሚጠበቀው JSON ጭነት {#expected-json-payload}
...
### `triage_category` እሴቶች {#triagecategory-values}
...
### የአስተያየት መሰብሰብን ማሰናከል {#disabling-feedback-collection}
...
## የሚተዳደር Superdav አገልግሎት {#managed-superdav-service}
...
## Google Calendar ውቅር {#google-calendar-configuration}
...
## TextBee SMS ማሳወቂያዎች {#textbee-sms-notifications}
...
### የባህሪ ምልክቶችን መድረስ {#accessing-feature-flags}

1. በ WordPress አስተዳዳሪ ውስጥ ወደ **Gratis AI Agent → ቅንብሮች** ይሂዱ።
2. **የባህሪ ምልክቶች** ትርን ጠቅ ያድርጉ።

### የመዳረሻ ቁጥጥር ምልክቶች {#access-control-flags}
...
### የአውቶሜሽን ደህንነት ምልክቶች {#automation-safety-flags}
