...
---
# የአባልነት ጊዜ ማብቂያ እና የጣቢያ መዘጋት {#membership-expiration-and-site-blocking}
...
## የአባልነት ሁኔታ የህይወት ዑደት {#membership-status-lifecycle}
...
### የአባልነቶች ወደ ጊዜ ያለፈበት ሁኔታ እንዴት ይሸጋገራሉ {#how-memberships-transition-to-expired}
...
#### በራስ-የሚደሰቱ (Auto-Renewing) እና በራስ-የማይደሰቱ (Non-Auto-Renewing) የአባልነቶች ልዩነት {#auto-renewing-vs-non-auto-renewing-memberships}
...
### የሙከራ ጊዜዎች እንዴት ይቋረጣሉ {#how-trials-end}
...
## የፊት-መጨት መዳረሻን መዝጋት {#block-frontend-access}
...
### ቅንብሩን ማዋቀር {#configuring-the-setting}
...
### ጣቢያው ሲዘጋ ጎብኚዎች ምን ያያሉ {#what-visitors-see-when-a-site-is-blocked}
...
### ምን ይዘጋል እና መቼ {#what-gets-blocked-and-when}
...
## ችግር መፈተሽ፡ ጊዜ ካለፈ በኋላ ጣቢያዎች ተደራሽ መሆን {#troubleshooting-sites-remaining-accessible-after-expiration}

የአባልነት ሁኔታው ካለፈ በኋላ ጣቢያዎች በህዝብ ተደራሽ ከሆኑ፣ እነዚህን ፍተሻዎች በቅደም ተከተል ይፈጽሙ፡

### 1. የBlock Frontend Access ቅንብር በርቷል መሆኑን ያረጋግጡ {#1-verify-the-block-frontend-access-setting-is-enabled}
...
### 2. የFrontend Block Grace Periodን ይፈትሹ {#2-check-the-frontend-block-grace-period}
...
### 3. የአባልነት ሁኔታው በእርግጥ እንደተቀየረ ያረጋግጡ {#3-confirm-the-membership-status-has-actually-changed}
...
### 4. Action Scheduler እየሰራ መሆኑን ያረጋግጡ {#4-verify-action-scheduler-is-running}
...
### 5. የክፍያ መግቢያ Webhook ችግሮችን ይፈትሹ (በራስ-የሚደሰቱ የአባልነቶች) {#5-check-for-gateway-webhook-issues-auto-renewing-memberships}
...
### 6. የጊዜ ማብቂያ የመታገስ ጊዜን ይፈትሹ (Cron ደረጃ) {#6-check-the-expiration-grace-period-cron-level}
...
### 7. የአባልነት ሁኔታን በእጅ ማብቃት {#7-manually-expire-a-membership}
...
## ለገንቢዎች ማጣቀሻ (Developer Reference) {#developer-reference}
