...
## የጣቢያ ዝርዝር መግለጫ ምንድን ነው? {#what-is-site-specification}
...
## የጣቢያ ዝርዝር መግለጫን ለምን መጠቀም አለብኝ? {#why-use-site-specification}

### በየجلسቶቹ ውስጥ ወጥነት (Consistency Across Sessions) {#consistency-across-sessions}
...
### የተሻሉ ምክሮች (Better Recommendations) {#better-recommendations}
...
### ፈጣን መማር (Faster Onboarding) {#faster-onboarding}

አዳዲስ አግነዋሚዎች (ወይም በአዲስ ክፍለ ጊዜ ውስጥ ያሉ አግነዋሚዎች) የሚያብራሩ ጥያቄዎችን ከመጠየቅ ይልቅ የsite_briefዎን በማንበብ በፍጥነት ይማራሉ።

## የጣቢያ ዝርዝር መግለጫን መጀመር (Initiating Site Specification) {#initiating-site-specification}

### በTheme Builder Onboarding ወቅት {#during-theme-builder-onboarding}
...
### በእጅ መጀመር (Manual Initiation) {#manual-initiation}
...
## የጣቢያ ዝርዝር መግለጫው ሂደት (The Site Specification Process) {#the-site-specification-process}

### ደረጃ 1: የጣቢያ ዓላማ (Site Purpose) {#step-1-site-purpose}
...
### ደረጃ 2: የታለመ ተመልካች (Target Audience) {#step-2-target-audience}
...
### ደረጃ 3: የምርት ስም ማንነት (Brand Identity) {#step-3-brand-identity}
...
### ደረጃ 4: የንግድ ግቦች (Business Goals) {#step-4-business-goals}
...
### ደረጃ 5: የይዘት አወቃቀር (Content Structure) {#step-5-content-structure}
...
## የsite_brief ማህደረ ትውስታዎ (Your site_brief Memory) {#your-sitebrief-memory}
...
## የsite_briefዎን መመልከት እና ማዘመን (Viewing and Updating Your site_brief) {#viewing-and-updating-your-sitebrief}

### የsite_briefዎን መመልከት {#view-your-sitebrief}
...
### የsite_briefዎን ማዘመን {#update-your-sitebrief}
...
## አግነዋሚዎች site_briefን እንዴት ይጠቀማሉ (How Agents Use site_brief) {#how-agents-use-sitebrief}

### የዲዛይን ምክሮች (Design Recommendations) {#design-recommendations}
...
### የባህሪ ምክሮች (Feature Suggestions) {#feature-suggestions}
...
### የይዘት አወቃቀር (Content Structure) {#content-structure}
...
### የተለዩ ይሁኑ (Be Specific) {#be-specific}
...
### በመደበኛነት ያዘምኑ (Update Regularly) {#update-regularly}
...
### ወጥ የሆኑ ቃላትን ይጠቀሙ (Use Consistent Terminology) {#use-consistent-terminology}
...
### ሁኔታን ያካትቱ (Include Context) {#include-context}
...
## ከTheme Builder Onboarding ጋር ያለው ግንኙነት (Relationship to Theme Builder Onboarding) {#relationship-to-theme-builder-onboarding}
