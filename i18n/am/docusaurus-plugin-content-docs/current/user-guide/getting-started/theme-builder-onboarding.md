...
## Theme Builder Onboarding Flow ምንድነው?
...
## Theme Builder Onboardingን መጀመር

### ለመጀመሪያ ጊዜ ሲሰሩ (First-Run Setup)
...
### ደረጃ 2: የድረ-ገጽ ዝርዝር መግለጫ (Site Specification)
...
### ደረጃ 3: የንድፍ ስርዓት ውሳኔዎች (Design System Decisions)
...
### ደረጃ 4: የቴም መፍጠር (Theme Generation)
...
### ደረጃ 5: መነቃቃት እና ማረጋገጥ (Activation and Verification)
...
## Site Specification እና site_brief Memory
...
## Onboarding ከተጠናቀቀ በኋላ ማበጀት (Customizing After Onboarding)

የ Theme Builder onboarding ከተጠናቀቀ በኋላ የሚከተሉትን ማድረግ ይችላሉ፦

### Design System Aesthetics Skillን መጠቀም
...
### theme.jsonን በቀጥታ ማርትዕ (Edit theme.json Directly)
