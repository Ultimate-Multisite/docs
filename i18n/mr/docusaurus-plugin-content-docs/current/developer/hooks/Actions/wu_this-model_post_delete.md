...
हा action तेव्हा ट्रिगर होतो, जेव्हा एखादे ऑब्जेक्ट डेटाबेसमध्ये सेव्ह (store) केले जाते.

## पॅरामीटर्स (Parameters) {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $result | `bool` | जर ऑब्जेक्ट यशस्वीरित्या डिलीट झाला असेल, तर `True` असते. |
| $this | `\Base_Model` | ऑब्जेक्टची इन्स्टन्स (instance). |

### कधीपासून उपलब्ध (Since) {#since}
