...
### पर्यायी मेथड्स (Optional methods)
...
### रिटर्न व्हॅल्यू कन्व्हेन्शन (Return value convention)
...
## तुमची capability नोंदणी करणे (Registering your capability)
...
## विझार्डमध्ये credential फील्ड जोडणे (Adding credential fields to the wizard)
...
## पोस्ट-नोंदणी क्रियाकलापांसाठी हुक्स (Hooks for post-registration actions)
