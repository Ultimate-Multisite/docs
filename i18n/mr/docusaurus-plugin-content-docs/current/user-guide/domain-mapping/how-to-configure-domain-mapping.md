...
---
# Domain Mapping (v2) कसे कॉन्फिगर करावे
...
### तुमच्या Ultimate Multisite Network वर domain mapping कसे सेटअप करावे
...
### domain DNS settings योग्यरीत्या कॉन्फिगर केलेली आहेत याची खात्री करणे
...
### Super Admin म्हणून custom domain नाव मॅप करणे
...
### Subsite वापरकर्ता म्हणून custom domain नाव mapping करणे
