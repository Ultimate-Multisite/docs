...
---
# तुमचा नोंदणी फॉर्म सानुकूलित करणे {#customizing-your-registration-form}
...
## लॉगिन आणि नोंदणी पाने: {#login-and-registration-pages}
...
## एकाधिक नोंदणी फॉर्म वापरणे: {#using-multiple-registration-forms}
...
### Checkout Form संपादित करणे: {#editing-a-checkout-form}
...
## URL parameters द्वारे products आणि templates pre-select करणे: {#pre-selecting-products-and-templates-via-url-parameters}
