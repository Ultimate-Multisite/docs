...
## इंटरनेट सर्च सक्षम करणे (Enabling Internet Search)
...
### Brave Search API की मिळवणे (Obtaining a Brave Search API Key)
...
### वापराच्या मर्यादा (Usage Limits)
...
### Tavily API की मिळवणे (Obtaining a Tavily API Key)
...
## इंटरनेट सर्च अक्षम करणे (Disabling Internet Search)
