...
### 7.0 पूर्वीच्या WordPress आवृत्त्या
...
### स्वयंचलित शोध (Automatic Discovery)
...
### सोपे व्यवस्थापन (Simplified Management)
...
### चांगले कार्यप्रदर्शन (Better Performance)

- क्षमता कॅश (cached) केल्या जातात.
- मागणीनुसार (on demand) लोडेड होतात.
- WordPress 7.0+ साठी ऑप्टिमाइझ केलेले.

## स्थलांतरण मार्ग (Migration Path)

### जर तुम्ही WordPress 6.x वर असाल
...
### जर तुम्ही WordPress 7.0+ वर असाल
...
### auto मोडमध्ये क्षमता लोड होत नाहीत
...
### मला legacy मोड कायम ठेवायचा आहे
...
### माझ्या कस्टम क्षमता दिसत नाहीत
...
### मला "unclassified ability" सूचना मिळत आहेत
...
## मागे सुसंगतता (Backward Compatibility)

### विद्यमान कॉन्फिगरेशन्स
...
### अप्रचलित होण्याची कालरेखा (Deprecation Timeline)
