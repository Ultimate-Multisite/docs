...
### 2. wp-config.php मध्ये कॉन्स्टंट्स जोडा
...
### 4. कनेक्टिव्हिटी तपासा (Verify Connectivity)
...
## कॉन्फिगरेशन संदर्भ (Configuration Reference)
