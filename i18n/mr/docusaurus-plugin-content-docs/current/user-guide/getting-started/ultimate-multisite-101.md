...
#### Subdomain विरुद्ध Subdirectory {#subdomain-vs-subdirectory}
...
#### Plugins आणि Themes {#plugins-and-themes}
...
#### Users आणि Administrators {#users-and-administrators}
...
#### प्रकरण 1: एक एजन्सी {#case-1-an-agency}
...
#### प्रकरण 2: Niche प्रोव्हायडर {#case-2-niche-provider}
...
#### प्रकरण 3: WordPress वेब होस्टिंग {#case-3-wordpress-web-hosting}
...
### आर्किटेक्चर विचार {#architecture-considerations}
...
#### Shared विरुद्ध Dedicated होस्टिंग {#shared-vs-dedicated-hosting}
...
#### Domain आणि SSL {#domain-and-ssl-1}
