...
---
# मल्टीसाइट सेटअप विझार्ड {#multisite-setup-wizard}
...
## विझार्ड कधी दिसतो? {#when-does-the-wizard-appear}
...
## पायरी 2: नेटवर्क कॉन्फिगरेशन {#step-2-network-configuration}
...
### नेटवर्क अ‍ॅडमिन ईमेल {#network-admin-email}
...
## पायरी 3: इंस्टॉलेशन {#step-3-installation}
...
## मॅन्युअल सेटअप फॉलबॅक {#manual-setup-fallback}
...
### विझार्ड सांगतो की wp-config.php लिहिता येत नाही {#the-wizard-says-wp-configphp-is-not-writable}
...
### सेटअपनंतर साइट्स अ‍ॅक्सेस करता येत नाहीत (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### सेटअपनंतर authentication समस्या {#authentication-issues-after-setup}
...
### इंस्टॉलेशन दरम्यान एक पायरी अयशस्वी झाली {#a-step-failed-during-installation}
