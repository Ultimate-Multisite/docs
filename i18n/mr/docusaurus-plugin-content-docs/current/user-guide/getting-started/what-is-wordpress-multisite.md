...
---
# WordPress Multisite म्हणजे काय? {#what-is-wordpress-multisite}
...
## WordPress Multisite नेमकं काय आहे? {#what-exactly-is-wordpress-multisite}
...
## Subdomain की Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites मध्ये काय शेअर होतं आणि काय नाही {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite वर User व्यवस्थापन {#user-management-on-wordpress-multisite}
...
## Performance विचार {#performance-considerations}
