...
## Theme Builder Onboarding Flow म्हणजे काय?
...
## Theme Builder Onboarding सुरू करणे

### पहिल्यांदा सेटअप (First-Run Setup)
...
### टप्पा १: मोड निवड (Mode Selection)
...
### टप्पा २: साइट तपशील (Site Specification)
...
### टप्पा ३: डिझाइन सिस्टीम निर्णय (Design System Decisions)
...
### टप्पा ४: थीम निर्मिती (Theme Generation)
...
### टप्पा ५: सक्रियण आणि पडताळणी (Activation and Verification)
...
## Site Specification आणि site_brief मेमरी
...
## Onboarding नंतर कस्टमायझेशन करणे

Theme Builder onboarding पूर्ण झाल्यावर, तुम्ही खालील गोष्टी करू शकता:

### Design System Aesthetics Skill चा वापर करणे
...
### theme.json मध्ये थेट संपादन करणे
...
### कस्टमाइज्ड ब्लॉक टेम्पलेट्स तयार करणे
...
## तुलना: जुने विरुद्ध नवीन Onboarding
