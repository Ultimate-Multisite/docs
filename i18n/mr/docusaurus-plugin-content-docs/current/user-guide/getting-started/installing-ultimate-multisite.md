...
---
# Ultimate Multisite इंस्टॉल करणे {#installing-ultimate-multisite}
...
## प्लगइन इंस्टॉल करणे {#installing-the-plugin}
...
### प्री-इंस्टॉल तपासणी {#pre-install-checks}
...
### डिफॉल्ट कंटेंट {#default-content}
...
### शिफारस केलेले प्लगइन {#recommended-plugins}
