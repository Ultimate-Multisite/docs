...
---
# सॉवरेन मायग्रेशन व्हेरिफिकेशन {#sovereign-migration-verification}
...
## चालवायच्या कमांड्स {#commands-to-run}
...
## सामान्य अपयश {#common-failures}

### डेटाबेस ग्रांट्स होस्टशी जुळत नाहीत {#database-grants-do-not-match-the-host}
...
### बेडरोक (Bedrock) किंवा लोकल इन्स्टॉल कनेक्ट करू शकत नाहीत {#bedrock-or-local-installs-cannot-connect}
...
### असिंक्रोनस पुश क्यू ड्रेन होत नाही {#async-push-queue-does-not-drain}
...
### टेनंट युजरची संख्या चुकीची आहे {#tenant-user-count-is-wrong}
...
### SSO भेट नाकारली जाते {#sso-visit-is-rejected}
...
## पुन्हा कधी प्रयत्न करायचे {#when-to-retry}
