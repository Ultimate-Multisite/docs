...
---
# Enhance Control Panel इंटिग्रेशन {#enhance-control-panel-integration}
...
## तुमचे API Credentials मिळवणे {#getting-your-api-credentials}

### 1. API Token तयार करा {#1-create-an-api-token}
...
### 2. तुमचा Organization ID मिळवा {#2-get-your-organization-id}
...
### 3. तुमचा Server ID मिळवा {#3-get-your-server-id}
...
### 4. तुमचा API URL मिळवा {#4-get-your-api-url}
...
### Integration Wizard द्वारे Setup {#setup-via-integration-wizard}
...
### Domain Map केल्यावर {#when-a-domain-is-mapped}
...
### Domain हटवल्यावर {#when-a-domain-is-removed}
...
## Setup सत्यापित करणे {#verifying-setup}

### Connection Test करा {#test-the-connection}
...
### Domain Map केल्यानंतर {#after-mapping-a-domain}
...
### वापरलेले सामान्य Endpoints {#common-endpoints-used}
...
### संपूर्ण API Documentation {#full-api-documentation}
...
## अतिरिक्त संसाधने {#additional-resources}
