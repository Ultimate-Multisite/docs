...
### 1. तुमची ServerPilot API माहिती मिळवा {#1-get-your-serverpilot-api-credentials}
...
### 2. तुमची App ID मिळवा {#2-get-your-app-id}
...
## SSL प्रमाणपत्र सत्यापन {#ssl-certificate-verification}
...
### SSL प्रमाणपत्र समस्या {#ssl-certificate-issues}
...
### Domain जोडले गेले नाही {#domain-not-added}
