...
### 1. तुमची cPanel क्रेडेन्शियल्स मिळवा {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php मध्ये Constants जोडा {#2-add-constants-to-wp-configphp}
...
### 3. इंटिग्रेशन सक्षम करा {#3-enable-the-integration}
...
## महत्त्वाच्या नोट्स {#important-notes}
