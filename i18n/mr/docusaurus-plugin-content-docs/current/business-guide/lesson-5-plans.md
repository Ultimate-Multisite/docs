...
---
# धडा ५: तुमच्या योजना डिझाइन करणे {#lesson-5-designing-your-plans}
...
## ग्राहक विभागांनुसार विचार करणे (Thinking in Customer Segments) {#thinking-in-customer-segments}
...
## FitSite योजना तयार करणे {#creating-the-fitsite-plans}
...
## प्लॅन ग्रुप सेट करणे (Setting Up the Plan Group) {#setting-up-the-plan-group}
...
## ऑर्डर बम्प्स जोडणे (Adding Order Bumps) {#adding-order-bumps}
...
## ही रचना का कार्य करते (Why This Structure Works) {#why-this-structure-works}
...
## FitSite नेटवर्क आतापर्यंत (The FitSite Network So Far) {#the-fitsite-network-so-far}
