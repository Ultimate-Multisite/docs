...
---
# धडा ७: स्वतःचे बनवणे (Making It Yours) {#lesson-7-making-it-yours}
...
## तुमचा प्लॅटफॉर्म डोमेन (Your Platform Domain) {#your-platform-domain}
...
### तुमचा डोमेन सेट करणे {#setting-up-your-domain}
...
## ॲडमिन अनुभवाचे व्हाईट-लेबलिंग (White-Labeling the Admin Experience) {#white-labeling-the-admin-experience}
...
### कस्टम लॉगिन पेज (Custom Login Page) {#custom-login-page}
...
### डॅशबोर्ड ब्रँडिंग (Dashboard Branding) {#dashboard-branding}
...
### कस्टम ॲडमिन पेजेस (Custom Admin Pages) {#custom-admin-pages}
...
## तुमच्या संवादांचे ब्रँडिंग (Branding Your Communications) {#branding-your-communications}

प्रत्येक ईमेल, इनव्हॉइस आणि नोटिफिकेशनने तुमच्या ब्रँडला बळकटी दिली पाहिजे.

### सिस्टीम ईमेल (System Emails) {#system-emails}
...
## ग्राहक-समोरची साइट (The Customer-Facing Site) {#the-customer-facing-site}
...
## ग्राहकांसाठी कस्टम डोमेन (Custom Domain for Customers) {#custom-domain-for-customers}
...
## आतापर्यंतचे FitSite नेटवर्क (The FitSite Network So Far) {#the-fitsite-network-so-far}
...
## या धड्यात आम्ही काय तयार केले {#what-we-built-this-lesson}
