...
## रिटर्न व्हॅल्यू (Return Value) {#return-value}
...
## नेव्हिगेशन लेबल विरुद्ध पेज शीर्षक (Navigation Label vs Page Title) {#navigation-label-vs-page-title}
...
## वापराचे उदाहरणे (Usage Examples) {#usage-examples}

### उदाहरण १: नेव्हिगेशन लेबलसह साधे मेनू {#example-1-simple-menu-with-navigation-label}
...
### उदाहरण २: विशिष्ट थीम स्थानासाठी मेनू {#example-2-menu-for-specific-theme-location}
...
## संबंधित क्षमता (Related Abilities) {#related-abilities-1}
