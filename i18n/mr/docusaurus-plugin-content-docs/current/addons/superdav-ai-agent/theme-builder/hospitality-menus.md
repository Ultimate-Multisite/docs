...
## समर्थित हॉस्पिटॅलिटी प्रकार (Supported Hospitality Types)
...
## मेन्यूची रचना (Menu Structure)

### मेन्यू श्रेणी (Menu Categories)
...
### मेन्यू आयटम स्वरूप (Menu Item Format)
...
## हॉस्पिटॅलिटी मेन्यू तयार करणे (Creating Hospitality Menus)

### पायरी १: मेन्यू माहिती द्या (Step 1: Provide Menu Information)
...
### पायरी २: Theme Builder मेन्यू तयार करतो (Step 2: Theme Builder Generates Menu)
...
### पायरी ३: पुनरावलोकन आणि सानुकूलित करा (Step 3: Review and Customize)
...
## मेन्यू डिस्प्ले पर्याय (Menu Display Options)

### पूर्ण मेन्यू पेज (Full Menu Page)
...
## आहारविषयक आणि ॲलर्जीक माहिती (Dietary and Allergen Information)

### आहारविषयक गुणधर्म (Dietary Attributes)
...
### ॲलर्जीक चेतावणी (Allergen Warnings)
...
## मेन्यू व्यवस्थापन (Menu Management)

### किंमती अपडेट करणे (Updating Prices)
...
### हंगामी आयटम्स जोडणे (Adding Seasonal Items)
...
### खास पदार्थांचे व्यवस्थापन (Managing Specials)
...
## Theme Builder सोबत एकत्रीकरण (Integration with Theme Builder)
...
### रेस्टॉरंट मेन्यू रचना (Restaurant Menu Structure)
...
### कॅफे मेन्यू रचना (Cafe Menu Structure)
...
## संबंधित वैशिष्ट्ये (Related Features)
