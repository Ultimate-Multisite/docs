...
दिलेल्या फॉर्मचा प्रकार या प्लॅनवर वापरला जाऊ शकतो की नाही हे तपासते. प्लगइन डेव्हलपर्सना रिटर्न व्हॅल्यू फिल्टर करण्याची परवानगी देते.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $value | `bool` | फॉर्मचा प्रकार मर्यादेपेक्षा जास्त आहे की नाही. |
| $form_type | `string` | तपासला जाणारा फॉर्मचा प्रकार. |
| $form_count | `int` | सध्या फॉर्मची संख्या. |
| $quota | `int` | परवानगी असलेला कोटा. |
