...
## Чӣ тавр ингибори нави Trigger сохтан? {#how-to-create-a-new-trigger}
...
## Чӣ тавр Амалҳо (Actions) сохтан? {#how-to-create-actions}
...
### Тарзисозии Амал (Setting up the Action) {#setting-up-the-action}
