...
## Важно — Подводный камень с сертификатами SSL с диким символом {#important--wildcard-ssl-pitfall}
...
### Masalalari SSL Certificate {#ssl-certificate-issues}
...
### Домен Нагоҳидашуда Нангӣ {#domain-not-added}
