...
## Гирифтани маълумоти API-и худ

### 1. Сохтани Токени API
...
### 2. Получение вашего Organization ID (Идентификатора организации)
...
### 3. Получение вашего Server ID (Идентификатора сервера)
...
### 4. Получение вашего API URL (URL API)
...
### Насоботӣ тавассути Wizard (Ройгон)
...
## Ташкилоти Иловагӣ дар WordPress
...
### Вақте ки домен пайваст карда мешавад (Mapped Domain)
...
### Вақте як домен аз навсозӣ карда мешавад (When a Domain is Removed)
...
### Муайян кардани DNS ва SSL (DNS and SSL Checking)
...
## Тасдиқи сохтшавӣ (Verifying Setup)

### Пулӣ кардани пайвасткунӣ (Test the Connection)
...
### Баъди тасвири домен (After Mapping a Domain)
...
## Мушки кушодаи (Troubleshooting)

### Мушки пайвасткунӣ (API Connection Issues)
...
### Масъалаҳои Сартират SSL (SSL Certificate Issues)
...
### Давраи санҷиши DNS (DNS Check Interval)
...
### Хатоҳои тасдиқ (Authentication Errors)
...
## Маълумоти API (API Reference)

### Тасдиқ (Authentication)
Ҳамаи дархостҳои API аз тасдиқи Bearer token истифода мешаванд:
```
Authorization: Bearer YOUR_TOKEN_HERE
```

### Нимбастрин Endpoint-ҳо (Common Endpoints Used)
