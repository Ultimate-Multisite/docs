...
---
# Нара мераи пайваст кардани интегратсияи Control Panel {#enhance-control-panel-integration}
...
# ҳамгирии бо Интеграцияи Control Panel {#setup-via-integration-wizard}
