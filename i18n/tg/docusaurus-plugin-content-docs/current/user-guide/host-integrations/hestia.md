...
---
# Интеграция с панелью управления Hestia
...
## Настройка (Мастер → Интеграции → Hestia)
...
## Мониторинг проблем (Troubleshooting)
