...
---
# Маҳорати Эстетикаи Системаи Намоишӣ (Design System Aesthetics Skill) {#design-system-aesthetics-skill}
...
## Эстетикаи Системаи Намоишӣ чист? {#what-is-design-system-aesthetics}
...
## Чаро бояд Эстетикаи Системаи Намоишӣ-ро истифода баред? {#why-use-design-system-aesthetics}

### Мувофиқӣ (Consistency) {#consistency}
...
### Маслият (Flexibility) {#flexibility}
...
## Фаъол кардани Маҳорати Эстетикаи Системаи Намоишӣ {#triggering-the-design-system-aesthetics-skill}

### Фаъолисозии Рушӣ (Manual Activation) {#manual-activation}
...
### Пулсиҳо аз ҷониби Агент (Automatic Suggestions) {#automatic-suggestions}
...
## Процесс эстетики дизайн-системы {#the-design-system-aesthetics-process}
...
### Қадами 4: Ҳадҷ ва Саёҳҳо (Borders and Shadows) {#step-4-borders-and-shadows}
...
### Қадами 5: Ҳаракат ва Аниматсия (Motion and Animation) {#step-5-motion-and-animation}
...
## Татбиқи Зиёрати Системаи Дизайн (Applying Design System Aesthetics) {#applying-design-system-aesthetics}

### Татбиқи Аוטوماتӣ (Automatic Application) {#automatic-application}
...
### Татбиқи Рушӣ (Manual Application) {#manual-application}
...
## Наблюдение за вашей дизайн-системой {#viewing-your-design-system}

### Спросите Агента {#ask-the-agent}
...
### Просмотр theme.json {#view-themejson}

Откройте `/wp-content/themes/[theme-name]/theme.json` в текстовом редакторе, чтобы увидеть исходные определения токенов.

## Обновление вашей дизайн-системы {#updating-your-design-system}

### Быстрые обновления {#quick-updates}
...
## Лучшие практики дизайн-системы {#design-system-best-practices}

### Последовательность (Consistency) {#consistency-1}
...
### Документатсияи системаи дизайн {#documentation}
...
## Шаблони маъмураи системаи дизайн {#common-design-system-patterns}

### Муосир ва Минималистӣ {#modern-minimalist}
...
### Гарм ва Достӣ {#warm-and-friendly}
...
### Мутахассиси Корпоративӣ {#professional-corporate}
...
### Хунки ва Болоғон {#creative-and-bold}
