...
## WordPress Multisite дуруст чист? {#what-exactly-is-wordpress-multisite}
...
## Subdomain ё Subdirectory? {#subdomain-or-subdirectory}
...
## Что общее для субсайтов и чего нет {#what-is-shared-among-subsites-and-what-is-not}
...
## Назарҳои иҷрои кор (Performance considerations) {#performance-considerations}
