...
---
# Маълумотномаи қобилиятҳо {#abilities-reference}
...
## Навъҳои фармоишии навиштаҳо {#custom-post-types}
...
## Таксономияҳои фармоишӣ {#custom-taxonomies}
...
## Системаи тарроҳӣ {#design-system}
...
## Менюҳои паймоиш {#navigation-menus}
...
## Идоракунии имконот {#options-management}
...
## Идоракунии муҳтаво {#content-management}
...
## Баррасии визуалӣ {#visual-review}
...
## Қобилиятҳои насбшаванда {#installable-abilities}
