...
Ду дархости ҳамзамон метавонанд ҳамон як қиматро хонанд ва ҳар ду ҳамон натиҷаи афзудашударо дубора сабт кунанд, ки дар натиҷа як ҳисоб аз даст меравад. `increment_item()` ҳисобро бо як дастури `UPDATE ... SET column = column + ?` ба муҳаррики пойгоҳи додаҳо месупорад ва амалиётро моҳиятан атомӣ мекунад.
