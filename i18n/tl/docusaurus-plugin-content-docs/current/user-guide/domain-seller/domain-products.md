...
---
# Mga Produkto at Presyo ng Domain {#domain-products-and-pricing}
...
## Tab ng Domain settings {#domain-settings-tab}
...
### Mga Suportadong TLDs {#supported-tlds}
...
### Markup type (Uri ng Markup) {#markup-type}
...
### Introductory pricing (Panimulang presyo) {#introductory-pricing}
...
## Admin: Manual na pagpaparehistro ng domain {#admin-manual-domain-registration}
