...
### 2. Kunin ang Iyong Server at Application IDs {#2-get-your-server-and-application-ids}
...
## Mahalaga — Problema sa Wildcard SSL {#important--wildcard-ssl-pitfall}
...
### Inirerekomendang Cloudways SSL setup para sa Ultimate Multisite network {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### Domain Hindi Naisama {#domain-not-added}
