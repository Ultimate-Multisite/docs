...
### 1. Beripikahin ang Iyong Closte API Key {#1-verify-your-closte-api-key}
...
## Paglikha ng Domain Record {#domain-record-creation}
...
### Hindi Naisama ang Domain {#domain-not-added}
...
### Interval ng DNS Check {#dns-check-interval}
