...
### Hindi ma-access ang mga site pagkatapos mag-setup (subdomains)
...
### Mga isyu sa authentication pagkatapos mag-setup
...
### Nagkaroon ng pagkabigo sa isang hakbang sa installation
