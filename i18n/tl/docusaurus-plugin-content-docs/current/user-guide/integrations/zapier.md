...
## Paano Magsisimula {#how-to-start}
...
## Paano Gumawa ng Bagong Trigger {#how-to-create-a-new-trigger}
...
## Paano Gumawa ng Actions {#how-to-create-actions}
...
### Pag-set up ng Action {#setting-up-the-action}
