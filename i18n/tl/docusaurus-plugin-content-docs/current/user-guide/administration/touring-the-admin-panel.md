...
Listahan ng mga kasalukuyang sinusuportang OAuth provider pools ang AI connector settings: Anthropic Max, OpenAI ChatGPT/Codex, at Google AI Pro. Ang bawat card ng provider ay nagbibigay-daan sa super admins na mag-connect ng mga account, mag-refresh ng mga naka-save na account, magtanggal ng mga account gamit ang email, at gumamit ng manual OAuth fallback kapag ang sandboxed environment ay humaharang sa browser redirect. Ang mga setup options para sa Cursor Pro ay tinanggal na mula sa admin panel.

Ang mga account ng ChatGPT/Codex ay sumusuporta sa connector-backed tool use kung saan pinapayagan ang paggamit ng mga tools, kaya ang mga workflow ng admin na umaasa sa mga operasyong sinusuportahan ng connector ay maaaring gumamit ng Codex tool behavior pagkatapos ma-connect ang OpenAI account.

![Settings page](/img/admin/settings-general.png)

Narito ang buong tingin sa general settings page:

![Settings general full page](/img/admin/settings-general-full.png)

At ang emails settings page:

![Settings emails full page](/img/admin/settings-emails-full.png)

At ang payments settings page:

![Settings payments full page](/img/admin/settings-payments-full.png)

At ang ibabang bahagi ng payments settings:

![Settings payments bottom section](/img/admin/settings-payments-bottom.png)

At ang sites settings page:
