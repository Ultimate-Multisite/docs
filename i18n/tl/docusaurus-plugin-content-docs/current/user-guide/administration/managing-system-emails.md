...
Mula doon, maaari mong ma-access ang pahina ng **System Emails** para makita ang lahat ng mga template ng email.
...
Para mag-import ng mga bagong email template:

1. Pumunta sa pahinang **System Emails**.
...
1. **Tanggalin at i-import muli** — Tanggalin ang system email at i-import ulit ito (ito ay magbubura ng mga metrics sa pagpapadala).
2. **I-reset gamit ang tool** — Gamitin ang **Reset & Import** tool, i-toggle ang opsyon na **Reset**, at piliin ang mga email na gusto mong i-reset.

Mas pinapaboran ang opsyong Reset dahil pinapanatili nito ang mga send metrics at iba pang metadata habang ibinabalik ang default na nilalaman.
