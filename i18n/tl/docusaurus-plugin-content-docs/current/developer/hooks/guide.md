---
title: Gabay sa Paggamit ng Hooks
sidebar_position: 1
...
### Lifecycle ng Customer {#customer-lifecycle}

#### Pagkatapos ng Paglikha ng Customer {#after-customer-creation}
...
#### Pagbabago ng Katayuan ng Customer {#customer-status-change}
...
#### Pagkatapos Ma-publish ang Site {#after-site-published}
...
#### Bago ang Paglalapat ng Template {#before-template-application}
...
#### Mga Paglipat ng Katayuan {#status-transitions}
...
#### Nakumpleto / Nabigo ang Payment {#payment-completed--failed}
...
#### Bago ang Pagproseso / Pagkatapos ng Pagkumpleto {#before-processing--after-completion}
...
### Mga Filter ng Presyo {#pricing-filters}

#### Kabuuan ng Cart {#cart-total}
...
### Mga Filter ng Template {#template-filters}
...
### Mga Filter ng Limitasyon {#limitation-filters}
...
### Mga Filter ng Gateway {#gateway-filters}
...
### Mga Field ng Checkout Form {#checkout-form-fields}
...
### Nilalaman ng Email {#email-content}
