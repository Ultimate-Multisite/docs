...
## Kailan ito gamitin {#when-to-use-it}
...
## Kombensiyon sa pagpapangalan ng file {#file-naming-convention}
...
## Mga available na hook at filter {#hooks-and-filters-available}
