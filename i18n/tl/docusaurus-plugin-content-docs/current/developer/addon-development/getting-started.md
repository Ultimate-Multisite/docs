...
---
# Pag-develop ng Addon {#addon-development}
...
├── inc/
│   ├── class-my-addon.php       # Pangunahing klase ng addon
│   ├── admin-pages/             # Interface ng admin
│   ├── models/                  # Mga pasadyang modelo ng data
│   └── integrations/            # Mga integrasyon ng third-party
├── assets/
│   ├── js/
│   └── css/
...
## Template ng Pangunahing File ng Addon {#main-addon-file-template}
...
## Halimbawa ng Pasadyang Modelo {#custom-model-example}
...
## Integrasyon ng Pahina ng Admin {#admin-page-integration}
...
## Pagsubok sa Iyong Addon {#testing-your-addon}
...
Nagdaragdag ang Ultimate Multisite v2.13.0 ng ilang extension points na kapaki-pakinabang para sa mga addon na nag-iintegrate sa mga sovereign tenant, checkout domain, o host-provider DNS automation.

### Mga URL para sa SSO at pamamahala ng main-site {#sso-and-main-site-management-urls}
...
### Mga base domain ng checkout-form {#checkout-form-base-domains}

Gamitin ang `wu_checkout_form_base_domains` kapag nagbibigay ang iyong addon ng karagdagang mga shared base domain na dapat kumilos tulad ng checkout-form **Site URL** domains sa halip na per-site custom mappings:
...
Nino-normalize ng Ultimate Multisite ang mga host na ito at nilalaktawan ang awtomatikong per-site mapped-domain records para sa mga ito.

### Awtomatikong paggawa ng domain-record {#automatic-domain-record-creation}

Gamitin ang `wu_should_create_domain_record_for_site` kapag kailangang pigilan o ipagpaliban ng iyong addon ang awtomatikong paggawa ng domain-record para sa bagong gawang site:
...
Ang mga integrasyon ng host-provider na nakikinig sa `wu_add_subdomain` ay maaaring gumawa ng provider-side DNS records kapag ginagawa ang mga site. Kung walang integrasyong nakarehistro para sa aksyong iyon, nilalaktawan ng Ultimate Multisite ang bakanteng background job.
...
- Tingnan ang [Pangkalahatang-ideya ng REST API](/developer/rest-api/overview) para sa API integration
