...
- [ ] Gumagana ang pagmamapa ng domain -- subukang gumawa ng sityo at mag-mapa ng custom domain
...
- [ ] Wasto ang lisensya ng lahat ng larawan (walang watermark ng stock photo)
- [ ] Gumagana ang mobile responsiveness sa bawat pahina ng hulmahan
...
- [ ] Tama ang pagpepresyo (buwan-buwan at taun-taon)
- [ ] Naka-configure ang mga setup fee sa tamang mga plano
...
- [ ] Matagumpay na napoproseso ang bayad
- [ ] Natatanggap ng customer ang welcome email pagkatapos mag-sign up
- [ ] Nagagawa ang bagong sityo gamit ang tamang hulmahan
...
- [ ] Gumagamit ang lahat ng system email ng FitSite branding at wikang partikular sa fitness
...
- [ ] Naka-configure at nasubukan ang welcome email sequence
...
- [ ] Natukoy at naidokumento ang refund policy
- [ ] Naka-set up ang business entity para sa pagtanggap ng mga bayad
...
- Tapat na feedback sa karanasan sa pag-sign up at onboarding
- Pahintulot na gamitin ang kanilang sityo bilang showcase example
- Pag-uulat ng anumang bug o isyung mararanasan nila
...
- Ilipat ang payment gateway sa live mode
- I-publish ang iyong sityong pang-marketing
...
1. **Lumipat sa live payments** -- i-disable ang test mode sa iyong payment gateway
2. **Tiyakin muli ng isa pang beses** -- gumawa ng kumpletong test signup gamit ang totoong bayad (i-refund ang sarili mo pagkatapos)
3. **Mag-monitor nang mabuti** -- bantayan ang mga error, nabigong signup, o isyu sa bayad
...
- **Mga isyu sa payment gateway**: Ihanda ang support contact ng iyong gateway provider
- **Mga problema sa SSL certificate**: Alamin kung paano mag-check at mag-renew ng certificates
- **Mga pagkabigo sa paghahatid ng email**: Subukan kung talagang dumarating ang mga email (tingnan ang mga spam folder)
...
- **Mga pamamaraan sa araw ng paglulunsad** upang mag-live nang may kumpiyansa
- **Isang contingency plan** para sa karaniwang mga isyu sa araw ng paglulunsad

---

**Susunod:** [Aralin 11: Paghahanap ng mga Customer](lesson-11-customers) -- ngayong live na ang FitSite, paano mo mahihikayat ang mga may-ari ng fitness studio na mag-sign up?
