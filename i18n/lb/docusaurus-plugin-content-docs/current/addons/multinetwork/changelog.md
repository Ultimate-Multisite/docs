---
title: Multi-Netzwierk Ännerungsprotokoll
sidebar_position: 99
...
* Nei: Klone vu Network-Medien — Site-Medie ginn korrekt duplizéiert, wann Networks vun enger Schabloun gekloont ginn.
* Fix: Network-Klonen funktionéiert elo ouni de Multi-Tenancy-Addon; Super-Admin-Rechter ginn nom Klonen nees zougewisen.
* Fix: Network-Erstellung ass elo kompatibel mat WooCommerce an all Bezuel-Gateways.
* Fix: Portnummer ass elo an der Generéierung vun der Fallback-Domain abegraff.
* Fix: CSS vum Schabloune-Picker gouf an en enqueued Stylesheet verluecht, fir korrekt Rendering op allen Themes.
