---
title: Inhalts-Synchronisatioun Ännerungsprotokoll
sidebar_position: 99
...
* Nei: Virauswiel vum Kand-Site fir Schabloun-Siten
* Nei: Medienextraktioun aus post_content fir all Bäitragstypen
* Nei: Synchroniséiere vun Taxonomien (Kategorien, Tags, personaliséiert Taxonomien)
* Geännert: Ëmbenannt vun "Elementor Template Sync" op "Content Sync"
...
* Vollstänneg Mediensynchroniséierung mat automatescher ID-Neizouuerdnung
* Astellungsintegratioun mat Ultimate Multisite
* Ënnerstëtzung fir Site-Ausgrenzung iwwer Netzwierk-Astellungen
* Läschen vum Elementor-Cache no der Synchroniséierung
* Erhale vun der Schabloun-Taxonomie
