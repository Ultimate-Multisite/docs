...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Recommandéiert fir Fotoen |
| **PNG** | `.png` | Ënnerstëtzt Transparenz |
...
- **Faarfpalett** — dominant Faarwe ginn extrahéiert an am Theme benotzt
- **Visuelle Stil** — modern, rustikal, minimalistesch, lieweg, asw.
- **Stëmmung an Atmosphär** — professionell, kreativ, frëndlech, luxuriéis, asw.
...
- **Moodboards** — Sammlunge vu Biller, déi Är gewënscht Ästhetik representéieren
- **Produktfotoen** — wann Dir Produkter hutt, déi Dir weise wëllt
...
- **Textlaaschteg Biller** — Screenshots mat vill Text
...
3. **Bréngt Varietéit eran** — Mëschung vu Faarf, Stil a Sujet
...
- **Faarfpalett** — primär, sekundär an Akzentfaarwen
- **Typografie** — Schrëftfamillje fir Iwwerschrëften a Kierpertext
- **Layout-Stil** — Ofstänn, Ausriichtung an Uerdnung vu Komponenten
...
1. Iwwerpréift déi generéiert Designrichtung
2. Gitt Feedback oder frot Upassungen un
...
- [Tools a Konfiguratioun](./tools.md) — verfügbar Tools a Konfiguratiounsoptiounen
