---
title: 'Lektioun 8: Aféierung vu Clienten'
sidebar_position: 9
...
- Sech aloggt an eng Säit gesäit, déi scho wéi eng Fitness-Websäit ausgesäit → bleift
- Genee weess, wat en als Nächst maache soll → bleift
- Sech an engem generesche WordPress Dashboard verluer fillt → geet fort
...
1. **Füügt Äre Studionumm an Äre Logo derbäi** -- Link op de Customizer oder d'Site Identity-Astellungen
2. **Aktualiséiert Äre Coursplang** -- Link direkt op den Editeur vun der Cours-Säit
3. **Füügt Är Trainer derbäi** -- Link op den Editeur vun der Trainer-Säit
4. **Setzt Är Kontaktdetailer** -- Link op den Editeur vun der Kontakt-Säit
5. **Kuckt eng Virschau vun Ärer Säit** -- Link op de Frontend
...
- Menüpunkten ze verstoppen, déi net relevant fir d'Gestioun vun enger Fitness-Säit sinn (z. B. Kommentaren, wann net benotzt)
- De Menü nei ze uerdnen, fir déi meescht benotzt Elementer no vir ze setzen
- Personaliséiert Menü-Beschrëftungen derbäizesetzen, déi fir d'Nisch Sënn maachen ("Äre Studio" amplaz vun "Ausgesinn")
...
- "De Logo an d'Faarwe vun Ärem Studio änneren"
- "Ären eegene Domain-Numm verbannen" (fir Growth/Pro-Clienten)
- "E Buchungs-Widget op Är Säit derbäisetzen"
...
- Éischte Login an Orientéierung
- D'Startsäit änneren
- De Coursplang aktualiséieren
- En neien Trainer derbäisetzen
...
- Hire aktuellen FitSite-Plang ze weisen
- Upgrade-Optiounen mat fitness-spezifesche Virdeeler unzeweisen
...
- **Aktivéierungsquote**: Wéi ee Prozentsaz vun den Umeldungen personaliséiert hir Säit tatsächlech bannent der éischter Woch?
- **Loginnen an der éischter Woch**: Wéi oft loggt sech en neie Client an der éischter Woch an?
...
├── Ultimate Multisite (konfiguréiert + gebrandt)
├── Plattform-Domain (fitsite.com + wildcard SSL)
├── Säit-Schablounen (Studio Essential, Gym Pro, Fitness Chain)
├── Produkter (Starter, Growth, Pro + Order Bumps)
├── Checkout-Ablaf (nisch-spezifesch, getest)
├── Branding (Login, Dashboard, E-Mailen, Invoices, Marketing-Säit)
├── Client-Onboarding
│   ├── Séier-Start-Dashboard-Widget
│   ├── Vereinfachten Dashboard fir d'Gestioun vu Fitness-Säiten
│   ├── 4-E-Mail-Begréissungssequenz
│   ├── Nisch-spezifesch Knowledge Base
│   ├── Video-Duerchféierungen
│   └── Personaliséiert Account-Säit
...
- **Eng Begréissungs-E-Mail-Sequenz**, déi Clienten duerch hir éischt Woch féiert
- **Nisch-spezifesch Hëllefsressourcen**, geschriwwe fir net-technesch Fitnessstudio-Besëtzer
- **Onboarding-Metriken**, fir d'Erfarung ze verfollegen an ze verbesseren

---

**Weider:** [Lektioun 9: Präisser fir Profit](lesson-9-pricing) -- mir verfeineren d'Präisstrategie, fir d'Recetten ze maximéieren an d'Churn ze minimiséieren.
