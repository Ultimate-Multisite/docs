...
- [ ] Domain-Mapping funktionéiert -- test d'Erstelle vun enger Websäit an d'Mappe vun enger personaliséierter Domain
...
- [ ] All Biller si richteg lizenzéiert (keng Stockfoto-Waasserzeechen)
- [ ] Mobil Responsivitéit funktionéiert op all Schabloune-Säit
...
- [ ] Präisser si korrekt (méintlech an jäerlech)
- [ ] Ariichtungsfraisen sinn op de richtege Pläng konfiguréiert
- [ ] Testperiod funktionéiert um Starter-Plang
...
- [ ] Bezuelung gëtt erfollegräich veraarbecht
- [ ] Client kritt eng Wëllkomm-E-Mail no der Umeldung
- [ ] Nei Websäit gëtt mat der korrekter Schabloun erstallt
...
- [ ] All System-E-Maile benotze FitSite-Branding a fitnessspezifesch Sprooch
...
- [ ] Wëllkomm-E-Mail-Sequenz ass konfiguréiert a getest
...
- [ ] Remboursementspolitik ass definéiert an dokumentéiert
- [ ] Geschäftsentitéit ass ageriicht, fir Bezuelungen ze kréien
...
- Éierleche Feedback zur Umeldungs- an Onboarding-Erfarung
- Erlaabnis, hir Websäit als Showcase-Beispill ze benotzen
- Melle vun all Bugs oder Problemer, op déi si stoussen
...
- Schalt de Bezuel-Gateway op Live-Modus
- Publizéiert Är Marketing-Websäit
...
1. **Op Live-Bezuelungen ëmschalten** -- deaktivéiert den Testmodus op Ärem Bezuel-Gateway
2. **Nach eng Kéier verifizéieren** -- maacht eng komplett Test-Umeldung mat enger richteger Bezuelung (rembourséiert Iech duerno selwer)
3. **Genee iwwerwaachen** -- passt op Feeler, feelgeschloen Umeldungen oder Bezuelproblemer op
...
- **Problemer mam Bezuel-Gateway**: Hutt de Support-Kontakt vun Ärem Gateway-Ubidder prett
- **SSL-Zertifikat-Problemer**: Wësst, wéi Dir Zertifikater kontrolléiert an erneiert
- **E-Mail-Liwwerfeeler**: Test, datt E-Mailen tatsächlech ukommen (Spam-Dossieren nokucken)
...
- **Prozedure fir de Startdag**, fir mat Vertrauen live ze goen
- **E Noutfallplang** fir heefeg Problemer um Startdag

---

**Nächst:** [Lektioun 11: Clientë fannen](lesson-11-customers) -- elo wou FitSite live ass, wéi bréngt Dir Besëtzer vu Fitnessstudioen dozou, sech unzemellen?
