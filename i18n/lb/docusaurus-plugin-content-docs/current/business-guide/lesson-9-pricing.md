---
title: 'Lektioun 9: Präisgestaltung fir Gewënn'
sidebar_position: 10
...
- Eng professionell Fitness-Websäit, déi $2,000-$5,000 kaschte géif, fir se individuell ze bauen
- Lafend Ënnerhalt, Updates a Sécherheet, iwwer déi si sech keng Gedanke musse maachen
- Nisch-spezifesch Funktiounen, déi generesch Builder net ubidden
- D'Gleewierdegkeet vun enger Plattform, déi fir hir Industrie gebaut ass
...
- **E Webentwéckler astellen**: $2,000-$5,000 am Viraus + $50-$100/Mount Ënnerhalt
- **Wix/Squarespace**: $16-$45/Mount, awer keng fitness-spezifesch Funktiounen, si bauen et selwer
- **Näischt maachen**: Verluer Memberen, déi si online net fannen
...
| Plang | Mountlech | Jäerlech (pro Mount) | Joresgesamt | Erspuernis |
|------|---------|-------------------|--------------|---------|
...
- **Starter**: Keng Ariichtungsfrais (Barrièren fir den Entrée ewechhuelen)
- **Growth**: $99 Ariichtungsfrais (deckt d'Konfiguratioun vun enger eegener Domain an eng initial Consultatioun)
- **Pro**: $299 Ariichtungsfrais (deckt Multi-Standuert-Ariichtung an Onboarding-Uruff)
...
- **7 Deeg gratis Testperiod** nëmmen am Starter-Plang
- Keng Testperiod bei Growth a Pro (dës Clientë si méi engagéiert an erwaarden ze bezuelen)
...
- **FITLAUNCH** -- 30% Rabatt op déi éischt 3 Méint (fir d'Launch-Promotioun)
- **ANNUAL20** -- 20% Rabatt op Jorespläng (wann net schonn erofgesat)
- **REFERRAL** -- 1 Mount gratis (fir Clientsempfeelungen)

Navigéier op **Ultimate Multisite > Discount Codes**, fir dës ze erstellen. Kuck [Rabattcoden erstellen](/user-guide/configuration/creating-discount-codes) fir de komplette Guide.
...
1. Konfiguréier Steiersätz an **Ultimate Multisite > Settings > Taxes**
2. Gëff dengen Pläng Steierkategorien
3. Stell sécher, datt Rechnungen d'Steier korrekt weisen
...
- **Konversiounsquot pro Plang**: Wann Starter gutt konvertéiert, awer Growth net, kéint d'Lück tëscht hinnen ze grouss sinn
- **Upgrade-Quot**: Wann nëmme wéineg Clienten vun Starter op Growth upgraden, bitt de Growth-Plang vläicht net genuch zousätzleche Wäert
...
- **Eng Testperiod** um Entrées-Plan, fir d'Hürden beim Umellen ze reduzéieren
- **Strategesch Rabattcoden** fir Launch, Referrals a Campagnen
- **Steierkonfiguratioun** fir konform Rechnungstellung
- **E Kader fir Präisiwwerpréiwung** fir lafend Optimiséierung

---

**Nächst:** [Lektioun 10: Startdag](lesson-10-launch) -- d'Checklëscht virum Start an d'Live-Schalten.
