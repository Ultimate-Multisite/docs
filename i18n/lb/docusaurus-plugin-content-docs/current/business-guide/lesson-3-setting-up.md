...
## Däin Hosting auswielen {#choosing-your-hosting}
...
### Op wat s du oppasse solls {#what-to-look-for}
...
### Recommandéiert Approche {#recommended-approach}
...
## WordPress Multisite installéieren {#installing-wordpress-multisite}
...
## Ultimate Multisite installéieren {#installing-ultimate-multisite}
...
## Fir d’Fitness-Nisch konfiguréieren {#configuring-for-the-fitness-niche}

Nodeems Ultimate Multisite installéiert ass, maach dës nisch-spezifesch Konfiguratiounswielen:

### Allgemeng Astellungen {#general-settings}
...
### E-Mail-Konfiguratioun {#email-configuration}
...
### Domain-Konfiguratioun {#domain-configuration}
...
## D’FitSite-Netzwierk bis elo {#the-fitsite-network-so-far}
