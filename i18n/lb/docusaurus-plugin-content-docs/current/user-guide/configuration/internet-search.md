...
## Internet Such aktivieren {#enabling-internet-search}
...
### Brave Search API-Schlüssel erhalte {#obtaining-a-brave-search-api-key}
...
### Nutzigsbeschränkige {#usage-limits}
...
### Gebruiksbeperkingen {#usage-limits-1}
...
## Internetzoek uitschakelen {#disabling-internet-search}
