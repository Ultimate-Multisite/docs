...
## Deine API-Credentials erhalte

### 1. Erstelle en API-Token
...
### 2. Holen Sie sich Ihre Organization ID
...
### 3. Holen Sie sich Ihre Server ID
...
## Zuesätzlichi WordPress Konfiguration
...
## Problembehealdigkeet (Troubleshooting)

### API-Verbindungssprobleme
...
### Häufigi Endpunkte, wo brucht wärde
...
### Vollständigi API Dokumentation
