---
title: Verständnis vom Dashboard
sidebar_position: 7
...
Das Widget berichtet über Ereignis uf Ultimate Multisite. Ereignis umfasse Registrierige, Abmeldige, Site-Erstellige, Löschige und anderi Aktivitäte.
...
D'Datumsspeicher regle d'Ziitruum vum Informatione, déi vun de Widgets direkt unde gfüelet ginn, inklusiv Iikomme, neui Mitmember, Ufschrei nach Land, Ufschrei nach Form und am me bséngte Site.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
Um de Widget **Most Visited Sites** z'funktione laassen, aktiveret d'Besichtungszähtung (visit counting) i **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
