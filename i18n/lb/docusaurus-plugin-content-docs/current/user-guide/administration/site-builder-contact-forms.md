...
## Ein Kontaktformular erstellen {#creating-a-contact-form}
...
## Verwendung vom generierte Shortcode {#using-the-generated-shortcode}
...
## Kontaktformular personalisiere {#customizing-the-contact-form}

Nachdem de Site Builder s'Kontaktformular erstellt het, chönd Dir es wiiter personalisiere:

### Über d'Chat-Schnittstell {#via-the-chat-interface}
...
### Über d'Admin-Schnittstell vom Formular-Plugin {#via-the-form-plugins-admin-interface}
...
## E-Mail-Benachrichtigunge {#email-notifications}
