...
### Feedback-Sammlung deaktivéieren
...
## Google Calendar Konfiguratioun
...
### Zougrëff op Funktiouns-Flags

1. Am WordPress-Admin, gitt op **Gratis AI Agent → Astellungen**.
2. Klickt op den Tab **Funktiouns-Flags**.

### Zougrëffskontroll-Flags
...
### Automatiséierungs-Sécherheets-Flags
