---
title: Management vo System E-Mails
sidebar_position: 13
...
Dort chasch du zur Seite **System Emails** goh, um alli E-Mail-Vorlagene z'gseh.

![System Emails list](/img/admin/system-emails-list.png)

Du chasch au einzelni E-Mail-Vorlagene mit em System-E-Mail-Editor bearbeite:
...
Um neui E-Mail-Vorlagene z'importiere:

1. Geh zur Seite **System Emails**
2. Klick uf de Knopf **Reset & Import** obe uf de Site
...
1. **Lösche und neu importiere** — Lösch d'System-E-Mail und importier si no mal (das löscht d'Versandstatistike)
2. **Über s'Tool zurücksetze** — Bruuch s'Tool **Reset & Import**, schalte d'Option **Reset** i und wähl die E-Mails us, wo du zurücksetze wetsch

D'Reset-Option isch bevorzugt, will si d'Versandstatistike und anderi Metadate behaltet, während de Standardinhalt wiederhergstellt wird.
