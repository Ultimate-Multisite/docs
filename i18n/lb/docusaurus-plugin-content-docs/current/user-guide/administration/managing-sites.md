...
- **Customer-owned** — Sites, wo zu bestimmte Kunde ghören
...
- **Site Title** — De Name vo de neue Site
- **Site URL** — D'Domain/de Pfad für d'Site
- **Site Type** — Ob es sich um e Customer Site, en Template oder e reguläri Site handelt
...
- **Visit limits** — Maximali Anzahl vo Site-Besüech
- **User account limits** — Grenze pro Benutzerrolle
- **Disk space** — Speicherquot für d'Site
- **Custom domain** — Domain-Mapping für die Site aktivieren
- **Plugin and theme visibility** — Kontrolliere, weli Plugins und Themes sichtbar, versteckt oder voraktiviert sind
...
- **Mapt Domaines** déi mit der Site verknäppt sinn
...
- **D'Site aktiveren/deaktivieren** mit eme Umschalter-Button
- **De Site-Typ ändere** oder d'Eigentümschaft neu zuefen
- **E Site-Bild/Thumbnail setzen** (wird am Frontend fir Site-Templates gpauscht)
- **D'Site permanent löschen**

:::warning
D'Löschung vun ere Site ass irreversibel. D'Site a all hir Inhalt wësen permanent entfernt.
:::
