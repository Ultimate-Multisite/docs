...
|------|------|-------------|
| $notices | `array` | Lëscht vun Noticë fir dee bestëmmte Panel. |
| $all_notices | `array` | Lëscht vun derbäigesaten Noticen, no Panel getrennt. |
| $panel | `string` | Panel, fir d'Noticen ofzeruffen. |
