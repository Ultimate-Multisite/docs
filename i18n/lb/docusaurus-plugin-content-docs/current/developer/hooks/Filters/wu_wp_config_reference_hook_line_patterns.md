...
Mir kontrolléieren op dräi Musteren, wa mir versichen erauszefannen, wou mir eis Konstanten asetze kënnen:
...
Definéiert an [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) an der Zeil 143
