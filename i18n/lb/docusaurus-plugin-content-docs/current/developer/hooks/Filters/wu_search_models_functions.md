...
Erlaabt plugin-Entwéckler, méi Sichmodell-Funktiounen derbäizesetzen.
...
Definéiert an [`inc/class-ajax.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/class-ajax.php#L244) an der Zeil 244
