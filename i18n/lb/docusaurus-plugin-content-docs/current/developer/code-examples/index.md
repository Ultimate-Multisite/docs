---
title: Fortgeschratt Code-Beispiller
sidebar_position: 1
...
Zwou gläichzäiteg Ufroe kënnen dee selwechte Wäert liesen an allebéid dat selwecht erhéicht Resultat zeréckschreiwen, wouduerch ee Grof verluer geet. `increment_item()` delegéiert d'Arithmetik un d'Datebank-Engine mat enger eenzeger `UPDATE ... SET column = column + ?`-Uweisung, wouduerch d'Operatioun u sech atomar ass.
