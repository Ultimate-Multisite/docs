---
title: Ярашлы endpointлар өчен Ultimate AI Connector үзгәрешләр журналы
sidebar_position: 99
...
* Төзәтү: Яңа provider карточкасы хәзер өстәгәндә автоматик рәвештә җәелә; plugin яңартылганда script cache busting.
* Төзәтү: `eval()` өчен динамик provider class namespace һәм яңа өстәлгән providerлар өчен автоматик җәелү тәртибе.
* Төзәтү: WordPress 6.9+ яраклылыгы өчен тотрыклы Card/CardBody/CardHeader/CardDivider компонентларын куллана (инде эксперименталь түгел).
* Төзәтү: Providerны drag-to-reorder өчен билгеләнмәгән DragHandle unicode grip иконасы белән алыштырылды.
