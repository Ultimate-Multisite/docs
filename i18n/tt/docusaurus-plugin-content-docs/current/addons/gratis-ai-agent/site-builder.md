...
---
# Сайт төзү оркестрациясе v2 {#site-builder-orchestration-v2}
...
### 2. Плагиннарны табу {#2-plugin-discovery}
...
### 3. Планны башкару {#3-plan-execution}
...
### 4. Барышны күзәтү {#4-progress-tracking}
...
### 5. Хаталардан торгызу {#5-error-recovery}
...
## Сайт планы мөмкинлекләре {#site-plan-abilities}
...
## v1 һәм v2 чагыштыру {#comparing-v1-and-v2}
...
## WP-CLI план командалары {#wp-cli-plan-commands}
