...
---
# Сайт Билдер Режима Удаление Уведомление
...
## Если Вы использовали режим Site Builder
...
### Перейдите на Setup Assistant agent
...
## Сравнение: Site Builder против Setup Assistant
...
## Миграция на Setup Assistant agent
...
### Мой существующий сайт из Site Builder не работает
...
### Могу ли я все еще использовать мои старые шаблоны Site Builder?
