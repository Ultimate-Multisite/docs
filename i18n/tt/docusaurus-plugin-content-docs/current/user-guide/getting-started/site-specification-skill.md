---
title: Веб-сайт специifikasi becerisi
sidebar_position: 18
...
- **Цели сайта**: Что делает ваш сайт и зачем он существует
- **Целевая аудитория**: Кто посещает ваш сайт и что им нужно
- **Фирменный стиль (Brand identity)**: Ваши цвета, тон общения и визуальный стиль
...
- Предложения функций, соответствующих целям вашего сайта
- Рекомендации структур контента, которые соответствуют вашим целям
...
- Интернет-магазин (E-commerce store)
- Блог или сайт с контентом
- Портфолио или демонстрация работ
- SaaS-приложение
...
- Основной цвет: [выбор цвета или шестнадцатеричный код]
- Вторичный цвет: [выбор цвета или шестнадцатеричный код]
- Акцентный цвет: [необязательно]

Как бы вы описали тон вашего бренда?
- Профессиональный / корпоративный
- Креативный / артистичный
- Игривый / непринужденный
...
Какой ваш основной показатель успеха (метрика)?
- Доход
...
- Плоская структура (весь контент на одном уровне)
- Иерархическая (категории и подкатегории)
- Хронологическая (в стиле блога)
- Основанная на продуктах (каталог)
- Другое: [опишите]
...
- Yeni bir kitleye geçtiğinizde
- Yeni ürün grupları eklediğinizde
...
- "Kaliteyi fiyattan daha çok önemseyen profesyonelleri hedefliyoruz"
...
- Ajanı "site brief'imi geri çağır" diye sorun
- Ayarlarınızda belleğin etkinleştirilip edilmediğini kontrol edin

**Я хочу начать заново с новым site\_brief**
- Спросите агента: "Очистить мой site brief и начать с чистого листа"
