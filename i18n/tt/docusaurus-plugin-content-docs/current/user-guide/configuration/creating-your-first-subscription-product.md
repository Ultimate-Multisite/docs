...
## Продуктлар Әтирү (Adding Products)
...
### Hisob-kitob sikllari (Billing Cycles)
...
#### Fiyat Değişiklikleri (Price Variations)
...
Вкладка **Taxes** (Налоги) соответствует настройкам налогов, указанным в **Ultimate Multisite > Settings > Taxes** и более конкретно определенным ставкам налогов. Чтобы включить налоги и определить применимые ставки налогов, пожалуйста, ознакомьтесь с документацией по [Ultimate Multisite: Settings](ultimate-multisite-settings).
...
#### Сайт Шаблондары (Site Templates)
