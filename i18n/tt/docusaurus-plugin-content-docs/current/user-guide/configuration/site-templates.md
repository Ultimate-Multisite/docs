...
---
# Сайт Шаблоны (v2) {#site-templates-v2}
...
## Что такое Site Template? {#what-is-a-site-template}
...
## Создание и редактирование нового Site Template {#creating-and-editing-a-new-site-template}
...
### Сайт шаблонының мазмунын өзгөртү {#customizing-the-contents-of-a-site-template}
...
### Өчрү опцияләр {#advanced-options}
...
### Сайт шаблонларын куллану {#using-site-templates}
...
#### Мод 1: Сайт шаблонын тағзам (Assign Site Template) {#mode-1-assign-site-template}
...
#### Режим 2: Мөмкин булган Сайт Шаблонын танлогы {#mode-2-choose-available-site-template}
...
### Дефолт режим: Checkout форматындагы сайт шаблонунун тандоосу {#default-mode-site-template-selection-on-the-checkout-form}
...
### Сайт Шаблоны Варианты {#site-template-options}
...
## Предварительное заполнение сайтов-шаблонов с помощью автозамены и поиска {#pre-populating-site-templates-with-auto-search-and-replace}
