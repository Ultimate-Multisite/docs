...
---
# Тема Создатель Возможностей: Шаблон и Активация Блочных Тем {#theme-builder-abilities-scaffold-and-activate-block-themes}
...
## Создание Блочного Шаблона (Scaffold Block Theme) {#scaffold-block-theme}
...
### Как вызвать (Invoke) {#how-to-invoke}
...
### Ожидаемый результат (Expected Output) {#expected-output}
...
## Активация Темы (Activate Theme) {#activate-theme}
...
## İş Akışı: Oluşturma ve Etkinleştirme {#workflow-scaffold-and-activate}
