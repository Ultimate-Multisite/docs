...
---
# Суверен Миграция Проверка {#sovereign-migration-verification}
...
## Распространенные сбои {#common-failures}
...
### Асинх очередь пуша не очищается (drain) {#async-push-queue-does-not-drain}
