...
---
# Переход в режим сторонних возможностей
...
### Auto Mode (Новый режим по умолчанию)
...
## Taşıma Yolu (Migration Path)

### Eğer WordPress 6.x kullanıyorsanız
...
### Eğer WordPress 7.0+ kullanıyorsanız
...
### Auto modunda yetenekler yüklenmiyor
...
### Мои пользовательские способности не отображаются
...
### Я получаю уведомления о «неклассифицированной способности»
...
### Временная шкала вывода из эксплуатации (Deprecation Timeline)
...
### Для пользовательских способностей
