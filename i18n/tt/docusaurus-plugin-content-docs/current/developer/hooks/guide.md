---
title: Хукларны куллану буенча кулланма
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks куллану кулланмасы {#hooks-usage-guide}

Ultimate Multisite 200+ гамәл hook һәм 280+ filter hook тәкъдим итә. Бу бит иң еш кулланыла торган hooks-ларны гамәли мисаллар белән аңлата. Тулы автоматик рәвештә ясалган белешмәлек өчен, бу бүлектәге башка битләрне карагыз.

## Action Hooks {#action-hooks}

### Клиентның яшәү циклы {#customer-lifecycle}

#### Клиент булдырылганнан соң {#after-customer-creation}
...
#### Клиент статусы үзгәрү {#customer-status-change}
...
#### Сайт бастырылганнан соң {#after-site-published}
...
#### Калып кулланылганчы {#before-template-application}
...
### Әгъзалык Hooks {#membership-hooks}

#### Статус күчешләре {#status-transitions}
...
### Түләү Hooks {#payment-hooks}

#### Түләү тәмамланды / уңышсыз булды {#payment-completed--failed}
...
#### Эшкәртү алдыннан / тәмамланганнан соң {#before-processing--after-completion}
...
### Бәя билгеләү фильтрлары {#pricing-filters}

#### Кәрзиннең гомуми суммасы {#cart-total}
...
### Калып фильтрлары {#template-filters}
...
### Чикләү фильтрлары {#limitation-filters}
...
### Gateway фильтрлары {#gateway-filters}
...
### Checkout форма кырлары {#checkout-form-fields}
