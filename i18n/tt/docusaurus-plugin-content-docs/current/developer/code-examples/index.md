...
## BerlinDB атомар санагычы `increment_item()` белән
...
### API куллануын әгъзалык буенча күзәтү
...
### Нигә `update_item()` урынына `increment_item()`
