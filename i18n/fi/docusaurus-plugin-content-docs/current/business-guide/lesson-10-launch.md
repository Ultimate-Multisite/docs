---
title: 'Oppitunti 10: Julkaisupäivä'
sidebar_position: 11
...
- [ ] Verkkotunnuksen yhdistäminen toimii -- testaa sivuston luominen ja mukautetun verkkotunnuksen yhdistäminen
...
- [ ] Kaikilla kuvilla on asianmukaiset lisenssit (ei kuvapankkikuvien vesileimoja)
- [ ] Mobiiliresponsiivisuus toimii jokaisella mallisivulla
...
- [ ] Hinnoittelu on oikein (kuukausittainen ja vuosittainen)
- [ ] Käyttöönottomaksut on määritetty oikeisiin paketteihin
- [ ] Kokeilujakso toimii Starter-paketissa
...
- [ ] Asiakas saa tervetulosähköpostin rekisteröitymisen jälkeen
- [ ] Uusi sivusto luodaan oikealla mallilla
...
- [ ] Kaikki järjestelmäsähköpostit käyttävät FitSite-brändäystä ja kuntoilualalle sopivaa kieltä
...
- [ ] Tervetulosähköpostien sarja on määritetty ja testattu
...
- [ ] Hyvityskäytäntö on määritetty ja dokumentoitu
- [ ] Yritysmuoto on perustettu maksujen vastaanottamista varten
...
- Rehellinen palaute rekisteröitymis- ja käyttöönottokokemuksesta
- Lupa käyttää heidän sivustoaan esimerkkiesittelynä
- He raportoivat havaitsemistaan virheistä tai ongelmista
...
- Vaihda maksuyhdyskäytävä live-tilaan
- Julkaise markkinointisivustosi
...
1. **Vaihda live-maksuihin** -- poista testitila käytöstä maksuyhdyskäytävässäsi
2. **Varmista vielä kerran** -- tee täydellinen testirekisteröityminen oikealla maksulla (hyvitä maksu itsellesi sen jälkeen)
3. **Seuraa tarkasti** -- tarkkaile virheitä, epäonnistuneita rekisteröitymisiä tai maksuongelmia
...
- **Maksuyhdyskäytävän ongelmat**: Pidä yhdyskäytäväpalveluntarjoajasi tukiyhteystiedot valmiina
- **SSL-varmenneongelmat**: Tiedä, miten varmenteet tarkistetaan ja uusitaan
- **Sähköpostin toimitusvirheet**: Testaa, että sähköpostit todella saapuvat perille (tarkista roskapostikansiot)
...
- **Julkaisupäivän menettelyt**, joiden avulla voit julkaista luottavaisin mielin
- **Varasuunnitelma** yleisiä julkaisupäivän ongelmia varten

---

**Seuraavaksi:** [Oppitunti 11: Asiakkaiden löytäminen](lesson-11-customers) -- nyt kun FitSite on live-tilassa, miten saat kuntosaliyrittäjät rekisteröitymään?
