---
title: 'Oppitunti 9: Kannattava hinnoittelu'
sidebar_position: 10
...
- Ammattimaisen fitness-verkkosivuston, jonka räätälöity rakentaminen maksaisi $2,000-$5,000
- Jatkuvaa ylläpitoa, päivityksiä ja tietoturvaa, joita heidän ei tarvitse miettiä
- Niche-kohtaisia ominaisuuksia, joita yleiset rakentajat eivät tarjoa
- Heidän toimialaansa varten rakennetun alustan uskottavuutta
...
- **Web-kehittäjän palkkaaminen**: $2,000-$5,000 etukäteen + $50-$100/kk ylläpito
- **Wix/Squarespace**: $16-$45/kk, mutta ei fitness-kohtaisia ominaisuuksia, ja he rakentavat sen itse
- **Ei tehdä mitään**: Menetetyt jäsenet, jotka eivät löydä heitä verkosta
...
| Paketti | Kuukausittain | Vuosittain (kuukaudessa) | Vuosihinta yhteensä | Säästö |
|------|---------|-------------------|--------------|---------|
| Starter | $49/kk | $39/kk | $468/vuosi | 20% alennus |
| Growth | $99/kk | $79/kk | $948/vuosi | 20% alennus |
| Pro | $199/kk | $159/kk | $1,908/vuosi | 20% alennus |
...
- **Starter**: Ei käyttöönottomaksua (poistaa aloituksen esteitä)
- **Growth**: $99 käyttöönottomaksu (kattaa mukautetun domainin määrityksen ja alustavan konsultoinnin)
- **Pro**: $299 käyttöönottomaksu (kattaa usean toimipisteen käyttöönoton ja perehdytyspuhelun)
...
- **7 päivän ilmainen kokeilu** vain Starter-paketissa
- Ei kokeilua Growth- ja Pro-paketeissa (nämä asiakkaat ovat sitoutuneempia ja odottavat maksavansa)
...
- **FITLAUNCH** -- 30% alennus ensimmäisistä 3 kuukaudesta (julkaisukampanjaan)
- **ANNUAL20** -- 20% alennus vuosipaketeista (jos niitä ei ole jo alennettu)
- **REFERRAL** -- 1 kuukausi ilmaiseksi (asiakassuositteluihin)

Siirry kohtaan **Ultimate Multisite > Alennuskoodit** luodaksesi nämä. Katso koko opas kohdasta [Alennuskoodien luominen](/user-guide/configuration/creating-discount-codes).
...
1. Määritä verokannat kohdassa **Ultimate Multisite > Asetukset > Verot**
2. Liitä veroluokat paketteihisi
3. Varmista, että laskut näyttävät verot oikein
...
- **Konversioaste paketeittain**: Jos Starter konvertoi hyvin mutta Growth ei, niiden välinen ero voi olla liian suuri
- **Päivitysaste**: Jos harva asiakas päivittää Starterista Growthiin, Growth-paketti ei ehkä tarjoa tarpeeksi lisäarvoa
...
- **Kokeilujakso** aloitustason paketissa rekisteröitymiskynnyksen madaltamiseksi
- **Strategiset alennuskoodit** julkaisua, suositteluja ja kampanjoita varten
- **Veromääritys** vaatimustenmukaista laskutusta varten
- **Hinnoittelun arviointikehys** jatkuvaa optimointia varten

---

**Seuraavaksi:** [Oppitunti 10: Julkaisupäivä](lesson-10-launch) -- julkaisua edeltävä tarkistuslista ja julkaisu.
