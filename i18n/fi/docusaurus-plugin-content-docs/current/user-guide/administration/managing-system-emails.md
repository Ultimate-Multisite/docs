---
title: Järjestelmän sähköpostien hallinta
sidebar_position: 13
...
![Asetukset - Sähköpostit-välilehti](/img/admin/settings-emails.png)

Sieltä pääset käsiksi **Järjestelmän sähköpostien** sivulle nähdäksesi kaikki sähköpostimalottit.

![Järjestelmän sähköpostilista](/img/admin/system-emails-list.png)

Voit myös muokata yksittäisiä sähköpostimalotteja käyttämällä järjestelmän sähköpostieditoria:
...
1. Siirry **Järjestelmän sähköpostit** -sivulle
2. Napsauta sivun yläreunassa olevaa **Nollaa ja tuo sisään (Reset & Import)** -painiketta
...
1. **Poista ja tuo sisään uudelleen** — Poista järjestelmän sähköposti ja tuo se takaisin (tämä poistaa lähetysmittarit)
2. **Nollaa työkalun avulla** — Käytä **Nollaa ja tuo sisään (Reset & Import)** -työkalua, vaihda **Nollaa (Reset)**-vaihtoehto ja valitse sähköpostit, joita haluat nollata

Nollausvaihtoehto on suositeltavin, koska se säilyttää lähetysmittarit ja muut metatiedot palauttaessaan oletussisältöä.
