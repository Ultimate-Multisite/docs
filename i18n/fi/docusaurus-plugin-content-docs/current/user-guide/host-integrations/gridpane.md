...
### 1. Hae GridPane-API-tunnisteesi {#1-get-your-gridpane-api-credentials}
...
### 2. Hae palvelimen ja sivuston ID:t {#2-get-your-server-and-site-ids}
...
### 3. Lisää vakiot wp-config.php:ään {#3-add-constants-to-wp-configphp}
...
### 4. Aktivoi integrointi {#4-enable-the-integration}
...
## SUNRISE-vakion hallinta {#sunrise-constant-management}
...
### Verkkotunnuksen ei lisätty {#domain-not-added}
