...
## Internet Hakuominaisuuden Aktivoiminen {#enabling-internet-search}
...
### Brave Search API-avaimen hankkiminen {#obtaining-a-brave-search-api-key}
...
### Tavily API-avaimen hankkiminen {#obtaining-a-tavily-api-key}
...
## Internet-haun poistaminen {#disabling-internet-search}
