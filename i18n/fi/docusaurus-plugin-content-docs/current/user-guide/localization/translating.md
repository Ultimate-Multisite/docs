...
Tämä on standardi WordPress -yhteisön käännössystem. Kun käännökset saavuttavat riittävän hyväksymisrajan, ne levitetään automaattisesti kaikille Ultimate Multisite -käyttäjille WordPress plugin -päivitysten kautta.

**Tarvitsemme apua!** Jos puhut kieltä englannin selain kuin kieli, harkitse käännösten panostamista. Vaikka vain muutaman merkin kääntäminen auttaa. Aloittamiseksi:

1. Vieraile [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) -sivulla
2. Valitse kielen
3. Napsauta "Contribute Translation" (Panosta käännöstä)
4. Tarvitset ilmaisen WordPress.org -tilin
...
1. Lataa Poedit [poedit.net](https://poedit.net) -sivulta
2. Avaa `.pot`-tiedoston sijainnista `wp-content/plugins/ultimate-multisite/lang/`
3. Käännä merkit Poeditin käyttöliittymässä
