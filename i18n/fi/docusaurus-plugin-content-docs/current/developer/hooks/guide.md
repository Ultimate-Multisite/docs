...
### Asiakkaan elinkaari {#customer-lifecycle}

#### Asiakkaan luonnin jälkeen {#after-customer-creation}
...
#### Asiakkaan tilan muutos {#customer-status-change}
...
### Sivuston hookit {#site-hooks}

#### Sivuston julkaisun jälkeen {#after-site-published}
...
#### Ennen mallipohjan käyttöönottoa {#before-template-application}
...
### Jäsenyyden hookit {#membership-hooks}

#### Tilan siirtymät {#status-transitions}
...
### Maksun hookit {#payment-hooks}

#### Maksu suoritettu / epäonnistunut {#payment-completed--failed}
...
### Checkout-hookit {#checkout-hooks}

#### Ennen käsittelyä / valmistumisen jälkeen {#before-processing--after-completion}
...
### Hinnoittelun suodattimet {#pricing-filters}

#### Ostoskorin kokonaissumma {#cart-total}
...
### Mallipohjan suodattimet {#template-filters}
...
### Rajoitusten suodattimet {#limitation-filters}
...
### Gateway-suodattimet {#gateway-filters}
...
### Checkout-lomakkeen kentät {#checkout-form-fields}
...
### Sähköpostin sisältö {#email-content}
