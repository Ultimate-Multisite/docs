...
#### Sau khi tạo khách hàng (After Customer Creation)
...
#### Thay đổi trạng thái khách hàng (Customer Status Change)
...
### Hooks cấp độ Website (Site Hooks)

#### Sau khi trang web được xuất bản (After Site Published)
...
#### Trước khi áp dụng template (Before Template Application)
...
### Hooks Tư cách thành viên (Membership Hooks)

#### Chuyển đổi trạng thái (Status Transitions)
...
### Hooks Thanh toán (Payment Hooks)

#### Thanh toán hoàn tất / Thất bại (Payment Completed / Failed)
...
### Hooks Thanh toán (Checkout Hooks)

#### Trước khi xử lý / Sau khi hoàn tất (Before Processing / After Completion)
...
### Bộ lọc Giá cả (Pricing Filters)

#### Tổng giỏ hàng (Cart Total)
...
### Bộ lọc Template (Template Filters)
...
### Bộ lọc Giới hạn (Limitation Filters)
...
### Bộ lọc Cổng thanh toán (Gateway Filters)
...
### Trường biểu mẫu Thanh toán (Checkout Form Fields)
