...
## Luồng khởi tạo tenant {#tenant-bootstrap-flow}
...
## SSO và REST hooks {#sso-and-rest-hooks}
...
## URL hành động của khách hàng độc lập {#sovereign-customer-action-urls}
...
## Xác minh di trú {#migration-verification}
...
## Bộ định tuyến cơ sở dữ liệu đã lỗi thời {#deprecated-database-router}
