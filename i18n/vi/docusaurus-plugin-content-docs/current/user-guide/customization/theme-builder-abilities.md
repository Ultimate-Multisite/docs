...
## Dựng Khung Chủ đề Block (Scaffold Block Theme)
...
## Kích hoạt Chủ đề (Activate Theme)
...
## Quy trình làm việc: Dựng Khung và Kích hoạt (Workflow: Scaffold and Activate)
...
## Token Thiết kế và Tùy chỉnh (Design Tokens and Customization)
