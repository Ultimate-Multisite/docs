...
---
# Di chuyển từ V1 {#migrating-from-v1}

## Ultimate Multisite đã chuyển từ dòng phiên bản 1.x ban đầu sang dòng phiên bản 2.x. {#ultimate-multisite-has-switched-from-its-original-1x-family-of-releases-to-the-2x-family-of-releases}
...
## Bây giờ, đến phần di chuyển {#now-the-migration}
