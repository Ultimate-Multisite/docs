...
## Khi nào trình hướng dẫn xuất hiện? {#when-does-the-wizard-appear}
...
## Bước 1: Chào mừng {#step-1-welcome}
...
## Bước 2: Cấu hình mạng lưới {#step-2-network-configuration}

Bước này yêu cầu bạn cấu hình các thiết lập cho mạng lưới.

### Cấu trúc site {#site-structure}
...
### Email quản trị mạng lưới {#network-admin-email}
...
## Bước 3: Cài đặt {#step-3-installation}
...
## Bước 4: Hoàn thành {#step-4-complete}
...
## Phương án cài đặt thủ công {#manual-setup-fallback}
...
### Trình hướng dẫn báo wp-config.php không thể ghi {#the-wizard-says-wp-configphp-is-not-writable}
...
### Không truy cập được các site sau khi cài đặt (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Lỗi xác thực sau khi cài đặt {#authentication-issues-after-setup}
...
### Một bước bị lỗi trong quá trình cài đặt {#a-step-failed-during-installation}
