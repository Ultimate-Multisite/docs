...
---
# Thông báo loại bỏ Site Builder Mode
...
### Site Builder Mode (Phiên bản cũ)
...
## Nếu bạn đang sử dụng Site Builder Mode

### Trang web của bạn vẫn an toàn
...
## Cách chuyển sang Setup Assistant Agent
...
## Lợi ích của Setup Assistant Agent
...
### Tôi không tìm thấy Site Builder mode
...
### Tôi muốn tái tạo một trang web từ Site Builder
...
### Trang web Site Builder hiện có của tôi không hoạt động
...
### Tôi có thể tiếp tục sử dụng các mẫu Site Builder cũ không?
