...
## Thiết lập thông số trang web là gì?
...
## Tại sao nên sử dụng Thiết lập thông số trang web?

### Tính nhất quán qua các phiên làm việc
...
## Khởi tạo Thiết lập thông số trang web

### Trong quá trình thiết lập Theme Builder
...
## Quy trình Thiết lập thông số trang web

### Bước 1: Mục đích trang web
...
## Xem và Cập nhật site_brief của bạn

### Xem site_brief của bạn
...
## Agent sử dụng site_brief như thế nào
...
## Mối quan hệ với Quy trình thiết lập Theme Builder
