...
---
# WordPress Multisite là gì? {#what-is-wordpress-multisite}
...
## WordPress Multisite chính xác là gì? {#what-exactly-is-wordpress-multisite}
...
## Subdomain hay Subdirectory? {#subdomain-or-subdirectory}
...
## Những gì được chia sẻ giữa các trang con và những gì không {#what-is-shared-among-subsites-and-what-is-not}
...
## Quản lý người dùng trên WordPress Multisite {#user-management-on-wordpress-multisite}
...
## Cân nhắc về hiệu suất {#performance-considerations}
