...
#### Subdomain và Subdirectory {#subdomain-vs-subdirectory}
...
#### Plugin và Theme {#plugins-and-themes}
...
#### Trường hợp 3: Hosting WordPress {#case-3-wordpress-web-hosting}
...
### Các cân nhắc về kiến trúc {#architecture-considerations}
...
#### Shared Hosting và Dedicated Hosting {#shared-vs-dedicated-hosting}
...
#### Script bên ngoài {#external-scripts}
...
#### Tên miền và SSL {#domain-and-ssl-1}
