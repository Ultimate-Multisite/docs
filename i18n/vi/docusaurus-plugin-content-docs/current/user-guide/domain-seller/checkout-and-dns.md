...
### URL trang được tạo tự động {#auto-generated-site-url}
...
### Hành vi tìm kiếm {#search-behaviour}
...
## Quản lý DNS của khách hàng {#customer-dns-management}
...
### Loại bản ghi được hỗ trợ {#supported-record-types}
...
### Những nhà cung cấp nào hỗ trợ quản lý DNS? {#which-providers-support-dns-management}
...
### Bản ghi DNS mặc định {#default-dns-records}
...
### Quản trị viên: xem và chỉnh sửa DNS {#admin-viewing-and-editing-dns}
