...
### Truy cập API {#api-access}
Bạn cần có quyền quản trị viên trên Enhance Control Panel để tạo token API.

## Lấy thông tin xác thực API {#getting-your-api-credentials}

### 1. Tạo Token API {#1-create-an-api-token}
...
### 2. Lấy Organization ID {#2-get-your-organization-id}
...
### 3. Lấy Server ID {#3-get-your-server-id}
...
### 4. Lấy URL API {#4-get-your-api-url}
...
### Thiết lập qua Trình hướng dẫn tích hợp {#setup-via-integration-wizard}
...
### Khi một tên miền bị xóa {#when-a-domain-is-removed}
...
### Kiểm tra DNS và SSL {#dns-and-ssl-checking}
...
### Sau khi ánh xạ tên miền {#after-mapping-a-domain}
...
### Các endpoint thường dùng {#common-endpoints-used}
...
### Tài liệu API đầy đủ {#full-api-documentation}
