...
### 1. Lấy thông tin đăng nhập API ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Lấy App ID {#2-get-your-app-id}
...
## Xác minh chứng chỉ SSL {#ssl-certificate-verification}
