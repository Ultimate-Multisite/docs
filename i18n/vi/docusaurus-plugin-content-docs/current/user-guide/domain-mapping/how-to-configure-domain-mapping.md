...
## Ánh xạ miền là gì? {#whats-domain-mapping}
...
### Cách thiết lập ánh xạ miền trên mạng Ultimate Multisite của bạn {#how-to-setup-domain-mapping-on-your-ultimate-multisite-network}
...
### Đảm bảo cài đặt DNS của miền được cấu hình đúng {#making-sure-the-domain-dns-settings-are-properly-configured}
...
### Ánh xạ tên miền tùy chỉnh với tư cách Quản trị viên cấp cao {#mapping-custom-domain-name-as-super-admin}
...
### Ánh xạ tên miền tùy chỉnh với tư cách người dùng trang con {#mapping-custom-domain-name-as-subsite-user}
...
### Về đồng bộ hóa tên miền {#about-domain-syncing}
