...
#### Tổng quan về trình chỉnh sửa Checkout Form
...
#### Bước 1: Thiết lập biến thể giá trên sản phẩm của bạn
...
#### Bước 2: Thêm trường Chọn kỳ vào biểu mẫu checkout của bạn
...
#### Chọn trước một kỳ thanh toán qua URL
...
### Miền cơ sở của biểu mẫu checkout
