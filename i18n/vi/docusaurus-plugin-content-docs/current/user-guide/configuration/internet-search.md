...
## Bật Tìm kiếm Internet {#enabling-internet-search}
...
### Cách lấy Khóa API Brave Search {#obtaining-a-brave-search-api-key}
...
### Cách lấy Khóa API Tavily {#obtaining-a-tavily-api-key}
...
## Tắt Tìm kiếm Internet {#disabling-internet-search}
