...
## Mẫu trang là gì? {#what-is-a-site-template}
...
## Tạo và chỉnh sửa một Mẫu trang mới {#creating-and-editing-a-new-site-template}
...
### Tùy chỉnh nội dung của một Mẫu trang {#customizing-the-contents-of-a-site-template}
...
### Sử dụng Mẫu trang {#using-site-templates}
...
#### Chế độ 1: Gán Mẫu trang {#mode-1-assign-site-template}
...
### Chế độ mặc định: lựa chọn mẫu trang trên biểu mẫu Thanh toán {#default-mode-site-template-selection-on-the-checkout-form}
...
### Tùy chọn mẫu site {#site-template-options}
...
#### Cho phép chuyển đổi mẫu {#allow-template-switching}
...
#### Cho phép người dùng dùng site của họ làm mẫu {#allow-users-to-use-their-site-as-templates}
...
#### Sao chép media khi nhân bản mẫu {#copy-media-on-template-duplication}
...
#### **Ngăn công cụ tìm kiếm lập chỉ mục mẫu site** {#prevent-search-engines-from-indexing-site-templates}
...
## Điền sẵn mẫu site bằng tự động tìm kiếm và thay thế {#pre-populating-site-templates-with-auto-search-and-replace}
...
### Giải quyết vấn đề "mẫu đầy placeholder" {#solving-the-template-full-of-placeholders-problem}
