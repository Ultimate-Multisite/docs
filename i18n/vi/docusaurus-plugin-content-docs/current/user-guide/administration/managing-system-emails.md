...
Từ đó, bạn có thể truy cập trang **System Emails** để xem tất cả mẫu email.

![Danh sách System Emails](/img/admin/system-emails-list.png)

Bạn cũng có thể chỉnh sửa từng mẫu email riêng lẻ bằng trình chỉnh sửa email hệ thống:
...
Để nhập mẫu email mới:

1. Đi tới trang **System Emails**
2. Nhấp vào nút **Reset & Import** ở đầu trang
...
1. **Xóa và nhập lại** — Xóa email hệ thống và nhập lại (thao tác này xóa các chỉ số gửi)
2. **Đặt lại qua công cụ** — Sử dụng công cụ **Reset & Import**, bật tùy chọn **Reset**, và chọn các email bạn muốn đặt lại

Tùy chọn Reset được ưu tiên vì nó giữ lại các chỉ số gửi và siêu dữ liệu khác trong khi khôi phục nội dung mặc định.
