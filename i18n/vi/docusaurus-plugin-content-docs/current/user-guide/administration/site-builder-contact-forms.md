...
## Cách Tạo Biểu Mẫu Liên Hệ {#creating-a-contact-form}
...
## Sử Dụng Shortcode Đã Tạo {#using-the-generated-shortcode}
...
## Tùy Chỉnh Biểu Mẫu Liên Hệ {#customizing-the-contact-form}

Sau khi Site Builder tạo biểu mẫu liên hệ, bạn có thể tùy chỉnh nó thêm:

### Qua Giao Diện Chat {#via-the-chat-interface}
...
### Qua Giao Diện Quản Trị của Plugin Biểu Mẫu {#via-the-form-plugins-admin-interface}
...
## Plugin Biểu Mẫu và Khả Năng Tương Thích {#form-plugins-and-compatibility}
...
### Biểu Mẫu Liên Hệ Đơn Giản {#simple-contact-form}

> "Tạo một biểu mẫu liên hệ đơn giản với các trường tên, email và tin nhắn."

### Biểu Mẫu Nhiều Bước {#multi-step-form}
