...
### Chế độ tự động (Auto Mode) (Mặc định mới)
...
## Kiểm tra chế độ hiện tại của bạn

### Qua Bảng điều khiển Admin
...
## Thay đổi chế độ của bạn

### Chuyển sang Chế độ tự động (Auto Mode)
...
### Chuyển sang Chế độ thủ công (Manual Mode)
...
### Chuyển sang Chế độ cũ (Legacy Mode)
...
## Lợi ích của Chế độ tự động (Auto Mode)

### Phát hiện tự động (Automatic Discovery)
...
### Tích hợp gốc (Native Integration)
...
### Quản lý đơn giản hóa (Simplified Management)
...
## Lộ trình di chuyển (Migration Path)

### Nếu bạn đang dùng WordPress 6.x
...
### Nếu bạn đang dùng WordPress 7.0+
...
### Các khả năng không tải trong chế độ tự động
...
### Tôi muốn giữ chế độ cũ (legacy mode)
...
### Các khả năng tùy chỉnh của tôi không hiển thị
...
### Tôi nhận được thông báo "unclassified ability"
...
### Lịch trình lỗi thời (Deprecation Timeline)
