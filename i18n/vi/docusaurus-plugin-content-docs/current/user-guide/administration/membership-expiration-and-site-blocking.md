...
## Vòng đời Trạng thái Thành viên
...
### Cách Thành viên Chuyển sang Trạng thái Hết hạn
...
#### Thành viên Tự động Gia hạn và Không Tự động Gia hạn
...
### Cách Thời gian Dùng thử Kết thúc
...
### Khách Truy cập Thấy Gì Khi Trang Web Bị Chặn
...
### 2. Kiểm tra Thời gian ân hạn chặn Frontend
...
### 3. Xác nhận Trạng thái Thành viên đã Thực sự Thay đổi
...
### 5. Kiểm tra Sự cố Webhook Cổng Thanh toán (Thành viên Tự động Gia hạn)
...
### 6. Kiểm tra Thời gian ân hạn Hết hạn (Cấp Cron)
