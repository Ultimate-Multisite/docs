...
## Tư Duy Theo Phân Khúc Khách Hàng {#thinking-in-customer-segments}
...
## Tạo Các Gói Dịch Vụ FitSite {#creating-the-fitsite-plans}

Điều hướng đến **Ultimate Multisite > Products > Add Product** cho từng gói dịch vụ.

### Gói 1: FitSite Starter -- $49/tháng {#plan-1-fitsite-starter----49month}
...
### Gói 2: FitSite Growth -- $99/tháng {#plan-2-fitsite-growth----99month}
...
### Gói 3: FitSite Pro -- $199/tháng {#plan-3-fitsite-pro----199month}
...
## Thiết Lập Nhóm Gói Dịch Vụ (Plan Group) {#setting-up-the-plan-group}
...
## Thêm Sản Phẩm Bổ Sung Khi Thanh Toán (Order Bumps) {#adding-order-bumps}
...
## Tại Sao Cấu Trúc Này Hiệu Quả {#why-this-structure-works}
