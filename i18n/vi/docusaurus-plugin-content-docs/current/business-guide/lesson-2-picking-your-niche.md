---
title: 'Bài học 2: Chọn ngách của bạn'
sidebar_position: 3
...
- Các doanh nghiệp được kỳ vọng phải có sự hiện diện trên web.
- Hầu hết các website hiện tại trong ngành đều có chất lượng kém.
- Các công cụ xây dựng website chung chung không giải quyết được nhu cầu cụ thể của họ.
- Việc phát triển tùy chỉnh (custom development) quá tốn kém đối với quy mô doanh nghiệp điển hình.
...
- Đủ lớn để có ngân sách marketing.
- Quen với việc trả phí thuê bao phần mềm (hệ thống đặt lịch, xử lý thanh toán, v.v.).
- Hoạt động ở quy mô mà mức chi phí $49-$199/tháng là một khoản chi phí kinh doanh hợp lý.
...
- Các hiệp hội ngành nghề, hội nghị hoặc triển lãm thương mại.
- Cộng đồng trực tuyến tích cực (nhóm Facebook, diễn đàn, subreddits).
- Các mạng lưới kết nối địa phương nơi chủ doanh nghiệp chia sẻ lời khuyên.
...
- Các ngành bạn đã từng làm việc hoặc xây dựng website.
...
- Tìm kiếm trên Google "[ngành nghề] website builder" và xem những gì đang tồn tại.
- Duyệt qua các diễn đàn ngành để tìm kiếm lời phàn nàn về sự hiện diện trên web.
...
- **Quy mô thị trường**: Có bao nhiêu doanh nghiệp tồn tại trong ngách này? (Bắt đầu với quốc gia/khu vực của bạn).
...
- Bạn đã có được website hiện tại bằng cách nào?
- Bạn ước nó có thể làm được điều gì mà hiện tại nó chưa làm được?
- Hiện tại bạn đang trả tiền cho nó bao nhiêu?
- Nếu có một nền tảng được xây dựng dành riêng cho [ngách của bạn], bạn có quan tâm không?
...
| Tiêu chí | Đánh giá |
|-----------|------------|
| Cần website nhưng gặp khó khăn | Có -- hầu hết các trang web phòng tập đều chung chung hoặc lỗi thời |
| Có khả năng chi trả gói đăng ký | Có -- đã trả $50-$200/tháng cho phần mềm đặt lịch |
| Thường tương tác với nhau | Có -- cộng đồng tích cực, sự kiện ngành, mạng lưới địa phương |
| Quy mô thị trường | Hơn 100.000 cơ sở chỉ ở Mỹ |
| Bức tranh cạnh tranh | Có ít nền tảng website chuyên biệt cho ngách này |
...
- **Nhà hàng và quán cà phê** -- thực đơn, đặt bàn, giờ mở cửa, tích hợp giao hàng
- **Môi giới bất động sản** -- danh sách nhà, hồ sơ môi giới, cẩm nang khu phố
- **Văn phòng luật** -- lĩnh vực hành nghề, tiểu sử luật sư, đặt lịch tư vấn
- **Nhà thờ và tổ chức phi lợi nhuận** -- sự kiện, bài giảng, quyên góp, cộng đồng
- **Nhà thầu dịch vụ** (thợ sửa ống nước, thợ điện, HVAC) -- khu vực dịch vụ, đặt lịch, đánh giá
- **Salon và spa** -- dịch vụ, đặt lịch, hồ sơ nhà tạo mẫu, thư viện ảnh
- **Phòng khám thú y** -- dịch vụ, cổng thông tin thú cưng, đặt lịch hẹn
- **Trường nhạc** -- hồ sơ giáo viên, lịch học, thông tin buổi biểu diễn
...
- **Xác thực FitSite**: xác nhận phòng tập thể hình đáp ứng tất cả các tiêu chí
- **Các ngách thay thế**: danh sách các lĩnh vực khác mà bạn có thể áp dụng khung làm việc này

---

**Tiếp theo:** [Bài 3: Thiết Lập Mạng Lưới Của Bạn](lesson-3-setting-up) -- chúng ta sẽ cài đặt Ultimate Multisite và cấu hình nền tảng cho FitSite.
