---
title: Nhật ký thay đổi Đồng bộ hóa Nội dung
sidebar_position: 99
...
* Mới: Chọn trước trang con cho các trang mẫu (template sites).
* Mới: Trích xuất media từ post_content cho tất cả các loại bài viết.
* Mới: Đồng bộ hóa taxonomy (các danh mục, thẻ, taxonomy tùy chỉnh).
* Đổi tên: Từ "Elementor Template Sync" thành "Content Sync".
...
* Đồng bộ hóa media đầy đủ với ánh xạ ID tự động.
* Tích hợp cài đặt với Ultimate Multisite.
* Hỗ trợ loại trừ trang web thông qua cài đặt mạng (network settings).
* Xóa cache Elementor sau khi đồng bộ.
* Bảo toàn taxonomy mẫu.
