...
### 1. Tạo Kế hoạch (Plan Generation)
...
### 2. Khám phá Plugin (Plugin Discovery)
...
### 3. Thực thi Kế hoạch (Plan Execution)
...
### 5. Khắc phục Lỗi (Error Recovery)
...
## Khả năng Kế hoạch Trang web (Site Plan Abilities)
