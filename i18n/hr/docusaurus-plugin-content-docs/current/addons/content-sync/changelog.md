---
title: Dnevnik promjena sinkronizacije sadržaja
sidebar_position: 99
...
* Novo: Predodabir podređene web-lokacije za predloške web-lokacija
* Novo: Izdvajanje medija iz post_content za sve vrste objava
* Novo: Sinkronizacija taksonomija (kategorije, oznake, prilagođene taksonomije)
* Promijenjeno: Preimenovano iz "Elementor Template Sync" u "Content Sync"
...
* Potpuna sinkronizacija medija s automatskim preslikavanjem ID-jeva
* Integracija postavki s Ultimate Multisite
* Podrška za izuzimanje web-lokacije putem mrežnih postavki
* Čišćenje Elementor predmemorije nakon sinkronizacije
* Očuvanje taksonomije predložaka
