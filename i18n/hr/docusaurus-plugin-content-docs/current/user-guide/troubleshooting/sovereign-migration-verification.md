...
---
# Provjera migracije suverenog hosta {#sovereign-migration-verification}
...
## Komande za pokretanje {#commands-to-run}
...
## Česte greške {#common-failures}

### Dotičitelj baze podataka se ne poklapa s hostom {#database-grants-do-not-match-the-host}
...
### Bedrock ili lokalne instalacije ne mogu se povezati {#bedrock-or-local-installs-cannot-connect}
...
### Asinhna redoslov za push nije ispraznjen (drain) {#async-push-queue-does-not-drain}
...
### Broj korisnika tenantera je pogrešan {#tenant-user-count-is-wrong}
...
### Posjet putem SSO-a se odbija {#sso-visit-is-rejected}
...
## Kada ponoviti pokušaj {#when-to-retry}
