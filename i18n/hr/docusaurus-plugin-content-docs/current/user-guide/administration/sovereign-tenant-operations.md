...
## Šta se mijenja za administratora
...
## Posjet suverene najmaki (Tenant)
...
## Provjera operacija udaljenih lokacija (Remote-site operations checklist)

Pre promjene suverene ili udaljene najmaki, potvrdite:

## Brisanje suverenih najmačkih domena
