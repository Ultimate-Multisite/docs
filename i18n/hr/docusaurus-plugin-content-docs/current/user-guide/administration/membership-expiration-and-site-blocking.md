...
### Kako Članstva Prelažu u Status Isteka
...
#### Otpuštajuće vs. Neotpuštajuće Članstva (Auto-Renewing vs. Non-Auto-Renewing Memberships)
...
### Kako se Krajaju Probne Razdoblja (How Trials End)
...
## Blokiranje Pristupa Frontend-u (Block Frontend Access)
...
### Što Posjetitelji Vidi Kada Se Sajt Blokira
...
## Rješavanje problema: Site ostaju dostupni nakon isteka roka

Ako su saiti ostali javno dostupni nakon što istekne članstvo, provjerite sljedeće korake u ovom redoslijedu:

### 1. Provjerite da je postavka Blokiranje pristupa frontend-u uključena
...
### 2. Provjerite Period odpuštanja za blokiranje pristupa frontend-u
...
### 3. Potvrdite da se Status Članstva Zapravo Promijeni
...
### 4. Provjerite da Li se Action Scheduler Pokreće
...
### 5. Provjerite probleme s Gateway Webhookovima (Automatsko obnavljanje članstva)
...
### 6. Provjerite razdoblje milosti za isteku (Cron nivo)
