---
title: Upravljanje e-mailovima sustava
sidebar_position: 13
...
Ondamo se odatle do stranice **System Emails** (Sistemski e-mailovi) kako biste vidjeli sve dostupne šablone za e-mailove.

![System Emails list](/img/admin/system-emails-list.png)

Možete uređivati pojedinačne email šablone koristeći editor sistemskih e-mailova:
...
Za uvoz novih email šablona:

1. Idite na stranicu **System Emails** (Sistemski e-mailovi)
2. Kliknite na gumb **Reset & Import** (Pristavi i uvez) na vrhu stranice
...
1. **Obrišite i ponovno uvezite** — Obrišite sistemski e-mail i uvezite ga ponovno (ovdje se brišu metrički podaci o slanju)
2. **Resetirajte putem alata** — Koristite alat **Reset & Import**, prebacite opciju **Reset** (Resetiraj) i odaberite e-mailove koje želite resetirati

Opcija Reset je poželjnija jer zadržava metričke podatke o slanju i druge metadata dok vraća podrazmjevni sadržaj.
