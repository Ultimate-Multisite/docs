...
## Omogućavanje Internetskog Pretraživanja {#enabling-internet-search}
...
### Ograničenja Korištenja {#usage-limits}
...
### Dobijanje ključa API-ja Tavilyja {#obtaining-a-tavily-api-key}
...
### Ograničenja korištenja {#usage-limits-1}
...
## Uključivanje internetskog pretraživanja {#disabling-internet-search}
