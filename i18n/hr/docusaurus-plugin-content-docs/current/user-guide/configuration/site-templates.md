...
---
# Šabloni za web stranice (v2) {#site-templates-v2}
...
## Što je Site Template? {#what-is-a-site-template}
...
## Kreiranje i uređivanje nove Site Template-a {#creating-and-editing-a-new-site-template}
...
### Prilagođavanje sadržaja Predloška Stranice {#customizing-the-contents-of-a-site-template}
...
### Korištenje Predlošaka Stranica {#using-site-templates}
...
#### Moda 1: Dodjela Predloška Stranice {#mode-1-assign-site-template}
...
#### Način 2: Odaberite dostupni šablon {#mode-2-choose-available-site-template}
...
### Podrazumevani način: Odabir šablona stranice na obrascu za plaćanje (Checkout form) {#default-mode-site-template-selection-on-the-checkout-form}
...
### Opcije za šablone stranica {#site-template-options}
...
#### Omogućite promjenu šablona {#allow-template-switching}
...
#### Omogućite korisnicima korištenje svoje stranice kao šablona {#allow-users-to-use-their-site-as-templates}
...
#### Kopiranje medija pri duplikaciji šablona {#copy-media-on-template-duplication}
...
#### **Sprečavanje indeksiranja šablona stranica od strane search engine-a** {#prevent-search-engines-from-indexing-site-templates}
...
## Predpopunjavanje šablona stranica s automatskim pretraživanjem i zamjenom {#pre-populating-site-templates-with-auto-search-and-replace}
...
### Rješavanje problema "šablon pun praznina" {#solving-the-template-full-of-placeholders-problem}
