...
---
# Integracija s Clostom {#closte-integration}
...
## Rješavanje problema (Troubleshooting) {#domain-record-creation}

### Problemi s povezivanjem API-ja {#troubleshooting}
- Provjerite jesu li Vaš ključ API-ja za Clostu ispravni
- Osigurajte da Vaš račun na Clostu ima potrebne dozvole

### Problemi s SSL certifikatima {#api-connection-issues}
...
### Domen nije dodan {#ssl-certificate-issues}
...
### Interval provjere DNS-a {#domain-not-added}
