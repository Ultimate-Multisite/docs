...
---
# Poboljšajte integraciju s kontrolnom panelom
...
## Dobivanje vaših API credentijala

### 1. Kreiranje API toke
...
### 2. Dohvatite svoj Organization ID
...
### Postavka putem Integracijskog vodiča (Integration Wizard)
...
### Konfiguracija .htaccess datoteke
