...
Dva istodobna zahtjeva mogu pročitati istu vrijednost i oba natrag zapisati isti uvećani rezultat, čime se gubi jedno brojanje. `increment_item()` delegira aritmetiku database engineu jednom naredbom `UPDATE ... SET column = column + ?`, čineći operaciju inherentno atomskom.
