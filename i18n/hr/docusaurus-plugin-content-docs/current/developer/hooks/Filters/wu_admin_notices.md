...
| Naziv | Tip | Opis |
|------|------|-------------|
| $notices | `array` | Popis obavijesti za tu određenu ploču. |
| $all_notices | `array` | Popis dodanih obavijesti, razdvojenih po ploči. |
| $panel | `string` | Ploča za dohvaćanje obavijesti. |
