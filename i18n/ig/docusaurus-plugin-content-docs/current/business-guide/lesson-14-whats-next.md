---
title: 'Nkuzi 14: Ihe Na-abịa Ọzọ'
sidebar_position: 15
...
│   ├── Ultimate Multisite (ahaziri + e nyere akara)
│   ├── Nnabata nwere wildcard SSL + ijikọ domain
│   └── CDN na caching maka arụmọrụ
├── Ngwaahịa
│   ├── Ụkpụrụ Webụsaịtị (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Atụmatụ (Starter $49/mo, Growth $99/mo, Pro $199/mo)
│   ├── Ọnụahịa kwa afọ nwere mbelata 20%
│   ├── Ego nhazi, nnwale, na mgbakwunye iwu
│   └── Koodu mbelata maka mgbasa ozi na ntụnye
├── Ahụmịhe
│   ├── Usoro checkout kwekọrọ na ngalaba ahịa
│   ├── Nbanye, dashboard, na ozi nwere akara
│   ├── Onboarding a na-eduzi site na widget Quick Start
│   ├── Usoro email nnabata
│   └── Ebe ọmụma na vidiyo na-akọwa usoro
├── Azụmahịa
│   ├── Inweta ndị ahịa n’ofe ụzọ 6
│   ├── Ọdịdị nkwado nwere ọkwa
│   ├── Usoro ọrụ (kwa ụbọchị, kwa izu, kwa ọnwa, kwa nkeji afọ)
│   ├── Nsochi metrics (MRR, churn, LTV, CAC)
│   └── Automation site na webhooks na usoro email
└── Uto
    ├── Atụmatụ ịgbasa akụrụngwa
    ├── Ime ka ego bawanye (upsells, ntụgharị kwa afọ, ọrụ ọhụrụ)
...
- **Ụlọ akwụkwọ nka ọgụ** -- ọkwa belt, ozi asọmpi, usoro klaasị
- **Ụlọ ọmụmụ ịgba egwu** -- usoro recital, gallery ngosi, ozi uwe ejiji
...
- **Njikọ ndoputa klaasị** -- njikọ miri emi na ikpo okwu ndoputa ndị a ma ama
- **Portal ndị otu** -- mpaghara a na-abanye maka ndị otu gym nwere usoro oge na akụrụngwa
...
- **Ndị ọkachamara ahụike** -- chiropractors, physiotherapists, nutritionists
...
1. Hà chọrọ webụsaịtị mana ọ na-esiri ha ike inweta nke ọma?
2. Hà nwere ike ịkwụ ụgwọ ndenye aha kwa ọnwa?
3. Hà na-akparịta ụka n’etiti onwe ha?

Ngalaba ahịa ọhụrụ ọ bụla chọrọ:

- Ụkpụrụ ọhụrụ emere maka ụlọ ọrụ ahụ
- Ọdịdị atụmatụ ọhụrụ na-egosi mkpa ụlọ ọrụ ahụ
- Ahịa na ụzọ inweta ndị ahịa ọhụrụ
- Ọdịnaya onboarding ọhụrụ na ọmụma nkwado
...
- `fitsite.com` -- ụlọ ọmụmụ ahụike
- `menusite.com` -- ụlọ oriri na ọṅụṅụ
- `lawsite.com` -- ụlọ ọrụ iwu
...
FitSite nwere ndị ahịa 200 na $89 ARPU:

- **MRR**: $17,800
- **ARR**: $213,600
- **Ọnụahịa ire nwere ike ịbụ**: $640,000 - $1,068,000
...
1. **Họrọ ngalaba ahịa** nwere mkpa doro anya, ikike ịkwụ ụgwọ, na obodo
2. **Kwado echiche ahụ** tupu iwulite
3. **Wuo ikpo okwu ahaziri nke ọma** nwere ụkpụrụ, atụmatụ, na branding kwekọrọ na ngalaba ahịa
4. **Mepụta ahụmịhe na-enweghị ihe mgbochi** site na signup ruo onboarding
5. **Tinye ọnụahịa dabere na uru** site na ọkwa atụmatụ, nnwale, na mbelata a haziri nke ọma
6. **Malite n’usoro** site na soft launch na checklist
7. **Nweta ndị ahịa** site na ụzọ kwekọrọ na ngalaba ahịa
8. **Gbaa ọrụ** site na usoro na-adịgide adịgide
9. **Gbasaa** akụrụngwa, ego, na otu ka ị na-eto
...
Oge kacha mma ịmalite bụ ụnyaahụ. Oge nke abụọ kacha mma bụ ugbu a.
