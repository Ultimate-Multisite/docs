...
title: Nzacha - wu_country_get_administrative_division_name
...
| Aha | Ụdị | Nkọwa |
|------|------|-------------|
| $name | `string` | Aha nkewa ahụ. Ọ na-abụkarị ihe dị ka steeti, provins, mpaghara, wdg. |
| $country_code | `string` | Koodu ISO mkpụrụedemede abụọ maka mba ahụ. |
