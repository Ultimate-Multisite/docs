...
Arịrịọ abụọ na-abịa n'otu oge nwere ike ịgụ otu uru ahụ ma ha abụọ deeghachi otu nsonaazụ a mụbara, tufuo otu ngụ. `increment_item()` na-enyefe mgbakọ ahụ n'aka engine database site na otu nkwupụta `UPDATE ... SET column = column + ?`, na-eme ka ọrụ ahụ bụrụ atomic n'onwe ya.
