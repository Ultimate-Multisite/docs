...
## Usoro ịkpọ faịlụ aha {#file-naming-convention}
...
## Ebe ị ga-etinye faịlụ ahụ {#where-to-place-the-file}
...
## Hooks na filters dị {#hooks-and-filters-available}
...
## Ihe atụ kacha nta {#minimal-example}
