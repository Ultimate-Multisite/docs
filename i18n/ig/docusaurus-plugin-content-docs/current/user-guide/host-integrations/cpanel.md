...
### 1. Lấy thông tin đăng nhập cPanel của bạn {#1-get-your-cpanel-credentials}
...
### 2. Thêm các hằng số vào wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Bật tính năng tích hợp {#3-enable-the-integration}
...
### Addon Domains (Miền Phụ) {#addon-domains}
...
### Subdomains (Miền Phụ) {#subdomains}
...
### Issues với Sertifikat SSL {#ssl-certificate-issues}
