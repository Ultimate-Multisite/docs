...
## Nkwado Setup {#setup-instructions}

### 1. Kụzi API Credentials RunCloud Gị {#1-get-your-runcloud-api-credentials}
...
### 2. Kụzi Server ID na App IDs Gị {#2-get-your-server-and-app-ids}
...
### 3. Add Constants na wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Enable Integrasi ọkụ {#4-enable-the-integration}
