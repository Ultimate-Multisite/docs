...
## Thông số Trang Web là gì? {#what-is-site-specification}
...
## Tại sao nên sử dụng Thông số Trang Web? {#why-use-site-specification}
...
### Tiếp nhận nhanh hơn (Faster Onboarding) {#faster-onboarding}
...
## Khởi tạo Thông số Trang Web {#initiating-site-specification}

### Trong quá trình tiếp nhận Theme Builder (During Theme Builder Onboarding) {#during-theme-builder-onboarding}
...
## Nkwado Site Specification {#the-site-specification-process}

### Ìgbè 1: Ihe Ama Site (Site Purpose) {#step-1-site-purpose}
...
### Ìgbè 2: Onye Nwanyị/Onye Nwa (Target Audience) {#step-2-target-audience}
...
### Ìgbè 3: Ọdụ Brand (Brand Identity) {#step-3-brand-identity}
...
### Ìgbè 4: Ọdụ Byee (Business Goals) {#step-4-business-goals}
...
### Ìgbè 5: Ọrụ Ihe (Content Structure) {#step-5-content-structure}
...
## Memory site_brief Gị {#your-sitebrief-memory}

Akpọrọ Site Specification, ihe nwere gị na-eme ka **site_brief** na memory agent gị. Ito bụ aka nchịkọta dị mma na nwere:

## Nhìn và Cập nhật tóm tắt trang web của bạn (site_brief) {#viewing-and-updating-your-sitebrief}

### Xem tóm tắt trang web của bạn (View Your site_brief) {#view-your-sitebrief}
...
### Cập nhật tóm tắt trang web của bạn (Update Your site_brief) {#update-your-sitebrief}
...
## Trợ lý sử dụng tóm tắt trang web (site_brief) như thế nào {#how-agents-use-sitebrief}
...
## Ịgba Nkwado Ndị Mba Ọ bụrụ Na-eme (Best Practices) {#best-practices}

### Ịgụ Akụkọ Ahụ (Be Specific) {#be-specific}
...
### Ịgụ Akwụkwọ Ndị Mma (Update Regularly) {#update-regularly}
...
### Ịgụ Nkwado Ndị Na-agba (Use Consistent Terminology) {#use-consistent-terminology}
...
### Ịgba Nkwado Ahụ (Include Context) {#include-context}
...
## Ọzọ na Onweghị Nwere Theme Builder (Relationship to Theme Builder Onboarding) {#relationship-to-theme-builder-onboarding}
...
## Ọnweghị Nwere Ihe Ndị Mba Ọ Na-eme (Troubleshooting) {#troubleshooting}
