...
## Quy trình Onboarding Theme Builder là gì? {#what-is-the-theme-builder-onboarding-flow}
...
## Bắt đầu Theme Builder Onboarding {#starting-the-theme-builder-onboarding}

### Thiết lập lần đầu chạy (First-Run Setup) {#first-run-setup}
...
## Các bước Onboarding {#the-onboarding-steps}

### Bước 1: Chọn Chế độ (Mode Selection) {#step-1-mode-selection}
...
### Bước 2: Thông số Trang web (Site Specification) {#step-2-site-specification}
...
### Step 3: Decision na Design System {#step-3-design-system-decisions}
...
### Step 4: Oluwo Theme {#step-4-theme-generation}
...
### Step 5: Activation na Verification {#step-5-activation-and-verification}
...
## Site Specification na site_brief Memory {#site-specification-and-sitebrief-memory}
...
### Ihe Ndị Site_brief Na-agbaỌzọ {#why-sitebrief-matters}

N'ime sesi-esi ndị ọzọ, agents ga-akwado site_brief gị maka:

### Manter consistency design na ndụmọdụ {#viewing-your-sitebrief}
...
### Ịgụnyere Site_brief Gị {#customizing-after-onboarding}
...
## Ịgbanwe Ndị Ocha Apụkụ Na Oge Ndeewo (Onboarding) {#use-the-design-system-aesthetics-skill}

Ọ bụrụ na onboarding Theme Builder tapụ, ị chụrụ ike ị:

### Rụrụ na Ụdị Kỹterị Design System Aesthetics Skill {#edit-themejson-directly}
...
### Gbanwe theme.json Na-akụkọ (Directly) {#create-custom-block-templates}
...
### Kụrụ Custom Block Templates {#comparison-old-vs-new-onboarding}
...
## Ịgụnyere Ndị Ocha Apụkụ Na Ndị Ndeewo (Comparison) {#troubleshooting}
...
## Ịgụnyere Ihe Ndị Dị N'ụmọdụ (Troubleshooting) {#next-steps}
