...
### Chế độ Site Builder (Cũ) {#site-builder-mode-legacy}
...
### Cái Gì Thay Thế Nó? {#what-replaced-it}
...
## Nếu Bạn Đang Dùng Site Builder Mode {#if-you-were-using-site-builder-mode}

### Trang Web Của Bạn An Toàn {#your-sites-are-safe}
...
## Chuyển sang Setup Assistant Agent {#migrating-to-setup-assistant-agent}
...
### Đối với các Trang đã có {#for-existing-sites}
...
### Chế độ Site Builder Mode {#site-builder-mode}
...
### Trợ lý Thiết lập (Setup Assistant Agent) {#setup-assistant-agent}
...
## Lợi Ích của Trợ lý Thiết lập (Setup Assistant Agent) {#benefits-of-setup-assistant-agent}
...
### Tùy biến tốt hơn {#better-customization}
...
### Quy trình Tích hợp {#integrated-workflow}
...
### Tôi không tìm thấy chế độ Site Builder mode {#i-cant-find-site-builder-mode}

Chế độ Site Builder mode đã bị gỡ bỏ. Hãy sử dụng trợ lý Thiết lập (Setup Assistant agent) thay thế:

"Help me set up a new site"

### Ọ na-akụ site ọhụrụ {#i-want-to-recreate-a-site-from-site-builder}
...
### Site Builder site onwe m na-eme ka ọ dịghị iji {#my-existing-site-builder-site-isnt-working}
...
### Ọ ga-akụ template Site Builder m dị? {#can-i-still-use-my-old-site-builder-templates}
...
## Ihe Gịnị Ga-akwụ (Next Steps) {#next-steps}
...
## Ihe Ndị Na-agba (Related Topics) {#related-topics}
