...
## Nhà cung cấp lưu trữ (Hosting provider) {#hosting-provider}
...
## Tên miền phụ (Subdomain) {#subdomain}
...
## Thư mục con (Subdirectory) {#subdirectory}
