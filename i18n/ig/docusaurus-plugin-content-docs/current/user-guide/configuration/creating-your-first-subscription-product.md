---
title: Nkwado Ụbọchị Ọzọ Na Ebe Ihe Ịchọ
sidebar_position: 6
...
## Quản lý Sản phẩm {#managing-products}
...
## Ịchọta Products (Adding Products) {#adding-products}
...
### Description (Nkwado) {#description}
...
### Pricing Type (Nri-isi Na-agbanwe) {#pricing-type}
...
### Oge Abịa (Billing Cycles) {#billing-cycles}
...
### Oge Proba (Trial Period) {#trial-period}
...
### Ọrụ Nkwado (Setup Fee) {#setup-fee}
...
### Hiahụ Ọbụghachi (Product Image) {#product-image}
...
### Ọrụ Product (Product Options) {#product-options}
...
#### Naik & Hạ (Up & Downgrades) {#up--downgrades}
...
#### Các Biến Thể Giá (Price Variations) {#price-variations}
...
:::tip Hiển thị Công tắc Kỳ Thanh toán trên Giao diện Người dùng Cuối (Frontend)
...
Cuối cùng, nếu quản trị viên mạng muốn việc chọn mẫu xảy ra trong các bước thanh toán, thì cài đặt ' _default_ ' là đủ rồi. Hoặc để loại bỏ và khóa việc chọn mẫu, đồng thời giao quyền chọn cho cài đặt gói (plan settings), bạn có thể muốn sử dụng các tùy chọn ' _assign new template_ ' hoặc ' _choose available site templates_ '.

#### Các trang web (Sites) {#sites}
...
_**Note: Ka ọ bụrụ ka themes a ga-anọchịrị ike maka ndị biara site, network administrator ga-anọchịrị ike ka ọ dị na network.**_
