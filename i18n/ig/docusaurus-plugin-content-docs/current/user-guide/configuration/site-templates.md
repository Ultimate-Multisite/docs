...
## Tạo và Chỉnh sửa Site Template mới
...
### Ịgbanwe ihe ndị dị n'ime Site Template
...
### Ịdị anyị dị mma (Advanced Options)
...
### Chế độ Mặc định: Chọn mẫu trang web trên biểu mẫu Thanh toán (Checkout form)
...
### Opciones de Modelos Sites (Site Template Options)
...
#### Cho phép Người dùng sử dụng Site của họ làm mẫu (Allow Users to use their Site as templates)
...
#### **Ngăn Công cụ Tìm kiếm lập chỉ mục các Site Templates (Prevent Search Engines from indexing Site Templates)**
...
## Điền sẵn Site Templates bằng tự động tìm và thay thế (Pre-populating Site Templates with auto search-and-replace)
