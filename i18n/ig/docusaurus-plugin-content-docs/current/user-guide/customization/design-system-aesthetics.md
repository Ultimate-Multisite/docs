---
title: Nkwado Ụdị Nkwado Design System Aesthetic
sidebar_position: 21
...
- **Thang kích thước (Size scale)**: Các kích thước được định sẵn (nhỏ, cơ sở, lớn, XL, v.v.)
...
1. Updates your theme's `theme.json` with all tokens (Nchegbu `theme.json` nke theme gị na-ahụka ọkụ ọkụ ọkụ ọkụ)
2. Applies the design system to your active theme (Na-ahụka design system na theme ahụ dị nwere)
...
1. **Koro site gị**: Bịta site gị ịhụ dị mma na design ọhụrụ ahụ.
2. **Dị mma nke ukwuu**: Dị mma n'ụzọ ọzọ, jiri skill gị again.
3. **Chọrọ template**: Jiji custom block templates ji site tokens gị.
4. **Dokumente**: Share design system gị na ndị mmadụ n'ime team.
