...
### Chuyển sang Chế độ Di sản (Legacy Mode)
...
## Lợi ích của Auto Mode (Chế độ Tự động)
...
### Các khả năng không tải trong chế độ auto
...
### Ndem Anyị Ndị Custom Abilities Na Ndị Na Ndị Na Ndị
...
### A Naa "unclassified ability" notices
