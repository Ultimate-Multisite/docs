...
Mkpụrụeduro, ị ga-agbanye (access) page **System Emails** maka ị chọpụta mmadụ email templates ọ bụla.

![System Emails list](/img/admin/system-emails-list.png)

Ị gị nwere ike ịgbagba individual email templates ndị a na-akọwa using system email editor:
...
Ọ bụrụ na ị chọpụta new email templates:

1. Jitụrụ page **System Emails**
2. Jikọta button **Reset & Import** dị n'ụdị anọchịrị page ahụ
...
1. **Delete and re-import** — Delete system email ahụ ma import ya ọzọ (a ga-anọghị metrics send)
2. **Reset via the tool** — Jikọta tool **Reset & Import**, chọpụta option **Reset**, ma chọpụta emails ndị ị chọrọ ka ịlụso

Option Reset bụ onye ọrụ dị mma n'ihi ya na-agbanye metrics send na metadata ndị ọzọ, karịsịta default content.
