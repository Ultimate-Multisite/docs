...
## Ka ihe mere nwere fọm administrators {#what-changes-for-administrators}
...
## Visiting a sovereign tenant {#visiting-a-sovereign-tenant}
...
## Xóa các người thuê chủ quyền (sovereign tenants) {#deleting-sovereign-tenants}
