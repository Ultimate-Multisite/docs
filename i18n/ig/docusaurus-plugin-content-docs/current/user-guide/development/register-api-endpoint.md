...
## Các tham số thân yêu của Endpoint (Endpoint body parameters) {#endpoint-body-parameters}
...
## Ọrụ na Zapier {#creating-an-action-in-zapier}
...
### Các tham số endpoint đầy đủ {#complete-endpoint-parameters}
