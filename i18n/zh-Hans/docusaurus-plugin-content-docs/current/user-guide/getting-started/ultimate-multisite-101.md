...
#### 子域名与子目录 {#subdomain-vs-subdirectory}
...
#### Plugins 和 Themes {#plugins-and-themes}
...
#### 用户和管理员 {#users-and-administrators}
...
#### 场景 2：垂直领域提供商 {#case-2-niche-provider}
...
#### 场景 3：WordPress 网站托管 {#case-3-wordpress-web-hosting}
...
#### 共享主机与专用主机 {#shared-vs-dedicated-hosting}
