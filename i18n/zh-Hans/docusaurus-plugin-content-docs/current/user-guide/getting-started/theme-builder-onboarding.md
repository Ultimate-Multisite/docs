...
## 什么是主题构建器入门流程？ {#what-is-the-theme-builder-onboarding-flow}
...
## 启动主题构建器入门流程 {#starting-the-theme-builder-onboarding}
...
## 入门步骤 {#the-onboarding-steps}

### 步骤 1：模式选择 {#step-1-mode-selection}
...
### 步骤 2：网站规范 {#step-2-site-specification}
...
### 步骤 3：设计系统决策 {#step-3-design-system-decisions}
...
### 步骤 4：主题生成 {#step-4-theme-generation}
...
### 步骤 5：激活和验证 {#step-5-activation-and-verification}
...
## 网站规范和 site_brief 内存 {#site-specification-and-sitebrief-memory}
...
### 为什么 site_brief 很重要 {#why-sitebrief-matters}
...
## 入门后进行定制 {#customizing-after-onboarding}

主题构建器入门流程完成后，您可以：

### 使用设计系统美学技能（Design System Aesthetics Skill） {#use-the-design-system-aesthetics-skill}
...
### 直接编辑 theme.json {#edit-themejson-directly}
...
### 创建自定义区块模板 {#create-custom-block-templates}
...
## 对比：旧版与新版入门流程 {#comparison-old-vs-new-onboarding}
