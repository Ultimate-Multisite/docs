...
## 向导何时出现？ {#when-does-the-wizard-appear}
...
## 第 2 步：网络配置 {#step-2-network-configuration}
...
### 向导提示 wp-config.php 无法写入 {#the-wizard-says-wp-configphp-is-not-writable}
...
### 设置后站点无法访问（子域名） {#sites-are-not-accessible-after-setup-subdomains}
...
### 设置后身份验证问题 {#authentication-issues-after-setup}
...
### 安装过程中某一步骤失败 {#a-step-failed-during-installation}
