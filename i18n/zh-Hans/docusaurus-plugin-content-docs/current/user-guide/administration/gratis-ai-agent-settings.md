...
## 反馈 endpoint 配置 {#feedback-endpoint-configuration}
...
### 预期的 JSON 负载 {#expected-json-payload}
...
### 禁用反馈收集 {#disabling-feedback-collection}
...
## 托管 Superdav 服务 {#managed-superdav-service}
...
## Google Calendar 配置 {#google-calendar-configuration}
...
### 访问功能标志 {#accessing-feature-flags}

1. 在 WordPress 管理后台，前往 **Gratis AI Agent → 设置**。
2. 点击 **功能标志** 选项卡。

### 访问控制标志 {#access-control-flags}
...
### 自动化安全标志 {#automation-safety-flags}
