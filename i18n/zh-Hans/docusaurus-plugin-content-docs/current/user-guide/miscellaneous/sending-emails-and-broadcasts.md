...
## 使用广播向客户的 Dashboard 添加管理通知 {#add-admin-notices-to-your-customers-dashboard-with-broadcasts}
...
## 向客户发送电子邮件 {#send-emails-to-your-customers}
...
#### 如何导入系统电子邮件 {#how-to-import-system-emails}
...
#### 重置系统电子邮件 {#reseting-system-emails}
