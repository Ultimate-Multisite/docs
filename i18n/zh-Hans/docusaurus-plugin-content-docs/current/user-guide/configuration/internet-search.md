...
## 启用互联网搜索 {#enabling-internet-search}
...
### 获取 Brave Search API 密钥 {#obtaining-a-brave-search-api-key}
...
### 获取 Tavily API 密钥 {#obtaining-a-tavily-api-key}
...
## 禁用互联网搜索 {#disabling-internet-search}
