...
## 导航标签 vs 页面标题 {#navigation-label-vs-page-title}
...
### 示例 1：带导航标签的简单菜单 {#example-1-simple-menu-with-navigation-label}
...
### 示例 2：用于特定主题位置的菜单 {#example-2-menu-for-specific-theme-location}
