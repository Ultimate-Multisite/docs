...
De demann similtane ka li menm valè a epi toude ekri menm rezilta ogmante a tounen, sa ki fè pèdi yon konte. `increment_item()` delege aritmetik la bay motè bazdone a ak yon sèl deklarasyon `UPDATE ... SET column = column + ?`, sa ki fè operasyon an atomik pa nati li.
