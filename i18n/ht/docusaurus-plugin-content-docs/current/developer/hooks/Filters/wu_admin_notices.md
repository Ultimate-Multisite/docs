...
| Non | Tip | Deskripsyon |
|------|------|-------------|
| $notices | `array` | Lis avi pou panèl patikilye sa a. |
| $all_notices | `array` | Lis avi ki ajoute yo, separe selon panèl. |
| $panel | `string` | Panèl pou rekipere avi yo. |
