...
### Sik Lavi Kliyan {#customer-lifecycle}

#### Apre Kreyasyon Kliyan {#after-customer-creation}
...
#### Chanjman Estati Kliyan {#customer-status-change}
...
### Hooks Sit {#site-hooks}

#### Apre Sit la Pibliye {#after-site-published}
...
#### Anvan Aplikasyon Modèl {#before-template-application}
...
### Hooks Manm {#membership-hooks}

#### Tranzisyon Estati {#status-transitions}
...
### Hooks Peman {#payment-hooks}

#### Peman Konplete / Echwe {#payment-completed--failed}
...
#### Anvan Pwosesis / Apre Konplete {#before-processing--after-completion}
...
### Filtè Pri {#pricing-filters}

#### Total Panye {#cart-total}
...
### Filtè Limitasyon {#limitation-filters}
...
### Chan Fòm Checkout {#checkout-form-fields}
