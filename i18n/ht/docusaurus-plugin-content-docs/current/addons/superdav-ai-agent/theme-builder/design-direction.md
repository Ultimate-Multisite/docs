...
- **Koulè prensipal** — koulè prensipal mak la yo itilize pou bouton, lyen, ak aksan
- **Koulè segondè** — koulè konplemantè pou varyete
- **Koulè aksan** — koulè pou mete eleman enpòtan yo an valè
...
- **Polis tit** — yo itilize pou tit paj ak antèt seksyon
- **Polis kò tèks** — yo itilize pou tèks paragraf ak kontni
- **Gwosè polis** — gwosè ki adapte pou diferan gwosè ekran
...
- Meni navigasyon konplè
- Layout konplè ak tout kolòn yo
...
- Navigasyon responsiv (meni hamburger)
- Layout yon sèl kolòn
...
| Aparèy | Lajè | Aperçu |
|--------|-------|---------|
| **Mobil** | 375px | Telefòn pòtrè |
| **Tablet** | 768px | Tablet peyizaj |
...
1. **Ajiste koulè** — chanje nenpòt koulè nan palèt la
2. **Chanje polis** — chwazi diferan tipografi
3. **Modifye espasman** — ajiste padding ak maj
...
- Aperçu desktop la mete ajou imedyatman
- Aperçu mobil la mete ajou imedyatman
...
- **Design orijinal** — wè sa ki chanje
...
1. **Revize toude aperçu yo** — verifye desktop ak mobil parèt byen
2. **Tcheke tout koulè yo** — asire kontras ak aksè
3. **Teste tipografi** — verifye lizibilite nan tout gwosè
...
1. Theme Builder jenere theme konplè ou
2. Theme nan enstale sou site WordPress ou
...
- **Verifye kontras** — itilize [Valide Kontras Palèt](../abilities/validate-palette-contrast.md) pou aksè
...
- [Valide Kontras Palèt](../abilities/validate-palette-contrast.md) — tcheke aksè koulè
- [Jenere Logo SVG](../abilities/generate-logo-svg.md) — kreye logo pèsonalize
