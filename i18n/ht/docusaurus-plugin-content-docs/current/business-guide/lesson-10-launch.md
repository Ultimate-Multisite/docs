...
- [ ] Katografi domèn mache -- teste kreye yon sit epi katografye yon domèn pèsonalize
...
- [ ] Tout imaj yo gen lisans apwopriye (pa gen watermark foto stock)
- [ ] Reponsivite mobil mache sou chak paj modèl
...
- [ ] Pri yo kòrèk (chak mwa ak chak ane)
- [ ] Frè setup yo konfigire sou bon plan yo
- [ ] Peryòd esè a mache sou plan Starter
...
- [ ] Peman an trete avèk siksè
- [ ] Kliyan an resevwa imèl akeyi apre enskripsyon an
- [ ] Nouvo sit la kreye ak modèl ki kòrèk la
...
- [ ] Tout imèl sistèm yo itilize mak FitSite ak langaj espesifik pou fitness
...
- [ ] Sekans imèl akeyi a konfigire epi teste
...
- [ ] Refund policy a defini epi dokimante
- [ ] Antite biznis la mete kanpe pou resevwa peman
...
- Feedback onèt sou eksperyans enskripsyon ak onboarding lan
- Pèmisyon pou itilize sit yo kòm yon egzanp ekspozisyon
- Rapòte nenpòt bug oswa pwoblèm yo rankontre
...
- Chanje payment gateway a pou mòd live
- Pibliye sit maketing ou a
...
1. **Chanje pou peman live** -- dezaktive mòd tès sou payment gateway ou
2. **Verifye yon lòt fwa ankò** -- fè yon enskripsyon tès konplè ak yon peman reyèl (ranbouse tèt ou apre)
3. **Siveye byen pre** -- gade pou erè, enskripsyon ki echwe, oswa pwoblèm peman
...
- **Pwoblèm payment gateway**: Kenbe kontak sipò founisè gateway ou a pare
- **Pwoblèm sètifika SSL**: Konnen kijan pou tcheke epi renouvle sètifika yo
- **Echèk livrezon imèl**: Teste pou asire imèl yo vrèman rive (tcheke dosye spam yo)
...
- **Pwosedi jou lansman** pou ale live ak konfyans
- **Yon plan ijans** pou pwoblèm komen jou lansman

---

**Apre:** [Leson 11: Jwenn Kliyan](lesson-11-customers) -- kounye a FitSite live, kijan ou fè pwopriyetè estidyo fitness yo enskri?
