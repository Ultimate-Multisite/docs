---
title: 'Leson 14: Ki sa k ap vini apre'
sidebar_position: 15
...
Rezo FitSite (Konplè)
├── Enfrastrikti
│   ├── WordPress Multisite (mòd soudomèn)
│   ├── Ultimate Multisite (konfigire + ak mak)
│   ├── Ebèjman ak wildcard SSL + katografyaj domèn
│   └── CDN ak kach pou pèfòmans
├── Pwodui
│   ├── Modèl sit (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Plan (Starter $49/mo, Growth $99/mo, Pro $199/mo)
│   ├── Pri anyèl ak 20% rabè
│   ├── Frè konfigirasyon, esè, ak òf siplemantè nan kòmann
│   └── Kòd rabè pou kanpay ak rekòmandasyon
├── Eksperyans
│   ├── Koule peman espesifik pou nich la
│   ├── Koneksyon, Dashboard, ak kominikasyon ak mak
│   ├── Entegrasyon gide ak widget Quick Start
│   ├── Sekans imèl byenvini
│   └── Baz konesans ak gid videyo etap pa etap
├── Biznis
│   ├── Akizisyon kliyan atravè 6 chanèl
│   ├── Estrikti sipò pa nivo
│   ├── Woutin operasyonèl (chak jou, chak semèn, chak mwa, chak trimès)
│   ├── Swivi metrik (MRR, dezabònman, LTV, CAC)
│   └── Otomatik atravè webhooks ak sekans imèl
└── Kwasans
    ├── Plan echèl enfrastrikti
    ├── Optimizasyon revni (òf siplemantè, konvèsyon anyèl, nouvo sèvis)
...
- **Lekòl atizay masyal** -- klasman senti, enfòmasyon tounwa, yerachi klas
- **Estidyo dans** -- orè resital, galri pèfòmans, enfòmasyon kostim
...
- **Entegrasyon rezèvasyon klas** -- entegrasyon pi fon ak platfòm rezèvasyon popilè yo
- **Pòtay manm** -- yon zòn ki mande koneksyon pou manm jim yo ak orè ak resous
...
- **Pratisyen sante** -- kiwopratikyen, fizyoterapis, nitrisyonis
...
1. Èske yo bezwen sit entènèt men yo gen difikilte pou jwenn bon sit?
2. Èske yo kapab peye yon abònman chak mwa?
3. Èske yo pale youn ak lòt?

Chak nouvo nich bezwen:

- Nouvo modèl ki fèt pou endistri sa a
- Nouvo estrikti plan ki reflete bezwen endistri sa a
- Nouvo chanèl maketing ak akizisyon
- Nouvo kontni entegrasyon ak konesans sipò
...
- `fitsite.com` -- estidyo fizik
- `menusite.com` -- restoran
- `lawsite.com` -- kabinè avoka
...
Yon FitSite ak 200 kliyan nan $89 ARPU:

- **MRR**: $17,800
- **ARR**: $213,600
- **Pri vant potansyèl**: $640,000 - $1,068,000
...
1. **Chwazi yon nich** ak bezwen klè, kapasite pou peye, ak kominote
2. **Valide** anvan ou bati
3. **Bati yon platfòm adapte** ak modèl, plan, ak mak espesifik pou nich la
4. **Kreye yon eksperyans san friksyon** depi enskripsyon rive nan entegrasyon
5. **Fikse pri selon valè** ak nivo estratejik, esè, ak rabè
6. **Lanse metodikman** ak yon lansman dousman ak lis verifikasyon
7. **Akeri kliyan** atravè chanèl espesifik pou nich la
8. **Fè operasyon yo mache** ak woutin dirab
9. **Echèl** enfrastrikti, revni, ak ekip pandan w ap grandi
...
Pi bon moman pou kòmanse se te yè. Dezyèm pi bon moman an se kounye a.
