...
---
# Voye Imèl ak Broadcasts (v2) {#sending-emails-and-broadcasts-v2}
...
## Ajoute avi admin sou dashboard kliyan ou yo ak Broadcasts {#add-admin-notices-to-your-customers-dashboard-with-broadcasts}
...
## Voye imèl bay kliyan ou yo {#send-emails-to-your-customers}
...
### Reset ak Enpòte {#resetting--importing}
...
#### Kijan pou enpòte imèl sistèm {#how-to-import-system-emails}
...
#### Reyinisyalize Imèl Sistèm yo {#reseting-system-emails}
