...
## Le champ de sélection de domaine Checkout
...
### Auto-generated site URL (URL sit la ki te jwenn otomatikman)
...
### Comportman rechèch (Search behaviour)
...
## Jere DNS Kliyan an (Customer DNS management)
...
### Ki pwofòvwa yo sipòte jere DNS?
...
### Enskripsyon DNS dekouvè (Default DNS records)
