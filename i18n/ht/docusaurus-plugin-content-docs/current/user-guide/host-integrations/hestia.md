...
## Konfigirasyon (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
Bay valè sa yo:
...
## Verifikasyon Setup {#verifying-setup}
...
## Egzanp API Call (cURL) {#example-api-call-curl}
...
## Rezolisasyon pwoblèm (Troubleshooting) {#troubleshooting}
...
## Referans (References) {#references}
