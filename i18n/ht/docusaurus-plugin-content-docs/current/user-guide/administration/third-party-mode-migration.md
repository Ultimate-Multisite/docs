...
## Verify Mod Kouran Ou Ye

### Fòch nan Admin Panel la
...
### Si Ou Ap itilize WordPress 6.x
...
### Si Ou Ap itilize WordPress 7.0+
...
## Resousè Soublen (Troubleshooting)

### Les capacités pa kòmanse telechaje nan auto mode
...
### Kapasite mwen pèsonèl mwen yo pa montre
...
### Mwen ap jwenn notifikasyon "unclassified ability" (ability ki pa klasifye)
...
## Backward Compatibility (Konpatibilite pou vye)

### Konfigirasyon ki egziste deja
...
### Timeline Deprecation (Liy tan pou retire)
...
## Best Practices (Me pratik)

### Pou nouvo enstalasyon yo
...
### Pou enstalasyon ki egziste deja
...
### Pou abilities koutim (Custom Abilities)
