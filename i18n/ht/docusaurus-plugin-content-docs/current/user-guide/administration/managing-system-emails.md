...
Lè ou rive la, ou ka jwenn aksè nan paj **System Emails** pou w wè tout template email yo.

![System Emails list](/img/admin/system-emails-list.png)

Ou ka edite chak template email anpil tou lè w itilize editè email sistèm sa a:
...
Pou enpòte nouvo template email:

1. Ale nan paj **System Emails**
2. Klike sou bouton **Reset & Import** anwo paj la
...
1. **Delete epi re-import** — Delete email sistèm la epi enpòte l ankò (sa ap efase metriksyon voye a)
2. **Resete atravè zouti a** — Itilize zouti **Reset & Import**, mete chanje opisyon **Reset**, epi chwazi email ou vle resete

Opsyon Reset la pi bon paske li kenbe metriksyon voye ak lòt metadata yo pandan li retounen kontni de fèt.
