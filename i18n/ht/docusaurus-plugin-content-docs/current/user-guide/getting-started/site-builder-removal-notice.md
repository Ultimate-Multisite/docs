---
title: Avis Retrait de Mode Constructeur Site
sidebar_position: 19
...
- Kreye sit ki soti nan template
- Konfigire tout bagay ki esansyèl
- Chwazi yon thème
...
- Yon setup ki pi fleksib, ki gide pa agent la
- Pi bon opsyon pou personalize thème ou an
...
|---------|----------------------|----------------------|
| Metòd setup | Fòm gwid (Wizard form) | Konvèsasyon agent la |
| Chwazi thème | Template predefined | Jenerasyon koutim |
| Personalizasyon | Opsyon limit | Sistèm design konplè |
| Site brief | Pa estoke | Memwa pèmanan |
...
1. Demann: "Ede m mete yon nouvo sit"
2. Agent Asistans Setup la ap gide ou atravè:
   - Objektif ak bezwen sit la
   - Piboud ki se moun ou vle atire
   - Idantite mark la (Brand identity)
...
1. Ou ka kontinye itilize li jan li ye a
2. Pou mete ajou sou tèm nan, demann: "Redesigne sit mwen"
...
1. Demann: "Chanje tèm mwen"
2. Agent Asistans Setup la ap fè sa:
   - Mande w sou prefere konsepsyon ou yo
...
2. Chwazi yon tèm
3. Konfigire tout bagay an batay
4. Fini
```
...
2. Defini piboud ou vle atire
3. Chwazi prefere konsepsyon ou yo
4. Agent jene yon tèm kay (custom theme)
5. Agent aktive tèm nan
...
- Kapasite Kontwòl Visibilité (Ability Visibility controls)
- Tout travay yo travay ansanm san pwoblèm
...
1. Demann ou: "Emanje, ede m mete yon nouvo sit"
2. Dekri objektif ak konsepsyon sit ou anvan an
...
1. Kontwe si thèm ou la toujou aktif
2. Verifye ke plugin ou yo aktive
...
- Sit ou ki egziste kontinye fonksyone
...
- **Site Specification Skill**: Defini objektif ak moun ou vle atire sit ou a
- **Design System Aesthetics Skill**: Amelyore idantite vizyèl sit ou a
