...
## Enstalasyon Plugin nan {#installing-the-plugin}
...
## Asistan Enstalasyon {#setup-wizard}
...
### Tcheke Anvan Enstalasyon {#pre-install-checks}
...
### Kontni Default {#default-content}
...
### Plugin Rekòmande {#recommended-plugins}
