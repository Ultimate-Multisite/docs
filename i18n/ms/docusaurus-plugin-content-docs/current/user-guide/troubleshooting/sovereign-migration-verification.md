...
---
# Pengesahan Migrasi Kedaulatan (Sovereign Migration Verification)
...
### Kelulusan pangkalan data tidak sepadan dengan hos (host)
...
### Pemasangan Bedrock atau tempatan (local) tidak dapat menyambung
...
### Barisan 'async push' tidak dikosongkan (drain)
...
### Bilangan pengguna tetapan adalah salah
