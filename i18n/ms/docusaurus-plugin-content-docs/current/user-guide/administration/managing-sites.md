...
- **Milik Pelanggan** — Laman yang dimiliki oleh pelanggan tertentu
...
- **Site Title** — Nama laman baharu
- **Site URL** — Domain/laluan untuk laman tersebut
- **Site Type** — Sama ada ia laman pelanggan, templat, atau laman biasa
...
- **Had lawatan** — Bilangan maksimum lawatan laman
- **Had akaun pengguna** — Had mengikut peranan pengguna
- **Ruang cakera** — Kuota storan untuk laman
- **Domain tersuai** — Aktifkan pemetaan domain untuk laman ini
- **Keterlihatan plugin dan tema** — Kawal plugin dan tema mana yang boleh dilihat, disembunyikan, atau diaktifkan secara automatik
...
- **Domain yang dipetakan** yang dikaitkan dengan laman
...
- **Aktif/nyahaktifkan laman** dengan butang togol
- **Tukar jenis laman** atau tugaskan semula pemilikan
- **Tetapkan imej/lakaran kecil laman** (dipaparkan di bahagian hadapan untuk templat laman)
- **Padam laman** secara kekal

:::warning
Pemadaman laman tidak boleh dibatalkan. Laman dan semua kandungannya akan dibuang secara kekal.
:::
