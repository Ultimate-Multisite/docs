...
| Peranti | Lebar | Pratonton |
|--------|-------|---------|
| **Mudah Alih** | 375px | Telefon potret |
| **Tablet** | 768px | Tablet landskap |
...
- **Sahkan kontras** — gunakan [Validate Palette Contrast](../abilities/validate-palette-contrast.md) untuk kebolehaksesan
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — semak kebolehaksesan warna
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — cipta logo tersuai
