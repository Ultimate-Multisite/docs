---
title: 'Pelajaran 10: Hari Pelancaran'
sidebar_position: 11
...
- [ ] Pemetaan domain berfungsi – uji dengan mencipta laman web dan memetakan domain tersuai
...
- [ ] Semua imej mempunyai lesen yang betul (tiada tanda air foto stok)
- [ ] Responsif mudah alih berfungsi pada setiap halaman templat
...
- [ ] Penetapan harga adalah betul (bulanan dan tahunan)
- [ ] Yuran persediaan (Setup fees) dikonfigurasi pada pelan yang betul
- [ ] Tempoh percubaan berfungsi pada pelan Starter
...
- [ ] Pelanggan menerima e-mel selamat datang selepas mendaftar
- [ ] Laman web baharu dicipta dengan templat yang betul
...
- [ ] Semua e-mel sistem menggunakan penjenamaan FitSite dan bahasa khusus kecergasan
...
- [ ] Urutan e-mel selamat datang dikonfigurasi dan diuji
...
- [ ] Dasar pemulangan wang (Refund policy) ditakrifkan dan didokumentasikan
- [ ] Entiti perniagaan disediakan untuk menerima pembayaran
...
- Maklum balas jujur mengenai pengalaman pendaftaran dan pendaftaran (onboarding)
- Kebenaran untuk menggunakan laman web mereka sebagai contoh pameran
- Melaporkan sebarang pepijat atau isu yang mereka temui
...
- Tukar payment gateway kepada mod langsung
- Terbitkan laman pemasaran anda
...
1. **Tukar kepada pembayaran langsung** – nyahaktifkan mod ujian pada payment gateway anda
2. **Sahkan sekali lagi** – lakukan pendaftaran ujian penuh dengan pembayaran sebenar (pulangkan wang kepada diri sendiri selepas itu)
3. **Pantau dengan teliti** – perhatikan ralat, pendaftaran yang gagal, atau isu pembayaran
...
- **Isu payment gateway**: Sediakan maklumat hubungan sokongan penyedia gateway anda
- **Masalah sijil SSL**: Ketahui cara menyemak dan memperbaharui sijil
- **Kegagalan penghantaran e-mel**: Uji bahawa e-mel benar-benar sampai (semak folder spam)
...
- **Prosedur hari pelancaran** untuk menjadi hidup dengan keyakinan
- **Pelan kontingensi** untuk isu-isu biasa pada hari pelancaran

---

**Seterusnya:** [Pelajaran 11: Mencari Pelanggan](lesson-11-customers) -- kini FitSite sudah hidup, bagaimana anda mendapatkan pemilik studio kecergasan untuk mendaftar?
