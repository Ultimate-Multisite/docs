---
title: 'Pelajaran 8: Proses Penerimaan Pelanggan'
sidebar_position: 9
...
- Log masuk dan melihat laman web yang sudah kelihatan seperti laman web kecergasan → akan kekal
- Tahu dengan tepat apa yang perlu dilakukan seterusnya → akan kekal
- Merasa keliru dalam dashboard WordPress yang generik → akan pergi
...
1. **Tambah nama studio dan logo anda** -- Pautan ke Customizer atau tetapan Site Identity
2. **Kemas kini jadual kelas anda** -- Pautan terus ke editor halaman Classes
3. **Tambah jurulatih anda** -- Pautan ke editor halaman Trainers
4. **Tetapkan butiran hubungan anda** -- Pautan ke editor halaman Contact
5. **Pra-lihat laman web anda** -- Pautan ke bahagian hadapan (frontend)
...
- Menyembunyikan item menu yang tidak relevan dengan pengurusan laman web kecergasan (cth., Comments jika tidak digunakan)
- Menyusun semula menu untuk meletakkan item yang paling kerap digunakan di hadapan
- Menambah label menu tersuai yang masuk akal untuk niche tersebut ("Studio Anda" berbanding "Appearance")
...
- "Menyambungkan nama domain anda sendiri" (untuk pelanggan Growth/Pro)
- "Menambah widget tempahan ke laman web anda"
...
- Log masuk pertama dan orientasi
- Mengedit laman utama
- Mengemas kini jadual kelas
- Menambah jurulatih baharu
...
- Menunjukkan pelan FitSite semasa mereka
- Memaparkan pilihan peningkatan dengan faedah spesifik kecergasan
...
- **Kadar Pengaktifan (Activation rate)**: Peratusan pendaftaran yang benar-benar menyesuaikan laman web mereka dalam minggu pertama?
- **Log masuk minggu pertama**: Berapa kali pelanggan baharu log masuk sepanjang minggu pertama mereka?
...
- **Urutan e-mel selamat datang** yang membimbing pelanggan sepanjang minggu pertama mereka
- **Sumber bantuan spesifik niche** yang ditulis untuk pemilik studio kecergasan bukan teknikal
- **Metrik onboarding** untuk menjejaki dan menambah baik pengalaman

---

**Seterusnya:** [Lesson 9: Pricing for Profit](lesson-9-pricing) -- kita menyempurnakan strategi penetapan harga untuk memaksimumkan pendapatan dan meminimumkan kadar pelanggan berhenti (churn).
