---
title: 'Pelajaran 4: Membina Templat Niche'
sidebar_position: 5
...
Seorang pemilik studio kecergasan yang mendaftar ke FitSite harus melihat:

- Laman utama yang kelihatan seperti laman web studio kecergasan
- Halaman untuk kelas, jadual, jurulatih, dan harga yang sudah dicipta
- Imej dan kandungan contoh yang sepadan dengan industri mereka
- Reka bentuk yang terasa profesional dan sesuai dengan jenama kecergasan
...
- **Laman Utama** dengan imej hero, sorotan kelas, dan seruan bertindak
- Halaman **Tentang** dengan kisah dan misi studio
- Halaman **Kelas** dengan susun atur jadual
- Halaman **Jurulatih** dengan kad profil
...
- Semua yang ada dalam Studio Essential, ditambah:
- Halaman **Keahlian** dengan jadual harga
- Halaman **Galeri** untuk foto kemudahan
- Bahagian **Blog** untuk tips dan berita kecergasan
...
- Semua yang ada dalam Gym Pro, ditambah:
- Halaman **Lokasi** dengan senarai pelbagai kemudahan
- Templat subhalaman **Franchise/lokasi**
...
1. Aktifkan tema yang sesuai untuk perniagaan kecergasan
2. Konfigurasi tetapan tema, warna, dan tipografi
3. Sediakan header dan footer dengan navigasi yang sesuai untuk kecergasan
...
- **Kandungan contoh** yang dibaca secara semula jadi untuk kecergasan ("Selamat datang ke [Nama Studio]" bukan "Lorem ipsum")
- **Imej contoh** dari laman foto stok percuma yang menunjukkan aktiviti kecergasan
- **Susun atur berfungsi** menggunakan pembina halaman atau editor blok
...
- Plugin tempahan atau penjadualan (jika berkaitan dengan peringkat pelan anda)
...
- [ ] Semua halaman dimuatkan dengan betul dan kelihatan profesional
- [ ] Kandungan contoh adalah membantu dan khusus niche
- [ ] Imej adalah sesuai dan dilindungi lesen dengan betul
- [ ] Responsif mudah alih berfungsi pada semua halaman
- [ ] Navigasi adalah logik dan lengkap
- [ ] Borang hubungan berfungsi
...
- **Kandungan contoh instruktif** yang membimbing pelanggan melalui penyesuaian
- **Senarai semak kualiti** untuk memastikan templat sedia untuk pengeluaran

---

**Seterusnya:** [Lesson 5: Designing Your Plans](lesson-5-plans) -- kita akan mencipta peringkat produk yang sepadan dengan cara perniagaan kecergasan beroperasi.
