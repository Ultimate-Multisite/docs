...
Ultimate Multisite menyediakan lebih 200 action hooks dan lebih 280 filter hooks. Halaman ini merangkumi hook yang paling kerap digunakan dengan contoh praktikal. Untuk rujukan automatik yang lengkap, layari halaman lain dalam bahagian ini.

## Action Hooks {#action-hooks}

### Kitaran Hayat Pelanggan {#customer-lifecycle}

#### Selepas Penciptaan Pelanggan {#after-customer-creation}
...
#### Selepas Tapak Diterbitkan {#after-site-published}
...
#### Sebelum Aplikasi Templat {#before-template-application}
...
#### Peralihan Status {#status-transitions}
...
#### Sebelum Pemprosesan / Selepas Selesai {#before-processing--after-completion}
...
### Filter Templat {#template-filters}
...
### Medan Borang Checkout {#checkout-form-fields}
