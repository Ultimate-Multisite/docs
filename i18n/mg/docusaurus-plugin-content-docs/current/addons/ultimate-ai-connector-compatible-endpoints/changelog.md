---
title: >-
  Tantaran'ny fanovana ho an'ny Ultimate AI Connector ho an'ny teboka farany
  mifanentana
sidebar_position: 99
...
* Fanamboarana: Mivelatra ho azy izao ny karatra mpamatsy vaovao rehefa ampiana; fanesorana cache an'ny script rehefa havaozina ny fanitarana.
* Fanamboarana: Namespace mavitrika ho an'ny class mpamatsy ho an'ny eval() sy fitondran-tena mivelatra ho azy ho an'ireo mpamatsy vao nampiana.
* Fanamboarana: Mampiasa singa Card/CardBody/CardHeader/CardDivider marin-toerana (tsy fanandramana intsony) ho an'ny fifanarahana amin'ny WordPress 6.9+.
* Fanamboarana: Nosoloina kisary grip unicode ny DragHandle tsy voafaritra ho an'ny fisintonana mpamatsy mba handaminana indray.
