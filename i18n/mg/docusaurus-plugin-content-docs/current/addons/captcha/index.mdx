...
## Cap Captcha: Fiarovana Self-Hosted izay Mandeha Fotsiny {#cap-captcha-self-hosted-protection-that-just-works}
...
## Fiarovana amin’ny WooCommerce Card Testing {#woocommerce-card-testing-protection}
...
## Mbola Mila Google reCAPTCHA na hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Namboarina ho an’ny Scale {#built-for-scale}
...
## Mila manamboatra zavatra ve aho? {#do-i-need-to-configure-anything}
...
## Mila API keys ho an’ny Cap Captcha ve aho? {#do-i-need-api-keys-for-cap-captcha}
...
## Hampiadana ny checkout-ko ve izany? {#will-this-slow-down-my-checkout}
...
## Miaro amin’ny fanafihana card testing ve izany? {#does-this-protect-against-card-testing-attacks}
...
## Afaka mampiasa captcha providers samihafa amin’ny sites samihafa ve aho? {#can-i-use-different-captcha-providers-on-different-sites}
...
## Mifanaraka amin’ny GDPR ve izany? {#is-this-gdpr-compliant}
...
#### Fotoanan’ny Tarpit {#tarpit-timing}
...
### Fahafahana Manitatra {#extensibility}

#### Sivana IP Whitelist {#ip-whitelist-filter}
...
#### Hetsika Alohan’ny Fanakanana {#pre-block-action}
...
## Famaritana IP an’ny Client & Proxies Atokisana {#client-ip-detection--trusted-proxies}
...
### Fanamboarana {#configuration-1}

#### Fitokisana Header Cloudflare {#cloudflare-header-trust}
...
#### Fanamboarana Trusted Proxy {#trusted-proxy-configuration}
...
#### Fikarohana Ho Azy Voalohany Rehefa Alefa {#first-enable-auto-detection}
...
### Nahoana Izany no Zava-dehibe {#why-this-matters}
