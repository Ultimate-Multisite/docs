...
## Mari-pamantarana Fitetezana vs Lohatenin'ny Pejy {#navigation-label-vs-page-title}
...
## Ohatra Fampiasana {#usage-examples}

### Ohatra 1: Menio Tsotra miaraka amin'ny Mari-pamantarana Fitetezana {#example-1-simple-menu-with-navigation-label}
...
### Ohatra 2: Menio ho an'ny Toerana Theme Manokana {#example-2-menu-for-specific-theme-location}
...
## Fanao Tsara Indrindra {#best-practices}
...
## Fahaiza-manao Mifandraika {#related-abilities-1}
