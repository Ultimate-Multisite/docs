...
Requests roa mitranga miaraka dia afaka mamaky sanda mitovy ary samy manoratra miverina ilay vokatra efa nampitomboina mitovy, ka very ny isa iray. `increment_item()` dia manankina ny aritmetika amin'ny motera database amin'ny fehezanteny `UPDATE ... SET column = column + ?` tokana, ka mahatonga ny asa ho atomika amin'ny maha-izy azy.
