...
title: Sivana - wu_wp_config_reference_hook_line_patterns
sidebar_label: wu_wp_config_reference_hook_line_patterns
_i18n_hash: 5fd70ec9bc5a2b3357660797baf5519b
---
# Sivana: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

Manamarina lamina telo izahay rehefa manandrana mamantatra hoe aiza no ahafahanay mampiditra ny konstanta-nay:
...
Voafaritra ao amin'ny [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) amin'ny andalana 143
