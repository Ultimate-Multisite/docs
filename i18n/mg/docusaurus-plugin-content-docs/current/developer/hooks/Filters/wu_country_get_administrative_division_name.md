...
title: Sivana - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Ny anaran’ny fizarana. Matetika dia zavatra toy ny fanjakana, faritany, faritra, sns. |
| $country_code | `string` | Kaody ISO litera roa ho an’ny firenena. |
| $state_code | `string` | Kaody ISO litera roa ho an’ny fanjakana. |
