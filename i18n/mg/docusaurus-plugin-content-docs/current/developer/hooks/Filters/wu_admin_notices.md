...
|------|------|-------------|
| $notices | `array` | Lisitry ny fampahafantarana ho an’io tontonana manokana io. |
| $all_notices | `array` | Lisitry ny fampahafantarana nampiana, nosarahina araka ny tontonana. |
| $panel | `string` | Tontonana hakana ireo fampahafantarana. |
