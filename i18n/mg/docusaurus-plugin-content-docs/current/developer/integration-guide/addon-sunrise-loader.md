...
## Rahoviana no hampiasana azy {#when-to-use-it}
...
## Fomba fanomezana anarana rakitra {#file-naming-convention}
...
## Aiza no hametrahana ny rakitra {#where-to-place-the-file}
...
## Hooks sy filters azo ampiasaina {#hooks-and-filters-available}
...
## Ohatra faran’izay tsotra {#minimal-example}
