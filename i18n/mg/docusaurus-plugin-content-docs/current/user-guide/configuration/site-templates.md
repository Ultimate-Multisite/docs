...
Midika izany fa afaka mamorona tranonkala fototra ianao, manao activation ireo plugin samihafa, mametraka theme iray ho aktife ary manova azy araka izay tianao. Avy eo, rehefa mamorona kaonty vaovao ny mpanjifanao, fa tsy handray tranonkala WordPress mahazatra tsy misy votoaty tena ilaina izy ireo, dia handray kopia amin'ny site fototra anareo izay efa misy ny fanovana sy ny votoatiny rehetra.
...
Izany dia hanokatra varavara (modal window) izay mangataka ny **Site title, Site Domain/path,** ary **Site type**. Eo anelanelan'ny fampiasana ny **Site Type** drop-down field dia ataovy azo antoka fa safidio ny **Site Template** *.*

_![Add site template modal with site type dropdown](/img/config/site-templates-list.png)_

Afaka manampy famaritana ho an'ny mpanjifa ianao mba hanazavana izay ao anatin'ilay template:

![Site template description field on the site template edit screen](/img/config/site-template-edit-description.png)

Forman'ny lany ambany amin'ilay fomba fanovana site template dia hahita ny toggle hoe **Copy Site**. Izany dia ahafahanao mamorona site template vaovao mifototra amin'ny site template efa misy ho fototra anao mba hanampiana anao handamina fotoana fa tsy hamoronana site template manomboka.
...
Amin'ny fototra, misy fomba roa azonao ampiasaina ankehitriny (tsy miaraka):

  * Fametrahana Site Template iray amin'ny Plan rehetra anao.
...
Mba hanaovana izany, mila mandeha any amin'ny **Ultimate Multisite > Products > Edit** ianao.

![Edit product to assign site template](/img/config/product-site-templates.png)

Izany dia hitondra anao any amin'ny pejy **Edit Product**. Eo ambanin'ny fizarana **Product Options**, dia tadidio ny tabilao hoe **Site template** ary safidio ny safidy hoe **Assign Site Template** avy ao amin'ilay drop-down field. Izany dia hamoaka ny lisitra ireo site templates azo atao ary ahafahanao misafidy template iray ihany ho an'io vokatra io.
...
Amin'ny pejy **Edit Product** dia eo ambanin ny faritany **Product Options**, dia tadidio ny tabilao **Site template** ary safidio ilay safidy hoe **Choose Available Site Template** avy ao amin'ilay drop-down field. Izany dia hampiseho ny lisitry ny site templates azo atao ary ahafahanao mifidy ilay site template tianao ho azo ampiasaina. Afaka manao izany ianao amin'ny safidiana fitondran-javatra azy: **Available** raha te-handefa an'ilay site template ao anatin'ilay lisitra ianao, _**Not Available**_ raha tsy tianao ho miseho ho safidy ilay site template. Ary **Pre-selected** raha tianao ny iray amin'ireo site templates voalaza ho toy ny default mifidy.
...
Izany dia hampiseho ny pejy **Edit Checkout Form**. Mitadiava ilay champ hoe **Template Selection** ary tsindrio **Edit** eo ambaniny.

Hahazo varavara (modal window) iray ianao. Eo anatin'ilay field hoe **Template Sites**, afaka mifidy sy manatsara ny lisitry ny site templates rehetra tianao ho azo ampiasaina mandritra ny fametrahana. Ireo site templates izay voatendrim-panazavana eto dia ho azo ampiasana na inona na inona vokatra no safidinao.

![Template selection field in the checkout form editor](/img/config/checkout-form-template-step.png)

Eo amin'ny lafiny (frontend), dia hitsoy ny mpividy ilay template chooser mandritra ny checkout ary afaka misafidy ny endrika manomboka ho an'ny tranonkala vaovao ho azy.
...
Ohatra, raha te-hazo ny anaran'ny orinasa an'ny mpampiasa azy ianao mandritra ny famarihana ary hampidirina ho an'ny pejy fialan-tany (home page) avy hatrany ny anaran'ilay orinasa. Amin'ny pejy fialan-tany amin'ny template anao dia mila manampy ireo placeholder ireo ianao, toy ny ao amin'ity sary ity (aza afaka atao ny manampy placeholders eo anoloan'ny tsindrim-peo roa - {{placeholder_name}}).

![Homepage with placeholder text in curly braces](/img/config/site-templates-list.png)

Avy eo, azonao atao ny manampy champ famarihana mifanaraka amin'izany ao amin'ny checkout form anao mba hanangonana ireo angona ireo. Ny editor checkout form mitovy ampiasaina ho an'ny safidy template dia ahafahanao mametraka champs manokana eo anilan'ny safidy template:

![Template selection and registration fields in the checkout form editor](/img/config/checkout-form-template-step.png)

Ny mpanjifa anao dia afaka mameno io champ io mandritra ny famarihana.

![Frontend checkout form with template chooser](/img/config/frontend-template-chooser.png)

Dia hanoloana ireo placeholder amin'ny angona omen'ny mpanjifa ho azy ny Ultimate Multisite.
...
Izany dia vahaolana ho an'izany, manome safidy antsika ny fametrahana sandana (fake values) ho an'ireo placeholder ireo ary mampiasa ireo sandana ireo mba hitadiavana sy hanovana ny votoatiny amin'ny template sites rehefa mijery azy ny mpanjifa.

Afaka miditra amin'ny editor an'ireo placeholder template ianao amin'ny alalan'ny fipetraka ao amin'i **Ultimate Multisite > Settings > Sites**, ary avy eo, eo amin'ny sidebar, dia tsindrio ny rohy hoe **Edit Placeholders**.

![Site template settings under the Sites settings page](/img/config/settings-sites-templates-section.png)

Izany dia hitondra anao any amin'ny editor an'ireo placeholder ireo, izay afaka manampy placeholder sy ny votoatiny mifandraika aminy ianao.
