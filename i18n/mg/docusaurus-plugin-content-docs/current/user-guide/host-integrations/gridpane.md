...
## Toromarika Fikarakarana (Setup Instructions) {#setup-instructions}

### 1. Fahazoana ny API Credentials anareo avy amin'ny GridPane {#1-get-your-gridpane-api-credentials}
...
### 2. Fahazoana ny Server sy Site IDs anareo {#2-get-your-server-and-site-ids}
...
### 3. Fampidirana ireo Constant ao amin'ny wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Fanondroana ny Fandefasana (Enable the Integration) {#4-enable-the-integration}
...
## Fitantanana ny Constant SUNRISE {#sunrise-constant-management}
...
### Tsy Nampiana Domain {#domain-not-added}
