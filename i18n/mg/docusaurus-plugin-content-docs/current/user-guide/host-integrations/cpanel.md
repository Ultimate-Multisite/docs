...
## Toetran'ny Fampiasana (Features)
...
### 1. Fahazoana ny Fandaharam-potoana cPanel anao
...
### 2. Fametrahana ireo Constants ao amin'ny wp-config.php
...
### 3. Fanondroana ny Fampifandraisana (Enable the Integration)
