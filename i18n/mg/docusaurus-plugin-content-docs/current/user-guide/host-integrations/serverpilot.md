...
### 1. Fahazoana ny API Credentials an'ny ServerPilot
...
### 3. Fametrahana ireo Constants ao amin'ny wp-config.php
...
### 4. Fanondroana ny Fandraisana (Enable the Integration)
...
### Fametrahana Domain (Domain Syncing)
...
### Fitantanana Sertifika SSL (SSL Certificate Management)
...
## Fanamarinana Sertifika SSL (SSL Certificate Verification)
...
### Olana momba ny Fampifandra API (API Connection Issues)
...
### Tsy Nampidirina ny Domain (Domain Not Added)
