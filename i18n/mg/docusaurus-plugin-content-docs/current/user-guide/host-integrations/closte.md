...
### 1. Fantaro ny API Key an'ny Closte anao {#1-verify-your-closte-api-key}
...
### 2. Ampirisihina ny Fampifandraisana (Enable the Integration) {#2-enable-the-integration}
...
## Famoronana Fandaharam-ba Domain (Domain Record Creation) {#domain-record-creation}
...
### Olana momba ny Fifandraisana amin'ny API {#api-connection-issues}
...
### Fepetra ho an'ny DNS Check Interval {#dns-check-interval}
