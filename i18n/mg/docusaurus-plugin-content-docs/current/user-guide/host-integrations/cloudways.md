...
## Toetran'izy ireo (Features) {#features}
...
### 1. Fahazoana ny API Credentials anao avy amin'ny Cloudways {#1-get-your-cloudways-api-credentials}
...
### 2. Fahazoana ny Server ID sy Application ID anao {#2-get-your-server-and-application-ids}
...
### Gestion des certificats SSL {#ssl-certificate-management}
...
## Extra Domains (Domain hafa) {#extra-domains}
...
## Zava-dehibe — Loza SSL Wildcard {#important--wildcard-ssl-pitfall}
...
### Fandaharana SSL Cloudways azo atao ho an'ny tambajotran'ny Ultimate Multisite {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### Olana amin'ny SSL Certificate {#ssl-certificate-issues}
