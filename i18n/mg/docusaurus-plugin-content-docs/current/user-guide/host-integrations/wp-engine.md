...
## Toromarika Fametrahana (Setup Instructions)

### 1. Fantaro ny Plugin WP Engine
...
### 2. Ampirisihina ny Fandrindrana (Enable the Integration)
...
### Fanohanana Subdomain (Subdomain Support)
...
### Wildcard Domains (Domaine mivelatra)
...
### SSL Certificates (Sertifika SSL)
