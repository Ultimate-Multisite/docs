...
## Toetran'ny Fandaharana (Features)
...
## Toromarika Fandaharana (Setup Instructions)

### 1. Famoronana Token API an'ny Hostinger-nao
...
### 3. Fametrahana ny Constant ao amin'ny wp-config.php
...
### 4. Ampirisihina ny Fandraisana (Enable the Integration)
...
### Addon Domains (Domaine Fanampiny)
