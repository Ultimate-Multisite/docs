...
---
# Migration amin'ny Fomba Fiasa Fandaharam-potoana Fahatelo (Third-Party Mode) {#third-party-mode-migration}
...
## Inona no Novana? {#what-changed}

### Alohan'ny v1.12.0 {#before-v1120}
...
## Iza no Voafeta? {#who-is-affected}

### Fampidirana Vaovao (WordPress 7.0+) {#new-installations-wordpress-70}
...
### Fampidirana Efa Misy (Existing Installations) {#existing-installations}
...
### Dikan-teny WordPress Alohan'ny 7.0 {#wordpress-versions-before-70}
...
## Fahatakarana ireo Fomba Fiasa (Understanding the Modes) {#understanding-the-modes}

### Auto Mode (Ny Default Vaovao) {#auto-mode-new-default}
...
### Fomba Mampiasa Manokana (Manual Mode) {#manual-mode}
...
### Fomba Taloha (Legacy Mode) {#legacy-mode}
...
## Famaritana ny Fomba Miasa Ankehitriny {#checking-your-current-mode}

### Amin'ny Admin Panel (Admin Panel) {#via-admin-panel}
...
## Fanovana ny Fomba Miasa {#changing-your-mode}

### Fiova amin'ny Auto Mode (Switch to Auto Mode) {#switch-to-auto-mode}
...
### Fiova amin'ny Manual Mode (Switch to Manual Mode) {#switch-to-manual-mode}
...
### Fiova amin'ny Legacy Mode (Switch to Legacy Mode) {#switch-to-legacy-mode}
...
## Tombontolo amin'ny Auto Mode {#benefits-of-auto-mode}

### Fikarohana Ho Anao Amin'ny Fomba Atao (Automatic Discovery) {#automatic-discovery}
...
### Fandefasana Mivantana (Native Integration) {#native-integration}
...
### Fitantanana Sarotra (Simplified Management) {#simplified-management}
...
### Fahafahana Miara-miasa Tsara kokoa (Better Performance) {#better-performance}

- Ny fahaizana dia voatahiry (cached)
- Azo ampiana rehefa ilaina (Lazy-loaded on demand)
- Voalamina ho an'ny WordPress 7.0+

## Lalàn'ny Fiovan-tena (Migration Path) {#migration-path}

### Raha mbola amin'ny WordPress 6.x ianao {#if-youre-on-wordpress-6x}
...
### Raha mbola amin'ny WordPress 7.0+ ianao {#if-youre-on-wordpress-70}
...
### Tsy mipoitra ny fahaizana amin'ny auto mode {#abilities-arent-loading-in-auto-mode}
...
### Te hanohy ny legacy mode aho {#i-want-to-keep-legacy-mode}
...
### Ireo tsy mipoitra ny fahaizana manokana ahy {#my-custom-abilities-arent-showing}
...
### Mampandray "ability tsy voasokajy" aho {#im-getting-unclassified-ability-notices}
...
## Fandresena ny fomba taloha (Backward Compatibility) {#backward-compatibility}

### Fandaharana efa misy {#existing-configurations}
...
### Fandaharam-potoana fandrosoana (Deprecation Timeline) {#deprecation-timeline}
...
## Fomba tsara indrindra ampiasaina (Best Practices) {#best-practices}

### Ho an'ny fanoratana vaovao (New Installations) {#for-new-installations}
...
### Ho an'ny fanoratana efa misy (Existing Installations) {#for-existing-installations}
...
### Ho an'ny fahaizana manokana (For Custom Abilities) {#for-custom-abilities}
...
## Lohateny Mifandraika {#next-steps}
