...
## Inona no miova ho an'ny administrator
...
## Fandikana (Visiting) ny tenant mpanjaka
...
## Fandaharam-potoana (Checklist) ho an'ny asa lavitra (Remote-site operations checklist)
...
## Fandefasana ireo mpanofa sohy (sovereign tenants)
