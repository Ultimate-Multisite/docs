...
### Entana JSON Andrasana {#expected-json-payload}
...
### Sanda `triage_category` {#triagecategory-values}
...
### Famonoana ny Fanangonana Feedback {#disabling-feedback-collection}
...
## Tolotra Superdav Tantanina {#managed-superdav-service}
...
## Fikirakirana Google Calendar {#google-calendar-configuration}
...
## Fampandrenesana SMS TextBee {#textbee-sms-notifications}
...
### Fidirana amin’ny Feature Flags {#accessing-feature-flags}

1. Ao amin’ny fitantanana WordPress, mandehana any amin’ny **Gratis AI Agent → Settings**.
2. Tsindrio ny tabilao **Feature Flags**.

### Flags Fanaraha-maso Fidirana {#access-control-flags}
...
### Saina momba ny Marika {#branding-flags}
...
### Saina momba ny Fiarovana ny Automatisation {#automation-safety-flags}
...
### Fampiharana Fanovana {#applying-changes}
