...
## Famoronana vokatra domain (Creating a domain product) {#creating-a-domain-product}
...
## Tabilao Domain Settings (Domain settings tab) {#domain-settings-tab}

### Mpamatsy (Provider) {#provider}
...
### TLDs azo antsoina (Supported TLDs) {#supported-tlds}
...
### Karazana famakafakana vidiny (Markup type) {#markup-type}
...
### Vidiny fanombohana (Introductory pricing) {#introductory-pricing}
...
## Fandefasana sy Famintinana TLD (TLD import and sync) {#tld-import-and-sync}
...
## Famerenana automatique (Auto-renewal) {#auto-renewal}
...
## Admin: Fanaovana soritra domain manokana (Manual domain registration) {#admin-manual-domain-registration}
