---
title: ការបកប្រែ Ultimate Multisite
sidebar_position: 19
...
នេះគឺជាប្រព័ន្ធបកប្រែសហគមន៍ស្តង់ដាររបស់ WordPress។ នៅពេលដែលការបកប្រែឈានដល់កម្រិតនៃការយល់ព្រមគ្រប់គ្រាន់ហើយ វាត្រូវបានចែកចាយដោយស្វ័យប្រវត្តិទៅកាន់អ្នកប្រើប្រាស់ Ultimate Multisite ទាំងអស់តាមរយៈការធ្វើបច្ចុប្បន្នភាព plugin WordPress។

**យើងត្រូវការជំនួយរបស់អ្នក!** ប្រសិនបើអ្នកនិយាយភាសាផ្សេងក្រៅពីភាសាអង់គ្លេស សូមពិចារណាចូលរួមបកប្រែ។ ការបកប្រែតែមួយចំនួនក៏មានប្រយោជន៍ដែរ។ ដើម្បីចាប់ផ្តើម៖

1. ចូលទៅកាន់ [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. ជ្រើសរើសភាសាដែលអ្នកចង់បកប្រែ
3. ចុចលើ "Contribute Translation" (រួមចំណែកការបកប្រែ)
4. អ្នកនឹងត្រូវការគណនី WordPress.org ឥតគិតថ្លៃ
...
1. ទាញយក Poedit ពី [poedit.net](https://poedit.net)
2. បើកឯកសារ `.pot` ដែលស្ថិតនៅក្នុងថត `wp-content/plugins/ultimate-multisite/lang/`
3. បកប្រែអត្ថបទ (strings) នៅក្នុងចំណុចប្រទាក់ Poedit
