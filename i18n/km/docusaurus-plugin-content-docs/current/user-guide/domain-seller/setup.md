...
---
# អ្នកលក់ដែន (.Domain Seller): ការរៀបចំ និងការកំណត់អ្នកផ្តល់សេវា
...
## កម្មវិធីជួយរៀបចំលើកដំបូង (First-run setup wizard)
...
### ជំហានទី ១ — ជ្រើសរើសអ្នកផ្តល់សេវា (Choose a provider)
...
### ជំហានទី ២ — បញ្ចូលព័ត៌មានសម្ងាត់ (Enter credentials)
...
## ការកំណត់ឡើងវិញនូវអ្នកផ្តល់សេវា (Reconfiguring a provider)
...
## កំណត់ចំណាំអំពីសមត្ថភាពអ្នកផ្តល់សេវា (Provider capability notes)
