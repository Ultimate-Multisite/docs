...
---
# Ultimate Multisite ១០១ {#ultimate-multisite-101}
...
### បណ្តាញ (The Network) {#the-network}
...
#### Subdomain ប៉ះ vs. Subdirectory {#subdomain-vs-subdirectory}
...
#### Plugins និង Themes {#plugins-and-themes}
...
#### Permalinks (ផ្លូវអចិន្ត្រៃយ៍) {#permalinks}
...
#### Static Pages (ទំព័រឋិតិវន្ត) {#static-pages}
...
### ការចុះឈ្មោះ (Registration) {#registration}
...
#### ករណីទី ២: អ្នកផ្តល់សេវាកម្មเฉพาะផ្នែក (Niche Provider) {#case-2-niche-provider}
...
#### ករណីទី ៣៖ ការបង្ហោះ WordPress Web Hosting {#case-3-wordpress-web-hosting}
...
### ការពិចារណាផ្នែកស្ថាបត្យកម្ម (Architecture Considerations) {#architecture-considerations}
...
#### ការបង្ហោះរួម (Shared) ប៉ះនឹងការបង្ហោះឯកជន (Dedicated Hosting) {#shared-vs-dedicated-hosting}
...
#### ការពិចារណាលើប្រសិទ្ធភាព (Performance Considerations) {#performance-considerations}
...
#### Snapshots (រូបថតស្ថានភាព) {#snapshots}
...
#### External Scripts (ស្គ្រីបខាងក្រៅ) {#external-scripts}
...
#### Plugins (កម្មវិធីបន្ថែម) {#plugins}
...
#### ដែន (Domain) និង SSL {#domain-and-ssl-1}
