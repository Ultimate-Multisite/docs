...
### API Connection Refused (ការបដិសេធការតភ្ជាប់ API)
...
### Authentication Errors (កំហុសនៃការផ្ទៀងផ្ទាត់)
...
### Domain Not Created (មិនបានបង្កើត Domain)
...
### SSL Certificate Not Issued (មិនបានចេញវិញ្ញាបនបត្រ SSL)
