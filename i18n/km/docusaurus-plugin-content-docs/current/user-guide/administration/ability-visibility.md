...
### ការចូលទៅកាន់ការកំណត់ការមើលឃើញសមត្ថភាព (Accessing Ability Visibility Settings) {#accessing-ability-visibility-settings}
...
### ការមើលព័ត៌មានលម្អិតនៃសមត្ថភាព (Viewing Ability Details) {#viewing-ability-details}
...
### ប្រតិបត្តិការជាច្រើនក្នុងពេលតែមួយ (Bulk Operations) {#bulk-operations}
...
## ការមើលឃើញលើផ្ទៃផ្សេងៗគ្នា {#visibility-in-different-surfaces}
...
## ការអនុវត្តល្អបំផុតด้านសន្តិសុខ (Security Best Practices) {#security-best-practices}

### គោលការណ៍ផ្តល់សិទ្ធិអប្បបរមា (Principle of Least Privilege) {#principle-of-least-privilege}
...
### ការត្រួតពិនិត្យជាទៀងទាត់ (Regular Audits) {#regular-audits}
...
### ការកត់ត្រា និងការតាមដាន (Logging and Monitoring) {#logging-and-monitoring}
...
### សមត្ថភាពភាគីទីបី (Third-Party Abilities) {#third-party-abilities}
...
## ការផ្លាស់ប្តូរពីរបៀបចាស់ (Legacy Mode Migration) {#migration-from-legacy-mode}
