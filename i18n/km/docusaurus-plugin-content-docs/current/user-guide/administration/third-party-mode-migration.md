...
---
# ការផ្លាស់ប្តូររបៀបដំណើរការជាមួយភាគីទីបី (Third-Party Mode Migration) {#third-party-mode-migration}
...
## តើអ្នកណាខ្លះដែលរងផលប៉ះពាល់? {#who-is-affected}
...
### WordPress កំណែមុន 7.0 {#wordpress-versions-before-70}
...
## ការយល់ដឹងអំពីរបៀបដំណើរការនីមួយៗ {#understanding-the-modes}
...
### របៀបដំណើរការដោយដៃ (Manual Mode) {#manual-mode}
...
### របៀបដំណើរការបែបចាស់ (Legacy Mode) {#legacy-mode}
...
## ការពិនិត្យមើលរបៀបដំណើរការបច្ចុប្បន្នរបស់អ្នក {#checking-your-current-mode}

### តាមរយៈ Admin Panel (ផ្ទាំងគ្រប់គ្រង) {#via-admin-panel}
...
## ការផ្លាស់ប្តូររបៀបដំណើរការរបស់អ្នក {#changing-your-mode}

### ប្តូរទៅ Auto Mode (របៀបស្វ័យប្រវត្តិ) {#switch-to-auto-mode}
...
### ប្តូរទៅ Manual Mode (របៀបដំណើរការដោយដៃ) {#switch-to-manual-mode}
...
### ប្តូរទៅ Legacy Mode (របៀបដំណើរការបែបចាស់) {#switch-to-legacy-mode}
...
## អត្ថប្រយោជន៍នៃ Auto Mode (របៀបអូតូម៉ាទិក) {#benefits-of-auto-mode}

### ការស្វែងរកដោយស្វ័យប្រវត្តិ (Automatic Discovery) {#automatic-discovery}
...
### ការរួមបញ្ចូលក្នុងប្រព័ន្ធដើម (Native Integration) {#native-integration}
...
### ការគ្រប់គ្រងកាន់តែងាយស្រួល (Simplified Management) {#simplified-management}
...
### ប្រសិទ្ធភាពកាន់តែប្រសើរ (Better Performance) {#better-performance}

- Abilities នឹងត្រូវ cache (រក្សាទុកជាបណ្ដោះអាសន្ន)
- Lazy-loaded នៅពេលមានតម្រូវការប៉ុណ្ណោះ
- បែបល្អបំផុតសម្រាប់ WordPress 7.0+។

## ផ្លូវនៃការផ្លាស់ប្តូរ (Migration Path) {#migration-path}

### ប្រសិនបើអ្នកកំពុងប្រើ WordPress 6.x {#if-youre-on-wordpress-6x}
...
### ប្រសិនបើអ្នកកំពុងប្រើ WordPress 7.0+ {#if-youre-on-wordpress-70}
...
### Abilities មិនផ្ទុកនៅក្នុង auto mode {#abilities-arent-loading-in-auto-mode}
...
### ខ្ញុំចង់រក្សា legacy mode {#i-want-to-keep-legacy-mode}
...
### สำหรับ ability ที่กำหนดเอง (Custom Abilities) {#for-custom-abilities}
...
## หัวข้อที่เกี่ยวข้อง {#next-steps}
