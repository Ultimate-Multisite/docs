...
## ការបើកដំណើរការក្នុង Sandbox (Sandbox Activation)
...
## ការគ្រប់គ្រង Plugin ដែលបង្កើតដោយស្វ័យប្រវត្តិ (Managing Generated Plugins)
...
## ការដំឡើង Plugin ដែលបង្កើតដោយស្វ័យប្រវត្តិនៅលើ Network (Installing a Generated Plugin on the Network)
...
## ការធ្វើបច្ចុប្បន្នភាព Plugin (Plugin Updates)
