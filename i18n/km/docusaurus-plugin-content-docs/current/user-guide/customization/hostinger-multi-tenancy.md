...
## កំណត់ចំណាំនៃការរៀបចំ (Setup notes) {#setup-notes}
...
## ការផ្លាស់ប្តូរជាក់លាក់តាមសមត្ថភាព (Capability-specific changes) {#capability-specific-changes}
...
## ការដោះស្រាយបញ្ហា Tenant របស់ Hostinger (Troubleshooting Hostinger tenants) {#troubleshooting-hostinger-tenants}
