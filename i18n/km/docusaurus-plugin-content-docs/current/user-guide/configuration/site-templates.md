...
## តើ Site Template ជាអ្វី? {#what-is-a-site-template}
...
## ការបង្កើត និងការកែសម្រួល Site Template ថ្មី {#creating-and-editing-a-new-site-template}
...
### ការកែសម្រួលខ្លឹមសារនៃ Site Template {#customizing-the-contents-of-a-site-template}
...
### ជម្រើសขั้นสูง (Advanced Options) {#advanced-options}
...
### ការប្រើប្រាស់ Site Templates {#using-site-templates}
...
#### របៀបទី ១: កំណត់ Site Template (Assign Site Template) {#mode-1-assign-site-template}
...
#### របៀបទី ២៖ ជ្រើសរើស قالب সাইតដែលអាចប្រើបាន (Choose Available Site Template) {#mode-2-choose-available-site-template}
...
### របៀបលំនាំដើម៖ ការជ្រើសរើស Site template នៅលើទម្រង់ Checkout {#default-mode-site-template-selection-on-the-checkout-form}
...
#### คัดลอกสื่อบนการทำสำเนาเทมเพลต (Copy Media on Template Duplication) {#copy-media-on-template-duplication}
...
### ការដោះស្រាយបញ្ហា "template ពោរពេញទៅដោយ placeholders" {#pre-populating-site-templates-with-auto-search-and-replace}
