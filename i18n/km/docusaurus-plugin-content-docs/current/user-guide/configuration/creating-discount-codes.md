...
---
# ការបង្កើត Discount Codes (v2) {#creating-discount-codes-v2}
...
## ការបង្កើត និងការកែសម្រួល Discount Codes {#creating-and-editing-discount-codes}
...
### ការប្រើប្រាស់ URL Parameters: {#using-url-parameters}
