...
---
# ទម្រង់ការបិទទូទាត់ (Checkout Forms) {#checkout-forms}
...
### ប្រអប់ Pricing Table (តារាងតម្លៃ) {#the-pricing-table-field}
...
### ការបន្ថែមប៊ូតុងជ្រើសរើសរយៈពេល {#adding-a-period-selection-toggle}
...
#### ជំហានទី ១៖ កំណត់ Price Variations នៅលើផលិតផលរបស់អ្នក {#step-1-set-up-price-variations-on-your-products}
...
#### ជំហានទី ២៖ បន្ថែមវាល Period Selection ទៅក្នុង Checkout Form របស់អ្នក {#step-2-add-the-period-selection-field-to-your-checkout-form}
...
#### ជំហានទី 3៖ កំណត់ទីតាំងវាឱ្យនៅពីលើតារាងតម្លៃ (Pricing Table) {#step-3-position-the-field-above-the-pricing-table}
...
#### វាដំណើរការយ៉ាងដូចម្តេចនៅលើ Frontend {#how-it-works-on-the-frontend}
...
#### ការជ្រើសរើសរយៈពេលបង់ប្រាក់ជាមុនតាមរយៈ URL {#pre-selecting-a-billing-period-via-url}
...
### វាល Template Selection (ការជ្រើសរើស قالب) {#the-template-selection-field}
...
#### ការបន្ថែមវាលដោយដៃ {#adding-the-field-manually}
...
#### ការលុបវាលចេញ {#removing-the-field}
