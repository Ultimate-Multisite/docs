...
## ทักษะที่คำนึงถึงธีมที่มีให้ใช้
...
## តើ Skills ត្រូវបានជ្រើសរើសដោយរបៀបណា
...
## ការប្រើប្រាស់ Theme-Aware Skills (ជំនាញដែលយល់ពី Theme)
