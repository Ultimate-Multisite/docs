...
## ពាក្យបញ្ជាសម្រាប់ដំណើរការ (Commands to run)
...
## ការបរាជ័យទូទៅ (Common failures)

### ការអនុញ្ញាតមូលដ្ឋានទិន្នន័យមិនត្រូវគ្នាជាមួយ host
...
### ការដំឡើង Bedrock ឬ local socket មិនអាចភ្ជាប់បានទេ
...
### Async push queue មិនបានបង្ហូរចេញទេ (does not drain)
...
### ចំនួនអ្នកប្រើប្រាស់ tenant មិនត្រឹមត្រូវទេ (Tenant user count is wrong)
...
### ការចូលមើល SSO ត្រូវបានបដិសេធ (SSO visit is rejected)
