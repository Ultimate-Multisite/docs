...
---
# ការតភ្ជាប់ Cloudways {#cloudways-integration}
...
## ការណែនាំអំពីការដំឡើង (Setup Instructions) {#setup-instructions}

### ១. ទទួលបានព័ត៌មាន API របស់ Cloudways របស់អ្នក {#1-get-your-cloudways-api-credentials}
...
### ២. ទទួលបាន Server ID និង Application IDs របស់អ្នក {#2-get-your-server-and-application-ids}
...
### 4. បើកដំណើរការការរួមបញ្ចូល (Enable the Integration) {#4-enable-the-integration}
...
## Extra Domains (ដែនបន្ថែម) {#extra-domains}
...
## សារសំខាន់ — បញ្ហាប្រឈម SSL Wildcard {#important--wildcard-ssl-pitfall}
...
### ការកំណត់រចនាសម្ព័ន្ធ Cloudways SSL ដែលត្រូវបានណែនាំសម្រាប់បណ្តាញ Ultimate Multisite {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### មិនបានបន្ថែមដែន (Domain Not Added) {#domain-not-added}
