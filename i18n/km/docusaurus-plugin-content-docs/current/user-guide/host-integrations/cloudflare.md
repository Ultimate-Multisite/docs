...
### ១. ទទួលបាន Cloudflare API Key របស់អ្នក {#1-get-your-cloudflare-api-key}
...
### ២. ទទួលបាន Zone ID របស់អ្នក {#2-get-your-zone-id}
...
### ៣. បន្ថែមថេរទៅក្នុង wp-config.php {#3-add-constants-to-wp-configphp}
...
### ៤. បើកដំណើរការការតភ្ជាប់ (Enable the Integration) {#4-enable-the-integration}
...
### ការគ្រប់គ្រង subdomain {#subdomain-management}
...
### ការបង្ហាញ DNS Record {#dns-record-display}
...
### វាខុសពីការរួមបញ្ចូល Cloudflare បែបស្តង់ដារយ៉ាងដូចម្តេច {#how-it-differs-from-the-standard-cloudflare-integration}
...
### ការកំណត់រចនាសម្ព័ន្ធ Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
### ไม่มีการเพิ่ม Subdomain {#subdomain-not-added}
...
### បញ្ហាការបណ្តាក់ទូរស័ព្ទ (Proxying Issues) {#proxying-issues}
