...
## របៀបរៀបចំ (Setup Instructions) {#setup-instructions}

### ១. ទទួលបានព័ត៌មាន API របស់ ServerPilot របស់អ្នក {#1-get-your-serverpilot-api-credentials}
...
### ២. ទទួលបាន App ID របស់អ្នក {#2-get-your-app-id}
