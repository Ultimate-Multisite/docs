...
---
# ការសម្របសម្រួល Site Builder v2 {#site-builder-orchestration-v2}
...
### 1. ការបង្កើតផែនការ {#1-plan-generation}
...
### 2. ការស្វែងរក Plugin {#2-plugin-discovery}
...
### 3. ការប្រតិបត្តិផែនការ {#3-plan-execution}
...
### 4. ការតាមដានវឌ្ឍនភាព {#4-progress-tracking}
...
### 5. ការស្តារកំហុស {#5-error-recovery}
...
## សមត្ថភាពផែនការគេហទំព័រ {#site-plan-abilities}
...
## ការប្រៀបធៀប v1 និង v2 {#comparing-v1-and-v2}
...
## ពាក្យបញ្ជាផែនការ WP-CLI {#wp-cli-plan-commands}
