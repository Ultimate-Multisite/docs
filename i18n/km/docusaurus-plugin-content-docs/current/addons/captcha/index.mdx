...
## Cap Captcha: ការការពារដែលបង្ហោះដោយខ្លួនឯង ហើយដំណើរការបានភ្លាមៗ {#cap-captcha-self-hosted-protection-that-just-works}
...
## ការពារការសាកល្បងកាតរបស់ WooCommerce {#woocommerce-card-testing-protection}
...
## នៅតែត្រូវការ Google reCAPTCHA ឬ hCaptcha មែនទេ? {#still-need-google-recaptcha-or-hcaptcha}
...
## បង្កើតឡើងសម្រាប់មាត្រដ្ឋានធំ {#built-for-scale}
...
## តើខ្ញុំត្រូវកំណត់អ្វីខ្លះទេ? {#do-i-need-to-configure-anything}
...
## តើខ្ញុំត្រូវការ API keys សម្រាប់ Cap Captcha ទេ? {#do-i-need-api-keys-for-cap-captcha}

ទេ។ Cap Captcha បង្ហោះដោយខ្លួនឯងទាំងស្រុង។ មិនមានគណនីខាងក្រៅ មិនមានការចុះឈ្មោះដែន និងមិនមានការឈឺក្បាលពីការកំណត់។

## តើវានឹងធ្វើឱ្យ checkout របស់ខ្ញុំយឺតទេ? {#will-this-slow-down-my-checkout}
...
## តើវាការពារប្រឆាំងនឹងការវាយប្រហារសាកល្បងកាតទេ? {#does-this-protect-against-card-testing-attacks}
...
## តើខ្ញុំអាចប្រើអ្នកផ្តល់ captcha ខុសៗគ្នានៅលើគេហទំព័រផ្សេងៗបានទេ? {#can-i-use-different-captcha-providers-on-different-sites}

អ្នកផ្តល់ captcha ត្រូវបានកំណត់ទូទាំងបណ្តាញ ប៉ុន្តែអ្នកអាចកែតម្រូវការកំណត់ភាពលំបាកតាមតម្រូវការរបស់អ្នក។

## តើវាអនុលោមតាម GDPR ទេ? {#is-this-gdpr-compliant}
...
### សមត្ថភាពពង្រីក {#extensibility}

#### តម្រងបញ្ជីស IP {#ip-whitelist-filter}
...
#### សកម្មភាពមុនរារាំង {#pre-block-action}
...
## ការរកឃើញ IP របស់អតិថិជន និងប្រូកស៊ីដែលទុកចិត្ត {#client-ip-detection--trusted-proxies}
...
#### ការទុកចិត្ត Cloudflare Header {#cloudflare-header-trust}
...
#### ការកំណត់រចនាសម្ព័ន្ធ Trusted Proxy {#trusted-proxy-configuration}
...
#### ការរកឃើញដោយស្វ័យប្រវត្តិពេលបើកដំបូង {#first-enable-auto-detection}
...
### ហេតុអ្វីរឿងនេះសំខាន់ {#why-this-matters}
