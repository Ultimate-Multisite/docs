...
សំណើពីរដំណាលគ្នាអាចអានតម្លៃដូចគ្នា ហើយទាំងពីរអាចសរសេរលទ្ធផលដែលបានបង្កើនដូចគ្នាត្រឡប់វិញ បណ្តាលឱ្យបាត់បង់ការរាប់មួយ។ `increment_item()` ផ្ទេរការគណនាទៅម៉ាស៊ីនមូលដ្ឋានទិន្នន័យដោយប្រើ statement តែមួយ `UPDATE ... SET column = column + ?` ដែលធ្វើឱ្យប្រតិបត្តិការនេះមានលក្ខណៈ atomic ដោយខ្លួនឯង។
