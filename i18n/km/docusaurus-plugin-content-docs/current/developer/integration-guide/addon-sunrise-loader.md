...
## ពេលណាត្រូវប្រើវា {#when-to-use-it}
...
## ច្បាប់ដាក់ឈ្មោះឯកសារ {#file-naming-convention}
...
## ទីតាំងដាក់ឯកសារ {#where-to-place-the-file}
...
## Hook និង filter ដែលអាចប្រើបាន {#hooks-and-filters-available}
