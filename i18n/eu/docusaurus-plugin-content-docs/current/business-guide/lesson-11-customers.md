---
title: 'Lezioa 11: Klientzak aurkitzea'
sidebar_position: 12
...
- **Zer dagoen klienteak jakin duzu** -- komunitate zehatzak, ekoizpenak eta kanaletak
...
- **Ez dago websteia**: Potentzial osoa -- zer emateke duzu hori behar du
...
- **Facebook groups** gimnazioaure, estudio managerra, fitness entrepreneurra
- **Reddit** komunitateak gabeak, r/personaltraining, r/fitnessindustry
...
1. **Gautxien kontribuitea** -- jardutza, fitness negozioa online jartzeko ideiak eskatzen,
2. **Zerbitzua batzuk erabilizki** -- fitness eta web presentazioaren arteko ikuntzen dutela jakin joateke
...
- "Websteiarekin gimnazioari gehiago miurak nola hartzen?"
- "Fitness studioetako websteiaren lehen erabilgarriak"
- "Personal trainerrek websteia behar dute?"
- "Eskaintzeko planaren onlinean nola jartzen da?"

Kanala 4: Partenariak

Fitness studio-ei irudiak eta hori ez duela negozioakarekin parteneriatu:

- **Rezervazio softwarea mendiak** -- horrek jardutzea konponbidea, sizkuntza web-aren daiteke.
- **Ekinakileko ekipamendu mendiak** -- horrek berrek pertsonalak aurkitzen du.
- **Fitness profesionaletatik negozio-coachak** -- horrek marketing eta aukera batzuk ezarri dute.
- **Negozioa-gertu-elakoak lekuak** -- komerzia-kamperazioak, txiki negozio-grupak.

Referral commissionak edo promosioa aldatzeko teklatuak emateko. [AffiliateWP addon](/addons/affiliatewp) dailean programa referentzial bat formalizatzeko lagundu.

Kanala 5: Indústria-ergeiak

Fitness industria-ren gehiagoak lekuetan aurkitu duzu potensiala duten kliuntzakarekin:

- **Trade shows eta expositak** -- estalkia edo partisipazioa-gertu-elakoak.
- **Konferentziak** -- hitz egiten aukera batzuk autoritatea ematen du.
- **Lokal fitness meetups** -- txikiagoak baina oso ondo targetatuta.
- **Online webinarrak** -- "Fitness studio-aren online presentazioa nola egin"

Handia budget batek ez duzu behar. Partezipal bat gisa aurkitu eta zer egiten duen artean hitz egiten baduzu, lehiak sortzeko aukera izango da.

Kanala 6: Erakunde-lekuak (Showcase Sites)

Marketing-aren beste espezialoa da kliuntzakaren web-lekuak. Barkapenarekin:

- Prozesu kustomer webstei marketing lapenaren
- Kasu-estudiak sortzea: "Nola [Studio Name]-ek 30% gehiago bestelakoak aurkitu zuen FitSite-rekin"
...
1. [AffiliateWP addon](/addons/affiliatewp) instalatu, bai aurkitu kondia, edo sistema bat simple referentzia trackinga sortu duzu
...
- **Cost per acquisition**: Kudeak zer gastatu zuen (aldea eta diru) irudi bat aurkitzeko?
- **Conversion rate**: Lehen kanaldako prospect-ek zein %-k inscrepen dira?
- **Customer quality**: Bestelako kanaldako kustomerak gehiago geratzen dira edo gehiago upgrade egiten dute?
...
- **Muna 7-12**: 50-100+ kustomer, referentziak eta organic searchak importante dira
...
* **Estrategia partezpenaren komunitatean** kredibilita sortzeko
* **Kontenido marketingak** fitness studio nagusiak erabilizten
* **Programa referentzia bat** "word of mouth"-a (gaitzen) diren irudiak eramateko
* **Tracking framework bat** zer funtzionatzen duen eramateko

---

**Hitzera:** [Lehen Itxura 12: Negozioa Erregitzen](lesson-12-operations) -- niche webplata nagusiari emateko eguneroko erreguntzak.
