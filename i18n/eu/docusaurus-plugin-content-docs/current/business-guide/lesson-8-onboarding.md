---
title: 'Lehena-lehenaren: Klientela ondo jartzea'
sidebar_position: 9
...
- Logiatu du eta web bat ikusten du zein fitness webstea dela → geratzen da
- Zer egin behar duen guztia ezagutzen du → geratzen da
- Generiko WordPress dashboard batean ez daiterren sentitzen da → aukeratzen da
...
1. **Zure studioaren nabarmena eta logoa gehitu** -- Customizer edo Site Identity aukeraera duen linku
2. **Zure klaseanak jarraitua** -- Classes page editorra direktu linku
3. **Zure entrenadorak gehitu** -- Trainers page editorra linku
4. **Zure datuak emateko informazioa zehaztu** -- Contact page editorra linku
5. **Zure webaren ikustea egin** -- Frontend-era linku

Mundia da Dashboarda Simplifikatu

Ekinak guzti ez dute WordPress menuko item guztietan ikusten behar. Mendatzen duzu:

- Menuko itemak horriak gizotzea eta fitness webgune administrazio edozein eragiketa ez dutenak (adibidez, komentariak erabiltzen ez dutenean)
- Menua ustez sortzeko, erabiltarri dauden itemak lehenago ipotzatu
- Niche-i (espezialitatea) eskatzen duen oso sentido dituzten menuko labelak gehitu ("Studio-ak" edo "Appearance"-ren aldeko)
...
- "Studioaren logo eta koloreak aldatzeko"
- "Itxura/Pro (Growth/Pro) klientzak dira, ir mailaren kontua konektatzeko"
- "Ir webgunean booking widget bat hasi"
...
- Lehen kontua hasi eta orientazioa
- Homepage mugitzen
- Esketza-erren planifikazioa onartzeko
- Trainer berri bat hasi
...
- Ertarte jakin plan FitSitearen aktualak
- Fitness-spediko bere interesak eta berrietan eskaintzen
...
- **Aktibazio tasa**: Irregistro dituztenen %-ren zehazki, zerbait lehen semanaan sitearen personalizatzen dute?
- **Lehen semanaan logpeak**: Berri klientu bat bere lehen semanaren aur egiteko logpeak ez du?
...
├── Ultimate Multisite (konfiguratu eta brandatutako)
├── Platform Domain (fitsite.com + wildcard SSL)
├── Site Templates (Studio Essential, Gym Pro, Fitness Chain)
├── Produkzioak (Starter, Growth, Pro + Order Bumps)
├── Checkout Flow (niche-spediko, testatutako)
├── Branding (login, dashboard, emails, invoices, marketing site)
├── Kliurietaren Onboardinga
│   ├── Quick Start dashboard widget
│   ├── Fitness site administrazioarekin errazatu dashboard
│   ├── 4-email berri-erregistroak
│   ├── Niche-spediko makuagunea (knowledge base)
│   ├── Video walkthroughs
│   └── Kontu zehaztu guneak
...
- **Email zehatz bat** bere taldea lehen semana baino irakurri eta orientatuz duena
- **Eskaintzak gertu-erako resource-ek** teknologia ez-tekniko fitness studio nagusiak dira
- **Onboarding metrikak** eraginkorrak eta hobetzeko prozesuak

---

**Hurrengo:** [Lehen Itzultza: Aurreratutako Prezioa](lesson-9-pricing) -- prezioaren estratezia hobetuko dugu, diru maximizatzeko eta taldearen aukera ezarrik.
