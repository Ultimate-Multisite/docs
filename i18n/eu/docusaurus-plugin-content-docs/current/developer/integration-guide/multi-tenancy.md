...
## Maizterra abiarazteko fluxua {#tenant-bootstrap-flow}
...
## SSO eta REST hook-ak {#sso-and-rest-hooks}
...
## Bezero subiranoen ekintza-URLak {#sovereign-customer-action-urls}
...
## Migrazio-egiaztapena {#migration-verification}
...
## Maizterra ezabatzea {#tenant-deletion}
...
## Baztertutako datu-basearen bideratzailea {#deprecated-database-router}
