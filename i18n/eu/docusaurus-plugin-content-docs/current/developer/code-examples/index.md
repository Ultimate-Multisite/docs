---
title: Kode-adibide aurreratuak
sidebar_position: 1
...
Aldi bereko bi eskaerak balio bera irakur dezakete eta biek gehitutako emaitza bera berridatzi, zenbaketa bat galduz. `increment_item()`-ek aritmetika datu-basearen motorraren esku uzten du `UPDATE ... SET column = column + ?` adierazpen bakar batekin, eragiketa berez atomikoa bihurtuz.
