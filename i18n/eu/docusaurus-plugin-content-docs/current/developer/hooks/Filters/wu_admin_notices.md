---
id: wu_admin_notices
title: Iragazkia - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Panel jakin horretako jakinarazpenen zerrenda. |
| $all_notices | `array` | Gehitutako jakinarazpenen zerrenda, panelaren arabera bereizita. |
| $panel | `string` | Jakinarazpenak eskuratzeko panela. |
