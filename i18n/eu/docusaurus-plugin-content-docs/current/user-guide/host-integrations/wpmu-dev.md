...
---
# Integrazioa WPMU DEV-ekin {#wpmu-dev-integration}
...
## Konfigurazioa Erdatzeko Instrukzioak {#setup-instructions}

### 1. WPMU DEV Hosting Bidez Kontrollatu {#1-verify-wpmu-dev-hosting}
...
### 2. Integrazioa Aktiboa Egitea {#2-enable-the-integration}
...
## Ondo Zerbitzua Erdatzen {#how-it-works}

### Domaineraren Sinkronizazioa {#domain-syncing}
...
### SSL Sertifikatua Administrazioa {#ssl-certificate-management}
...
## Ezaurritako Oinarrizko Nota hauek {#important-notes}

### Domenia Erabatzea {#domain-removal}
...
### API Autentikazioa {#api-authentication}
...
## Problema Erabatzea (Troubleshooting) {#troubleshooting}
...
### Domenia Ez Hasartu {#domain-not-added}
