...
## Aurtegitura Erregitzenak

### 1. RunCloud API Identifikazioak Hondartu
...
### 2. Zure Server eta App ID-ak Hondartu
...
### 3. Konstante hauek wp-config.php-le Hondartu
...
## Ondo Zerbitzuon Moduaren Erdatu (How It Works)
...
## Problema Erdatzeko (Troubleshooting)
...
### Domeina Ez Hasartu (Domain Not Added)
