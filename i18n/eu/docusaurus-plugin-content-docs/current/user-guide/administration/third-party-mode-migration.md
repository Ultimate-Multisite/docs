...
### v1.12.0 Herrian Aurrera egin baino lehen
...
### v1.12.0 Herrian Aurrera egin ondoren
...
### Instalazioak Bizi (WordPress 7.0+)
...
### WordPress Bertsioak 7.0 Herrian Aurrera egin baino lehen
...
## Moduak Erratzena (Understanding the Modes)

### Auto Mode (Defaulta Bikoa)
...
## Modu Aurreratuaren Kontroloa

### Administrazio Panelu bidez
...
### Auto Modu (Auto Mode) funtziara aldatzea
...
### Manual Modu (Manual Mode) funtziara aldatzea
...
### Legazian Moduarekin (Legacy Mode) aldatzea
...
## Auto Moduen Benefiziotasunak

### Automatiko Aurretxera (Automatic Discovery)
...
### Integrazio Natiboa (Native Integration)
...
### Administrazioa Orokorizatua (Simplified Management)
...
### Hau WordPress 7.0+an dagoenean
...
### Auto moduan abilidades ez dagoenean
...
### "unclassified ability" (ez klasifikatu ability) notiziak hartzen dutena
...
## Backward Compatibility (Ireki-aldia)

### Konfigurazioak dagoen daude
...
### Deprecation Timeline (Ez-eragiketa aldea)
...
## Best Practices (Mehietako praktikak)

### Berri instalazioetan
...
### Abilities bereziak (Custom Abilities)
