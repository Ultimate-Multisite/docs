...
## Membershiparen Status Bizitza-aldia
...
### Membershiparen Amaierdia Zer Modu egiten du?
...
#### Auto-renplatu eta Ez-auto-renplatu Membriatzaingoak (Memberships)
...
### Oinarriak Nondatzen Dugu (How Trials End)
...
## Frontend-eko Zuzendaritza Blokeatzea (Block Frontend Access)
...
### Irakaspenak Blokeatuta Dagoenean Zerren Erakunde
...
### Zerren Blokeatuta Dagoena eta Eguneko Prozesua
...
## Problema-soluzpen: Membership-ek irizten jakin nahi duenean

Membership-ek irizten jakin nahi duenean, hauek lehenik ikustu behar duzu:

### 1. Block Frontend Access konponbidea onditu da
...
### 2. Frontend Block Grace Period-a ikustu
...
### 3. Ezinbesteko Statusa Mendiaren Ezkutik Kontrollatu
...
### 4. Action Scheduler-ek Irrun Duela Kontrollatu
...
### 5. Gateway Webhook Problema Nagusiak Erakunde (Auto-Renewing Memberships)
...
### 6. Expiration Grace Period Nagusiak Erakunde (Cron Level)
...
### 7. Membership bat manuaz eragitu (Manually Expire a Membership)
...
## Ezgune-lerako referentzia (Developer Reference)
