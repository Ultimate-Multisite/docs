...
## Konfigurazioa Instrukiak

### 1. CyberPanel API-aren aktibatu
...
### 2. Konstanteak wp-config.php-le gehitu
...
### 4. Konektibitatea jartzen jakinarazteko
...
### Email Forwarders (Email Aurreragileak)
...
## Problema-ezlikizuna (Troubleshooting)

### API Konektua Ez Eragitenak
