---
title: Administrazio panelaren ikusiak
sidebar_position: 16
...
AI konektoreak konfiguratizi osoa suportatzen dituzten OAuth provider pool hauek: Anthropic Max, OpenAI ChatGPT/Codex eta Google AI Pro. Lehen kontu super adminak lehiak konektatzeko, kontuak iruditzen (refresh) edo email-ekoa besteko kontuak hartzeko, eta browser-ekoa redirekta egiten tratatzen ez duenean sandboxed erabilera manual OAuth fallbacka erabiltzeko aukera ematen ditu. Cursor Pro setup opsioak admin panelaren ondorioz arau dira.

ChatGPT/Codex kontuak konektore-backed tool use (konektore-ekoa suportatutako tool use) suportatzen du, horrek operazioak tool-ekoa uste dugu, gertatu beharko du, zehatz kontu OpenAI-rekin konektatuta Codex tool behaviora erabil dezake.

![Settings page](/img/admin/settings-general.png)

Hona da general settings pagaren oso ikuspen:

![Settings general full page](/img/admin/settings-general-full.png)

Eta email-ekoa kontuak hartzeko pagina:

![Settings emails full page](/img/admin/settings-emails-full.png)

Eta mugikorrak (payments) kontuak hartzeko pagina:

![Settings payments full page](/img/admin/settings-payments-full.png)

Eta mugikorrak kontuak hartzeko pagaren espezialko zehaldia:

![Settings payments bottom section](/img/admin/settings-payments-bottom.png)

Eta siti-ekoa kontuak hartzeko pagina:
