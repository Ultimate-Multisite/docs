...
## Lehenan iruditzen setup wizard (First-run setup wizard) {#first-run-setup-wizard}
...
### Irudi 1 — Provedior bat aukeratu {#step-1--choose-a-provider}
...
### Irudi 2 — Credenciales eratu {#step-2--enter-credentials}
...
### Irrenditua 3 — Konektazioa probatu {#step-3--test-the-connection}
...
### Irrenditua 4 — TLDs importatu {#step-4--import-tlds}
...
### Irrenditua 5 — Domain produkzioa sortu {#step-5--create-a-domain-product}
...
## Providera irrenditua (Reconfiguring a provider) {#reconfiguring-a-provider}
...
### Ikusteko leku bat gehiago ematzea {#adding-a-second-provider}
...
### TLD-ak manuaz sinkronatzea {#syncing-tlds-manually}
...
## Provedoraren kapabilidadeko noturia {#provider-capability-notes}
