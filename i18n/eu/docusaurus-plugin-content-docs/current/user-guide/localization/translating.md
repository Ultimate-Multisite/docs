---
title: Ultimate Multisite-a iritszalean
sidebar_position: 19
...
Hau da WordPress komunitatearen standard translation sistema. Itxiturikak ordezkatu behar duen aprobatasun merkatuaren maila egonatuenean, automaticoki Ultimate Multisite erabiltzaile guztiei WordPress plugin update-ek bidez ezarritzen dira.

**Biziaren laguntzen dituzteko!** Ingilerraren bestelako hizkuntza bat dutenean, itxiturikak kontribuiziona jakin dezake. Ez gutxiago testu bat itxitu ere laguntzen du. Aurrera egiteko:

1. Zure [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) webgunean jarri.
2. Zure hizkuntza aukeratu.
3. "Contribute Translation" (Itxiturik kontribuiziona) klikatu.
4. WordPress.org akun bat libre behar duzu.
...
1. [poedit.net](https://poedit.net) dartzatu Poedit-a
2. `wp-content/plugins/ultimate-multisite/lang/` dairean dagoen `.pot` filea irekitu
3. Poedit-aren interfazean string-ak irudiari egitu
