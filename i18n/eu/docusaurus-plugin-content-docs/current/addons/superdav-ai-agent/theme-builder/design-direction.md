...
- **Kolore nagusia** — botoietarako, esteketarako eta azentuetarako erabiltzen den marka-kolore nagusia
- **Bigarren mailako kolorea** — aniztasunerako kolore osagarria
- **Azentu-kolorea** — elementu garrantzitsuetarako nabarmentze-kolorea
...
- **Izenburuen letra-tipoa** — orrialde-izenburuetarako eta atal-buruetarako erabiltzen da
- **Gorputzaren letra-tipoa** — paragrafo-testurako eta edukirako erabiltzen da
- **Letra-tamaina** — pantaila-tamaina desberdinetarako tamaina moldakorra
...
- **Ikonoak** — ikonoen estiloa eta tamaina
...
- Nabigazio moldakorra (hamburger menu)
...
| Gailua | Zabalera | Aurrebista |
|--------|-------|---------|
| **Mobile** | 375px | Telefono bertikala |
| **Tablet** | 768px | Tablet horizontala |
...
1. **Koloreak doituz** — paletako edozein kolore aldatu
2. **Letra-tipoak aldatuz** — tipografia desberdinak hautatu
3. **Tarteak aldatuz** — padding eta marjinak doitu
...
- Desktop aurrebista berehala eguneratzen da
- Mobile aurrebista berehala eguneratzen da
...
- **Jatorrizko diseinua** — ikusi zer aldatu den
...
1. **Berrikusi bi aurrebistak** — egiaztatu desktop eta mobile itxura ona dutela
2. **Egiaztatu kolore guztiak** — ziurtatu kontrastea eta irisgarritasuna
3. **Probatu tipografia** — egiaztatu irakurgarritasuna tamaina guztietan
...
1. Theme Builder-ek zure theme osoa sortzen du
2. Theme-a zure WordPress gunean instalatzen da
...
- **Egiaztatu kontrastea** — erabili [Baliozkotu paletaren kontrastea](../abilities/validate-palette-contrast.md) irisgarritasunerako
...
- [Baliozkotu paletaren kontrastea](../abilities/validate-palette-contrast.md) — egiaztatu koloreen irisgarritasuna
- [Sortu Logo SVG](../abilities/generate-logo-svg.md) — sortu logo pertsonalizatuak
