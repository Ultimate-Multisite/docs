...
Orrialde bat errendatu ondoren abiarazten da.
...
[`inc/admin-pages/class-base-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/admin-pages/class-base-admin-page.php#L382) fitxategian definituta, 382. lerroan.
