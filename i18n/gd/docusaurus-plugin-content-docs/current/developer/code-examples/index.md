---
title: Eisimpleirean Còid Adhartach
sidebar_position: 1
...
Faodaidh dà iarrtas aig an aon àm an aon luach a leughadh agus an dithis an aon toradh meudaichte a sgrìobhadh air ais, a’ call aon chunntas. Bidh `increment_item()` a’ tiomnadh an àireamhachd dhan einnsean stòr-dàta le aon aithris `UPDATE ... SET column = column + ?`, a’ dèanamh na h-obrach atamach na nàdar.
