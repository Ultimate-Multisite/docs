...
title: Sìoltachan - wu_wp_config_reference_hook_line_patterns
...
Air a mhìneachadh ann an [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) aig loidhne 143
