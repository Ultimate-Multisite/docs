---
id: wu_admin_notices
title: Criathrag - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Liosta de bhrathan airson a’ phannail shònraichte sin. |
| $all_notices | `array` | Liosta de bhrathan a chaidh a chur ris, air an sgaradh a rèir pannail. |
| $panel | `string` | Pannal airson na brathan fhaighinn air ais. |
