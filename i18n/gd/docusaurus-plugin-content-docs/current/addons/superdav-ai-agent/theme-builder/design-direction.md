...
- **Prìomh dhath** — prìomh dhath a’ bhrand, air a chleachdadh airson putanan, ceanglaichean, agus stràcan
- **Dath àrd-sgoile** — dath co-phàirteach airson caochladh
- **Dath stràca** — dath comharrachaidh airson eileamaidean cudromach
...
- **Clò cinn** — air a chleachdadh airson tiotalan duilleige agus cinn earrannan
- **Clò bodhaig** — air a chleachdadh airson teacsa pharagrafan agus susbaint
- **Meudan clò** — meudachadh freagairteach airson diofar mheudan sgrìn
...
- **Ìomhaigheagan** — stoidhle agus meud ìomhaigheagan
...
- Clàr-seòlaidh slàn
- Cruth iomlan leis a h-uile colbh
...
- Seòladh freagairteach (clàr hamburger)
- Cruth aon-cholbh
...
| Uidheam | Leud | Ro-shealladh |
|--------|-------|---------|
| **Mobile** | 375px | Fòn ann am portrait |
| **Tablet** | 768px | Tablet ann an landscape |
...
1. **Ag atharrachadh dhathan** — atharraich dath sam bith sa phailead
2. **Ag atharrachadh chlòthan** — tagh typefaces eadar-dhealaichte
3. **Ag atharrachadh farsaingeachd** — atharraich padding agus margins
...
- Ùraichidh an ro-shealladh desktop sa bhad
- Ùraichidh an ro-shealladh mobile sa bhad
...
- **Dealbhadh tùsail** — faic dè dh’atharraich
...
1. **Dèan ath-sgrùdadh air an dà ro-shealladh** — dearbhaich gu bheil desktop agus mobile a’ coimhead math
2. **Thoir sùil air a h-uile dath** — dèan cinnteach à iomsgaradh agus ruigsinneachd
3. **Dèan deuchainn air clò-sgrìobhadh** — dearbhaich so-leughaidh aig a h-uile meud
...
1. Gineas Theme Builder an theme iomlan agad
2. Thèid an theme a stàladh air an làrach WordPress agad
...
- **Dearbhaich iomsgaradh** — cleachd [Dearbhaich Iomsgaradh Paileid](../abilities/validate-palette-contrast.md) airson ruigsinneachd
...
- [Dearbhaich Iomsgaradh Paileid](../abilities/validate-palette-contrast.md) — thoir sùil air ruigsinneachd dhathan
- [Gineadh Logo SVG](../abilities/generate-logo-svg.md) — cruthaich suaicheantasan gnàthaichte
