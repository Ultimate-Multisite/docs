...
## Mar a Dh’obraicheas e {#how-it-works}

### 1. Gineadh Plana {#1-plan-generation}
...
### 2. Lorg Plugin {#2-plugin-discovery}
...
### 3. Cur-an-gnìomh a’ Phlana {#3-plan-execution}
...
### 4. Tracadh Adhartais {#4-progress-tracking}
...
### 5. Ath-bheothachadh bho Mhearachd {#5-error-recovery}
...
## Comasan Plana Làraich {#site-plan-abilities}
...
## A’ dèanamh coimeas eadar v1 agus v2 {#comparing-v1-and-v2}
...
## Òrdughan Plana WP-CLI {#wp-cli-plan-commands}
