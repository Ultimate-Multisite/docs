...
## Fhàilteachadh an fhadail cheòrsaichean (Domain Selection checkout field)
...
### A' chluarach fhadail ar cheòrsaichean
...
### Fhadail contact a' chluarach (Registrant contact fields)
...
### URL site a thàinig air an t-seòl (Auto-generated site URL)
...
### Comharbhaidh seanchas (Search behaviour)
...
## Bhriseadh DNS a' chluain (Customer DNS management)
...
### Tipean riaghnaidh a tha a' tòiseachadh (Supported record types)
...
### Còmhraidhean a tha a' tòiseachadh air bhriseadh DNS?
...
### Seachdaidhean DNS a tha air a bhith agad
...
### Admin: a ghlacadh agus atharrachadh seachdaidhean DNS
