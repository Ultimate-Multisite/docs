---
title: Ceannach air comharrachadh e-mailtean sistemaichean
sidebar_position: 13
...
Frum sin, le tuig a tha thu a' chluichd an seàil **System Emails** airson faic a h-eòlas air e-mailan.

![System Emails list](/img/admin/system-emails-list.png)

Is e luach a tha thu a' chluichd e-mailan sin a' chluichd gu sgaidhlig a' chluichd an seàil e-mailan:
...
Gus a chluichd e-mailan ùra:

1. Tuisge an seàil **System Emails**
2. Cluich air tòstáil **Reset & Import** air a' chùlnaidhean a' chùlnaid an seàil
...
1. **Deallt agus chluichd gu sgaidhlig** — Deallt an e-mail sin is chluichd air a' chluichd gu sgaidhlig (faigh thu a' chluichd send metrics).
2. **A' chluichd gu sgaidhlig gu fhaighneachadh** — Aiguseach an chluichd **Reset & Import**, chruinneachadh an fhoiclas **Reset**, agus taisg e-mailan a tha thu a' chluichd a' chluichd.

Tha an fhoiclas Reset a bhith a' chluichd air a bhith a' chluichd send metrics agus metadata eile a' chluichd, mar a tha e a' chluichd an e-mailan a' chluichd gu sgaidhlig.
