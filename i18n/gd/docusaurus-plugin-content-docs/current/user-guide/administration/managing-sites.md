...
- **Customer-owned** — Sites a tha pàirt de chùineòr-dhearg.
...
- **Site Title** — An t-aon fhaighinn an site ùr
- **Site URL** — An domain/path airson an site
- **Site Type** — An t-aon site, template, no site a tha de dhach.
...
- **Visit limits** — An t-aon fhaighinn a tha de dhach
- **User account limits** — Leimean airson rôil ùr-dhearg
- **Disk space** — Fòcas a' chluainteachd airson an site
- **Custom domain** — A' chluainteachadh mapping domain airson an site
- **Plugin and theme visibility** — A' chluainteachadh gu sònraichte na plugin-e agus na themean a tha a' chluainteachd, a' chluainteachd, no a' chluainteachd air an t-aon.
...
- **Mapped domains** a tha a' tòiseachadh le an sinnean
...
- **Enable/disable the site** le bhfàilteadh nút-aon
- **Change the site type** no 'sgeuladh an t-amh air
- **Set a site image/thumbnail** (a tha a' sgaidh air an fhaisg airson sinnean amh)
- **Delete the site** gu fìor

:::warning
Tha deichid an t-amh gu fìor. Bidh an t-amh agus a h-uile a tha air a' chlàradh gu fìor a' sgaidh.
:::
