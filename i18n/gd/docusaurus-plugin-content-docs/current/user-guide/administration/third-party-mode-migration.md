...
## A' chlàradh mod a tha thu a' tuiteam

### Gu bith a lasa an Admin Panel
...
## Atharrachadh mod a tha thu a' tuiteam

### Atharrachadh gu Mod Auto
...
### Atharrachadh gu Mod Leagach (Legacy Mode)
...
## Faighinn Super Mode (Auto Mode)

### Fhòcas Autonomach (Automatic Discovery)
...
### Fhòcas Eòlasach (Native Integration)
...
### Bhratadh a' Chùl (Simplified Management)
...
### Bhratadh a' Chùl (Better Performance)
...
## Aithris Eòlasach (Migration Path)

### Má Tha Thuair a' WordPress 6.x
...
## Aithris Eòlasach (Troubleshooting)

### Tha Fhòcasan a' tòisich seach i mode auto
...
### Tha mi ag iarraidh a' mode legacy a' tòisich
...
### A mo fy mhobail a tha chanachdairt
...
### Tha mi ag iarraidh "ability" a tha chanachdairt
...
## Comharrachadh le fhaighinn (Backward Compatibility)

### Chluarachdan a tha aig a' chluarachdan a tha aig ìre
...
### Tairm a tha a' chluarachadh (Deprecation Timeline)
...
## Bhràith-beatha (Best Practices)

### airson ùra chluarachdan
...
### airson chluarachdan a tha aig ìre
...
### airson abilities a tha aig ìre
...
## Tairm a tha a' chluarachadh (Next Steps)
