...
## Fàiltean a tha a' gineall

### Nàth a tha grantadaich de database a' tòiseachadh air an host
...
### Fhàiltean Bedrock no local chaidh a' chluarachd
...
### Chaidh an t-uisge push async a' chluarachadh (drain)
...
### Tha seirbheisg user tenant a' tòiseachadh air
...
### Chaidh fhailtean SSO a' gineallt
...
## Nuair a tha thu a' tabhann a' fhaighinn
