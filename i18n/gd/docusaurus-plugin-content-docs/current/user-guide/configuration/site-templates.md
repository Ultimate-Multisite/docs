...
Air a' cheann, tha thu ag obair seòl a tha a' tòiseachadh, tha thu a' gineadh pluginhean fìor-fhaighinn, tha thu a' seth theme a tha a' tòiseachadh, agus tha thu a' chlàradh air a thabhairt gu sònraichte. Acha, nuair a tha sinn a' cheann a' chlàradh seòl ùr a thabhairt, chaidh e a' fhaighinn seòl WordPress a tha a' tòiseachadh le sin a tha mòr-fhaighinn a tha air a' chlàradh. Tha eanach air a' cheann a' chlàradh seòl a tha a' tòiseachadh le sin a tha mòr-fhaighinn a tha air a' chlàradh.
...
Bhaidh seo a' cheann seòl a tha a' tòiseachadh le sin a tha a' toirt air an fhadail (modal window) a tha ag gairm airson **Site title, Site Domain/path,** agus **Site type**. Air an ìde **Site Type**, tha thu a' faighinn gu sònraichte gu robh thu a' tòiseachadh air **Site Template** *.*

_![Add site template modal with site type dropdown](/img/config/site-templates-list.png)_

Cha tha thu ag obair air a thabhairt fìor-fhaighinn do chliachanna airson a bhith a' faighinn gu sònraichte gu robh thu a' tòiseachadh air an template:

![Site template description field on the site template edit screen](/img/config/site-template-edit-description.png)

An tòr chùl mun fòram, tha thuir thuair **Copy Site** toggle switch a fheuchdu. Bidh seo a golladh gu robh thu a thrascall air ùr site template a' chlàradh mar am bith a' chlàradh a' chlàradh a' chlàradh a' chlàradh a' chlàradh a' chlàradh.
...
Drie modh, chan thuig a' chliachdan a bhith ag iarraidh tòiseachadh air an t-template gu sònraichte nuair a thonn an t-account. Ach, tha thu a' tuiteam a bhith a' fìor a' leideinn a chuir thu a' faighinn a' chùlchnaich a bhith a' leideinn a' chùlchnaich a' leideinn a' chùlchnaich.

Chan thu thu a' tuiteam a bhith ag iarraidh seo, tha thu a' deabhach a bhith a' tòiseachadh air **Ultimate Multisite > Products > Edit**.

![Edit product to assign site template](/img/config/product-site-templates.png)

Chan eil seo a' tuiteam a' chùlchnaich gu **Edit Product** page. An t-seachdaidh **Product Options**, tha thu a' fhadraidh an tab **Site template** agus tha thu a' leideinn an t-option **Assign Site Template** a' chluinadh frum an fhaighinn. Chan eil seo a' tuiteam a' chùlchnaich air an liosta de site templates a tha a' faighinn agus chan eil e a' gineadh a' leideinn a' chùlchnaich a' leideinn a' chùlchnaich a' leideinn a' chùlchnaich.
...
Ar **Edit Product** page ar. A'n sectiùr **Product Options**, tha thuinn a' chlàradh **Site template** tab agus sceilidh an option **Choose Available Site Template** a' tatrean an fhaighinn. Bidh seo a' tòiseachadh an list air site templates a' chlàradh agus bi thu a' faicinn a' tòiseachadh an site template a tha thu a' faicinn a' tòiseachadh. Is e cheann thu a' faicinn seo a' tòiseachadh gu sgaidh thu a' faicinn: **Available** thu a tha thu a' faicinn an site template a bhith air a' chlàradh. _**Not Available**_ thu a tha thu a' faicinn an site template a bhith a' tòiseachadh mar option. Agus **Pre-selected** thu a tha thu a' faicinn air an site template a bhith a' tòiseachadh gu sgaidh thu a' faicinn air an list a tha thu a' faicinn a' tòiseachadh.
...
Bidh seo a' tòiseachadh an seachdaire **Edit Checkout Form**. Faigh an fhaighinn **Template Selection** field agus sceilidh **Edit** a' tatrean.

Bidh seachdaire modal a' tòiseachadh. Air an fhaighinn **Template Sites** field thu a tha thu a' faicinn a' chlàradh agus a' leasadh a' chlàradh site templates a tha thu a' faicinn a' tòiseachadh air a' chlàradh a tha thu a' faicinn a' tòiseachadh. Tha na site templates a tha thu a' faicinn anseo a' tòiseachadh gu sgaidh thu a' faicinn a' tòiseachadh gu sgaidh thu a' faicinn air a bhith air a' chlàradh.

![Template selection field in the checkout form editor](/img/config/checkout-form-template-step.png)

Ar an fhaighinn, tha na gcothrom a' faicinn an chooser template gu sgaidh thu a' faicinn a' tòiseachadh air a' chlàradh a tha thu a' faicinn a' tòiseachadh agus a' faicinn a' chlàradh a' chlàradh a' chlàradh a' chlàradh a' chlàradh a' chlàradh.
...
Is eadar de fòcas a tha de dhutha de Ultimate Multisite, a choimhne a leic a bhith a bhith ag tòiseachadh text, colur, agus fhaighinntean ar fòram de registration. Cuimhneach, an uair a tharpmadh sinn an datha sin, is eadar sinn a lasadh air an am pre-populate an sgrùdadh (content) mar a tha thuiteachdaichean (template) a th'annachdaich. Agus tha thuiteach a tha a' tòiseachadh, rinn Ultimate Multisite an fhaighinntean sin gu daccais air an fhaighinntean a th'annachdaich a bhith gu fhaighinntean a th'annachdaich a shàbhaladh.

Mar eisimpleir, os a tha thuiteach a tha thuiteach de chùlann-chùlann (company name) a raibh thuiteach air an tòiseachadh agus a bhith a' tòiseachadh an tòiseachadh de chùlann sin ar an seòl (home page). Ar an tòiseachadh thuiteach de thòiseachadh, rinn thuig thuiteachdaichean sin, mar a tha air a bhith a' tòiseachadh gu fhaighinntean dubh-curlaidh - {{placeholder_name}}.

![Homepage with placeholder text in curly braces](/img/config/site-templates-list.png)

An uair sin, is eadar sinn a lasadh fhaighinntean a tha a' tòiseachadh air an fòram de checkout a bhith a' tòiseachadh datha sin. An fòram de checkout a tha a' tòiseachadh a tha a' tòiseachadh a th'annachdaich a tha a' tòiseachadh a bhith a' tòiseachadh gu fhaighinntean dubh-curlaidh a shàbhaladh air an tòiseachadh de thòiseachadh:

![Template selection and registration fields in the checkout form editor](/img/config/checkout-form-template-step.png)

Bidh an chùlann a bhith ag fhuiladh sin an fhaighinntean sin gu daccais air an tòiseachadh de thòiseachadh.

![Frontend checkout form with template chooser](/img/config/frontend-template-chooser.png)

An uair sin, rinn Ultimate Multisite an fhaighinntean a shàbhaladh gu daccais air an datha a tha a' tòiseachadh de chùlann a th'annachdaich.
...
Sealltainn a h-uile, rinn am pròiseas seo: gieidh sinn an option a bhith ag sethandlean fuaime (fake values) airson na placeholders, agus rinn sinn eirigh a' chluainteachadh agus a' roinnadh air na sitiadau template mar a tha a' tighinn a' chuidirean a' tighinn.

Is eadar thu a bhith agad de dhòigh air an editor placeholder site template gu dìreach gu **Ultimate Multisite > Settings > Sites**, agus tha, air an sidebar, a' chluainteachadh air an lìnne **Edit Placeholders**.

![Site template settings under the Sites settings page](/img/config/settings-sites-templates-section.png)

Bidh seo a tharghinn chuig an editor de chuid na placeholders, agus is eadar thu a bhith agad a' chluainteachadh placeholder agus an t-sìth a tha a' tighinn.
