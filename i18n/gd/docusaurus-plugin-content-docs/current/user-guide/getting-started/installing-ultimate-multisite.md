...
## A’ stàladh an Plugin {#installing-the-plugin}
...
### Sgrùdaidhean ro-stàladh {#pre-install-checks}
...
### Stuth Gnàthach {#default-content}
...
### Plugins air a mholadh {#recommended-plugins}
