...
## Amasachadh (Setup Instructions)

### 1. Bheann an Plugin WP Engine (Verify WP Engine Plugin)
...
### 2. Amasachadh an Ghàdhachd (Enable the Integration)
...
## Conaiche (How It Works)

### Ghàdhachd Domain Sinne (Domain Syncing)
...
## Taispeadáin (Troubleshooting)

### Crisbeidhean cuideachd API (API Connection Issues)
...
### Crisbeidhean subdomain (Subdomain Issues)
