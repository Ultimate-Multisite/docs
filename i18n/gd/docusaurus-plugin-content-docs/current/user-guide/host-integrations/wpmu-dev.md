...
## Còmhraidhean Seòlaidh (Setup Instructions)

### 1. Aims a' Chàrach Air WPMU DEV (Verify WPMU DEV Hosting)
...
### 2. Aims a' Chàrach Air (Enable the Integration)
...
## Conach a' Chàrach (How It Works)

### Ginealach a' Chàrach (Domain Syncing)
...
### Muibheachadh Dènamh (Domain Removal)
...
### Aithreachadh API (API Authentication)
...
## Tairgseachadh (Troubleshooting)

### Cùrsain API (API Connection Issues)
...
### Cùrsain Leabhar SSL (SSL Certificate Issues)
...
### Leabhar Cha Bhaidh a Chluasach (Domain Not Added)
