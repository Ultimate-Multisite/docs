...
### 1. Ghràdh an API Credentials agad {#1-get-your-gridpane-api-credentials}
...
### 2. Ghràdh ID na Seannach agus na Sitean agad {#2-get-your-server-and-site-ids}
...
### 3. Añadh Seannachnan i wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Bheir an Seannachanna a' ghlamaidh (Enable the Integration) {#4-enable-the-integration}
...
## Conas A tha e ag obair (How It Works) {#how-it-works}
...
## Bhrat airson Constant SUNRISE {#sunrise-constant-management}
...
## Bhrat airson an tòiseachadh (Troubleshooting) {#troubleshooting}

### Bhrat air coimhnichean API (API Connection Issues) {#api-connection-issues}
...
### Bhrat air certfeid SSL (SSL Certificate Issues) {#ssl-certificate-issues}
...
### Domhain a tha a' sgeuladh (Domain Not Added) {#domain-not-added}
