---
title: 'Leasan 14: Dè thig an ath rud'
sidebar_position: 15
...
```
Lìonra FitSite (Coileanta)
├── Bun-structar
│   ├── WordPress Multisite (modh fo-àrainn)
│   ├── Ultimate Multisite (air a rèiteachadh + le branndadh)
│   ├── Aoigheachd le SSL wildcard + mapadh àrainn
│   └── CDN agus caching airson coileanadh
├── Bathar
│   ├── Teamplaidean làraich (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Planaichean (Starter $49/mo, Growth $99/mo, Pro $199/mo)
│   ├── Prìsean bliadhnail le lasachadh 20%
│   ├── Cìsean rèiteachaidh, deuchainnean, agus order bumps
│   └── Còdan lasachaidh airson iomairtean agus tar-chur
├── Eòlas
│   ├── Sruth checkout sònraichte don niche
│   ├── Logadh a-steach, Dashboard, agus conaltraidhean le branndadh
│   ├── Onboarding treòraichte le widget Quick Start
│   ├── Sreath phuist-d fàilte
│   └── Bunait-eòlais agus stiùiridhean bhidio
├── Gnìomhachas
│   ├── Togail luchd-ceannach thar 6 seanalan
│   ├── Structar taice le ìrean
│   ├── Gnàthasan obrachaidh (làitheil, seachdaineil, mìosail, ràitheil)
│   ├── Tracadh mheatairean (MRR, churn, LTV, CAC)
│   └── Fèin-obrachadh tro webhooks agus sreathan puist-d
└── Fàs
    ├── Plana sgèileachaidh bun-structair
    ├── Leasachadh teachd-a-steach (upsells, tionndadh bliadhnail, seirbheisean ùra)
...
- **Sgoiltean ealain-mhìleanta** -- rangachadh chriosan, fiosrachadh farpaisean, rangachd chlasaichean
- **Stiùidiothan dannsa** -- clàran thaisbeanaidhean, gailearaidhean coileanaidh, fiosrachadh mu chulaidhean
...
- **Amalachadh glèidhidh chlasaichean** -- amalachadh nas doimhne le àrd-ùrlaran glèidhidh mòr-chòrdte
- **Portal bhall** -- raon le logadh a-steach airson buill gym le clàran-ama agus goireasan
...
- **Cleachdaichean slàinte** -- chiropractors, physiotherapists, nutritionists
...
1. A bheil feum aca air làraich-lìn ach a bheil e doirbh dhaibh feadhainn mhath fhaighinn?
2. An urrainn dhaibh fo-sgrìobhadh mìosail a phàigheadh?
3. A bheil iad a’ bruidhinn ri chèile?

Feumaidh gach niche ùr:

- Teamplaidean ùra air an dealbhadh airson a’ ghnìomhachais sin
- Structaran plana ùra a tha a’ nochdadh feumalachdan a’ ghnìomhachais sin
- Margaidheachd agus seanalan togail ùra
- Susbaint onboarding ùr agus eòlas taice
...
- `fitsite.com` -- stiùidiothan fallaineachd
- `menusite.com` -- taighean-bìdh
- `lawsite.com` -- companaidhean lagha
...
FitSite le 200 luchd-ceannach aig $89 ARPU:

- **MRR**: $17,800
- **ARR**: $213,600
- **Prìs reic a dh’fhaodadh a bhith ann**: $640,000 - $1,068,000
...
1. **Tagh niche** le feumalachdan soilleir, comas pàighidh, agus coimhearsnachd
2. **Dearbhaich** mus tog thu
3. **Tog àrd-ùrlar freagarraichte** le teamplaidean, planaichean, agus branndadh sònraichte don niche
4. **Cruthaich eòlas gun bhacadh** bho chlàradh gu onboarding
5. **Prìsich a rèir luach** le ìrean ro-innleachdail, deuchainnean, agus lasachaidhean
6. **Cuir air bhog gu rianail** le cur air bhog bog agus liosta-sgrùdaidh
7. **Faigh luchd-ceannach** tro sheanalan sònraichte don niche
8. **Ruith obrachaidhean** le gnàthasan seasmhach
9. **Sgèileadh** bun-structar, teachd-a-steach, agus sgioba mar a dh’fhàsas tu
...
B’ e an-dè an t-àm as fheàrr airson tòiseachadh. ’S e a-nis an dàrna àm as fheàrr.
