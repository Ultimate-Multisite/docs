...
---
# Handling: wu_page_before_render {#action-wupagebeforerender}

Udløses før rendering af en side.
...
Defineret i [`inc/admin-pages/class-base-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/admin-pages/class-base-admin-page.php#L356) på linje 356
