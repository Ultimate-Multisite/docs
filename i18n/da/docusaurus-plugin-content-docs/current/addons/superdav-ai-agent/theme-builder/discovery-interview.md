...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Anbefales til fotografier |
| **PNG** | `.png` | Understøtter gennemsigtighed |
...
- **Farvepalet** — dominerende farver udtrækkes og bruges i theme
- **Visuel stil** — moderne, rustik, minimalistisk, livlig osv.
- **Stemning og atmosfære** — professionel, kreativ, venlig, luksuriøs osv.
...
- **Moodboards** — samlinger af billeder, der repræsenterer din ønskede æstetik
- **Produktbilleder** — hvis du har produkter at fremvise
...
- **Teksttunge billeder** — skærmbilleder med meget tekst
...
3. **Medtag variation** — blanding af farve, stil og emne
...
- **Farvepalet** — primære, sekundære og accentfarver
- **Typografi** — skrifttypefamilier til overskrifter og brødtekst
- **Layoutstil** — afstand, justering og komponentarrangement
...
1. Gennemgå den genererede designretning
2. Giv feedback eller anmod om justeringer
...
- [Værktøjer og konfiguration](./tools.md) — tilgængelige værktøjer og konfigurationsmuligheder
