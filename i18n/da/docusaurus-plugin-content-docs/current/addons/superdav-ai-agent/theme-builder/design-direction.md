...
## Komponenter i designretning {#design-direction-components}

### 1. Farvepalette {#1-color-palette}
...
### 3. Layout og afstand {#3-layout-and-spacing}
...
## Rendering af forhåndsvisning {#preview-rendering}
...
## Forfining af dit design {#refining-your-design}

### Foretag justeringer {#making-adjustments}
...
### Opdateringer af forhåndsvisning {#preview-updates}
...
## Godkendelse af designretning {#design-direction-approval}
...
4. Fortsæt til [Hospitality Menus](./hospitality-menus.md) eller andre funktioner
...
- **Bekræft kontrast** — brug [Validate Palette Contrast](../abilities/validate-palette-contrast.md) for tilgængelighed
...
### Forhåndsvisning opdateres ikke {#preview-not-updating}
...
### Farver ser anderledes ud {#colors-look-different}
...
### Typografiproblemer {#typography-issues}
...
- [Discovery Interview](./discovery-interview.md) — indsamling af designinformation
- [Hospitality Menus](./hospitality-menus.md) — opret strukturerede menusider
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — tjek farvetilgængelighed
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — opret brugerdefinerede logoer
