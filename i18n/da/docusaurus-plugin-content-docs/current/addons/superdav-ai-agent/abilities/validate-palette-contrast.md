...
---
# Valider palettekontrast {#validate-palette-contrast}
...
## Kontrollerede WCAG-niveauer {#wcag-levels-checked}
...
## Par, der ikke består, og anbefalinger {#failing-pairs-and-recommendations}
