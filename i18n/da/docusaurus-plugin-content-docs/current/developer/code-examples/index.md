---
title: Avancerede kodeeksempler
sidebar_position: 1
...
To samtidige anmodninger kan læse den samme værdi og begge skrive det samme inkrementerede resultat tilbage, så én optælling går tabt. `increment_item()` uddelegerer aritmetikken til databasemotoren med en enkelt `UPDATE ... SET column = column + ?`-sætning, hvilket gør operationen iboende atomar.
