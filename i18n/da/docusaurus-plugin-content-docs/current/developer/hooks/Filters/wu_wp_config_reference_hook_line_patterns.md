...
Vi tjekker for tre mønstre, når vi forsøger at finde ud af, hvor vi kan injicere vores konstanter:
...
Defineret i [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) på linje 143
