...
## Installation af plugin'et {#installing-the-plugin}
...
### Forudgående kontrol {#pre-install-checks}
...
### Standardindhold {#default-content}
...
### Anbefalede plugins {#recommended-plugins}
