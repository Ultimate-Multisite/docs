...
## Oprettelse af et domæneprodukt
...
### Understøttede TLD'er (Supported TLDs)
...
### Prisjusteringstype (Markup type)
...
### Indledende prissætning (Introductory pricing)

### Tilbud om rabatter på første år
