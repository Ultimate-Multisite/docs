...
---
# Opsætning af manuelle betalinger (v2) {#setting-up-manual-payments-v2}
...
## Sådan aktiverer du manuelle betalinger {#how-to-enable-manual-payments}
...
## Bekræftelse af manuelle betalinger {#confirming-manual-payments}
