...
---
# Verificering af suveræn migration
...
### Database-tilladelser matcher ikke værten
...
### Bedrock eller lokale installationer kan ikke forbinde
...
### Asynkron push-køen drænes ikke
...
### Antal brugere i tenanten er forkert
