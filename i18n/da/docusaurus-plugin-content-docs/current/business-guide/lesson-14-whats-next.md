---
title: 'Lektion 14: Hvad kommer næste'
sidebar_position: 15
...
FitSite Network (Komplet)
├── Infrastruktur
│   ├── WordPress Multisite (subdomæne-tilstand)
│   ├── Ultimate Multisite (konfigureret + mærket)
│   ├── Hosting med wildcard SSL + domænemapping
│   └── CDN og caching til ydeevne
├── Produkt
│   ├── Site Templates (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Planer (Starter $49/md, Growth $99/md, Pro $199/md)
│   ├── Årlig prissætning med 20% rabat
│   ├── Opsætningsgebyrer, prøveperioder og order bumps
│   └── Rabatkoder til kampagner og henvisninger
├── Oplevelse
│   ├── Niche-specifik checkout flow
│   ├── Mærket login, dashboard og kommunikation
│   ├── Vejledt onboarding med Quick Start widget
│   ├── Velkomst e-mail sekvens
│   └── Videnbase og video-genveje
├── Forretning
│   ├── Kundeanskaffelse på tværs af 6 kanaler
│   ├── Trinvis supportstruktur
│   ├── Driftsrutiner (daglig, ugentlig, månedlig, kvartalsvis)
│   ├── Metriksporing (MRR, churn, LTV, CAC)
│   └── Automatisering via webhooks og e-mail sekvenser
└── Vækst
    ├── Infrastruktur skaleringplan
...
- **Kampsports skoler** -- bælterangering, turneringoplysninger, klassehierarki
- **Dansestudier** -- repertoireplaner til recital, performancegallerier, kostumedetaljer
...
- **Kursusbestillingsintegration** -- dybere integration med populære bookingplatforme
- **Medlemsportal** -- et logget område til fitnessmedlemmer med tidsplaner og ressourcer
...
**Sundhedsprofessionelle** -- kiropraktorer, fysioterapeuter, ernæringseksperter
...
1. Har de brug for hjemmesider, men kæmper med at få gode?
2. Kan de betale et månedligt abonnement?
3. Tal de sammen?

Hver ny niche har brug for:

- Nye templates designet til den pågældende branche
- Nye planstrukturer, der afspejler den pågældende branshes behov
- Nye marketing- og acquisitionskanaler
- Ny onboarding-indhold og supportviden
...
Et FitSite med 200 kunder til $89 ARPU:

- **MRR**: $17.800
- **ARR**: $213.600
- **Potentiel salgspris**: $640.000 - $1.068.000
...
1. **Vælg en niche** med klare behov, betalingsevne og fællesskab
2. **Valider** før du bygger
3. **Byg en skræddersyet platform** med niche-specifikke skabeloner, planer og branding
4. **Skab en problemfri oplevelse** fra tilmelding gennem onboarding
5. **Prissæt for værdi** med strategiske niveauer, prøveperioder og rabatter
6. **Lancér metodisk** med en blød lancering og tjekliste
7. **Accepter kunder** gennem niche-specifikke kanaler
8. **Kør driften** med bæredygtige rutiner
9. **Skalér** infrastruktur, omsætning og teamet, efterhånden som du vokser
...
Det bedste tidspunkt at starte var i går. Det næstbedste tidspunkt er nu.
