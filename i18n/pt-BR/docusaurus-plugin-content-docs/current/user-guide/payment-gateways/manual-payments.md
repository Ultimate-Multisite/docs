...
---
# Configurando pagamentos manuais (v2) {#setting-up-manual-payments-v2}
...
## Como habilitar pagamentos manuais {#how-to-enable-manual-payments}
...
## Confirmando pagamentos manuais {#confirming-manual-payments}
