...
Clicar em **Ativar na Rede** ativa o plugin em toda a sua rede multisite automaticamente. Após a ativação, o assistente continua normalmente para a etapa de instalação. Você não precisa sair do assistente para corrigir o estado da ativação.
:::
...
### Plugins Recomendados {#recommended-plugins}
