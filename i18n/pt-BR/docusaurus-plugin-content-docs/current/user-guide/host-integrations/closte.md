...
---
# Integração Closte {#closte-integration}
...
### 1. Verifique sua chave de API Closte {#1-verify-your-closte-api-key}
...
### 2. Ative a Integração {#2-enable-the-integration}
...
### Problemas com Certificados SSL {#ssl-certificate-issues}
