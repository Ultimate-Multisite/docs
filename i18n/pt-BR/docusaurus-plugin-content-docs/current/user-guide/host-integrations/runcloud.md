...
---
# Integração RunCloud {#runcloud-integration}
...
### 1. Obtenha suas credenciais de API do RunCloud {#1-get-your-runcloud-api-credentials}
...
### 2. Obtenha seus IDs de Servidor e Aplicativo {#2-get-your-server-and-app-ids}
