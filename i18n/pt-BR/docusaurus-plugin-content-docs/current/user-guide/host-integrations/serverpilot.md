...
---
# Integração ServerPilot {#serverpilot-integration}
...
### 1. Obtenha suas credenciais da API ServerPilot {#1-get-your-serverpilot-api-credentials}
...
## Verificação de Certificado SSL {#ssl-certificate-verification}
