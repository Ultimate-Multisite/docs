...
### 2. Obtenha seu Zone ID {#2-get-your-zone-id}
...
### Exibição de registros DNS {#dns-record-display}
...
### Como isso difere da integração padrão com Cloudflare {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Configurando Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
