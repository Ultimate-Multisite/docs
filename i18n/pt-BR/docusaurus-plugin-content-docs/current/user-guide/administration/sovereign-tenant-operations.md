...
:::warning
Não exclua um inquilino soberano enquanto a verificação da migração ainda estiver em execução ou enquanto os jobs de push assíncronos estiverem na fila. Aguarde a conclusão da verificação para que o desinstalação não remova credenciais necessárias para os jobs pendentes.
:::
