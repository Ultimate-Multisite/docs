...
### 1. Ativar a API do CyberPanel {#1-enable-the-cyberpanel-api}
...
### 3. Ativar a Integração {#3-enable-the-integration}
...
### Mapeamento de Domínio {#domain-mapping}
...
### SSL Automático (Auto-SSL) {#auto-ssl}
...
### Encaminhadores de E-mail {#email-forwarders}
...
### Conexão API Recusada {#api-connection-refused}
