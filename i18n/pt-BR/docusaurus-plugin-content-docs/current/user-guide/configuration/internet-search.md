...
## Ativando a Busca na Internet {#enabling-internet-search}
...
### Obtendo uma Chave API do Brave Search {#obtaining-a-brave-search-api-key}
...
### Obtendo uma Chave API do Tavily {#obtaining-a-tavily-api-key}
...
## Desativando a Busca na Internet {#disabling-internet-search}
