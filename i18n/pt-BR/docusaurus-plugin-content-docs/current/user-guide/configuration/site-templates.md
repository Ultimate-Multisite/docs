...
### Personalizando os conteúdos de um Modelo de Site
...
#### Modo 2: Escolher Site Template Disponível
...
#### Permitir que Usuários usem seu Site como templates
...
#### Copiar Mídia na Duplicação de Template
...
#### **Impedir que Mecanismos de Busca indexem Templates de Site**
...
## Pré-preenchendo Templates de Site com busca e substituição automática
...
### Resolvendo o problema do "template cheio de placeholders"
