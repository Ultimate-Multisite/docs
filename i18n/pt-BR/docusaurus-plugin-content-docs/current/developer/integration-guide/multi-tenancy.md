...
## Fluxo de bootstrap de tenant {#tenant-bootstrap-flow}
...
## Hooks de SSO e REST {#sso-and-rest-hooks}
...
## URLs de ações de clientes soberanos {#sovereign-customer-action-urls}
...
## Exclusão de tenant {#tenant-deletion}
...
## Roteador de banco de dados obsoleto {#deprecated-database-router}
