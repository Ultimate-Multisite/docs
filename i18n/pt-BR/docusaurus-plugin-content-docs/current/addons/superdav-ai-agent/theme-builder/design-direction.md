...
- **Verifique o contraste** — use [Validate Palette Contrast](../abilities/validate-palette-contrast.md) para acessibilidade
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — verifique a acessibilidade das cores
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — crie logotipos personalizados
