...
Permet aux développeurs de contourner cette vérification.
...
Défini dans [`inc/class-requirements.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/class-requirements.php#L256) à la ligne 256
