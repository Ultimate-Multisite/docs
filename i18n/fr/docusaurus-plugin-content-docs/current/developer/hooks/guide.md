...
---
# Guide d'utilisation des Hooks {#hooks-usage-guide}
...
### Cycle de vie du client {#customer-lifecycle}

#### Après la création du client {#after-customer-creation}
...
#### Changement de statut du client {#customer-status-change}
...
### Hooks du site {#site-hooks}

#### Après la publication du site {#after-site-published}
...
#### Avant l'application du modèle {#before-template-application}
...
### Hooks d'adhésion {#membership-hooks}

#### Transitions de statut {#status-transitions}
...
### Hooks de paiement {#payment-hooks}

#### Paiement terminé / échoué {#payment-completed--failed}
...
### Hooks de caisse {#checkout-hooks}

#### Avant le traitement / Après l'achèvement {#before-processing--after-completion}
...
### Filtres de tarification {#pricing-filters}
...
### Filtres de modèle {#template-filters}
...
### Filtres de limitation {#limitation-filters}
...
### Champs du formulaire de paiement {#checkout-form-fields}
...
### Contenu de l'e-mail {#email-content}
