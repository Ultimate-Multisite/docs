...
## Installation Composer / Bedrock {#composer--bedrock-installation}
...
### Utiliser la REST API {#use-the-rest-api}

```bash
curl -u "api_key:api_secret" https://yoursite.com/wp-json/wu/v2/customers
```

### S’accrocher aux événements {#hook-into-events}
