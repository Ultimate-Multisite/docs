...
## Widgets du tableau de bord réseau {#network-dashboard-widgets}
...
### Actualités et Discussions {#news-and-discussions}
...
## Tableau de bord Ultimate Multisite {#ultimate-multisite-dashboard}
...
### Croissance du revenu récurrent mensuel {#monthly-recurring-revenue-growth}
...
### Support de plage de dates {#date-range-support}
