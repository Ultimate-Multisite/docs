...
---
# Exportation et Importation {#export--import}
...
## Exporter un site en ZIP {#exporting-a-site-to-a-zip}
...
## Ce que l'exportation inclut {#what-the-export-includes}
...
## Importer un site depuis un ZIP {#importing-a-site-from-a-zip}
...
## Limitations et notes de compatibilité {#limitations-and-compatibility-notes}
