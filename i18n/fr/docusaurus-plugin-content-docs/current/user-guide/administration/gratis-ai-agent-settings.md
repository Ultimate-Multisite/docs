...
## Configuration de l’endpoint de retour
...
### Désactiver la collecte des retours
...
### Accéder aux indicateurs de fonctionnalités
...
### Indicateurs de sécurité de l’automatisation
