...
## Générer un Plugin via l'IA {#generating-a-plugin-via-ai}
...
## Activation en Sandbox {#sandbox-activation}
...
## Gestion des Plugins Générés {#managing-generated-plugins}
...
## Installation d'un Plugin Généré sur le Réseau {#installing-a-generated-plugin-on-the-network}
...
## Mises à Jour de Plugins {#plugin-updates}
