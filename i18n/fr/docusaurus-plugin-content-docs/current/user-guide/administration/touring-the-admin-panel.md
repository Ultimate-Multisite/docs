---
title: Visite du panneau d’administration
sidebar_position: 16
...
Voici une vue complète du Dashboard :

![Page complète du Dashboard Ultimate Multisite](/img/admin/um-dashboard-full.png)

Et la section inférieure du Dashboard :

![Section inférieure du Dashboard Ultimate Multisite](/img/admin/um-dashboard-bottom.png)

Voici également une vue complète du Dashboard du réseau :
...
Les paramètres du connecteur IA répertorient les pools de fournisseurs OAuth actuellement pris en charge : Anthropic Max, OpenAI ChatGPT/Codex et Google AI Pro. Chaque carte de fournisseur permet aux super administrateurs de connecter des comptes, d’actualiser les comptes enregistrés, de supprimer des comptes par e-mail et d’utiliser le mode de secours OAuth manuel lorsqu’un environnement sandboxé bloque la redirection du navigateur. Les options de configuration de Cursor Pro ont été supprimées du panneau d’administration.

Les comptes ChatGPT/Codex prennent en charge l’utilisation d’outils via connecteur lorsque l’opération autorise les outils, de sorte que les workflows d’administration qui dépendent d’opérations prises en charge par le connecteur peuvent utiliser le comportement d’outils Codex une fois le compte OpenAI connecté.

![Page des paramètres](/img/admin/settings-general.png)

Voici une vue complète de la page des paramètres généraux :

![Page complète des paramètres généraux](/img/admin/settings-general-full.png)

Et la page des paramètres des e-mails :

![Page complète des paramètres des e-mails](/img/admin/settings-emails-full.png)
