...
---
# Modèles de site (v2) {#site-templates-v2}
...
## Qu’est-ce qu’un modèle de site ? {#what-is-a-site-template}
...
## Création et modification d’un nouveau modèle de site {#creating-and-editing-a-new-site-template}
...
### Personnalisation du contenu d’un modèle de site {#customizing-the-contents-of-a-site-template}
...
### Utilisation des modèles de site {#using-site-templates}
...
#### Mode 1 : Attribuer un modèle de site {#mode-1-assign-site-template}
...
#### Mode 2 : Choisir un modèle de site disponible {#mode-2-choose-available-site-template}
...
### Mode par défaut : sélection du modèle de site dans le formulaire de paiement {#default-mode-site-template-selection-on-the-checkout-form}
...
### Options de modèle de site {#site-template-options}
...
#### Autoriser le changement de modèle {#allow-template-switching}
...
#### Autoriser les utilisateurs à utiliser leur site comme modèles {#allow-users-to-use-their-site-as-templates}
...
#### Copier les médias lors de la duplication de modèle {#copy-media-on-template-duplication}
...
#### **Empêcher les moteurs de recherche d’indexer les modèles de site** {#prevent-search-engines-from-indexing-site-templates}
...
## Préremplir les modèles de site avec une recherche-et-remplacement automatique {#pre-populating-site-templates-with-auto-search-and-replace}
