...
---
# cPanel Intégration {#cpanel-integration}
...
### 1. Obtenez vos identifiants cPanel {#1-get-your-cpanel-credentials}
...
### 2. Ajoutez les constantes à wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Activez l'intégration {#3-enable-the-integration}
...
### Domaines supplémentaires {#addon-domains}
