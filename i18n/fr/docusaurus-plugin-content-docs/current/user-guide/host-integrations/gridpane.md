...
---
# Intégration GridPane {#gridpane-integration}
...
### 1. Obtenez vos identifiants API GridPane {#1-get-your-gridpane-api-credentials}
1. Connectez-vous à votre tableau de bord GridPane
2. Allez dans "Settings" > "API"
3. Générez une clé API si vous n'en avez pas déjà une
4. Copiez votre clé API

### 2. Obtenez vos identifiants de serveur et de site {#2-get-your-server-and-site-ids}
