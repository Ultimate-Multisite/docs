...
---
# Intégration du panneau de contrôle Enhance {#enhance-control-panel-integration}
...
## Obtenir vos identifiants API {#getting-your-api-credentials}

### 1. Créer un jeton API {#1-create-an-api-token}
...
### 2. Obtenir votre ID d'organisation {#2-get-your-organization-id}
...
### 3. Obtenir votre ID de serveur {#3-get-your-server-id}
...
### 4. Obtenir votre URL API {#4-get-your-api-url}
...
### Configuration via l'assistant d'intégration {#setup-via-integration-wizard}
...
### Lorsqu'un domaine est mappé {#when-a-domain-is-mapped}
...
### Lorsqu'un domaine est supprimé {#when-a-domain-is-removed}
...
### Vérification DNS et SSL {#dns-and-ssl-checking}
...
### Après le mappage d'un domaine {#after-mapping-a-domain}
...
### Intervalle de vérification DNS {#dns-check-interval}
...
### Points de terminaison communs utilisés {#common-endpoints-used}
