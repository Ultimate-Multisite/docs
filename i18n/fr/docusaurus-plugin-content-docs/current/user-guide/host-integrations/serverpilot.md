...
---
# Intégration ServerPilot {#serverpilot-integration}
...
### 1. Obtenez vos identifiants API ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Obtenez votre App ID {#2-get-your-app-id}
...
### 3. Ajoutez les constantes à wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Activez l'intégration {#4-enable-the-integration}
...
## Vérification des certificats SSL {#ssl-certificate-verification}
...
### Suppression de domaine {#domain-removal}
