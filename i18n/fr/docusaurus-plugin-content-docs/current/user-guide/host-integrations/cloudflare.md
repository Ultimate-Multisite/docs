...
---
# Intégration Cloudflare {#cloudflare-integration}
...
### 1. Obtenir votre clé API Cloudflare {#1-get-your-cloudflare-api-key}
...
### 2. Obtenir votre ID de zone {#2-get-your-zone-id}
...
### Affichage des enregistrements DNS {#dns-record-display}
...
### En quoi cela diffère de l’intégration Cloudflare standard {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Configurer Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
### Sous-domaine non ajouté {#subdomain-not-added}
...
### Problèmes de proxying {#proxying-issues}
