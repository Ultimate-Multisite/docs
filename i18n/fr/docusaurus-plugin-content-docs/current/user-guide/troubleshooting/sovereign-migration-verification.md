...
### Les droits de base de données ne correspondent pas à l'hôte
...
### Les installations Bedrock ou locales ne peuvent pas se connecter
...
### La file de tâches asynchrones ne se vide pas
...
### Le nombre d'utilisateurs du tenant est incorrect
