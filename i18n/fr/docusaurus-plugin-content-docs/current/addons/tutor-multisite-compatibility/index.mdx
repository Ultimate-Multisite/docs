...
# Compatibilité Tutor Multisite {#tutor-multisite-compatibility}
...
## Fonctionnalité déplacée depuis le plugin MU {#functionality-moved-from-mu-plugin}
...
### Tables affectées {#affected-tables}
