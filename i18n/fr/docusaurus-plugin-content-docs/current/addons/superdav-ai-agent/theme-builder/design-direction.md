...
1. **Ajustant les couleurs** — changez n'importe quelle couleur de la palette
2. **Changeant les polices** — sélectionnez différentes familles de polices
3. **Modifiant l'espacement** — ajustez les marges et le rembourrage
...
1. **Revoyez les deux aperçus** — vérifiez que l'affichage sur ordinateur de bureau et mobile est bon
2. **Vérifiez toutes les couleurs** — assurez-vous du contraste et de l'accessibilité
3. **Testez la typographie** — vérifiez la lisibilité à toutes les tailles
...
1. Theme Builder génère votre thème complet
2. Le thème est installé sur votre site WordPress
...
- **Vérifier le contraste** — utilisez [Validate Palette Contrast](../abilities/validate-palette-contrast.md) pour l'accessibilité
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — vérifier l'accessibilité des couleurs
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — créer des logos personnalisés
