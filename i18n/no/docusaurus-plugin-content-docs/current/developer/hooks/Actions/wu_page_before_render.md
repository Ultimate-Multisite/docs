...
Lar utviklere av plugins legge til ekstra innhold før vi viser siden.
...
Definert i [`inc/admin-pages/class-base-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/admin-pages/class-base-admin-page.php#L388) på linje 388
