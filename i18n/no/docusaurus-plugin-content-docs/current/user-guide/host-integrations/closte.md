...
---
# Closte-integrasjon {#closte-integration}
...
### 1. Bekreft Closte API-nøkkelen din {#1-verify-your-closte-api-key}
...
## Oppretting av domeneoppføringer {#domain-record-creation}
