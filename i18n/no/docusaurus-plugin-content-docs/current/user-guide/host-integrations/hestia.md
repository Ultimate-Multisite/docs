...
---
# Hestia Control Panel-integrasjon {#hestia-control-panel-integration}
...
## Konfigurasjon (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Verifisere oppsettet {#verifying-setup}
