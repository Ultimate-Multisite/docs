...
## Hva endres for administratorer {#what-changes-for-administrators}
...
## Besøk på en suveren leietaker {#visiting-a-sovereign-tenant}
...
## Sjekkliste for fjernsiteoperasjoner {#remote-site-operations-checklist}
...
## Slette suverene leier {#deleting-sovereign-tenants}
