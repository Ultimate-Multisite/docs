...
### API Connection Refused (Tilkobling til API avvist)
...
### Authentication Errors (Autentiseringsfeil)
...
### Domain Not Created (Domene ikke opprettet)
...
### SSL Certificate Not Issued (SSL-sertifikat ikke utstedt)
