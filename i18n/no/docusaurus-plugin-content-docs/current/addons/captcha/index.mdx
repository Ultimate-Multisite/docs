...
## Cap Captcha: Selvhostet beskyttelse som bare virker {#cap-captcha-self-hosted-protection-that-just-works}
...
## Trenger du fortsatt Google reCAPTCHA eller hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Bygget for skala {#built-for-scale}
...
## Trenger jeg å konfigurere noe? {#do-i-need-to-configure-anything}
...
## Kan jeg bruke forskjellige captcha-leverandører på forskjellige sites? {#can-i-use-different-captcha-providers-on-different-sites}
