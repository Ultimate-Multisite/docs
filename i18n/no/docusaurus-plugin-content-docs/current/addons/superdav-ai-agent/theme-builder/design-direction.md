...
- **Verifiser kontrast** — bruk [Validate Palette Contrast](../abilities/validate-palette-contrast.md) for tilgjengelighet
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — sjekke fargegjennomførbarhet
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — lage tilpassede logoer
