...
- **Color primarius** — color praecipuus notae, adhibitus ad globulos, nexus, et accentus
- **Color secundarius** — color complementarius ad varietatem
- **Color accentus** — color emphasin praebens pro elementis importantibus
...
- **Fons titulorum** — adhibitus pro titulis paginarum et capitibus sectionum
- **Fons corporis** — adhibitus pro textu paragraphorum et contentu
- **Magnitudines fontium** — dimensio responsiva pro diversis magnitudinibus schermatum
...
- **Icones** — stilus et dimensio iconum
...
- Menu navigationis plenum
- Dispositio completa cum omnibus columnis
...
- Navigatio responsiva (menu hamburger)
- Dispositio unius columnae
...
| Machina | Latitudo | Praevisio |
|--------|-------|---------|
| **Mobile** | 375px | Telephonum verticale |
| **Tablet** | 768px | Tabula horizontalis |
...
1. **Colores accommodare** — muta quemlibet colorem in tabula
2. **Fontes mutare** — elige diversas formas litterarum
3. **Spatia modificare** — accommoda padding et margines
...
- Praevisio desktop statim renovatur
- Praevisio mobilis statim renovatur
...
- **Design originale** — vide quid mutatum sit
...
1. **Utramque praevisionem recense** — verifica desktop et mobile bene apparere
2. **Omnes colores inspice** — cura contrastum et accessibilitatem
3. **Typographiam proba** — verifica legibilitatem in omnibus magnitudinibus
...
1. Theme Builder thema tuum completum generat
2. Thema in situ tuo WordPress installatur
...
- **Contrastum verifica** — utere [Validate Palette Contrast](../abilities/validate-palette-contrast.md) pro accessibilitate
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — inspice accessibilitatem colorum
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — crea logos customizatos
