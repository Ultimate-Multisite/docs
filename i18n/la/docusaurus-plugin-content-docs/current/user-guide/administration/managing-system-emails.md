---
title: Administrare emails systematis.
sidebar_position: 13
...
Desde allí, puedes acceder a la página **System Emails** (Emails Systemáticos) para ver todas las plantillas de correo electrónico.

![System Emails list](/img/admin/system-emails-list.png)

También puedes editar plantillas de correo electrónico individuales usando el editor de correos electrónicos del sistema:
...
Para importar nuevas plantillas de correo electrónico:

1. Ve a la página **System Emails** (Emails Systemáticos)
2. Haz clic en el botón **Reset & Import** (Restablecer e Importar) en la parte superior de la página
...
1. **Eliminar e importar de nuevo** — Elimina el correo electrónico del sistema e impórtalo de nuevo (esto borra las métricas de envío)
2. **Restablecer a través de la herramienta** — Usa la herramienta **Reset & Import** (Restablecer e Importar), activa la opción **Reset** (Restablecer) y selecciona los correos electrónicos que deseas restablecer

La opción Reset es preferida porque conserva las métricas de envío y otros metadatos mientras restaura el contenido predeterminado.
