...
---
# Integrare con GridPane {#gridpane-integration}
...
### 1. Obtener tus Credenciales de API de GridPane {#1-get-your-gridpane-api-credentials}
...
### 2. Obtener tus IDs de Servidor y Sitio {#2-get-your-server-and-site-ids}
