---
title: Notitia de Removendo Modus Constructio Situii
sidebar_position: 19
...
- Creatione situs ex template
- Configuratio parametror primorum
- Eligendo themam
...
- Configuratio plus flexibilis, guidata a agent
- Optiones customizationis themorum meliores
...
```
"Mihi situm novum configurare"
```

vel

```
"Iniciare onboarding Thematic Builder"
```
...
|---------|----------------------|----------------------|
| Methodus Configurandi | Form wizard | Conversatio agentis |
| Selectio Thematis | Template praedita | Generatio customis |
| Customizationes | Optiones limitatae | System designi pleni |
| Site brief | Non conservatur | Memoria persistens |
...
1. Petitio: "Ad me novum situs configurare" (Ajuta me in configuration novum situs)
2. Agent Auxilii Configurandi te ducere per:
   - Finem et metas siti
   - Publicum cibum (Target audience)
   - Identitatem marquei (Brand identity)
...
1. Ut idem ut est, uti possis continuare uti est.
2. Ad actualizandum themam, pete: "Redesign my site" (Redignum me situs)
...
1. Petitio: "Change my theme" (Mutare me themam)
2. Agent Auxilii Configurandi facit:
   - Quaestionem de preferentibus tuis design adhibet
...
1. Elegere templum
2. Selectare themam
3. Configurare parametra basica
4. Finis
```
...
2. Definiere publicum cibum tuum
3. Eligere preferentias design
4. Agent themam custom generabit
5. Agent themam activat
...
1. Richiesta: "Mi aiuti a configurare un nuovo sito"
...
- **Design System Aesthetics Skill**: Perfezionare l'identità visiva del tuo sito
