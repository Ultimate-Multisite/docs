---
title: Specifica del sito habilidad
sidebar_position: 18
...
- **Audiencia objetivo**: Quién visita tu sitio y lo que necesita
- **Identidad de marca**: Tus colores, tono y estilo visual
- **Objetivos comerciales**: Cómo se ve el éxito para tu sitio
...
- Sugerir características alineadas con el propósito de tu sitio
...
```
"Definīmus specificum situm meum"
```
...
```
Quid est finis primarius huius siti?
- Magasin e-commerce
- Blog vel situs contentus
- Portfolio vel ostentatio
- Applicatio SaaS
- Communitas vel forum
- Aliter: [describere]
```
...
- Consumptores / populus generālis
- Professiones negotiatores
- Developer / usores technici
- Studentes / educatores
- Aliter: [describere]
...
- Color primarius: [selector coloris vel codice hex]
- Color secundarius: [selector coloris vel codice hex]
- Color accentus: [opcionale]

Quommodo describeres tonum marci tuae?
- Professionale / corporativus
- Creativus / artisticus
- Ludus / casuallinus
- Minimalis / modernus
- Calidus / amicus
```
...
- Generare leads
- Vendere productos
- Construere communitatem
- Partire scientia
- Stabilire auctoritatem
- Aliter: [describere]

Quid est metrica tua primaria?
- Revenio
- Engagement usoris
- Rēmis contentus
- Conversiones
...
- Planum (omnes contenta in eodem nive)
- Hierarchicum (categorie et subcategorie)
- Chronologicum (stilo blog)
- Per productum (catalogus)
- Aliter: [describere]

Quid genera contenti usus?
- Postes blog
- Paginae productorum
- Studia casus
- Documentatio
...
```
"Actualiza brief situi meum: nunc cibum B2B cibum targetamus"
```

vel

```
"Revīde specification situi meam"
```
...
```
Tu: "Redesigna hominem meum"
Agentem: "In base brief situi tuo, cibos feminas ab 25 ad 45 annos targetas
cum tono calidum et artigianale. Design creatum faciam qui enfatizet
...
```
Tu: "Quid addere debbe?"
Agentem: "Pro store e-commerce focum fidelitatis clientium,
recomināre mihi: program fidelitatis, opiniones clientium, newslettere epistularum,
...
- Lorsque vous changez d'audience
...
- "Nous ciblons des professionnels qui privilégient la qualité plutôt que le prix"
...
Vous pouvez également exécuter Site Specification de manière indépendante si vous souhaitez :
...
- Demandez à l'agent de "récupérer mon site brief" (`recall my site brief`)
- Vérifiez que la mémoire est activée dans vos paramètres

**Volo in novum cum novo site\_brief**
- Qua qua agentem: "Purgare mi site brief et incipere ex novo"
- Deinde Redi Specificatione Site

**Agentis consilia sunt quae non concordant cum meo site\_brief**
- Qua agente pete ut "meum site brief reverat"
...
1. **Ubi Theme Builder**: Creare theum customem ex tuo site\_brief
2. **Formam Redigere**: Usus skill Design System Aesthetics ad operationem designini minutae
3. **Content Planum**: Agentibus petere de re structura contenti consiliis
4. **Features Aedificare**: Petitiones requirere quae cum tuis ambitibus societatis concordant
