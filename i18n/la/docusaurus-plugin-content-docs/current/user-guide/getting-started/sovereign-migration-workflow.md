---
title: Fluxus Migratio Sovranorum
sidebar_position: 8
...
- Una copia de seguridad actual del sitio fuente.
...
- Un enlace de anfitrión de base de datos que coincida con el entorno de destino.
...
5. Drena (vacía) los trabajos de migración asíncrona.
...
El flujo de verificación comprueba la migración desde varios ángulos:

- El esquema del inquilino existe y puede ser escrito por el escritor de la base de datos del inquilino.
- El anfitrión de la base de datos configurado tiene permisos válidos.
- Los usuarios del inquilino están presentes y coinciden con el recuento esperado de usuarios de instalación soberana.
- La cola de envío asíncrono puede drenarse con éxito.
- Las rutas de datos antiguas del lado de la red ya no son necesarias para el inquilino soberano.
