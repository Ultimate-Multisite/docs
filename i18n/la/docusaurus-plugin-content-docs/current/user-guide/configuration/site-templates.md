...
#### Modo 2: Eligere Templum Disponibile
...
### Modalitate Predefinita: Selezione del modello di sito sul modulo di Checkout
...
#### Permitir a Trocar de Modelo (Template Switching)
...
#### Permitir a los Usuarios usar su Sitio como modelos (Templates)
...
#### Copiar Medios en la Duplicación del Modelo (Template Duplication)
...
#### **Evitar que los Motores de Búsqueda indexen los Modelos de Sitio**
...
## Prellenar Modelos de Sitio con búsqueda y reemplazo automático
...
### Resolviendo el problema de "plantilla llena de marcadores de posición"
