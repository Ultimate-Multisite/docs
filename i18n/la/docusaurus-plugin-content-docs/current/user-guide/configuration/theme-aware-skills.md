...
Ognis skill includit:

- **Documenta specifici thematis** — consilium ad usum et adaptationem thematis
- **Referentiae bloc et pattern** — bloc availability, pattern et optiones design
...
Skill Block Themes praebet consilium de:

- Creando et editando templates uti editor bloc
- Operando cum pattern bloc et blocbus reutilizandis
- Customizatione stylorum globalium et settingum theme.json
- Usando blocos thematis et variationes
- Construendo pattern bloc customes pro situm tuum
...
Skill Themes Classici praebet consilium de:

Cum PHP template files et hooks operare
Personalizare aspectus thēmatis per Customizer
Uso area widget et sidebars
Modificatio CSS et développment child theme
Comprendere hierarchiam themae et tags template
...
Scientia Kadence Blocks dē:

- Uso librarii blockbus avancae Kadence (Hero, Testimonials, Pricing, etc.)
- Configuratio optionum et ponentiarum blockbus Kadence
- Constructio dispositionum customium cum blockbus grid et container Kadence
- Integrare blockbus Kadence cum thema tuino
- Utilizare systematis design et presetium Kadence
...
Scientia Kadence Theme dē:

- Personalizare themae Kadence per styles globales et theme.json
- Uso patternum et templates blockbus integrata Kadence
- Configuratio optionum et ponentiarum themae Kadence
- Constructio designium customia cum systemate design Kadence
- Integrare Kadence cum pluginbus et instrumentis popularibus
...
1. Folosești o temă de bloc cu abilitatea **Block Themes** activă.
...
> "Adaugă o zonă widget personalizată în bare laterală folosind un child theme."

**Pentru Kadence Blocks:**
> "Construiește o secțiune de testimoniale folosind blocul Kadence Testimonials."

**Pentru Kadence Theme:**
> "Personalizează aspectul layout-ului header și stilizarea menuirii de navigare."

Asistentul îți va oferi îndrumări specifice temei și exemple de cod adaptate temei și pluginurilor tale active.

:::note
Abilitățile conștiente de temă sunt disponibile automat în Superdav AI Agent v1.10.0 și versiuni ulterioare. Nu este necesară nicio configurare sau setare suplimentară.
:::
