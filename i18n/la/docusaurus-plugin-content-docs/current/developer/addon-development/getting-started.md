---
title: Initia evolutionis additamentorum
sidebar_position: 1
...
```
my-addon/
├── my-addon.php                 # Fasciculus principalis moduli inserticii
├── inc/
│   ├── class-my-addon.php       # Classis principalis additamenti
│   ├── admin-pages/             # Interfacies administratoria
│   ├── models/                  # Exemplaria datorum propria
│   └── integrations/            # Integrationes tertiarum partium
├── assets/
│   ├── js/
│   └── css/
...
- Utere [Addon Template](/addons/addon-template) ut structura initiali
