...
## Consuetudo nominandi tabulas {#file-naming-convention}
...
## Ubi tabulam ponere {#where-to-place-the-file}
...
## Hami et filtra praesto {#hooks-and-filters-available}
...
## Exemplum minimum {#minimal-example}
