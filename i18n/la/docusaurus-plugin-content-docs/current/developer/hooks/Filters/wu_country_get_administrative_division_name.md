...
title: Filtrum - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Nomen divisionis. Plerumque aliquid sicut civitas, provincia, regio, etc. |
| $country_code | `string` | Codex ISO duarum litterarum pro patria. |
| $state_code | `string` | Codex ISO duarum litterarum pro civitate. |
