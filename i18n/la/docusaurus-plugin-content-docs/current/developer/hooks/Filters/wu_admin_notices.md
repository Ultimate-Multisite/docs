---
id: wu_admin_notices
title: Filtrum - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Index nuntiorum pro illo certo pannello. |
| $all_notices | `array` | Index nuntiorum additorum, per pannellum separatorum. |
| $panel | `string` | Pannellum ex quo nuntia recuperanda sunt. |
