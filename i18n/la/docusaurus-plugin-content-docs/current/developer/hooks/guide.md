...
### Cyclus Vitae Emptoris {#customer-lifecycle}

#### Post Creationem Emptoris {#after-customer-creation}
...
#### Mutatio Status Emptoris {#customer-status-change}
...
### Hooks Siti {#site-hooks}

#### Post Situm Publicatum {#after-site-published}
...
#### Ante Applicationem Exemplaris {#before-template-application}
...
### Hooks Sodalitatis {#membership-hooks}

#### Transitiones Status {#status-transitions}
...
### Hooks Solutionis {#payment-hooks}

#### Solutio Perfecta / Defecta {#payment-completed--failed}
...
#### Ante Tractationem / Post Completionem {#before-processing--after-completion}
...
### Filtra Pretii {#pricing-filters}

#### Summa Cart {#cart-total}
...
### Filtra Exemplarium {#template-filters}
...
### Filtra Limitationum {#limitation-filters}
...
### Filtra Gateway {#gateway-filters}
...
### Campi Formae Checkout {#checkout-form-fields}
