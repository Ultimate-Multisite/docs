---
title: Exempla codicis provecta
sidebar_position: 1
...
Duae petitiones simul factae eundem valorem legere possunt et ambae idem exitum incrementatum rescribere, uno numero amisso. `increment_item()` arithmeticam machinae datorum mandat una sententia `UPDATE ... SET column = column + ?`, operationem natura atomica reddens.
