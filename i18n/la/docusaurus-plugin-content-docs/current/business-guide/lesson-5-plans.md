---
title: 'Lectio 5: Consilia tua designare'
sidebar_position: 6
...
Pro studiis exercitationis corporis, tria segmenta naturalia exstant:

| Segmentum | Qui Sint | Quid Egeant |
|---------|-------------|----------------|
| **Exercitatores soli / studia parva** | 1-3 ministri, unus locus, initium facientes | Situs professionalis, notitia classium, forma contactus |
| **Gymnasia constituta** | 5-20 ministri, unus locus, crescentia | Omnia supra, plus reservationes, blog, pinacotheca, dominium proprium |
| **Catenae exercitationis corporis** | Plures loci, nota constituta | Omnia supra, plus multi-site, paginae locorum, index ministrorum |
...
**Tabula descriptionis**:
- Nomen: FitSite Starter
- Descriptio: "Omnia quae exercitatori personali aut studio parvo opus sunt ut professionaliter online appareat."

**Tabula generalis**:
- Genus producti: Consilium
- Munus clientis: Administrator

**Tabula Exemplarium Situs**:
- Exemplaria situs permittere: Activatum
- Exemplaria praesto: Studio Essential tantum

**Limitationes**:
- Situs: 1
- Spatium disci: 1 GB
- Dominium proprium: Inactivatum (utitur `studioname.fitsite.com`)

**Tabula Additamentorum**:
- Additamentum formae contactus: Cogere ut activetur
- Additamentum SEO: Cogere ut activetur
- Additamentum reservationum: Non praesto (incitamentum ad meliorem gradum)
...
**Tabula descriptionis**:
- Nomen: FitSite Growth
- Descriptio: "Pro gymnasiis constitutis quae parata sunt praesentiam suam online augere et nova membra attrahere."

**Tabula Exemplarium Situs**:
- Exemplaria praesto: Studio Essential et Gym Pro

**Limitationes**:
- Situs: 1
- Spatium disci: 5 GB
- Dominium proprium: Activatum

**Tabula Additamentorum**:
- Omnia in Starter, plus:
- Additamentum reservationum: Cogere ut activetur
- Additamentum pinacothecae: Cogere ut activetur
- Functiones blog: Praesto

**Tabula Ascensuum et Descensuum**:
...
**Tabula descriptionis**:
- Nomen: FitSite Pro
- Descriptio: "Suggestum completum pro notis exercitationis corporis cum pluribus locis."

**Tabula Exemplarium Situs**:
- Exemplaria praesto: Omnia tria exemplaria

**Limitationes**:
- Situs: 5 (unus pro quoque loco)
- Spatium disci: 20 GB
- Dominium proprium: Activatum

**Tabula Additamentorum**:
- Omnia in Growth, plus:
- Omnia additamenta praemii: Cogere ut activentur
...
1. Statue **Grecem Consiliorum** ad "FitSite Plans" pro omnibus tribus consiliis
2. Statue **Ordinem Producti** ad 1 (Starter), 2 (Growth), 3 (Pro)
...
- **Extra Storage Pack** ($19/mensis) -- additicia 5 GB spatii disci
- **Priority Support** ($29/mensis) -- tempora responsionis celeriora
- **Additional Site** ($39/mensis) -- pro clientibus quibus plures situs opus sunt quam consilium eorum permittit
...
- **Pro** segmento magni valoris servit cui subsidium plurium locorum opus est
...
- **Grex consiliorum** cum itinere ascensus claro
- **Producta incrementorum ordinis** ad reditum additicium
- **Structura pretiorum** in valore clientis fundata, non in specificationibus technicis

---

**Deinde:** [Lectio 6: Experientia Inscriptionis](lesson-6-checkout) -- fluxum solutionis aedificamus qui dominos studiorum exercitationis corporis in clientes solventes convertit.
