---
title: 'Lectio 9: Pretium ad lucrum constituendum'
sidebar_position: 10
...
- Situm interretialem professionalem pro exercitatione corporali, qui $2,000-$5,000 constaret si ex more aedificaretur
- Sustentationem continuam, renovationes, et securitatem de quibus cogitare non necesse habent
- Proprietates nichae proprias quas constructores generici non offerunt
- Fidem platformae ad industriam eorum aedificatae
...
- **Conductio evolutoris interretialis**: $2,000-$5,000 initio + $50-$100/mense pro sustentatione
- **Wix/Squarespace**: $16-$45/mense sed sine proprietatibus exercitationi propriis; ipsi id aedificant
- **Nihil facere**: Sodales amissi qui eos online invenire non possunt
...
| Ratio | Menstruum | Annuum (per mensem) | Totum Annuum | Pars servata |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mense | $39/mense | $468/anno | 20% deductum |
| Growth | $99/mense | $79/mense | $948/anno | 20% deductum |
| Pro | $199/mense | $159/mense | $1,908/anno | 20% deductum |
...
- **Starter**: Nulla merces institutionis (impedimenta ad ingressum remove)
- **Growth**: $99 merces institutionis (configurationem dominii consuetudinis et consultationem initialem tegit)
- **Pro**: $299 merces institutionis (institutionem plurium locorum et vocationem inductionis tegit)
...
- **Probatio gratuita 7 dierum** in ratione Starter tantum
- Nulla probatio in Growth et Pro (hi clientes magis obligati sunt et exspectant se soluturos)
...
- **FITLAUNCH** -- 30% deductum primis 3 mensibus (pro promotione inaugurationis)
- **ANNUAL20** -- 20% deductum a rationibus annuis (si nondum deductae sunt)
- **REFERRAL** -- 1 mensis gratuitus (pro commendationibus clientium)

Naviga ad **Ultimate Multisite > Codices Deductionis** ut hos crees. Vide [Creare Codices Deductionis](/user-guide/configuration/creating-discount-codes) pro duce pleno.
...
1. Configura rates tributorum in **Ultimate Multisite > Optiones > Tributa**
2. Applica categorias tributorum rationibus tuis
3. Cura ut syngraphae tributa recte ostendant
...
- **Rata conversionis per rationem**: Si Starter bene convertit sed Growth non, intervallum inter eas fortasse nimis magnum est
- **Rata promotionis**: Si pauci clientes a Starter ad Growth promoventur, ratio Growth fortasse non satis valoris additi offert
...
- **Tempus probationis** in consilio initiali ad difficultatem inscriptionis minuendam
- **Codices deductionis strategici** ad launch, commendationes, et expeditiones
- **Configuratio tributorum** ad rationes exigendas legibus conformes
- **Compages recensionis pretiorum** ad continuam optimam rationem

---

**Deinde:** [Lectio 10: Dies Launch](lesson-10-launch) -- index rerum ante launch inspiciendarum et publice edere.
