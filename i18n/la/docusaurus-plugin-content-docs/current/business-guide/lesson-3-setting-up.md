---
title: 'Lectio 3: Rete Tuum Configurare'
sidebar_position: 4
...
1. Installa WordPress apud praebitorem hospitii tui
2. Sequere ducem [Quomodo WordPress Multisite Installare](/user-guide/getting-started/how-to-install-wordpress-multisite)
3. Elige configurationem **subdominii** cum rogaberis
...
1. Additamentum in rete totum imponas et actives
2. Exsequaris [Ducem Institutionis](/user-guide/getting-started/multisite-setup-wizard)

Dum ducem institutionis peragis, provinciam FitSite in mente tene:

- **Moneta**: Pone ad monetam qua clientes tui studiorum exercitationis corporis utuntur
...
- Sermonem genericum "novus situs tuus" cum nuntiis exercitationi corporis propriis substitue
- Exemplum tituli salutationis: "Situs interretialis studii exercitationis corporis tui paratus est"
- Exemplum corporis salutationis: Studium eorum, classes, et initium capiendum cum situ exercitationis corporis eorum commemora
...
1. Naviga ad **Ultimate Multisite > Optiones > Mappatio Dominii**
2. Sequere ducem integrationis pro hospite tuo specifico
3. Proba novos subsitus SSL automatice accipere
...
├── Ultimate Multisite (institutum et configuratum)
├── Hospitium cum wildcard SSL
├── Mappatio dominii configurata
├── Exemplaria epistularum electronicarum provinciae propria (initialia)
...
- **Hospitium et SSL** constituta pro rete crescente
- **Mappatio dominii** configurata pro praebitore hospitii tui
- **Tonus epistularum electronicarum provinciae proprius** a primo die constitutus

---

**Proximum:** [Lectio 4: Exemplaria Provinciae Aedificanda](lesson-4-templates) -- exemplaria situs creamus quibus domini studiorum exercitationis corporis re vera uti volent.
