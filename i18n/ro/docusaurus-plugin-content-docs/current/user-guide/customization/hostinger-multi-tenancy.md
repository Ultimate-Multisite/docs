...
## Note de configurare {#setup-notes}
...
## Modificări specifice capacității {#capability-specific-changes}
...
## Depanare tenantilor Hostinger {#troubleshooting-hostinger-tenants}
