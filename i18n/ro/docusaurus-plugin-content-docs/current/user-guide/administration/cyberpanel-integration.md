...
### 1. Activarea API-ului CyberPanel
...
### 2. Adăugarea constantelor în wp-config.php
...
### Maparea Domeniilor (*Domain Mapping*)
...
### Conexiunea API Refuzată (*API Connection Refused*)
...
### Certificatul SSL Nu Este Emitat
