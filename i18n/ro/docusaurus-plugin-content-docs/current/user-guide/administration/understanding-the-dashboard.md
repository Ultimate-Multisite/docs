---
title: Înțelegerea tabloului de bord
sidebar_position: 7
...
Acest widget raportează evenimentele din Ultimate Multisite. Evenimentele includ înscrieri, anulări, creări de site-uri, ștergeri și alte activități.
...
![Graficul creșterii MRR](/img/admin/um-dashboard-mrr.png)
...
![Selector interval de date și statistici](/img/admin/um-dashboard-date-range.png)

Intervalul de date determină perioada pentru informațiile afișate de widget-urile de mai jos, inclusiv venituri, abonamente noi, înscrieri după țară, înscrieri după formular și cele mai vizitate site-uri.

![Widget-uri cu statistici în panoul de control](/img/admin/um-dashboard-stats.png)

:::tip
Pentru ca widget-ul **Cele mai vizitate site-uri** să funcționeze, activează contorizarea vizitelor din **Ultimate Multisite → Setări → Site-uri → Activează limitarea și contorizarea vizitelor**.
:::
