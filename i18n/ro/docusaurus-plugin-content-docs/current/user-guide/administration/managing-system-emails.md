---
title: Gestionarea e-mailurilor de sistem
sidebar_position: 13
...
![Fila Settings - Emails](/img/admin/settings-emails.png)

De acolo, poți accesa pagina **System Emails** pentru a vedea toate șabloanele de email.

![Lista System Emails](/img/admin/system-emails-list.png)

Poți edita și șabloane individuale de email folosind editorul de emailuri de sistem:
...
Pentru a importa șabloane noi de email:

1. Mergi la pagina **System Emails**
2. Fă clic pe butonul **Reset & Import** din partea de sus a paginii
...
1. **Șterge și reimportă** — Șterge emailul de sistem și importă-l din nou (aceasta șterge metricile de trimitere)
2. **Resetează prin instrument** — Folosește instrumentul **Reset & Import**, activează opțiunea **Reset** și selectează emailurile pe care vrei să le resetezi

Opțiunea Reset este preferată, deoarece păstrează metricile de trimitere și alte metadate, restaurând în același timp conținutul implicit.
