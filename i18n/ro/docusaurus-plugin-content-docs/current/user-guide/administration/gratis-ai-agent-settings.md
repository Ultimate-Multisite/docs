...
## Configurarea endpointului de feedback
...
### Dezactivarea colectării feedbackului
...
### Accesarea indicatorilor de funcționalități

1. În administrarea WordPress, mergi la **Gratis AI Agent → Setări**.
2. Fă clic pe fila **Indicatori de funcționalități**.

### Indicatori de control al accesului
...
### Indicatori de siguranță pentru automatizare
