...
---
# Integrarea WPMU DEV {#wpmu-dev-integration}
...
### 1. Verifică găzduirea WPMU DEV {#1-verify-wpmu-dev-hosting}
...
### Ștergerea domeniilor {#domain-removal}
...
### Autentificarea API {#api-authentication}
