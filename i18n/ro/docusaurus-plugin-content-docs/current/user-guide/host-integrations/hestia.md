...
## Configurare (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Exemplu de Apel API (cURL) {#example-api-call-curl}
