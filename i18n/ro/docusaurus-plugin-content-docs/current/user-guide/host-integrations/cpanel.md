...
### 1. Obține datele de autentificare cPanel {#1-get-your-cpanel-credentials}
...
### 2. Adaugă constantele în wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Activează integrarea {#3-enable-the-integration}
