...
### 1. Obține datele de autentificare API pentru ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Obține App ID-ul {#2-get-your-app-id}
...
## Verificarea certificatelor SSL {#ssl-certificate-verification}
...
### Domeniu neadăugat {#domain-not-added}
...
### Eliminarea domeniilor {#domain-removal}
