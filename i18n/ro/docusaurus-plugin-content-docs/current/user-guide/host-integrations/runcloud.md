...
### 1. Obține datele de autentificare API RunCloud {#1-get-your-runcloud-api-credentials}
...
### 2. Obține ID-urile serverului și aplicației {#2-get-your-server-and-app-ids}
