...
## Activarea Căutării pe Internet {#enabling-internet-search}
...
### Obținerea unei Chei API Brave Search {#obtaining-a-brave-search-api-key}
...
### Limitele de Utilizare {#usage-limits}
...
### Obținerea unei Chei API Tavily {#obtaining-a-tavily-api-key}
...
### Limitele de Utilizare {#usage-limits-1}
...
## Dezactivarea Căutării pe Internet {#disabling-internet-search}
