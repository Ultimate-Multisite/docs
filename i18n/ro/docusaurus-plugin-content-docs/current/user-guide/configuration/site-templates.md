...
## Crearea și editarea unui Șablon de site nou
...
### Modul implicit: selectarea șablonului de site în formularul de checkout
...
### Opțiuni pentru șablonul de site
...
#### Permite utilizatorilor să își folosească site-ul ca șabloane
...
## Pre-completarea șabloanelor de site cu căutare și înlocuire automată
