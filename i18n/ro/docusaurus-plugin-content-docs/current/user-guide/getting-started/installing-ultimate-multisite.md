---
title: Instalarea Ultimate Multisite
sidebar_position: 12
...
Din **Panoul de administrare al rețelei**, accesați **Pluginuri → Adăugați un nou plugin**.

![Pagina „Adăugați un nou plugin” din panoul de administrare al rețelei](/img/installation/add-new-plugin.png)

Căutați **„Ultimate Multisite”** (cu ghilimele pentru o potrivire exactă), și acesta va apărea ca primul rezultat. Faceți clic pe **Instalați acum**.

![Rezultatele căutării care afișează Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Odată instalat, faceți clic pe **Activează în rețea** pentru a activa pluginul în întreaga rețea.

![Plugin instalat cu butonul „Activează în rețea”](/img/installation/plugin-installed.png)

După activare, veți fi redirecționat automat către Asistentul de configurare.
...
![Verificările prealabile care afișează cerințele de sistem](/img/installation/wizard-pre-install-checks.png)

:::note Butonul „Activează în rețea” (v2.6.1+)
Dacă Ultimate Multisite a fost instalat, dar **nu a fost încă activat la nivel de rețea** — de exemplu, dacă ați făcut clic pe **Activează** (pentru un singur site) în loc de **Activează în rețea** din ecranul pluginurilor pentru rețea —, etapa de verificare prealabilă va detecta acest lucru și va afișa un buton **Activează în rețea**.
...
![Configurare finalizată - Ecranul „Gata”](/img/installation/wizard-ready.png)

![Panoul de administrare al rețelei cu Ultimate Multisite activat](/img/installation/network-dashboard.png)
