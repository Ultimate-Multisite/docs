---
title: Ghid de Utilizare a Hook-urilor
sidebar_position: 1
...
## Hook-uri de Acțiune {#action-hooks}

### Ciclu de Viață al Clientului {#customer-lifecycle}

#### După Crearea Clientului {#after-customer-creation}
...
#### Schimbarea Statusului Clientului {#customer-status-change}
...
### Hook-uri de Site {#site-hooks}

#### După Publicarea Site-ului {#after-site-published}
...
#### Înainte de Aplicarea Template-ului {#before-template-application}
...
### Hook-uri de Abonament (Membership) {#membership-hooks}

#### Tranziții de Status {#status-transitions}
...
### Hook-uri de Plată {#payment-hooks}

#### Plată Finalizată / Eșuată {#payment-completed--failed}
...
### Hook-uri de Checkout {#checkout-hooks}

#### Înainte de Procesare / După Finalizare {#before-processing--after-completion}
...
### Hook-uri de Domeniu {#domain-hooks}
...
## Hook-uri de Filtrare {#filter-hooks}

### Filtre de Preț {#pricing-filters}

#### Totalul Coșului {#cart-total}
...
### Filtre de Template {#template-filters}
...
### Filtre de Limitare {#limitation-filters}
...
### Filtre de Gateway {#gateway-filters}
...
### Câmpuri de Formular de Checkout {#checkout-form-fields}
...
### Conținutul Emailului {#email-content}
