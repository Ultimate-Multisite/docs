...
## Ce este disponibil {#whats-available}
...
## Instalare cu Composer / Bedrock {#composer--bedrock-installation}
...
### Utilizarea REST API {#use-the-rest-api}

```bash
curl -u "api_key:api_secret" https://yoursite.com/wp-json/wu/v2/customers
```

### Hook-uirea în Evenimente {#hook-into-events}
...
### Crearea unui Addon {#build-an-addon}
