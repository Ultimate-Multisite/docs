...
| Dispozitiv | Lățime | Vizualizare |
|--------|-------|---------|
| **Mobil** | 375px | Telefon în portret |
| **Tabletă** | 768px | Tabletă pe orizontală |
...
- **Verificați contrastul** — folosiți [Validate Palette Contrast](../abilities/validate-palette-contrast.md) pentru accesibilitate
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — verificați accesibilitatea culorilor
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — creați logo-uri personalizate
