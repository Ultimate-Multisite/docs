...
## Cap Captcha: Protecție Self-Hosted care Funcționează Pur și Simplu {#cap-captcha-self-hosted-protection-that-just-works}
...
## Protecția Împaginilor de Testare cu Carduri WooCommerce {#woocommerce-card-testing-protection}
...
## Ai Încă Nevoie de Google reCAPTCHA sau hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Construcție pentru Scală {#built-for-scale}
...
## Trebuie să configurez ceva? {#do-i-need-to-configure-anything}
...
## Pot folosi furnizori de captcha diferiți pe site-uri diferite? {#can-i-use-different-captcha-providers-on-different-sites}

Furnizorul de captcha este setat la nivel de rețea, dar poți ajusta setările de dificultate în funcție de nevoile tale.

## Este conform cu GDPR? {#is-this-gdpr-compliant}
...
## Rate Limiting (Limitarea Ratei) {#rate-limiting}
...
#### Filtru Whitelist IP {#ip-whitelist-filter}
...
#### Acțiune Pre-Blocare {#pre-block-action}
...
## Detectarea IP-ului Client și Proxy-urile de Încredere {#client-ip-detection--trusted-proxies}
...
### Modelul de Încredere {#trust-model}
...
### Configurarea {#configuration-1}

#### Încrederea în Antetul Cloudflare {#cloudflare-header-trust}
...
#### Configurarea Proxy-urilor de Încredere {#trusted-proxy-configuration}
...
#### Detectare Auto la Prima Activare {#first-enable-auto-detection}
...
### De Ce Este Important {#why-this-matters}
