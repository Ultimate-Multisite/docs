---
id: wu_admin_notices
title: Pagsala - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Lista sa mga pahibalo para sa maong panel. |
| $all_notices | `array` | Lista sa mga pahibalo nga gidugang, gibulag sumala sa panel. |
| $panel | `string` | Panel diin kuhaon ang mga pahibalo. |
