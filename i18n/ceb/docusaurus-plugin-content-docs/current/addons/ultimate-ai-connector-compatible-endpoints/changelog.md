---
title: Changelog sa Ultimate AI Connector para sa mga Compatible Endpoints
sidebar_position: 99
...
* Ayos (Fix): Ang bag-ong provider card karon awtomatikong mo-expand pag-add; script cache busting kung mag-update ang plugin.
* Ayos (Fix): Dynamic provider class namespace para sa eval() ug auto-expand behaviour para sa mga bag-ong provider nga gi-add.
* Ayos (Fix): Gigamit na ang stable nga Card/CardBody/CardHeader/CardDivider components (dili na experimental) para sa compatibility sa WordPress 6.9+.
* Ayos (Fix): Gipalit na ang undefined DragHandle ngadto sa unicode grip icon para sa pag-drag ug reorder sa provider.
