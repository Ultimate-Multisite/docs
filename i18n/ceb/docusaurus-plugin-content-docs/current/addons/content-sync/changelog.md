---
title: Tala sa mga Kausaban sa Content Sync
sidebar_position: 99
...
* Bag-o: Pre-selection sa child site alang sa mga template sites
* Bag-o: Pagkuha og media gikan sa post_content para sa tanang post type
* Bag-o: Pag-sync sa taxonomy (categories, tags, custom taxonomies)
* Nabag-o ang ngalan gikan sa "Elementor Template Sync" ngadto sa "Content Sync"
...
* Bug-os nga media sync uban ang awtomatikong ID remapping
* Integrasyon sa settings uban sa Ultimate Multisite
* Suporta sa pag-exclude og site pinaagi sa network settings
* Paglimpyo sa Elementor cache human mag-sync
* Pagtipig (preservation) sa template taxonomy
