...
## Functionality Gidala gikan sa MU Plugin {#functionality-moved-from-mu-plugin}
...
## Pamamahala sa Database (Database Management) {#database-management}
...
### Mga Apektadong Tables {#affected-tables}
