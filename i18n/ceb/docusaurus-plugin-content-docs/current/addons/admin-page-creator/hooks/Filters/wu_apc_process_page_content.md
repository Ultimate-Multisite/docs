...
title: Pagsala - wu_apc_process_page_content
...
|------|------|-------------|
| $content | `string` | Content human sa mga pagpuli. |
| $content_before_processing | `string` | Content sa wala pa ang mga pagpuli. |
