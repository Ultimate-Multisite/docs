---
title: 'Leksyon 9: Pagpresyo alang sa Kita'
sidebar_position: 10
...
- Usa ka propesyonal nga fitness website nga makatabang ug mahimong mopalit og $2,000-$5,000 kon i-build kini pag-ayo
- Padayon nga maintenance, updates, ug security nga dili na nila kinahanglan panghunahunaon
- Mga feature nga espesipiko sa industriya nga wala maagian sa mga generic builders
- Ang kredibilidad sa usa ka platform nga gihimo para sa ilang industriya
...
- **Pagkuha og web developer**: $2,000-$5,000 nga upfront + $50-$100/bulan para maintenance
- **Wix/Squarespace**: $16-$45/bulan apan walay fitness-specific features, sila mismo ang maghimo niini
- **Pagbuhat og wala**: Mawala ang mga miyembro kay dili nila makita online
...
- **Starter**: Walay setup fee (aron dili mahimong babag ang pagsugod)
- **Growth**: $99 setup fee (makapahiuli sa custom domain configuration ug initial consultation)
- **Pro**: $299 setup fee (makapahiuli sa multi-location setup ug onboarding call)
...
- **7-day free trial** lang sa Starter plan
- Walay trial sa Growth ug Pro (kining mga kustomer mas committed ug nagpaabot nga magbayad)
...
- **FITLAUNCH** -- 30% off sa unang 3 ka bulan (para sa launch promotion)
- **ANNUAL20** -- 20% off sa annual plans (kon wala pa kini gi-discount)
- **REFERRAL** -- 1 ka bulan nga libre (para sa mga referral gikan sa kustomer)

Adto sa **Ultimate Multisite > Discount Codes** aron pagmugna niini. Tan-awa ang [Creating Discount Codes](/user-guide/configuration/creating-discount-codes) alang sa kompleto nga giya.

:::tip Ayaw Pag-Discount Kanunay
...
1. I-configure ang tax rates sa **Ultimate Multisite > Settings > Taxes**
2. Ipahamtang ang mga tax categories sa imong mga plano
3. Siguroha nga husto nga magpakita og tax ang mga invoice
...
- **Conversion rate by plan**: Kon maayo ang conversion sa Starter apan dili ang Growth, tingali sobra ra ka dako ang agwat tali niini
- **Upgrade rate**: Kon gamay lang ang kustomer nga nag-upgrade gikan sa Starter paingon sa Growth, basin wala'y igo nga dugang bili ang ihatag sa Growth plan
...
- **Usa ka trial period** sa entry-level plan aron makamenos sa pagsugod nga kalisdanan
- **Strategic discount codes** para sa launch, referrals, ug mga kampanya
- **Tax configuration** alang sa compliant billing
- **A pricing review framework** alang sa padayon nga pagpaayo

---

**Next:** [Lesson 10: Launch Day](lesson-10-launch) -- ang pre-launch checklist ug pagpabuhay.
