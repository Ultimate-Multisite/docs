...
Pangitaa ang **"Ultimate Multisite"** (uban ang mga quotes para sa eksaktong pagpares) ug kini makita isip unang resulta. I-klik ang **Install Now**.

![Mga resulta sa pagpangita nga nagpakita sa Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Kung na-install na, i-klik ang **Network Activate** aron ma-activate ang plugin sa tibuok mong network.

![Plugin na-install uban ang Network Activate button](/img/installation/plugin-installed.png)

Pagkahuman sa pag-activate, awtomatiko ka nga idirekta sa Setup Wizard.
...
![Pre-install checks nagpakita sa mga kinahanglanon sa sistema](/img/installation/wizard-pre-install-checks.png)

:::note Network Activate button (v2.6.1+)
Kung na-install na ang Ultimate Multisite apan **dili pa ma-activate sa network** — pananglit, kung imong gi-klik ang **Activate** (single-site) imbes nga **Network Activate** gikan sa screen sa mga plugin sa network — makita niini ang Pre-install Checks step ug ipakita ang usa ka **Network Activate** button.
...
![Nahuman na ang setup - Ready screen](/img/installation/wizard-ready.png)

![Network Admin Dashboard uban ang aktibo nga Ultimate Multisite](/img/installation/network-dashboard.png)
