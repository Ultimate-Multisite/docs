---
title: Skill sa Estetika sa Design System
sidebar_position: 21
...
1. Mo-update sa imong theme's `theme.json` gamit ang tanang tokens
2. I-apply ang design system sa imong active theme
...
1. **Suriha ang imong site**: Bisitaha ang imong site para makita ang bag-ong disenyo
2. **Pinoon pa**: Buhat og mga kausaban gamit pag-usab sa imong abilidad
3. **Paghimo og templates**: Paghimo og custom block templates gamit ang imong design tokens
4. **Dokumento**: Ipaambit ang imong design system sa mga miyembro sa team
