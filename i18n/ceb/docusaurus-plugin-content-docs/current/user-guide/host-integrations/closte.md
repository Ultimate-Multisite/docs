...
## Mga Instruksyon sa Pag-set Up (Setup Instructions) {#setup-instructions}

### 1. Siguraduhon ang Imong Closte API Key {#1-verify-your-closte-api-key}
...
### 2. I-enable ang Integrasyon (Enable the Integration) {#2-enable-the-integration}
...
## Paghimo og Domain Record (Domain Record Creation) {#domain-record-creation}
...
### Domain Wala Dugang {#domain-not-added}
