---
title: Nag-translate sa Ultimate Multisite
sidebar_position: 19
...
Kini ang standard nga sistema sa paghubad sa komunidad sa WordPress. Kung ang mga hubad naabot na sa saktong threshold sa pag-approve, awtomatikong ipamultiply kini sa tanang Ultimate Multisite users pinaagi sa WordPress plugin updates.

**Gikinahanglan nato ang inyong tabang!** Kung nagsulti mo og lain nga pinulongan gawas sa English, palihog hunahunaa nga magkontribyo og mga hubad. Bisan pag paghubad lang gamay nga mga string makatabang na. Aron magsugod:

1. Bisitaha ang [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Pilia ang inyong pinulongan
3. I-click ang "Contribute Translation"
4. Kinahanglan ninyo og libre nga WordPress.org account
...
1. Download ang Poedit gikan sa [poedit.net](https://poedit.net)
2. Buksan ang `.pot` file gikan sa `wp-content/plugins/ultimate-multisite/lang/`
3. I-translate ang mga strings sa interface sa Poedit
