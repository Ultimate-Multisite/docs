---
title: Pagdumala sa mga Email sa Sistema
sidebar_position: 13
...
Didto, mahimo nimong ma-access ang pahina nga **System Emails** aron makita ang tanang email templates.

![System Emails list](/img/admin/system-emails-list.png)

Mahimo usab nimo i-edit ang mga indibidwal nga email templates gamit ang system email editor:
...
Para mag-import og bag-ong email templates:

1. Moadto sa pahina nga **System Emails**
2. I-click ang button nga **Reset & Import** sa taas sa pahina
...
1. **I-delete ug i-import pag-usab** — I-delete ang system email ug i-import pag-usab niini (kini magtanggal sa mga metrics sa pagpadala)
2. **I-reset pinaagi sa tool** — Gamita ang tool nga **Reset & Import**, i-toggle ang option nga **Reset**, ug piliha ang mga emails nga gusto nimong i-reset

Ang Reset option mas gipaboran kay nagpabilin kini sa mga send metrics ug uban pang metadata samtang giresend pagbalik ang default nga content.
