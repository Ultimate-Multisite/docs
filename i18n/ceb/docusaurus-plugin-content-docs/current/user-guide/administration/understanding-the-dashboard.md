...
Kini nga widget nagreport bahin sa mga panghitabo sa Ultimate Multisite. Ang mga panghitabo naglakip sa signups, cancellations, paghimo og site, pagtanggal, ug uban pang mga kalihokan.
...
Ang date range nagdumala sa panahon sa impormasyong gipakita sa mga widget sa ubos, lakip ang kita, bag-ong miyembro, signups base sa nasud, signups base sa form, ug labing gihitabo nga mga sites.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
Aron molihok ang **Most Visited Sites** widget, i-enable ang visit counting sa **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
