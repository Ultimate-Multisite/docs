...
## Paghimo og Contact Form {#creating-a-contact-form}
...
## Paggamit sa Nahimong Shortcode {#using-the-generated-shortcode}
...
## Pag-customize sa Contact Form {#customizing-the-contact-form}

Pagkahuman nga himuon sa Site Builder ang contact form, pwede pa nimo kining mas i-customize:

### Paggamit pinaagi sa Chat Interface {#via-the-chat-interface}
...
### Paggamit pinaagi sa Admin Interface sa Form Plugin {#via-the-form-plugins-admin-interface}
...
## Mga Form Plugin ug Compatibility {#form-plugins-and-compatibility}
...
## Mga Halimbawa sa Paggamit (Example Use Cases) {#example-use-cases}
