...
Dito nakakabit (hook) ang ating mga API para magdagdag ng mga bagong field template.

Huwag gamitin nang direkta ang filter na ito. Gumamit sa halip ng function na `wu_register_field_template()`.
