...
Tatakbo ito pagkatapos ganap na i-initialize ang Multi-Tenancy addon.

## Mga Parameter {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $addon | `\WP_Ultimo_Multi_Tenancy` | Ang instance ng addon. phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- wu_ is standard prefix for WP Ultimo. |
