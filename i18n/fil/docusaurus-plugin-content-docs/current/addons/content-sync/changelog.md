...
* Bago: Pre-selection ng child site para sa mga template site
* Bago: Pagkuha ng media mula sa post_content para sa lahat ng post type
* Bago: Pag-sync ng taxonomy (kategorya, tag, custom taxonomies)
* Binago: Binago ang pangalan mula "Elementor Template Sync" patungong "Content Sync"
...
* Kumpletong media sync na may awtomatikong ID remapping
* Integrasyon sa settings kasama ang Ultimate Multisite
* Suporta sa pag-exclude ng site sa pamamagitan ng network settings
* Paglilinis ng Elementor cache pagkatapos mag-sync
