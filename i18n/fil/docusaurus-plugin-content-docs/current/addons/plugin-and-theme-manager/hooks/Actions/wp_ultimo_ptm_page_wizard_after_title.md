...
---
# Aksyon: wp_ultimo_ptm_page_wizard_after_title {#action-wpultimoptmpagewizardaftertitle}

Pinapayagan nito ang mga developer ng plugin na magdagdag ng karagdagang mga button sa mga pahina na nakalista.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $ | `\WU_Page` | Instance ng Ultimate Page para sa Multisite |
