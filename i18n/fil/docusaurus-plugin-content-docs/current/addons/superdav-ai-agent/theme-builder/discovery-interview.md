...
- **Color palette** — kinukuha ang mga dominanteng kulay at ginagamit sa tema
- **Visual style** — modern, rustic, minimalist, vibrant, atbp.
- **Mood and atmosphere** — propesyonal, malikhain, palakaibigan, marangya, atbp.
...
- **Mood boards** — mga koleksyon ng mga larawan na kumakatawan sa gusto mong aesthetic
- **Product photos** — kung mayroon kang mga produkto na ipapakita
...
- **Text-heavy images** — mga screenshot na maraming teksto
...
3. **Magbigay ng variety** — paghaluin ang kulay, istilo, at subject matter
...
- **Color palette** — primary, secondary, at accent colors
- **Typography** — font families para sa headings at body text
- **Layout style** — spacing, alignment, at pagkaayos ng component
...
1. Suriin ang nabuong design direction
2. Magbigay ng feedback o humiling ng pagbabago
...
- [Tools and Configuration](./tools.md) — mga available na tools at configuration options
