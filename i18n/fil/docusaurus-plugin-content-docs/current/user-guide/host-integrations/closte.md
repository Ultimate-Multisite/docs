...
---
# Pagsasama ng Closte {#closte-integration}
...
### 1. I-verify ang Iyong Closte API Key {#1-verify-your-closte-api-key}
...
### 2. I-enable ang Pagsasama {#2-enable-the-integration}
...
## Paggawa ng Domain Record {#domain-record-creation}
