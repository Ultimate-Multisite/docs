...
---
# Export at Import {#export--import}
...
## Pag-e-export ng isang site sa ZIP {#exporting-a-site-to-a-zip}
...
## Kasama sa Export (What the export includes) {#what-the-export-includes}
...
## Pag-i-import ng isang site mula sa ZIP {#importing-a-site-from-a-zip}
...
## Limitasyon at Paalala sa Compatibility (Limitations and compatibility notes) {#limitations-and-compatibility-notes}
