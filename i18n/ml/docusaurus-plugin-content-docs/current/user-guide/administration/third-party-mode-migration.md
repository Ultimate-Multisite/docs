...
## എന്താണ് മാറ്റിയത്? (What Changed?)

### v1.12.0-ന് മുമ്പ് (Before v1.12.0)
...
## ആരെയാണ് ഇത് ബാധിക്കുന്നത്? (Who Is Affected?)

### പുതിയ ഇൻസ്റ്റാളേഷനുകൾ (WordPress 7.0+)
...
### നിലവിലുള്ള ഇൻസ്റ്റാളേഷനുകൾ (Existing Installations)
...
### 7.0-ന് മുമ്പുള്ള WordPress പതിപ്പുകൾ (WordPress Versions Before 7.0)
...
## മോഡുകൾ മനസ്സിലാക്കൽ (Understanding the Modes)

### Auto Mode (പുതിയ ഡിഫോൾട്ട്)
...
## നിങ്ങളുടെ നിലവിലെ മോഡ് പരിശോധിക്കൽ (Checking Your Current Mode)

### അഡ്മിൻ പാനലിലൂടെ (Via Admin Panel)
...
## നിങ്ങളുടെ മോഡ് മാറ്റുന്നത് എങ്ങനെ (Changing Your Mode)

### Auto Mode-ലേക്ക് മാറാൻ (Switch to Auto Mode)
...
### Manual Mode-ലേക്ക് മാറാൻ (Switch to Manual Mode)
...
### Legacy Mode-ലേക്ക് മാറാൻ (Switch to Legacy Mode)
...
## Auto Mode-ൻ്റെ ഗുണങ്ങൾ (Benefits of Auto Mode)

### ഓട്ടോമാറ്റിക് കണ്ടെത്തൽ (Automatic Discovery)
...
### നാറ്റീവ് സംയോജനം (Native Integration)
...
### ലളിതമായ മാനേജ്മെന്റ് (Simplified Management)
...
### മികച്ച പ്രകടനം (Better Performance)
...
## മൈഗ്രേഷൻ പാത (Migration Path)

### നിങ്ങൾ WordPress 6.x-ൽ ആണെങ്കിൽ (If You're on WordPress 6.x)
...
### നിങ്ങൾ WordPress 7.0+ ൽ ആണെങ്കിൽ (If You're on WordPress 7.0+)
...
### ഓട്ടോ മോഡിൽ കഴിവുകൾ ലോഡ് ആകുന്നില്ല (Abilities aren't loading in auto mode)
...
### എനിക്ക് ലെഗസി മോഡ് നിലനിർത്തണം (I want to keep legacy mode)
...
### എൻ്റെ കസ്റ്റം കഴിവുകൾ കാണിക്കുന്നില്ല (My custom abilities aren't showing)
...
### "unclassified ability" നോട്ടീസുകൾ ലഭിക്കുന്നു (I'm getting "unclassified ability" notices)
...
## പിന്നോട്ട് പൊരുത്തത (Backward Compatibility)

### നിലവിലുള്ള കോൺഫിഗറേഷനുകൾ (Existing Configurations)
...
### നിർത്തലാക്കൽ ടൈംലൈൻ (Deprecation Timeline)
...
### പുതിയ ഇൻസ്റ്റാളേഷനുകൾക്ക് (For New Installations)
...
### നിലവിലുള്ള ഇൻസ്റ്റാളേഷനുകൾക്ക് (For Existing Installations)
...
### കസ്റ്റം കഴിവുകൾക്ക് (For Custom Abilities)
