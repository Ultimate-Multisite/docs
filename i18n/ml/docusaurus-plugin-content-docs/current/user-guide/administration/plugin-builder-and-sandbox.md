...
## AI വഴി ഒരു Plugin ഉണ്ടാക്കൽ (Generating a Plugin via AI) {#generating-a-plugin-via-ai}
...
## Generated Plugins കൈകാര്യം ചെയ്യൽ (Managing Generated Plugins) {#managing-generated-plugins}
...
## Network-ൽ ഒരു Generated Plugin ഇൻസ്റ്റാൾ ചെയ്യൽ (Installing a Generated Plugin on the Network) {#installing-a-generated-plugin-on-the-network}
