...
## ഇത് എന്തുചെയ്യുന്നു {#what-it-does}
...
## മുൻകൂർ ആവശ്യകതകൾ (Prerequisites) {#prerequisites}
...
## സജ്ജീകരണ നിർദ്ദേശങ്ങൾ (Setup Instructions) {#setup-instructions}

### 1. CyberPanel API എനേബിൾ ചെയ്യുക {#1-enable-the-cyberpanel-api}
...
### 2. wp-config.php-ൽ Constants ചേർക്കുക {#2-add-constants-to-wp-configphp}
...
### 3. Integration എനേബിൾ ചെയ്യുക {#3-enable-the-integration}
...
### 4. കണക്റ്റിവിറ്റി പരിശോധിക്കുക {#4-verify-connectivity}
...
## കോൺഫിഗറേഷൻ റഫറൻസ് (Configuration Reference) {#configuration-reference}
...
## പ്രധാന കുറിപ്പുകൾ (Important Notes) {#important-notes}
...
## റഫറൻസുകൾ (References) {#references}
