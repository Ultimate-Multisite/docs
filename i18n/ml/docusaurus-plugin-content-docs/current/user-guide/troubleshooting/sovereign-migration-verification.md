...
---
# സൊവർיין മൈഗ്രേഷൻ പരിശോധന {#sovereign-migration-verification}
...
## പ്രവർത്തിപ്പിക്കേണ്ട കമാൻഡുകൾ {#commands-to-run}
...
## സാധാരണ പരാജയലുകൾ {#common-failures}

### ഡാറ്റാബേസ് ഗ്രാൻ്റുകൾ ഹോസ്റ്റുമായി মেলে {#database-grants-do-not-match-the-host}
...
### Bedrock അല്ലെങ്കിൽ ലോക്കൽ ഇൻസ്റ്റാളുകൾ ബന്ധിപ്പിക്കാൻ കഴിയുന്നില്ല {#bedrock-or-local-installs-cannot-connect}
...
### അസിങ്ക് പുഷ് ക്യൂ പ്രോസസ്സ് ചെയ്യുന്നില്ല (drain) {#async-push-queue-does-not-drain}
...
### ടെനന്റ് യൂസർ എണ്ണം തെറ്റാണ് {#tenant-user-count-is-wrong}
...
### SSO സന്ദർശനം നിരസിക്കപ്പെടുന്നു {#sso-visit-is-rejected}
...
## എപ്പോൾ വീണ്ടും ശ്രമിക്കണം {#when-to-retry}
