...
### 1. നിങ്ങളുടെ cPanel ക്രെഡൻഷ്യലുകൾ നേടുക {#1-get-your-cpanel-credentials}
...
### 3. ഇന്റഗ്രേഷൻ പ്രവർത്തനക്ഷമമാക്കുക {#3-enable-the-integration}
...
## പ്രധാനപ്പെട്ട കുറിപ്പുകൾ {#important-notes}
