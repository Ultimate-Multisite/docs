...
### 1. നിങ്ങളുടെ ServerPilot API ക്രെഡൻഷ്യലുകൾ നേടുക {#1-get-your-serverpilot-api-credentials}
...
### 2. നിങ്ങളുടെ App ID നേടുക {#2-get-your-app-id}
...
### SSL സർട്ടിഫിക്കറ്റ് മാനേജ്‌മെന്റ് {#ssl-certificate-management}
...
## SSL സർട്ടിഫിക്കറ്റ് വെരിഫിക്കേഷൻ {#ssl-certificate-verification}
