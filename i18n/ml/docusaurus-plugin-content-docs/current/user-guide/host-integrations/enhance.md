...
---
# Enhance കൺട്രോൾ പാനൽ ഇന്റഗ്രേഷൻ {#enhance-control-panel-integration}
...
### സിസ്റ്റം ആവശ്യകതകൾ {#system-requirements}
...
### API ആക്സസ് {#api-access}
API tokens സൃഷ്ടിക്കാൻ Enhance Control Panel-ലേക്ക് administrator ആക്സസ് ഉണ്ടായിരിക്കണം.

## നിങ്ങളുടെ API Credentials എങ്ങനെ ലഭിക്കും {#getting-your-api-credentials}

### 1. ഒരു API Token സൃഷ്ടിക്കുക {#1-create-an-api-token}
...
### 2. നിങ്ങളുടെ Organization ID ലഭിക്കുക {#2-get-your-organization-id}
...
### 3. നിങ്ങളുടെ Server ID ലഭിക്കുക {#3-get-your-server-id}
...
### 4. നിങ്ങളുടെ API URL ലഭിക്കുക {#4-get-your-api-url}
...
### ആവശ്യമായ Constants {#required-constants}
...
### Integration Wizard വഴി സെറ്റപ്പ് {#setup-via-integration-wizard}
...
## കൂടുതൽ WordPress Configuration {#additional-wordpress-configuration}
...
### ഒരു Domain Map ചെയ്യുമ്പോൾ {#when-a-domain-is-mapped}
...
### ഒരു Domain നീക്കം ചെയ്യുമ്പോൾ {#when-a-domain-is-removed}
...
### DNS-ഉം SSL Checking-ഉം {#dns-and-ssl-checking}
...
## സെറ്റപ്പ് Verify ചെയ്യൽ {#verifying-setup}

### Connection ടെസ്റ്റ് ചെയ്യുക {#test-the-connection}
...
### Domain Map ചെയ്തതിന് ശേഷം {#after-mapping-a-domain}
...
### Domain ചേർക്കപ്പെട്ടില്ല {#domain-not-added}
...
### ഉപയോഗിക്കുന്ന സാധാരണ Endpoints {#common-endpoints-used}
...
## കൂടുതൽ Resources {#additional-resources}
