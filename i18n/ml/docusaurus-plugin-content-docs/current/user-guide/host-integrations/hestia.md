...
---
# Hestia Control Panel ഇന്റഗ്രേഷൻ {#hestia-control-panel-integration}
...
## ഇത് എന്താണ് ചെയ്യുന്നത് {#what-it-does}
...
## കോൺഫിഗറേഷൻ (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## സെറ്റപ്പ് പരിശോധിക്കൽ {#verifying-setup}
...
## കുറിപ്പുകളും ടിപ്പുകളും {#notes--tips}
...
## ഉദാഹരണ API Call (cURL) {#example-api-call-curl}
