...
## Setup നിർദ്ദേശങ്ങൾ {#setup-instructions}

### 1. നിങ്ങളുടെ RunCloud API Credentials നേടുക {#1-get-your-runcloud-api-credentials}
...
### 2. നിങ്ങളുടെ Server-ഉം App IDs-ഉം നേടുക {#2-get-your-server-and-app-ids}
...
### 4. Integration Enable ചെയ്യുക {#4-enable-the-integration}
