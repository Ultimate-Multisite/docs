...
---
# Multisite സെറ്റപ്പ് വിസാർഡ് {#multisite-setup-wizard}
...
## വിസാർഡ് എപ്പോഴാണ് ദൃശ്യമാകുന്നത്? {#when-does-the-wizard-appear}
...
## ഘട്ടം 1: സ്വാഗതം {#step-1-welcome}
...
## ഘട്ടം 2: നെറ്റ്‌വർക്ക് കോൺഫിഗറേഷൻ {#step-2-network-configuration}

ഈ ഘട്ടം നിങ്ങളുടെ നെറ്റ്‌വർക്ക് സെറ്റിംഗ്സ് കോൺഫിഗർ ചെയ്യാൻ ആവശ്യപ്പെടുന്നു.

### സൈറ്റ് ഘടന {#site-structure}
...
### നെറ്റ്‌വർക്ക് ടൈറ്റിൽ {#network-title}
...
### നെറ്റ്‌വർക്ക് അഡ്മിൻ ഇമെയിൽ {#network-admin-email}
...
## ഘട്ടം 3: ഇൻസ്റ്റലേഷൻ {#step-3-installation}
...
## ഘട്ടം 4: പൂർത്തിയായി {#step-4-complete}
...
## Manual സെറ്റപ്പ് Fallback {#manual-setup-fallback}
...
### വിസാർഡ് wp-config.php writable അല്ലെന്ന് പറയുന്നു {#the-wizard-says-wp-configphp-is-not-writable}
...
### സെറ്റപ്പിന് ശേഷം സൈറ്റുകൾ ആക്സസ് ചെയ്യാൻ കഴിയുന്നില്ല (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### സെറ്റപ്പിന് ശേഷം authentication പ്രശ്നങ്ങൾ {#authentication-issues-after-setup}
...
### ഇൻസ്റ്റലേഷൻ സമയത്ത് ഒരു ഘട്ടം പരാജയപ്പെട്ടു {#a-step-failed-during-installation}
