...
## Theme Builder Onboarding Flow എന്നാൽ എന്ത്?
...
## Theme Builder Onboarding എങ്ങനെ തുടങ്ങാം

### ആദ്യമായി സജ്ജീകരിക്കുന്നത് (First-Run Setup)
...
### മാനുവൽ ആക്ടിവേഷൻ (Manual Activation)
...
### ഘട്ടം 1: മോഡ് തിരഞ്ഞെടുക്കൽ (Mode Selection)
...
### ഘട്ടം 2: സൈറ്റ് വിവരണം (Site Specification)
...
### ഘട്ടം 3: ഡിസൈൻ സിസ്റ്റം തീരുമാനങ്ങൾ (Design System Decisions)
...
### ഘട്ടം 4: തീം ജനറേഷൻ (Theme Generation)
...
### ഘട്ടം 5: ആക്ടിവേഷനും പരിശോധനയും (Activation and Verification)
...
## Site Specification ഉം site_brief മെമ്മറിയും
...
### നിങ്ങളുടെ site_brief കാണുന്നത് എങ്ങനെ
...
## Onboarding കഴിഞ്ഞ ശേഷം കസ്റ്റമൈസ് ചെയ്യുന്നത്

Theme Builder onboarding പൂർത്തിയാക്കിയ ശേഷം, നിങ്ങൾക്ക് ചെയ്യാൻ കഴിയുന്നത്:

### Design System Aesthetics Skill ഉപയോഗിക്കുക
...
### theme.json നേരിട്ട് എഡിറ്റ് ചെയ്യുക
...
### കസ്റ്റം ബ്ലോക്ക് ടെംപ്ലേറ്റുകൾ ഉണ്ടാക്കുക
...
## താരതമ്യം: പഴയതും പുതിയതുമായ Onboarding
