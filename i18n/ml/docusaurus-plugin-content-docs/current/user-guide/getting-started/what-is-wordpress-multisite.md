...
---
# എന്താണ് WordPress Multisite? {#what-is-wordpress-multisite}
...
## എന്താണ് WordPress Multisite കൃത്യമായി? {#what-exactly-is-wordpress-multisite}
...
## Subdomain അല്ലെങ്കിൽ Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites-ൽ എന്താണ് ഷെയർ ചെയ്യുന്നത്, എന്താണ് ഷെയർ ചെയ്യാത്തത് {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite-ലെ User management {#user-management-on-wordpress-multisite}
...
## Performance പരിഗണനകൾ {#performance-considerations}
