...
#### ടെംപ്ലേറ്റ് അപ്ലയി ചെയ്യുന്നതിന് മുമ്പ് (Before Template Application)
...
### പേയ്‌മെന്റ് Hooks (Payment Hooks)

#### പേയ്‌മെന്റ് പൂർത്തിയായതോ പരാജയപ്പെട്ടതോ (Payment Completed / Failed)
...
## ഫിൽട്ടർ Hooks (Filter Hooks)

### വിലനിർണ്ണയ ഫിൽട്ടറുകൾ (Pricing Filters)

#### കാർട്ട് ടോട്ടൽ (Cart Total)
...
### ടെംപ്ലേറ്റ് ഫിൽട്ടറുകൾ (Template Filters)
...
### പരിമിതി ഫിൽട്ടറുകൾ (Limitation Filters)
...
### ഗേറ്റ്‌വേ ഫിൽട്ടറുകൾ (Gateway Filters)
...
### ചെക്ക്ഔട്ട് ഫോം ഫീൽഡുകൾ (Checkout Form Fields)
...
### ഇമെയിൽ ഉള്ളടക്കം (Email Content)
