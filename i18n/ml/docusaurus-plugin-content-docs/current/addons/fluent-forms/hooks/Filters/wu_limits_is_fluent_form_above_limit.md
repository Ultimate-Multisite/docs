...
|------|------|-------------|
| $value | `bool` | ഫോം തരം ലിമിറ്റിനപ്പുറമാണോ അല്ലയോ എന്ന് ഇത് പരിശോധിക്കുന്നു |
| $form_type | `string` | പരിശോധിക്കപ്പെടുന്ന ഫോം തരം |
| $form_count | `int` | നിലവിലെ ഫോം എണ്ണം |
| $quota | `int` | അനുവദിക്കപ്പെട്ട ക്വാട്ട |
