...
## ഡെവലപ്‌മെന്റ് (Development) {#development}

### സജ്ജീകരണം (Setup) {#setup}
...
### പ്രോജക്റ്റ് ഘടന (Project Structure) {#project-structure}
...
### കോഡ് സ്റ്റാൻഡേർഡുകൾ (Code Standards) {#code-standards}
...
### ബിൽഡ് സിസ്റ്റം (Build System) {#build-system}
