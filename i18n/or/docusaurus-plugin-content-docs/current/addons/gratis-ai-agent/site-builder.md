...
---
# ସାଇଟ୍ ନିର୍ମାତା ସମନ୍ୱୟ v2 {#site-builder-orchestration-v2}
...
### 1. ଯୋଜନା ତିଆରି {#1-plan-generation}
...
### 2. Plugin ଖୋଜ {#2-plugin-discovery}
...
### 3. ଯୋଜନା କାର୍ଯ୍ୟାନ୍ବୟନ {#3-plan-execution}
...
### 4. ପ୍ରଗତି ଟ୍ରାକିଂ {#4-progress-tracking}
...
### 5. ତ୍ରୁଟି ପୁନରୁଦ୍ଧାର {#5-error-recovery}
...
## ସାଇଟ୍ ଯୋଜନା କ୍ଷମତା {#site-plan-abilities}
...
## v1 ଏବଂ v2 ତୁଳନା {#comparing-v1-and-v2}
...
## WP-CLI ଯୋଜନା କମାଣ୍ଡ {#wp-cli-plan-commands}
