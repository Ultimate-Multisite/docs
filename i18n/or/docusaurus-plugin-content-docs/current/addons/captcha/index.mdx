...
## Cap Captcha: Self-Hosted ସୁରକ୍ଷା ଯାହା ସହଜରେ କାମ କରେ {#cap-captcha-self-hosted-protection-that-just-works}
...
## WooCommerce Card Testing ସୁରକ୍ଷା {#woocommerce-card-testing-protection}
...
## ଏବେ ମଧ୍ୟ Google reCAPTCHA କିମ୍ବା hCaptcha ଦରକାର? {#still-need-google-recaptcha-or-hcaptcha}
...
## Scale ପାଇଁ ତିଆରି {#built-for-scale}
...
## ପ୍ରାୟ ପଚରାଯାଉଥିବା ପ୍ରଶ୍ନ {#frequently-asked-questions}

## ମୋତେ କିଛି configure କରିବା ଦରକାର କି? {#do-i-need-to-configure-anything}
...
## ମୁଁ ଭିନ୍ନ sites ରେ ଭିନ୍ନ captcha providers ବ୍ୟବହାର କରିପାରିବି କି? {#can-i-use-different-captcha-providers-on-different-sites}

captcha provider network-wide ଭାବେ set ହୁଏ, କିନ୍ତୁ ଆପଣଙ୍କ ଆବଶ୍ୟକତା ଅନୁସାରେ difficulty settings ସମନ୍ୱୟ କରିପାରିବେ।

## ଏହା GDPR compliant କି? {#is-this-gdpr-compliant}
...
## Client IP Detection ଏବଂ Trusted Proxies {#client-ip-detection--trusted-proxies}
...
#### Cloudflare Header ଭରସା {#cloudflare-header-trust}
...
#### Trusted Proxy ବିନ୍ୟାସ {#trusted-proxy-configuration}
...
#### ପ୍ରଥମ-ସକ୍ଷମ Auto-Detection {#first-enable-auto-detection}
...
### ଏହା କାହିଁକି ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ {#why-this-matters}
