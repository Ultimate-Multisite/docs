...
### 1. ଆପଣଙ୍କ Closte API Key ଯାଞ୍ଚ କରନ୍ତୁ {#1-verify-your-closte-api-key}
...
### 2. Integration କୁ ଅନ୍ୟ କରନ୍ତୁ (Enable) {#2-enable-the-integration}
...
## Domain Record Creation {#domain-record-creation}
...
### SSL ସର୍ଟିକେଟ୍ ସମସ୍ୟା {#ssl-certificate-issues}
...
### ଡୋमेन ଯୋଗାଯୋଗ ନଥିବା {#domain-not-added}
...
### DNS ଚେକ୍ ବର୍ତ୍ତମାନ (DNS Check Interval) {#dns-check-interval}
