...
## ସେଟଅପ ନିର୍ଦ୍ଦେଶ (Setup Instructions)

### ୧. ଆପଣଙ୍କର ServerPilot API କ୍ରିଡେନସିଆଲ୍ (Credentials) ଲାଭ କରନ୍ତୁ
...
### ୩. wp-config.php ରେ କୁମାରନ୍ତୀଗୁଡ଼ିକ ଯୋଡ଼ନ୍ତୁ (Add Constants to wp-config.php)
...
### ୪. ଏକତ୍ରୀତାକୁ ସକାରାତ୍ମକ କରନ୍ତୁ (Enable the Integration)
...
### SSL ସର୍ଟିଫିକେଟ୍ ମ୍ୟାନେଜମେଣ୍ଟ (SSL Certificate Management)
...
## SSL ସର୍ଟିଫିକେଟ୍ ଯାଞ୍ଚ (SSL Certificate Verification)
...
### ଡୋମେନ୍ ଯୋଗ ହେଉନାହିଁ (Domain Not Added)
...
### ডোমেইন রিমুভ করা (Domain Removal)
