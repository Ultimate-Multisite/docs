...
### ୪. ଆପଣଙ୍କ API URL କିପରି ନି ಪಡೆಯବେ
...
### ଆବଶ୍ୟକ ଧାରଣାଗୁଡ଼ିକ (Required Constants)
...
### ଇଣ୍ଟିଗ୍ରେସନ୍ ମାଧ୍ୟମରେ ସେଟଅପ୍ କରିବା
...
### ଯେତେବେଳେ ଏକ ଡୋमेन ବାହାର କରାଯାଏ (When a Domain is Removed)
...
### DNS ଏବଂ SSL ଯାଞ୍ଚ (DNS and SSL Checking)
...
## ସେଟଅପ ଯାଞ୍ଚ କରିବା (Verifying Setup)

### କନେକ୍ସନ୍ ପରୀକ୍ଷା କରନ୍ତୁ (Test the Connection)
...
### ଡୋमेन ମ୍ୟପ୍ କରିବା ପରେ (After Mapping a Domain)
...
## ସମସ୍ୟାଗୁଡ଼ିକର ଉପରେ କାର୍ଯ୍ୟ କରିବା (Troubleshooting)

### API ଯୋଗାଯୋଗ ସମସ୍ୟା (API Connection Issues)
...
### ডোমেইন ଯୋଗାଯୋଗ ହେଉନାହିଁ (Domain Not Added)
...
### SSL ପ୍ରମାଣପ୍ରାପ୍ତି ସମସ୍ୟା (SSL Certificate Issues)
...
### ব্যবহৃত সাধারণ এন্ডপয়েন্টসমূহ
...
## ଅତିରିକ୍ତ ସମ୍ପୂର୍ଣ୍ଣ (Additional Resources)
