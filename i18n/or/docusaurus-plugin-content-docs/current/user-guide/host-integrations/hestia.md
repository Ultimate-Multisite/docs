...
---
# Hestia Control Panel ସହିତ ଏକୀକରଣ (Integration) {#hestia-control-panel-integration}
...
## ଏହା କ'ଣ କରେ (What It Does) {#what-it-does}
...
## ସେଟିଂ (Configuration) (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## ଉଦାହରଣ API କଲ୍ (cURL) {#example-api-call-curl}
...
## ସମସ୍ୟା ଠିକ୍ କରିବା (Troubleshooting) {#troubleshooting}
