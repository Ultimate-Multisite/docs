...
### ୧. ଆପଣଙ୍କର cPanel କ୍ରିଡେନସିଆଲ୍‌ଗୁଡ଼ିକ ଲାଭ କରନ୍ତୁ (Get Your cPanel Credentials)
...
### ୨. wp-config.php ରେ କన్‌ସ୍ଟାଣ୍ଟ୍‌ଗୁଡ଼ିକ ଯୋଡ଼ନ୍ତୁ (Add Constants to wp-config.php)
...
### ୩. ଏକତ୍ରୀକରଣକୁ ସକାରାତ୍ମକ କରନ୍ତୁ (Enable the Integration)
