...
---
# Gratis AI Agent ସେଟିଂସ୍ {#gratis-ai-agent-settings}
...
## ସେଟିଂସ୍ ପ୍ରବେଶ {#accessing-settings}
...
### ଆଶାକରାଯାଉଥିବା JSON Payload {#expected-json-payload}
...
### `triage_category` ମୂଲ୍ୟଗୁଡ଼ିକ {#triagecategory-values}
...
### Feedback Collection ବନ୍ଦ କରିବା {#disabling-feedback-collection}
...
### Feature Flags ପ୍ରବେଶ {#accessing-feature-flags}
...
### ବ୍ରାଣ୍ଡିଂ ଫ୍ଲାଗ୍‌ମାନ {#branding-flags}
...
### ସ୍ୱୟଂଚାଳନ ସୁରକ୍ଷା ଫ୍ଲାଗ୍‌ମାନ {#automation-safety-flags}
...
### ପରିବର୍ତ୍ତନ ଲାଗୁ କରିବା {#applying-changes}
