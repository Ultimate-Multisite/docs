---
title: ହୁକ୍ସ ବ୍ୟବହାର ମାର୍ଗଦର୍ଶିକା
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks ବ୍ୟବହାର ମାର୍ଗଦର୍ଶିକା {#hooks-usage-guide}

Ultimate Multisite ୨୦୦ରୁ ଅଧିକ action hooks ଏବଂ ୨୮୦ରୁ ଅଧିକ filter hooks ପ୍ରଦାନ କରେ। ଏହି ପୃଷ୍ଠାରେ ବ୍ୟବହାରିକ ଉଦାହରଣ ସହ ସବୁଠାରୁ ସାଧାରଣଭାବେ ବ୍ୟବହୃତ hooks ଆଲୋଚନା କରାଯାଇଛି। ସମ୍ପୂର୍ଣ୍ଣ ସ୍ୱୟଂଚାଳିତ ଭାବେ ସୃଷ୍ଟ reference ପାଇଁ, ଏହି ଖଣ୍ଡର ଅନ୍ୟ ପୃଷ୍ଠାଗୁଡ଼ିକୁ ଦେଖନ୍ତୁ।

## Action Hooks {#action-hooks}

### ଗ୍ରାହକ ଜୀବନଚକ୍ର {#customer-lifecycle}

#### ଗ୍ରାହକ ସୃଷ୍ଟି ପରେ {#after-customer-creation}
...
#### ଗ୍ରାହକ ସ୍ଥିତି ପରିବର୍ତ୍ତନ {#customer-status-change}
...
#### Site ପ୍ରକାଶିତ ହେବା ପରେ {#after-site-published}
...
#### Template ପ୍ରୟୋଗ ପୂର୍ବରୁ {#before-template-application}
...
#### ସ୍ଥିତି ପରିବର୍ତ୍ତନ {#status-transitions}
...
#### Payment ସମ୍ପୂର୍ଣ୍ଣ / ବିଫଳ {#payment-completed--failed}
...
#### ପ୍ରକ୍ରିୟାକରଣ ପୂର୍ବରୁ / ସମ୍ପୂର୍ଣ୍ଣ ହେବା ପରେ {#before-processing--after-completion}
...
### ମୂଲ୍ୟ ନିର୍ଦ୍ଧାରଣ Filters {#pricing-filters}
...
### ସୀମାବଦ୍ଧତା Filters {#limitation-filters}
