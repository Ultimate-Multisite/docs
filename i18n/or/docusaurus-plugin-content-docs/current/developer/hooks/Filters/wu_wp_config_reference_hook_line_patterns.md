...
title: ଫିଲ୍ଟର - wu_wp_config_reference_hook_line_patterns
...
ଲାଇନ 143ରେ [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) ଭିତରେ ପରିଭାଷିତ
