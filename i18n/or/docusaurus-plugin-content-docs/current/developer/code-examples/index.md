...
ଦୁଇଟି ସମୟକାଳୀନ ଅନୁରୋଧ ସମାନ ମୂଲ୍ୟ ପଢ଼ିପାରେ ଏବଂ ଦୁହେଁ ସମାନ ବୃଦ୍ଧିତ ଫଳାଫଳକୁ ପଛକୁ ଲେଖିପାରେ, ଫଳରେ ଗୋଟିଏ ଗଣନା ହରାଇଯାଏ। `increment_item()` ଗୋଟିଏ ମାତ୍ର `UPDATE ... SET column = column + ?` ବିବୃତି ସହ ଅଙ୍କଗଣିତକୁ ଡେଟାବେସ୍ ଇଞ୍ଜିନ୍‌କୁ ସମର୍ପଣ କରେ, ଯାହା ଏହି କାର୍ଯ୍ୟକୁ ସ୍ୱଭାବତଃ ପରମାଣୁ କରେ।
