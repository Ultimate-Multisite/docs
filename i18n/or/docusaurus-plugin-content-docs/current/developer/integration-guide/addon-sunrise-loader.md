...
## କେବେ ବ୍ୟବହାର କରିବେ {#when-to-use-it}
...
## ଫାଇଲ୍ ନାମକରଣ ପ୍ରଥା {#file-naming-convention}
...
## ଫାଇଲ୍ କେଉଁଠି ରଖିବେ {#where-to-place-the-file}
...
## ଉପଲବ୍ଧ hooks ଏବଂ filters {#hooks-and-filters-available}
...
## ନ୍ୟୁନତମ ଉଦାହରଣ {#minimal-example}
