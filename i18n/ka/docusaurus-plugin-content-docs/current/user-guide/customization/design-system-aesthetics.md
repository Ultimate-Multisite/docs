...
---
# დიზაინის სისტემის ესთეტიკის უნარი {#design-system-aesthetics-skill}
...
## რა არის დიზაინის სისტემის ესთეტიკა? {#what-is-design-system-aesthetics}
...
## რატომ გამოვიყენოთ დიზაინის სისტემის ესთეტიკის უნარი? {#why-use-design-system-aesthetics}

### თანმიმდევრულობა (Consistency) {#consistency}
...
### ეფექტურობა (Efficiency) {#efficiency}
...
### მოქნილობა (Flexibility) {#flexibility}
...
## დიზაინის სისტემის ესთეტიკის უნარის გააქტიურება {#triggering-the-design-system-aesthetics-skill}
...
### ავტომატური შეთავაზებები (Automatic Suggestions) {#automatic-suggestions}
...
## დიზაინის სისტემის ესთეტიკური პროცესი {#the-design-system-aesthetics-process}

### ნაბიჯი 1: ტიპოგრაფია {#step-1-typography}
...
### ნაბიჯი 2: ფერების პალიტრა {#step-2-color-palette}
...
### ნაბიჯი 3: ინტერვალები (Spacing) {#step-3-spacing}
...
### ნაბიჯი 4: საზღვრები და ჩრდილები (Borders and Shadows) {#step-4-borders-and-shadows}
...
### ნაბიჯი 5: მოძრაობა და ანიმაციები (Motion and Animation) {#step-5-motion-and-animation}
...
## დიზაინის სისტემის ესთეტიკის გამოყენება {#applying-design-system-aesthetics}

### ავტომატური გამოყენება {#automatic-application}
...
### მექანიკური გამოყენება (Manual Application) {#manual-application}

თქვენ ასევე შეგიძლიათ პირდაპირ გადაწეროთ `theme.json`:

## დიზაინის სისტემის ნახვა {#viewing-your-design-system}

### აგენტს ჰკითხეთ {#ask-the-agent}
...
### theme.json-ის ნახვა {#view-themejson}

გახსენით `/wp-content/themes/[theme-name]/theme.json` ტექსტურ რედაქტორში, რომ ნახოთ უხეშ ტოკენების განმარტებები.

## დიზაინის სისტემის განახლება {#updating-your-design-system}

### სწრაფი განახლებები {#quick-updates}
...
### სრული გადაკეთება (Redesign) {#full-redesign}
...
### ნაწილობრივი განახლებები {#partial-updates}
...
## დიზაინის სისტემის საუკეთესო პრაქტიკა {#design-system-best-practices}

### თანმიმდევრულობა (Consistency) {#consistency-1}
...
### მასშტაბურობა (Scalability) {#scalability}
...
## საერთო დიზაინის სისტემის შაბლონები (Common Design System Patterns) {#common-design-system-patterns}

### თანამედროვე მინიმალისტური (Modern Minimalist) {#modern-minimalist}
...
### თბილი და მეგობრული (Warm and Friendly) {#warm-and-friendly}
...
### პროფესიონალური კორპორატიული (Professional Corporate) {#professional-corporate}
...
### კრეატიული და მკვეთრი (Creative and Bold) {#creative-and-bold}
...
## შემდეგი ნაბიჯები (Next Steps) {#next-steps}
