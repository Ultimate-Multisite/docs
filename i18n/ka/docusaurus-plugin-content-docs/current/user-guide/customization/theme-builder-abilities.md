...
---
# თემის მშენებლობის შესაძლებლობები: ბლოკების თემების სკაფტერი და აქტივაცია {#theme-builder-abilities-scaffold-and-activate-block-themes}
...
## ბლოკების თემის სკაფტერი (Scaffold Block Theme) {#scaffold-block-theme}
...
### როგორ გამოვიძახოთ (How to Invoke) {#how-to-invoke}
...
### მოსალოდნელი შედეგი (Expected Output) {#expected-output}
...
### მოსალოდნელი შედეგი (Expected Output) {#expected-output-1}
...
## სამუშაო პროცესი: სტრუქტურირება და აქტივაცია (Workflow: Scaffold and Activate) {#workflow-scaffold-and-activate}
...
## დიზაინის ტოკნები და კസ്റ്റმაიზაცია (Design Tokens and Customization) {#design-tokens-and-customization}
...
## შეზღუდვები და შენიშვნები (Limitations and Notes) {#limitations-and-notes}
