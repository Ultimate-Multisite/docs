...
## ქსელური დაფის ვიჯეტები (Network Dashboard Widgets)
...
### აქტივობის ნაკადი (Activity Stream)
...
### ყოველთვიური განმეორებადი შემოსავლის ზრდა (Monthly Recurring Revenue Growth)
