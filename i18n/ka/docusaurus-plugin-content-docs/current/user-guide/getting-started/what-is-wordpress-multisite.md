...
## რა არის ზუსტად WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## სუბდომენი თუ სუბდი rikt? {#subdomain-or-subdirectory}
...
## სუპერ ადმინი (The Super Admin) {#the-super-admin}
...
## რა არის საერთო ქვესაიტებს შორის და რა არ არის საერთო {#what-is-shared-among-subsites-and-what-is-not}
...
## მომხმარებლის მართვა WordPress Multisite-ზე {#user-management-on-wordpress-multisite}
