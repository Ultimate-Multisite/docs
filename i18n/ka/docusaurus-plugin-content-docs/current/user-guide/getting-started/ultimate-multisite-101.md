...
## WordPress-ის Multisite {#the-wordpress-multisite}
...
#### ქვედა დომენი (Subdomain) vs. ქვედა დირექტორია (Subdirectory) {#subdomain-vs-subdirectory}
...
#### პლაგინები და თემები {#plugins-and-themes}
...
#### მომხმარებლები და ადმინისტრატორები {#users-and-administrators}
...
#### Permalinks (პერმალિંკები) {#permalinks}
...
#### Static Pages (სტატიკური გვერდები) {#static-pages}
...
#### შემთხვევა 2: ნიშური პროვაიდერი (Niche Provider) {#case-2-niche-provider}
...
#### შემთხვევა 3: WordPress ვებ-მასპინგი {#case-3-wordpress-web-hosting}
...
### არქიტექტურული გათვლები (Architecture Considerations) {#architecture-considerations}
...
#### საერთო (Shared) vs. სპეციალიზებული (Dedicated) ჰოსტინგი {#shared-vs-dedicated-hosting}
...
#### შესრულების გათვალისწინებები {#performance-considerations}
...
#### სნაპშოტები (Snapshots) {#snapshots}
...
#### გარე სკრიპტები (External Scripts) {#external-scripts}
...
#### დომენი და SSL {#domain-and-ssl-1}
