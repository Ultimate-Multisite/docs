...
## პლაგინის დაყენება {#installing-the-plugin}
...
### წინასწარი შემოწმება {#pre-install-checks}
...
### სტანდარტული შინაარსი {#default-content}
...
### რეკომენდებული პლაგინები {#recommended-plugins}
