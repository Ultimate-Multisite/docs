...
### 1. მიიღეთ თქვენი ServerPilot API საკრედენტები
...
## SSL სერტიფიკატის ვერიფიკაცია (შეამოწმება)
