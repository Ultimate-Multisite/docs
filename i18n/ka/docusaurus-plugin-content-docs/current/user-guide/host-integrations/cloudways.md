...
### 1. მიიღეთ თქვენი Cloudways API საკვანძოები (Credentials) {#1-get-your-cloudways-api-credentials}
...
### 2. მიიღეთ თქვენი სერვერის და აპლიკაციის ID-ები {#2-get-your-server-and-application-ids}
...
### დომეინების სინქრონიზაცია (Domain Syncing) {#domain-syncing}
...
### SSL სერტიფიკატების მართვა (SSL Certificate Management) {#ssl-certificate-management}
...
## დამატებითი დომეინები (Extra Domains) {#extra-domains}
...
## მნიშვნელოვანი — Wildcard SSL-ის პრობლემა {#important--wildcard-ssl-pitfall}
...
### რეკომენდებული Cloudways SSL-ის დაყენება Ultimate Multisite ქსელისთვის {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### დომეინის დამატება არ არის {#domain-not-added}
