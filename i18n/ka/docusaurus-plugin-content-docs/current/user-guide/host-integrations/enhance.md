...
## თქვენი API კრედენციალტების მიღება

### 1. API ტოკენის შექმნა
...
### 2. ორგანიზაციული ID-ის (Organization ID) მოძიება
...
### 3. სერვერის ID-ის (Server ID) მოძიება
...
### 4. API მისამართის (API URL) მოძიება
...
### დაყენება ინტეგრაციის მანიპულატორის საშუალებით (Setup via Integration Wizard)
...
## დამატებითი WordPress კონფიგურაცია (Additional WordPress Configuration)
...
### .htaccess კონფიგურაცია (Configuration)
...
### Cookie კონსტანტები (Cookie Constants)
...
### როდესაც დომენი გაერთიანებულია (When a Domain is Mapped)
...
### დომეინის დამატება არ არის შესრულებული (Domain Not Added)
...
### ხშირად გამოყენებული ენდპოინტები (Common Endpoints Used)
