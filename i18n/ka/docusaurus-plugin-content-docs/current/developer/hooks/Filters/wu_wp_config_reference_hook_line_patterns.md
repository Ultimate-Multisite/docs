...
title: ფილტრი - wu_wp_config_reference_hook_line_patterns
sidebar_label: wu_wp_config_reference_hook_line_patterns
_i18n_hash: 5fd70ec9bc5a2b3357660797baf5519b
---
# ფილტრი: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

ჩვენ ვამოწმებთ სამ შაბლონს, როდესაც ვცდილობთ გავარკვიოთ, სად შეგვიძლია ჩვენი კონსტანტების ჩასმა:
...
განსაზღვრულია [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143)-ში, 143-ე ხაზზე
