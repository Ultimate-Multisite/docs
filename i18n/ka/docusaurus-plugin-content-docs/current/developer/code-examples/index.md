---
title: გაფართოებული კოდის მაგალითები
sidebar_position: 1
_i18n_hash: 98addf6b26f4c19754fed6e4f64a1704
---
# გაფართოებული კოდის მაგალითები {#advanced-code-examples}

ეს მაგალითები აჩვენებს გაფართოებულ ინტეგრაციის შაბლონებს Ultimate Multisite-თან.

## დინამიკური ფასების ძრავა {#dynamic-pricing-engine}

წესებზე დაფუძნებული ფასების ძრავა, რომელიც იყენებს მოცულობის, ლოიალობისა და სეზონურ ფასდაკლებებს:
...
## გაფართოებული საიტის მომზადება {#advanced-site-provisioning}

ავტომატურად დააკონფიგურირეთ ახალი საიტები plugin-ებით, SSL-ით, CDN-ით, სარეზერვო ასლებითა და მონიტორინგით, plan-ის მახასიათებლებზე დაყრდნობით:
...
## მორგებული შეზღუდვების სისტემა {#custom-limitations-system}

თვალყური ადევნეთ და აღასრულეთ რესურსების ლიმიტები გამოყენების გაფრთხილებებით:
...
## BerlinDB ატომური მთვლელი `increment_item()`-ით {#berlindb-atomic-counter-with-incrementitem}

Ultimate Multisite v2.6.1-მ BerlinDB `Query` კლასს დაამატა `increment_item()` მეთოდი. გამოიყენეთ ის რიცხვით სვეტებზე უსაფრთხო, ატომური ზრდების შესასრულებლად read-modify-write შეჯიბრებების გარეშე — სასარგებლოა მთვლელებისთვის, გამოყენების კვოტებისთვის და rate-limiting შემოწმებებისთვის, რომლებიც პარალელური მოთხოვნების პირობებში მუშაობს.

### მეთოდის სიგნატურა {#method-signature}
...
### API გამოყენების თვალყურის დევნება თითოეული წევრობისთვის {#tracking-api-usage-per-membership}

პრაქტიკული შაბლონი თითოეული წევრობისთვის API rate limit-ების აღსასრულებლად:
...
### რატომ `increment_item()` და არა `update_item()` {#why-incrementitem-instead-of-updateitem}

გულუბრყვილო read-modify-write მიდგომა პარალელური მოთხოვნების პირობებში უსაფრთხო არ არის:
...
ორ ერთდროულ მოთხოვნას შეუძლია წაიკითხოს ერთი და იგივე მნიშვნელობა და ორივემ უკან ჩაწეროს იგივე გაზრდილი შედეგი, რის გამოც ერთი დათვლა დაიკარგება. `increment_item()` არითმეტიკას გადასცემს მონაცემთა ბაზის ძრავს ერთი `UPDATE ... SET column = column + ?` ბრძანებით, რაც ოპერაციას ბუნებრივად ატომურს ხდის.
