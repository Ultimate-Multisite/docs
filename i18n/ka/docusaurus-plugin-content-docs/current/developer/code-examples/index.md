...
## BerlinDB ატომური მთვლელი `increment_item()`-ით
...
### API გამოყენების თვალყურის დევნება თითოეული წევრობისთვის
...
### რატომ `increment_item()` და არა `update_item()`
