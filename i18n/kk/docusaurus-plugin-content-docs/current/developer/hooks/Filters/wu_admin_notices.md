...
|------|------|-------------|
| $notices | `array` | Сол нақты панельге арналған хабарламалар тізімі. |
| $all_notices | `array` | Панель бойынша бөлінген қосылған хабарламалар тізімі. |
| $panel | `string` | Хабарламаларды алу үшін панель. |
