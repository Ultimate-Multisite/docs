---
title: Хуктарды пайдалану нұсқаулығы
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks пайдалану нұсқаулығы {#hooks-usage-guide}

Ultimate Multisite 200-ден астам action hook және 280-нен астам filter hook ұсынады. Бұл бет практикалық мысалдармен ең жиі қолданылатын hooks түрлерін қамтиды. Толық автоматты түрде жасалған анықтама үшін осы бөлімдегі басқа беттерді қараңыз.

## Action Hooks {#action-hooks}

### Клиенттің өмірлік циклі {#customer-lifecycle}

#### Клиент жасалғаннан кейін {#after-customer-creation}
...
#### Клиент мәртебесінің өзгеруі {#customer-status-change}
...
#### Сайт жарияланғаннан кейін {#after-site-published}
...
#### Үлгіні қолданар алдында {#before-template-application}
...
### Мүшелік hooks {#membership-hooks}

#### Мәртебе ауысулары {#status-transitions}
...
### Төлем hooks {#payment-hooks}

#### Төлем аяқталды / сәтсіз аяқталды {#payment-completed--failed}
...
#### Өңдеуге дейін / аяқталғаннан кейін {#before-processing--after-completion}
...
### Баға белгілеу сүзгілері {#pricing-filters}

#### Себет жиыны {#cart-total}
...
#### Салық мөлшерлемелері {#tax-rates}
...
### Үлгі сүзгілері {#template-filters}
...
### Шектеу сүзгілері {#limitation-filters}
...
### Gateway сүзгілері {#gateway-filters}
...
### Checkout форма өрістері {#checkout-form-fields}
