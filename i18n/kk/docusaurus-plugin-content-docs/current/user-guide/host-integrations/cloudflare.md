...
### 1. Cloudflare API кілтіңізді алыңыз {#1-get-your-cloudflare-api-key}
...
### 2. Зона ID-ңізді алыңыз {#2-get-your-zone-id}
...
### 3. wp-config.php-ке тұрақты сандарды қосыңыз {#3-add-constants-to-wp-configphp}
...
### 4. Интеграцияны іске қосу {#4-enable-the-integration}
...
### Поддоменді басқару {#subdomain-management}
...
### Поддомен қосылмаған {#subdomain-not-added}
...
### Проксиулау мәселелері {#proxying-issues}
