...
---
# Қажеттілікті көру (Ability Visibility) {#ability-visibility}
...
## Қажеттілікті көру дегеніміз не? {#what-is-ability-visibility}
...
## Қажеттілікті көруді басқару {#managing-ability-visibility}

### Қажеттілік көру параметрлеріне қол жеткізу {#accessing-ability-visibility-settings}
...
### Қажеттіліктің мәліметтерін қарау {#viewing-ability-details}
...
### Көріну деңгейлерін өзгерту {#changing-visibility-levels}
...
### Жоғары деңгейдегі операциялар (Bulk Operations) {#bulk-operations}
...
## Партнер рұқсат тізілімі (Partner Allow-List) {#partner-allow-list}
...
### Партнерлерді қосу {#adding-partners}
...
### Қажеттіліктерді партнерлерге тағайындау {#assigning-abilities-to-partners}
...
### Партнерге қол жеткізуді бұзу {#revoking-partner-access}
...
## Классификацияланбаған мүмкіндіктер (Unclassified Abilities) {#unclassified-abilities}

Егер Superdav AI Agent та танымаған үшінші тараптың мүмкіндігін орнатсаңыз, ол **Классификацияланбаған** деп белгіленеді.

### Классификацияланбаған мүмкіндіктер туралы администратор хабарламасы {#admin-notice-for-unclassified-abilities}
...
### Классификацияланбаған мүмкіндіктерді қарау {#reviewing-unclassified-abilities}
...
### Классификацияланбаған мүмкіндіктерді неге классификациялау керек? {#why-classify-unclassified-abilities}
...
## Әртүрлі беттерде көрініс беру {#visibility-in-different-surfaces}
...
## Қауіпсіздік бойынша үздік тәжірибелер {#security-best-practices}

### Төменгі құқық принципі {#principle-of-least-privilege}
...
### Үздік тексерулер {#regular-audits}
...
### Журнал және бақылау {#logging-and-monitoring}
...
### Үшінші тарап мүмкіндіктері {#third-party-abilities}
...
## Оширдыларды шешу {#troubleshooting}
...
## Ескі режимнен миграциялау {#migration-from-legacy-mode}
