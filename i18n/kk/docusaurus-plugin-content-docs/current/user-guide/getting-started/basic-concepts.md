...
---
# Негізгі ұғымдар {#basic-concepts}
...
## Деңгейлі деректер базасы (Database) {#database}
...
## Хостинг провайдери (Hosting provider) {#hosting-provider}
...
## Субдиректория (Subdirectory) {#subdirectory}
...
## Сайт Шаблоны (Site Template) {#site-template}
...
## Доменді Сәйкестендіру (Domain Mapping) {#domain-mapping}
...
## Checkout Form (Ордені Қосу Формасы) {#checkout-form}
