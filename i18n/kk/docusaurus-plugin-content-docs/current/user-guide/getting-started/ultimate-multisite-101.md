...
#### Субдомен vs. Субдиректория (Subdomain vs. Subdirectory) {#subdomain-vs-subdirectory}
...
#### Плагиндер және Темалар {#plugins-and-themes}
...
#### Жоюшылар және Администраторлар {#users-and-administrators}
...
#### Permalinks (Сайт сілтемелері) {#permalinks}
...
#### Static Pages (Статикалық парақтар) {#static-pages}
...
### Пайдалану Сценарийлері {#use-cases}

#### 1-Сынария: Агенттік (Agency) {#case-1-an-agency}
...
#### 2-ке мысал: Ниша жеткізуші (Niche Provider) {#case-2-niche-provider}
...
#### 3-Жарайы: WordPress Веб Хостингі {#case-3-wordpress-web-hosting}
...
### Құрылымдық Ескертулер {#architecture-considerations}
...
#### Ортақ және Арнайы Хостинг (Shared vs. Dedicated Hosting) {#shared-vs-dedicated-hosting}
...
#### Снапшоттар (Snapshots) {#snapshots}
...
#### Внешние скрипты (External Scripts) {#external-scripts}
...
#### Домен және SSL {#domain-and-ssl-1}
