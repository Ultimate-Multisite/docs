...
---
# Մի քանի տնօրինակների անկախություն (Multi-Tenancy Isolation) {#multi-tenancy-isolation}
...
## Անկախության ռազմավարություն (Isolation strategy) {#isolation-strategy}
...
## Բազայի հոստիի կապակցում (Database host binding) {#database-host-binding}
...
## Ֆայլային համակարգի արմատ (Filesystem root) {#filesystem-root}
...
## Հաստատման հերթականություն (Provisioning order) {#provisioning-order}
...
## Սովրենային հաճախորդների կառավարման հոսքեր (Sovereign customer management flows) {#sovereign-customer-management-flows}
