...
## વર્ડપ્રેસ મલ્ટીસાઇટ {#the-wordpress-multisite}
...
#### ենթադիր անունը (Subdomain) vs. ենթադիր թղթապանակը (Subdirectory) {#subdomain-vs-subdirectory}
...
#### Պլագիններ և թեմաներ (Plugins and Themes) {#plugins-and-themes}
...
#### Օգտվողներ և ադմիններ (Users and Administrators) {#users-and-administrators}
...
#### Permalinks (Հղումների կառուցվածք) {#permalinks}
...
#### Static Pages (Սථատ էջեր) {#static-pages}
...
### Գրանցում (Registration) {#registration}
...
#### Դեպք 2. Խոսնակցական մատակարար (Niche Provider) {#case-2-niche-provider}
...
#### 3-րդ դեպք. WordPress වෙබ් հոստինգ {#case-3-wordpress-web-hosting}
...
### Ճարտարապետական հաշվի առնելու հարցեր {#architecture-considerations}
...
#### Ընդհանուր (Shared) vs. Տվյալների բաժանված (Dedicated) հոստինգ {#shared-vs-dedicated-hosting}
...
#### Արագության հաշվի առնելը (Performance Considerations) {#performance-considerations}
...
#### Սնոպշոտներ (Snapshots) {#snapshots}
...
#### બાહ્ય સ્ક્રિપ્ટ્સ (External Scripts) {#external-scripts}
