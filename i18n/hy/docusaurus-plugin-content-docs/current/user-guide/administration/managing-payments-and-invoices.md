...
## Իրավարձակման կարգավորումներ (Payment Settings)
...
### Ընդհանուր վճարման տարբերակներ (General Payment Options)
...
### Վճարման մուտքեր (Payment Gateways)
...
## Վճարումների դիտում (Viewing Payments)
