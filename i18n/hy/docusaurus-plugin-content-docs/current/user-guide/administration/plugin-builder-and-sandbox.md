...
## Plugin-ի գեներացում AI-ի միջոցով {#generating-a-plugin-via-ai}
...
## Sandbox-ում ակտիվացում {#sandbox-activation}
...
## Ստեղծված Plugin-երի կառավարում {#managing-generated-plugins}
...
## Ստեղծված Plugin-ի Տեղադրում ցանցում {#installing-a-generated-plugin-on-the-network}
...
## Plugin-երի Թարմացումներ {#plugin-updates}
...
## Անվտանգության Հետևողություններ {#security-considerations}
