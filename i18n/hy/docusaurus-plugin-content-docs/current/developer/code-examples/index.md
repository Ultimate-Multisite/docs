---
title: Ընդլայնված կոդի օրինակներ
sidebar_position: 1
...
Երկու միաժամանակյա հարցումներ կարող են կարդալ նույն արժեքը և երկուսն էլ հետ գրել նույն ավելացված արդյունքը՝ կորցնելով մեկ հաշվում։ `increment_item()`-ը թվաբանությունը փոխանցում է տվյալների բազայի շարժիչին՝ մեկ `UPDATE ... SET column = column + ?` հրամանով, դարձնելով գործողությունն ի բնե ատոմային։
