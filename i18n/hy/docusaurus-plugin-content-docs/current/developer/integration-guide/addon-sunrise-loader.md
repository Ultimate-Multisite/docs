...
---
# Addon Sunrise ֆայլի բեռնիչ {#addon-sunrise-file-loader}
...
## Երբ օգտագործել այն {#when-to-use-it}
...
## Ֆայլի անվանման կանոն {#file-naming-convention}
...
## Որտեղ տեղադրել ֆայլը {#where-to-place-the-file}
...
## Հասանելի hook-եր և զտիչներ {#hooks-and-filters-available}
...
## Նվազագույն օրինակ {#minimal-example}
