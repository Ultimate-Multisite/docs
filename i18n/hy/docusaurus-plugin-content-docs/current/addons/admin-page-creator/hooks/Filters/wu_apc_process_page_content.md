...
title: Զտիչ - wu_apc_process_page_content
...
|------|------|-------------|
| $content | `string` | Բովանդակությունը փոխարինումներից հետո։ |
| $content_before_processing | `string` | Բովանդակությունը նախքան փոխարինումները։ |
