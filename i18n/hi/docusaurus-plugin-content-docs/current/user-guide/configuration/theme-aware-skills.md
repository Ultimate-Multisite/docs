...
## What Are Theme-Aware Skills? (थीम-जागरूक स्किल्स क्या हैं?) {#what-are-theme-aware-skills}
...
## Available Theme-Aware Skills (उपलब्ध थीम-जागरूक स्किल्स) {#available-theme-aware-skills}
...
### Kadence Blocks (काडेंस ब्लॉक्स) {#kadence-blocks}
...
### Kadence Theme (काडेंस थीम) {#kadence-theme}
...
## How Skills Are Selected (स्किल्स कैसे चुनी जाती हैं) {#how-skills-are-selected}
...
### Multiple Skills (कई स्किल्स) {#multiple-skills}
...
### Switching Themes (थीम बदलना) {#switching-themes}
...
## Using Theme-Aware Skills (थीम-जागरूक स्किल्स का उपयोग करना) {#using-theme-aware-skills}
