...
---
# Closte इंटीग्रेशन {#closte-integration}
...
### 1. अपनी Closte API Key सत्यापित करें {#1-verify-your-closte-api-key}
...
### 2. इंटीग्रेशन सक्षम करें {#2-enable-the-integration}
...
## Domain Record निर्माण {#domain-record-creation}
