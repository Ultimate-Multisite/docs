...
---
# cPanel इंटीग्रेशन {#cpanel-integration}
...
### 1. अपने cPanel क्रेडेंशियल्स प्राप्त करें {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php में Constants जोड़ें {#2-add-constants-to-wp-configphp}
