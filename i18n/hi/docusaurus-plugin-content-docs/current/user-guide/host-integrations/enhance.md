...
## अपने API Credentials प्राप्त करना {#getting-your-api-credentials}

### 1. API Token बनाएं {#1-create-an-api-token}
...
### 2. अपना Organization ID प्राप्त करें {#2-get-your-organization-id}
...
### 3. अपना Server ID प्राप्त करें {#3-get-your-server-id}
...
### 4. अपना API URL प्राप्त करें {#4-get-your-api-url}
...
### आवश्यक Constants {#required-constants}
...
### Integration Wizard के माध्यम से Setup {#setup-via-integration-wizard}
...
## अतिरिक्त WordPress Configuration {#additional-wordpress-configuration}
...
### जब एक Domain Map होता है {#when-a-domain-is-mapped}
...
### जब एक Domain Remove होता है {#when-a-domain-is-removed}
...
### DNS और SSL Checking {#dns-and-ssl-checking}
...
## Setup Verify करना {#verifying-setup}

### Connection Test करें {#test-the-connection}
...
### Domain Map करने के बाद {#after-mapping-a-domain}
...
### API Connection समस्याएं {#api-connection-issues}
...
### Domain Add नहीं हुआ {#domain-not-added}
...
### SSL Certificate समस्याएं {#ssl-certificate-issues}
...
### उपयोग किए जाने वाले सामान्य Endpoints {#common-endpoints-used}
...
## अतिरिक्त Resources {#additional-resources}
