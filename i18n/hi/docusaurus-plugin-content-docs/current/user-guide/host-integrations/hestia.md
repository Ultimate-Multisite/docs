...
---
# Hestia Control Panel इंटीग्रेशन {#hestia-control-panel-integration}
...
## कॉन्फ़िगरेशन (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## सेटअप की जांच करना {#verifying-setup}
...
## उदाहरण API Call (cURL) {#example-api-call-curl}
