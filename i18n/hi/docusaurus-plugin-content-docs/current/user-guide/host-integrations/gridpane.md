...
### 1. अपने GridPane API Credentials प्राप्त करें {#1-get-your-gridpane-api-credentials}
...
### 2. अपने Server और Site IDs प्राप्त करें {#2-get-your-server-and-site-ids}
...
### 4. Integration सक्षम करें {#4-enable-the-integration}
