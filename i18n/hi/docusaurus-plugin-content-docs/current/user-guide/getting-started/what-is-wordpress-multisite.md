...
---
# WordPress Multisite क्या है? {#what-is-wordpress-multisite}
...
## WordPress Multisite वास्तव में क्या है? {#what-exactly-is-wordpress-multisite}
...
## Subdomain या Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites के बीच क्या share होता है और क्या नहीं {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite पर User management {#user-management-on-wordpress-multisite}
