...
## Theme Builder Onboarding Flow क्या है?
...
## Theme Builder Onboarding शुरू करना

### पहली बार सेटअप (First-Run Setup)
...
### मैन्युअल एक्टिवेशन (Manual Activation)
...
## Onboarding के चरण (The Onboarding Steps)

### चरण 1: मोड का चयन (Mode Selection)
...
### चरण 2: साइट का विवरण (Site Specification)
...
### चरण 3: डिज़ाइन सिस्टम के निर्णय (Design System Decisions)
...
### चरण 4: थीम जनरेशन (Theme Generation)
...
### चरण 5: एक्टिवेशन और सत्यापन (Activation and Verification)
...
## Site Specification और site_brief Memory
...
### site_brief क्यों महत्वपूर्ण है
...
## Onboarding के बाद कस्टमाइज़ करना (Customizing After Onboarding)

Theme Builder onboarding पूरा होने के बाद, आप:

### Design System Aesthetics Skill का उपयोग करें
...
## तुलना: पुराना बनाम नया Onboarding
