...
## विज़ार्ड कब दिखाई देता है? {#when-does-the-wizard-appear}
...
### विज़ार्ड कहता है कि wp-config.php writable नहीं है {#the-wizard-says-wp-configphp-is-not-writable}
...
### Setup के बाद sites accessible नहीं हैं (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Setup के बाद authentication issues {#authentication-issues-after-setup}
...
### Installation के दौरान कोई step fail हो गया {#a-step-failed-during-installation}
