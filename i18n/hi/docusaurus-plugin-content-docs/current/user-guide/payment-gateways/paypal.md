...
---
# PayPal Gateway सेट करना (v2) {#setting-up-the-paypal-gateway-v2}
...
## अपने नेटवर्क पर PayPal सक्षम करना {#enabling-paypal-on-your-network}
...
## मार्गदर्शित सेटअप विज़ार्ड का उपयोग करना {#using-the-guided-setup-wizard}
...
## PayPal API क्रेडेंशियल प्राप्त करना {#getting-the-paypal-api-credentials}
