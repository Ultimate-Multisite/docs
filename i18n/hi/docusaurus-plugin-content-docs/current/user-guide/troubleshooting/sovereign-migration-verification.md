...
## सामान्य विफलताएं (Common failures) {#common-failures}

### डेटाबेस ग्रांट होस्ट मेल नहीं खाती {#database-grants-do-not-match-the-host}
...
### बेडरोक (Bedrock) या लोकल इंस्टॉलेशन कनेक्ट नहीं हो पाते {#bedrock-or-local-installs-cannot-connect}
...
### टेनेंट उपयोगकर्ता संख्या गलत है (Tenant user count is wrong) {#tenant-user-count-is-wrong}
...
### SSO विज़िट अस्वीकृत है (SSO visit is rejected) {#sso-visit-is-rejected}
...
## दोबारा प्रयास कब करें {#when-to-retry}
