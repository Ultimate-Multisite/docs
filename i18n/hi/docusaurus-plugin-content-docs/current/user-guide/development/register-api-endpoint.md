...
यहाँ API Settings पेज का पूरा दृश्य है:

![API Settings का पूरा पेज](/img/config/settings-api-full.png)
...
## Zapier में action बनाना {#creating-an-action-in-zapier}
...
### Action बनाना {#creating-an-action}
