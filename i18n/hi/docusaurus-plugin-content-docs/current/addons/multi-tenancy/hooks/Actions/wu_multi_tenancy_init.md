...
यह तब ट्रिगर होता है जब मल्टी-टेनेंसी ऐडऑन पूरी तरह से इनिशियलाइज़ हो जाता है।

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $addon | `\WP_Ultimo_Multi_Tenancy` | ऐडऑन का इंस्टेंस। phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- wu_ WP Ultimo के लिए मानक प्रीफ़िक्स है। |
