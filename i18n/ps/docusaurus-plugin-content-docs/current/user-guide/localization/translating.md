...
ئەمە سیستەمی وەرگێڕانی estàndard ی کۆمەڵگای WordPressە. کاتێک وەرگێڕانەکان ئاستی پەسەندکردنی پێویست بەدەست دەهێنن، بە شێوەیەکی ئۆتۆماتیک بۆ هەموو بەکارهێنەرانی Ultimate Multisite لە ڕێگەی به‌روزرسیکردنی پڵگینی WordPress دابەش دەکرێن.

**ئێمە پێویستە یارمەتیت بدەین!** ئەگەر زمانی تر نەکات، تکایە بیر بکەرەوە کە وەرگێڕان پێشکەش بکەیت. تەنانەت وەرگێڕانی چەند ڕستەیەکی یارمەتیدا دەدات. بۆ دەستپێکردن:
...
3. لەسەر دڵنیایی "Contribute Translation" کلیک بکە
...
1. Poedit د [poedit.net](https://poedit.net) څخه ډاونلوډ کړئ
2. هغه `.pot` فایل چې له `wp-content/plugins/ultimate-multisite/lang/` کې دی، پرې खोله کړئ
3. په Poedit интерфей کې متنونه ترجمه کړئ
