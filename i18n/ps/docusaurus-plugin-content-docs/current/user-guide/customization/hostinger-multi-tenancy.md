...
## تنظیم کولو یادا出来ي (Setup notes) {#setup-notes}
...
## په خاص قابلیتونو کې بدلونونه (Capability-specific changes) {#capability-specific-changes}
...
## د Hostinger تَنټینتونو په حل کېدو کې ستونمو حل (Troubleshooting Hostinger tenants) {#troubleshooting-hostinger-tenants}
