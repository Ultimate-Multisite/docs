...
### ধাপ ৪ — TLD সমূহ আমদানি কৰক (Import TLDs)
...
### ধাপ ৫ — এটা ডোমেইন প্ৰডাক্ট সৃষ্টি কৰক
...
## প্ৰদানকাৰ পুনৰ কনফিগুৰেট কৰা (Reconfiguring a provider)
