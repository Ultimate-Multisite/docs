...
### १. आफ्नो GridPane API प्रमाणहरू प्राप्त गर्नुहोस् (Get Your GridPane API Credentials)
...
### २. आफ्नो सर्भर र साइट ID प्राप्त गर्नुहोस् (Get Your Server and Site IDs)
...
### ३. wp-config.php मा कन्स्टेन्टहरू थप्नुहोस् (Add Constants to wp-config.php)
...
### ४. इन्टिग्रेशन सक्रिय गर्नुहोस् (Enable the Integration)
