...
### 1. گەرانەکان و API Credentials یاری بکە (Get Your RunCloud API Credentials) {#1-get-your-runcloud-api-credentials}
...
### 2. Server و App ID یاری بکە (Get Your Server and App IDs) {#2-get-your-server-and-app-ids}
...
### 3. گۆڕانکارییەکان لە wp-config.php دا زیاد بکە (Add Constants to wp-config.php) {#3-add-constants-to-wp-configphp}
...
### 4. یەکگرتووکارییەکە چالاک بکە (Enable the Integration) {#4-enable-the-integration}
