...
### ۱. خپل ServerPilot API Credentials ترلاسه کړئ
...
### ۳. Constants په wp-config.php کې اضافه کړئ
...
### ۴. همغږي فعال کړئ (Enable the Integration)
...
### د ډامین syncing (Domain Syncing)
...
### SSL Certificate Management (د SSL سندات مدیریت)
...
## SSL Certificate Verification (د SSL سنداتو تایید)
...
## Troubleshooting (مشکلاتي حل)

### API Connection Issues (د API اړیکو مشکلات)
...
### SSL Certificate Issues (د SSL سنداتو مشکلات)
...
### Domain Not Added (ډومین اضافه نه شوی)
