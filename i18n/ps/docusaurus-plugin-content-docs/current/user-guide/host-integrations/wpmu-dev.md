...
### ۱. WPMU DEV هاستۍ تایید کړئ (Verify WPMU DEV Hosting)
...
### ۲. همکارۍ فعال کړئ (Enable the Integration)
...
### Domain Syncing (د domain سنسینګ)
...
### SSL Certificate Management (د SSL سنداتو مدیریت)
