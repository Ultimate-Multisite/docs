...
## سیٹ اپ کے ہدایات (Setup Instructions)

### 1. اپنے Closte API کیپ کو تصدیق کریں (Verify Your Closte API Key)
...
### 2. انٹیگریشن کو فعال کریں (Enable the Integration)
...
## ڈومین ریکارڈ تخلیق (Domain Record Creation)
...
### د DNS چک فاصله (DNS Check Interval)
