...
## د ووردپرس Multisite {#the-wordpress-multisite}
...
#### کارونکي او مدیران (Users and Administrators) {#users-and-administrators}
...
### ثبتول (Registration) {#registration}
...
### استعمال کے صورتحال (Use Cases) {#use-cases}

#### حالت ۱: یو ایجنسی (An Agency) {#case-1-an-agency}
...
#### مورد ۳: میزبانی وب وردپرس (WordPress Web Hosting) {#case-3-wordpress-web-hosting}
...
### ملاحظات معماری (Architecture Considerations) {#architecture-considerations}
...
#### میزبانی مشترک در مقابل اختصاصی (Shared vs. Dedicated Hosting) {#shared-vs-dedicated-hosting}
...
#### خارجي اسکرپټونه (External Scripts) {#external-scripts}
...
#### ڈومین اور SSL {#domain-and-ssl-1}
