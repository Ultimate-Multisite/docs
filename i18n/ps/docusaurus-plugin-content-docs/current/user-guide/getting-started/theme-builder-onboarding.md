...
## Theme Builder Onboarding Flow څه دی؟
...
## Theme Builder Onboarding پیل کول

### د پیل کولو لپاره пърو ځلې تنظیم (First-Run Setup)
...
## Onboarding Steps (Onboarding ګامونه)

### Step 1: Mode Selection (د ډول انتخاب)
...
### Step 2: Site Specification (د سایت مشخصات)
...
### مرحله ۳: Design System Decisions (تصميم سیستمको निर्णयहरू)
...
### مرحله ۴: Theme Generation (Theme جوړول)
...
### مرحله ۵: Activation and Verification (فعالیت او تایید)
...
## Site Specification او site_brief Memory (مقرصه مشخصات او memory)
...
### site_brief مهم زه کوه؟ (چې site_brief مهم دی)
...
## د تنظیم کولو وروسته (After Onboarding)

د Theme Builder onboarding پوره کیدو وروسته، تاسو کولی شئ:

### Design System Aesthetics Skill کارول
...
### Custom Block Templates جوړ کړئ
