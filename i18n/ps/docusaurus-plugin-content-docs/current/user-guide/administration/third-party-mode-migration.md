...
### 7.0 څخه مخکې WordPress Version
...
## د اوسني حالت پر چکین

### له ადمن پینل (Admin Panel)
...
### ته به Auto Mode کېږی (Switch to Auto Mode)
...
### ته به Manual Mode کېږی (Switch to Manual Mode)
...
### ته به Legacy Mode کېږی (Switch to Legacy Mode)
...
## Auto Mode (حالت خودکار) ګټې

### اتوماتیک پيدا کول (Automatic Discovery)
...
### ساده مدیریت (Simplified Management)
...
### که تاسو په WordPress 7.0+ کې یاست
...
### Abilities په auto mode کې نه کیږي
...
### زه "unclassified ability" (غیر تصنیف شوی ځانګړتیا) پیغامونه ترلاسه کوم
...
## پخوانی سازگاری (Backward Compatibility)

### پرانە تنظیمات (Existing Configurations)
