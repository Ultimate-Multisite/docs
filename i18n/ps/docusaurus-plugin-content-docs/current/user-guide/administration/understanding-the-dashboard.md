...
یہ ویجٹ Ultimate Multisite میں ہونے والے واقعات کی رپورٹ کرتا ہے۔ واقعات میں سائن اپ، منسوخی، سائٹ بنانا، ڈیلیٹ کرنا اور دیگر سرگرمیاں شامل ہیں۔
...
محدوده تاریخ، دوره‌ای را که ویجت‌های زیر آن اطلاعات نمایش داده می‌شوند، شامل درآمد، عضویت‌های جدید، ثبت‌نام بر اساس کشور، ثبت‌نام بر اساس فرم و پربازدیدترین سایت‌ها را کنترل می‌کند.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
برای اینکه ویجت **محبوب‌ترین سایت‌ها** کار کند، قابلیت شمارش بازدید در **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting** را فعال کنید.
:::
