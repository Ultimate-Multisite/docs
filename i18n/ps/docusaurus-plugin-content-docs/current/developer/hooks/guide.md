...
### د پېرېدونکي ژوندلړۍ {#customer-lifecycle}

#### د پېرېدونکي له جوړېدو وروسته {#after-customer-creation}
...
#### د پېرېدونکي د حالت بدلون {#customer-status-change}
...
### د سایټ Hooks {#site-hooks}

#### د سایټ له خپرېدو وروسته {#after-site-published}
...
#### د کينډۍ له پلي کولو مخکې {#before-template-application}
...
### د غړیتوب Hooks {#membership-hooks}

#### د حالت بدلونونه {#status-transitions}
...
### د تادیې Hooks {#payment-hooks}

#### تادیه بشپړه شوه / ناکامه شوه {#payment-completed--failed}
...
### د Checkout Hooks {#checkout-hooks}

#### له پروسس کولو مخکې / له بشپړېدو وروسته {#before-processing--after-completion}
...
### د بیې Filters {#pricing-filters}

#### د کارټ ټولټال {#cart-total}
...
### د کينډۍ Filters {#template-filters}
...
### د محدودیت Filters {#limitation-filters}
...
### د Gateway Filters {#gateway-filters}
...
### د Checkout فورمې برخې {#checkout-form-fields}
...
### د برېښنالیک منځپانګه {#email-content}
