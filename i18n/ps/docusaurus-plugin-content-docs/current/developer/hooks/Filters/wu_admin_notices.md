...
| نوم | ډول | تشریح |
|------|------|-------------|
| $notices | `array` | د هغه ځانګړي پینل لپاره د خبرتیاوو لېست. |
| $all_notices | `array` | د زیات شوو خبرتیاوو لېست، د پینل له مخې جلا شوی. |
| $panel | `string` | هغه پینل چې خبرتیاوې ترې ترلاسه کېږي. |
