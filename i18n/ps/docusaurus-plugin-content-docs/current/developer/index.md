...
## Composer / Bedrock نصب {#composer--bedrock-installation}
...
### REST API وکاروئ {#use-the-rest-api}

```bash
curl -u "api_key:api_secret" https://yoursite.com/wp-json/wu/v2/customers
```

### له پېښو سره Hook کړئ {#hook-into-events}
...
### یوه اضافه جوړه کړئ {#build-an-addon}
