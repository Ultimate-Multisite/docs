...
## Azure OpenAI: د پرومپټ زېرمه کول
...
### د Azure OpenAI لپاره غوره کړنلارې
...
### د OpenRouter لپاره غوره کړنلارې
...
### د Vertex Anthropic Caching کارول
...
### د Vertex Anthropic لپاره غوره کړنې
...
## د برابرونکو ترمنځ Caching تګلاره

### یوځای شوی Configuration
