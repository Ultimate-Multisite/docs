...
## د فایل نومولو دود {#file-naming-convention}
...
## فایل چیرته کېږدئ {#where-to-place-the-file}
...
## موجود hooks او filters {#hooks-and-filters-available}
...
## لږ تر لږه بېلګه {#minimal-example}
