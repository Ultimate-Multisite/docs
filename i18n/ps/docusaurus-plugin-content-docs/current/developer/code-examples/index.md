...
دوه هممهالې غوښتنې کولای شي هماغه ارزښت ولولي او دواړه هماغه زیات شوی پایله بېرته ولیکي، چې یو شمېر له منځه وړي. `increment_item()` حساب کتاب د ډیټابېس انجن ته د یوې واحدې `UPDATE ... SET column = column + ?` وینا سره سپاري، چې عملیات په ذاتي ډول اټومي کوي.
