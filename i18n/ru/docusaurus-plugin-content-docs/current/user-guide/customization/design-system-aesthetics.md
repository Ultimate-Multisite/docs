...
---
# Эстетика дизайн-системы {#design-system-aesthetics-skill}
...
## Что такое эстетика дизайн-системы? {#what-is-design-system-aesthetics}
...
## Зачем использовать эстетику дизайн-системы? {#why-use-design-system-aesthetics}
...
## Активация навыка «Эстетика дизайн-системы» {#triggering-the-design-system-aesthetics-skill}
...
### Шаг 4: Границы и тени {#step-4-borders-and-shadows}
...
### Шаг 5: Анимация и движение {#step-5-motion-and-animation}
...
## Применение эстетики дизайн-системы {#applying-design-system-aesthetics}
...
### Ручное применение {#manual-application}
...
## Просмотр дизайн-системы {#viewing-your-design-system}
...
## Обновление дизайн-системы {#updating-your-design-system}
...
### Последовательность {#consistency-1}
...
## Общие паттерны дизайн-систем {#common-design-system-patterns}

### Современный минимализм {#modern-minimalist}
...
### Теплый и дружелюбный {#warm-and-friendly}
...
### Профессиональный корпоративный {#professional-corporate}
...
### Креативный и смелый {#creative-and-bold}
