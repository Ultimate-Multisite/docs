---
title: Известные несовместимости
sidebar_position: 15
...
**Note** : All other WPMU Dev plugins can be used normally alongside Ultimate Multisite. Examples include _Smush_, _Forminator_, _Defender_, etc.
