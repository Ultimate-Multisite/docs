...
## Шаг 1: Добро пожаловать {#step-1-welcome}
...
## Шаг 2: Конфигурация сети {#step-2-network-configuration}

На этом шаге вам предлагается настроить параметры сети.

### Структура сайтов {#site-structure}
...
### Электронная почта администратора сети {#network-admin-email}
...
## Шаг 3: Установка {#step-3-installation}
...
## Шаг 4: Завершено {#step-4-complete}
...
## Резервный ручной набор {#manual-setup-fallback}
...
### Мастер сообщает, что wp-config.php недоступен для записи {#the-wizard-says-wp-configphp-is-not-writable}
...
### Сайты недоступны после установки (поддомены) {#sites-are-not-accessible-after-setup-subdomains}
...
### Проблемы с аутентификацией после установки {#authentication-issues-after-setup}
...
### Шаг не выполнен во время установки {#a-step-failed-during-installation}
