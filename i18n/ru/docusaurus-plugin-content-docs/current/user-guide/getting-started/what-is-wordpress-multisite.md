...
---
# Что такое WordPress Мультисайт? {#what-is-wordpress-multisite}
...
## Что именно такое WordPress Мультисайт? {#what-exactly-is-wordpress-multisite}
...
## Поддомен или Подкаталог? {#subdomain-or-subdirectory}
...
## Что совместно используется между подсайтами, а что нет {#what-is-shared-among-subsites-and-what-is-not}
...
## Управление пользователями в WordPress мультисайте {#user-management-on-wordpress-multisite}
