...
_Multisite (subdomain or subdirectory) also needs to be activated._ [Как установить WordPress Multisite](/docs/user-guide/getting-started/how-to-install-wordpress-multisite).
