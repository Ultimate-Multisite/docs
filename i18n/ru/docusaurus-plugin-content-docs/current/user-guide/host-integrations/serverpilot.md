...
### 1. Получите свои учетные данные API ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Получите ваш App ID {#2-get-your-app-id}
...
## Проверка SSL‑сертификата {#ssl-certificate-verification}
