...
---
# Интеграция с панелью управления Enhance {#enhance-control-panel-integration}
...
## Получение ваших учетных данных API {#getting-your-api-credentials}
...
### 2. Получение вашего Organization ID {#2-get-your-organization-id}
...
### 3. Получение вашего Server ID {#3-get-your-server-id}
...
### 4. Получение вашего API URL {#4-get-your-api-url}
...
### Необходимые константы {#required-constants}
...
### Настройка через мастер интеграции {#setup-via-integration-wizard}
...
## Дополнительная конфигурация WordPress {#additional-wordpress-configuration}
...
### Конфигурация .htaccess {#htaccess-configuration}
...
### Константы cookie {#cookie-constants}
...
### Когда домен привязан {#when-a-domain-is-mapped}
...
### Тестирование соединения {#test-the-connection}
...
### Интервал проверки DNS {#dns-check-interval}
...
### Часто используемые конечные точки {#common-endpoints-used}
...
### Полная документация API {#full-api-documentation}
