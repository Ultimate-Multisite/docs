...
---
# Направление дизайна {#design-direction}
...
## Компоненты направления дизайна {#design-direction-components}

### 1. Цветовая палитра {#1-color-palette}
...
### 3. Макет и отступы {#3-layout-and-spacing}
...
### 4. Визуальные элементы {#4-visual-elements}
...
## Предварительный просмотр {#preview-rendering}

### Предпросмотр для десктопа {#desktop-preview}
...
### Предпросмотр для мобильных устройств {#mobile-preview}
...
### Точки останова адаптивности {#responsive-breakpoints}
...
## Доработка дизайна {#refining-your-design}

### Внесение изменений {#making-adjustments}
...
### Обновление предварительного просмотра {#preview-updates}
...
### Сравнительный просмотр {#comparison-view}
...
## Утверждение направления дизайна {#design-direction-approval}
...
### Предпросмотр не обновляется {#preview-not-updating}
...
### Цвета выглядят по-разному {#colors-look-different}
...
### Проблемы с типографикой {#typography-issues}
