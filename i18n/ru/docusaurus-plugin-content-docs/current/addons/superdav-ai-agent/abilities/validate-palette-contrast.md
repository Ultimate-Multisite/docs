...
---
# Проверка контрастности палитры {#validate-palette-contrast}
...
## Проверяемые уровни WCAG {#wcag-levels-checked}
...
## Интеграция с конструктором тем {#integration-with-theme-builder}
...
## Неудачные пары и рекомендации {#failing-pairs-and-recommendations}
