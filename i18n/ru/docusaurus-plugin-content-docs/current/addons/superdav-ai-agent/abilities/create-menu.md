...
## Навигационная метка vs Заголовок страницы {#navigation-label-vs-page-title}
...
### Пример 1: Простое меню с навигационной меткой {#example-1-simple-menu-with-navigation-label}
...
### Пример 2: Меню для конкретного местоположения темы {#example-2-menu-for-specific-theme-location}
...
## Связанные возможности {#related-abilities-1}
