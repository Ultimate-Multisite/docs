...
## Интеграция страницы администрирования
...
### SSO и URL управления основным сайтом
...
### Базовые домены формы оформления заказа
...
### Автоматическое создание записей домена
