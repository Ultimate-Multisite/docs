...
---
# Создание кастомной интеграции регистратора доменов
...
### Конвенция возвращаемого значения
...
## Добавление полей учетных данных в мастер настройки
...
## Хуки для действий после регистрации
