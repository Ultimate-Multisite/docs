---
title: Руководство по использованию хуков
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Руководство по использованию хуков {#hooks-usage-guide}

Ultimate Multisite предоставляет более 200 хуков действий и более 280 хуков фильтров. Эта страница охватывает наиболее часто используемые хуки с практическими примерами. Для полного автоматически сгенерированного справочника просмотрите другие страницы в этом разделе.

## Хуки действий {#action-hooks}

### Жизненный цикл клиента {#customer-lifecycle}

#### После создания клиента {#after-customer-creation}
...
#### Изменение статуса клиента {#customer-status-change}
...
### Хуки сайта {#site-hooks}

#### После публикации сайта {#after-site-published}
...
#### Перед применением шаблона {#before-template-application}
...
#### Переходы статуса {#status-transitions}
...
### Хуки платежей {#payment-hooks}

#### Платеж завершен / не выполнен {#payment-completed--failed}
...
### Хуки оформления заказа {#checkout-hooks}

#### Перед обработкой / после завершения {#before-processing--after-completion}
...
## Фильтры хуков {#filter-hooks}

### Фильтры цен {#pricing-filters}

#### Итого корзины {#cart-total}
...
### Фильтры шаблонов {#template-filters}
...
### Фильтры ограничений {#limitation-filters}
...
### Фильтры шлюзов {#gateway-filters}
...
### Поля формы оформления {#checkout-form-fields}
...
### Содержимое письма {#email-content}
