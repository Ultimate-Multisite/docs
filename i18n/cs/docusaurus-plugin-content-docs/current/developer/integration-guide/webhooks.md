...
*   Vždy ověřte a vyčistěte (sanitize) všechna přijímaná data v payloadu, než na nich podniknete jakýkoli krok.
*   Vracívejte vhodné HTTP status kódy (200 pro úspěch, 400 pro špatné požadavky).
