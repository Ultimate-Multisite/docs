...
### 1. Získejte své přihlašovací údaje Cloudways API
...
### 2. Získejte ID svého serveru a aplikace
...
### Doporučené nastavení Cloudways SSL pro síť Ultimate Multisite
