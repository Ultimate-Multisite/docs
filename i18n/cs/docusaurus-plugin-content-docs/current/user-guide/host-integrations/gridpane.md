...
---
# Integrace GridPane {#gridpane-integration}
...
### 1. Získání API přístupových údajů pro GridPane {#1-get-your-gridpane-api-credentials}
...
### 2. Získání ID serveru a webu {#2-get-your-server-and-site-ids}
...
### 3. Přidání konstant do wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Aktivace integrace {#4-enable-the-integration}
...
## Správa konstanty SUNRISE {#sunrise-constant-management}
