...
---
# Formuláře pokladny {#checkout-forms}
...
#### Přehled editoru formuláře pokladny {#checkout-form-editor-overview}
...
### Úprava formuláře pokladny {#editing-a-checkout-form}
...
### Pole Cenová tabulka {#the-pricing-table-field}
...
#### Krok 1: Nastavte cenové varianty u svých produktů {#step-1-set-up-price-variations-on-your-products}
...
#### Krok 2: Přidejte pole Výběr období do svého checkout formuláře {#step-2-add-the-period-selection-field-to-your-checkout-form}
...
#### Krok 3: Umístěte pole nad cenovou tabulku {#step-3-position-the-field-above-the-pricing-table}
...
#### Jak to funguje na frontendu {#how-it-works-on-the-frontend}
...
#### Předvýběr fakturačního období přes URL {#pre-selecting-a-billing-period-via-url}
...
### Pole Výběr šablony {#the-template-selection-field}
...
#### Ruční přidání pole {#adding-the-field-manually}
...
### Základní domény checkout formulářů {#checkout-form-base-domains}
...
#### Odebrání pole {#removing-the-field}
