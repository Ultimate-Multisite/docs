...
## Připojení k databázové hostitelské straně (Database host binding)
...
## Kořen souborového systému (Filesystem root)
...
## Pořadí nasazení (Provisioning order)
...
## Točivé procesy pro správu suverénních zákazníků
