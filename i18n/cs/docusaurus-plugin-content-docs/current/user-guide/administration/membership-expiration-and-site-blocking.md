...
### Jak členství přechází do stavu Expired
...
#### Členství s automatickou vs. bezautomatickou obnovou
...
### Co návštěvníci uvidí, když je web zablokován
...
## Řešení problémů: Weby zůstávají dostupné po expiraci

Pokud zůstávají weby veřejně dostupné po expiraci členství, postupujte podle těchto kontrol v pořadí:

### 1. Ověřte, že je nastavení Block Frontend Access aktivní
...
### 2. Zkontrolujte Frontend Block Grace Period
...
### 3. Potvrďte, že se stav členství skutečně změnil
...
### 4. Ověřte, že Action Scheduler běží
...
### 5. Zkontrolujte problémy s webhooky brány (Členství s automatickou obnovou)
...
### 6. Zkontrolujte období milosti expirace (Na úrovni cron)
