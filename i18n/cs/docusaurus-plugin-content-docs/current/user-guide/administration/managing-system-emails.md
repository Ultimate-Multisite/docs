...
## Zobrazení systémových e-mailů {#viewing-system-emails}
...
## Import nových e-mailových šablon {#importing-new-email-templates}
...
## Resetování e-mailových šablon {#resetting-email-templates}
