...
## Co je onboardingový proces Theme Builderu?
...
## Spuštění onboardingového procesu Theme Builderu
...
### Krok 3: Rozhodování o designovém systému
...
## Specifikace webu a paměť site_brief
...
## Vylepšení po onboardingu

Po dokončení onboardingového procesu Theme Builderu můžete:

### Použít dovednost Design System Aesthetics
...
### Vytvořit vlastní blokové šablony
...
## Porovnání: Starý vs. Nový onboarding
