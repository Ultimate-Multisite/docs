...
---
# Co je WordPress Multisite? {#what-is-wordpress-multisite}
...
## Co přesně je WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## Subdoména nebo podadresář? {#subdomain-or-subdirectory}
...
## Co je mezi podweby sdílené a co ne {#what-is-shared-among-subsites-and-what-is-not}
...
## Správa uživatelů v WordPress Multisite {#user-management-on-wordpress-multisite}
