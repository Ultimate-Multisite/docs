...
#### Subdoména vs. podadresář {#subdomain-vs-subdirectory}
...
#### Pluginy a šablony {#plugins-and-themes}
...
#### Uživatelé a administrátoři {#users-and-administrators}
...
### Architektonické úvahy {#architecture-considerations}
...
#### Sdílený vs. dedikovaný hosting {#shared-vs-dedicated-hosting}
...
#### Úvahy o výkonu {#performance-considerations}
...
#### Externí skripty {#external-scripts}
