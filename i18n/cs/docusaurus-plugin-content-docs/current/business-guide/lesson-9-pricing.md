...
## Principy cenotvorby pro nišní platformy {#pricing-principles-for-niche-platforms}

### Cena podle hodnoty, ne podle nákladů {#price-on-value-not-cost}
...
### Kotvování k alternativám {#anchor-to-alternatives}
...
## Implementace variací cen {#implementing-price-variations}
...
### Proč funguje roční cenotvorba {#why-annual-pricing-works}
...
## Poplatky za nastavení {#setup-fees}
...
### Jak zajistit konverzi ze zkušebního období {#making-trials-convert}
...
## Skupinové kódy (Discount Codes) {#discount-codes}
...
## Revize cenotvorby {#reviewing-your-pricing}
