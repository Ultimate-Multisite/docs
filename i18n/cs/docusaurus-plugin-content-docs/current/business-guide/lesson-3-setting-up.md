...
---
# Lekce 3: Nastavení vaší sítě {#lesson-3-setting-up-your-network}
...
## Výběr hostingu {#choosing-your-hosting}
...
### Na co si dát pozor {#what-to-look-for}
...
### Doporučený přístup {#recommended-approach}
...
## Instalace WordPress Multisite {#installing-wordpress-multisite}
...
## Konfigurace pro fitness niši {#configuring-for-the-fitness-niche}
...
### Konfigurace e-mailů {#email-configuration}
...
### Konfigurace domény {#domain-configuration}
...
## FitSite síť na tuto chvíli {#the-fitsite-network-so-far}
