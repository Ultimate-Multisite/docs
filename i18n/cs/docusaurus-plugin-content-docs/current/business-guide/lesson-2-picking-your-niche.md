...
- Většina aktuálních webových stránek v daném průmyslu je špatné
- Obecné nástroje (generické budovače) jejich specifické potřeby neřeší
- Vlastní vývoj je pro typickou velikost podnikání příliš drahý
...
- Zvyklí platit za softwarové předplatné (systémy pro rezervace, zpracování plateb atd.)
- Fungovat na úrovni, kde je $49–$199/měsíc rozumné podnikatelské výdaje
...
- Aktivní online komunity (skupiny na Facebooku, fóra, subreddity)
- Lokální networking, kde se majitelé podniků vyměňují doporučení
...
- Projděte průmyslovými fóri a hledejte stížnosti na webovou přítomnost
...
- Co by mohly dělat, ale nedělají?
- Na co to momentálně platíte?
- Pokud by existovala platforma postavena specificky pro [vaši niche], zajímalo by vás?
...
| Kritérium | Hodnocení |
| :--- | :--- |
| Potřebují webové stránky, ale mají potíže | Ano – většina webů studií je obecná nebo zastaralá |
| Mohou si stařit předplatné | Ano – již platí $50–$200/měsíc za software pro rezervace |
| Komunikují mezi sebou | Ano – aktivní komunity, průmyslové události, lokální sítě |
| Velikost trhu | 100 000+ zařízení jen v USA |
| Konkurenční prostředí | Existuje málo platform webů specifických pro niche |
...
- **Restaurace a kavárny** – menu, rezervace, hodiny, integrace dopravy
- **Realitní makléři** – inzeráty, profily makléřů, průvodce čtvrtěmi
- **Advokátní kanceláře** – obory práva, biografie právníků, rezervace konzultací
- **Kostely a neziskové organizace** – události, kazatelství, darování, komunita
- **Obchodní zhotovitelé** (zařízení potrubí, elektrikáři, HVAC) – oblasti služeb, rezervace, recenze
- **Salóny a spa** – služby, rezervace, profily stylistů, galerie
- **Veterinární kliniky** – služby, portály pro zvířata, rezervace termínů
- **Hudební školy** – profily učitelů, plánování lekcí, informace o recitálech
...
- **Ověření FitSite**: potvrdilo, že fitness studia splňují všechna kritéria
- **Alternativní niche**: seznam dalších vertikál, na které můžete tento rámec aplikovat

---

**Další:** [Lekce 3: Nastavení vaší sítě](lesson-3-setting-up) — nainstalujeme Ultimate Multisite a nakonfigurujeme základ pro FitSite.
