...
Spustí se před vykreslením konkrétní stránky.

Usage: Dynamickou část je třeba nahradit platným ID stránky, např. `add_action('wu_page_events_before_render', 'do_something_callback', 10, 2);`
