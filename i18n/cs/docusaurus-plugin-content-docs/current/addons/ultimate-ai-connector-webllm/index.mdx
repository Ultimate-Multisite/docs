...
## Plující chatovací widget {#floating-chat-widget}
...
### Indikátor stavu v admin panelu {#admin-bar-status-indicator}
...
### Jak widget povolit nebo deaktivovat {#how-to-enable-or-disable-the-widget}
...
### Chování automatického dotazu {#auto-prompt-behaviour}
...
### Widget se neobjevuje {#the-chat-widget-does-not-appear}
...
### Indikátor v admin panelu zobrazuje „Error“ {#the-admin-bar-indicator-shows-error}
...
### Váhy modelu se stahují při každé návštěvě {#model-weights-download-every-time}
