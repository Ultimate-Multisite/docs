...
| Zařízení | Šířka | Náhled |
|--------|-------|---------|
| **Mobilní** | 375px | Portrétní telefon |
| **Tablet** | 768px | Pozorovací tablet |
...
- **Ověřte kontrast** — pro přístupnost použijte [Validate Palette Contrast](../abilities/validate-palette-contrast.md)
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — kontrola přístupnosti barev
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — vytváření vlastních log diper SVG
