...
### Añadir o campo a un formulario de checkout
...
### Campos de contacto do registrador
...
### Quais os provedores que suportam a gestão de DNS?
...
### Registros de DNS predeterminados
...
### Admin: visualización e edición de DNS
