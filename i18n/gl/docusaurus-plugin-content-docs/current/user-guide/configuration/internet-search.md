...
## Ativar a Busca na Internet {#enabling-internet-search}
...
### Obter uma Chave de API do Brave Search {#obtaining-a-brave-search-api-key}
...
### Limites de Utilização {#usage-limits}
...
### Obter uma Chave API do Tavily {#obtaining-a-tavily-api-key}
...
## Desativar a Pesquisa na Internet {#disabling-internet-search}
