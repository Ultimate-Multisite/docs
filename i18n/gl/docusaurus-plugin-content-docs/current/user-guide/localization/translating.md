---
title: Traducindo Ultimate Multisite
sidebar_position: 19
...
Este é o sistema de tradución estándar da comunidade WordPress. Cando as tradución chegan a un limiar suficiente de aprobación, son distribuídas automáticamente a todos os usuarios de Ultimate Multisite mediante as actualizacións do plugin WordPress.

**Precisamos da súa axuda!** Se fala unha lingua que non sexa o inglés, por favor, considera colaborar coas traducións. Até traduciar algunhas frases axuda. Para empezar:

1. Visita [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Seleita a pulo que queres
3. Clica en "Contribute Translation" (Colabore coa tradución)
4. Terás de ter unha conta gratuita de WordPress.org
...
1. Baixa o Poedit de [poedit.net](https://poedit.net)
2. Abre o ficheiro `.pot` de `wp-content/plugins/ultimate-multisite/lang/`
3. Tradúce as *strings* na interfaz do Poedit
