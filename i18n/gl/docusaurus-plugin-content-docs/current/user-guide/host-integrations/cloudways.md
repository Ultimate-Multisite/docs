...
### 1. Obtén as tus Credenciais API de Cloudways
...
### 2. Obtén os teus IDs de Servidor e Aplicación
...
## Importante — Problema com Wildcard SSL
...
### Configuración Recomendada de SSL de Cloudways para una red Ultimate Multisite
...
### Problemas con o Certificado SSL
