...
---
# Como usar os snippets Ultimate Multisite no noso repositório do GitHub
...
# Como añadir o snippet no ficheiro functions.php do teu tema.
...
# Como crear Plugins Must-Use (mu-plugins)
