...
## Se Estavas a Usar o Modo Construtor de Sites

### Os Teus Sites Estão Seguros
...
### Migrar para o Setup Assistant Agent
...
### Agente Assistente de Configuração
...
### O meu site existente no Site Builder não está a funcionar
...
### Ainda posso usar os meus antigos templates do Site Builder?
