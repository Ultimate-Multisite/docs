...
## Cap Captcha: protección autoaloxada que simplemente funciona {#cap-captcha-self-hosted-protection-that-just-works}
...
## Protección contra probas de tarxetas en WooCommerce {#woocommerce-card-testing-protection}
...
## Aínda precisas Google reCAPTCHA ou hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Deseñado para escalar {#built-for-scale}
...
## Teño que configurar algo? {#do-i-need-to-configure-anything}
...
## Preciso claves de API para Cap Captcha? {#do-i-need-api-keys-for-cap-captcha}
...
## Isto ralentizará o meu checkout? {#will-this-slow-down-my-checkout}
...
## Protexe isto contra ataques de probas de tarxetas? {#does-this-protect-against-card-testing-attacks}
...
## Podo usar distintos provedores de captcha en sitios diferentes? {#can-i-use-different-captcha-providers-on-different-sites}

O provedor de captcha establécese para toda a rede, pero podes axustar a dificultade segundo as túas necesidades.

## Isto é conforme co GDPR? {#is-this-gdpr-compliant}
...
#### Temporización do tarpit {#tarpit-timing}
...
#### Filtro de lista branca de IP {#ip-whitelist-filter}
...
#### Acción previa ao bloqueo {#pre-block-action}
...
## Detección de IP do cliente e proxies de confianza {#client-ip-detection--trusted-proxies}
...
#### Confianza no header de Cloudflare {#cloudflare-header-trust}
...
#### Configuración de proxy de confianza {#trusted-proxy-configuration}
...
#### Detección automática na primeira activación {#first-enable-auto-detection}
...
### Por que isto importa {#why-this-matters}
