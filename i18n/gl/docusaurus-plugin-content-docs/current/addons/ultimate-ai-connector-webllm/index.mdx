...
### Indicador de estado na barra de administración {#admin-bar-status-indicator}
...
### Como activar ou desactivar o widget {#how-to-enable-or-disable-the-widget}
...
### Comportamento de auto-prompt {#auto-prompt-behaviour}
...
## Execución con SharedWorker {#sharedworker-runtime}
...
### O widget de chat non aparece {#the-chat-widget-does-not-appear}
...
### O indicador da barra de administración mostra "Erro" {#the-admin-bar-indicator-shows-error}
...
### Os pesos do modelo descárganse cada vez {#model-weights-download-every-time}
