...
- **Cor primaria** — cor principal da marca usada para botóns, ligazóns e acentos
- **Cor secundaria** — cor complementaria para variedade
- **Cor de acento** — cor de destaque para elementos importantes
...
- **Fonte dos encabezados** — usada para títulos de páxina e cabeceiras de sección
- **Fonte do corpo** — usada para texto de parágrafo e contido
- **Tamaños de fonte** — dimensionamento adaptable para diferentes tamaños de pantalla
...
- **Iconas** — estilo e tamaño das iconas
...
- Disposición completa con todas as columnas
...
| Dispositivo | Largura | Vista previa |
|--------|-------|---------|
| **Móbil** | 375px | Teléfono en vertical |
| **Tableta** | 768px | Tableta en horizontal |
...
1. **Axustar cores** — cambiar calquera cor da paleta
2. **Cambiar fontes** — seleccionar tipos de letra diferentes
3. **Modificar o espazamento** — axustar recheo e marxes
...
- A vista previa de escritorio actualízase inmediatamente
- A vista previa móbil actualízase inmediatamente
...
- **Deseño orixinal** — ver o que cambiou
...
1. **Revisa ambas as vistas previas** — verifica que escritorio e móbil se vexan ben
2. **Comproba todas as cores** — garante contraste e accesibilidade
3. **Proba a tipografía** — verifica a lexibilidade en todos os tamaños
...
1. Theme Builder xera o teu tema completo
2. O tema instálase no teu sitio WordPress
...
- **Verifica o contraste** — usa [Validar contraste da paleta](../abilities/validate-palette-contrast.md) para accesibilidade
...
- [Validar contraste da paleta](../abilities/validate-palette-contrast.md) — comprobar a accesibilidade da cor
- [Xerar Logo SVG](../abilities/generate-logo-svg.md) — crear logotipos personalizados
