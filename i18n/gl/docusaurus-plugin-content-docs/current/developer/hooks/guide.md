...
#### Despois da creación do cliente {#after-customer-creation}
...
#### Cambio de estado do cliente {#customer-status-change}
...
### Hooks de sitio {#site-hooks}

#### Despois de publicar o sitio {#after-site-published}
...
#### Antes da aplicación do modelo {#before-template-application}
...
### Hooks de subscrición {#membership-hooks}

#### Transicións de estado {#status-transitions}
...
#### Pagamento completado / fallido {#payment-completed--failed}
...
#### Antes do procesamento / despois da finalización {#before-processing--after-completion}
...
### Filtros de prezos {#pricing-filters}

#### Total do carriño {#cart-total}
...
### Filtros de modelos {#template-filters}
...
### Filtros de limitacións {#limitation-filters}
...
### Filtros de pasarelas {#gateway-filters}
...
### Campos do formulario de checkout {#checkout-form-fields}
...
### Contido do correo electrónico {#email-content}
