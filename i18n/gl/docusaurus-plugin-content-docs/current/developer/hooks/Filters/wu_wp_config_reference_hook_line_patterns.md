...
---
# Filtro: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

Comprobamos tres patróns ao tentar descubrir onde podemos inxectar as nosas constantes:
...
Definido en [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) na liña 143
