...
## Njira yoyambitsa tenant {#tenant-bootstrap-flow}
...
## SSO ndi REST hooks {#sso-and-rest-hooks}
...
## Ma URL a zochita za kasitomala wodziyimira pawokha {#sovereign-customer-action-urls}
...
## Kutsimikizira kusamuka {#migration-verification}
...
## Kuchotsa tenant {#tenant-deletion}
...
## Database router yakale {#deprecated-database-router}
