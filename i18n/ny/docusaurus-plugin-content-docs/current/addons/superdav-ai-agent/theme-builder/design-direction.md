...
- **Mtundu woyambirira** — mtundu waukulu wa brand womwe umagwiritsidwa ntchito pa mabatani, ma link, ndi zokometsera
- **Mtundu wachiwiri** — mtundu wogwirizana kuti pakhale kusiyanasiyana
- **Mtundu wotsindika** — mtundu wowonetsa zinthu zofunika
...
- **Font ya mutu** — imagwiritsidwa ntchito pa mitu ya masamba ndi mitu ya magawo
- **Font ya thupi** — imagwiritsidwa ntchito pa mawu a ndime ndi zomwe zili
- **Makulidwe a font** — kukula komwe kumasinthika molingana ndi makulidwe osiyanasiyana a screen
...
- **Icons** — sitayilo ndi kukula kwa icon
...
- Menyu yonse ya navigation
- Layout yonse yokhala ndi mizati yonse
...
- Navigation yosinthika (hamburger menu)
- Layout ya mzati umodzi
...
| Chipangizo | M'lifupi | Kuwonetseratu |
|--------|-------|---------|
| **Mobile** | 375px | Foni ya portrait |
| **Tablet** | 768px | Tablet ya landscape |
...
1. **Kusintha mitundu** — sinthani mtundu uliwonse mu phale
2. **Kusintha ma font** — sankhani ma typeface osiyanasiyana
3. **Kusintha mipata** — sinthani padding ndi margins
...
- Kuwonetseratu kwa desktop kumasinthidwa nthawi yomweyo
- Kuwonetseratu kwa mobile kumasinthidwa nthawi yomweyo
...
- **Kapangidwe koyambirira** — onani zomwe zasinthidwa
...
1. **Unikani ma preview onse awiri** — tsimikizirani kuti desktop ndi mobile zikuwoneka bwino
2. **Fufuzani mitundu yonse** — onetsetsani kusiyana ndi accessibility
3. **Yesani typography** — tsimikizirani kuwerengeka pa makulidwe onse
...
1. Theme Builder imapanga theme yanu yonse
2. Theme imayikidwa pa site yanu ya WordPress
...
- **Tsimikizirani kusiyana** — gwiritsani ntchito [Validate Palette Contrast](../abilities/validate-palette-contrast.md) kuti pakhale accessibility
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — fufuzani accessibility ya mitundu
- [Pangani Logo SVG](../abilities/generate-logo-svg.md) — pangani ma logo apadera
