---
title: Kuyika Ultimate Multisite
sidebar_position: 12
...
Kuchokera ku **Network Admin Dashboard** yanu, pitani ku **Plugins → Add New Plugin**.

![Tsamba la Network Admin Add New Plugin](/img/installation/add-new-plugin.png)

Sakani "Ultimate Multisite" (ndi zolembedwa kuti muzipeza molondola) ndipo idzawonekera ngati chotsatira choyamba. Dinani **Install Now**.

![Zotsatira za kusaka zikuwonetsa Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Mukayika, dinani **Network Activate** kuti muyike pulogalamu yothandizira (plugin) pa netiweki yonse.

![Pulogalamu yothandizira yayikidwa ndi batani la Network Activate](/img/installation/plugin-installed.png)

Pambuyo poyika, mudzatsamwitsidwa ku Setup Wizard.
...
![Zoyenera kuyika kale zikuwonetsa zofunikira](/img/installation/wizard-pre-install-checks.png)

:::note Batani la Network Activate (v2.6.1+)
Ngati Ultimate Multisite idayikidwa koma **sidayikidwe pa netiweki yonse** — mwachitsanzo, ngati dinani **Activate** (pa webusayiti imodzi) m'malo a **Network Activate** kuchokera ku tsamba la mapulogalamu othandizira a netiweki — gawo la Zoyenera Kuyika Kale lidzazindikira izi ndipo lidzawonetsa batani la **Network Activate**.
...
![Kuyika kwamalizidwa - Tsamba la Takonzeka](/img/installation/wizard-ready.png)

![Network Admin Dashboard ndi Ultimate Multisite ikugwira ntchito](/img/installation/network-dashboard.png)

Pitirirani ndipo muzisangalale!
