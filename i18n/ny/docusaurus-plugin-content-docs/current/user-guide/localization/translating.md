---
title: Kuthandiza Ultimate Multisite
sidebar_position: 19
...
Iyi ndiyo mfumo ya kutranslate ya WordPress community. Pamene uthandizo lwa kutranslate lliwe na idhlo yomwamba, linatranslate kwa mtendeka wosangalatsa wose wa Ultimate Multisite mwachidzi wa updates za plugin za WordPress.

**Tili tikufuna ntchito yanu!** Ngati muli ndi chiwerengero chosiyanasiye ndi English, muli ndi chonde kuti muthandize kuweka uthandizo lwa kutranslate. Kuti mutangane:

1. Tsimani pa [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Chonje yanu ya chiwerengero (language)
3. Onje "Contribute Translation"
4. Muli ndi account yosangalatsa wosangalatsa wa WordPress.org
...
1. Ndikumbukira Poedit ku [poedit.net](https://poedit.net)
2. Mulani `.pot` file yomweyi m'moyo wanu `wp-content/plugins/ultimate-multisite/lang/`
3. Tereke mawulu (strings) mu interface ya Poedit
