...
- **Customer-owned** — Sites zomwe zikuyenera kwa makatundu oyenera
...
- **Site Title** — M'malo wina wa site yatsopano
- **Site URL** — Domain/path yomwe siti lili
- **Site Type** — Kuti ndi site ya makatundu oyenera, template, kapena site yosonyeza
...
- **Visit limits** — Izi zikuyenera kukhala nthawi yomwe siti likugwirira ntchito
- **User account limits** — Maluso awo kwa role ya user imodzi
- **Disk space** — M'malo wopereka kwa storage wa site
- **Custom domain** — Kuti mupangidwe mapping ya domain yomwe siti lili
- **Plugin and theme visibility** — Kuti mufunse kuti plugins ndi themes zotani zimene zikuyenera kuoneka, kutayika, kapena kukhala zikuyenera kuyesa
...
- **Mapped domains** zinazohusishwa na site
...
- **Enable/disable the site** kwa kutumia button ya toggle
- **Change the site type** au kuhamisha umiliki (reassign ownership)
- **Set a site image/thumbnail** (inayoonekana kwenye frontend kwa ajili ya site templates)
- **Delete the site** milele

:::warning
Kufuta site si jambo linaloweza kurudishwa. Site na maudhui yote yake yatofutwa milele.
:::
