...
## Zomwe Zilipo M'Mwayi (Prerequisites)
...
## Maonja ya Kufunga (Setup Instructions)

### 1. Kufanya API ya CyberPanel Iwe Yopo
...
### 2. Kuongeza Constants kwenye wp-config.php
...
### 3. Kuwezesha Ujumuishaji (Enable the Integration)
...
### 4. Kuthibitisha Uunganishaji (Verify Connectivity)
...
## Kujitahidi Kutafuta Matatizo (Troubleshooting)

### API Connection Inarejelea
...
### Makosa ya Utambulisho (Authentication Errors)
