...
## Mabadiliko yanayotokea kwa wasimamizi (What changes for administrators)
...
## Kuingia kwenye mteja wa uhuru (Visiting a sovereign tenant)
...
## Orodha ya ukaguzi kwa ajili ya shughuli za eneo la mbali (Remote-site operations checklist)
...
## Kufuta watendaji wa kibaya (Deleting sovereign tenants)
