...
Izi zimeneza kuti mungagwiritse site lomaliza, muliyezi zinthu zina (plugins), muliyezi ya theme yomwe imaperekedwa, ndipo mungayendetsani m'njira yomwe mukuwamba. Pankuti mwana wanu akugwira account yomwe yomwe, m'moyo woyamba ndi WordPress osati ndi zinthu zina zomwe zimeneza, amapereka kopitiliza (copy) ya site lomaliza lanu lomwe limeneza ndi zinthu zonse zomwe zikuyendetsedwa.
...
Izi zimeneza kuti kukhala ndi window lomwe lili ndi chondeledwe cha **Site title, Site Domain/path,** ndipo **Site type**. M'moyo wa drop-down ya **Site Type**, muliyezi kuti mupereke **Site Template** *.

_![Add site template modal with site type dropdown](/img/config/site-templates-list.png)_

Mungagwiritse kuti mungapereke chitsanzo cha kukhala kwa mwana wanu (customer-facing description) kuti muphimbu kuti Site Template imeneza ndi chiyani:

![Site template description field on the site template edit screen](/img/config/site-template-edit-description.png)

M'mulo mu mwambiri wa fomu, utavuta **Copy Site** toggle switch. Iyi zikukwera kukukwera site template yekawo monga mbiri wopereka kuti muperekera nthawi, muli kukhala mukupeza site template monga m'mulo wopereka monga m'mulo wopereka monga m'mulo wopereka.
...
Moyo wotowu, m'moyo wotowu wosamukulu, m'moyo wotowu wosamukulu, m'moyo wotowu wosamukulu.

Moyo wotowu wosamukulu, m'moyo wotowu wosamukulu, m'moyo wotowu wosamukulu.
...
Pa **Edit Product** page. Under the section ya **Product Options**, chulani tab ya **Site template**, ndikupatsa **Choose Available Site Template** ku mpaka wa drop-down field. Izi zikupatsa list ya site templates zoshoza ndipo zikupatsa ku chokera site template yomwe utafuna ikhale yomwe. Muthafuna kuti muli ndi chiyembekezo cha iwo: **Available** (Kukhalitsa) ngati mukufuna site template ikhale m'malo wa list. _**Not Available**_ (Sikukhale) ngati mukufuna site template isikukhale m'malo monga chagera. Ndipo **Pre-selected** (Yomwe yachokera) ngati mukufuna kuti site template imodzi yomwe yali m'malo wa list ikhale yomwe yomwe yosonyeza kwa mpaka.
...
Izi zikupatsa page ya **Edit Checkout Form**. Ndikupatsa field ya **Template Selection** ndipo chokera **Edit** pansi pa iwo.

Modal window imapatsa. Pansi pa field ya **Template Sites** muli ndi ulemu wosonyeza site templates zonse zomwe mukufuna kuti zikukhale m'malo pansi pa registration. Site templates zomwe muliotenga pano zimakhale m'malo mpaka osati muliotenga product yomwe user anachokera.

![Template selection field in the checkout form editor](/img/config/checkout-form-template-step.png)

Pa frontend, makalata akuti customers amakuthandizira template chooser pansi pa checkout ndipo angathe kukhonza design yomwe yosonyeza kwa site yanu yomwe yachokera.
...
Mwachitsanzo, ngati mukufuna kupeza dzina la kampani la woperekera wanu pansi pa registration ndipo kutanthauza dzina la kampani m'malo m'malo ya home page. Pamodzi ndi template yomweyo ya home page yanu, mukucheza malo omwe tikapereka, monga m'njira ya zithunzi zinapereka (placeholders) - monga m'njira ya zithunzi m'malo ({{placeholder_name}}).

![Homepage with placeholder text in curly braces](/img/config/site-templates-list.png)

Kuti nthawi yomwe, mungapeke kukhala ndi field la registration lolimba lilo m'checkout form yanu kuti mucheze data lanse. Editor ya checkout form yomwe yomwe imapereka kwa kuchokera kwa template imapereka malo omwe mungapeke fields zina m'malo m'malo ya template:

![Template selection and registration fields in the checkout form editor](/img/config/checkout-form-template-step.png)

Woperekera wanu mudzakhala ndi ule field lilo pamene mucheze data lanse pamene muliwoneka.

![Frontend checkout form with template chooser](/img/config/frontend-template-chooser.png)

Ultimate Multisite idzakhazikitsa malo omwe tikapereka ndi data yomwe woperekera wanu amapereka m'malo m'malo.
...
Kuti muliwo, tsimikira kuti muwoneza kusonyeza matengo osalira (fake values) kwa mga placeholder, ndipo tikagwiritsa ntchito matengo awa kuti tikutseze ndi kuchinjika ndi kuchotsa malo awo pa sitete zake pamene makatundu wanu akulowa.

Muli ndi ulemu wosankha editor ya template placeholders monga: **Ultimate Multisite > Settings > Sites**, ndipo monga m'moyo wa upatindiri (sidebar), muli ndi link ya **Edit Placeholders**.

![Site template settings under the Sites settings page](/img/config/settings-sites-templates-section.png)

Ili zimene kuti muwoneze editor ya malo awo, pamene mungapeza placeholders ndi malo awo.
