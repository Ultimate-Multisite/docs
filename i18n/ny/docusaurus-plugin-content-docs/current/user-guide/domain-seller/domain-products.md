---
title: >-
  Zomwe Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi
  Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe
  ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi
  Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe
  ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi
  Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe
  ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi Zomwe ndi
...
2. ndiudzi **Add New**
3. rikumbutsa aina ya product kuti ndi **Domain**
4. rikumbutsa tab ya **Domain Settings** (mwina mmodzi)
5. ndikumbutsa
...
Chitha list ya TLDs zomwe zimapereka m'mwayi wopereka wosonyeza (mwachitsanzo, `.com, .net, .org`) kuti muwoneke product wosonyeza kwa TLD (TLD-specific product) womwe umapereka kwa zonse.
...
| Mode (Mmodzi) | Kodi imapereka bwanji |
|---|---|
| **Percentage** (Mabwino) | Imapereka percentage kuposa chisoni cha wholesale. Markup ya 20% pa domain yomwe ndi $10 imapereka $12. |
...
| Setting | Kufunika |
|---|---|
| **Disabled** | WHOIS privacy sikuperekedwa kapena kuperekedwa. |
| **Always Included** | WHOIS privacy ikuperekedwa m'moyo woperekera m'moyo woyamba m'mpaidoni. |
| **Customer Choice** | Kukhala ndi checkbox m'moyo wopereka. Onjeza **Privacy price** kuti kuperekera kwa mwaka, kapena chitsatira $0 kuti kusonye kuti likuperekedwa m'mpaidoni. |

Poyenera Namecheap, WHOIS privacy imaperekera kwa WhoisGuard (limakhalidwe mpaidoni). Poyenera OpenSRS, imaperekera kwa OpenSRS privacy service (mungathe kukhala ndi chisoni m'moyo wopereka).
...
- **Manual sync:** Settings › Domain Seller › Sync TLDs (poyenera provider).
- **Automatic sync:** Imaperekedwa m'moyo wopereka m'maka m'moyo woyamba m'mpaidoni kwa providers onse zomwe zimaperekedwa.

Poyenera sync, penda tab ya Domain Settings ya domain yoyenera ndikuyendetsa TLD picker kuti mufotokozera TLDs zomwe zikuperekedwa ndi mphamvu ya wholesale yake m'moyo wopereka.
...
- Pamene membership imaperekedwa ndipo domain ikuperekedwa, renewal ya domain imaperekedwa m'moyo woperekera.
- Zomwe zikuyenera kuwoneka zikugwiritsa ntchira payment gateway yomwe imaperekedwa kwa mwanawo.
- Renewal zomwe zimapangidwa zikuperekedwa m'moyo woperekera ndi exponential backoff.
- Email notifications zimapereka kuti renewal imaperekedwa, kusakhala, ndipo kukhala kudzera.

Email template IDs za events za tsiku la domain:
...
1. Tenda **Network Admin › Ultimate Multisite › Register Domain**
2. Select customer ule monga ndi kulemba dzina la domain
3. Tsatira zinthu za monga monga (name, address, phone) za wopereka data
4. Click **Register**

Record la domain lilipeza ndipo limalimbikizidwa ndi account ya monga monga.
