...
### 1. Pange Credentials ya GridPane Yanu
...
### 2. Pange Server ndi Site IDs Yanu
...
## Kodi Imapangidwa Bwera (How It Works)
...
## Kukhazikitsa Mavuto (Troubleshooting)

### Mavuto pa API Connection
