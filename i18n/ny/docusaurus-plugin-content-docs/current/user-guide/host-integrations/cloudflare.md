...
### 1. Gundira API Key Yanu ya Cloudflare
...
### 3. Yendetsa Constants ku wp-config.php
...
### Kodi ndi kodi ndi integrasi ya standard ya Cloudflare
...
### Kukhazikitsa Cloudflare Custom Hostnames
