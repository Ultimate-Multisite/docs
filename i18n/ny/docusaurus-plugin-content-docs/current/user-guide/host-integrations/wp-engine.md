...
## Mafunso ya Kukhazikitsa (Setup Instructions)

### 1. Kuwonetsa Plugin ya WP Engine
...
### 2. Kukhazikitsa Kufotokozera (Enable the Integration)
...
## Kodi Imene Imene? (How It Works)

### Kupanga Domain Wopangidwa (Domain Syncing)
...
### Kukhazikitsa Subdomain (Subdomain Support)
...
## Zikomo Zomwamba (Important Notes)
