...
## Vifaa vya Kwanza (Prerequisites)
...
## Ufunguo (Wizard → Integrations → Hestia)
...
## Kuangalia Maandalizi (Verifying Setup)
...
## Maelezo na Vidokezo (Notes & Tips)
...
## Kukhala Mfundo (Troubleshooting)
