---
title: >-
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  ...
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera Kufotera
  Kufotera Kufotera Kufotera Kufotera Kufot
sidebar_position: 2
...
3. Onani **Access Tokens**.
4. Onani **Create Token**.
5. Pempani m'token lina dzina lomwe limapereka (mwachitsanzo, "Ultimate Multisite Integration").
6. Pempani role ya **System Administrator**.
7. Kwa tsiku lomwe imaperekedwa:
...
1. Mu Enhance Control Panel, tenda pa **Servers**
2. Kufuna server wopambwa womwe WordPress uliyo nalo
3. Server ID (UUID format) utendeka mu URL kapena mu ma-details a server
4. Muli monga momwezi wokonzekera API kuti mutendeka servers:
...
3. Utambira **Enhance Control Panel Integration** uliambike nazo **Configuration**
4. Wizard utakufuna mambo yote:
...
3. Enhance imapanga domain iwo ku server configuration yanu
...
3. Message ya m'mwayi imapereka:
...
3. Kufotokozera m'Enhance Control Panel kuti domain imapereka:
...
- Kuphunzitsa kuti utaphunzira HTTPS, osati HTTP.
...
- Tsintha kuti `WU_ENHANCE_API_TOKEN` ikhudza m'config ya `wp-config.php`.
- Tsintha kuti token si yomwe yali yoperekedwa kapena yosakwera mu Enhance.
- Tsintha kuti pali chidziwitso (typos) m'token.

**Error: "Server ID is not configured"**
- Tsintha kuti `WU_ENHANCE_SERVER_ID` ikhudza m'config ya `wp-config.php`.
...
2. Filter ndi **integration-enhance**
3. Tsintha kuti pali mapeto omwe amagwira ntchito za ndalama.
...
- Tsintha kuti ndalama imakwanira kuperekedwa bwino: `nslookup yourdomain.com`
- Enhance imayenera DNS iperekedwe poyenera paipapo kuti iperekedwe SSL.
...
1. Tsintha ku **Servers** > **Your Server** > **Domains**
...
2. Tafuta mipangilio ya **DNS Check Interval**
...
2. Review Ultimate Multisite logs
3. Consult [GitHub Discussions](https://github.com/Multisite-Ultimate/ultimate-multisite/discussions)
