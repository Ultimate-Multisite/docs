...
## Mafunso a Kufotokozera (Setup Instructions) {#setup-instructions}

### 1. Yambira Hosting la WPMU DEV {#1-verify-wpmu-dev-hosting}
...
### 2. Kufuna Integration {#2-enable-the-integration}
...
## Kodi Imalimbikitsidwa Bwera? (How It Works) {#how-it-works}
...
### Ulamulira SSL Certificate {#ssl-certificate-management}
...
### Kuondokera kwa Domain {#domain-removal}
