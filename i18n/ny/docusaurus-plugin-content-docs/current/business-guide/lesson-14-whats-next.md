---
title: 'Phunziro 14: Chotsatira ndi chiyani'
sidebar_position: 15
...
```
FitSite Network (Yonse)
├── Zomangamanga
│   ├── WordPress Multisite (njira ya subdomain)
│   ├── Ultimate Multisite (yakonzedwa + yokhala ndi brand)
│   ├── Hosting yokhala ndi wildcard SSL + domain mapping
│   └── CDN ndi caching kuti igwire bwino ntchito
├── Chinthu
│   ├── Ma template a webusayiti (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Ma plan (Starter $49/mo, Growth $99/mo, Pro $199/mo)
│   ├── Mitengo yapachaka yokhala ndi kuchotsera kwa 20%
│   ├── Ndalama za setup, trials, ndi order bumps
│   └── Ma code ochotsera mtengo a makampeni ndi zotumizira
├── Zochitika
│   ├── Njira ya checkout yochokera pa msika wapadera
│   ├── Login, Dashboard, ndi mauthenga okhala ndi brand
│   ├── Onboarding yotsogoleredwa ndi Quick Start widget
│   ├── Mndandanda wa ma imelo olandirira
│   └── Malo a chidziwitso ndi makanema ofotokozera sitepe ndi sitepe
├── Bizinesi
│   ├── Kupeza makasitomala kudzera m'makanema 6
│   ├── Kapangidwe ka thandizo kokhala ndi magawo
│   ├── Machitidwe a ntchito (tsiku lililonse, sabata lililonse, mwezi uliwonse, kotala iliyonse)
│   ├── Kutsata ma metric (MRR, churn, LTV, CAC)
│   └── Automation kudzera mu webhooks ndi ma sequence a imelo
└── Kukula
    ├── Plan yokulitsa zomangamanga
    ├── Kukonza ndalama (upsells, kusintha kukhala pachaka, mautumiki atsopano)
...
- **Masukulu a martial arts** -- ranking ya belt, zambiri za tournament, hierarchy ya makalasi
- **Ma situdiyo a dance** -- ndandanda za recital, magalare a performance, zambiri za costume
...
- **Kulumikizana ndi booking ya makalasi** -- kulumikizana kozama ndi nsanja zotchuka za booking
- **Portal ya mamembala** -- malo olowetsedwa a mamembala a gym okhala ndi ndandanda ndi resources
...
- **Akatswiri a health** -- chiropractors, physiotherapists, nutritionists
...
1. Kodi amafunikira ma webusayiti koma amavutika kupeza abwino?
2. Kodi angakwanitse kulipira subscription ya mwezi uliwonse?
3. Kodi amalankhulana wina ndi mzake?

Msika wapadera watsopano uliwonse umafunikira:

- Ma template atsopano opangidwira industry imeneyo
- Mapangidwe a ma plan atsopano owonetsa zofunikira za industry imeneyo
- Marketing yatsopano ndi njira zatsopano zopezera makasitomala
- Content yatsopano ya onboarding ndi chidziwitso cha thandizo
...
- `fitsite.com` -- ma situdiyo a fitness
- `menusite.com` -- ma restaurant
- `lawsite.com` -- ma law firms
...
FitSite yokhala ndi makasitomala 200 pa $89 ARPU:

- **MRR**: $17,800
- **ARR**: $213,600
- **Mtengo wogulitsa womwe ungatheke**: $640,000 - $1,068,000
...
1. **Sankhani msika wapadera** wokhala ndi zofunikira zomveka, kuthekera kolipira, ndi gulu
2. **Tsimikizirani** musanayambe kumanga
3. **Mangani nsanja yosinthidwa mwapadera** yokhala ndi ma template, ma plan, ndi branding zogwirizana ndi msika wapadera
4. **Pangani zochitika zopanda zovuta** kuchokera pa signup mpaka onboarding
5. **Ikani mtengo molingana ndi phindu** ndi magawo anzeru, trials, ndi kuchotsera
6. **Launch mwadongosolo** ndi soft launch ndi checklist
7. **Pezani makasitomala** kudzera m'makanema ogwirizana ndi msika wapadera
8. **Yendetsani ntchito** ndi machitidwe okhazikika
9. **Kulitsa** zomangamanga, ndalama, ndi timu mukamakula
...
Nthawi yabwino kwambiri yoyambira inali dzulo. Nthawi yachiwiri yabwino kwambiri ndi tsopano.
