...
## Cap Captcha: protección autoalojada que simplemente funciona {#cap-captcha-self-hosted-protection-that-just-works}
...
## Protección contra pruebas de tarjetas en WooCommerce {#woocommerce-card-testing-protection}
...
## ¿Aún necesitas Google reCAPTCHA o hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Creado para escalar {#built-for-scale}
...
## ¿Necesito configurar algo? {#do-i-need-to-configure-anything}
...
## ¿Necesito claves API para Cap Captcha? {#do-i-need-api-keys-for-cap-captcha}
...
## ¿Esto ralentizará mi checkout? {#will-this-slow-down-my-checkout}
...
## ¿Esto protege contra ataques de prueba de tarjetas? {#does-this-protect-against-card-testing-attacks}
...
## ¿Puedo usar diferentes proveedores de captcha en distintos sitios? {#can-i-use-different-captcha-providers-on-different-sites}
...
#### Temporización del tarpit {#tarpit-timing}
...
#### Filtro de lista blanca de IP {#ip-whitelist-filter}
...
#### Acción previa al bloqueo {#pre-block-action}
...
## Detección de IP de cliente y proxies de confianza {#client-ip-detection--trusted-proxies}
...
#### Confianza en el header de Cloudflare {#cloudflare-header-trust}
...
#### Autodetección al activar por primera vez {#first-enable-auto-detection}
