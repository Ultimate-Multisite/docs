...
Distribuir subsitios entre servidores y bases de datos para rendimiento y seguridad
...
El addon incluye un marco de pruebas completo:
...
- **Modo Desarrollo**: activos sin minificar para depuración

## Configuración

El addon soporta varias opciones de configuración accesibles a través de la interfaz del administrador de la red.

## Ganchos y Filtros

### Acciones

- `ultimate-multisite-addon-template_init` - Se dispara después de la inicialización del addon
- `ultimate-multisite-addon-template_loaded` - Se dispara después de que se cargan todos los archivos del addon

### Filtros

- `ultimate-multisite-addon-template_settings` - Modificar la configuración del addon
- `ultimate-multisite-addon-template_enabled` - Sobrescribir el estado de habilitación/deshabilitación del addon
