---
title: 'Lección 2: Eligiendo tu nicho'
sidebar_position: 3
...
- Se espera que las empresas tengan presencia web
- La mayoría de los sitios web actuales de la industria son de baja calidad
- Los constructores genéricos no resuelven sus necesidades específicas
- El desarrollo personalizado es demasiado caro para el tamaño típico de negocio
...
- Lo suficientemente establecidos como para tener un presupuesto de marketing
- Acostumbrados a pagar por suscripciones de software (sistemas de reserva, procesamiento de pagos, etc.)
- Operando a una escala donde $49-$199/mes sea un gasto empresarial razonable
...
- Asociaciones industriales, conferencias o ferias comerciales
- Comunidades en línea activas (grupos de Facebook, foros, subreddits)
- Redes locales donde los propietarios de negocios comparten recomendaciones
...
- Industrias en las que has trabajado o para las que has construido sitios web
...
- Busca en Google "[industria] website builder" y mira lo que existe
- Navega por foros de la industria en busca de quejas sobre la presencia web
...
- **Tamaño del mercado**: ¿Cuántos negocios existen en este nicho? (Empieza con tu país/región)
...
- ¿Cómo obtuvieron su sitio web actual?
- ¿Qué desearían que pudiera hacer que no puede hacer?
- ¿Por qué lo pagan actualmente?
- Si existiera una plataforma construida específicamente para [tu nicho], ¿estarían interesados?
...
| Criterio | Evaluación |
|-----------|------------|
| Necesitan sitios web, pero les cuesta | Sí, la mayoría de los sitios de estudios son genéricos o están desactualizados |
| Pueden pagar una suscripción | Sí, ya pagan entre $50 y $200/mes por software de reserva |
| Se hablan entre sí | Sí, comunidades activas, eventos de la industria, redes locales |
| Tamaño del mercado | Más de 100,000 instalaciones solo en EE. UU. |
| Panorama de la competencia | Existen pocos sitios web específicos para nichos |
...
- **Restaurantes y cafeterías** — menús, reservas, horarios, integración de entrega
- **Agentes inmobiliarios** — listados, perfiles de agentes, guías de vecindarios
- **Bufetes de abogados** — áreas de práctica, biografías de abogados, reserva de consultas
- **Iglesias y organizaciones sin fines de lucro** — eventos, sermones, donaciones, comunidad
- **Contratistas especializados** (plomeros, electricistas, HVAC) — áreas de servicio, reservas, reseñas
- **Salones y spas** — servicios, reservas, perfiles de estilistas, galerías
- **Clínicas veterinarias** — servicios, portales para mascotas, reserva de citas
- **Escuelas de música** — perfiles de instructores, programación de lecciones, información de recitales
...
- **Validación de FitSite**: confirmado que los estudios de fitness cumplen todos los criterios
- **Nichos alternativos**: una lista de otras verticales a las que puedes aplicar este marco

---

**Siguiente:** [Lección 3: Configurando tu red](lesson-3-setting-up) — instalamos Ultimate Multisite y configuramos los cimientos para FitSite.
