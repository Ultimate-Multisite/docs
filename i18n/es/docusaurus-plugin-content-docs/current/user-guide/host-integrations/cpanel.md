...
---
# cPanel Integración {#cpanel-integration}
...
### 1. Obtén tus credenciales de cPanel {#1-get-your-cpanel-credentials}
...
### 2. Añade constantes a wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Habilita la integración {#3-enable-the-integration}
