...
---
# Integración RunCloud {#runcloud-integration}
...
### 1. Obtén tus credenciales API de RunCloud {#1-get-your-runcloud-api-credentials}
...
### 2. Obtén tus IDs de servidor y aplicación {#2-get-your-server-and-app-ids}
...
### 3. Añade las constantes a wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Habilita la integración {#4-enable-the-integration}
