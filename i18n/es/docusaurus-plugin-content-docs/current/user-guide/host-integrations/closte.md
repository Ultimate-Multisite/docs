...
---
# Closte Integración {#closte-integration}
...
### 1. Verifica tu Closte API Key {#1-verify-your-closte-api-key}
...
### 2. Habilita la integración {#2-enable-the-integration}
...
## Creación de registros de dominio {#domain-record-creation}
