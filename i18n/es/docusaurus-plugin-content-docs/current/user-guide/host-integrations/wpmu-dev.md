...
---
# Integración WPMU DEV {#wpmu-dev-integration}
...
### 1. Verificar el alojamiento WPMU DEV {#1-verify-wpmu-dev-hosting}
...
### Eliminación de dominios {#domain-removal}
...
### Autenticación API {#api-authentication}
