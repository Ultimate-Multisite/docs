...
### 1. Obtén tus credenciales API de ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Obtén tu App ID {#2-get-your-app-id}
...
### Eliminación de dominio {#domain-removal}
