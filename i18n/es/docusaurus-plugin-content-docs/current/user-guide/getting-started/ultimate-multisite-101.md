...
#### Subdominio vs. Subdirectorio {#subdomain-vs-subdirectory}
...
### Consideraciones de Arquitectura {#architecture-considerations}
...
#### Hosting Compartido vs. Dedicado {#shared-vs-dedicated-hosting}
