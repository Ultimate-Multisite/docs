...
---
# Cómo usar los snippets de Ultimate Multisite en nuestro repositorio de GitHub
...
# Cómo añadir el snippet en el archivo functions.php de tu theme.
...
# Cómo crear Must-Use Plugins (mu-plugins)
