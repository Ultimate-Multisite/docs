...
- Si falla **Visit (SSO)**, confirma que el DNS y el SSL estén activos para el dominio del inquilino.
- Si la desinstalación deja recursos del host pendientes, elimina cualquier base de datos, usuario o carpeta restante en hPanel después de confirmar las copias de seguridad.
