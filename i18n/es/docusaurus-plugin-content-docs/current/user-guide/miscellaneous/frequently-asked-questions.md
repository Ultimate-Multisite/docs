...
_Multisite (subdominio o subdirectorio) también necesita estar activado._ [How to Install WordPress Multisite](/user-guide/getting-started/how-to-install-wordpress-multisite).
