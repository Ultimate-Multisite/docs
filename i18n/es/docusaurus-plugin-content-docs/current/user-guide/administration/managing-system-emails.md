---
title: Gestión de correos electrónicos del sistema
sidebar_position: 13
...
![Settings - pestaña Emails](/img/admin/settings-emails.png)

Desde ahí, puedes acceder a la página **System Emails** para ver todas las plantillas de correo electrónico.
...
1. Ve a la página **System Emails**
2. Haz clic en el botón **Reset & Import** en la parte superior de la página
...
1. **Eliminar y volver a importar** — Elimina el correo electrónico del sistema e impórtalo de nuevo (esto borra las métricas de envío)
2. **Restablecer mediante la herramienta** — Usa la herramienta **Reset & Import**, activa la opción **Reset** y selecciona los correos electrónicos que quieres restablecer

La opción Reset es la preferida, ya que conserva las métricas de envío y otros metadatos mientras restaura el contenido predeterminado.
