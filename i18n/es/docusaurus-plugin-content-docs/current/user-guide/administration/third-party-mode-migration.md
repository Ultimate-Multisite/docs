...
### Instalaciones nuevas (WordPress 7.0+)
...
### Versiones de WordPress anteriores a 7.0
...
### Modo automático (Nuevo predeterminado)
...
### Las capacidades no se cargan en modo automático
...
### Quiero mantener el modo heredado
...
### Mis capacidades personalizadas no se muestran
