...
---
# Operaciones de Inquilinos Soberanos {#sovereign-tenant-operations}
...
## ¿Qué cambia para los administradores? {#what-changes-for-administrators}
...
## Visitar un inquilino soberano {#visiting-a-sovereign-tenant}
...
## Lista de verificación de operaciones de sitios remotos {#remote-site-operations-checklist}

Antes de cambiar un inquilino soberano o remoto, confirma:

## Eliminación de inquilinos soberanos {#deleting-sovereign-tenants}
