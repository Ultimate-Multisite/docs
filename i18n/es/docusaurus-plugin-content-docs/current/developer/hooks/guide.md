---
title: Guía de uso de Hooks
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Guía de uso de Hooks {#hooks-usage-guide}

Ultimate Multisite proporciona más de 200 hooks de acción y más de 280 hooks de filtro. Esta página cubre los hooks más utilizados con ejemplos prácticos. Para una referencia completa generada automáticamente, navega por las otras páginas de esta sección.

## Hooks de Acción {#action-hooks}

### Ciclo de vida del cliente {#customer-lifecycle}

#### Después de la creación del cliente {#after-customer-creation}
...
#### Cambio de estado del cliente {#customer-status-change}
...
### Hooks del sitio {#site-hooks}

#### Después de publicar el sitio {#after-site-published}
...
#### Antes de aplicar la plantilla {#before-template-application}
...
### Hooks de membresía {#membership-hooks}
...
### Hooks de pago {#payment-hooks}

#### Pago completado / fallido {#payment-completed--failed}
...
### Hooks de pago {#checkout-hooks}

#### Antes de procesar / después de completar {#before-processing--after-completion}
...
### Filtros de precios {#pricing-filters}
...
### Filtros de plantillas {#template-filters}
...
### Filtros de limitaciones {#limitation-filters}
...
### Filtros de pasarela {#gateway-filters}
...
### Campos del formulario de pago {#checkout-form-fields}
...
### Contenido del correo electrónico {#email-content}
