...
---
# GridPane Integracija {#gridpane-integration}
...
### 1. Gaukite savo GridPane API kreditius {#1-get-your-gridpane-api-credentials}
...
### 2. Gaukite savo serverio ir vietos ID {#2-get-your-server-and-site-ids}
...
## SUNRISE konstantos valdymas {#sunrise-constant-management}
...
## Probleminiai situacijos tvarkymas (Troubleshooting) {#troubleshooting}
