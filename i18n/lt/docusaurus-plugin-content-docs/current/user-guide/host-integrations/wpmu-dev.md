...
---
# Integracija su WPMU DEV {#wpmu-dev-integration}
...
### 1. Patikrinkite WPMU DEV Hostingu {#1-verify-wpmu-dev-hosting}
...
### 2. Įjunkite integraciją {#2-enable-the-integration}
...
### SSL sertifikato valdymas {#ssl-certificate-management}
...
## Svarbiausios nuotaikos {#important-notes}

### Domeno pašalinimas {#domain-removal}
...
### API autentifikavimas {#api-authentication}
...
### SSL sertifikato problemas {#ssl-certificate-issues}
...
### Domenas nėra pridėtas {#domain-not-added}
