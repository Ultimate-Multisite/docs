...
---
# Integracija su Hestia Control Panel {#hestia-control-panel-integration}
...
## Konfiguravimas (Wizard → Integracijos → Hestia) {#configuration-wizard--integrations--hestia}
Įveskite šiuos vert.</
...
## Nustatymų patikrinimas {#verifying-setup}
...
## Užduotys ir patarimai {#notes--tips}
...
## API pavyzdys (cURL) {#example-api-call-curl}
