---
title: Vertinimas Ultimate Multisite
sidebar_position: 19
...
Tai yra standartinė WordPress bendruomenės vertimo sistema. Kai vertimai pasieka pakankamą patvirtinimo užfikirimo, jie automatiškai skirstomi visoms Ultimate Multisite vartotojai per WordPress plugin atnaujinimus.

**Jums reikia pagalbos!** Jei kalba yra kitas nei anglų, prašome laikytis vertimų įnašimo. Net kelios eilutės vertinimas padeda. Pradėti:

1. Eikite [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Pasirinkite savo kalbą
3. Spauskite „Pridėti vertimą“ (Contribute Translation)
4. Jums reikalinga nemokama WordPress.org paskyra
...
1. Atskleidkite Poedit nuo [poedit.net](https://poedit.net)
2. Atvarkykite `.pot` failą iš katalogų `wp-content/plugins/ultimate-multisite/lang/`
3. Išverstykite tekstus Poedit ar interface'e
