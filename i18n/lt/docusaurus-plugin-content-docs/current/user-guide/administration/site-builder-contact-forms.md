...
## Kontaktformáció létrehozása {#creating-a-contact-form}
...
## Generált rövid kód használata {#using-the-generated-shortcode}
...
## Kontakto formos pritaikymas {#customizing-the-contact-form}

Po to, kai Site Builder sukuria kontakto formą, ją galite further pritaikyti:

### Per čatą interfeisą {#via-the-chat-interface}
...
### Per formos plokštadienio administravimo interfeisą {#via-the-form-plugins-admin-interface}
...
## Formos plokštadieniai ir supraveikojimas {#form-plugins-and-compatibility}
...
## El. laiškų pranešimai {#email-notifications}
...
## Pavyzdiniai naudojimo atvejai {#example-use-cases}

### Paprastas kontaktinis forma {#simple-contact-form}

> "Sukurti paprastą kontaktinį formą su laukais vardas, el. pašto adresas ir žinutė."

### Multistepi forma {#multi-step-form}
