...
## Vienos svetainės eksportavimas {#exporting-one-site}
...
## Visos tinklo eksportavimas {#exporting-the-whole-network}
...
### Tinklo importavimo darybai (Network Import Bundles) {#network-import-bundles}
...
#### Tinklo importavimo darybos generavimas {#generating-a-network-import-bundle}
...
#### Atvežimas iš Network Import Bundle {#restoring-from-a-network-import-bundle}
...
## Įdėkite savai paleidant eksporto ZIP failą {#installing-a-self-booting-export-zip}
