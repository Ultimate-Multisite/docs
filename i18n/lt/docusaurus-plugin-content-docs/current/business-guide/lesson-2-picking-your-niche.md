---
title: '2 pamoka: Savo nišos pasirinkimas'
sidebar_position: 3
...
- Iš verslų tikimasi internetinio buvimo
- Dauguma dabartinių svetainių industrijoje yra prastos kokybės
- Bendriniai kūrimo įrankiai neišsprendžia jų specifinių poreikių
- Individualus kūrimas yra per brangus tipiniam verslo dydžiui
...
- Pakankamai įsitvirtinę, kad turėtų rinkodaros biudžetą
- Įpratę mokėti už programinės įrangos prenumeratas (rezervavimo sistemas, mokėjimų apdorojimą ir pan.)
- Veikiantys tokiu mastu, kuriame $49-$199/mėn. yra pagrįstos verslo išlaidos
...
- Industrijos asociacijų, konferencijų arba parodų
- Aktyvių internetinių bendruomenių (Facebook grupių, forumų, subredditų)
- Vietinį tinklaveikos kontekstą, kuriame verslų savininkai dalijasi rekomendacijomis
...
- Industrijas, kuriose dirbote arba kurioms kūrėte svetaines
...
- Google "[industry] website builder" ir pažiūrėkite, kas egzistuoja
- Naršykite industrijos forumuose, ieškodami skundų dėl internetinio buvimo
...
- **Rinkos dydis**: kiek verslų yra šioje nišoje? (Pradėkite nuo savo šalies / regiono)
...
- Kaip gavote dabartinę svetainę?
- Ko norėtumėte, kad ji galėtų daryti, bet negali?
- Kiek šiuo metu už ją mokate?
- Jei egzistuotų platforma, sukurta specialiai [jūsų nišai], ar jus tai domintų?
...
|-----------|------------|
| Reikia svetainių, bet sunku | Taip -- dauguma studijų svetainių yra bendrinės arba pasenusios |
| Gali sau leisti prenumeratą | Taip -- jau moka $50-$200/mėn. už rezervavimo programinę įrangą |
| Bendrauja tarpusavyje | Taip -- aktyvios bendruomenės, industrijos renginiai, vietiniai tinklai |
| Rinkos dydis | 100 000+ objektų vien tik JAV |
| Konkurentų aplinka | Yra nedaug nišai specifinių svetainių platformų |
...
- **Restoranai ir kavinės** -- meniu, rezervacijos, darbo valandos, pristatymo integracija
- **Nekilnojamojo turto agentai** -- skelbimai, agentų profiliai, rajonų gidai
- **Advokatų kontoros** -- praktikos sritys, advokatų biografijos, konsultacijų rezervacija
- **Bažnyčios ir ne pelno organizacijos** -- renginiai, pamokslai, aukos, bendruomenė
- **Amatų ir techninių paslaugų rangovai** (santechnikai, elektrikai, ŠVOK) -- aptarnavimo sritys, rezervacija, atsiliepimai
- **Grožio salonai ir SPA** -- paslaugos, rezervacija, stilistų profiliai, galerijos
- **Veterinarijos klinikos** -- paslaugos, augintinių portalai, vizitų rezervacija
- **Muzikos mokyklos** -- instruktorių profiliai, pamokų planavimas, koncertų informacija
...
- **FitSite patvirtinimas**: patvirtinta, kad fitneso studijos atitinka visus kriterijus
- **Alternatyvios nišos**: kitų vertikalių sąrašas, kurioms galite taikyti šią struktūrą

---

**Toliau:** [3 pamoka: tinklo nustatymas](lesson-3-setting-up) -- įdiegsime Ultimate Multisite ir sukonfigūruosime FitSite pagrindą.
