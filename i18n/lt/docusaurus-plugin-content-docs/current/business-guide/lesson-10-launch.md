---
title: '10 pamoka: Paleidimo diena'
sidebar_position: 11
...
- [ ] Domenų susiejimas veikia -- išbandykite svetainės sukūrimą ir pasirinktinio domeno susiejimą
...
- [ ] Visos nuotraukos tinkamai licencijuotos (be standartinių nuotraukų vandens ženklų)
- [ ] Mobilusis prisitaikymas veikia kiekviename šablono puslapyje
...
- [ ] Kainodara teisinga (mėnesinė ir metinė)
- [ ] Įdiegimo mokesčiai sukonfigūruoti tinkamuose planuose
- [ ] Bandomasis laikotarpis veikia Starter plane
...
- [ ] Mokėjimas sėkmingai apdorojamas
- [ ] Klientas po registracijos gauna pasveikinimo el. laišką
- [ ] Nauja svetainė sukuriama su teisingu šablonu
...
- [ ] Visi sistemos el. laiškai naudoja FitSite prekės ženklą ir fitnesui pritaikytą kalbą
...
- [ ] Pasveikinimo el. laiškų seka sukonfigūruota ir išbandyta
...
- [ ] Grąžinimo politika apibrėžta ir dokumentuota
- [ ] Verslo subjektas paruoštas mokėjimams priimti
...
- Sąžiningą atsiliepimą apie registracijos ir įvedimo patirtį
- Leidimą naudoti jų svetainę kaip pavyzdį demonstracijai
- Pranešimą apie bet kokias klaidas ar problemas, su kuriomis jie susiduria
...
- Perjunkite mokėjimų šliuzą į realų režimą
- Publikuokite savo rinkodaros svetainę
...
1. **Perjunkite į realius mokėjimus** -- išjunkite testavimo režimą savo mokėjimų šliuze
2. **Patikrinkite dar kartą** -- atlikite pilną bandomąją registraciją su realiu mokėjimu (po to sau grąžinkite pinigus)
3. **Atidžiai stebėkite** -- sekite klaidas, nepavykusias registracijas ar mokėjimų problemas
...
- **Mokėjimų šliuzo problemoms**: Turėkite pasiruošę savo šliuzo teikėjo pagalbos kontaktą
- **SSL sertifikato problemoms**: Žinokite, kaip patikrinti ir atnaujinti sertifikatus
- **El. laiškų pristatymo nesėkmėms**: Patikrinkite, ar el. laiškai iš tikrųjų pasiekia gavėjus (patikrinkite šlamšto aplankus)
...
- **Paleidimo dienos procedūras**, kad galėtumėte paleisti užtikrintai
- **Atsarginį planą** dažnoms paleidimo dienos problemoms

---

**Toliau:** [11 pamoka: Klientų paieška](lesson-11-customers) -- dabar, kai FitSite veikia viešai, kaip paskatinti fitneso studijų savininkus užsiregistruoti?
