---
title: '9 pamoka: Kainodara siekiant pelno'
sidebar_position: 10
...
- Profesionalią fitneso svetainę, kurios individualus sukūrimas kainuotų $2,000-$5,000
- Nuolatinę priežiūrą, atnaujinimus ir saugumą, apie kuriuos jiems nereikia galvoti
- Nišai pritaikytas funkcijas, kurių nesiūlo bendros paskirties kūrimo įrankiai
- Platformos, sukurtos jų industrijai, patikimumą
...
- **Žiniatinklio kūrėjo samdymu**: $2,000-$5,000 iš anksto + $50-$100/mėn. priežiūra
- **Wix/Squarespace**: $16-$45/mėn., bet be fitnesui skirtų funkcijų, ir jie turi susikurti patys
- **Nieko nedarymu**: Prarasti nariai, kurie negali jų rasti internete
...
| Planas | Mėnesinis | Metinis (per mėnesį) | Metinė suma | Sutaupymas |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mėn. | $39/mėn. | $468/metus | 20% nuolaida |
| Growth | $99/mėn. | $79/mėn. | $948/metus | 20% nuolaida |
| Pro | $199/mėn. | $159/mėn. | $1,908/metus | 20% nuolaida |
...
- **Starter**: Nėra nustatymo mokesčio (pašalinamos įėjimo kliūtys)
- **Growth**: $99 nustatymo mokestis (padengia pasirinktinio domeno konfigūraciją ir pradinę konsultaciją)
- **Pro**: $299 nustatymo mokestis (padengia kelių lokacijų nustatymą ir įvedimo skambutį)
...
- **7 dienų nemokamas bandomasis laikotarpis** tik Starter plane
- Nėra bandomojo laikotarpio Growth ir Pro planuose (šie klientai yra labiau įsipareigoję ir tikisi mokėti)
...
- **FITLAUNCH** -- 30% nuolaida pirmiems 3 mėnesiams (paleidimo akcijai)
- **ANNUAL20** -- 20% nuolaida metiniams planams (jei dar nėra pritaikyta nuolaida)
- **REFERRAL** -- 1 mėnuo nemokamai (klientų rekomendacijoms)

Eikite į **Ultimate Multisite > Discount Codes**, kad juos sukurtumėte. Išsamų vadovą žr. [Nuolaidų kodų kūrimas](/user-guide/configuration/creating-discount-codes).
...
1. Sukonfigūruokite mokesčių tarifus skiltyje **Ultimate Multisite > Settings > Taxes**
2. Priskirkite mokesčių kategorijas savo planams
3. Įsitikinkite, kad sąskaitose mokesčiai rodomi teisingai
...
- **Konversijos rodiklį pagal planą**: Jei Starter konvertuoja gerai, bet Growth ne, tarpas tarp jų gali būti per didelis
- **Atnaujinimo rodiklį**: Jei nedaug klientų pereina iš Starter į Growth, Growth planas gali nesiūlyti pakankamai papildomos vertės
...
- **Bandomasis laikotarpis** pradinio lygio planui, kad būtų sumažinta registracijos trintis
- **Strateginiai nuolaidų kodai** paleidimui, rekomendacijoms ir kampanijoms
- **Mokesčių konfigūracija** reikalavimus atitinkančiam sąskaitų išrašymui
- **Kainodaros peržiūros sistema** nuolatiniam optimizavimui

---

**Toliau:** [10 pamoka: Paleidimo diena](lesson-10-launch) -- kontrolinis sąrašas prieš paleidimą ir paleidimas gyvai.
