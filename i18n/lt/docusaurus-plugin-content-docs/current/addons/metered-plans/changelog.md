---
title: Pagal naudojimą apmokestinamų planų pakeitimų žurnalas
sidebar_position: 99
...
- Nauja: Connector taikymo mechanizmas perdarytas su dinaminiu limito aptikimu ir tiesioginiu įrašymu, užtikrinant tikslumą realiuoju laiku visuose connectoriuose
- Pataisyta: Duomenų bazės lentelių atnaujinimai dabar teisingai suderinti su BerlinDB schemos apibrėžtimis, užkertant kelią atnaujinimo klaidoms naujuose diegimuose
- Pataisyta: Duomenų bazės atnaujinimo callbackai konvertuoti į teisingą formatą, išsprendžiant tylias atnaujinimo klaidas
- Pataisyta: Trupmeninės reikšmės dabar priimamos AI Usage Overage Markup įvesties lauke
