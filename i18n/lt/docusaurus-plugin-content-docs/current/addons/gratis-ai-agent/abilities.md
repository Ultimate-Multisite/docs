...
## Pasirinktiniai įrašų tipai {#custom-post-types}
...
## Pasirinktinės taksonomijos {#custom-taxonomies}
...
## Visuotiniai stiliai {#global-styles}
...
## Navigacijos meniu {#navigation-menus}
...
## Parinkčių valdymas {#options-management}
...
## Turinio valdymas {#content-management}
...
## Vizualinė peržiūra {#visual-review}
...
## Diegiamos galimybės {#installable-abilities}
