...
### 1. Plano generavimas {#1-plan-generation}
...
### 2. Pluginų aptikimas {#2-plugin-discovery}
...
### 3. Plano vykdymas {#3-plan-execution}
...
### 4. Pažangos sekimas {#4-progress-tracking}
...
### 5. Klaidų atkūrimas {#5-error-recovery}
...
## Svetainės plano gebos {#site-plan-abilities}
...
## v1 ir v2 palyginimas {#comparing-v1-and-v2}
...
## WP-CLI plano komandos {#wp-cli-plan-commands}
