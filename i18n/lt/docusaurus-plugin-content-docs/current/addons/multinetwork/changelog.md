---
title: Kelių tinklų pakeitimų žurnalas
sidebar_position: 99
...
* Nauja: tinklo medijos klonavimas — svetainės medija teisingai dubliuojama klonuojant tinklus iš šablono.
* Pataisyta: tinklo klonavimas dabar veikia be multi-tenancy addon; super admin teisės po klonavimo suteikiamos iš naujo.
* Pataisyta: tinklo kūrimas dabar suderinamas su WooCommerce ir visais mokėjimo šliuzais.
* Pataisyta: prievado numeris dabar įtraukiamas generuojant atsarginį domeną.
* Pataisyta: šablono pasirinkiklio CSS perkeltas į įtraukiamą stiliaus aprašą, kad būtų teisingai atvaizduojamas visose temose.
