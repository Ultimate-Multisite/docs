...
- **Pagrindinė spalva** — pagrindinė prekės ženklo spalva, naudojama mygtukams, nuorodoms ir akcentams
- **Antrinė spalva** — papildoma spalva įvairovei
- **Akcentinė spalva** — paryškinimo spalva svarbiems elementams
...
- **Antraščių šriftas** — naudojamas puslapių pavadinimams ir sekcijų antraštėms
- **Pagrindinio teksto šriftas** — naudojamas pastraipų tekstui ir turiniui
- **Šriftų dydžiai** — prisitaikantys dydžiai skirtingiems ekrano dydžiams
...
- **Piktogramos** — piktogramų stilius ir dydžiai
...
- Pilnas navigacijos meniu
- Visas išdėstymas su visais stulpeliais
...
- Prisitaikanti navigacija (hamburgerio meniu)
...
| Įrenginys | Plotis | Peržiūra |
|--------|-------|---------|
| **Mobilusis** | 375px | Vertikalios padėties telefonas |
| **Planšetė** | 768px | Horizontalios padėties planšetė |
...
1. **Koreguodami spalvas** — pakeiskite bet kurią paletės spalvą
2. **Keisdami šriftus** — pasirinkite kitus šriftus
3. **Modifikuodami tarpus** — koreguokite vidines paraštes ir paraštes
...
- Darbalaukio peržiūra atsinaujina iš karto
- Mobilioji peržiūra atsinaujina iš karto
...
- **Pirminiu dizainu** — pamatykite, kas pasikeitė
...
1. **Peržiūrėkite abi peržiūras** — patikrinkite, ar darbalaukio ir mobilioji versijos atrodo gerai
2. **Patikrinkite visas spalvas** — užtikrinkite kontrastą ir prieinamumą
3. **Išbandykite tipografiją** — patikrinkite skaitomumą visais dydžiais
...
1. Theme Builder sugeneruoja visą jūsų temą
2. Tema įdiegiama jūsų WordPress svetainėje
...
- **Patikrinkite kontrastą** — naudokite [Paletės kontrasto patikrinimą](../abilities/validate-palette-contrast.md) prieinamumui
...
- [Paletės kontrasto patikrinimas](../abilities/validate-palette-contrast.md) — patikrinkite spalvų prieinamumą
- [Generuoti Logo SVG](../abilities/generate-logo-svg.md) — kurkite pasirinktinius logotipus
