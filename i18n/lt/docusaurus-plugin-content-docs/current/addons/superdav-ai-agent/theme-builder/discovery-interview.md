...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Rekomenduojama fotografijoms |
| **PNG** | `.png` | Palaiko skaidrumą |
...
- **Spalvų paletė** — dominuojančios spalvos išgaunamos ir naudojamos temoje
- **Vizualinis stilius** — modernus, kaimiškas, minimalistinis, ryškus ir t. t.
- **Nuotaika ir atmosfera** — profesionali, kūrybiška, draugiška, prabangi ir t. t.
...
- **Nuotaikų koliažai** — vaizdų rinkiniai, atspindintys jūsų norimą estetiką
- **Produktų nuotraukos** — jei turite produktų, kuriuos norite pristatyti
...
- **Tekstu perkrauti vaizdai** — ekrano kopijos su daug teksto
...
3. **Įtraukite įvairovę** — spalvų, stiliaus ir temos derinį
...
- **Spalvų paletė** — pagrindinės, antrinės ir akcentinės spalvos
- **Tipografija** — šriftų šeimos antraštėms ir pagrindiniam tekstui
- **Maketo stilius** — tarpai, lygiavimas ir komponentų išdėstymas
...
1. Peržiūrėkite sugeneruotą dizaino kryptį
2. Pateikite atsiliepimą arba paprašykite koregavimų
...
- [Įrankiai ir konfigūracija](./tools.md) — prieinami įrankiai ir konfigūracijos parinktys
