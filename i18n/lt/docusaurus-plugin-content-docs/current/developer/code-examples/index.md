---
title: Pažangūs kodo pavyzdžiai
sidebar_position: 1
...
Dvi vienalaikės užklausos gali perskaityti tą pačią reikšmę ir abi įrašyti tą patį padidintą rezultatą, prarandant vieną skaičiavimą. `increment_item()` perduoda aritmetiką duomenų bazės varikliui vienu `UPDATE ... SET column = column + ?` sakiniu, todėl operacija iš esmės yra atominė.
