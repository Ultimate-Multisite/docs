---
title: Kablių naudojimo vadovas
sidebar_position: 1
...
### Kliento gyvavimo ciklas {#customer-lifecycle}

#### Po kliento sukūrimo {#after-customer-creation}
...
#### Kliento būsenos pasikeitimas {#customer-status-change}
...
### Svetainės Hooks {#site-hooks}

#### Po svetainės paskelbimo {#after-site-published}
...
#### Prieš šablono pritaikymą {#before-template-application}
...
### Narystės Hooks {#membership-hooks}

#### Būsenos perėjimai {#status-transitions}
...
### Mokėjimo Hooks {#payment-hooks}

#### Mokėjimas atliktas / nepavyko {#payment-completed--failed}
...
#### Prieš apdorojimą / po užbaigimo {#before-processing--after-completion}
...
### Kainodaros filtrai {#pricing-filters}

#### Krepšelio suma {#cart-total}
...
### Šablonų filtrai {#template-filters}
...
### Apribojimų filtrai {#limitation-filters}
...
### Gateway filtrai {#gateway-filters}
...
### Checkout formos laukai {#checkout-form-fields}
...
### El. laiško turinys {#email-content}
