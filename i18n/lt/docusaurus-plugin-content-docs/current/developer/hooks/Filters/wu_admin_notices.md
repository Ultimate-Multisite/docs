---
id: wu_admin_notices
title: Filtras - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Pranešimų sąrašas tam konkrečiam skydeliui. |
| $all_notices | `array` | Pridėtų pranešimų sąrašas, suskirstytas pagal skydelį. |
| $panel | `string` | Skydelis, kurio pranešimus reikia gauti. |
