...
---
# Kūrėjų dokumentacija {#developer-documentation}
...
## Kas pasiekiama {#whats-available}
...
## Composer / Bedrock diegimas {#composer--bedrock-installation}
...
### Naudokite REST API {#use-the-rest-api}

```bash
curl -u "api_key:api_secret" https://yoursite.com/wp-json/wu/v2/customers
```

### Prisijunkite prie įvykių {#hook-into-events}
...
### Sukurkite priedą {#build-an-addon}
