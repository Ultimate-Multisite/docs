...
## Strategi isoliad {#isolation-strategy}
...
## Cyfathrebu host databnwch {#database-host-binding}
...
## Fylfachau fylfachau (Filesystem root) {#filesystem-root}
...
## Ordyn cyfathriant (Provisioning order) {#provisioning-order}
...
## Cyfathriant rheoli cyd-defnyddwyr swyddogol (Sovereign customer management flows) {#sovereign-customer-management-flows}
