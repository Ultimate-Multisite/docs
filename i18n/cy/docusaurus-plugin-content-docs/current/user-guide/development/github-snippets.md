...
---
# Sut i'rdefnyddio snippetau Ultimate Multisite ar gyfer y repository GitHub ein {#how-to-use-ultimate-multisite-snippets-on-our-github-repository}
...
# Sut i ddefnyddio'r snippet ar fy ffylch `functions.php` o'ch theme. {#how-to-add-the-snippet-on-your-themes-functionsphp-file}
...
# Sut i creu Pluginau Must-Use (mu-plugins) {#how-to-create-must-use-plugins-mu-plugins}
