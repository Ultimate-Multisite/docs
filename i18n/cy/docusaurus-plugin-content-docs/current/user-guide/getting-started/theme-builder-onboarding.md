...
## Beth yw ffylchion gweithredig Theme Builder? {#what-is-the-theme-builder-onboarding-flow}
...
## Cynllunio'r Theme Builder Onboarding {#starting-the-theme-builder-onboarding}

### Setffryd Cyntaf (First-Run Setup) {#first-run-setup}
...
### Awyr Manual (Manual Activation) {#manual-activation}
...
## Ymddangosau'r Onboarding {#the-onboarding-steps}

### Cynllunio Modd (Mode Selection) {#step-1-mode-selection}
...
### Cynllunio'r Site (Site Specification) {#step-2-site-specification}
...
### Cynllunio System Cyflwr (Design System) {#step-3-design-system-decisions}
...
### Cynllunio Thymor (Theme Generation) {#step-4-theme-generation}
...
### Actywio a Cynodiad {#step-5-activation-and-verification}
...
## Cyflwr Y Safon a Memoriad site_brief {#site-specification-and-sitebrief-memory}
...
### Pam mae site_brief yn bwysig {#why-sitebrief-matters}

Yn gyfarfynion yn dda, mae'r cyflwyniadau yn cyfeirio at eich site_brief i:

---
### Cadw your site_brief {#viewing-your-sitebrief}
...
## Gwahanu ar ôl Onboarding {#customizing-after-onboarding}

Ar ôl i weinio'r Theme Builder, gallwch:

### Defnyddio'r Faddau Skill Design System Aesthetics {#use-the-design-system-aesthetics-skill}
...
### Redig theme.json yn dros y cyflym {#edit-themejson-directly}
...
### Creu Template Blocau Custom {#create-custom-block-templates}
...
## Cyflwyniad: Canolbwyntio anhef vs. newydd {#comparison-old-vs-new-onboarding}
...
## Cyflwyniad: Cynllunio anhef {#troubleshooting}
