...
## Gosod y Plugin {#installing-the-plugin}
...
### Archwiliadau Cyn-osod {#pre-install-checks}
...
### Cynnwys Difeiriol {#default-content}
...
### Plugins Argymhegedig {#recommended-plugins}
