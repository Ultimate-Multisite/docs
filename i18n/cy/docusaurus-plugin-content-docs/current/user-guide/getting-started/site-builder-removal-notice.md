---
title: Cyflwyniad Aros y Mod Gweithredwr Safon
sidebar_position: 19
...
- Creu safleoedd o thymau
- Cyflwyno setegau sylfaenol
- Dechrau'r thymau
...
- Setegau mwy llawer, a ddynol gan y agent
- Opsiadau gwellterion thymau
...
1. Mae'n gofyn: "Help me set up a new site" (Help i ddatblygu siat newydd)
2. Bydd y Agent Cyflwyniad Datblygu'r Siat yn gwneud eich cyfarwyddo drwy:
   - Pethau a golau'r siat ac amgylcheddau
   - Ymddangosol ar gyfer y ddefnyddwyr target
   - Identiti brand (Brand identity)
...
1. Gallwch sicrhaesu ei ddefnyddio fel mae hi'n bodoliad
2. I newid y theme, gofyn: "Redesign my site" (Newid fy siat)
...
1. Gofyn: "Change my theme" (Newid fy theme)
2. Bydd y Agent Cyflwyniad Datblygu'r Siat yn gwneud yr hyn ymlaen:
   - Mae'n gofyn am eich pethau dylunio
...
2. Deilio theme
3. Cyflwynio setffroi cychwynig (Configure basic settings)
4. Rheoli
```
...
2. Defnyddiwch ddefnyddwyr target eich siat
3. Deilio pethau dylunio
4. Mae'r Agent yn creu theme newydd
5. Mae'r Agent yn acti'r theme
...
- Gallu gweld cyddeallau (Ability Visibility controls)
- Mae pob un yn gweithio'n dda gyda'i gilydd
...
1. Cyflwyno: "Help me set up a new site" (Help wyneuddu'r siart new)
2. Disgrifwch y gweithredol a'r dyluniad o'r siart gwreiddiol
...
1. Gwylio bod eich thymau (theme) yn gael ei weithio
2. Gyflwynwch y pluginau eich gael yn ddefnyddio
...
- Mae eich siartau sydd yn gael ei weithio
...
- **Site Specification Skill**: Defnyddiwch eich gymrydau a'r ddefnyddwyr o'r siart
- **Design System Aesthetics Skill**: Gyflymu eich identiti wizual o'r siart
