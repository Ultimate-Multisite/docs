...
### 1. Derbyn eich Cyfathriau API GridPane
...
### 2. Derbyn eich IDs Server a Site
...
### 3. Ychwanegu Cyconstantau i wp-config.php
...
## Cyflwyniad Cynllunio (Troubleshooting)
...
### Domenaeth Nid cael ei ddefnyddio
