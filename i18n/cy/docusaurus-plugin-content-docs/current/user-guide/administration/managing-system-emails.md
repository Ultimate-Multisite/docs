---
title: Cyfathrebu E-bostrefau System
sidebar_position: 13
...
O'r lle hwn, gallwch cyrraedd y peidiad **System Emails** i weld pob model e-melynu.

![System Emails list](/img/admin/system-emails-list.png)

Gallwch hefyd redig modelau e-melynu unigol gan ddefnyddio'r editor e-melynu systemau:
...
I cyflwyno modelau e-melynu newydd:

1. Ymynychi at y peidiad **System Emails**
2. Chwilio ar y bot **Reset & Import** yn y cefndir y peidiad
...
1. **Talybu a cyflwyno eto** — Talybu'r e-melynu systemau a cyflwyno'n ddiweddar (mae hyn yn talybu'r metricau anfon).
2. **Cyfathogi drwy'r tool** — Defnyddiw y tool **Reset & Import**, gwylio ar y opsiwn **Reset**, a dechrau'r e-melynu sydd eich bod eisiau cyfathogi.

Mae'r opsiwn Reset yn cael ei gael yn priodol oherwydd mae hi'n parhau â'r metricau anfon a metadata eraill gyda chynllunio'r cynnwys ddefnyddiol yn ôl.
