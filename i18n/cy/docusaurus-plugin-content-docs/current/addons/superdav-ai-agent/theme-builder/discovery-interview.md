...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Argymhellir ar gyfer ffotograffau |
| **PNG** | `.png` | Yn cefnogi tryloywder |
...
- **Palet lliwiau** — caiff lliwiau dominyddol eu tynnu a’u defnyddio yn y theme
- **Arddull weledol** — modern, gwledig, minimalaidd, bywiog, ac ati
- **Naws ac awyrgylch** — proffesiynol, creadigol, cyfeillgar, moethus, ac ati
...
- **Byrddau naws** — casgliadau o ddelweddau sy’n cynrychioli eich estheteg ddymunol
- **Lluniau cynnyrch** — os oes gennych gynhyrchion i’w harddangos
...
- **Delweddau trwm o ran testun** — sgrinluniau gyda llawer o destun
...
3. **Cynhwyswch amrywiaeth** — cymysgedd o liw, arddull, a phwnc
...
- **Palet lliwiau** — lliwiau cynradd, eilaidd, ac acen
- **Teipograffeg** — teuluoedd ffont ar gyfer penawdau a thestun corff
- **Arddull gosodiad** — bylchu, aliniad, a threfniant cydrannau
...
1. Adolygwch y cyfeiriad dylunio a gynhyrchwyd
2. Darparwch adborth neu gofynnwch am addasiadau
...
- [Offer a Chyfluniad](./tools.md) — offer sydd ar gael ac opsiynau cyfluniad
