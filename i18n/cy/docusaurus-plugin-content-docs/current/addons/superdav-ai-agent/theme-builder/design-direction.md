...
- **Lliw cynradd** — prif liw brand a ddefnyddir ar gyfer botymau, dolenni, ac acenion
- **Lliw eilaidd** — lliw ategol ar gyfer amrywiaeth
- **Lliw acen** — lliw amlygu ar gyfer elfennau pwysig
...
- **Ffont pennawd** — a ddefnyddir ar gyfer teitlau tudalennau a phenawdau adrannau
- **Ffont corff** — a ddefnyddir ar gyfer testun paragraffau a chynnwys
- **Meintiau ffont** — meintio ymatebol ar gyfer gwahanol feintiau sgrin
...
- **Eiconau** — arddull a maint eiconau
...
- Dewislen lywio lawn
- Cynllun cyflawn gyda'r holl golofnau
...
- Llywio ymatebol (dewislen hamburger)
- Cynllun un golofn
...
| Dyfais | Lled | Rhagolwg |
|--------|-------|---------|
| **Mobile** | 375px | Ffôn portread |
| **Tablet** | 768px | Tabled tirwedd |
...
1. **Addasu lliwiau** — newid unrhyw liw yn y palet
2. **Newid ffontiau** — dewis teipiau gwahanol
3. **Addasu bylchau** — addasu padding ac ymylon
...
- Mae rhagolwg desktop yn diweddaru ar unwaith
- Mae rhagolwg mobile yn diweddaru ar unwaith
...
- **Dyluniad gwreiddiol** — gweld beth newidiodd
...
1. **Adolygu'r ddau ragolwg** — gwirio bod desktop a mobile yn edrych yn dda
2. **Gwirio pob lliw** — sicrhau cyferbyniad a hygyrchedd
3. **Profi teipograffeg** — gwirio darllenadwyedd ar bob maint
...
1. Mae Theme Builder yn cynhyrchu eich theme cyflawn
2. Caiff y theme ei osod ar eich safle WordPress
...
- **Gwirio cyferbyniad** — defnyddiwch [Dilysu Cyferbyniad Palet](../abilities/validate-palette-contrast.md) ar gyfer hygyrchedd
...
- [Dilysu Cyferbyniad Palet](../abilities/validate-palette-contrast.md) — gwirio hygyrchedd lliw
- [Cynhyrchu Logo SVG](../abilities/generate-logo-svg.md) — creu logos personol
