...
Gall dau gais cydamserol ddarllen yr un gwerth a’r ddau ysgrifennu’r un canlyniad cynyddrannol yn ôl, gan golli un cyfrif. Mae `increment_item()` yn dirprwyo’r rhifyddeg i beiriant y gronfa ddata gydag un datganiad `UPDATE ... SET column = column + ?`, gan wneud y gweithrediad yn atomig yn ei hanfod.
