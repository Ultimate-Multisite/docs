---
id: wu_admin_notices
title: Hidlydd - wu_admin_notices
...
| Enw | Math | Disgrifiad |
|------|------|-------------|
| $notices | `array` | Rhestr o hysbysiadau ar gyfer y panel penodol hwnnw. |
| $all_notices | `array` | Rhestr o hysbysiadau a ychwanegwyd, wedi’u gwahanu yn ôl panel. |
| $panel | `string` | Panel i adalw’r hysbysiadau. |
