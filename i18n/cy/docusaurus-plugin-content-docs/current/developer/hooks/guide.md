---
title: Canllaw Defnyddio Bachau
sidebar_position: 1
...
### Cylch Oes Cwsmer {#customer-lifecycle}

#### Ar Ôl Creu Cwsmer {#after-customer-creation}
...
#### Newid Statws Cwsmer {#customer-status-change}
...
#### Ar Ôl Cyhoeddi Site {#after-site-published}
...
#### Cyn Cymhwyso Templed {#before-template-application}
...
#### Trawsnewidiadau Statws {#status-transitions}
...
#### Taliad wedi’i Gwblhau / wedi Methu {#payment-completed--failed}
...
#### Cyn Prosesu / Ar Ôl Cwblhau {#before-processing--after-completion}
...
### Hidlwyr Prisiau {#pricing-filters}

#### Cyfanswm Cert {#cart-total}
...
### Hidlwyr Templed {#template-filters}
...
### Hidlwyr Cyfyngu {#limitation-filters}
...
### Hidlwyr Gateway {#gateway-filters}
...
### Meysydd Ffurflen Checkout {#checkout-form-fields}
