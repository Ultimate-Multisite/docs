---
title: 'Dysgu 8: Cynllunio Cysgodau Client'
sidebar_position: 9
...
- Cyflwyno a gweld safle sy'n dod yn debyg i wefan gymunedol → parhau
- Mewn gwybod cywir beth yw'r cynllun nesaf → parhau
- Teimlo'n dda mewn dashboard WordPress am y tro cyntaf → gadael
...
**FitSite Cynheltu Cyntaf:**

1. **Ymddangos eich enw studio a'r logo eich** -- Cysyllti â setegau Customizer neu gyfarwyddiadau safle
2. **Cyfnewidiwch eich cynllun cyflwyniad** -- Cysyllti'n dros y redactor y peidiad Classes yn uniongyrchol
3. **Ymddangos eich trainwyr** -- Cysyllti â'r redactor y peidiad Trainers
4. **Setwch eich amserau cyfathrebu** -- Cysyllti â'r redactor y peidiad Contact
5. **Gweld eich safle** -- Cysyllti â'r frontend
...
- Gwahanu item menuau na'r golygu i ddefnyddio ar ffurf fitness (e.e., Comments os nad yw'n cael ei defnyddio)
- Reorder y menu i rhoi'r itemau a ddefnyddir yn fwy cyntaf
- Ychwanegu labelau menu byw sydd yn ddefnyddiol ar gyfer y niche ("Dyddstaf Your Studio" yn lle "Appearance")
...
- "Newidi'r logo a gwynion eich studio"
- "Cysylltu eich domain eich hun" (ar gyfer cyddeeion Growth/Pro)
- "Cynllunio widget cyflwyniad ar eich site"
...
- Ymddangos gyntaf a cyflwyniad
- Redig y peiriant
- Newidi'r cynllun cynghrair
- Cynnwys trainwyr newydd
...
- Cynhel eu plan FitSite ar gyferbynnu
- Danglyddu opsiyn cyfathreiddio gyda chynlluniau fitnes
...
- **Cyfradd cyflwyniad (Activation rate)**: Paenyg yr ychwanegau o'r cyfathrebu sy'n gwneud ei ffurfiad ar gyfer y site mewn cyfnod gyntaf?
- **Gysylltiadau yn y cyfnod gyntaf**: Betyn nhw yn y cyfradd newydd yn y cyfnod gyntaf?
...
- **Cyseiliau e-bost** sy'n gwneud y cyflwyniad i'u cyddeeau trwy'r cymeriad gyntaf eu hysbysebu
- **Rhyddau help yn benodol ar gyfer y gweithwyr fithrin** a ddynol ar gweithredol

---

**Manor nesaf:** [Dysgu 9: Prifyniadau i Gwerth] -- byddwn yn gwneud y strategaeth prifyniadau yn ddefnyddio'r cyflymdu cyfrifolion a minyrau chwilio.
