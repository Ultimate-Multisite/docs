---
title: 'Dysgu 2: Mae''n Dechrau eich Niche'
sidebar_position: 3
...
- Mae'r busnesau wedi'u gofyn i gael rhywbeth ar wefan
- Mae’r gymharol o wefanau presennol yn y dyfodol yn dda
- Nid yw'r adeiladu cyffredinol yn dod o hyd i'u angen penodol
- Mae ddatblygiad custom yn rhy ddwfn am gräddiad busnes tyvoeddol
...
- Cynllunol yn ddefnyddio cyfrifolion marcadol
- Mae wedi bod yn gweld am ystyried am y cyflwyniadau software (systemau chwarae, prosessau peidiad, etc.)
- Mae'n gweithio mewn gräddiad lle mae $49-$199/mlynediad yn ddefnyddiol oystyr busnes
...
- Cyfathigion diwygau, cyfarfodydd, neu droseddau cymrydol
- Gymunedol online weithredol (Facebook groups, forwmau, subreddits)
- Cysylltiad lleol lle mae bennwr busnes yn rhannu cyfaddodiadau
...
- Cyfathigion ydynt chi wedi gweithio mewn i neu wedi bod yn llwybr wefan
...
- Chwilio ar Google "[cyfathigion] website builder" a gweld beth mae gennych
- Gweithio mewn forwmau y dyfodol am anwybion am gyflwyniad wefan
...
- **Cyflen yr bazar**: Betyn bennwr sydd mewn tymor hwnnw? (Dechrau gyda'r ble/regi eich gwlad)
...
- Sut wedi cael eich gwefan ar hyn o bryd?
- Beth yw'r hyn syddai ei gallai wneud y mae hi'n gallu, naid oes ganddo?
- Beth ydych chi yn bawb am ei ffurfio ar hyn o bryd?
- Os byddai platformau sydd wedi cael eu llwybr yn cael eu guberdig yn benodol i [ryngweithiau eich niche], byddwch yn hoffus iddo?
...
| Criterion | Assesiad |
|-----------|------------|
| Mae angen gweidiadau | Ydw -- mae'r benodau studio yn amrywiol neu wedi cael eu ddefnyddio |
| Gallai ei chynllunio | Ydw -- mae'n dalu $50-200/mthydw ar gyfer cyddeilio software |
| Siarad â'r uniadau gyda'i gilydd | Ydw -- cymunedau weithredol, digwyddiadau o'r dynged, rhwydweithiau lleol |
| Cyfathrebu | 100,000+ cyfathreg yn yr Unol Daleith yn unig |
| Llandai gweithwyr cynnes | Dim ond ychydig ffurfau benodol sydd ar gael |
...
- **Bwytyr a cafedau** -- menws, cyddeilioi, oriau gweithio, cyfathriadau dylunio
- **Gweithwyr tref** -- cyflwyniadau, profiad gweithwyr, cyfarwyddiadau o'r dyfodol
- **Firmau gyfraith** -- arfaethau gweithredol, profiad y lawrdynwyr, cyddeilioi cynllunio
- **Eglwysion a sefydliadau nad yw yn ffurf** -- digwyddiadau, cerddoriaethau, ddarparu, cymuned |
- **Gweithwyr cyfathrebu** (plumberiau, gweithwyr eletric) -- arfaethau weithredol, cyddeilioi, adolygiadau
- **Salons a spa'r** -- gwasanaethau, cyddeilioi, profiad stylistaid, gallerïau
- **Clinici veterinari** -- gwasanaethau, portau o'r peth, cyddeilioi cyfathregiadau
- **Ysgolion mynediadau** -- profiad y ddealltorion, cynllunio dysgu, wybodaeth am digwyddiadau

Mae pob un o'r hyn yn cael ei gynnwys: angen benodol ar wefan, gallu dalu, a chwarae o'r cymuned.

- **Ffarchnad wybodaeth arallgolygu**: tri cridhentyn i ddarparu unrhyw niche (seiliedig)
- **Methodau cyflwyno/gyfeiriad**: siarad â chwaraeon, analiz y gweithwyr cymrydol, gwastat yr adroddiad (landing page testing)
- **Cyflwyno FitSite**: mae'r estafidiaethau wedi'u cywir yn cynnwys pob un o'r cridhentyn

---

**Manor nesaf:** [Lesiad 3: Cyfluniad y Rwybrach] (lesson-3-setting-up) -- byddwn i chwarae Ultimate Multisite a gyfluniad y cyfnod i FitSite.
