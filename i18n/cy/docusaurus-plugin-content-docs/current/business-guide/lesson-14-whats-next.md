---
title: 'Dysgu 14: Beth sydd ar y cyntaf'
sidebar_position: 15
...
FitSite Network (Cyflen) (Cyflen Comol)
├── Infrastructure
│   ├── WordPress Multisite (moddeynau subdomain)
│   ├── Ultimate Multisite (configwyd + brandoedd)
│   ├── Hosting gyda wildcard SSL + mapiad domenaid
│   └── CDN a caching ar gyfer perfformiad
├── Product
│   ├── Site Templates (Studio Essential, Gym Pro, Fitness Chain)
│   ├── Planau (Starter $49/mth, Growth $99/mth, Pro $199/mth)
│   ├── Prifau blynyddol gyda disgyblhau 20%
│   ├── Cymeriadau setffroi, trialiau a ymdrechion oder
│   └── Codau disgyblhau ar gyfer cyflwyniadau a cyflwyniadau
├── Experience
│   ├── Rheol checydau yn unigol i'r niche
│   ├── Cyflwyniad (login, dashboard, a chymdeithas) gyda brandoedd
│   ├── Onboarding cyfarwydd gyda widget Quick Start
│   ├── Cyfres email gyfeiriadwy
│   └── Gweithgref neu ddefnyddio video walkthroughs
├── Business
│   ├── Cyflwyniad cleiention ar draws 6 chyflenau
│   ├── Estrwyllun cefnogaeth wedi'i cyflwyno mewn trefi
│   ├── Rytmau gweithredol (dyddiol, wythlyd, manwl, cymeriad)
│   ├── Draffio metrefau (MRR, churn, LTV, CAC)
│   └── Automataiddiad drwy webhooks a cyfres email
└── Growth
    ├── Plan ddefnyddio infrastructure arallt
...
- **Ysgolion arfaethau** -- cyflwyniad o llyngau, wybodaeth torriantiau, cyfyngedigau clasa
...
- **Cyfathryd cyflwyniad clasa** -- cyfathryd gynnwys platformau cyfathryd popular
- **Porta chwaraewyr** -- ardal aelodau wedi'u cyflwyno i chwaraewyr gym gyda chyfnodau a resusurau
...
**Clwbau cyfrifol** -- tîmau cyfrifol am ychwanegol, llyngau, clwbau rekreisiol

**Gweithwyr chwaraeiddiol** -- chiropractwyr, physiotherapists, nutritionists
...
1. A yw'n angen eu cyfathoghion web ond mae nhw yn ddatblygu'r gwefan iawn?
2. Gallant nhw ei chynllunio cyflwyniad manwl (subscription) am gyfnod?
3. Oesau nhw gyda'i gilydd?

Mae angen i bob niche newydd:

- Newid ffurfau wedi'u ddefnyddio ar gyfer y dyfodol
- Newid cysylltiadau cynllunio yn adeiladu'r angen y niche
- Newid cyflymion caisau a chyflwyniad newydd
- Newid cynnwys cynllunio a gwybodaeth cefnogaeth
...
- `fitsite.com` -- styddiadau fitness
- `menusite.com` -- bwytyrniaid
- `lawsite.com` -- firmau cyfreithas
...
FitSite gyda 200 cleient yn $89 ARPU:

- **MRR**: $17,800
- **ARR**: $213,600
- **Cyfrg bawchais allweddol**: $640,000 - $1,068,000
...
1. **Bwyso un niche** gyda phrychiadau glir, gallu ystyried eu cyfrifoldeb, a chymuned.
2. **Gofal/Gwylio** قبل y ddatblygiad.
3. **Tegyn ffurfwrdd wedi'i gael** gyda templateau, cynlluniau, a brandwidiadau penodol i'r niche.
4. **Creu profiad heb chwarae** o'r cyfrifoldeb i'r ychwanegu (onboarding).
5. **Cyfrif am gwerthfawr** gyda llyfrgellau strategol, tystiolaethau (trials), a ddisgyblhau.
6. **Gweithredu yn llwybr** gyda chwarae soft launch a checklist.
7. **Cyfrif cleientau** drwy gyfeiriadau penodol i'r niche.
8. **Rannu gweithredoedd** gyda rhutiau ddefnyddiol.
9. **Gwellt** y ffurfwrdd, cyfrifau, a'r tîm gan fod yn ddigwydd.
...
Yn ddylesg y orffennwg hwnnw. Y cyfnodau mwyaf da yn gyfrif yw hi.
