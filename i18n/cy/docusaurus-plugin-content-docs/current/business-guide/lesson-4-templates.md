---
title: 'Dysgu 4: Gynllunio Templa Niche'
sidebar_position: 5
...
Rydyn rheolwr studio ffitnes sy'n cyflwyno i FitSite yn weld:

- Peïaedd gartref (homepage) sy'n edrych fel wefan studio ffitnes
- Peïaedd ar gyfer clasau, rhaglenni, trainwyr, a prifau
- Lluniau a cynnwys canol sy'n ddatblygu gyda'u dyfodol
- Dylun sy'n teimlo yn proffesiynol ac yn cyflwyno'r brand ffitnes
...
- **Pejyn Homepage** gyda pwyllgor, sylwion clasa, a cyfal cyflwyno
- **Pejyn Am ystod** gyda stori'r estud a'r misyn
- **Pejyn Clyswyddogaethau** gyda llwybr o darluniau amser
- **Pejyn Trainwyr** gyda chardau profiadau
...
- Clywed yr holl ddefnyddiau yn Studio Essential, plus:
- **Pejyn Cyfathrebu** gyda tablaw preniau
- **Pejyn Galleri** ar gyfer ffotos y cyfleusterau
...
- Clywed yr holl ddefnyddiau yn Gym Pro, plus:
- **Pejyn Lleoliadau** gyda llywio ffasiadau cyfleusterau aml
- **Templat peiriant/lleoliad** o subpeiriant
...
1. Actiwaiad un thema sy'n busol i gweithredau fithresigol
2. Cyfluniad y setegau y thema, y lliwiau a'r tyngeddiant
3. Cyfluniad y header a'r footer gyda nawigatiwn i ddefnyddio yn gweithredol

:::tip Dechreuwch y thema
...
- **Cynnwys cyflwyniad** sydd yn ddefnyddiol ar gyfer fithresigol ("Bwynch yn [Enw Studio]") nid "Lorem ipsum"
- **Imagedau cynnwys** o safonau ffotgo freifol sydd yn dangos gweithredau fithresigol
- **Cyfluniadau ffurfiol** gan ddefnyddio'r page builder neu'r block editor
...
- Un plugin o ddefnyddio neu cyfluniad (os yw'n cywir i eich cynnig plan)
...
3. Cyfluniad y toggel **Site Template**
...
- [ ] Mae pob dudalen yn lladd yn dda ac yn edrych yn proffesiynol
- [ ] Mae cynnwys lleol (placeholder content) yn helpu a yn cywir i'r niche
- [ ] Mae'r amgylcheddau yn ddefnyddiol ac yn cael eu llwybr yn iawn
- [ ] Mae ychwanegiad mobail yn gweithredu arall pob dudalen
- [ ] Mae'r cyd-gyfeiriad yn logol a gyflawn
- [ ] Mae ffurfau cyfathogh yn gweithredu
...
├── Hosting gyda wildcard SSL
├── Domain mapping configwyd
├── Site Templates
│   ├── Studio Essential (studiadau bach, trainwyr)
│   ├── Gym Pro (gymau wedi'u llwybr)
│   └── Fitness Chain (llawer lleoliadau amgylcheddol)
...
- **Cynnwys lleol addysgu** sy'n cyfarwyddo cyd-gyfeiriadau i'r cyd-gyfathrebu
- **Gwylch ychwanegau** i sicrhau bod y templat yn barod i'r proddection

---

**Nesaf:** [Dysgu 5: Cynllunio eich Planau](lesson-5-plans) -- byddom ni creu tairon o produs (product tiers) sy'n cyfathri â sut mae busnesau ffitnes yn gweithredu mewn gwirionedd.
