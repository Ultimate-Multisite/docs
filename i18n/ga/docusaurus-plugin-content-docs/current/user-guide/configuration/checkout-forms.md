...
#### Oibríocht Editor Fómród Checkout
...
### An Fhóláil Tágráid (The Pricing Table Field)
...
#### Step 1: Déan ar fáil Price Variations ar do Producath
...
#### Step 2: Añadh an Period Selection Field ar do Corm Cheicinn
...
#### Step 3: Posíonadh an Fíel Above the Pricing Table
...
#### Conas Tá Éifeachtach Ar an Frontend
...
#### Pre-selectáil Ar Chuid URL via URL
