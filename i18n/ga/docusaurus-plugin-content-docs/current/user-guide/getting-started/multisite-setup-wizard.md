...
### Tairgseán Ngrúpaí (Network Title)
...
### Email Admin Ngrúpaí (Network Admin Email)
...
## Step 3: Installation (An tAonlaíocht)
...
### Tá wp-config.php gan cur isteach (not writable)
...
### Níl na siteanna ag cur isteach tar éifeachtach (subdomains)
...
### Probleanna cúilte tar éifeachtach tar éifeachtach
