...
### 1. Déan do Chuid API Credentials Cloudways
...
### 2. Déan do Server ID agus Application IDs
...
### 4. Fáilteadh an Iompair (Enable the Integration)
...
## Conas Tá Sé Ag Réiteach (How It Works)

### Synchriú Domáin (Domain Syncing)
...
### Cur na Certs SSL (SSL Certificate Management)
...
### Cloudways SSL setup cur chuig ar bhealach do ngrú Ultimate Multisite
