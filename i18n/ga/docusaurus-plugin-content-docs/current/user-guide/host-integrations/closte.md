...
## Instructiona Cuidiúcháin (Setup Instructions) {#setup-instructions}

### 1. Déan cinnte de do Closte API Key {#1-verify-your-closte-api-key}
...
### 2. Fáilte an cur chuimhne (Enable the Integration) {#2-enable-the-integration}
...
## Conas Tá Sinteacht Ag Réiteach (How It Works) {#how-it-works}
...
## Creach Domáin (Domain Record Creation) {#domain-record-creation}
...
## Curteála (Troubleshooting) {#troubleshooting}

### Problemaí le Cónáiste API {#api-connection-issues}
...
### Problemaí le Sertificat SSL {#ssl-certificate-issues}
...
### Domán Níl Curtha Ar Fáil {#domain-not-added}
...
### Taispeántacht Cónáiste DNS {#dns-check-interval}
