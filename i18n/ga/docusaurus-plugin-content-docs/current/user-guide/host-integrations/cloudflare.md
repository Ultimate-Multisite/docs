...
## Instructionaí Déanála {#setup-instructions}

### 1. Déan an t-Aipkey Cloudflare {#1-get-your-cloudflare-api-key}
...
### 2. Déan an t-Zone ID {#2-get-your-zone-id}
...
### 4. Fáil an Iompairte {#4-enable-the-integration}
...
### Cur na Subdomains {#subdomain-management}
...
### Déan na Record DNS {#dns-record-display}
...
### Conas é seo ag déanamh é freisin ná cur chuireann isteach chuẩn {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Déan Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
## Note ag cur isteach {#important-notes}
...
### Cúsaí ar connadh API {#api-connection-issues}
...
### Níl an subdomain ag cur isteach {#subdomain-not-added}
...
### Probleanna Proxy {#proxying-issues}
