...
- **Customer-owned** — Siteacha a bhaineann le custaimerí a bhfuil siad ag iarraidh
...
- **Site Title** — An t-ainm an siteach nua
- **Site URL** — An domain/path atá ag siteach
- **Site Type** — An chuid sinte, má tá sé siteach custaimer, template, nó siteach ríamhach
...
- **Visit limits** — An n-amhsar as an chuid siteach
- **User account limits** — An lúthas ar chuid rôl úsáideach
- **Disk space** — An tairgseacht stóras ar an siteach
- **Custom domain** — Aistriú domain chun cur isteach leat ar an siteach sinte
- **Plugin and theme visibility** — Cur áimneas ar na plugin agus na themeacha atá ag cur isteach, a bheith ag cur isteach, nó ag cur isteach arís

Goile, an t-amhail, na siopaí a thugann ar fáil:
...
- **Domainaí a chiallaíonn** a chiallaíonn an siopa
...
- **Chruinneáil/Anailís an siopa** le cur chuimní (toggle button)
- **Athchruinneáil an t-amhail an siopa** nó athchruinneáil ealaíocht (ownership)
- **Taispeántas an siopa/thumbnail** a chur ar fáil (a bhfaidh sé a bheith ag an chuid a bhfostacha do templaí siopa)
- **Déanamh an siopa** go léir

:::warning
Is é an t-amhail an siopa go léir. Beidh an siopa agus an cur chuimní ar fáil go léir ag déanamh amach go léir.
:::
