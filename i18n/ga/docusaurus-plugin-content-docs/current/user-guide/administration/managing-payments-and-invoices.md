---
title: Tríocht ar Paymeanta agus Faoisnéisí
sidebar_position: 15
...
Seo an fhoisteán láimhseallta de seachtain peleála:
...
- **Currency** — An cur le chéile a úsáidtear chun tráchtála
- **Currency Position** — Cén fáth a bhfáine an chuid le chéile (i dtreo/tar éifeachtach an amont)
...
Tá portail atá ar fáil:

- **Stripe** — Peleála card le Stipe
- **PayPal** — Peleála PayPal
- **Manual** — Do chuid chur i bhfeicliú ó chuid féin nó chun peleála a bheith ag cur in áit

Tá chéad aistriúcháin a bheith agat a chomhraithe ar chuid aistriúcháin a bheith agat.
...
Leat ag fílteadh peleála ar stáit (comhlaithe, ag teacht, leathmaithe, leatairt) agus chun tráchtála a bheith agat a chur i bhfeicliú.
...
Tá oupadas chothromú ar an foirme láithreacha ag cur iechóg:

- **An ainm agus an áit na fuirí** a shlonnadh ar an foirme láithreacha
- **Foirme nualachais** agus siomraidh (sequence)
- **Lóg** a shlonnadh ar an oifneáil ar an foirme láithreacha
- **Teastaí footer a chothromú** chun téarmaí, nótaí, nó leanaisfeacht a bheith ar an foirme

Leat a chothromú an foirme láithreacha, cur isteach i **Ultimate Multisite → Settings → Payment** agus leiceáil ar na rathacha a bhaineann leis an foirme.
