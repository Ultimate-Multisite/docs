---
title: Curmhaíochta E-mailí Sistéimaithe
sidebar_position: 13
...
Mar sin féin, leat é a bheith ag cur isteach ar an curteoir **System Emails** chun an talamh na réiteach emailí a fheiceáil.

![System Emails list](/img/admin/system-emails-list.png)

Is féidir leat hefyd athrú individual email templates a bheith agat trí d'email editor sistim:
...
Chun inneadh new email templates:

1. Déan cur isteach ar an curteoir **System Emails**
2. Cliceáil ar an nútair **Reset & Import** ar an áit uisce seo
...
1. **Déan agus inneadh ar ais** — Déan an email sistim agus inneadh é againn (is é seo a bhfáthfaidh métrica send)
2. **Athrú trí an curteoir** — Use an curteoir **Reset & Import**, athrú an option **Reset**, agus déan seirbhísí a bhfuil tú ag athrú ar ais
