...
## Instruction a Chúsaíocht

### 1. Fáilte an API CyberPanel
...
### 2. Add Constants ar wp-config.php
...
## Conas Tá É seo Ag Réiteach

### Domain Mapping (Mapeadh Domáina)
...
### Email Forwarders (Foirmeanna E-mail)
...
## Cúram Fhinn (Configuration Reference)
