...
## Rochtain ar Shocruithe {#accessing-settings}

1. Sa riarthóir WordPress, téigh chuig **Gratis AI Agent → Socruithe**.
2. Cliceáil an cluaisín **Ardleibhéal**.

## Cumraíocht Chríochphointe Aiseolais {#feedback-endpoint-configuration}
...
### Ualach JSON a bhfuiltear ag súil leis {#expected-json-payload}
...
### Luachanna `triage_category` {#triagecategory-values}
...
### Bailiú Aiseolais a Dhíchumasú {#disabling-feedback-collection}
...
## Seirbhís Bhainistithe Superdav {#managed-superdav-service}
...
## Cumraíocht Google Calendar {#google-calendar-configuration}
...
## Fógraí SMS TextBee {#textbee-sms-notifications}
...
## Bratacha Gnéithe {#feature-flags}
...
### Rochtain ar Bhratacha Gnéithe {#accessing-feature-flags}

1. Sa riarthóir WordPress, téigh chuig **Gratis AI Agent → Socruithe**.
2. Cliceáil an cluaisín **Bratacha Gnéithe**.

### Bratacha Rialaithe Rochtana {#access-control-flags}
...
### Bratacha Brandála {#branding-flags}
...
### Bratacha Sábháilteachta Uathoibrithe {#automation-safety-flags}
...
### Athruithe a Chur i bhFeidhm {#applying-changes}
