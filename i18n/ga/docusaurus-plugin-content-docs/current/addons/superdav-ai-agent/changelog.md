...
- **Geataí faofa daonna agus taifid mheabhrúcháin** — cuir uathoibrithe ar sos le haghaidh athbhreithnithe agus seachain fógraí dúblacha
...
- **Cumas Validate Palette Contrast** — seiceáil péirí dathanna le haghaidh comhlíonta WCAG sula gcuirtear i bhfeidhm ar théama iad
- **Biachláir fáilteachais** — is féidir le Theme Builder leathanaigh bhiachláir struchtúrtha bia agus dí a ghiniúint anois do ghnólachtaí fáilteachais
- **Rindreáil réamhamhairc deisce agus móibíleach** — réamhamharc ar do dhearadh ar ghléasanna deisce agus móibíleacha le linn roghnú treo dearaidh
...
- **Orduithe WP-CLI** — athchóiríodh ailiasanna namespace a bhí ar iarraidh tar éis athstruchtúrú roimhe seo
- **Uathoibriú imeachtaí** — láimhseálann sé go galánta suímh nach bhfuil táblaí uathoibrithe cruthaithe iontu fós
- **cumas memory-save** — úsáideann sé anois an réimír namespace cheart i dtógálaí na treorach córais
- **Torthaí uirlise scálacha** — filltear iad anois i gceart sula gcuirtear ar ais chuig an AI iad
- **Staitisticí úsáide** — láimhseálann siad anois formáid oidhreachta eochair an chumais i gceart agus uasghrádú á dhéanamh ó leaganacha níos sine
