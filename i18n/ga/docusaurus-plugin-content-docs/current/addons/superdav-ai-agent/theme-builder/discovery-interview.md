...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Molta do ghrianghraif |
| **PNG** | `.png` | Tacaíonn sé le trédhearcacht |
...
- **Pailéad dathanna** — baintear dathanna ceannasacha amach agus úsáidtear iad sa téama
- **Stíl amhairc** — nua-aimseartha, tuaithe, íostach, bríomhar, srl.
- **Giúmar agus atmaisféar** — gairmiúil, cruthaitheach, cairdiúil, sómasach, srl.
...
- **Cláir ghiúmair** — bailiúcháin íomhánna a léiríonn an aeistéitic atá uait
- **Grianghraif táirgí** — má tá táirgí agat le taispeáint
...
- **Íomhánna trom ar théacs** — seatanna scáileáin le go leor téacs
...
3. **Cuir éagsúlacht san áireamh** — meascán de dhath, stíl, agus ábhar
...
- **Pailéad dathanna** — dathanna príomhúla, tánaisteacha, agus béime
- **Clóghrafaíocht** — teaghlaigh chló do cheannteidil agus do théacs coirp
- **Stíl leagan amach** — spásáil, ailíniú, agus socrú comhpháirteanna
...
1. Athbhreithnigh an treo deartha a gineadh
2. Soláthair aiseolas nó iarr coigeartuithe
...
- [Uirlisí agus Cumraíocht](./tools.md) — uirlisí agus roghanna cumraíochta atá ar fáil
