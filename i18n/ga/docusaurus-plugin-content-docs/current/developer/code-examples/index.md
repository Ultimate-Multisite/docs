...
Is féidir le dhá iarratas comhuaineacha an luach céanna a léamh agus an toradh incrimintithe céanna a scríobh ar ais araon, rud a chailleann comhaireamh amháin. Tarmligeann `increment_item()` an uimhríocht chuig inneall an bhunachair sonraí le ráiteas aonair `UPDATE ... SET column = column + ?`, rud a fhágann go bhfuil an oibríocht adamhach ó nádúr.
