...
title: Scagaire - wu_wp_config_reference_hook_line_patterns
...
Sainithe in [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) ag líne 143
