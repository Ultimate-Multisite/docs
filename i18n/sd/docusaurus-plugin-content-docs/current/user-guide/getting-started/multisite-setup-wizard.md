...
## ویزارد ڪهڙي وقت ظاهر ٿئي ٿو؟ {#when-does-the-wizard-appear}
...
## قدم 3: تنصيب (Installation) {#step-3-installation}
...
## قدم 4: مکمل کریں (Complete) {#step-4-complete}
...
### विज़ार्डले भन्छ कि wp-config.php लेख्न सकिँदैन {#the-wizard-says-wp-configphp-is-not-writable}
