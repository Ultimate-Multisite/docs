...
---
# بنیادی تصورات (Basic Concepts) {#basic-concepts}
...
## سوپير اڊمن (Super Admin) {#super-admin}
...
## سائٽ ٽيمپليٽ (Site Template) {#site-template}
...
## دومين مپنگ (Domain Mapping) {#domain-mapping}
...
## अल्टीमेट मल्टीसाइट (Ultimate Multisite) {#ultimate-multisite}
