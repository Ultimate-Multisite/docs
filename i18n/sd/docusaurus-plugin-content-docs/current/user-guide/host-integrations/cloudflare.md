...
### ১. আপনার ক্লাউডফ্লেয়ার API কী সংগ্রহ করুন (Get Your Cloudflare API Key)
...
### ২. আপনার জোন আইডি সংগ্রহ করুন (Get Your Zone ID)
...
### ৩. wp-config.php এ কনস্ট্যান্ট যোগ করুন (Add Constants to wp-config.php)
...
### ৪. ইন্টিগ্রেশন সক্ষম করুন (Enable the Integration)
...
### DNS رڪڊ جو ڏيکاري (DNS Record Display)
...
### اسان standard Cloudflare integration کان فرق ڪي ٿو
...
### Cloudflare Custom Hostnames کي ترتیب ڏيڻ (Setting up)
...
## گهريلو مسئلا حل ڪرڻ (Troubleshooting)
...
### پراڪسي جي مسئلا (Proxying Issues)
