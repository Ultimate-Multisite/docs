...
### دومين سنڪرائس (Domain Syncing) {#domain-syncing}
...
### ਡੋमेन ਹਟ ਕਰਨਾ (Domain Removal) {#domain-removal}
...
### API ਪ੍ਰਮਾਣਿਕਤਾ (API Authentication) {#api-authentication}
...
## ਟ੍ਰਬੂਲਸ਼ੂਟਿੰਗ (Troubleshooting) {#troubleshooting}

### API ਕਨੈਕਸ਼ਨ ਦੇ ਮੁੱਦੇ (API Connection Issues) {#api-connection-issues}
...
### SSL ਸਰਟੀਫਿਕੇਟ ਦੇ ਮੁੱਦੇ (SSL Certificate Issues) {#ssl-certificate-issues}
...
### ਡੋमेन ਜੋੜਿਆ ਨਹੀਂ ਗਿਆ (Domain Not Added) {#domain-not-added}
