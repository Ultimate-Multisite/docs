...
## ترتیب ڏيڻ جي تعليمات {#setup-instructions}
...
### 4. Integration Enable गर्नुहोस् {#4-enable-the-integration}
...
### Addon Domains (اضافي دوميني) {#addon-domains}
...
### Subdomains (سڀ دوميني) {#subdomains}
...
## Troubleshooting (مسئلي حل) {#troubleshooting}

### API Connection Issues (API جو رابطو جي مسئلن) {#api-connection-issues}
...
### دامن شامل نه ٿيو {#domain-not-added}
