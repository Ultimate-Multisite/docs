...
## Prerequisites (پہلا قدم) {#prerequisites}
...
## Requirements (ضروري معلومات) {#requirements}
...
### API कनेक्शन अस्वीकृत (API Connection Refused) {#api-connection-refused}
...
### डोमेन सिर्जना भएन (Domain Not Created) {#domain-not-created}
...
### SSL प्रमाणपत्र जारी भएन (SSL Certificate Not Issued) {#ssl-certificate-not-issued}
