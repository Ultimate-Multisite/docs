...
## एउटा साइट एक्सपोर्ट गर्ने (Exporting one site) {#exporting-one-site}
...
## पूरा नेटवर्क एक्सपोर्ट गर्ने (Exporting the whole network) {#exporting-the-whole-network}
...
#### नेटवर्क इम्पोर्ट बन्डल्स बनाउने (Generating a Network Import Bundle) {#generating-a-network-import-bundle}
...
## خود چبوڻ واري export ZIP نصب ڪرڻ (Installing a self-booting export ZIP) {#installing-a-self-booting-export-zip}
