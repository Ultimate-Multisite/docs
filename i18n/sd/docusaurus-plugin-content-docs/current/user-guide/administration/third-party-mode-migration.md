...
### آٹو موڈ (نیا ڈیفالٹ) {#auto-mode-new-default}
...
### اڊمن پینل (Admin Panel) ذريعي {#via-admin-panel}
...
## پنهنجي موڊ کي بدلائڻ {#changing-your-mode}
...
## Auto Mode جا فائدے (Benefits of Auto Mode) {#benefits-of-auto-mode}

### خود بخود گهرجي ٿي (Automatic Discovery) {#automatic-discovery}
...
### ناتيوي انتغالي (Native Integration) {#native-integration}
...
### سڌي انتظام (Simplified Management) {#simplified-management}
...
## Migration Path (انتقال جو رستو) {#migration-path}
...
### मेरो कस्टम صلاحیتون ڏسڻ ۾ نه آڻيندي {#my-custom-abilities-arent-showing}
...
## Backward Compatibility (پچھلا مطابقت) {#backward-compatibility}
...
### Deprecation Timeline (برداري کا وقت) {#deprecation-timeline}
...
## Best Practices (سٺا عمل) {#best-practices}
