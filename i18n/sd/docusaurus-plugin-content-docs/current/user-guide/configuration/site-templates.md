...
## سائيٽ टेम्प्लेट के آهي؟ {#what-is-a-site-template}
...
## هڪ نئين سائيٽ टेम्प्लेट کي ٺاهڻ ۽ هوڙڻ (Creating and Editing a new Site Template) {#creating-and-editing-a-new-site-template}
...
### उन्नत विकल्प (Advanced Options) {#advanced-options}
...
#### موڊ 2: موجود سيتن ٽيمپليٽ چونڊيو {#mode-2-choose-available-site-template}
...
### Default Mode: Checkout form تي سائٽ ٽيمل جو انتخاب {#default-mode-site-template-selection-on-the-checkout-form}
...
### سائٹ ٹیمپلیٹ کے آپشنز (Site Template Options) {#site-template-options}
...
#### ٹیمپلیٹ سوئچنگ کی اجازت دیں (Allow Template Switching) {#allow-template-switching}
...
#### صارف کي پنهنجي سائٽ کي ٹیمپلیٽ طور استعمال کرنے کی اجازت دیں (Allow Users to use their Site as templates) {#allow-users-to-use-their-site-as-templates}
...
#### ٹیمپليٹ डुپلڪي پر ميڊيا ڪاپي ڪريو (Copy Media on Template Duplication) {#copy-media-on-template-duplication}
...
#### **سرچ انجن کي سائٹ ٹیمپلیٽن انڊڪس ڪرڻ کان روڪيان (Prevent Search Engines from indexing Site Templates)** {#prevent-search-engines-from-indexing-site-templates}
...
## آٽو سرچ-آندريپلیس سان سائٹ ٹیمپلیٽن کي پُر ڪرڻ (Pre-populating Site Templates with auto search-and-replace) {#pre-populating-site-templates-with-auto-search-and-replace}
...
### "ٽيمپليٽ هيلڊرن جو مليو" مسئلو حل ڪرڻ {#solving-the-template-full-of-placeholders-problem}
