...
#### چڪڙ (Checkout Form Editor) جو خلاصو
...
### چڪڙ فارم کي سنڀالڻ (Editing a Checkout Form)
...
### پرائسنگ ٹیبل فیلڈ (The Pricing Table Field)
...
#### قدم 1: پنهنجي پروڊڪٽس تي Price Variations ترتیب ڏيو
...
#### سٹیپ ۳: فیلڈ کو پرائسنگ ٹیبل کے اوپر رکھیں
...
#### فرنٹ اینڈ پر یہ کیسے کام کرتا ہے
...
#### URL کے ذریعے بلنگ پیریڈ کا پہلے سے انتخاب کرنا
...
### ٹیمپلیٹ سلیکشن فیلڈ (The Template Selection Field)
...
#### هيٺ ڏنل طرح ڪيئن ڪم ڪري ٿو (How it works)
...
#### فیلڊ کي ختم ڪرڻ (Removing the field)
