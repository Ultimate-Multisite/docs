...
## ڊزائن جي سمت جا جزا {#design-direction-components}

### 1. رنگن جي پيلٽ {#1-color-palette}
...
### 3. ترتيب ۽ فاصلو {#3-layout-and-spacing}
...
## پنهنجي ڊزائن کي بهتر ڪرڻ {#refining-your-design}
...
### Preview اپڊيٽس {#preview-updates}
...
## ڊزائن جي سمت جي منظوري {#design-direction-approval}
...
### Preview اپڊيٽ نه پيو ٿئي {#preview-not-updating}
