...
### 1. منصوبي جي ٺاهه {#1-plan-generation}
...
### 3. منصوبي جو عملدرآمد {#3-plan-execution}
...
### 4. اڳڀرائي ٽريڪ ڪرڻ {#4-progress-tracking}
...
## Site Plan صلاحيتون {#site-plan-abilities}
...
## WP-CLI پلان ڪمانڊز {#wp-cli-plan-commands}
