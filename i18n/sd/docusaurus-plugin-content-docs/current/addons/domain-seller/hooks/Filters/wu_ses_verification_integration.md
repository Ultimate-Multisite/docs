...
فلٽر: ٻين code کي SES انٽيگريشن آبجيڪٽ مهيا ڪرڻ جي اجازت ڏئي ٿو.
...
| نالو | قسم | وضاحت |
|------|------|-------------|
| $integration | `object\|null` | SES انٽيگريشن آبجيڪٽ، يا null. |
...
[`inc/class-ses-verification-manager.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-domain-seller/blob/main/inc/class-ses-verification-manager.php#L731) ۾ لائن 731 تي بيان ٿيل
