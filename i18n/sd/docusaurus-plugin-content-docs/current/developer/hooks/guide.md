---
title: هوڪس جي استعمال جي رهنمائي
sidebar_position: 1
...
### گراهڪ جي زندگي چڪر {#customer-lifecycle}
...
#### سانچو لاڳو ڪرڻ کان اڳ {#before-template-application}
...
#### حالت جون منتقليون {#status-transitions}
...
### ادائگي Hooks {#payment-hooks}

#### ادائگي مڪمل ٿي / ناڪام ٿي {#payment-completed--failed}
...
### چيڪ آئوٽ Hooks {#checkout-hooks}

#### عمل کان اڳ / مڪمل ٿيڻ کان پوءِ {#before-processing--after-completion}
...
### سانچو Filters {#template-filters}
...
### حد بندي Filters {#limitation-filters}
...
### گيٽ وي Filters {#gateway-filters}
...
### چيڪ آئوٽ فارم جا خانا {#checkout-form-fields}
