...
## ٽيننٽ bootstrap وهڪرو {#tenant-bootstrap-flow}
...
## خودمختيار customer action URLs {#sovereign-customer-action-urls}
...
## لڏپلاڻ جي تصديق {#migration-verification}
...
## ٽيننٽ deletion {#tenant-deletion}
