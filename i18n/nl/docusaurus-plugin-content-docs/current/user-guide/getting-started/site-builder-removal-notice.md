---
title: Verwijderingsmelding Site Builder Mode
sidebar_position: 19
...
- Het creëren van sites vanuit templates
- Het configureren van basisinstellingen
...
- Een flexibelere, agent-geleide opzet
- Betere thema-aanpassingsopties
...
1. Vraag: "Help me set up a new site"
2. De Setup Assistant agent begeleidt u bij:
   - Het doel en de doelen van de site
   - Het doelpubliek
   - De merkidentiteit
   - De thema-generatie
...
1. U kunt deze gewoon blijven gebruiken
2. Om het thema te updaten, vraag: "Redesign my site"
...
1. Vraag: "Change my theme"
2. De Setup Assistant agent zal:
   - Vragen naar uw ontwerppreferenties
...
1. Vraag: "Help me set up a new site"
2. Beschrijf het doel en het ontwerp van uw oorspronkelijke site
...
1. Controleer of uw thema nog steeds actief is
2. Controleer of uw plugins ingeschakeld zijn
...
- Uw bestaande sites blijven werken
...
- **Site Specification Skill**: Definieer de doelen en het publiek van uw site
- **Design System Aesthetics Skill**: Verfijn de visuele identiteit van uw site
