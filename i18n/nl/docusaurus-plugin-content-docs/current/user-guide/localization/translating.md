---
title: Vertalen van Ultimate Multisite
sidebar_position: 19
...
Dit is het standaard WordPress-community vertaalplatform. Wanneer vertalingen een voldoende goedkeuringsdrempel bereiken, worden ze automatisch verspreid naar alle Ultimate Multisite-gebruikers via WordPress plugin updates.

**We hebben uw hulp nodig!** Als u een taal spreekt die niet Engels is, overweeg dan om vertalingen bij te dragen. Zelfs het vertalen van een paar strings helpt. Om te beginnen:

1. Bezoek [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Selecteer uw taal
3. Klik op 'Contribute Translation'
4. U heeft een gratis WordPress.org-account nodig
...
1. Download Poedit vanaf [poedit.net](https://poedit.net)
2. Open het `.pot`-bestand vanuit `wp-content/plugins/ultimate-multisite/lang/`
3. Vertaal de strings in de Poedit-interface
