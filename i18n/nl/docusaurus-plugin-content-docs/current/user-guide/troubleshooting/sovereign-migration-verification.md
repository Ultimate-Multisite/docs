...
### Databasegrants komen niet overeen met de host
...
### Bedrock of lokale installs kunnen niet verbinden
...
### De asynchrone push wachtrij wordt niet geleegd (drain)
...
### Het aantal gebruikers van de tenant is verkeerd
