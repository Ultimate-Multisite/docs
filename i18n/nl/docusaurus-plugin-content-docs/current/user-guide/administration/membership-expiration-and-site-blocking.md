...
## Levenscyclus van het lidmaatschap
...
### Hoe lidmaatschappen overgaan naar verlopen
...
#### Auto-vernieuwende versus niet-auto-vernieuwende lidmaatschappen
...
### Wat bezoekers zien wanneer een site geblokkeerd is
...
### Wat en wanneer wordt geblokkeerd
...
## Probleemoplossing: Sites blijven toegankelijk na expiratie
...
### 1. Controleer of de instelling Block Frontend Access is ingeschakeld
...
### 2. Controleer de Frontend Block Grace Period
...
### 3. Bevestig dat de lidmaatschapstatus daadwerkelijk is veranderd
...
### 4. Controleer of Action Scheduler draait
...
### 5. Controleer op Webhook-problemen van de Gateway (Auto-vernieuwende lidmaatschappen)
...
### 6. Controleer de Expiratiegratieperiode (Cron Niveau)
...
### 7. Handmatig een lidmaatschap laten verlopen
