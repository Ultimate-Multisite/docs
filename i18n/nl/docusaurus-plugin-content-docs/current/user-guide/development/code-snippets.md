...
## De positie van het Account-menu-item wijzigen
...
## Controleren of de gebruiker onder een bepaald pakket valt en/of een actief abonnement heeft
...
## CORS-problemen met Font-Icons in gekoppelde domeinen oplossen
## CORS-problemen met Font-Icons in gekoppelde domeinen oplossen
