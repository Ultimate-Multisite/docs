...
Filters de ID van het plan om te controleren. Als dit bestaat, zal het nieuwe abonnement dit plan gebruiken.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $plan_id | `string` | ID van het Stripe-plan om te controleren. |
