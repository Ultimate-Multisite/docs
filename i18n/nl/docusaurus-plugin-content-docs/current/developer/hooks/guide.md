...
## Actie Hooks {#action-hooks}

### Klantlevenscyclus {#customer-lifecycle}

#### Na Klantcreatie {#after-customer-creation}
...
#### Klantstatusverandering {#customer-status-change}
...
#### Na Site Gepubliceerd {#after-site-published}
...
#### Voor Template Toepassing {#before-template-application}
...
### Lidmaatschap Hooks {#membership-hooks}

#### Statusovergangen {#status-transitions}
...
#### Betaling Voltooid / Mislukt {#payment-completed--failed}
...
### Prijsfilters {#pricing-filters}

#### Winkelwagen Totaal {#cart-total}
...
### Beperkingsfilters {#limitation-filters}
