...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Aanbevolen voor foto's |
| **PNG** | `.png` | Ondersteunt transparantie |
...
- **Kleurpalet** — dominante kleuren worden geëxtraheerd en gebruikt in het thema
- **Visuele stijl** — modern, rustiek, minimalistisch, levendig, etc.
- **Sfeer en uitstraling** — professioneel, creatief, vriendelijk, luxueus, etc.
...
- **Moodboards** — collecties van afbeeldingen die uw gewenste esthetiek vertegenwoordigen
- **Productfoto's** — als u producten wilt tonen
...
- **Tekstzware afbeeldingen** — screenshots met veel tekst
...
3. **Voeg variatie toe** — een mix van kleur, stijl en onderwerp
...
- **Kleurpalet** — primaire, secundaire en accentkleuren
- **Typografie** — letterfamilies voor koppen en bodytekst
- **Lay-outstijl** — witruimte, uitlijning en componentarrangement
...
1. Bekijk de gegenereerde ontwerkreichting
2. Geef feedback of vraag om aanpassingen
...
- [Tools and Configuration](./tools.md) — beschikbare tools en configuratieopties
