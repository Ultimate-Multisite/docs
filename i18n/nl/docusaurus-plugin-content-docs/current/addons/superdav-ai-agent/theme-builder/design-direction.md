...
- **Verifieer het contrast** — gebruik [Validate Palette Contrast](../abilities/validate-palette-contrast.md) voor toegankelijkheid
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — controleer kleurtoegankelijkheid
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — creëer aangepaste logo's
