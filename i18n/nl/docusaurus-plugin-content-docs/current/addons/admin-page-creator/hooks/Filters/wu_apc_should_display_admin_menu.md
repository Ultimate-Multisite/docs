...
Sta beheerders toe om de adminmenu-pagina's te verbergen, als ze het aanpassingsproces hebben voltooid.

## Parameters {#parameters}

| Naam | Type | Beschrijving |
|------|------|-------------|
| $should_display_admin_menu | `bool` | Moeten we de pagina's weergeven? |
| $network_active | `bool` | Controleer of de plugin actief is als netwerkbeheerder. |
