...
Stelt ontwikkelaars in staat een pluginlijst te beheren die mogelijk uitgesloten kan worden van de gegenereerde zip.

## Parameters

| Name | Type | Description |
|------|------|-------------|
| $plugin_list | `array` | De plugins die uitgesloten zullen worden. |
