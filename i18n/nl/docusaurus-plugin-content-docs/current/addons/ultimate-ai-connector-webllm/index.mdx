...
## Vloeiend Chatwidget {#floating-chat-widget}
...
### Statusindicator in de Admin-Balk {#admin-bar-status-indicator}
...
### Hoe u het Widget inschakelt of uitschakelt {#how-to-enable-or-disable-the-widget}
...
## Widget Instellingen {#widget-settings}
...
### Het chatwidget verschijnt niet {#the-chat-widget-does-not-appear}
...
### De admin-balk indicator toont "Error" {#the-admin-bar-indicator-shows-error}
...
### Modelgewichten downloaden elke keer {#model-weights-download-every-time}
