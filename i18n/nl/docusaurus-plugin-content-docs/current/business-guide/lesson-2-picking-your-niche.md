...
- Bedrijven een webaanwezigheid zouden moeten hebben
- De meeste huidige websites in de sector van slechte kwaliteit zijn
- Algemene builders hun specifieke behoeften niet oplossen
- Maatwerkontwikkeling te duur is voor de typische bedrijfsgrootte
...
- Genoeg gevestigd zijn om een marketingbudget te hebben
- Gewend zijn aan het betalen voor softwareabonnementen (boekingssystemen, betalingsverwerking, enz.)
- Werken op een schaal waarbij $49-$199/maand een redelijke bedrijfskosten is
...
- Brancheverenigingen, conferenties of beurzen
- Actieve online gemeenschappen (Facebookgroepen, forums, subreddits)
- Lokale netwerken waar ondernemers aanbevelingen delen
...
- Industrieën waarin je gewerkt hebt of voor welke je websites hebt gebouwd
...
- Zoek op Google "[industrie] website builder" en kijk wat er bestaat
- Blader door brancheforums op zoek naar klachten over de webaanwezigheid
...
- **Marktgrootte**: Hoeveel bedrijven bestaan er in deze niche? (Begin met je land/regio)
...
- Hoe heb je je huidige website gekregen?
- Wat zou je willen dat hij kon doen, maar nu niet kan?
- Waar betaal je momenteel voor?
- Als er een platform bestond dat specifiek voor [jouw niche] was gebouwd, zou je dan geïnteresseerd zijn?
...
|-----------|------------|
| Need websites but struggle | Ja -- de meeste studio's zijn generiek of verouderd |
| Can afford subscription | Ja -- betalen al $50-$200/maand voor boekingssoftware |
| Talk to each other | Ja -- actieve gemeenschappen, industrie-evenementen, lokale netwerken |
| Market size | 100.000+ faciliteiten in de VS alleen al |
| Competitor landscape | Er bestaan weinig niche-specifieke websiteplatforms |
...
- **Restaurants en cafés** -- menu's, reserveringen, openingstijden, bezorging
- **Makelaars** -- listings, profielen van makelaars, buurtgidsen
- **Advocatenkantoren** -- vakgebieden, biografieën advocaten, consultatieboeking
- **Kerken en non-profitorganisaties** -- evenementen, preken, donaties, gemeenschap
- **Gespecialiseerde aannemers** (loodgieters, elektriciens, HVAC) -- servicegebieden, boeking, beoordelingen
- **Salons en spa's** -- diensten, boeking, stylistprofielen, galerijen
- **Dierenklinieken** -- diensten, huisdierportalen, afspraakboeking
- **Muziekacademieën** -- instructeurprofielen, lesplanning, recitalinformatie
...
- **FitSite validatie**: bevestigde dat fitnessstudio's aan alle criteria voldoen
- **Alternatieve niches**: een lijst met andere verticale markten waarop je dit raamwerk kunt toepassen

---

**Volgende:** [Les 3: Je Netwerk Opzetten](lesson-3-setting-up) -- we installeren Ultimate Multisite en configureren de basis voor FitSite.
