...
## Zrozumienie procesu rejestracji {#understanding-the-registration-flow}
...
## Projektowanie płatności FitSite {#designing-the-fitsite-checkout}

Przejdź do **Ultimate Multisite > Checkout Forms** i utwórz nowy formularz.

### Krok 1: Wybór planu {#step-1-plan-selection}
...
### Krok 2: Wybór szablonu {#step-2-template-selection}
...
### Krok 3: Tworzenie konta {#step-3-account-creation}
...
### Krok 4: Konfiguracja witryny {#step-4-site-setup}
...
### Krok 5: Płatność {#step-5-payment}
...
### Krok 6: Potwierdzenie {#step-6-confirmation}
...
## Konfigurowanie płatności {#configuring-payment}
...
## Testowanie procesu {#testing-the-flow}
