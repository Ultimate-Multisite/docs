...
## Domeny platformy {#your-platform-domain}
...
### Konfiguracja domeny {#setting-up-your-domain}
...
## White-labeling doświadczenia w panelu administracyjnym {#white-labeling-the-admin-experience}
...
### Spersonalizowana strona logowania {#custom-login-page}
...
### Branding panelu administracyjnego (Dashboard) {#dashboard-branding}
...
### Niestandardowe strony administracyjne {#custom-admin-pages}
...
## Branding komunikacji {#branding-your-communications}

Każdy e-mail, faktura i powiadomienie powinno wzmacniać Twoją markę.

### Systemowe e-maile {#system-emails}
...
## Strona widoczna dla klienta {#the-customer-facing-site}
...
## Domeny niestandardowe dla klientów {#custom-domain-for-customers}
