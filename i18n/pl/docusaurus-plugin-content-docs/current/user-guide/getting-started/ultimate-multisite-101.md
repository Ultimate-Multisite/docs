...
#### Subdomena czy podkatalog {#subdomain-vs-subdirectory}
...
#### Pluginy i motywy {#plugins-and-themes}
...
#### Użytkownicy i administratorzy {#users-and-administrators}
...
### Kwestie architektury {#architecture-considerations}
...
#### Hosting współdzielony vs. dedykowany {#shared-vs-dedicated-hosting}
...
#### Skrypty zewnętrzne {#external-scripts}
