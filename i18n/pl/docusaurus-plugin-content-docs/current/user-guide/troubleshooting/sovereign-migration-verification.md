...
---
# Weryfikacja Migracji Suwerennej
...
### Uwierzytelnianie w bazie danych się nie zgadza z hostem
...
### Instalacje Bedrock lub lokalne nie mogą się połączyć
...
### Kolejka asynchronicznego push nie jest opróżniana (drain)
...
### Liczba użytkowników tenantów jest błędna
