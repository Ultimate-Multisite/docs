---
title: Tłumaczenie Ultimate Multisite
sidebar_position: 19
...
1. Odwiedź [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Wybierz swój język
3. Kliknij "Contribute Translation"
4. Będziesz potrzebować darmowego konta na WordPress.org
...
1. Pobierz Poedit ze strony [poedit.net](https://poedit.net)
2. Otwórz plik `.pot` z katalogu `wp-content/plugins/ultimate-multisite/lang/`
3. Przetłumacz frazy w interfejsie Poedit
