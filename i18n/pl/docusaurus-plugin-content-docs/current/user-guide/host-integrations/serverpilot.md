...
---
# Integracja z ServerPilot {#serverpilot-integration}
...
### 1. Uzyskaj dane dostępowe do API ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Uzyskaj App ID {#2-get-your-app-id}
...
## Weryfikacja certyfikatu SSL {#ssl-certificate-verification}
