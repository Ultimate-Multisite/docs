...
---
# Integracja z cPanel {#cpanel-integration}
...
### 1. Uzyskaj dane logowania do cPanel {#1-get-your-cpanel-credentials}
...
### 2. Dodaj stałe do wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Włącz integrację {#3-enable-the-integration}
