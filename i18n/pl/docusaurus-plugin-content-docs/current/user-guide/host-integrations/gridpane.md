...
---
# Integracja z GridPane {#gridpane-integration}
...
### 1. Uzyskanie danych dostępowych do API GridPane {#1-get-your-gridpane-api-credentials}
...
### 2. Uzyskanie identyfikatorów serwera i strony {#2-get-your-server-and-site-ids}
...
### 3. Dodanie stałych do wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Włączenie integracji {#4-enable-the-integration}
...
## Zarządzanie stałą SUNRISE {#sunrise-constant-management}
