...
## Co się zmienia dla administratorów {#what-changes-for-administrators}
...
## Odwiedzanie suwerennego najemcy {#visiting-a-sovereign-tenant}
...
## Lista kontrolna operacji dla stron zdalnych (Remote-site operations checklist) {#remote-site-operations-checklist}
...
## Usuwanie najemców suwerennych {#deleting-sovereign-tenants}
