...
### 2. Dodanie stałych do wp-config.php
...
### Połączenie API odrzucone (Connection Refused)
...
### Domena nie została utworzona (Domain Not Created)
...
### Certyfikat SSL nie został wydany (SSL Certificate Not Issued)
