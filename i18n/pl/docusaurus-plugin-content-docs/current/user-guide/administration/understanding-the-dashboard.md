---
title: Zrozumienie Panelu głównego
sidebar_position: 7
...
Ten widżet raportuje zdarzenia w Ultimate Multisite. Do zdarzeń należą rejestracje, anulowania, tworzenie i usuwanie witryn oraz inne aktywności.
...
![Selektor zakresu dat i statystyki](/img/admin/um-dashboard-date-range.png)

Zakres dat określa okres wyświetlany przez widżety poniżej, w tym przychody, nowe członkostwa, rejestracje według kraju, rejestracje według formularza i najczęściej odwiedzane witryny.

![Widżety statystyk panelu](/img/admin/um-dashboard-stats.png)

:::tip
Aby widżet **Najczęściej odwiedzane witryny** działał, włącz liczenie odwiedzin w **Ultimate Multisite → Ustawienia → Witryny → Włącz limitowanie i liczenie odwiedzin**.
:::
