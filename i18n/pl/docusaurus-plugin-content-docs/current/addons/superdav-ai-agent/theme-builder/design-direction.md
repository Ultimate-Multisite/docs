...
- **Weryfikuj kontrast** — użyj [Validate Palette Contrast](../abilities/validate-palette-contrast.md) dla dostępności
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — sprawdzanie dostępności kolorów
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — tworzenie niestandardowych logo
