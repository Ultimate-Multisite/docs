...
## Pływający widget czatu {#floating-chat-widget}
...
### Wskaźnik statusu w admin-bar {#admin-bar-status-indicator}
...
### Jak włączyć lub wyłączyć widget {#how-to-enable-or-disable-the-widget}
...
## Hooks i Filtry {#hooks-and-filters}
...
### Widget czatu nie pojawia się {#the-chat-widget-does-not-appear}
...
### Wskaźnik w admin-bar pokazuje „Error” {#the-admin-bar-indicator-shows-error}
...
### Wagi modelu pobierane za każdym razem {#model-weights-download-every-time}
