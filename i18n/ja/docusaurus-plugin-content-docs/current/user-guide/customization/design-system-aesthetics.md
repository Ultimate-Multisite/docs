...
---
# デザインシステムのエステティクススキル {#design-system-aesthetics-skill}
...
## デザインシステムのエステティクスとは？ {#what-is-design-system-aesthetics}
...
## デザインシステムのエステティクスを使う理由 {#why-use-design-system-aesthetics}
...
## デザインシステムのエステティクススキルの起動 {#triggering-the-design-system-aesthetics-skill}

### 手動での起動 {#manual-activation}
...
## デザインシステムのエステティクスプロセス {#the-design-system-aesthetics-process}

### ステップ 1: タイポグラフィ {#step-1-typography}
...
### ステップ 2: カラーパレット {#step-2-color-palette}
...
### ステップ 4: ボーダーとシャドウ {#step-4-borders-and-shadows}
...
### ステップ 5: モーションとアニメーション {#step-5-motion-and-animation}
...
## デザインシステムのエステティクスの適用 {#applying-design-system-aesthetics}
...
## デザインシステムの確認方法 {#viewing-your-design-system}

### エージェントに尋ねる {#ask-the-agent}
...
### theme.json を見る {#view-themejson}

テキストエディタで `/wp-content/themes/[テーマ名]/theme.json` を開くと、生のトークン定義を確認できます。

## デザインシステムの更新 {#updating-your-design-system}

### クイックアップデート {#quick-updates}
...
## デザインシステムのベストプラクティス {#design-system-best-practices}
...
## 一般的なデザインシステムパターン {#common-design-system-patterns}

### モダンミニマリスト {#modern-minimalist}
...
### 温かみがありフレンドリー {#warm-and-friendly}
...
### プロフェッショナルな企業向け {#professional-corporate}
