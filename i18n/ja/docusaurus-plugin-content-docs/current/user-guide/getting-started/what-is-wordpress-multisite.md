...
## WordPress マルチサイトとは正確に何ですか？ {#what-exactly-is-wordpress-multisite}
...
## サブドメインかサブディレクトリか？ {#subdomain-or-subdirectory}
...
## サブサイト間で共有されるものと共有されないもの {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress マルチサイトにおけるユーザー管理 {#user-management-on-wordpress-multisite}
