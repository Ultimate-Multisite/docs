...
### 1. ServerPilot API 認証情報を取得する {#1-get-your-serverpilot-api-credentials}
...
### 2. アプリ ID を取得する {#2-get-your-app-id}
...
### 4. 統合を有効にする {#4-enable-the-integration}
...
## SSL 証明書検証 {#ssl-certificate-verification}
