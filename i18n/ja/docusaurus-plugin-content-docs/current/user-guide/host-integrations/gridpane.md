...
---
# GridPane インテグレーション {#gridpane-integration}
...
### 1. GridPane API 認証情報を取得 {#1-get-your-gridpane-api-credentials}
...
### 2. サーバーとサイト ID を取得 {#2-get-your-server-and-site-ids}
...
## SUNRISE 定数管理 {#sunrise-constant-management}
