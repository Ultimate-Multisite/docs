...
## Broadcastsで顧客のDashboardに管理者通知を追加する {#add-admin-notices-to-your-customers-dashboard-with-broadcasts}
...
## 顧客にメールを送信する {#send-emails-to-your-customers}
...
### リセットとインポート {#resetting--importing}
...
#### システムメールをインポートする方法 {#how-to-import-system-emails}
...
#### システムメールのリセット {#reseting-system-emails}
