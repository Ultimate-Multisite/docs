...
## Site Plan Abilities（サイトプランアビリティ） {#site-plan-abilities}
...
## WP-CLI Plan Commands（WP-CLIプランコマンド） {#wp-cli-plan-commands}
