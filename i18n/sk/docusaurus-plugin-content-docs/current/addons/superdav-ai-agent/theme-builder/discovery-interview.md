...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Odporúčané pre fotografie |
| **PNG** | `.png` | Podporuje priehľadnosť |
...
- **Farebnú paletu** — dominantné farby sa extrahujú a použijú v téme
- **Vizuálny štýl** — moderný, rustikálny, minimalistický, živý atď.
- **Náladu a atmosféru** — profesionálna, kreatívna, priateľská, luxusná atď.
...
- **Mood boardy** — kolekcie obrázkov predstavujúce vašu požadovanú estetiku
- **Fotografie produktov** — ak máte produkty na prezentáciu
...
- **Obrázky s veľkým množstvom textu** — snímky obrazovky s množstvom textu
...
3. **Zahrňte rozmanitosť** — kombináciu farby, štýlu a témy
...
- **Farebnú paletu** — primárne, sekundárne a akcentové farby
- **Typografiu** — rodiny písiem pre nadpisy a text tela
- **Štýl rozloženia** — rozostupy, zarovnanie a usporiadanie komponentov
...
1. Skontrolujte vygenerované smerovanie dizajnu
2. Poskytnite spätnú väzbu alebo požiadajte o úpravy
...
- [Nástroje a konfigurácia](./tools.md) — dostupné nástroje a možnosti konfigurácie
