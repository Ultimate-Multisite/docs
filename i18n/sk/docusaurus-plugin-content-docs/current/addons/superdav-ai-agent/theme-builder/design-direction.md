...
- **Overte kontrast** — použite [Validate Palette Contrast](../abilities/validate-palette-contrast.md) pre prístupnosť
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — skontrolujte prístupnosť farieb
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — vytvorte vlastné logá
