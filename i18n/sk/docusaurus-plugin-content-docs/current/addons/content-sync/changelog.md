---
title: Záznam zmien synchronizácie obsahu
sidebar_position: 99
...
* Nové: Predvýber podradenej stránky pre šablónové stránky
* Nové: Extrakcia médií z post_content pre všetky typy príspevkov
* Nové: Synchronizácia taxonómií (kategórie, značky, vlastné taxonómie)
* Zmenené: Premenované z „Elementor Template Sync“ na „Content Sync“
...
* Úplná synchronizácia médií s automatickým premapovaním ID
* Integrácia nastavení s Ultimate Multisite
* Podpora vylúčenia stránky cez nastavenia siete
* Vymazanie cache Elementor po synchronizácii
* Zachovanie taxonómie šablón
