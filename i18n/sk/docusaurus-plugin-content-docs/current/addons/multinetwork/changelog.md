---
title: Zoznam zmien pre viacero sietí
sidebar_position: 99
...
* Nové: Klonovanie sieťových médií — médiá lokality sa pri klonovaní sietí zo šablóny správne duplikujú.
* Oprava: Klonovanie siete teraz funguje bez addonu multi-tenancy; oprávnenia super admin sa po klonovaní znova udelia.
* Oprava: Vytváranie siete je teraz kompatibilné s WooCommerce a všetkými platobnými bránami.
* Oprava: Číslo portu je teraz zahrnuté pri generovaní záložnej domény.
* Oprava: CSS pre výber šablóny bolo presunuté do zaradeného stylesheetu na správne vykresľovanie vo všetkých témach.
