...
## Prečo sú šablóny pre niku dôležité {#why-niche-templates-matter}
...
## Plánovanie vašich šablón {#planning-your-templates}

Pred tvorbou sa rozhodnite, aké šablóny ponúknete. Pre FitSite vytvoríme tri:

### Šablóna 1: Studio Essential {#template-1-studio-essential}
...
### Šablóna 2: Gym Pro {#template-2-gym-pro}
...
### Šablóna 3: Fitness Chain {#template-3-fitness-chain}
...
## Tvorba šablónového webu {#building-a-template-site}
...
### Krok 1: Vytvorte šablónový web {#step-1-create-the-template-site}
...
### Krok 2: Nainštalujte a nakonfigurujte tému {#step-2-install-and-configure-the-theme}
...
### Krok 3: Vytvorte stránky {#step-3-create-the-pages}
...
### Krok 5: Označte ako šablónu {#step-5-mark-as-template}
...
## Kontrolný zoznam kvality šablóny {#template-quality-checklist}
