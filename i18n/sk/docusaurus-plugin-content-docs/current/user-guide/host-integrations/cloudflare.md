...
### 1. Získanie svojho API kľúča Cloudflare {#1-get-your-cloudflare-api-key}
...
### 2. Získanie ID svojej domény (Zone ID) {#2-get-your-zone-id}
...
### 3. Pridanie kon constantov do wp-config.php {#3-add-constants-to-wp-configphp}
...
### Správa poddomenenov {#subdomain-management}
...
### Zobrazenie DNS záznamov {#dns-record-display}
...
## Vlastné hostné mená Cloudflare (Cloudflare Custom Hostnames) {#cloudflare-custom-hostnames}
...
### Ako sa to líši od štandardnej integrácie Cloudflare {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Konfigurácia vlastných hostných mení Cloudflare {#setting-up-cloudflare-custom-hostnames}
...
## Řešenie problémov {#troubleshooting}
...
### Poddoména nebola pridaná {#subdomain-not-added}
...
### Problémy s proxy {#proxying-issues}
