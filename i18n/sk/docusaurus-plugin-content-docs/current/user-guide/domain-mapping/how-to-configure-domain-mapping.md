...
---
# Ako nakonfigurovať mapovanie domén (v2)
...
### Ako nastaviť mapovanie domén vo vašej sieti Ultimate Multisite
...
### Uistenie sa, že nastavenia DNS domény sú správne nakonfigurované
...
### Mapovanie vlastného názvu domény ako Super Admin
...
### Mapovanie vlastného názvu domény ako používateľ podlokality
