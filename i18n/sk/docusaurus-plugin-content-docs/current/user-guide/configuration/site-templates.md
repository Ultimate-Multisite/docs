...
## Vytváranie a upravovanie novej Šablóny sítí
...
### Prispôsobenie obsahu šablóny webovej stránky
...
### Používanie šablon webových stránok
...
#### Režim 1: Pridanie šablóny webovej stránky
...
#### Režim 2: Vyberte dostupnú šablonu
...
### Predvolený režim: Výber šablóny sitovky na formulári pokladne (Checkout form)
...
### Možnosti šablón pre webové stránky
...
#### Povolenie používateľom používať ich webovú stránku ako šablóny
...
#### Kopírovanie médií pri duplikácii šablóny
...
#### **Zabrišcie indexovanie šablón pre webové stránky vyhľadávacími systémami**
...
## Predpripravovanie šablón pre webové stránky s automatickým vyhľadávaním a nahradením
...
### Riešenie problému „šablóna plná zástupných miest“
