...
### Poplatok za nastavenie (Setup Fee)
...
Odkazník na zálehy **Taxes** (Daňové ohľady) je v súlade s nastaveniami daní definovanými v **Ultimate Multisite > Settings > Taxes** a konkrétne s definovanými daňovými sadzba. Aby ste aktivovali daňové ohľady a definovali platné daňové sadzby, si pozrite dokumentáciu na [Ultimate Multisite: Settings](ultimate-multisite-settings).
...
#### Omeňovanie pri zzerovaní (Reset Limitations)
...
## Upraviť, Duplikovať alebo Odstrániť Produkt
