...
## Aktivovanie internetového vyhľadávania {#enabling-internet-search}
...
### Získanie API kľúča Brave Search {#obtaining-a-brave-search-api-key}
...
### Získanie API kľúča Tavily {#obtaining-a-tavily-api-key}
...
### Limity použitia {#usage-limits-1}
...
## Vyhľadávanie v sieti vypnuté {#disabling-internet-search}
