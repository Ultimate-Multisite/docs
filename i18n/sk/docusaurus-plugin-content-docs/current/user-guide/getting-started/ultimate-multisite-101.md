...
#### Poddoména vs. Podreť (Subdomain vs. Subdirectory) {#subdomain-vs-subdirectory}
...
#### Plugins a Themes {#plugins-and-themes}
...
#### Používatelia a správy (Administrators) {#users-and-administrators}
...
#### Permalinks (Permalienky) {#permalinks}
...
#### Prípad 1: Agentúra {#case-1-an-agency}
...
#### Úprava 3: Web hostovanie WordPressu {#case-3-wordpress-web-hosting}
...
### Architektonické zváženia {#architecture-considerations}
...
#### Splnené vs. Vlastné hostovanie {#shared-vs-dedicated-hosting}
...
#### Zváženia týkajúce výkonu {#performance-considerations}
...
#### Snapshots (Záznamy stavu) {#snapshots}
...
#### Externé skripty {#external-scripts}
