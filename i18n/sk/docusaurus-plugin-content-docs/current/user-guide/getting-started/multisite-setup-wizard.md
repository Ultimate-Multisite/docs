...
## Kedy sa nástroj zobrazí? {#when-does-the-wizard-appear}
...
## Predchádzajúce požiadavky {#prerequisites}
...
## Krok 2: Konfigurácia siete {#step-2-network-configuration}

Tento krok vás požiada o konfiguráciu vašich sietiach.

### Štruktúra sita {#site-structure}
...
### E-mail administrátora siete {#network-admin-email}
...
## Krok 3: Instalácia {#step-3-installation}
...
## Krok 4: Dokončené {#step-4-complete}
...
## Manual Setup Fallback (Náhradné riešenie manuálnej konfigurácie) {#manual-setup-fallback}
...
## Troubleshooting (Úprava problémov) {#troubleshooting}

### Nástroj uvádza, že wp-config.php nie je zapisovateľný (not writable) {#the-wizard-says-wp-configphp-is-not-writable}
...
### Stránky nie sú prístupné po nastavení (subdomény) {#sites-are-not-accessible-after-setup-subdomains}
...
### Problémy s autentifikáciou po nastavení {#authentication-issues-after-setup}
...
### Chyba sa stala počas instalácie {#a-step-failed-during-installation}
