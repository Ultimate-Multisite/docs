...
---
# Onboarding prechádzajúca cesta Theme Builderu {#theme-builder-onboarding-flow}
...
## Čo je onboardingová cesta Theme Builderu? {#what-is-the-theme-builder-onboarding-flow}
...
## Začiatok s Theme Builderom onboardingom {#starting-the-theme-builder-onboarding}

### Prvý spustenie {#first-run-setup}
...
### Manuálna aktivácia {#manual-activation}
...
## Kroky onboardingovej cesty {#the-onboarding-steps}

### Krok 1: Výber režimu {#step-1-mode-selection}
...
### Krok 2: Špecifikácia webu {#step-2-site-specification}
...
### Krok 3: Presnenia návrhu (Design System Decisions) {#step-3-design-system-decisions}
...
### Krok 4: Generovanie témy (Theme Generation) {#step-4-theme-generation}
...
### Krok 5: Aktivácia a overenie {#step-5-activation-and-verification}
...
## Špecifikácia stránky a pamäť site_brief {#site-specification-and-sitebrief-memory}
...
### Prečo je site_brief dôležitý {#why-sitebrief-matters}

V budúcich oturách agenti odkazujú na váš `site_brief` na:

### Zobrazenie vášho site_briefu {#viewing-your-sitebrief}
...
## Prispôsobenie po onboardingovej fáze {#customizing-after-onboarding}

Po dokončení onboardingovej fázy Theme Builder môžete:

### Použiť skickú dizajn systémovú zručnosť (Design System Aesthetics skill) {#use-the-design-system-aesthetics-skill}
...
### Upraviť theme.json priamo {#edit-themejson-directly}
...
### Vytvoriť prispô)))lované šablóny blokov (Custom Block Templates) {#create-custom-block-templates}
...
## Porovnanie: Staré vs. Nové onboardingové fázy {#comparison-old-vs-new-onboarding}
