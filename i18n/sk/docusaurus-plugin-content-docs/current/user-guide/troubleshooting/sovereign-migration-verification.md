...
## Často zastávajúce chyby

### Granty v databáze sa neodpovedajú hostu
...
### Bedrock alebo lokálne inštalácie sa nečupajú
...
### Asynná dia čerpadla sa nevyčisti (drain)
...
### Počet používateľov domény je nesprávny
...
## Kľúčové momenty pre ponavodenie
