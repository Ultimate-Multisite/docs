...
---
# Integrácia Ultimate Multisite s Zapierom {#integrating-ultimate-multisite-with-zapier}
...
## Ako vytvoriť nový Trigger {#how-to-create-a-new-trigger}
...
## Ako vytvoriť Actions {#how-to-create-actions}
...
### Nastavenie akcie {#setting-up-the-action}
