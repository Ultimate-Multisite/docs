...
Od toho môžete prístup k stránke **System Emails**, kde si uvidíte všetky šablóny e-mailov.

![System Emails list](/img/admin/system-emails-list.png)

Môžete tiež upraviť jednotlivé šablóny e-mailov pomocou redaktóra systémových e-mailov:
...
Aby ste mohli importovať nové šablóny e-mailov:

1. Prejdite na stránku **System Emails**
2. Kliknite na tlačidlo **Reset & Import** v hornej časti stránky
...
1. **Odstrániť a znovu importovať** — Odstránite systémový e-mail a importujte ho znova (to vymaže metriky o odoslaní)
2. **Resetovanie pomocou nástroja** — Použite nástroj **Reset & Import**, prepnite možnosť **Reset** a vyberte e-maily, ktoré chcete resetovať

Možnosť Reset je odporúčaná, pretože zachová metriky o odoslaní a iné metadátové informácie, zatiaľ čo obnovuje pôvodný obsah.
