...
### 2. Pridajte konстанти do wp-config.php
...
### Domain Mapping (Mapovanie domén)
...
### Email Forwarders (Prekonajky e-mailov)
...
## Referencia konfiguračnej informácie
