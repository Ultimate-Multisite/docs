...
---
# Operácie s suverénnymi najemcami {#sovereign-tenant-operations}
...
## Zmeny pre administrátorov {#what-changes-for-administrators}
...
## Navštiekanie suverénneho najemcu {#visiting-a-sovereign-tenant}
...
## Kontrolný zoznam operácií vzdialeného sity {#remote-site-operations-checklist}
...
## Odstránenie suverénnych najmovateľov (sovereign tenants) {#deleting-sovereign-tenants}
