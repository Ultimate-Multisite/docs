---
title: Príručka používania hookov
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Sprievodca používaním hookov {#hooks-usage-guide}

Ultimate Multisite poskytuje viac ako 200 action hookov a viac ako 280 filter hookov. Táto stránka pokrýva najčastejšie používané hooky s praktickými príkladmi. Úplný automaticky generovaný prehľad nájdete na ostatných stránkach v tejto sekcii.

## Action hooky {#action-hooks}

### Životný cyklus zákazníka {#customer-lifecycle}

#### Po vytvorení zákazníka {#after-customer-creation}
...
#### Zmena stavu zákazníka {#customer-status-change}
...
### Hooky webu {#site-hooks}

#### Po zverejnení webu {#after-site-published}
...
#### Pred použitím šablóny {#before-template-application}
...
### Membership hooky {#membership-hooks}

#### Prechody stavu {#status-transitions}
...
### Platobné hooky {#payment-hooks}

#### Platba dokončená / zlyhala {#payment-completed--failed}
...
### Checkout hooky {#checkout-hooks}

#### Pred spracovaním / po dokončení {#before-processing--after-completion}
...
## Filter hooky {#filter-hooks}

### Filtre cien {#pricing-filters}

#### Celková suma košíka {#cart-total}
...
### Filtre šablón {#template-filters}
...
### Filtre obmedzení {#limitation-filters}
...
### Polia formulára checkoutu {#checkout-form-fields}
