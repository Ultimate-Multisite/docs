---
title: Začíname s vývojom doplnkov
sidebar_position: 1
...
```
my-addon/
├── my-addon.php                 # Hlavný súbor pluginu
├── inc/
│   ├── class-my-addon.php       # Hlavná trieda doplnku
│   ├── admin-pages/             # Admin rozhranie
│   ├── models/                  # Vlastné dátové modely
│   └── integrations/            # Integrácie tretích strán
├── assets/
│   ├── js/
│   └── css/
...
- Použite [Addon Template](/addons/addon-template) ako počiatočnú kostru
