...
## Konvencia pomenovania súborov {#file-naming-convention}
...
## Kam umiestniť súbor {#where-to-place-the-file}
...
## Dostupné hooky a filtre {#hooks-and-filters-available}
...
## Minimálny príklad {#minimal-example}
