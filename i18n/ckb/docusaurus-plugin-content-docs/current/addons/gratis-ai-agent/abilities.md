...
---
# سەرچاوەی تواناکان {#abilities-reference}
...
## جۆرە پۆستە دەستکردەکان {#custom-post-types}
...
## پۆلێنکارییە دەستکردەکان {#custom-taxonomies}
...
## ستایلە گشتییەکان {#global-styles}
...
## مێنیوەکانی ڕێنیشاندان {#navigation-menus}
...
## بەڕێوەبردنی هەڵبژاردنەکان {#options-management}
...
## بەڕێوەبردنی ناوەڕۆک {#content-management}
...
## پێداچوونەوەی بینراو {#visual-review}
...
## تواناکانی دامەزراندن {#installable-abilities}
