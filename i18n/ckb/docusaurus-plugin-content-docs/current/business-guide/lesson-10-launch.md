...
- [ ] Alan adı eşleştirmesi çalışıyor -- bir site oluşturup özel bir alan adı eşleştirmeyi test edin
...
- [ ] Tüm görseller uygun lisanslanmış (stok fotoğraf filigranı yok)
...
- [ ] Kurulum ücretleri ilgili planlarda ayarlandı
...
- [ ] Ödeme işlemleri başarılı oluyor
- [ ] Kullanıcı kayıt olduktan sonra hoş geldiniz e-postasını alıyor
...
- [ ] Tüm sistem e-postaları FitSite markası ve fitness odaklı dilini kullanıyor
...
- [ ] Ödeme almak için iş kuruluşu kuruldu
...
- بازخورد صادقانه در مورد تجربه ثبت‌نام و شروع کار
- اجازه استفاده از سایتشان به عنوان نمونه نمایش
- گزارش هرگونه باگ یا مشکلی که با آن مواجه می‌شوند
...
- درگاه پرداخت را به حالت زنده تغییر دهید
...
۱. **به پرداخت زنده تغییر وضعیت دهید** -- حالت تست را روی درگاه پرداخت خود غیرفعال کنید
۲. **یک بار دیگر تأیید کنید** -- یک ثبت‌نام کامل با پرداخت واقعی انجام دهید (بعد از آن خودتان پول را پس بگیرید)
۳. **با دقت نظارت کنید** -- به دنبال خطاها، ثبت‌نام‌های ناموفق یا مشکلات پرداخت باشید
...
- **مشکلات درگاه پرداخت**: تماس پشتیبانی ارائه‌دهنده درگاه خود را آماده داشته باشید
- **مشکل‌های گواهی SSL**: بدانید چگونه گواهی‌ها را بررسی و تمدید کنید
- **شکست در ارسال ایمیل**: تست کنید که آیا ایمیل‌ها واقعاً می‌رسند یا خیر (پوشه‌های اسپم را چک کنید)
...
├── Ultimate Multisite (پیکربندی شده + برندسازی شده) ✓
├── Platform Domain (fitsite.com + SSL وایلد کارت) ✓
├── Site Templates (Studio Essential، Gym Pro، Fitness Chain) ✓
├── Products (Starter، Growth، Pro + Order Bumps + Discounts) ✓
├── Checkout Flow (پایان به پایان تست شده است) ✓
├── Branding (کامل) ✓
├── Customer Onboarding (شروع سریع، ایمیل‌ها، منابع کمک) ✓
├── Pricing Strategy (سالانه، آزمایشی، هزینه‌های راه‌اندازی، تخفیف‌ها) ✓
├── Pre-Launch Checklist (تأیید شده) ✓
├── Soft Launch (مشتریان بتا ثبت‌نام کردند) ✓
└── LIVE ✓
```
...
- **رویه‌های روز راه‌اندازی** برای ورود با اطمینان به محیط عملیاتی
- **یک برنامه اضطراری** برای مشکلات رایج روز راه‌اندازی

---

**بعدی:** [درس ۱۱: پیدا کردن مشتریان](lesson-11-customers) -- حالا که FitSite فعال است، چگونه از صاحبان استودیو تناسب اندام بخواهید ثبت‌نام کنند؟
