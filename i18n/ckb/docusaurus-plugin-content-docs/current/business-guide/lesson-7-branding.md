...
---
# سبق ٧: خۆشکردن بۆ خۆت {#lesson-7-making-it-yours}
...
## دامێنی پلاتفۆرمەکەت {#your-platform-domain}
...
### ڕێکخستنی دامێنی تۆ {#setting-up-your-domain}
...
## وایت-لێبلکردنی ئەزموونی ئیدارە (Admin Experience) {#white-labeling-the-admin-experience}

کاتێک خاوەن ستۆدیۆی فیتنسەکە چووە ناو داشبۆردی سایتەکەی، دەبێت براندەکەت ببینێت، نەک WordPress یان Ultimate Multisite.

### لاگینی تایبەت (Custom Login Page) {#custom-login-page}
...
### براندکردنی داشبۆرد (Dashboard Branding) {#dashboard-branding}
...
### صفحات ئادمن تایبەت (Custom Admin Pages) {#custom-admin-pages}
...
## براندکردنی پەیوەندییەکان (Branding Your Communications) {#branding-your-communications}

هەر ئیمێلی، فاکتۆرا (invoice)، و ئاگادارییەک دەبێت براندەکەت پەیام بکاتەوە.

### ئیمێلەکانی سیستەم (System Emails) {#system-emails}
...
## سایت面向 مشتری {#the-customer-facing-site}
...
## دامنه سفارشی برای مشتریان {#custom-domain-for-customers}
...
## Çfarë Krijim Këtë Leksi {#the-fitsite-network-so-far}
