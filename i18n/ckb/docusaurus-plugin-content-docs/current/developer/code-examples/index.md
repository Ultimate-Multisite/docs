---
title: نموونەکانی کۆدی پێشکەوتوو
sidebar_position: 1
...
دوو داواکاریی هاوکات دەتوانن هەمان نرخ بخوێننەوە و هەردووکیان هەمان ئەنجامی زیادکراو بنووسنەوە، یەک ژمارە لەدەست بدەن. `increment_item()` ژمێرکارییەکە دەداتە پاڵ بزوێنەری داتابەیس بە یەک دەستەواژەی `UPDATE ... SET column = column + ?`، کە کردارەکە بە شێوەی سروشتی ئەتۆمی دەکات.
