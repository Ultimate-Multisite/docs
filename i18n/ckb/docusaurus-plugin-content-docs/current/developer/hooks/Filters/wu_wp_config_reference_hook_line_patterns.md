...
title: پاڵێوەر - wu_wp_config_reference_hook_line_patterns
sidebar_label: wu_wp_config_reference_hook_line_patterns
_i18n_hash: 5fd70ec9bc5a2b3357660797baf5519b
---
# فلتەر: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

ئێمە بۆ سێ نەخشە دەگەڕێین کاتێک هەوڵ دەدەین بزانین لە کوێ دەتوانین constants ـەکانمان بخەینە ناوەوە:
...
لە [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) لە هێڵی 143 پێناسە کراوە
