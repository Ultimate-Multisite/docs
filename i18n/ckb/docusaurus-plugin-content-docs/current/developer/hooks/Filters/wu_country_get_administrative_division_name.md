...
title: فلتەر - wu_country_get_administrative_division_name
...
| ناو | جۆر | وەسف |
|------|------|-------------|
| $name | `string` | ناوی بەشەکە. زۆرجار شتێک وەک state، province، region، هتد. |
| $country_code | `string` | کۆدی ISO دوو پیتی بۆ وڵاتەکە. |
| $state_code | `string` | کۆدی ISO دوو پیتی بۆ state. |
