...
## Derdikeşandin Plugin bi AI {#generating-a-plugin-via-ai}
...
## Aktifkirina Sandbox {#sandbox-activation}
...
## Rêbkirina Pluginên Derxistin {#managing-generated-plugins}
...
## Integration HookScanner {#installing-a-generated-plugin-on-the-network}
...
## بیرۆکەکانی پاراستراوکردن (Security Considerations) {#plugin-updates}
