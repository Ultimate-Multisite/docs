...
---
# کۆتایی هاتنی ئەستۆ و ڕێگریکردن لە سایت
...
## ژیانکردنی تێสถานەت (Membership Status Lifecycle)
...
### چۆن ئەندازیارەکان دەگوازرێن بۆ کۆتایی هاتنی
...
#### ئەندامبوونی خۆڕاگەیشتنەوە (Auto-Renewing) بەرامبەر ئەو کەسانەی خۆیان بەپێی ئۆتۆماتیک نۆژوونیان دەکرێت (Non-Auto-Renewing)
...
### چۆن تریالەکان کۆتایی دبن (How Trials End)
...
## ڕێگری لە دەستپێکردنی فۆنتئەندی (Block Frontend Access)
...
### چی بینەران دەبینن کاتێک سایتێک ڕاگرتراوە؟
...
## Utatuzi: Tovuti Zinazobaki Zenye Upataji Baada ya Kuisha Muda

Ikiwa tovuti bado zinafanya kazi hadharani baada ya uye kuisha, fanya ukaguzi huu kwa mpangilio:

### 1. Thibitisha kwamba Mpangilio wa Block Frontend Access umeichweshwa (Enabled)
...
### 2. Angalia Periodi ya Faraja ya Kuzuia Frontend
...
### ٣. دڵنیابە کە دۆخی یەکەم بە ڕاستی گۆڕاوە
...
### ٤. دڵنیابە کە Action Scheduler چالاکە
...
### ٥. چاککردن بۆ کێشەکانی Gateway Webhook (Memberships کە خودی خۆیان دەگەڕێنەوە)
...
### ٦. چاککردن بۆ ماوەی بەردەوامبوون (Cron Level)
...
### ٧. بە شێوەیەکی دەستکرد کۆتایی پێهێنانی ئەندازیاری ئەندازیاری کارپێری (Membership)
...
## ئاماژە بۆ پەرەپێدان (Developer Reference)
