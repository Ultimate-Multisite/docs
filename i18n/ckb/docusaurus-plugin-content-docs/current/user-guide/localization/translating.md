---
title: وەرگێڕانی Ultimate Multisite
sidebar_position: 19
...
ئەمە سیستەمی وەرگێڕانی estàndardی کۆمەڵگای WordPress. کاتێک وەرگێڕانەکان ئاستێکی پێویست بۆ پەسەندکردن دەبینن، بە شێوەیەکی ئۆتۆماتیک بۆ هەموو بەکارهێنەرانی Ultimate Multisite لە ڕێگەی نوێکراوەکانی پڵۆഗി WordPress دابەش دەکرێن.

**ئێرمان پێویستە!** ئەگەر زمانی دیکەت لە ئینگلیزی دەکەیت، تکایە بیر بکەرەوە بۆ پێشنیاری وەرگێڕان. تەنانەت وەرگێڕانی چەند ڕستەیەکی کەم یارمەتی دەدات. بۆ دەستپێکردن:
...
3. لەسەر دAssuming "Contribute Translation" بێت
4. پێویستە هەژماری وردی WordPress.org هەبێت
...
1. Poedit لە [poedit.net](https://poedit.net) داوا بکەیت
2. فایلی `.pot` لە `wp-content/plugins/ultimate-multisite/lang/` بکەرەوە
3. دەقەکان (strings) لە ڕێگەی ئۆتۆماتیکی Poedit وەربگێڕە
