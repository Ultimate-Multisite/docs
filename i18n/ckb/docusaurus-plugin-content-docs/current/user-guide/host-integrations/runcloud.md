...
## Instelinstructies {#setup-instructions}

### 1. Haal je RunCloud API-gegevens op {#1-get-your-runcloud-api-credentials}
...
### 2. Haal je Server- en App-ID's op {#2-get-your-server-and-app-ids}
...
### کێشەی پەیوەندی API (API Connection Issues) {#api-connection-issues}
...
### کێشەی پڕۆژەی SSL (SSL Certificate Issues) {#ssl-certificate-issues}
...
### دامێنی زیاد نەکراوە (Domain Not Added) {#domain-not-added}
