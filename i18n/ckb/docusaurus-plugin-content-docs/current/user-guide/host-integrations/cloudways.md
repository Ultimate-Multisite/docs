...
## Rêzên Rêveberî (Setup Instructions)

### 1. Girtina Mînakî API ya Cloudways (Get Your Cloudways API Credentials)
...
### 2. Girtina ID-yên Server û Uygulasyon (Get Your Server and Application IDs)
...
### 3. Zêdekirina Kôtên (Constants) li wp-config.php
...
### 4. چالاککردنی یەکگرتوو (Integration)
...
### هەڵگرتنی دۆمێنافەکان (Domain Syncing)
...
## Domên Diheltirîn (Extra Domains)
...
### Set-upê SSL a Cloudways ji bo résega Ultimate Multisite
...
### پروبلیمات لەسەر گوازارنی SSL Certificate
