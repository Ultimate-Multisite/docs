...
### ١. گرتنی زانیارییەکانی cPanel {#1-get-your-cpanel-credentials}
...
### ٢. زیادکردنی گۆڕاوەکان لە wp-config.php {#2-add-constants-to-wp-configphp}
...
### ٣. چالاککردنەوەی یەکگرتووکارییەکە {#3-enable-the-integration}
...
### کێشەی پەیوەندی لەگەڵ API (API Connection Issues) {#api-connection-issues}
...
### دامێنەکە زیاد نەکراوە (Domain Not Added) {#domain-not-added}
...
### پروبلیمات سیفلی سرتیفیکیت (SSL Certificate Issues) {#ssl-certificate-issues}
