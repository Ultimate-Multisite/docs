...
### 1. Marrja e Kredencialeve API të GridPane-së
...
### 2. Marrja e ID-ve të Serverit dhe Sitet
...
### 3. Shtimi i Konstanteve në wp-config.php
...
### کێشەکانی سێرتیسڵ (SSL Certificate)
