...
### 1. الحصول على مفتاح API الخاص بك من Cloudflare
...
### 2. الحصول على معرف النطاق (Zone ID) الخاص بك
...
### نیشاندانی تۆمارەی DNS (DNS Record Display)
...
## ناوی میزڵەکانی تایبەت لە Cloudflare (Cloudflare Custom Hostnames)
...
### جیاوازی لەگەڵ integrationی ستاندارد یەک
