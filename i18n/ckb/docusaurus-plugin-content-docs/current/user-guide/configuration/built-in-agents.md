...
---
# Agentـە Built-inەکان {#built-in-agents}
...
## دەستگەیشتن بە هەڵبژاردەری Agent {#accessing-the-agent-picker}
...
## ئەو پێنج Agentە Built-inانە {#the-five-built-in-agents}

### نووسەری ناوەڕۆک {#content-writer}
...
### بەڕێوەبەری Plugin {#plugin-manager}
...
### یارمەتیدەری پشتگیری {#support-assistant}
...
## یەکخستنەکانی ئۆتۆماسیۆنی Superdav {#superdav-automation-integrations}
...
## تایبەتمەندکردنی Agent ـەکان {#customising-agents}

هەر agent ـێکی ناوخۆیی دەتوانرێت لە ڕێگەی filter ـی `gratis_ai_agent_agents` فراوان بکرێت یان بگۆڕدرێت.

### زیادکردنی system prompt ـێکی تایبەت بۆ agent ـێکی هەبوو {#adding-a-custom-system-prompt-to-an-existing-agent}
...
### تۆمارکردنی agent ـێکی نوێ {#registering-a-new-agent}
...
### لابردنی agent ـێکی ناوخۆیی {#removing-a-built-in-agent}
