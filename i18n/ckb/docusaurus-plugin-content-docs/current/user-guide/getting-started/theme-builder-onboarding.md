...
## Çfarë është Flowa e Onboarding-it për Theme Builder? {#what-is-the-theme-builder-onboarding-flow}
...
## Fillimi i Onboarding-it për Theme Builder {#starting-the-theme-builder-onboarding}
...
### Aktivizimi Manual {#manual-activation}
...
## Hapat e Onboarding-it {#the-onboarding-steps}
...
### Pasê 3: Kararên Sistema Tasîg (Design System) {#step-3-design-system-decisions}
...
### Pasê 4: Çêkirina Theme (Theme Generation) {#step-4-theme-generation}
...
### Pasê 5: Aktivekirin û Ra têkînîna (Activation and Verification) {#step-5-activation-and-verification}
...
## Teyarekirina Site û Maghsalê site_brief (site_brief Memory) {#site-specification-and-sitebrief-memory}
...
### Neden site_brief girîng e {#why-sitebrief-matters}

Di seansên din de, ajanên ji **site_brief** yê we şerê dikin ji bo:

### پارامترەکان بۆ سەرنجراوێکردن (Maintain design consistency across changes) {#viewing-your-sitebrief}

*   دڵنیابConvertTo بە شێوەیەکی یەکگرتوو بێت لە هەموو گۆڕانکارییەکاندا.

### پێشنیارکردنی تایبەتمەندییەکان کە لەگەڵ مەبەستی سایتەکەت دەگونجێن (Suggest features aligned with your site's purpose) {#customizing-after-onboarding}

*   تایبەتمەندییەکانی دیکە پێشنیار بکە کە بە شێوەیەکی باش لەگەڵ مەبەست و ئامانجەکەت بۆ سایتەکەدا بێت.

### پێشنیاری پڕۆژەی تێگەیشتن لە دۆخەکە (Provide context-aware recommendations) {#use-the-design-system-aesthetics-skill}

*   پێناسنامەکانی تایبەت بدە بەو ئەو شتە کە ئێستا دەبینیت و دۆخی ئێستای سایتەکەت بۆ باشتر ڕێنمایی بکات.

### گۆڕینی پرسیارە سیستەماتییەکان لەسەر پێشوەختنی سەرەتایی (Avoid repeating setup questions) {#edit-themejson-directly}

*   پێویست نییە دووبارە ئەو پرسیارانەی کە لە کاتی سەرەتای تنظیموونی سایتەکەدا دەپرسیت، دڵنیا بیت.

### تانە: بینینی پوختەی سایتەکەت (Viewing Your site_brief) {#create-custom-block-templates}
...
## گۆڕینی پاش سەرەتایی (Customizing After Onboarding) {#comparison-old-vs-new-onboarding}

پاش تەواو بوونی ڕێنمایی Theme Builder، دەتوانیت:

### بەکارهێنانی توانای ڕەنگ و شێوەی دیزاین (Use the Design System Aesthetics Skill) {#troubleshooting}
...
### دەستکاری ورد لە theme.json (Edit theme.json Directly) {#next-steps}
