...
## دامەزراندنی پلاگینەکە {#installing-the-plugin}
...
## سەرجەم کۆنتڕۆڵی یەکخستنەوە {#setup-wizard}
...
### هەڵسەنگاندنی پێش دامەزراندن {#pre-install-checks}
...
### ناوەڕۆکی پێشوەختە {#default-content}
...
### پلاگینەکانی ڕەشباز {#recommended-plugins}
