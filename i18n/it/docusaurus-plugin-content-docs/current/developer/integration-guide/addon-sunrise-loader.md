...
## Convenzione di denominazione dei file {#file-naming-convention}
...
## Dove posizionare il file {#where-to-place-the-file}
...
## Hook e filtri disponibili {#hooks-and-filters-available}
...
## Esempio minimo {#minimal-example}
