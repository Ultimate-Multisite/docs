...
## Template del file principale dell'addon
...
### URL di gestione SSO e del sito principale
...
### Domini di base del modulo di checkout
...
### Creazione automatica dei record di dominio
