...
title: >-
  Per favore, fornisci il contenuto del file in modo che io possa procedere con
  la traduzione.
...
|------|------|-------------|
| $custom_headers | `array` | L'array delle intestazioni personalizzate. |
