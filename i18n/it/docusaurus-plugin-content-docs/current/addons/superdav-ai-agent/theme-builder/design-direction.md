...
- **Verificare il contrasto** — usa [Validate Palette Contrast](../abilities/validate-palette-contrast.md) per l'accessibilità
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — controllare l'accessibilità dei colori
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — creare loghi personalizzati
