...
After you have Multisite enabled on WordPress, it is time to install Ultimate Multisite. To correctly install Ultimate Multisite, you must have:
  ...
  * WordPress: v5.3+ (Consigliato: ultima versione stabile)
  * PHP: 7.4.x (supporto a > 8.0 in arrivo)
  * MySQL: v5+ (Consigliato: 5.6, nel caso in cui non disponiate di 8.0 sul vostro provider di hosting)
...
For a detailed guide on how to install Ultimate Multisite, **clicca qui**.
