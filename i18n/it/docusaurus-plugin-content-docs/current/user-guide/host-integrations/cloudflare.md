...
---
# Integrazione Cloudflare {#cloudflare-integration}
...
### 1. Ottieni la tua Cloudflare API Key {#1-get-your-cloudflare-api-key}
...
### 2. Ottieni il tuo Zone ID {#2-get-your-zone-id}
...
### Visualizzazione dei record DNS {#dns-record-display}
...
### In cosa differisce dall’integrazione Cloudflare standard {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Configurazione di Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
### Sottodominio non aggiunto {#subdomain-not-added}
...
### Problemi di proxy {#proxying-issues}
