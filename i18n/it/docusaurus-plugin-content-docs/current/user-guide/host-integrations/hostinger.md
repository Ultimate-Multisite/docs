...
---
# Integrazione Hostinger (hPanel) {#hostinger-hpanel-integration}
...
### 1. Genera il tuo token API di Hostinger {#1-generate-your-hostinger-api-token}
...
### 2. Trova il tuo ID account {#2-find-your-account-id}
...
### Domini aggiuntivi (Addon Domains) {#addon-domains}
