...
---
# Verifica Migrazione Sovrana {#sovereign-migration-verification}
...
## Comandi da eseguire {#commands-to-run}
...
## Errori comuni {#common-failures}

### I permessi del database non corrispondono all'host {#database-grants-do-not-match-the-host}
...
### Le installazioni Bedrock o locali non riescono a connettersi {#bedrock-or-local-installs-cannot-connect}
...
### La coda di push asincrona non viene svuotata (drain) {#async-push-queue-does-not-drain}
...
### Il numero di utenti del tenant è errato {#tenant-user-count-is-wrong}
...
### La visita SSO viene rifiutata {#sso-visit-is-rejected}
...
## Quando riprovare {#when-to-retry}
