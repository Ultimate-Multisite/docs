...
---
# Sovereign Migration Überprüfung {#sovereign-migration-verification}
...
## Befehle zum Ausführen {#commands-to-run}
...
## Häufige Fehler {#common-failures}

### Datenbankberechtigungen stimmen nicht mit dem Host überein {#database-grants-do-not-match-the-host}
...
### Bedrock- oder lokale Installationen können nicht verbinden {#bedrock-or-local-installs-cannot-connect}
...
### Die asynchrone Push-Warteschlange wird nicht geleert {#async-push-queue-does-not-drain}
...
### Die Benutzeranzahl des Tenants ist falsch {#tenant-user-count-is-wrong}
...
### SSO-Besuch wird abgelehnt {#sso-visit-is-rejected}
...
## Wann neu versuchen? {#when-to-retry}
