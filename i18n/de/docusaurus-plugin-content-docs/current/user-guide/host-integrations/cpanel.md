...
### 1. Holen Sie sich Ihre cPanel-Anmeldeinformationen {#1-get-your-cpanel-credentials}
...
### 2. Fügen Sie Konstanten zu wp-config.php hinzu {#2-add-constants-to-wp-configphp}
...
### 3. Aktivieren Sie die Integration {#3-enable-the-integration}
