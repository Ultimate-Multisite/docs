...
### 1. Holen Sie sich Ihre GridPane API-Zugangsdaten {#1-get-your-gridpane-api-credentials}
...
### 2. Holen Sie sich Ihre Server- und Site-IDs {#2-get-your-server-and-site-ids}
...
## SUNRISE-Konstantenverwaltung {#sunrise-constant-management}
