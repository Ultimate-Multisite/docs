...
### 1. Überprüfen Sie Ihren Closte API Key {#1-verify-your-closte-api-key}
...
### 2. Aktivieren Sie die Integration {#2-enable-the-integration}
...
### DNS-Check-Intervall {#dns-check-interval}
