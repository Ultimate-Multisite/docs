...
### 1. Erhalten Sie Ihre ServerPilot-API-Anmeldeinformationen {#1-get-your-serverpilot-api-credentials}
...
### 2. Erhalten Sie Ihre App-ID {#2-get-your-app-id}
...
## SSL-Zertifikatsverifizierung {#ssl-certificate-verification}
