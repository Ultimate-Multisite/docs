...
## Einrichtungshinweise {#setup-instructions}

### 1. Die CyberPanel API aktivieren {#1-enable-the-cyberpanel-api}
...
### 2. Konstanten in wp-config.php hinzufügen {#2-add-constants-to-wp-configphp}
...
### 3. Die Integration aktivieren {#3-enable-the-integration}
...
### 4. Konnektivität überprüfen {#4-verify-connectivity}
...
### E-Mail-Weiterleitungen {#email-forwarders}
