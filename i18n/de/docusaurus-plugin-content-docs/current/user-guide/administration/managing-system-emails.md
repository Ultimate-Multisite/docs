---
title: System-E-Mails verwalten
sidebar_position: 13
...
![Settings – Tab Emails](/img/admin/settings-emails.png)

Von dort aus kannst du auf die Seite **System Emails** zugreifen, um alle E-Mail-Vorlagen zu sehen.

![Liste der System Emails](/img/admin/system-emails-list.png)

Du kannst einzelne E-Mail-Vorlagen auch mit dem System-E-Mail-Editor bearbeiten:
...
So importierst du neue E-Mail-Vorlagen:

1. Gehe zur Seite **System Emails**
2. Klicke oben auf der Seite auf den Button **Reset & Import**
...
1. **Löschen und erneut importieren** — Lösche die System-E-Mail und importiere sie erneut (dadurch werden Versandmetriken gelöscht)
2. **Über das Tool zurücksetzen** — Verwende das Tool **Reset & Import**, aktiviere die Option **Reset** und wähle die E-Mails aus, die du zurücksetzen möchtest

Die Reset-Option wird bevorzugt, da sie Versandmetriken und andere Metadaten beibehält, während der Standardinhalt wiederhergestellt wird.
