---
title: Verstehen des Dashboards
sidebar_position: 7
...
Dieses Widget berichtet über Ereignisse in Ultimate Multisite. Ereignisse umfassen Anmeldungen, Kündigungen, Seitenerstellungen, Löschungen und andere Aktivitäten.
...
![Datumsbereich-Auswahl und Statistiken](/img/admin/um-dashboard-date-range.png)

Der Datumsbereich bestimmt den Zeitraum der von den darunterliegenden Widgets angezeigten Informationen, einschließlich Umsatz, neue Mitgliedschaften, Anmeldungen nach Land, Anmeldungen nach Formular und meistbesuchte Seiten.

![Dashboard-Statistik-Widgets](/img/admin/um-dashboard-stats.png)

:::tip
Um das **Most Visited Sites** Widget zum Laufen zu bringen, aktivieren Sie die Besuchszählung unter **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
