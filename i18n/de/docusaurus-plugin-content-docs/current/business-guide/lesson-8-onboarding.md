---
title: 'Lektion 8: Kunden-Onboarding'
sidebar_position: 9
...
- sich einloggt und eine Website sieht, die bereits wie eine Fitness-Website aussieht → bleibt
- genau weiß, was als Nächstes zu tun ist → bleibt
- sich in einem generischen WordPress-Dashboard verloren fühlt → geht
...
1. **Fügen Sie Ihren Studio-Namen und Ihr Logo hinzu** – Link zum Customizer oder zu den Site Identity Einstellungen
2. **Aktualisieren Sie Ihren Stundenplan** – Direkter Link zum Editor der Seite „Kurse“
3. **Fügen Sie Ihre Trainer hinzu** – Link zum Editor der Seite „Trainer“
4. **Legen Sie Ihre Kontaktdaten fest** – Link zum Editor der Seite „Kontakt“
5. **Vorschau Ihrer Website** – Link zum Frontend
...
- Menüpunkte ausblenden, die für die Verwaltung einer Fitness-Website nicht relevant sind (z. B. Kommentare, falls nicht genutzt)
- Die Menüpunkte neu anordnen, um die am häufigsten verwendeten Elemente zuerst zu platzieren
- Benutzerdefinierte Menübezeichnungen hinzufügen, die für die Nische Sinn ergeben ("Ihr Studio" statt "Erscheinungsbild")
...
- „Das Logo und die Farben Ihres Studios ändern“
- „Ihre eigene Domain verbinden“ (für Growth/Pro Kunden)
- „Ein Buchungs-Widget auf Ihrer Website hinzufügen“
...
- Erstes Login und Orientierung
- Bearbeiten der Startseite
- Aktualisieren des Stundenplans
- Hinzufügen eines neuen Trainers
...
- Ihren aktuellen FitSite-Plan anzuzeigen
- Upgrade-Optionen mit fitnessspezifischen Vorteilen darzustellen
...
- **Aktivierungsrate**: Welcher Prozentsatz der Anmeldungen passt seine Website tatsächlich innerhalb der ersten Woche an?
- **Logins in der ersten Woche**: Wie oft meldet sich ein neuer Kunde in seiner ersten Woche an?
...
├── Checkout Flow (nischenspezifisch, getestet)
├── Branding (Login, Dashboard, E-Mails, Rechnungen, Marketing-Seite)
├── Kunden-Onboarding
│   ├── Quick Start Dashboard Widget
│   ├── Vereinfachtes Dashboard für Fitness-Website-Verwaltung
│   ├── 4-E-Mail-Willkommens-Sequenz
│   ├── Nischenspezifische Wissensdatenbank
│   ├── Video-Anleitungen
│   └── Angepasste Kontoseite
...
- **Eine Willkommens-E-Mail-Sequenz**, die Kunden durch ihre erste Woche führt
- **Nischenspezifische Hilferessourcen**, geschrieben für nicht-technische Betreiber von Fitnessstudios
- **Onboarding-Metriken**, um das Erlebnis zu verfolgen und zu verbessern

---

**Weiter:** [Lektion 9: Preisgestaltung für Profit](lesson-9-pricing) – wir verfeinern die Preisstrategie, um den Umsatz zu maximieren und die Abwanderung zu minimieren.
