...
## Tenant-Bootstrap-Ablauf {#tenant-bootstrap-flow}
...
## SSO- und REST-Hooks {#sso-and-rest-hooks}
...
## Aktions-URLs für souveräne Kunden {#sovereign-customer-action-urls}
...
## Migrationsverifizierung {#migration-verification}
...
## Tenant-Löschung {#tenant-deletion}
...
## Veralteter Datenbank-Router {#deprecated-database-router}
