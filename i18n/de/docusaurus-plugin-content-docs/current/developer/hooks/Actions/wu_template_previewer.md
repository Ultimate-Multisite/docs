...
title: Aktion - wu_template_previewer
...
Wird ausgeführt, wenn sich der Kontext im Template-Previewer befindet.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $template_previewer | `self` | Instanz der aktuellen Klasse. |
