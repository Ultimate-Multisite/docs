...
title: Aktion - wu_multi_tenancy_init
...
Auslöst, nachdem das Multi-Tenancy-Addon vollständig initialisiert wurde.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $addon | `\WP_Ultimo_Multi_Tenancy` | Die Addon-Instanz. phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- wu_ ist ein Standardpräfix für WP Ultimo. |
