...
- **Kontrast überprüfen** — verwenden Sie [Validate Palette Contrast](../abilities/validate-palette-contrast.md) für die Barrierefreiheit
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — Farbarrierefreiheit prüfen
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — benutzerdefinierte Logos erstellen
