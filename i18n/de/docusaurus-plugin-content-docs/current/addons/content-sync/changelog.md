---
title: Content Sync Änderungsprotokoll
sidebar_position: 99
...
* Neu: Vorauswahl von Kindseiten für Template-Seiten
* Neu: Medienextraktion aus post_content für alle Beitragstypen
* Neu: Taxonomiesynchronisierung (Kategorien, Schlagwörter, benutzerdefinierte Taxonomien)
* Geändert: Umbenennung von "Elementor Template Sync" zu "Content Sync"
...
* Vollständige Mediensynchronisierung mit automatischer ID-Neuzuweisung
* Einstellungenintegration mit Ultimate Multisite
* Unterstützung für Seitenausschluss über Netzwerkeinstellungen
* Leeren des Elementor-Caches nach Synchronisierung
* Erhaltung der Template-Taxonomie
