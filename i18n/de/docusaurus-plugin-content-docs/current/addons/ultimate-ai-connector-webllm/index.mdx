...
## Schwebendes Chat-Widget {#floating-chat-widget}
...
### Statusanzeige in der Admin-Leiste {#admin-bar-status-indicator}
...
### Widget aktivieren oder deaktivieren {#how-to-enable-or-disable-the-widget}
...
### Das Chat-Widget erscheint nicht {#the-chat-widget-does-not-appear}
...
### Die Admin-Leisten-Anzeige zeigt „Error“ an {#the-admin-bar-indicator-shows-error}
...
### Modellgewichte werden jedes Mal heruntergeladen {#model-weights-download-every-time}
