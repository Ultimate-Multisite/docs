...
Admins nu admin menu de pages chupa sakne de mauke deta hai, je oh customization da amal pura kar chuke hon.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $should_display_admin_menu | `bool` | Je hamein pages dikhane de hain. |
| $network_active | `bool` | Check karna ki plugin network admin de liye active hai ya nahi. |
