...
- **Contrast verify karein** — accessibility ke liye [Validate Palette Contrast](../abilities/validate-palette-contrast.md) ka upyog karein
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — color accessibility check karein
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — custom logos banayein
