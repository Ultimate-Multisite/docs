...
## Ability Visibility ਕੀ ਹੈ? {#what-is-ability-visibility}
...
## Visibility Levels (ਦਿਖਾਈ ਦੇਣ ਦੇ ਪੱਧਰ) {#visibility-levels}
...
## Ability Visibility Manage ਕਰਨਾ {#managing-ability-visibility}

### Ability Visibility Settings ਤੱਕ ਪਹੁੰਚ ਕਰਨਾ {#accessing-ability-visibility-settings}
...
### Ability Details ਦੇਖਣਾ {#viewing-ability-details}
...
### Visibility Levels ਬਦਲਣਾ {#changing-visibility-levels}
...
### Bulk Operations (ਇੱਕੋ ਵਾਰ ਵਿੱਚ ਕੰਮ) {#bulk-operations}
...
### Partners ਜੋੜਨਾ {#adding-partners}
...
### Partners ਨੂੰ Abilities ਸੌਂਪਣਾ {#assigning-abilities-to-partners}
...
### Partner Access ਵਾਪਸ ਲੈਣਾ (Revoking) {#revoking-partner-access}
...
## Unclassified Abilities (ਅਨ੍ਰਮਿਤ abilities) {#unclassified-abilities}
...
### Unclassified Abilities ਲਈ Admin Notice {#admin-notice-for-unclassified-abilities}
...
### Unclassified Abilities ਦੀ ਸਮੀਖਿਆ ਕਰਨਾ {#reviewing-unclassified-abilities}
...
### Unclassified Abilities ਨੂੰ Classify ਕਿਉਂ ਕਰੀਏ? {#why-classify-unclassified-abilities}
...
## Different Surfaces 'ਤੇ Visibility {#visibility-in-different-surfaces}
...
## Security Best Practices (ਸੁਰੱਖਿਆ ਲਈ ਸਭ ਤੋਂ ਵਧੀਆ ਤਰੀਕੇ) {#security-best-practices}

### Principle of Least Privilege (ਘੱਟੋ-ਘੱਟ ਸਹੂਲਤ ਦਾ ਸਿਧਾਂਤ) {#principle-of-least-privilege}
...
### Third-Party Abilities (ਤੀਜੀ ਧਿਰ ਦੀਆਂ abilities) {#third-party-abilities}
...
## Troubleshooting (ਸਮੱਸਿਆ ਨਿਵਾਰਣ) {#troubleshooting}
...
## Migration from Legacy Mode (ਪੁਰਾਣੇ mode ਤੋਂ ਤਬਦੀਲੀ) {#migration-from-legacy-mode}
