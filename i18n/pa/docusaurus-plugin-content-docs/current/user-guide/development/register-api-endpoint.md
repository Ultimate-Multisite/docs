...
## ਐਂਡਪੁਆਇੰਟ ਦੇ body parameters {#endpoint-body-parameters}
...
## Zapier ਵਿੱਚ ਐਕਸ਼ਨ ਬਣਾਉਣਾ {#creating-an-action-in-zapier}
...
### ਐਕਸ਼ਨ ਬਣਾਉਣਾ {#creating-an-action}
...
### ਪੂਰੇ ਐਂਡਪੁਆਇੰਟ parameters {#complete-endpoint-parameters}
