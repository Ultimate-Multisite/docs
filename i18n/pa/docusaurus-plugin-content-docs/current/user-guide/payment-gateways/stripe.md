...
---
# Stripe Gateway ਸੈੱਟਅੱਪ ਕਰਨਾ (v2) {#setting-up-the-stripe-gateway-v2}
...
## Stripe ਨੂੰ ਐਕਟਿਵ ਕਰਨਾ {#enabling-stripe}
...
### Stripe ਬਨਾਮ Stripe Checkout: {#stripe-vs-stripe-checkout}
...
## Stripe Webhook ਸੈੱਟਅੱਪ ਕਰਨਾ {#setting-up-stripe-webhook}
