...
## Theme Builder Onboarding Flow ਕੀ ਹੈ? {#what-is-the-theme-builder-onboarding-flow}
...
## Theme Builder Onboarding ਸ਼ੁਰੂ ਕਰਨਾ {#starting-the-theme-builder-onboarding}

### ਪਹਿਲੀ ਵਾਰ ਸੈਟਅਪ (First-Run Setup) {#first-run-setup}
...
## Onboarding ਦੇ ਕਦਮ (The Onboarding Steps) {#the-onboarding-steps}

### ਕਦਮ 1: Mode Selection {#step-1-mode-selection}
...
### ਕਦਮ 2: Site Specification {#step-2-site-specification}
...
### ਕਦਮ 3: Design System Decisions {#step-3-design-system-decisions}
...
### ਕਦਮ 4: Theme Generation {#step-4-theme-generation}
...
### ਕਦਮ 5: Activation and Verification {#step-5-activation-and-verification}
...
## Site Specification ਅਤੇ site_brief Memory {#site-specification-and-sitebrief-memory}
...
### site_brief ਕਿਉਂ ਮਹੱਤਵਪੂਰਨ ਹੈ {#why-sitebrief-matters}
...
### ਆਪਣੇ site_brief ਨੂੰ ਦੇਖਣਾ {#viewing-your-sitebrief}
...
## Onboarding ਤੋਂ ਬਾਅਦ ਕਸਟਮਾਈਜ਼ ਕਰਨਾ {#customizing-after-onboarding}

Theme Builder onboarding ਪੂਰਾ ਹੋਣ ਤੋਂ ਬਾਅਦ, ਤੁਸੀਂ ਇਹ ਕਰ ਸਕਦੇ ਹੋ:

### Design System Aesthetics Skill ਦੀ ਵਰਤੋਂ ਕਰਨਾ {#use-the-design-system-aesthetics-skill}
...
### theme.json ਨੂੰ ਸਿੱਧਾ Edit ਕਰਨਾ {#edit-themejson-directly}
...
### Custom Block Templates ਬਣਾਉਣਾ {#create-custom-block-templates}
...
## ਤੁਲਨਾ: ਪੁਰਾਣਾ ਬਨਾਮ ਨਵਾਂ Onboarding {#comparison-old-vs-new-onboarding}
