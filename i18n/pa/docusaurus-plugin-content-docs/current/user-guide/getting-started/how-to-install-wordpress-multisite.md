...
---
# ਮੈਂ WordPress Multisite ਕਿਵੇਂ ਇੰਸਟਾਲ ਕਰਾਂ? {#how-do-i-install-wordpress-multisite}
...
# /wp-admin ਵਿੱਚ trailing slash ਜੋੜੋ {#add-a-trailing-slash-to-wp-admin}
...
## ਆਮ ਸਮੱਸਿਆਵਾਂ: {#common-problems}

### 1\. ਮੈਂ ਨਵੀਆਂ ਸਾਈਟਾਂ ਬਣਾ ਸਕਦਾ/ਸਕਦੀ ਹਾਂ ਪਰ ਉਹ ਐਕਸੈਸ ਨਹੀਂ ਹੋ ਰਹੀਆਂ। {#1-i-can-create-new-sites-but-they-are-not-accessible}
