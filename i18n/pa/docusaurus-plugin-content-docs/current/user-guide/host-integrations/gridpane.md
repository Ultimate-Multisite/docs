...
## ਸੈੱਟਅੱਪ ਹਿਦਾਇਤਾਂ {#setup-instructions}

### 1. ਆਪਣੇ GridPane API ਕ੍ਰੈਡੈਂਸ਼ੀਅਲ ਪ੍ਰਾਪਤ ਕਰੋ {#1-get-your-gridpane-api-credentials}
...
### 2. ਆਪਣੀ Server ਅਤੇ Site ID ਪ੍ਰਾਪਤ ਕਰੋ {#2-get-your-server-and-site-ids}
...
### 4. ਇੰਟੀਗ੍ਰੇਸ਼ਨ ਨੂੰ ਸਮਰੱਥ ਕਰੋ {#4-enable-the-integration}
...
## SUNRISE Constant ਪ੍ਰਬੰਧਨ {#sunrise-constant-management}
