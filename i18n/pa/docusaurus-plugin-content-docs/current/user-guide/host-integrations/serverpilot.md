...
### 1. ਆਪਣੇ ServerPilot API ਕ੍ਰੇਡੈਂਸ਼ੀਅਲ ਪ੍ਰਾਪਤ ਕਰੋ {#1-get-your-serverpilot-api-credentials}
...
### 2. ਆਪਣੀ App ID ਪ੍ਰਾਪਤ ਕਰੋ {#2-get-your-app-id}
...
### 4. ਇੰਟੀਗ੍ਰੇਸ਼ਨ ਨੂੰ ਚਾਲੂ ਕਰੋ {#4-enable-the-integration}
...
## SSL ਸਰਟੀਫਿਕੇਟ ਵੈਰੀਫਿਕੇਸ਼ਨ {#ssl-certificate-verification}
