...
## ਕੌਂਫਿਗਰੇਸ਼ਨ (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## ਸੈੱਟਅੱਪ ਦੀ ਪੁਸ਼ਟੀ ਕਰਨਾ {#verifying-setup}
...
## ਉਦਾਹਰਨ API ਕਾਲ (cURL) {#example-api-call-curl}
