...
---
# Enhance ਕੰਟਰੋਲ ਪੈਨਲ ਇੰਟੀਗ੍ਰੇਸ਼ਨ {#enhance-control-panel-integration}
...
### ਸਿਸਟਮ ਲੋੜਾਂ {#system-requirements}
...
### API ਪਹੁੰਚ {#api-access}
API tokens ਬਣਾਉਣ ਲਈ ਤੁਹਾਡੇ ਕੋਲ Enhance ਕੰਟਰੋਲ ਪੈਨਲ ਦੀ ਐਡਮਿਨਿਸਟ੍ਰੇਟਰ ਪਹੁੰਚ ਹੋਣੀ ਚਾਹੀਦੀ ਹੈ।

## ਆਪਣੇ API ਕ੍ਰੀਡੈਂਸ਼ੀਅਲਜ਼ ਪ੍ਰਾਪਤ ਕਰਨਾ {#getting-your-api-credentials}

### 1. API Token ਬਣਾਓ {#1-create-an-api-token}
...
### 2. ਆਪਣਾ Organization ID ਲਓ {#2-get-your-organization-id}
...
### 3. ਆਪਣਾ Server ID ਲਓ {#3-get-your-server-id}
...
### 4. ਆਪਣਾ API URL ਲਓ {#4-get-your-api-url}
...
### ਲੋੜੀਂਦੇ Constants {#required-constants}
...
### Integration Wizard ਰਾਹੀਂ ਸੈੱਟਅੱਪ {#setup-via-integration-wizard}
...
## ਵਾਧੂ WordPress ਕੌਂਫਿਗਰੇਸ਼ਨ {#additional-wordpress-configuration}
...
### .htaccess ਕੌਂਫਿਗਰੇਸ਼ਨ {#htaccess-configuration}
...
### ਜਦੋਂ ਕੋਈ ਡੋਮੇਨ ਮੈਪ ਕੀਤਾ ਜਾਂਦਾ ਹੈ {#when-a-domain-is-mapped}
...
### ਜਦੋਂ ਕੋਈ ਡੋਮੇਨ ਹਟਾਇਆ ਜਾਂਦਾ ਹੈ {#when-a-domain-is-removed}
...
### DNS ਅਤੇ SSL ਜਾਂਚ {#dns-and-ssl-checking}
...
## ਸੈੱਟਅੱਪ ਦੀ ਪੁਸ਼ਟੀ {#verifying-setup}

### ਕਨੈਕਸ਼ਨ ਟੈਸਟ ਕਰੋ {#test-the-connection}
...
### ਡੋਮੇਨ ਮੈਪ ਕਰਨ ਤੋਂ ਬਾਅਦ {#after-mapping-a-domain}
...
### DNS ਜਾਂਚ ਅੰਤਰਾਲ {#dns-check-interval}
...
### ਪ੍ਰਮਾਣੀਕਰਨ ਗਲਤੀਆਂ {#authentication-errors}
...
### ਆਮ ਵਰਤੇ ਜਾਣ ਵਾਲੇ Endpoints {#common-endpoints-used}
...
### ਪੂਰੀ API ਦਸਤਾਵੇਜ਼ੀ {#full-api-documentation}
...
## ਵਾਧੂ ਸਰੋਤ {#additional-resources}
