...
---
# RunCloud ਇੰਟੀਗ੍ਰੇਸ਼ਨ {#runcloud-integration}
...
## ਸੈੱਟਅੱਪ ਦੀਆਂ ਹਿਦਾਇਤਾਂ {#setup-instructions}

### 1. ਆਪਣੇ RunCloud API ਕ੍ਰੀਡੈਂਸ਼ੀਅਲ ਪ੍ਰਾਪਤ ਕਰੋ {#1-get-your-runcloud-api-credentials}
...
### 2. ਆਪਣੀ Server ਅਤੇ App ID ਪ੍ਰਾਪਤ ਕਰੋ {#2-get-your-server-and-app-ids}
