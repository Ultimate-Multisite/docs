...
## ਸੈਟਅਪ ਨਿਰਦੇਸ਼ (Setup Instructions) {#setup-instructions}

### 1. ਆਪਣਾ Hostinger API Token ਬਣਾਓ {#1-generate-your-hostinger-api-token}
...
### 2. ਆਪਣਾ Account ID ਲੱਭੋ {#2-find-your-account-id}
...
### 3. wp-config.php ਵਿੱਚ Constants ਜੋੜੋ {#3-add-constants-to-wp-configphp}
...
### 4. Integration ਨੂੰ Enable ਕਰੋ {#4-enable-the-integration}
...
## ਜ਼ਰੂਰੀ ਨੋਟਾਂ (Important Notes) {#important-notes}
