...
---
# Custom Registrar Integration ਬਣਾਉਣਾ {#building-a-custom-registrar-integration}
...
## Registering your capability {#registering-your-capability}
...
## Wizard ਵਿੱਚ credential fields ਜੋੜਨਾ {#adding-credential-fields-to-the-wizard}
...
## Post-registration actions ਲਈ Hooks {#hooks-for-post-registration-actions}
