...
## Heyət Statusunun Dövrü {#membership-status-lifecycle}
...
### Heyətlər Necə Bitmiş Statusuna Keçir {#how-memberships-transition-to-expired}
...
#### Avtomatik Yenilənən və Avtomatik Yenilənməyən Heyətlər {#auto-renewing-vs-non-auto-renewing-memberships}
...
### Sınaq Müddətləri Necə Bitir {#how-trials-end}
...
## Frontend Girişinin Bloklanması {#block-frontend-access}
...
### Parametrin Konfiqurasiyası {#configuring-the-setting}
...
### Sayt Bloklandığı Zaman Ziyarətçilər Nə Görürlər {#what-visitors-see-when-a-site-is-blocked}
...
### Nə Bloklanır və Nə Vaxt {#what-gets-blocked-and-when}
...
## Problem-Solving: Bitmə Sonra Saytların Əlçatan Qalması {#troubleshooting-sites-remaining-accessible-after-expiration}

Heyətlər bitdikdən sonra saytlar ictimaiyyətə açıq qalırsa, bu yoxlamaları ardıcıl olaraq yerinə yetirin:

### 1. Block Frontend Access Parametrinin Aktiv Olduğunu Yoxlayın {#1-verify-the-block-frontend-access-setting-is-enabled}
...
### 2. Frontend Block Grace Period-i Yoxlayın {#2-check-the-frontend-block-grace-period}
...
### 3. Heyət Statusunun Əslində Dəyişdiyini Təsdiqləyin {#3-confirm-the-membership-status-has-actually-changed}
...
### 4. Action Scheduler-in İşlədiyini Yoxlayın {#4-verify-action-scheduler-is-running}
...
### 5. Qapı Webhook Problemlərinə Baxın (Avtomatik Yenilənən Heyətlər) {#5-check-for-gateway-webhook-issues-auto-renewing-memberships}
...
### 6. Bitmə Nəzakət Müddətinə Baxın (Cron Səviyyəsi) {#6-check-the-expiration-grace-period-cron-level}
...
### 7. Heyəti Əl ilə Bitirmək {#7-manually-expire-a-membership}
...
## Developer Referansı {#developer-reference}
