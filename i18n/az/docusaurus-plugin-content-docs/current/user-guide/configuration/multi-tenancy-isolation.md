...
## İzolasiya strategiyası (Isolation strategy)
...
## Verilənlər bazası host bağlama (Database host binding)
...
## Fayl sistemi kökü (Filesystem root)
...
## Təminat sırası (Provisioning order)
...
## Suveren müştəri idarəetmə axınları (Sovereign customer management flows)
