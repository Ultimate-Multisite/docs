...
## Domen məhsulu yaratmaq {#creating-a-domain-product}
...
## Domain settings tab (Domen Ayarları tabı) {#domain-settings-tab}
...
### Supported TLDs (Dəstəklənən TLD-lər) {#supported-tlds}
...
### Markup type (Qiymət artırma növü) {#markup-type}
...
### Introductory pricing (Təqdimat qiymətləndirməsi) {#introductory-pricing}
...
### WHOIS privacy (WHOIS məxfiliyi) {#whois-privacy}
...
## TLD idxalı və sinxronizasiyası {#tld-import-and-sync}
...
## Auto-renewal (Avtomatik yeniləmə) {#auto-renewal}
...
## Admin: Manual domain registration (Admin: Əl ilə domen qeydiyyatı) {#admin-manual-domain-registration}
