...
### 1. WPMU DEV Hostingini Yoxlayın {#1-verify-wpmu-dev-hosting}
...
### 2. İnteqrasiyanı Aktivləşdirin {#2-enable-the-integration}
...
### SSL Sertifikatları Problemləri {#ssl-certificate-issues}
