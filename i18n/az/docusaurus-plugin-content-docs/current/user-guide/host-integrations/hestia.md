...
---
# Hestia Control Panel İntegrasiyası {#hestia-control-panel-integration}
...
## Konfiqurasiya (Sihirbaz → İntegrasiyalar → Hestia) {#configuration-wizard--integrations--hestia}
...
## Qurulumu Yoxlamaq {#verifying-setup}
...
## Nümunə API Çağırışı (cURL) {#example-api-call-curl}
