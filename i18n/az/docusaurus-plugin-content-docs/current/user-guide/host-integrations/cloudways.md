...
### 1. Cloudways API Giriş Məlumatlarınızı Alın
...
### 2. Server və Tətbiq ID-lərinizi Alın
...
### SSL Sertifikatlarının İdarə Edilməsi
...
### Ultimate Multisite şəbəkəsi üçün tövsiyə olunan Cloudways SSL quruluşu
