...
## Təkmilləşdirilmiş Mətn {#users-and-administrators}

### Başlıq: Domen Strukturları və Subdomainlərin İşləmə Prinsipi {#media}
...
### 1. Domen Adları Nədir? (Əsas Konsept) {#permalinks}
...
### 2. Alt Domenlər (Subdomains) və Onların Rolu {#static-pages}
...
### 3. Texniki İşləmə Prinsipi: DNS Rolu {#registration}
...
### 4. Nəticə: Nə vaxt hansını istifadə etməli? {#domain-and-ssl}
