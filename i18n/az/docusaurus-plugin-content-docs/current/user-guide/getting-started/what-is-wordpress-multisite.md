...
---
# WordPress Multisite nədir? {#what-is-wordpress-multisite}
...
## WordPress Multisite tam olaraq nədir? {#what-exactly-is-wordpress-multisite}
...
## Alt saytlarda nə paylaşılır və nə paylaşılmır {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite-da istifadəçi idarəetməsi {#user-management-on-wordpress-multisite}
...
## Performans nəzərdən keçirilməsi {#performance-considerations}
