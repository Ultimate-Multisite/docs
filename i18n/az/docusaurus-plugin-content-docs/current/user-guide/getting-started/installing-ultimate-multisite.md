...
## Pluginin quraşdırılması {#installing-the-plugin}
...
## Quraşdırma Sehrbazı {#setup-wizard}
...
### Quraşdırmadan əvvəl yoxlamalar {#pre-install-checks}
...
### Standart Məlumatlar {#default-content}
...
### Tövsiyə Olunan Pluginlər {#recommended-plugins}
