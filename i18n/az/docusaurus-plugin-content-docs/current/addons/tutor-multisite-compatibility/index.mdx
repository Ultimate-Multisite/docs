...
# Tutor Multisite Uyğunluğu {#tutor-multisite-compatibility}
...
## MU Plugin-dən Köçürülmüş Funksionallıq {#functionality-moved-from-mu-plugin}
...
## Verilənlər Bazası İdarəetməsi {#database-management}
...
### Təsir Edən Cədvəllər {#affected-tables}
...
### Admin İnterfeysi {#admin-interface}
