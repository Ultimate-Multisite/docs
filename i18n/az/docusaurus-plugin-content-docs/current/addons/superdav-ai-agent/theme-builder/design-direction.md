...
- **Əsas rəng** — düymələr, linklər və vurğular üçün istifadə edilən əsas brend rəngi
- **İkincil rəng** — müxtəliflik üçün tamamlayıcı rəng
- **Vurğu rəngi** — vacib elementlər üçün diqqət çəkən rəng
...
- **Başlıq fontu** — səhifə başlıqları və bölmə başlıqları üçün istifadə olunur
- **Mətn fontu** — abzasa mətn və məzmun üçün istifadə olunur
- **Font ölçüləri** — müxtəlif ekran ölçüləri üçün adaptiv ölçülənmə
...
- **İkonlar** — ikon stili və ölçülənməsi
...
- Bütün sütunlarla tam yerləşdirmə
...
- Adaptiv naviqasiya (hamburger menyusu)
- Bir sütunlu yerləşdirmə
...
| Cihaz | En | Önizləmə |
|--------|-------|---------|
| **Mobil** | 375px | Portret telefon |
| **Planşet** | 768px | Peyzaj planşeti |
...
1. **Rəngləri tənzimləmək** — palitradakı istənilən rəngi dəyişin
2. **Fontları dəyişmək** — fərqli şriftlər seçin
3. **Boşluğu dəyişmək** — padding və marginləri tənzimləyin
...
- Masaüstü önizləməsi dərhal yenilənir
- Mobil önizləməsi dərhal yenilənir
...
- **Orijinal dizayn** — nəyin dəyişdiyini görün
...
1. **Hər iki önizləməni yoxlayın** — masaüstü və mobil görünüşün yaxşı olduğundan əmin olun
2. **Bütün rəngləri yoxlayın** — kontrast və əlçatanlıqdan əmin olun
3. **Tipoqrafiyanı sınaqdan keçirin** — bütün ölçülərdə oxunaqlığı yoxlayın
...
1. Tema Qurucu sizin tam temanızı yaradır
2. Tema WordPress saytınıza quraşdırılır
...
- **Kontrastı yoxlayın** — əlçatanlıq üçün [Validate Palette Contrast](../abilities/validate-palette-contrast.md) istifadə edin
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — rəng əlçatanlığını yoxlayın
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — fərdiləşdirilmiş loqolar yaradın
