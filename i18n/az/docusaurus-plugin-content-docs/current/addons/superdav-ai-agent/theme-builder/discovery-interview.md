...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Fotoqrafiyalar üçün tövsiyə olunur |
| **PNG** | `.png` | Şəffaflığı dəstəkləyir |
...
- **Rəng palitrası** — dominant rənglər çıxarılır və temada istifadə olunur
- **Vizual üslub** — müasir, kənd təsərrüfatı, minimal, canlı və s.
- **Əhval və atmosfer** — peşəkar, yaradıcı, mehriban, lüks və s.
...
- **Mood boardlar** — istədiyiniz estetikanı təmsil edən şəkillər kolleksiyaları
- **Məhsul fotoqrafiyaları** — göstərmək üçün məhsullarınız varsa
...
- **Mətnlə yüklənmiş şəkillər** — çox mətnli skrinşotlar
...
3. **Çeşitlilik yaradın** — rəng, üslub və mövzu baxımından qarışdırın
...
- **Rəng palitrası** — əsas, ikincil və vurğu rəngləri
- **Tipoqrafiya** — başlıqlar və mətn üçün şrift ailələri
- **Yerləşdirmə üslubu** — boşluq, hizalama və komponent düzülüşü
...
1. Yaradılan dizayn istiqamətini nəzərdən keçirin
2. Rəy verin və ya tənzimləmə tələb edin
...
- [Tools and Configuration](./tools.md) — mövcud alətlər və konfiqurasiya seçimləri
