...
## Uçan Söhbət Widget-ı {#floating-chat-widget}
...
### Admin-Bar Status Göstəricisi {#admin-bar-status-indicator}
...
### Widget-ı Aktivləşdirmək və ya Deaktivləşdirmək {#how-to-enable-or-disable-the-widget}
...
## Widget Parametrləri {#widget-settings}
...
## SharedWorker İşləmə Mühiti {#sharedworker-runtime}
...
### Söhbət widget-ı görünmür {#the-chat-widget-does-not-appear}
...
### Admin-bar göstəricisi "Error" göstərir {#the-admin-bar-indicator-shows-error}
...
### Model çəkisi hər dəfə yüklənir {#model-weights-download-every-time}
