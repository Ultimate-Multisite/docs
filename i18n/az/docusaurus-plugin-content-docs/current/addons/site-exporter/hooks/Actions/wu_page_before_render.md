...
Bu hərəkət (action) səhifə render edilməzdən əvvəl işə düşür.
...
[`inc/admin-pages/class-base-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/admin-pages/class-base-admin-page.php#L356) faylında 356-cı sətirdə təyin olunub
