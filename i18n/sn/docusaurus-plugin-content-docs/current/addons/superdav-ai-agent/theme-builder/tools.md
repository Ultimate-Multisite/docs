---
title: Zvishandiso uye Kumisikidza
sidebar_position: 4
...
- **Kuongorora website** — kukopa uye kuongorora mawebsite evakwikwidzi kana ekukurudzira
- **Kuburitsa dhizaini** — kuziva mavara, mafonti, uye mapatani ekuronga
- **Chimiro chezviri mukati** — kunzwisisa kurongeka kwemapeji uye nhanho dzawo
- **Kuona maficha** — kuziva maplugin uye mashandiro
- **Kuongorora mashandiro** — kutarisa kumhanya kwepeji uye kuvandudzwa
- **Kuongorora SEO** — kuongorora meta tags uye data rakarongwa

**Mashandisirwo:**

```
Ongorora dhizaini yeexample.com uye uishandise sekurudziro yesite yangu.
```

**Zvainoburitsa:**

- Palette yemavara uye mashandisirwo emavara
- Typography (mafonti uye saizi)
- Chimiro chekuronga uye nzvimbo
- Mapatani ekufambisa
- Kurongeka kwezviri mukati
- Kushandiswa kwemifananidzo nemedia
- Zvinhu zvinodyidzana
- Kupindura kwemobile

**Miganhu:**

- Haikwanisi kukopa masite akadzivirirwa nepassword
- Inoremekedza robots.txt nemitemo yesite
- Inogona kusabata zvizere zvirimo zvinochinja
...
- Kugadzirwa kweCustom CSS
- Kugadzirwa kweanimation
- Dhizaini yezvinhu zvinodyidzana
...
Kugona kweAdvanced companion kunogona kusanganisira:

- **Zvishandiso zvefilesystem** — kuongorora uye kugadzirisa mafaera akatenderwa munzvimbo dzinovimbwa
- **Zvishandiso zvedatabase** — kubvunza kana kugadzirisa data yesite kana zvapihwa mvumo pachena
- **Zvishandiso zveWP-CLI** — kumhanyisa mirairo yekuchengetedza uye kuongorora WordPress
- **Zvishandiso zveREST dispatcher** — kufonera maREST endpoints akanyoreswa kuburikidza nemafambisirwo ebasa anodzorwa ekutumira
- **Zvishandiso zvekuvaka plugin** — kugadzira hwaro uye kudzokorora pakodhi yeplugin
- **Zvishandiso zveGit snapshot** — kugadzira snapshots usati waita mabasa ane ngozi evagadziri
- **Zvishandiso zvekutonga vashandisi** — kubatsira kuongorora kana kugadzirisa marekodhi evashandisi panotenderwa
- **Zvishandiso zvebenchmark** — kumhanyisa mabhenchimaki emashandiro kana kugona kuitira ongororo yebudiriro
...
1. Enda ku **Gratis AI Agent → Settings**
2. Enda ku **Theme Builder → Tools**
...
- **Kukopa site** — kunoda kuwana internet
- **Analytics** — inoda kubatanidzwa neGoogle Analytics
- **Kugadzira zvirimo** — kunoda API keys
...
1. Enda ku **Gratis AI Agent → Settings → API Keys**
2. Isa credentials yechishandiso chimwe nechimwe
3. Edza kubatana
...
```
Ongorora dhizaini yesite yemukwikwidzi wangu pa competitor.com
...
```
Bvisa palette yemavara kubva kuexample.com uye uishandise sekurudziro.
```

```
Ongorora chimiro chekufambisa cheexample.com uye shandisa kurongeka
kwakafanana pasite yangu.
```

```
Tarisa kupindura kwemobile kweexample.com uye iva nechokwadi chekuti site yangu
...
```
Enzanisa madhizaini e site1.com ne site2.com uye gadzira dhizaini
...
- Shandisa ongororo kuti uwane kufemerwa, kwete kukopa
...
3. **Bvisa mavara** — shandisa mapalette emavara sepokutangira
...
3. **Simbisa kodzero** — iva nechokwadi chekuti unogona kushandisa zvirimo zvabviswa
...
3. **Isa zvinotarisirwa** — tsanangura zvinangwa zvako zvekugadzira
...
- Masaiti makuru anogona kupera nguva
...
- [Menu dzeHospitality](./hospitality-menus.md) — gadzira mapeji emenu
