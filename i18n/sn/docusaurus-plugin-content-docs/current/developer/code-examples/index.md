---
title: Mienzaniso yeKodhi Yepamusoro
sidebar_position: 1
...
Zvikumbiro zviviri zvinoitika panguva imwe chete zvinogona kuverenga kukosha kumwe chete uye zvose zvonyora zvakare mhedziso imwechete yakawedzerwa, zvichirasikirwa nekuverenga kumwe. `increment_item()` inoendesa arithmetic ku database engine nechirevo chimwe che `UPDATE ... SET column = column + ?`, ichiita kuti operation yacho ive atomic pachayo.
