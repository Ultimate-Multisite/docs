...
title: Sefa - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Zita rechikamu. Kazhinji chinhu chakaita se state, province, region, nezvimwe. |
| $country_code | `string` | Kodhi yeISO ine mavara maviri yenyika. |
| $state_code | `string` | Kodhi yeISO ine mavara maviri ye state. |
