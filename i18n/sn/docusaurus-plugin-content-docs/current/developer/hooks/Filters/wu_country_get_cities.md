...
title: Sefa - wu_country_get_cities
...
|------|------|-------------|
| $cities | `array` | Rondedzero yemazita emaguta edunhu. Hapana makiyi aripo. |
| $country_code | `string` | Kodhi yeISO yemavara maviri yenyika. |
