...
## Kuratidza Kuti (Setup Instructions)

### 1. Shandisa ServerPilot API Credentials yako
...
### 3. Shandisa Constants mu wp-config.php
...
## Izvi Zvinogona Kuenda Sei (How It Works)

### Kuratidza Domain Syncing
...
## Kuratidza Matambudziko (Troubleshooting)

### Matambudziko ekutanga ne API Connection
...
### Matambudziko ekuti SSL Certificate Inotanga
