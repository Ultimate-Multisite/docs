...
## Mhando Yekubatanidza (Setup Instructions)

### 1. Shandisa API Credentials dzako dzeCloudways
...
### 2. Shandisa Server ID neApplication IDs dzako
...
## Izvi zvinhu zvinoreva (How It Works)
...
## Zvinhu Zvinofanira Kuti Uve Ndizvo — Wildcard SSL Pitfall
...
## Kuti Unenge Uyuva Matambudziko (Troubleshooting)
...
### Matambudziko anorwisi SSL Certificate
