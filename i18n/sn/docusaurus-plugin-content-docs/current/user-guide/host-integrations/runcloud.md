...
## Maelekezo ya Kuweka (Setup Instructions)

### 1. Pata Vitambulisho vya API vya RunCloud
...
### 2. Pata Maalum ya Server na App Yako
...
### 4. Washa Integration (Enable the Integration)
...
## Ino Inengei Kufanya Nini? (How It Works)
