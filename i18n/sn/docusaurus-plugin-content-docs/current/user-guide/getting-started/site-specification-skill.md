...
- **Chingiro chesite (Site purpose)**: Chiita chii site yako uye chii chiri chako
- **Vanhu vanogona kuenda pano (Target audience)**: Vanhu vanogona kuenda pano uye zvinhu vanodzivirira
- **Chiri chendo chekugadzirisa kwako (Brand identity)**: Mwariro wakako, nzira yakaiwa yako, uye chiri chete chekugadzirisa kwako
- **Makore ekugara (Business goals)**: Kuti kune mufanana unenge uri site yako
- **Chinhu chinokosha chehupenyu (Content structure)**: Site yako inowanikwa sei
...
- Makore aino uye vanhu vanogona kuenda pano
- Mwariro wakako uye nzira yako yekugadzirisa kwako
...
- Vashandise zvinhu zvinobatanidza nechingiro chesite chesite chesite chesite
- Vashandise chinhu chinokosha chehupenyu chako
...
Miutaurei kutaura Site Specification sei nguva yese:

```
"Tiri tiri rineitezo renyika renyika"
```
...
```
Chii chiri chinangwa chesite?
- Store ya zvinovaka (E-commerce store)
- Blog kana site yezvinhu (Blog or content site)
- Portfolio kana kuona zvinhu (Portfolio or showcase)
- SaaS application
- Community kana forum
- Other: [chiri chiri]
```
...
- Vana vanovaka / vanhu vose
- Vabasa vebusiness
- Vana vanovaka / vanhu vanovaka (Developers / technical users)
- Vanovaka / vanovaka (Students / educators)
- Other: [chiri chiri]
...
- Primary color: [color picker kana hex code]
- Secondary color: [color picker kana hex code]
- Accent color: [chiri chiri]

Unenge uunoda kuita mwari weBrand wako sei?
- Professional / corporate (Maviri)
- Creative / artistic (Maviri)
- Playful / casual (Maviri)
- Minimal / modern (Maviri)
...
- Kuita leads (Generate leads)
- Kuva zvinhu (Sell products)
- Kutaura community (Build community)
- Kuratidza kunzwisisa (Share knowledge)
- Kubatsira (Establish authority)
- Other: [chiri chiri]

Chii chinenge chiri chiri?
- Revenue (Miti)
- User engagement (Kuti vanhu vashandi vashandise)
- Content reach (Kuti zvinhu zvinofanira kuone)
- Conversions (Kuti vanhu vashande zvakasiyana)
- Other
```
...
- Flat (zvinhu zvose zviri mumwe nguva)
- Hierarchical (categories kana subcategories)
- Chronological (kuti zvinofanira kuita blog)
- Product-based (catalog)
- Other: [chiri chiri]

Mhando dzinenge dzineita?
- Blog posts
- Product pages
- Case studies
- Documentation
...
- Kana uchigara ku munhu wechokwadi wepfungwa
- Kana uchishandisa zvinhu dzinobva
...
- "Tiri kuita munhu vachikuru vanoda kune zvinhu zvakakwana pane kunzwisisa"
...
Unogona kutaura Site Specification pamwe nekuita izvi kana:

- Kuratidza zvinodiwa pakati pekuita zvakasiyana
- Kuratidza site_brief yako kana chiri chinobata
- Kuratidza specification yakakwana pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba pamba p

**Ndinoda kuitanga nguva yakare ne-site_brief chete**
- Chida agent: "Clear my site brief and start fresh" (Chibvumira/Fara site brief wangu uye kuita zviri mutsva)
- Ndipo chida kuratidza Site Specification pfungwa.

**Agent inopa zvinhu zvinoreva kuti hazvirei nemunhu anogona kukwanisa (recommendations) zvakasiyana ne-site_brief wangu**
- Chida agent kuti "review my site brief" (kuratidza/kufamba nguva yakare site brief wangu)
...
1. **Gara neTheme Builder**: Gita theme mutsva kubva pa site_brief yako
2. **Rendera Chinhu chekugadzirisa (Refine Design)**: Shandi skill ya Design System Aesthetics kuti uita zvinoreva kudzidzira zvakawanda zvekuita design.
3. **Tora Mhando Yemabhuku (Plan Content)**: Gita agents kuti vave nemarudzo ekurasa mhando yezvinhu (content structure recommendations).
4. **Gadzira Zvinoreva (Build Features)**: Gita features dziri kuitira zvinhu zvako zvinoreva nekugara nekuita zvinhu zvakakosha kwemafungiro ako (business goals).
