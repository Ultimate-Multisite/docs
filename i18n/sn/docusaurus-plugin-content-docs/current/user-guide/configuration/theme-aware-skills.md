---
title: >-
  Maviri anogona kuita zvinhu zvakasiyana-siyana nemafanirano ekuti
  zvinoshandiswa.
sidebar_position: 27
...
- **Documentation yekuti hutano rako unogona kushandisa uye kuva wako** — zvinhu zvinopairika kuti utsvake uye kuva wako
- **References dzemblock uye patterns** — blocks, patterns, uye matsvaka ekugadzirisa (design options) dzinobva
...
Skill ya Block Themes inopa zvinhu zvinopairika nezve:

- Kuita uye kuendawo (editing) templates nekubata (block editor)
- Kuti utsvake nemapatern uye blocks dzinogona kutanga (reusable blocks)
- Kuva wako styles dzakawanda uye settings dzemtheme.json
- Kushandisa theme blocks uye variations
- Kuita custom block patterns kuti site yako inenge yakaita sei
...
Skill ya Classic Themes inopa zvinhu zvinopairika nezve:

Kutiwe nemafungwaro ekugadzirwa:

*   Kugara nePHP template files uye hooks
*   Kugadzirisa rifundo retheme (theme appearance) kuburikidza neCustomizer
*   Kugona kuita widget areas uye sidebars
*   Kugadzirisa CSS uye development ya child theme
*   Kugona kutsvaga nzira dzinogona dzine theme hierarchy uye template tags
...
Skill ya Kadence Blocks inopa nguva yakawanda pamusoro pe:

*   Kugara nekugona kuita kadai dzakanyisa dzinogona dzinowanikwa muKadence (Hero, Testimonials, Pricing, nhegudzo dzine zvakanyisa).
*   Kugadzirisa settings uye options dzemafungwaro (block settings) uye responsive.
*   Kugadzira layouts dzakakwana negrid uye container blocks dzemukuru weKadence.
*   Kugara nekugona kuita Kadence blocks nemu theme yako.
*   Kugara nekugona kuita design system uye presets dzemukuru weKadence.
...
Skill ya Kadence Theme inopa nguva yakawanda pamusoro pe:

*   Kugadzirisa Kadence theme kuburikidza nemafungwaro ekugara (global styles) uye theme.json.
*   Kugara nekugona kuita patterns uye templates dzakanyisa dzinogone muKadence.
*   Kugadzirisa settings uye options dzemukuru weKadence.
*   Kugadzira designs dzakakwana nedesign system ya Kadence.
*   Kugara nemu popular plugins uye tools dzemukuru weKadence.
...
1. Unenge uri munhu anogona kuita blocks (block theme) uye asistensti inowanikwa ye **Block Themes** inoshandiswa.
...
**Kune Classic Themes:**
> "Shandisa custom widget area pamusoro ye sidebar nekubatsira kubva muuno hweiri (child theme)."

**Kune Kadence Blocks:**
> "Tora testimonials section sei tiri shandisa Kadence Testimonials block."

**Kune Kadence Theme:**
> "Rendesa layout ya header uye styling ya navigation menu."

Asistensti inogona kuita matendo ekunzwisisa kubva muuno hweiri uye code examples dzinobva muno hweiri dzine kuratidza theme yako yakare uye plugins dzakare.

:::note
Skills dzinovaka themes dzine kutarisirwa zvakare zvinogone kuonekwa kune Superdav AI Agent v1.10.0 uye kubva. Haichii kune kukosha kwekuita setup kana kuratidza.
:::
