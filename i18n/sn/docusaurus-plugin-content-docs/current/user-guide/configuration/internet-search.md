...
## Inenge Inenge Yakwanisa Kuti Iwe Kurungu Kunechira (How It Works)
...
## Kuratidza Kurungu Kunechira (Enabling Internet Search)
...
### Kuita API Key ya Brave Search (Obtaining a Brave Search API Key)
...
### Limits Yekuti Iwe Uye (Usage Limits)
...
## Kupa Mashure Anogone Kubva pa Internet
