...
Iyi ndiyo nzira yakakwana ya kurudzira WordPress community. Kana kurudzira kuva nekuita, inogona kutsimuka nekuti inoshandiswa mu updates dzepaininisi dze plugin dzese dze Ultimate Multisite.

**Tichatanga!** Kana uchida kutaura ndiro yakasiyana-siyana neEnglish, ndichida kuti uingine utaurire kurudzira. Kurudzira zvinhu zvishoma kunogona kuita. Kuti usimbe, unofanira:

1. Tinga [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Chigadzirisa chako chetiro (Select your language)
3. Chibvumira "Contribute Translation"
4. Unofanira kuva neaccount yakasiyana-siyana ya WordPress.org
...
2. Funga file yekuita `.pot` kubva mu `wp-content/plugins/ultimate-multisite/lang/`
3. Translate strings mu interface ya Poedit
