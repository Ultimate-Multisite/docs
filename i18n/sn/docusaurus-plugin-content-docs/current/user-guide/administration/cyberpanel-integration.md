...
## Maonero ya Kufamba (Setup Instructions)

### 1. Faraura API ya CyberPanel
...
### 2. Shanda Constants ku wp-config.php
...
### 4. Kuona Kuti Zvinoregerera (Verify Connectivity)
...
## Kuti Unzire (Troubleshooting)

### API Connection Inorekererwa
