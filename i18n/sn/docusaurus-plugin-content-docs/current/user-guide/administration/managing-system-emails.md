---
title: Kugara/Kubatsira Email dzemabhizinesi
sidebar_position: 13
...
Kubva pano, unogona kuenda kune kurumbidza kwemabhumbi (System Emails) kuti uone imihiro yese yemashoko.

![System Emails list](/img/admin/system-emails-list.png)

Unogonawo kungeura imihiro yakasiyana-yana nemashoko nekubata imihiro iyi munzvimbo yekurumbidza kwemabhumbi (system email editor):
...
Kuti utore (import) imihiro yakadzama:

1.enda kune kurumbidza kwemabhumbi (System Emails)
2.chibvumirano **Reset & Import** chiri pamusoro nemaoko ekupedzisira (top of the page)
...
1. **Kupada nekubata nekuita zvakanaka (Delete and re-import)** — Pada system email uye utorewowowo (import)wowowowo (re-import). (Izvi zvinopada metrics dzemashoko).
2. **Kuratidza kubva panzvimbo (Reset via the tool)** — Shanda **Reset & Import** yakasiyana, simba option ya **Reset**, uye chigadzira imihiro unoziva kuti utorewowowowo (reset) zvino.

Option ya Reset inowanikwa nekuti inoparasika metrics dzemashoko nemetadata yakaipa, uye inoreva zvakasiyana-yana imihiro yakadzama.
