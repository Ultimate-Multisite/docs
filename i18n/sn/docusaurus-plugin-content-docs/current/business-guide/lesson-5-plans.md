---
title: 'Chidzidzo 5: Kugadzira Zvirongwa Zvako'
sidebar_position: 6
...
Kumastudio efitness, kune zvikamu zvitatu zvechisikigo:

| Chikamu | Ndivanaani | Zvavanoda |
|---------|-------------|----------------|
| **Varairidzi vega / mastudio madiki** | Vashandi 1-3, nzvimbo imwe chete, vachangotanga | Saiti yehunyanzvi, ruzivo rwemakirasi, fomu rekubata |
| **Magym akatosimba** | Vashandi 5-20, nzvimbo imwe chete, ari kukura | Zvese zviri pamusoro pamwe nekubhuka, blog, gallery, domain yakasarudzika |
| **Machain efitness** | Nzvimbo dzakawanda, brand yakatosimba | Zvese zviri pamusoro pamwe ne multi-site, mapeji enzvimbo, dhairekitori revashandi |
...
**Tabu yerondedzero**:
- Zita: FitSite Starter
- Rondedzero: "Zvese zvinodiwa nemurairidzi wega kana studio diki kuti iratidzike sehunyanzvi paindaneti."

**Tabu yakajairika**:
- Rudzi rwechigadzirwa: Chirongwa
- Basa remutengi: Administrator

**Tabu yematemplate esaiti**:
- Bvumira matemplate esaiti: Yakagoneswa
- Matemplate aripo: Studio Essential chete

**Miganhu**:
- Masaiti: 1
- Nzvimbo yedisiki: 1 GB
- Domain yakasarudzika: Yakadzimwa (inoshandisa `studioname.fitsite.com`)

**Tabu yemaplugin**:
- Plugin yefomu rekubata: Force Activate
- SEO plugin: Force Activate
- Plugin yekubhuka: Haisi Kuwanikwa (kurudziro yekukwidziridza)
...
**Tabu yerondedzero**:
- Zita: FitSite Growth
- Rondedzero: "Yemagym akatosimba agadzirira kukudza kuvapo kwawo paindaneti uye kukwezva nhengo itsva."

**Tabu yematemplate esaiti**:
- Matemplate aripo: Studio Essential uye Gym Pro

**Miganhu**:
- Masaiti: 1
- Nzvimbo yedisiki: 5 GB
- Domain yakasarudzika: Yakagoneswa

**Tabu yemaplugin**:
- Zvese zviri muStarter, pamwe ne:
- Plugin yekubhuka: Force Activate
- Gallery plugin: Force Activate
- Kushanda kweblog: Kunowanikwa

**Tabu yekukwidziridza nekudzikisa**:
...
**Tabu yerondedzero**:
- Zita: FitSite Pro
- Rondedzero: "Platform yakazara yemabrand efitness ane nzvimbo dzakawanda."

**Tabu yematemplate esaiti**:
- Matemplate aripo: Matemplate ese matatu

**Miganhu**:
- Masaiti: 5 (imwe panzvimbo imwe neimwe)
- Nzvimbo yedisiki: 20 GB
- Domain yakasarudzika: Yakagoneswa

**Tabu yemaplugin**:
- Zvese zviri muGrowth, pamwe ne:
- Ma premium plugins ese: Force Activate
...
1. Seta **Boka reChirongwa** ku "FitSite Plans" pazvirongwa zvese zvitatu
2. Seta **Kurongeka kweChigadzirwa** ku 1 (Starter), 2 (Growth), 3 (Pro)
...
- **Extra Storage Pack** ($19/mwedzi) -- imwe 5 GB yenzvimbo yedisiki
- **Priority Support** ($29/mwedzi) -- nguva dzekupindura dzinokurumidza
- **Additional Site** ($39/mwedzi) -- yevatengi vanoda masaiti akawanda kupfuura anobvumirwa nechirongwa chavo
...
- **Pro** inoshandira chikamu chine kukosha kwepamusoro chinoda rutsigiro rwenzvimbo dzakawanda
...
- **Boka rechirongwa** rine nzira yakajeka yekukwidziridza
- **Zvigadzirwa zveorder bump** zvekuwedzera mari inopinda
- **Chimiro chemitengo** chakavakirwa pakukosha kumutengi, kwete pazviyero zvehunyanzvi

---

**Chinotevera:** [Chidzidzo 6: Chiitiko cheKunyoresa](lesson-6-checkout) -- tinovaka mafambiro echeckout anoshandura varidzi vemastudio efitness kuva vatengi vanobhadhara.
