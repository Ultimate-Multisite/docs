---
title: 'Casharka 9: Qiimeyn si Faa''iido loo Helo'
sidebar_position: 10
...
- Website fitness oo xirfadle ah oo ku kici lahaa $2,000-$5,000 in si gaar ah loo dhiso
- Dayactir joogto ah, updates, iyo amni aysan ka fikirin
- Tilmaamo niche-gaar ah oo dhisayaasha guud aysan bixin
- Kalsoonida platform loo dhisay warshaddooda
...
- **Shaqaaleysiinta web developer**: $2,000-$5,000 hore + $50-$100/bishii dayactir
- **Wix/Squarespace**: $16-$45/bishii laakiin ma laha tilmaamo fitness-gaar ah, iyaga ayaa iska dhisaya
- **Waxba ha sameyn**: Xubno lumay oo aan online ka heli karin
...
| Qorshe | Bil kasta | Sannadle (bishii) | Wadarta Sannadlaha | Kayd |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mo | $39/mo | $468/year | 20% dhimis |
| Growth | $99/mo | $79/mo | $948/year | 20% dhimis |
| Pro | $199/mo | $159/mo | $1,908/year | 20% dhimis |
...
- **Starter**: Ma jiro khidmad dejin (ka saar caqabadaha gelitaanka)
- **Growth**: $99 khidmad dejin (waxay daboolaysaa habeynta domain gaar ah iyo la-talin bilow ah)
- **Pro**: $299 khidmad dejin (waxay daboolaysaa dejinta goobo badan iyo wicitaanka onboarding)
...
- **7-maalmood tijaabo bilaash ah** oo ku kooban qorshaha Starter
- Tijaabo ma leh Growth iyo Pro (macaamiishan way ka go'an tahay waxayna filayaan inay bixiyaan)
...
- **FITLAUNCH** -- 30% dhimis 3-da bilood ee ugu horreeya (xayeysiiska furitaanka)
- **ANNUAL20** -- 20% dhimis qorshayaasha sannadlaha ah (haddii aan hore loo dhimayn)
- **REFERRAL** -- 1 bil bilaash ah (tixraacyada macaamiisha)

U gudub **Ultimate Multisite > Discount Codes** si aad kuwan u abuurto. Eeg [Abuurista Koodhadhka Dhimista](/user-guide/configuration/creating-discount-codes) si aad u hesho hagaha buuxa.

:::tip Ha Dhimin Sida Caadiga Ah
...
1. Ku habee heerarka canshuurta **Ultimate Multisite > Settings > Taxes**
2. Ku dabaq qaybaha canshuurta qorshayaashaada
3. Hubi in invoices-ku si sax ah u muujiyaan canshuurta
...
- **Heerka beddelka qorshe kasta**: Haddii Starter si fiican u beddelmo laakiin Growth uusan sidaas sameyn, farqiga u dhexeeya labadooda ayaa laga yaabaa inuu aad u weyn yahay
- **Heerka kor-u-qaadista**: Haddii macaamiil yar ay ka kor u qaadaan Starter una gudbaan Growth, qorshaha Growth waxaa laga yaabaa inuusan bixin qiime dheeraad ah oo ku filan
...
```
Shabakadda FitSite
├── WordPress Multisite (qaabka subdomain)
├── Ultimate Multisite (la habeeyay + branded)
├── Domain-ka Platform (fitsite.com + wildcard SSL)
├── Templates-ka Goobta (Studio Essential, Gym Pro, Fitness Chain)
├── Products
│   ├── FitSite Starter ($49/mo ama $468/yr) + tijaabo 7-maalmood ah
│   ├── FitSite Growth ($99/mo ama $948/yr) + $99 khidmad dejin
│   ├── FitSite Pro ($199/mo ama $1,908/yr) + $299 khidmad dejin
│   └── Order Bumps + Discount Codes
├── Socodka Bixinta (oo leh toggle xulashada muddada)
├── Branding (login, dashboard, emails, invoices, goobta suuqgeynta)
├── Onboarding-ka Macmiilka (Quick Start, emails, ilaha caawinta)
├── Istaraatiijiyadda Qiimeynta
│   ├── Dhimisyada sannadlaha ah (20% dhimis)
│   ├── Khidmadaha dejinta istaraatiijiga ah
│   ├── Tijaabo 7-maalmood ah oo Starter ah
│   ├── Koodhadhka dhimista ee ololeyaasha iyo tixraacyada
│   └── Habeynta canshuurta
...
- **Muddo tijaabo ah** oo ku jirta plan-ka heerka gelitaanka si loo yareeyo caqabadda isdiiwaangelinta
- **Koodhadh dhimis istiraatiiji ah** oo loogu talagalay daahfurka, tixraacyada, iyo ololayaasha
- **Qaabeynta canshuurta** ee biil-bixin waafaqsan shuruucda
- **Qaab-dhismeed dib-u-eegis qiimeyn** oo loogu talagalay hagaajin joogto ah

---

**Xiga:** [Casharka 10: Maalinta Daahfurka](lesson-10-launch) -- liiska hubinta ka hor daahfurka iyo si toos ah u bilaabista.
