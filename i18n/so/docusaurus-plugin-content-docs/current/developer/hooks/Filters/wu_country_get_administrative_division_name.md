...
title: Shaandhee - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Magaca qaybta. Badanaa waa wax sida gobol, province, region, iwm. |
| $country_code | `string` | ISO code laba-xaraf ah oo waddanka ah. |
| $state_code | `string` | ISO code laba-xaraf ah oo gobolka ah. |
