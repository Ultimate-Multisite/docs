...
## Qofka Waxaa Saamaynta?

### Warbixinta Cusub (WordPress 7.0+)
...
### Warbixinta Hore (Existing Installations)
...
### Noocyada WordPress Ka Hor v7.0
...
### Habka gacanta lagu maamulo (Manual Mode)
...
## In La Hubiyo Habkaaga Hadda ah

### Iyada oo loo marayo Admin Panel (Dashboard)
...
## Faayidaoyinka Auto Mode (Auto Mode)

### Ogaanshooyin Iska-dhasha (Automatic Discovery)
...
### Isdhexgalka Dabiiciga ah (Native Integration)
...
### Maamul fudud (Simplified Management)
...
### Waxa Ugu wanaagsan ee Waxqabadka (Better Performance)
...
## Waddooyinka Ku Marinta (Migration Path)

### Haddii aad ku jirto WordPress 6.x
...
### Haddii aad ku jirto WordPress 7.0+
...
### Awoodaha ma soo muuqan Auto Mode-ka
...
### Waxaan rabaa in aan ilaaliyo legacy mode
...
### Awooddaabtayga aan sameeyay ma muuqato
...
### Waxaan helayaa ogeysiisyo "ability aan la kala saarin" (unclassified ability)
...
## Isku dhafka hore (Backward Compatibility)

### Istaraatiyadda hore (Existing Configurations)
...
### Xilliga joojinta (Deprecation Timeline)
...
## Hababka ugu wanaagsan (Best Practices)

### Kuwa cusub ee Installation-ka
...
### Abilities-ka gaarka ah (For Custom Abilities)
