---
title: Maareynta Email-yada Nidaamka
sidebar_position: 13
...
Kaas u socota, waxaad heli kartaa bogga **System Emails** si aad u aragto dhammaan qaababka email-ka.

![System Emails list](/img/admin/system-emails-list.png)

Waxaad sidoo kale waxaad hagaajin kartaa qaabab email-ka gaarka ah adiga oo isticmaalaya editorka system email-ka:
...
Si aad u soo darto qaabab email-ka cusub:

1. U socda bogga **System Emails**
2. Ku riix badhka **Reset & Import** ee sare ee bogga
...
1. **Ka saar oo dib u soo darto** — Ka saar system email-ka oo dib u soo darto (tani waxay ka saartaa tirada dirooyinka la diray).
2. **Dib u dhigista iyadoo la isticmaalayo tool-ka** — Isticmaal tool-ka **Reset & Import**, fur doorashada **Reset**, oo dooro email-yada aad rabto inaad dib u dhigto.

Doorashada Reset waa mid la ixtiraa sababtoo ah waxay ilaalinaysaa tirada dirooyinka (send metrics) iyo macluumaadka kale inta badan iyadoo soo celinaysa waxa horeeyay.
