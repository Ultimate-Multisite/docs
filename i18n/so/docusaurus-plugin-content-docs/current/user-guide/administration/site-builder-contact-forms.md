...
## Sameynta Foomamada La Xiriirka (Creating a Contact Form)
...
## Isticmaalka Shortcode-ka La Samay
...
## Wax ka beddelid Form-ka La Xiriirka (Customizing the Contact Form)

Marka Site Builder-ku form-ka la xiriirka uu sameeyo, waxaad si dheeri ah u hagaajin kartaa:

### Iyadoo la isticmaalayo Chat Interface-ka
...
### Iyadoo la isticmaalayo Admin Interface-ka Plugin-ka Form-ka
...
## Tusaaleoyin Isticmaal

### Form-ka La Xiriirka Fudud

> "Samay form-ka la xiriirka fudud oo leh meelaha magaca, email-ka, iyo fariinta."

### Foomka Cadhan-Cadhan (Multi-Step Form)
...
### Foomka Laba-Tallaabo Ah (Form with Conditional Logic)
...
### Foomka La Soo Dhaqan File (Form with File Upload)
