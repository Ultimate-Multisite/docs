...
- **Customer-owned** — Sawirro u socda macmiil gaar ah
...
- **Site Title** — Magaca sawirka cusub
- **Site URL** — Domain-ka/path-ka sawirka
- **Site Type** — Ma waa sawir macmiil, template, mise sawir caadi ah
...
- **Visit limits** — Tirada ugu badan ee la soo booqan karo sawirka
- **User account limits** — Xaddidda kooxda macmiil kasta oo isticmaalaya (per user role)
- **Disk space** — Qaybta kaydka (storage quota) ee sawirka
- **Custom domain** — Furista xiriirka domain-ka (domain mapping) ee sawirkan
- **Plugin and theme visibility** — Maamulka waxa lagu arki karo, laga qabto, ama si hore loo furay plugin-yada iyo themes-ka
...
- **Domain-yada la xiriira** website-ka
...
- **In shaqeyso/in joojiso website-ka** iyadoo la isticmaalayo badhanka toggle
- **In beddelo nooca website-ka** ama aad dib u qabato milkiilaha (reassign ownership)
- **In dejisid sawirka/thumbnail-ka website-ka** (oo muujinaya dhinaca hore ee template-yada website-ka)
- **In si joogto ah looro fogaado (Delete)** website-ka

:::warning
Fogaadista website-ka ma aha mid la dib u samayn karo. Website-ka iyo dhammaan waxa ku jira ayaa si joogto ah looga saari doonaa.
:::
