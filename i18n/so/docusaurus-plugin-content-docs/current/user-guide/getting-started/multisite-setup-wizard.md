...
## Goorma ayuu Wizard-ku Emaaga Muuqdaa?
...
## Shuruudaha Horumarinta (Prerequisites)
...
## Tallaabada 1: Soo Dhawoow (Welcome)
...
## Tallaabada 2: Qorsheynta Network-ka (Network Configuration)

Tani tallaabadu waxay ku weydiinaysaa inaad qorsheysid dejinta network-kaaga.

### Qaababka Website-ka (Site Structure)
...
### Magaca Network-ka (Network Title)
...
### Email-ka Maamulaha Network-ka (Network Admin Email)
...
## Tallaabada 3: Installation (Wax-soo-qarista)
...
## Habka loo isticmaalo haddii ay shaqo darrada (Manual Setup Fallback)
...
### Wizard-ku wuxuu sheegayaa in wp-config.php aan la qorin karin (not writable)
...
### Website-yadu ma la heli karaan ka dib markii la samaynayo habka (subdomains)
...
### Dhibaatooyinka caddaynta ka dambeeya habka (Authentication issues after setup)
...
### Tallaabada ayaa ku guuldareysay inta lagu jiro install-ka
