...
## Subdomain (Domain-ka Hoose) {#domain}
...
## Subdirectory (Folder Hoose) {#subdomain}
...
## Subsite (Website Hoose) {#subdirectory}
...
## Themes (Qoraallada Muuqaalka) {#plugin}
...
## Site Template (Qaabdhismeedka Website-ka) {#themes}
...
## Domain Mapping (Xiriirka Dooman) {#site-template}
...
## Media (Waxyaabaha La Soo Dhaafay) {#ssl}
...
## Permalinks (Xiriirro Joogto ah) {#media}
