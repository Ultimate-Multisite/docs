---
title: Qaab-dhismeedyada goobta
sidebar_position: 4
...
Tani waxay ka dhigan tahay inaad samayn karto website aasaasi ah, aad u furto plugins kala duwan, aad u dejiso theme (theme) oo firfircoon, lana hagaajiso sida aad rabto. Marka macaamiisha cusub ay abuuraan account cusub, halkii ay helayaan WordPress site caadi ah oo aan wax macno lahayn gudaha, waxay heli doonaan nuqul ka mid ah website-ka aasaasiga ah ee aad samaysay oo leh dhammaan hagaajinta iyo waxyaabaha horey u jira.
...
Tani waxay furaysaa fekerka (modal window) oo weydiinaya **Site title, Site Domain/path,** iyo **Site type**. Qaybta hoose ee **Site Type** drop-down field, hubi inaad doorato **Site Template** *.*

_![Add site template modal with site type dropdown](/img/config/site-templates-list.png)_

Waxaad sidoo kale ku dari kartaa sharaxaad u aragti macaamiisha si loo fasirayo waxa uu template-ku ka kooban yahay:

![Site template description field on the site template edit screen](/img/config/site-template-edit-description.png)

Form-ka hoose, waxaad arki doontid badhanka **Copy Site** toggle switch. Tani waxay kuu oggolaanaysaa inaad samayso qaab cusub oo site template ah oo ku salaysan mid hore si aad u hesho meel ugu horreeya si aad waqti badan uga badbaadiso, halkii aad ka samayn lahayd site template ka bilaash.
...
Guud ahaan, waxaa jira laba hab oo aad isticmaali karto hadda (si aan isku mar u sameyn):

  * In la xiro Site Template hal mid ah dhammaan Plans-kaaga.
...
Si aad u samayso, waa inaad tagtaa **Ultimate Multisite > Products > Edit**.

![Edit product to assign site template](/img/config/product-site-templates.png)

Tani waxay ku qaadi doontaa bogga **Edit Product**. Hooska qaybta **Product Options**, raadi tab-ka **Site template** oo dooro badhanka (drop-down field) ee **Assign Site Template**. Tani waxay soo bandhigi doontaa liiska site templates ee la heli karo, waxaana kuu oggolaan doonta inaad doorato kaliya hal site template oo loogu talagalay macdalkaaga.
...
Markii **Edit Product** bogga. Hooska **Product Options** qaybta, **Site template** tab-ka ka raadiyo oo dooro **Choose Available Site Template** option-ka laga soo qaado drop-down field-ka. Tani waxay kuu soo bandhigi doontaa liiska site templates ee la heli karo, waxaana kuu oggolaanaya inaad doorato site template-ka aad rabto inuu diyaar yahay. Waxaad taas samayn kartaa adigoo doorista sida uu u shaqeeyo: **Available** haddii aad rabto in site template-ka lagu daro liiska. _**Not Available**_ haddii aad rabto in site template-ku aanuu si doon ah u muuqdo oo awood. Waxaana **Pre-selected** haddii aad rabto mid ka mid ah site templates ee la soo bandhigay inuu noqdo kan horey loo doorbiday.
...
Tani waxay kuu soo bandhigi doontaa bogga **Edit Checkout Form**. Raadi qaybta **Template Selection** (Dooro Template) oo riix **Edit** hoos ka dambeeya.

Waxaa soo muuqan doonid modal window. Qaybta **Template Sites**-ka, waxaad dooran kartaa oo liici kartaa dhammaan site templates-ka aad rabto inuu si buuxda u heli karaan inta lagu jiro diiwaangelinta. Site templates-ka aad halkan qeexdo waxay si isku mid ah u heli doonaan iyadoo ku xiran waxa uu isticmaalay isticmaalahu.

![Template selection field in the checkout form editor](/img/config/checkout-form-template-step.png)

Frontend-ka, macaamiishu waxay arkaan doorashada template-ka inta lagu jiro diiwaangelinta waxayna qaadan karaan naqshadda bilowga ah ee website-kooda cusub.
...
Tusaale ahaan, haddii aad rabto inaad hesho magaca shirkadda isticmaalahaaga inta uu diiwaangeli lahaa oo si toos ah u dhigto magaca shirkadda bogga hore (home page). Waxaad u baahan tahay inaad ku dari lahayd placeholders-ka qaab-dhismeedkaaga bogga hore, sida sawirka hoose (placeholders-ku waa inay lahaadaan oo ay ku furan yihiin laba curly braces - {{placeholder_name}}).

![Homepage with placeholder text in curly braces](/img/config/site-templates-list.png)

Markaas, waxaad si fudud u dari kartaa meel diiwaangelinta (registration field) oo la mid ah foomkaaga checkout-ka si aad macluumaadkaas u hesho. Editor-ka foomka checkout-ka ee isku isticmaalka qaab-dhismeedka ayaa kuu oggolaanaya inaad meelo gaar ah ku dhigto qaybaha kale (custom fields) oo la mid ah doortaha qaab-dhismeedka:

![Template selection and registration fields in the checkout form editor](/img/config/checkout-form-template-step.png)

Macmiilkaaga ayaa markaas awood u leh inuu buuxiyo meeshaas inta uu diiwaangeli lahaa.

![Frontend checkout form with template chooser](/img/config/frontend-template-chooser.png)

Ultimate Multisite wuxuu badbaadin doonaa placeholders-ka macluumaadka ay bixiyay macmiilka si toos ah.
...
Si aad u xalliso arrintan, waxaan kuu soo jeedinaynaa inaad dejisid qiimeoyin been ah (fake values) ee meelaha ay ku jiraan placeholders-ka, ka dibna waxaan isticmaalnaa qiimahaas si aan u raadiyo oo badbaado (search and replace) waxyaabaha ay ku jira template-yada marka macaamiisha ay booqdaan.

Waxaad heli kartaa editorka placeholder-yada adiga oo tagaya **Ultimate Multisite > Settings > Sites**, ka dibna, dhinaca hore (sidebar), aad u riixid xiriirka **Edit Placeholders**.

![Site template settings under the Sites settings page](/img/config/settings-sites-templates-section.png)

Tani waxay ku qaadi doontaa editorka waxa lagu qoro placeholder-yada, halkaas oo aad ku dari karto placeholders-ka iyo waxyaabaha ay la xiriiraan.
