...
## Waxyaabaha caadiga ah ee ku guuldareysan

### Ujeeddooyinka database-ka (Database grants) ma laha isku-dubbar
...
### Bedrock ama rakibidda deegaanka (local installs) ma laha isku xirnaansho
...
### Qaybta async push queue ma soo baxdo (does not drain)
...
### Tirada isticmaalayaasha qoysku ma sax ahayd (Tenant user count is wrong)
...
### Booqashada SSO ma diidnaayo (SSO visit is rejected)
