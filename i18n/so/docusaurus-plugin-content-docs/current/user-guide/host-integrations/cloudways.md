...
## Tallaabooyinka Qaadista (Setup Instructions)

### 1. Hel Isticmaalka API-ka Cloudways-kaaga (Get Your Cloudways API Credentials)
...
### 2. Hel ID-ga Server-ka iyo Application-kaaga (Get Your Server and Application IDs)
...
### 3. Ku dar Constants-ka faylka wp-config.php (Add Constants to wp-config.php)
...
### 4. Furista Isdhexgalka (Enable the Integration)
...
### Sync-ka Domainyada (Domain Syncing)
...
### Maareynta Shahaaynta SSL (SSL Certificate Management)
...
## Extra Domains (Domain-yada Kale)
...
## Muhiim — Dhibaatada SSL-ka Wildcard-ka Hoose
...
### Qaabka SSL-ka Cloudways-ga La Taloobay ee Network Ultimate Multisite
...
## Wax-ii-la-tacaal (Troubleshooting)
