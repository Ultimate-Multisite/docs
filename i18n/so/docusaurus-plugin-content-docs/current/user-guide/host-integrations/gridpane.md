...
### 1. Hel Isticmaalayaasha API-kaaga GridPane (API Credentials)
...
### 2. Hel ID-yada Server-ka iyo Website-kaaga
...
### Dhibaatooyinka SSL Certificate-ka
...
### Domainka Aan La Bixin (Domain Not Added)
