...
### 1. Samee Token API-ga Hostinger-kaaga
...
### 4. Furita isku-xirnaanta (Enable the Integration)
...
## Sidee Waa Inuu Shaqeeyo (How It Works)

### Addon Domains (Domainyada Ku Darbada)
...
## Wax Ka Bartida (Troubleshooting)

### Masalahaatada Xiriirka API-ga
...
### Domain aan la soo darin (Domain Not Added)
...
### Masalahaatka Sertifikaanka SSL (SSL Certificate Issues)
