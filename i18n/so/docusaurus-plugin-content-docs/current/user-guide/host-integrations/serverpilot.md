...
## Wax-soo-dhismeedyada (Features) {#features}
...
### 1. Hel Shaxda API-gaaga ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Hel App ID-gaaga {#2-get-your-app-id}
...
### 4. Fur Isku-dhaafka (Enable the Integration) {#4-enable-the-integration}
...
### Isku-dhaafinta Domain-ka (Domain Syncing) {#domain-syncing}
...
### Maareynta Sertiga SSL (SSL Certificate Management) {#ssl-certificate-management}
...
## Xaqiijinta Sertiga SSL (SSL Certificate Verification) {#ssl-certificate-verification}
...
### Dhibaatooyinka Sertiga SSL-ka {#ssl-certificate-issues}
...
### Tutinta Domainka {#domain-removal}
