...
## Cap Captcha: Ilaalin Self-Hosted ah oo Si Toos ah u Shaqaysa {#cap-captcha-self-hosted-protection-that-just-works}
...
## Ilaalinta Tijaabinta Kaarka ee WooCommerce {#woocommerce-card-testing-protection}
...
## Weli Ma U Baahan Tahay Google reCAPTCHA ama hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Waxaa Loo Dhisay Ballaarin {#built-for-scale}
...
## Ma u baahanahay inaan wax habeeyo? {#do-i-need-to-configure-anything}
...
## Ma u baahanahay API keys ee Cap Captcha? {#do-i-need-api-keys-for-cap-captcha}
...
## Tani ma gaabin doontaa checkout-kayga? {#will-this-slow-down-my-checkout}
...
## Tani ma ka ilaalisaa weerarada tijaabinta kaarka? {#does-this-protect-against-card-testing-attacks}
...
## Ma isticmaali karaa bixiyayaal captcha oo kala duwan sites kala duwan? {#can-i-use-different-captcha-providers-on-different-sites}
...
## Tani ma u hoggaansan tahay GDPR? {#is-this-gdpr-compliant}
...
### La Ballaarin Karo {#extensibility}

#### Filter-ka Liiska Cad ee IP {#ip-whitelist-filter}
...
#### Ficilka Ka Hor Xannibaadda {#pre-block-action}
...
## Ogaanshaha IP-ga Client-ka & Proxies la Aamini Karo {#client-ip-detection--trusted-proxies}
...
### Habaynta {#configuration-1}

#### Kalsoonida Cloudflare Header {#cloudflare-header-trust}
...
#### Habaynta Proxy-yada la Aamini Karo {#trusted-proxy-configuration}
...
#### Ogaanshaha Tooska ah ee Markii Ugu Horreysay ee La Hawlgeliyo {#first-enable-auto-detection}
...
### Sababta Tani Muhiim u Tahay {#why-this-matters}
