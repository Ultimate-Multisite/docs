---
title: Diiwaanka Isbeddellada Shabakado Badan
sidebar_position: 99
...
* Cusub: Nuqul-samaynta warbaahinta network — warbaahinta site si sax ah ayaa loo nuqulaa marka networks laga clone-gareeyo template.
* Hagaajin: Clone-garaynta network hadda way shaqaysaa iyada oo aan lahayn addon-ka multi-tenancy; mudnaanta super admin dib ayaa loo bixiyaa clone kadib.
* Hagaajin: Abuurista network hadda waxay la jaanqaadaysaa WooCommerce iyo dhammaan payment gateways.
* Hagaajin: Lambarka port hadda waxa lagu daraa samaynta domain-ka fallback.
* Hagaajin: CSS-ka doortaha template waxa loo raray stylesheet la enqueued-gareeyay si uu si sax ah ugu muuqdo dhammaan themes.
