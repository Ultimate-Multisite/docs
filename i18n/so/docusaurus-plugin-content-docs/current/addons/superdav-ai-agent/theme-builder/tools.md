...
- **Falanqaynta mareegta** — xoq oo falanqee mareegaha tartamayaasha ama kuwa dhiirigelinta ah
- **Soo saarista naqshadda** — aqoonso midabada, faraha qoraalka, iyo qaababka layout-ka
- **Qaab-dhismeedka nuxurka** — faham abaabulka bogga iyo kala-sarraynta
- **Ogaanshaha astaamaha** — aqoonso plugins iyo shaqaynta
- **Falanqaynta waxqabadka** — hubi xawaaraha bogga iyo hagaajinta
- **Falanqaynta SEO** — dib u eeg meta tags iyo xogta qaabaysan

**Isticmaalka:**

```
Falanqee naqshadda example.com oo u isticmaal dhiirigelin ahaan mareegtayda.
```

**Waxa Uu Soo Saaro:**

- Palette-ka midabada iyo isticmaalka midabka
- Typography (faraha qoraalka iyo cabbirrada)
- Qaab-dhismeedka layout-ka iyo kala-fogaanshaha
- Qaababka navigation-ka
- Abaabulka nuxurka
- Isticmaalka sawirrada iyo warbaahinta
- Qaybaha is-dhexgalka
- Ka-jawaabidda mobilka

**Xaddidaadaha:**

- Ma xoqi karo mareego sir-lagu-ilaaliyo
- Waxa uu ixtiraamaa robots.txt iyo siyaasadaha mareegta
- Waxa laga yaabaa inuusan qaban nuxur dynamic ah
...
- Abuurista CSS gaar ah
- Abuurista animation
- Naqshadeynta qaybaha is-dhexgalka
...
Awoodaha wehelka Advanced waxa ka mid noqon kara:

- **Qalabka filesystem** — baadh oo wax ka beddel faylasha la oggolaaday ee deegaanada la aamini karo
- **Qalabka database** — weydii ama cusboonaysii xogta mareegta marka si cad loo oggolaado
- **Qalabka WP-CLI** — socodsii amarrada dayactirka iyo baadhista WordPress
- **Qalabka REST dispatcher** — wac endpoints REST ee diiwaangashan adigoo maraya socodsiinno dispatch oo la xakameeyo
- **Qalabka dhisaha plugin-ka** — diyaari qaab-dhismeed oo ku celceli code-ka plugin-ka
- **Qalabka git snapshot** — samee snapshots ka hor hawlgallada horumariye ee khatarta leh
- **Qalabka maaraynta isticmaalaha** — ka caawi dib-u-eegista ama hagaajinta diiwaannada isticmaalaha halka laga oggol yahay
- **Qalabka benchmark** — socodsii benchmarks waxqabad ama awood si dib-u-eegis horumarineed loogu sameeyo
...
1. U gudub **Gratis AI Agent → Dejinta**
2. Tag **Theme Builder → Qalabka**
...
- **Xoqidda mareegta** — waxay u baahan tahay helitaan internet
- **Falanqaynta** — waxay u baahan tahay isku-darka Google Analytics
- **Abuurista nuxurka** — waxay u baahan tahay furayaasha API
...
1. Tag **Gratis AI Agent → Dejinta → Furayaasha API**
2. Geli aqoonsiyada qalab kasta
3. Tijaabi xiriirka
...
```
Falanqee naqshadda mareegta tartankayga ee competitor.com
...
```
Ka soo saar palette-ka midabada example.com oo u isticmaal dhiirigelin ahaan.
```

```
Falanqee qaab-dhismeedka navigation-ka ee example.com oo ku dabaq abaabul la mid ah
mareegtayda.
```

```
Hubi ka-jawaabidda mobilka ee example.com oo xaqiiji in mareegtaydu
...
```
Isbarbardhig naqshadaha site1.com iyo site2.com oo samee naqshad
...
- U isticmaal falanqaynta dhiirigelin, ee ha u isticmaalin nuqul
...
3. **Soo saar midabada** — u isticmaal color palettes meel-bilaabid ahaan
...
3. **Xaqiiji xuquuqda** — hubi inaad isticmaali karto nuxurka la soo saaray
...
3. **Deji filashooyinka** — qeex yoolalkaaga naqshadeynta
...
- Goobo waaweyn waxay geli karaan timeout
...
- [Menu-yada Martigelinta](./hospitality-menus.md) — samee bogagga menu-ga
