...
To je standardni sistem za prevode v WordPress topljusti. Ko prevodi doseže dovolj visoko stopnjo odobritev, se avtomatsko distribuira vsi Ultimate Multisite uporabniki prek WordPress plugin update-ov.

**Potrebujemo vaše pomoč!** Če govorite jezik, ki ni angleški, razmislite o prinošanju prevodov. Čeven prevod nekaj besed pomaga. Za začetek:

1. Obiščite [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Izberite svoj jezik
3. Kliknite na "Contribute Translation" (Prinoš prevod)
4. Bute potrebujete brezplačno račun na WordPress.org
...
1. Prekličite Poedit z [poedit.net](https://poedit.net)
2. Odprite datoteko `.pot` iz `wp-content/plugins/ultimate-multisite/lang/`
3. Prevedite besede v interfejsu Poedita
