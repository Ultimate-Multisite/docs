...
## Kaj je delno (shared) in kaj ni delno med subsiti
...
## Upravljanje uporabnikov na WordPress Multisite
...
## Vzema v obzir uspešnosti (Performance considerations)
