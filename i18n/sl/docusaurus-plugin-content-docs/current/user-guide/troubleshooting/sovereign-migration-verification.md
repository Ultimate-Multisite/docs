...
### Dovoljenja v bazi podatkov ne ustrezuje gostu
...
### Bedrock ali lokalne instalacije ne morejo povezati se
...
### Asinkronska vrža za push ni praznjena (drain)
...
### Število uporabnikov tenenta je napakljivo
