---
title: Upravljanje sistemnih e-poštnih sporočil
sidebar_position: 13
...
Od tam lahko dostopate do strani **System Emails**, kjer boste videli vse e-mail template.

![System Emails list](/img/admin/system-emails-list.png)

Lahko lahko redaktirate individualne e-mail template z uporabo editorja sistemskih e-mailov:
...
Za import novih e-mail template:

1. Pojdite na stran **System Emails**
2. Kliknite na gumb **Reset & Import** na vrhu strani
...
1. **Obrišite in ponovno importirajte** — Obrišite sistemski e-mail in ga ponovno importirajte (to briše podatke o pošiljanju).
2. **Resetirajte preko orodja** — Uporabite orodje **Reset & Import**, preklopite možnost **Reset** in izberite e-mailove, ki jih želite resetirati

Možnost Reset je boljša, ker ohranja podatke o pošiljanju in druge metadata, medtem ko se vrne na standardno vsebino.
