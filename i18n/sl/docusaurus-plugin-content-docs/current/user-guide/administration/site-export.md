...
### Network Import Bundles (Paketi za import mreže)
...
#### Generiranje network import bundle-a
...
#### Ponovno uporabo iz voznja omrežnega paketa (Restoring from a Network Import Bundle)
...
## Instalacija ZIP datoteke za izvoz, ki se sam obvladuje (Installing a self-booting export ZIP)
