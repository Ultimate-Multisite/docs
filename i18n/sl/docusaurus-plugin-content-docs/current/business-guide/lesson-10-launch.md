...
- [ ] Preslikava domen deluje -- preizkusite ustvarjanje spletnega mesta in preslikavo domene po meri
...
- [ ] Vse slike imajo ustrezne licence (brez vodnih žigov stock fotografij)
- [ ] Mobilna odzivnost deluje na vsaki strani predloge
...
- [ ] Cene so pravilne (mesečne in letne)
- [ ] Pristojbine za nastavitev so konfigurirane pri pravih načrtih
- [ ] Poskusno obdobje deluje pri načrtu Starter
...
- [ ] Plačilo se uspešno obdela
- [ ] Stranka po prijavi prejme pozdravno e-pošto
- [ ] Novo spletno mesto se ustvari s pravilno predlogo
...
- [ ] Vsa sistemska e-poštna sporočila uporabljajo blagovno znamko FitSite in jezik, specifičen za fitnes
...
- [ ] Zaporedje pozdravnih e-poštnih sporočil je konfigurirano in preizkušeno
...
- [ ] Politika vračil je opredeljena in dokumentirana
- [ ] Poslovni subjekt je vzpostavljen za prejemanje plačil
...
- Iskrene povratne informacije o izkušnji prijave in uvajanja
- Dovoljenje za uporabo njihovega spletnega mesta kot predstavitvenega primera
- Poročanje o vseh napakah ali težavah, na katere naletijo
...
- Preklopite plačilni prehod v način v živo
- Objavite svoje marketinško spletno mesto
...
1. **Preklopite na plačila v živo** -- onemogočite testni način na svojem plačilnem prehodu
2. **Preverite še enkrat** -- opravite popolno testno prijavo z resničnim plačilom (nato si vrnite denar)
3. **Pozorno spremljajte** -- opazujte napake, neuspešne prijave ali težave s plačili
...
- **Težave s plačilnim prehodom**: Pripravite kontakt podpore svojega ponudnika prehoda
- **Težave s certifikatom SSL**: Vedite, kako preveriti in obnoviti certifikate
- **Neuspešna dostava e-pošte**: Preizkusite, ali e-poštna sporočila dejansko prispejo (preverite mape z vsiljeno pošto)
...
- **Postopke za dan lansiranja** za samozavesten prehod v živo
- **Načrt ukrepanja ob nepredvidenih dogodkih** za pogoste težave na dan lansiranja

---

**Naprej:** [Lekcija 11: Iskanje strank](lesson-11-customers) -- zdaj ko je FitSite v živo, kako pripravite lastnike fitnes studiev, da se prijavijo?
