---
title: 'Lekcija 2: Izbira vaše niše'
sidebar_position: 3
...
- Se od podjetij pričakuje, da imajo spletno prisotnost
- Je večina trenutnih spletnih mest v panogi slabe kakovosti
- Generični graditelji ne rešujejo njihovih specifičnih potreb
- Je razvoj po meri predrag za tipično velikost podjetja
...
- Dovolj uveljavljene, da imajo marketinški proračun
- Navajene plačevati naročnine za programsko opremo (sistemi za rezervacije, obdelava plačil itd.)
- Delovati v obsegu, kjer je $49-$199/mesec razumen poslovni strošek
...
- Panožna združenja, konference ali sejme
- Aktivne spletne skupnosti (Facebook skupine, forumi, subredditi)
- Lokalno mreženje, kjer si lastniki podjetij delijo priporočila
...
- Panogah, v katerih ste delali ali zanje gradili spletna mesta
...
- Google "[panoga] website builder" in poglejte, kaj obstaja
- Prebrskajte panožne forume za pritožbe glede spletne prisotnosti
...
- **Velikost trga**: Koliko podjetij obstaja v tej niši? (Začnite s svojo državo/regijo)
...
- Kako ste dobili svoje trenutno spletno mesto?
- Kaj bi si želeli, da bi lahko počelo, pa ne more?
- Koliko trenutno plačujete zanj?
- Če bi obstajala platforma, zgrajena posebej za [vašo nišo], bi vas zanimala?
...
| Merilo | Ocena |
|-----------|------------|
| Potrebujejo spletna mesta, vendar se mučijo | Da -- večina spletnih mest studiev je generičnih ali zastarelih |
| Si lahko privoščijo naročnino | Da -- že plačujejo $50-$200/mesec za programsko opremo za rezervacije |
| Med seboj se pogovarjajo | Da -- aktivne skupnosti, panožni dogodki, lokalne mreže |
| Velikost trga | Več kot 100.000 objektov samo v ZDA |
| Konkurenčno okolje | Obstaja malo nišno specifičnih platform za spletna mesta |
...
- **Restavracije in kavarne** -- meniji, rezervacije, delovni čas, integracija dostave
- **Nepremičninski agenti** -- oglasi nepremičnin, profili agentov, vodiči po soseskah
- **Odvetniške pisarne** -- področja prakse, biografije odvetnikov, rezervacija posvetov
- **Cerkve in neprofitne organizacije** -- dogodki, pridige, donacije, skupnost
- **Obrtni izvajalci** (vodovodarji, električarji, HVAC) -- območja storitev, rezervacije, ocene
- **Saloni in spa centri** -- storitve, rezervacije, profili stilistov, galerije
- **Veterinarske klinike** -- storitve, portali za hišne ljubljenčke, rezervacije terminov
- **Glasbene šole** -- profili inštruktorjev, načrtovanje lekcij, informacije o nastopih
...
- **Potrditev FitSite**: potrjeno, da fitnes studii izpolnjujejo vsa merila
- **Alternativne niše**: seznam drugih vertikal, na katere lahko uporabite ta okvir

---

**Naprej:** [Lekcija 3: Nastavitev vaše mreže](lesson-3-setting-up) -- namestimo Ultimate Multisite in konfiguriramo temelje za FitSite.
