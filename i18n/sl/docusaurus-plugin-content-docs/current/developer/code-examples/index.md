...
## Dinamični mehanizem določanja cen
...
## Napredno zagotavljanje spletnih mest
...
## BerlinDB atomski števec z `increment_item()`
...
### Sledenje uporabi API-ja na članstvo
...
### Zakaj `increment_item()` namesto `update_item()`
