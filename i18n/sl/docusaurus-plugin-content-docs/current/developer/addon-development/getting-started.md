---
title: Začetek razvoja dodatkov
sidebar_position: 1
...
```
my-addon/
├── my-addon.php                 # Glavna datoteka vtičnika
├── inc/
│   ├── class-my-addon.php       # Glavni razred dodatka
│   ├── admin-pages/             # Skrbniški vmesnik
│   ├── models/                  # Prilagojeni podatkovni modeli
│   └── integrations/            # Integracije tretjih strani
├── assets/
│   ├── js/
│   └── css/
...
- Uporabite [predlogo dodatka](/addons/addon-template) kot začetno ogrodje
