...
Preverimo tri vzorce, ko poskušamo ugotoviti, kam lahko vstavimo naše konstante:
...
Definirano v [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) v vrstici 143
