...
- **Preverite kontrast** — uporabite [Validate Palette Contrast](../abilities/validate-palette-contrast.md) za dostopnost
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — preverite dostopnost barv
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — ustvarite logotipe po meri
