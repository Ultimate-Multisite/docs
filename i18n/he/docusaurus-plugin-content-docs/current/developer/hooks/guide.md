...
### מחזור חיי הלקוח (Customer Lifecycle)

#### לאחר יצירת לקוח (After Customer Creation)
...
#### שינוי סטטוס לקוח (Customer Status Change)
...
#### לאחר פרסום האתר (After Site Published)
...
#### לפני יישום תבנית (Before Template Application)
...
#### מעברי סטטוס (Status Transitions)
...
#### תשלום הושלם / נכשל (Payment Completed / Failed)
...
#### לפני עיבוד / לאחר השלמה (Before Processing / After Completion)
