...
title: פילטר - wu_add_new_domain_modal_fields
...
מסנן את השדות המוצגים בחלון הקופץ (modal) להוספת דומיין חדש.

מאפשר ל-addons (כמו Domain Seller) לשנות או להחליף את השדות של רישום הדומיין.

## Parameters

| Name | Type | Description |
|------|------|-------------|
| $fields | `array` | שדות הטופס. |
