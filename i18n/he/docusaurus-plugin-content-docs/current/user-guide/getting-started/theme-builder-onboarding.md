...
## מהו תהליך הדרכה של בונה התבניות?
...
## התחלת תהליך הדרכה של בונה התבניות
...
### שלב 3: החלטות מערכת העיצוב (Design System)
...
### שלב 4: יצירת התבנית (Theme Generation)
...
## התאמה אישית לאחר ההדרכה

לאחר שסיימה הדרכת בונה התבניות, אתה יכול:

### להשתמש במיומנות אסתטיקת מערכת העיצוב (Design System Aesthetics Skill)
...
### יצירת תבניות בלוק מותאמות אישית
