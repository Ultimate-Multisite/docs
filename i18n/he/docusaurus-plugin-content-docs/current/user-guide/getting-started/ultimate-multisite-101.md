...
## ה-WordPress Multisite {#the-wordpress-multisite}
...
#### Subdomain לעומת Subdirectory {#subdomain-vs-subdirectory}
...
#### תוספים ותבניות {#plugins-and-themes}
...
#### משתמשים ומנהלים {#users-and-administrators}
...
#### מקרה 3: אחסון אתרי WordPress {#case-3-wordpress-web-hosting}
...
#### סקריפטים חיצוניים {#external-scripts}
