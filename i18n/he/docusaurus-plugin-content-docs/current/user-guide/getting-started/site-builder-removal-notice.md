...
### מצב בונה אתרים (Site Builder Mode) (ישן)
...
## השוואה: Site Builder מול Setup Assistant
...
## היתרונות של Setup Assistant Agent
...
### אני רוצה ליצור מחדש אתר מ-Site Builder
...
### האתר הקיים שלי מ-Site Builder לא עובד
...
### האם אני עדיין יכול להשתמש בתבניות הישנות של Site Builder?
