...
## מה זה בעצם WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## תת-דומיין או תת-תיקייה? {#subdomain-or-subdirectory}
...
## מה משותף בין תתי-אתרים ומה לא {#what-is-shared-among-subsites-and-what-is-not}
...
## ניהול משתמשים ב-WordPress Multisite {#user-management-on-wordpress-multisite}
