...
## מתי האשף מופיע? {#when-does-the-wizard-appear}
...
## שלב 1: ברוכים הבאים {#step-1-welcome}
...
## שלב 2: הגדרת רשת {#step-2-network-configuration}

בשלב זה תתבקשו להגדיר את הגדרות הרשת שלכם.

### מבנה האתרים {#site-structure}
...
## שלב 3: התקנה {#step-3-installation}
...
## חלופה להגדרה ידנית {#manual-setup-fallback}
...
### האשף אומר ש-wp-config.php לא ניתן לכתיבה {#the-wizard-says-wp-configphp-is-not-writable}
...
### האתרים לא נגישים לאחר ההגדרה (תת-דומיינים) {#sites-are-not-accessible-after-setup-subdomains}
...
### בעיות אימות לאחר ההגדרה {#authentication-issues-after-setup}
...
### שלב נכשל במהלך ההתקנה {#a-step-failed-during-installation}
