...
## הגדרה (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## דוגמה לקריאת API (cURL) {#example-api-call-curl}
