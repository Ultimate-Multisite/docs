...
---
# אינטגרציה עם cPanel {#cpanel-integration}
...
### 1. השגת פרטי ההתחברות ל-cPanel {#1-get-your-cpanel-credentials}
...
### 2. הוספת קבועים לקובץ wp-config.php {#2-add-constants-to-wp-configphp}
