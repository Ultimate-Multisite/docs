...
### 1. קבלת פרטי ה-API של ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. קבלת ה-App ID {#2-get-your-app-id}
...
### 3. הוספת קבועים לקובץ wp-config.php {#3-add-constants-to-wp-configphp}
...
## אימות תעודות SSL {#ssl-certificate-verification}
