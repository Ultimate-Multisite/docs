...
### 2. הוספת קבועים ל-wp-config.php
...
### Email Forwarders (העברת דואר אלקטרוני)
...
### API Connection Refused (החיבור ל-API נדחה)
...
### Authentication Errors (שגיאות אימות)
...
### Domain Not Created (הדומיין לא נוצר)
...
### SSL Certificate Not Issued (תעודת SSL לא הונפקה)
