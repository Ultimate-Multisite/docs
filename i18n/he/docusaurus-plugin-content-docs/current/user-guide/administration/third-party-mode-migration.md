...
### התקנות חדשות (WordPress 7.0 ומעלה)
...
## הבנת המצבים (Understanding the Modes)

### מצב אוטומטי (Auto Mode) (ברירת המחדל החדשה)
...
## בדיקת המצב הנוכחי שלך

### דרך לוח הניהול (Admin Panel)
...
### מעבר למצב אוטומטי (Switch to Auto Mode)
...
### מעבר למצב ידני (Switch to Manual Mode)
...
### מעבר למצב מיושן (Switch to Legacy Mode)
...
## יתרונות מצב אוטומטי (Benefits of Auto Mode)

### גילוי אוטומטי (Automatic Discovery)
...
### אינטגרציה מובנית (Native Integration)
...
### ניהול פשוט (Simplified Management)
...
### היכולות לא נטענות במצב אוטומטי
...
### אני רוצה לשמור על מצב מיושן (Legacy mode)
...
### היכולות המותאמות אישית שלי לא מופיעות
...
### אני מקבל הודעות "יכולת שלא סווגה" (unclassified ability)
...
### ציר ההפחתה (Deprecation Timeline)
