...
### כיצד חברות עוברות למצב Expired
...
#### חברות מתחדשות אוטומטית מול חברות שאינן מתחדשות אוטומטית
...
### כיצד מסתיימים הניסיונות (Trials)
...
### מה המבקרים רואים כאשר האתר נחסם
...
## פתרון בעיות: אתרים שנותרים נגישים לאחר תפוגה

אם אתרים נשארים נגישים לציבור לאחר תפוגת חברות, עקוב אחר הבדיקות הללו לפי סדר:

### 1. ודא שהגדרת Block Frontend Access מופעלת
...
### 2. בדוק את Frontend Block Grace Period
...
### 3. אשר שהסטטוס של החברות השתנה בפועל
...
### 5. בדיקת בעיות ווּבְהוּק של ה-Gateway (חברות מתחדשות אוטומטית)
...
### 6. בדיקת תקופת החסד של התפוגה (רמת הקרונ)
