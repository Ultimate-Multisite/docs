...
## Notkun skráningarsíðu: {#using-the-registration-form}
...
## Notkun staðsetna með liðréttum línunum (Shareable Link): {#using-a-shareable-link}
...
### Skráning með mannvælum betalingsréttum (Manual Payments): {#registering-using-manual-payments}
