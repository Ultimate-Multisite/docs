...
#### Översiktur yfir chekout form editor
...
### Að viðbót þriðja valandi skráningu
...
#### Stig 1: Sett upp Price Variations á vörum þínum
...
#### Stig 2: Bættu Period Selection hluti í skjama kaupum viðskiptavina
...
#### Átgáfn 3: Hættu feltinn ofan bảngar fyrir verðlaun (Pricing Table)
...
#### Hvernig það virkar á front endi (Frontend)
...
#### Fyrstvalinn val reikningstímas með URL-i
...
### Feltur vala mallar (Template Selection Field)
...
#### Að bæta felti manueel (Adding the field manually)
