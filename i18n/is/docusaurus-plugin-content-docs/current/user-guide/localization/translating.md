---
title: Öryggisfullt multisítandi
sidebar_position: 19
...
1. Umsóknu [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Veldu tunguna þína
3. Klikkaðu á "Contribute Translation" (Teikna þýðing)
4. Þú þarft að hafa frelst WordPress.org reikning
...
1. Lættu ned á Poedit frá [poedit.net](https://poedit.net)
2. Opna `.pot` lausninn sem er í `wp-content/plugins/ultimate-multisite/lang/`
3. Þýðu texta í Poedit greiningarstöðu
