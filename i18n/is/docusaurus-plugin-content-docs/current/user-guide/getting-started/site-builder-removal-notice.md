...
## Ef þú varðir að nota Site Builder Mode

### Staðir þín eru trygg
...
### Skila yfir á Setup Assistant Agent
...
## Samanburður: Site Builder vs. Setup Assistant
...
### Á fyrirfram tilstaða síti (For Existing Sites)
...
### Á breytingar í theme-inum (For Theme Changes)
...
## Mikilvægar skilningarskilpur (Key Differences)
...
## Áttekjur fyrir ákveðna vafinn (Troubleshooting)

### Ég finn ekki Site Builder mode

Site Builder mode hefur verið fjutt. Notaðu Setup Assistant agent í stað þess:

"Hjálpa mér á að sett upp nýtt svið"

### Vilja ég byggja upp sitet nýtt frá Site Builder
...
### Sitet mitt með Site Builder virkar ekki
...
### Get ég enn notaja gamla Site Builder temaplakka?
