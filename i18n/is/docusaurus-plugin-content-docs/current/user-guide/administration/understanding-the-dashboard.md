---
title: Að skilja styrkustöðvaldið
sidebar_position: 7
...
Þessi hlutverksskil minnist um viðburði í Ultimate Multisite. Viðburðin fyllast með skráningum, afskráningum, sköpunum staðnum, fjarlögum og öðrum aðgerðum.
...
Stöðu fyrir daga stýrir tímabili upplýsinganna sem viðbótum undir sýna, sérstaklega fasteinkum, nýjum meðlimskiptum, skráningum eftir land og mest heimsækta staðum.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
Til að gera **Most Visited Sites** viðbótinn virkan, opna virkni fyrir fylgja (visit counting) í **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
