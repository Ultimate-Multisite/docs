...
## Hvernig það virkar {#setup-instructions}

### Domain Mapping (Heimnana mappa) {#1-enable-the-cyberpanel-api}
...
### Auto-SSL (Sjálfsvirki SSL) {#2-add-constants-to-wp-configphp}
...
### www Subdomain (www undirheimild) {#3-enable-the-integration}
...
### Email Forwarders (Tölvupóstfyrirsendur) {#4-verify-connectivity}
...
## Mikilvægar athugasemdir {#domain-mapping}
...
## Aðgerðarstefna (Troubleshooting) {#auto-ssl}

### API tenging er negtin {#www-subdomain}
...
### Feil á samningun {#email-forwarders}
...
### Domain er ekki skapaður {#configuration-reference}
...
### SSL sertifiki er ekki sett {#important-notes}
