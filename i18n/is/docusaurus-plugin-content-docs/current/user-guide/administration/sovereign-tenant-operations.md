...
## Hvað breytist fyrir stjórnendur? {#what-changes-for-administrators}
...
## Heimsóking sjálfstæðs leita {#visiting-a-sovereign-tenant}
...
## Teiknlist fyrir fjarska-leita (Remote-site operations checklist) {#remote-site-operations-checklist}
...
## Leikning leigandafylkinga (Deleting sovereign tenants) {#deleting-sovereign-tenants}
