...
Frá þessum stað geturðu að komast í **System Emails** síðuna til að sjá allar póstformateins.

![System Emails list](/img/admin/system-emails-list.png)

Þú getur einnig breytt einstaka póstformateins með system email editor:
...
Til innnaðar nýr póstformateins:

1. Gangi yfir **System Emails** síðuna
2. Klikka á knappa **Reset & Import** uppstofa á síðuna
...
1. **Slettja og innaða aftur** — Slettja systempóstinn og innaða hann aftur (þetta slettir sendarmiðli)
2. **Tilfar fyrir Reset með verkfæri** — Notaðu verkfæri **Reset & Import**, skiptu **Reset** möguleika í ljós, og veldu póstformateins sem þú vilt setja aftur
