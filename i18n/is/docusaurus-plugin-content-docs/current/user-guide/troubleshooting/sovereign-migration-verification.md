...
## Kommandofer til að nota {#commands-to-run}
...
## Almenn feil {#common-failures}

### Database grants eru ekki jafn með hostnum {#database-grants-do-not-match-the-host}
...
### Bedrock eða local installs geta ekki tengjast {#bedrock-or-local-installs-cannot-connect}
...
### Async push queue er ekki tømð {#async-push-queue-does-not-drain}
...
### Innbyggðar notandastafn er órétt {#tenant-user-count-is-wrong}
...
### SSO-visiting er negtitt {#sso-visit-is-rejected}
...
## Þegar þarf að prófa aftur {#when-to-retry}
