...
## Innreiðarferli {#setup-instructions}

### 1. Fá þína Cloudways API staðfestingar (API Credentials) {#1-get-your-cloudways-api-credentials}
...
### 2. Fá þína Server- og Application ID's {#2-get-your-server-and-application-ids}
...
### 4. Skrá inn samstarfsemi (Enable the Integration) {#4-enable-the-integration}
...
### Samræmi domæna (Domain Syncing) {#domain-syncing}
...
### Stjórnun SSL sertifikata (SSL Certificate Management) {#ssl-certificate-management}
...
## Mikilvægt — Villandi SSL ferðarferli {#important--wildcard-ssl-pitfall}
...
### Aðskilt Cloudways SSL sett upp fyrir Ultimate Multisite net {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### Vấn đề Chứng chỉ SSL {#ssl-certificate-issues}
...
### Domæna er ekki viðbúin {#domain-not-added}
