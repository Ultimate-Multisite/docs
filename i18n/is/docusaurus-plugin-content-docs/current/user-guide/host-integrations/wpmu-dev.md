...
## Uppsetningurstefnur {#setup-instructions}

### 1. Staða WPMU DEV staðfestingar {#1-verify-wpmu-dev-hosting}
...
### 2. Skynna samningann {#2-enable-the-integration}
...
### Samningur á domænum {#domain-syncing}
...
### Fjarlagning domæna (Domain Removal) {#domain-removal}
...
### API Aðferðing (API Authentication) {#api-authentication}
...
## Feilanáttsetning (Troubleshooting) {#troubleshooting}

### Vafinn á API tengingu {#api-connection-issues}
...
### Vafinn á SSL-certifíkata {#ssl-certificate-issues}
...
### Domén er ekki viðbúinn {#domain-not-added}
