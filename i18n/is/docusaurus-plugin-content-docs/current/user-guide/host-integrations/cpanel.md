...
### 1. Fá þína cPanel upplýsingar {#1-get-your-cpanel-credentials}
...
### 2. Búa konstantir í wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Skynja samningann {#3-enable-the-integration}
...
### Vætur á API tengingu {#api-connection-issues}
