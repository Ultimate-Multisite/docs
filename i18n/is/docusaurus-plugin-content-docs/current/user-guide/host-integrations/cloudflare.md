...
### 1. Fá þennan Cloudflare API Key {#1-get-your-cloudflare-api-key}
...
### 2. Fá þennan Zone ID {#2-get-your-zone-id}
...
### 3. Setta konstantir í wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Skynna samninginn {#4-enable-the-integration}
...
### Stjórnun subdomain-skjalanna {#subdomain-management}
...
### Visning DNS-skráms {#dns-record-display}
...
## Cloudflare Custom Hostnames (Handhildaðir nefnunir í Cloudflare) {#cloudflare-custom-hostnames}
...
### Hvernig þetta er annleikur yfir standard Cloudflare samningi {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Innstillingar Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
### Vélbúnaðsfornleiki við API tengingu {#api-connection-issues}
...
### Subdomain ekki bætt við {#subdomain-not-added}
...
### Vafnissvið (Proxying Issues) {#proxying-issues}
