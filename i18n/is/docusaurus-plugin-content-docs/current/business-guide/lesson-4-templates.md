---
title: 'Læoni 4: Sköpun nítandi temaplakstur'
sidebar_position: 5
...
- **Um okkur** - með sögum um studion og ábyrgðinni
- **Hönnun** - með skjaldi fyrir tímamót
...
- Allt í Studio Essential, ásamt:
- **Meðferð** - með skjaldi fyrir verðlisti
- **Myndavíti** - fyrir myndir um tilboðinn
- **Blogg** - með hugleiðingum og fréttum um træningu
...
- Allt í Gym Pro, ásamt:
- **Staðir** - með fleiri tilboðum um tilboðinn
- **Franchise/staður** skjaldi
...
3. Þetta síti verður þitt vinnandi skjaldi

1. Aktiva þema sem passar fyrir fítlessíðum
2. Innstilla þemaþáttagögn, lögna og texta
3. Set upp hófargang og undirskrifar með nákvæmganga-eignandi leiðbeiningum
...
- **Stöðgæðilegum texta** sem lyfir sig fyrir fítlessíðuna ("Velkomin í [Nafn staðar]" ekki "Lorem ipsum")
- **Stöðgæðilegum myndum** frá freymdum myndasíti sem sýna fítlessi aðgerðir
- **Funktionallegar laga** með því að nota síðubygginguna eða block editor
...
- Ein plugin fyrir nákvæmganga eða skjalafyrirbótum (ef það er viðkomandi fyrir planinn þinn)
...
3. Aktiva **Site Template** tveimur (toggle)
...
- [ ] Allir yfirskrifar eru hlutnaðar og sjaldgæfar
- [ ] Haldfæti er hjálfandi og sérsniðið fyrir hverja nítid
- [ ] Myndir eru viðeigandi og rétt litsliðin
- [ ] Móbilverskynsemi virkar á öllum yfirskrifum
- [ ] Stjórnunarleiðin eru logísk og fullkomna
- [ ] Tengslustafur virka
...
├── Domen mapping sett upp
├── Site Templates
│   ├── Studio Essential (smá studiar, trænir)
│   ├── Gym Pro (etablerð gym)
│   └── Fitness Chain (fleiri staði)
...
- **Lærileiðandi haldfætiinnihaldi** sem leiðar viðskiptavini í sniðningu
- **Kvalitetskontrolllista** til að tryggja að mallar séu klára fyrir framleiðslu

---

**Næstu:** [Læoni 5: Hönnun þína plan] -- við byggjum áfram vöruhlutana sem passar hvernig lyftisfræði fyrirtæki virkja sig í raun.
