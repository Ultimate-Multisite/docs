...
## Kjanna Nú Númerin Þínar {#know-your-numbers}
Fyrir skalningum er þarf að skilja hvar þú stendur:

### Mikilvæg Metrikir {#key-metrics}
...
### Dæmi: FitSite með 50 Viðskiptavinum {#example-fitsite-at-50-customers}
...
## Skala Kerfið {#scaling-infrastructure}
### Þegar skalni upp {#when-to-scale}
...
### Skilning til nýr staðsetningarsviði (Hosting Migration) {#how-to-scale}
...
## Sjálfskipta aðgerðir (Automating Operations) {#hosting-migration}

Þegar þú vinnst, verða manuelle ferli að vera hönnunarstöð. Skilja hvað þú getur sjálfskiptað:

### Webhooks og Zapier {#automating-operations}
...
### Tölvun á eildum {#webhooks-and-zapier}
...
### Sjálfgerðarstýring í stuðningi {#email-automation}
...
### Nýjar skekkinguferli {#upselling-existing-customers}
...
## Sköpun á Teamum {#raising-prices}
...
## Hvað Við Heimdu Í Þessi Læoni {#growth-milestones}
