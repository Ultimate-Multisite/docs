---
title: 'Læoni 8: Klýfing við viðskipti'
sidebar_position: 9
...
- Veit nákvæmlega hvað hann skal gera næst → heldur
- Finns óhugaður í algengum WordPress dashboardi → fellar
...
1. **Bylgja nafn stúdionsins og logóið þitt** -- Link til Customizer eða Site Identity settir
2. **Uppfærðu skiljanleika fyrir klássið þitt** -- Direkt linkur að efni-editorinn á Klássum síti
3. **Bylgja þárennandi þína** -- Linkur til efni-editorinn á Þárennandi síti
4. **Setta tengilag fyrir þig** -- Linkur til efni-editorinn á Tengilag síti
5. **Fyrirspáðu sítið þitt** -- Linkur til framtíðar (frontend)
...
- Að hýða menurefni sem eru ekki tengd við stjórnun fítnessíti (t.d. Umræður ef þú ert ekki með það)
- Að breyta fyrirhverfningum menurinn til að setja algengustu efni fyrst í lista
- Að bæta sérsniðnum merki á menurinn sem eru tengd nýtingu (t.d. "Þín Studio" í stað "Umsýnu")
...
- "Að breyta logopó og lögum stúdíða þín"
- "Að tengja eigin doménnaverslið" ( fyrir Growth/Pro viðskiptavini)
- "Að bæta niðursetningartölvustjórn í síðu þína"
...
- Frumtengingu og leiðurstofa
- Breytningu á hólfeytingar síðunnar
- Uppfæring skiljunar
- Að bæta við nýja tölvustjórnara
...
Visniðu þennan leikn:

- Sýna núverandi FitSite planinn þinn
- Visna uppgraderingstendur með fítesskuggafólki
...
- **Aktivitetarhlutfall**: Hvað er mögulegt hluti upphafsregistra sem hlutta sínum vísandi sér í sitt sviði innan fyrra veckan?
- **Innskráningar í fyrra veckan**: Hversu oft skrá sig nýr viðskiptavinur inn á netinu í fyrra veckan?
...
- **Velkomandi tölvupóstur-sekvens** sem leiðar viðskiptavili í fyrra veiku
- **Hjálparauðgerðir sérsniðnar fyrir nýjum eigendur fitness staða** sem ekki eru tæknilega ábyrgðin
- **Mælingar um innriðningu** til að fylgjast með og bæta upplifuna

---

**Næstu:** [Læoni 9: Setningur fyrir álsnefnd](lesson-9-pricing) -- við finnum fram á setningu fyrir verðsetningu til að ná maxima í skönum og minnimaða farið.
