...
Tvær samtímis beiðnir geta lesið sama gildið og báðar skrifað til baka sömu hækkuðu niðurstöðuna, þannig að ein talning tapast. `increment_item()` framselur útreikninginn til gagnagrunnsvélarinnar með einni `UPDATE ... SET column = column + ?` skipun, sem gerir aðgerðina í eðli sínu óskipta.
