...
|------|------|-------------|
| $notices | `array` | Listi yfir tilkynningar fyrir það tiltekna spjald. |
| $all_notices | `array` | Listi yfir tilkynningar sem hefur verið bætt við, aðskildar eftir spjaldi. |
| $panel | `string` | Spjald til að sækja tilkynningarnar. |
