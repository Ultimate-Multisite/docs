...
- **Aðallitur** — aðalmerkjavörulitur sem er notaður fyrir hnappa, tengla og áherslur
- **Aukalitur** — viðbótarlitur fyrir fjölbreytni
- **Áherslulitur** — litur til að draga fram mikilvæg atriði
...
- **Fyrirsagnaletur** — notað fyrir síðuheiti og kaflafyrirsagnir
- **Meginmálsletur** — notað fyrir málsgreinatexta og efni
- **Leturstærðir** — skalanlegar stærðir fyrir mismunandi skjástærðir
...
- Fullur leiðsagnarvalmynd
- Heildaruppsetning með öllum dálkum
...
- Skalanleg leiðsögn (hamborgaravalmynd)
- Uppsetning í einum dálki
...
| Tæki | Breidd | Forskoðun |
|--------|-------|---------|
| **Farsími** | 375px | Sími í lóðréttri stöðu |
| **Spjaldtölva** | 768px | Spjaldtölva í láréttri stöðu |
...
1. **Aðlaga liti** — breyta hvaða lit sem er í pallettunni
2. **Breyta letri** — velja aðrar leturgerðir
3. **Breyta bilum** — aðlaga innri og ytri spássíur
...
- Forskoðun fyrir skjáborð uppfærist strax
- Forskoðun fyrir farsíma uppfærist strax
...
- **Upprunalega hönnun** — sjáðu hvað breyttist
...
1. **Yfirfarðu báðar forskoðanir** — staðfestu að skjáborð og farsími líti vel út
2. **Athugaðu alla liti** — tryggðu birtuskil og aðgengi
3. **Prófaðu leturfræði** — staðfestu læsileika í öllum stærðum
...
1. Theme Builder býr til heildarþemað þitt
2. Þemað er sett upp á WordPress vefsvæðinu þínu
...
- **Staðfestu birtuskil** — notaðu [Validate Palette Contrast](../abilities/validate-palette-contrast.md) fyrir aðgengi
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — athuga litaaðgengi
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — búa til sérsniðin lógó
