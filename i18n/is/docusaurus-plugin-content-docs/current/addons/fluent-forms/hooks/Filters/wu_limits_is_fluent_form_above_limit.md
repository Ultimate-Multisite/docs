...
title: Sía - wu_limits_is_fluent_form_above_limit
...
| Nafn | Tegund | Lýsing |
|------|------|-------------|
| $value | `bool` | Hvort eyðublaðstegundin sé yfir hámarki eða ekki |
| $form_type | `string` | Eyðublaðstegundin sem verið er að athuga |
