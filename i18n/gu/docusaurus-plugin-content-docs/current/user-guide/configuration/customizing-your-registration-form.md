...
---
# તમારા નોંધણી ફોર્મને કસ્ટમાઇઝ કરવું {#customizing-your-registration-form}
...
## લૉગિન અને નોંધણી પૃષ્ઠો: {#login-and-registration-pages}
...
## બહુવિધ નોંધણી ફોર્મ્સનો ઉપયોગ કરવો: {#using-multiple-registration-forms}
...
## URL પરિમાણો દ્વારા ઉત્પાદનો અને ટેમ્પ્લેટ્સને પૂર્વ-પસંદ કરવું: {#pre-selecting-products-and-templates-via-url-parameters}
...
### ટેમ્પ્લેટ્સ માટે: {#for-templates}
