...
---
# સાઇટ ટેમ્પલેટ્સ (v2) {#site-templates-v2}
...
## સાઇટ ટેમ્પલેટ શું છે? {#what-is-a-site-template}
...
## નવું સાઇટ ટેમ્પલેટ બનાવવું અને સંપાદિત કરવું {#creating-and-editing-a-new-site-template}
...
### સાઇટ ટેમ્પલેટની સામગ્રી કસ્ટમાઇઝ કરવી {#customizing-the-contents-of-a-site-template}
...
### અદ્યતન વિકલ્પો {#advanced-options}
...
### સાઇટ ટેમ્પલેટ્સનો ઉપયોગ {#using-site-templates}
...
#### મોડ 1: સાઇટ ટેમ્પલેટ સોંપો {#mode-1-assign-site-template}
...
#### મોડ 2: ઉપલબ્ધ સાઇટ ટેમ્પલેટ પસંદ કરો {#mode-2-choose-available-site-template}
...
### ડિફોલ્ટ મોડ: Checkout ફોર્મ પર સાઇટ ટેમ્પલેટ પસંદગી {#default-mode-site-template-selection-on-the-checkout-form}
...
### સાઇટ ટેમ્પલેટ વિકલ્પો {#site-template-options}
...
#### ટેમ્પલેટ બદલવાની મંજૂરી આપો {#allow-template-switching}
...
#### વપરાશકર્તાઓને તેમની સાઇટને ટેમ્પલેટ તરીકે ઉપયોગ કરવાની મંજૂરી આપો {#allow-users-to-use-their-site-as-templates}
...
#### ટેમ્પલેટ ડુપ્લિકેશન પર મીડિયા કૉપી કરો {#copy-media-on-template-duplication}
...
#### **સર્ચ એન્જિનોને સાઇટ ટેમ્પલેટ્સ ઇન્ડેક્સ કરવાથી રોકો** {#prevent-search-engines-from-indexing-site-templates}
...
## ઓટો શોધ-અને-બદલો વડે સાઇટ ટેમ્પલેટ્સ પૂર્વ-ભરવા {#pre-populating-site-templates-with-auto-search-and-replace}
...
### "placeholdersથી ભરેલા ટેમ્પલેટ" સમસ્યા ઉકેલવી {#solving-the-template-full-of-placeholders-problem}
