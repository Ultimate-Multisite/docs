...
## Agent Picker ઍક્સેસ કરવું {#accessing-the-agent-picker}
...
## પાંચ બિલ્ટ-ઇન Agents {#the-five-built-in-agents}
...
## Superdav ઓટોમેશન એકીકરણો {#superdav-automation-integrations}
...
## એજન્ટ્સને કસ્ટમાઇઝ કરવું {#customising-agents}

દરેક બિલ્ટ-ઇન એજન્ટને `gratis_ai_agent_agents` ફિલ્ટર દ્વારા વિસ્તારી અથવા બદલી શકાય છે.

### અસ્તિત્વમાં રહેલા એજન્ટમાં કસ્ટમ સિસ્ટમ પ્રોમ્પ્ટ ઉમેરવું {#adding-a-custom-system-prompt-to-an-existing-agent}
...
### નવો એજન્ટ નોંધવો {#registering-a-new-agent}
...
### બિલ્ટ-ઇન એજન્ટ દૂર કરવો {#removing-a-built-in-agent}
