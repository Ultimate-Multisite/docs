...
---
# WordPress Multisite શું છે? {#what-is-wordpress-multisite}
...
## WordPress Multisite ખરેખર શું છે? {#what-exactly-is-wordpress-multisite}
...
## Subdomain કે Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites વચ્ચે શું share થાય છે અને શું નથી {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite પર User management {#user-management-on-wordpress-multisite}
...
## Performance બાબતો {#performance-considerations}
