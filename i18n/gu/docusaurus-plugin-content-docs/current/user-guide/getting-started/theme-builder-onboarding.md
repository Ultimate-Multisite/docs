...
## Theme Builder Onboarding Flow શું છે?
...
## Theme Builder Onboarding શરૂ કરવો

### પ્રથમ-વપરાશ સેટઅપ (First-Run Setup)
...
## Onboarding ના પગલાં (The Onboarding Steps)

### પગલું ૧: મોડ સિલેક્શન (Mode Selection)
...
### પગલું ૨: સાઇટ સ્પેસિફિકેશન (Site Specification)
...
### પગલું ૩: ડિઝાઇન સિસ્ટમ નિર્ણયો (Design System Decisions)
...
### પગલું ૪: થીમ જનરેશન (Theme Generation)
...
### પગલું ૫: એક્ટિવેશન અને વેરિફિકેશન (Activation and Verification)
...
## Site Specification અને site_brief Memory
...
### site_brief શા માટે મહત્વનું છે
...
## Onboarding પછી કસ્ટમાઇઝેશન (Customizing After Onboarding)

Theme Builder onboarding પૂર્ણ થયા પછી, તમે આ કરી શકો છો:

### Design System Aesthetics Skill નો ઉપયોગ કરવો
...
### theme.json માં સીધું એડિટ કરવું
...
## સરખામણી: જૂનું વિરુદ્ધ નવું Onboarding (Comparison: Old vs. New Onboarding)
