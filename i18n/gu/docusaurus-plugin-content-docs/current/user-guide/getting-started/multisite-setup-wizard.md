...
## વિઝાર્ડ ક્યારે દેખાય છે? {#when-does-the-wizard-appear}
...
## સ્ટેપ 2: નેટવર્ક Configuration {#step-2-network-configuration}

આ સ્ટેપ તમને તમારી network settings configure કરવા માટે કહે છે.

### સાઇટ Structure {#site-structure}
...
## સ્ટેપ 3: Installation {#step-3-installation}
...
### વિઝાર્ડ કહે છે કે wp-config.php writable નથી {#the-wizard-says-wp-configphp-is-not-writable}
...
### Setup પછી Sites accessible નથી (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Setup પછી Authentication issues {#authentication-issues-after-setup}
...
### Installation દરમિયાન કોઈ step fail થયું {#a-step-failed-during-installation}
