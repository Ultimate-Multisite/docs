...
---
# હું WordPress Multisite કેવી રીતે ઇન્સ્ટોલ કરું? {#how-do-i-install-wordpress-multisite}
...
# /wp-admin માં trailing slash ઉમેરો {#add-a-trailing-slash-to-wp-admin}
...
## સામાન્ય સમસ્યાઓ: {#common-problems}

### 1\. હું નવી sites બનાવી શકું છું પણ તે accessible નથી. {#1-i-can-create-new-sites-but-they-are-not-accessible}
