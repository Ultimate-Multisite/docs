...
## ડોમેન મેપિંગ શું છે? {#whats-domain-mapping}
...
### તમારા Ultimate Multisite નેટવર્ક પર ડોમેન મેપિંગ કેવી રીતે સેટઅપ કરવું {#how-to-setup-domain-mapping-on-your-ultimate-multisite-network}
...
### ડોમેન DNS settings યોગ્ય રીતે કૉન્ફિગર થયેલી છે તેની ખાતરી કરવી {#making-sure-the-domain-dns-settings-are-properly-configured}
...
### Super Admin તરીકે કસ્ટમ ડોમેન નામ મેપ કરવું {#mapping-custom-domain-name-as-super-admin}
...
### Subsite user તરીકે custom domain name mapping કરવું {#mapping-custom-domain-name-as-subsite-user}
...
### Domain Syncing વિશે {#about-domain-syncing}
