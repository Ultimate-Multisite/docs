...
### 1. તમારા cPanel Credentials મેળવો {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php માં Constants ઉમેરો {#2-add-constants-to-wp-configphp}
...
### 3. Integration Enable કરો {#3-enable-the-integration}
...
## સમસ્યાનું નિવારણ {#troubleshooting}
...
### Domain ઉમેરાયું નથી {#domain-not-added}
