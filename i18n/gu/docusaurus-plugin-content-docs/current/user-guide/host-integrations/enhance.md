...
### System જરૂરિયાતો {#system-requirements}
...
## તમારા API Credentials મેળવવા {#getting-your-api-credentials}

### 1. API Token બનાવો {#1-create-an-api-token}
...
### 2. તમારું Organization ID મેળવો {#2-get-your-organization-id}
...
### 3. તમારું Server ID મેળવો {#3-get-your-server-id}
...
### 4. તમારું API URL મેળવો {#4-get-your-api-url}
...
### જરૂરી Constants {#required-constants}
...
### Integration Wizard દ્વારા Setup {#setup-via-integration-wizard}
...
## વધારાનું WordPress Configuration {#additional-wordpress-configuration}
...
### જ્યારે Domain Map થાય છે {#when-a-domain-is-mapped}
...
### જ્યારે Domain Remove થાય છે {#when-a-domain-is-removed}
...
### DNS અને SSL Checking {#dns-and-ssl-checking}
...
## Setup Verify કરવું {#verifying-setup}

### Connection Test કરો {#test-the-connection}
...
### Domain Map કર્યા પછી {#after-mapping-a-domain}
...
### સામાન્ય રીતે વપરાતા Endpoints {#common-endpoints-used}
...
### સંપૂર્ણ API Documentation {#full-api-documentation}
...
## વધારાના Resources {#additional-resources}
