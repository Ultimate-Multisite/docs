...
### 1. તમારા GridPane API Credentials મેળવો {#1-get-your-gridpane-api-credentials}
...
### 2. તમારા Server અને Site IDs મેળવો {#2-get-your-server-and-site-ids}
...
### 4. Integration Enable કરો {#4-enable-the-integration}
