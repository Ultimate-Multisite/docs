...
### 1. તમારા ServerPilot API ક્રેડેન્શિયલ્સ મેળવો {#1-get-your-serverpilot-api-credentials}
...
### 2. તમારું App ID મેળવો {#2-get-your-app-id}
...
### 4. ઇન્ટિગ્રેશન સક્રિય કરો {#4-enable-the-integration}
...
### SSL Certificate મેનેજમેન્ટ {#ssl-certificate-management}
...
## SSL Certificate ચકાસણી {#ssl-certificate-verification}
...
### ડોમેન દૂર કરવું {#domain-removal}
