...
અહીં API Settings પેજનો સંપૂર્ણ view છે:

![API Settings સંપૂર્ણ પેજ](/img/config/settings-api-full.png)
...
## Zapier માં action બનાવવું {#creating-an-action-in-zapier}
...
### Action બનાવવું {#creating-an-action}
