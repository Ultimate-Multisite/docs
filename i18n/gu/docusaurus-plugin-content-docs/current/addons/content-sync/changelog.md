---
title: સામગ્રી સિંક ફેરફારની નોંધ
sidebar_position: 99
...
* નવું: ટેમ્પલેટ સાઇટ્સ માટે ચાઇલ્ડ સાઇટનું પ્રી-સિલેક્શન.
* નવું: બધા પોસ્ટ પ્રકારો માટે post_content માંથી મીડિયા નિષ્કર્ષણ (Media extraction).
* નવું: ટેક્સોનોમી sync કરવું (categories, tags, custom taxonomies).
* બદલાયું: "Elementor Template Sync" નું નામ બદલીને "Content Sync" કરવામાં આવ્યું.
...
* સ્વચાલિત ID રીમેપિંગ સાથે સંપૂર્ણ મીડિયા sync.
* Ultimate Multisite સાથે સેટિંગ્સનું એકીકરણ (Settings integration).
* નેટવર્ક સેટિંગ્સ દ્વારા સાઇટ બાકાત રાખવાનો સપોર્ટ (Site exclusion support).
* sync પછી Elementor કેશ સાફ કરવો (Cache clearing).
* ટેમ્પલેટ ટેક્સોનોમીનું સંરક્ષણ (Template taxonomy preservation).
