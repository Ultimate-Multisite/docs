...
title: ફિલ્ટર - wu_domain_seller_search_delay
sidebar_label: wu_domain_seller_search_delay
_i18n_hash: b0871b15059808a847875636d151245f
---
# Filter: wu_domain_seller_search_delay

ડોમેન સર્ચના ડીબાઉન્સ ડિલે (debounce delay) ને મિલિસેકન્ડ્સમાં ફેરફાર કરે છે.

ધીમા કનેક્શન્સ પર API કોલ્સ ઘટાડવા માટે આ મૂલ્ય વધારવું.

## Parameters

| Name | Type | Description |
|------|------|-------------|
| $delay | `int` | મિલિસેકન્ડ્સમાં ડીબાઉન્સ ડિલે. ડિફોલ્ટ 500 છે. |
