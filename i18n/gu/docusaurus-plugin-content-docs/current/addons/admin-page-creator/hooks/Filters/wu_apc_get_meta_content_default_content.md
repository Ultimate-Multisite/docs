...
ડેવલપર્સને ડિફોલ્ટ વેલ્યુઝને ફિલ્ટર કરવાની મંજૂરી આપે છે.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $default_value | `string` | ડિફોલ્ટ વેલ્યુ. |
| $meta_type | `string` | જે પ્રકારના મેટા ડેટા મેળવવાનો છે તેનો પ્રકાર. |
