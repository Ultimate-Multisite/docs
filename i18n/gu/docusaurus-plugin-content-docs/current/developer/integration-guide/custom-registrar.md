...
### વૈકલ્પિક methods (Optional methods)
...
## તમારી capability રજીસ્ટર કરવી (Registering your capability)
...
## wizard માં credential fields ઉમેરવા (Adding credential fields to the wizard)
...
## post-registration actions માટે hooks (Hooks for post-registration actions)
