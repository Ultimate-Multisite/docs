...
જ્યારે કોઈ object ને database માં save (store) કરવામાં આવે છે, ત્યારે આ action ચાલે છે.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $result | `bool` | જો object સફળતાપૂર્વક delete થઈ ગયું હોય, તો `True` આવશે. |
| $this | `\Base_Model` | આ object નું instance છે. |
