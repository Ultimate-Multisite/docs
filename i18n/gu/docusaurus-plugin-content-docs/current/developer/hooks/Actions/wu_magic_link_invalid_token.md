...
title: ક્રિયા - wu_magic_link_invalid_token
sidebar_label: wu_magic_link_invalid_token
_i18n_hash: 122806eb779ac296404a6984019a9e98
---
# Action: wu_magic_link_invalid_token

જ્યારે કોઈ અમાન્ય મેજિક લિંક ટોકન (magic link token) મળે ત્યારે આ એક્શન ટ્રિગર થાય છે.

## Parameters

| Name | Type | Description |
|------|------|-------------|
| $reason | `string` | અમાન્ય ટોકનનું કારણ. |
