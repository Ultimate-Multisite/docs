...
## Качан колдонуу керек {#when-to-use-it}
...
## Файл аталышынын эрежеси {#file-naming-convention}
...
## Файлды кайда жайгаштыруу керек {#where-to-place-the-file}
...
## Жеткиликтүү hook’тор жана filter’лер {#hooks-and-filters-available}
...
## Минималдуу мисал {#minimal-example}
