---
title: Хуктарды колдонуу боюнча колдонмо
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks колдонуу колдонмосу {#hooks-usage-guide}

Ultimate Multisite 200дөн ашык action hook жана 280ден ашык filter hook камсыздайт. Бул баракта практикалык мисалдар менен эң көп колдонулган hooks камтылган. Толук автоматтык түрдө түзүлгөн маалымдама үчүн бул бөлүмдөгү башка барактарды карап чыгыңыз.

## Action Hooks {#action-hooks}

### Кардардын жашоо цикли {#customer-lifecycle}

#### Кардар түзүлгөндөн кийин {#after-customer-creation}
...
#### Кардардын статусу өзгөргөндө {#customer-status-change}
...
### Сайт hooks {#site-hooks}

#### Сайт жарыялангандан кийин {#after-site-published}
...
#### Калып колдонулардан мурун {#before-template-application}
...
### Мүчөлүк hooks {#membership-hooks}

#### Статустун өтүүлөрү {#status-transitions}
...
### Төлөм hooks {#payment-hooks}

#### Төлөм аяктады / ишке ашкан жок {#payment-completed--failed}
...
#### Иштетүүдөн мурун / Аяктагандан кийин {#before-processing--after-completion}
...
### Баа чыпкалары {#pricing-filters}

#### Себеттин жалпы суммасы {#cart-total}
...
### Калып чыпкалары {#template-filters}
...
### Чектөө чыпкалары {#limitation-filters}
...
### Gateway чыпкалары {#gateway-filters}
...
### Checkout формасынын талаалары {#checkout-form-fields}
