...
---
# Чыпка: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

Биз константаларыбызды кайсы жерге киргизе аларыбызды аныктоого аракет кылганда үч үлгүнү текшеребиз:
...
[`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) ичинде 143-сапта аныкталган
