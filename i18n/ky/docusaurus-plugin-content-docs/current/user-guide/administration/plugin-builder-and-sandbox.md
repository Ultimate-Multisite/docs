...
---
# Плагин Билдер жана Сандбокс {#plugin-builder--sandbox}
...
## AI аркылуу плагиндерди генерациялоо {#generating-a-plugin-via-ai}
...
## Сансбокс активдештирүү {#sandbox-activation}
