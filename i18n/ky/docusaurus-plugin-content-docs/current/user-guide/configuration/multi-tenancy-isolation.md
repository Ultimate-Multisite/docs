...
## Базалык хост байланышы (Database host binding) {#database-host-binding}
...
## Файл системасынын түпкү каталогу (Filesystem root) {#filesystem-root}
...
## Орнотуу тартиби {#provisioning-order}
...
## Суверейн кардарды башкаруу процесстери {#sovereign-customer-management-flows}
