...
## Конечная точка тела параметрлери {#endpoint-body-parameters}
...
### **Мемлекеттик мүлүкат (Membership)** {#membership}
...
## Zapierде аракет (action) түзүү {#creating-an-action-in-zapier}
...
### Аракет түзүү {#creating-an-action}
...
### Полные параметры конечной точки (Complete endpoint parameters) {#complete-endpoint-parameters}
