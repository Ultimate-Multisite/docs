...
### 1. ServerPilot API күчтүңүздү алыңыз {#1-get-your-serverpilot-api-credentials}
...
### 2. App ID'ңизди алыңыз {#2-get-your-app-id}
...
### Домен синхролоосу {#domain-syncing}
...
### SSL Сertifikatтарын Баскычтаруу (Management) {#ssl-certificate-management}
...
## SSL Сertifikatтарын Текшерүү (Verification) {#ssl-certificate-verification}
...
## Ар кандай Кырдаалдарды Чечимдөө (Troubleshooting) {#troubleshooting}

### API Байланышы Кырдаалдары {#api-connection-issues}
...
### SSL Сertifikatтары Кырдаалдары {#ssl-certificate-issues}
...
### Домен Кошолбогон {#domain-not-added}
