...
### 1. RunCloud API маалыматтарын алыңыз
...
### 2. Сервер жана App ID'дерин алыңыз
...
### 4. Интеграцияны иштетүү (Enable the Integration)
