...
---
# Контрол панели интеграциясын жакшыртуу {#enhance-control-panel-integration}
...
### Системалык талаптар {#system-requirements}
...
### API кирүү {#api-access}
API токендерин түзүү үчүн Enhance Control Panel администраторлук укугуңуз болушу керек.

## API киргизүүлөрүңүздү алуу {#getting-your-api-credentials}

### 1. API Токени түзүү {#1-create-an-api-token}
...
### 2. Получение Идентификатора Организации (Get Your Organization ID) {#2-get-your-organization-id}
...
### 3. Получение Идентификатора Сервера (Get Your Server ID) {#3-get-your-server-id}
...
### 4. Получение URL API (Get Your API URL) {#4-get-your-api-url}
...
### Интеграция аркы аркы орнотуучу менен {#setup-via-integration-wizard}
...
## Кошумча WordPress конфигурациясы {#additional-wordpress-configuration}
...
### Домен карталганда {#when-a-domain-is-mapped}
...
### Домен алынса качан {#when-a-domain-is-removed}
...
### DNS жана SSL текшерүү {#dns-and-ssl-checking}
...
## Орноту текшерүү {#verifying-setup}

### Байланышты сынап көрүү {#test-the-connection}
...
### Доменди маптандыktan кийин {#after-mapping-a-domain}
...
## Кырдаалды Араалануу (Troubleshooting) {#troubleshooting}

### API Байланышы Керектенбейт {#api-connection-issues}
...
### Домен Койлучы Эмес {#domain-not-added}
...
### SSL Сertifikat Маселелери {#ssl-certificate-issues}
...
### DNS Чексилдирилиш Интервалы {#dns-check-interval}
...
### Аутентификация каталары {#authentication-errors}
...
### Колдонулган Көрсөткүчтөр (Endpoints) {#common-endpoints-used}
...
### Толук API Документациясы {#full-api-documentation}
...
### Аткаруу (Performance) {#performance}
...
## Кошумча булактар (Additional Resources) {#additional-resources}
