...
---
# Ultimate Multisite'у Zapier менен интеграциялоо {#integrating-ultimate-multisite-with-zapier}
...
## Башталыш кантип жасалат {#how-to-start}
...
## Жаңы Триггерди кантип түзүү керек {#how-to-create-a-new-trigger}
...
## Иш-аракеттерди кантип түзүү керек {#how-to-create-actions}
...
### Иш-аракетти коюу {#setting-up-the-action}
