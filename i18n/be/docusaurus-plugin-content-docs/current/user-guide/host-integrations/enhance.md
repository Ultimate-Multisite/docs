...
### Наладванне праз Wizard інтэграцыі
...
## Дадатковая канфігурацыя WordPress
...
### Частыя адканіцы, якія выкарыстоўваюцца
