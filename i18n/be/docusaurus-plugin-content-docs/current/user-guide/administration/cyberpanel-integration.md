...
### API Connection Refused (Адмова ў злучэнні API)
...
### Authentication Errors (Памылкі аўтэнтыкацыі)
...
### Domain Not Created (Домен не створаны)
...
### SSL Certificate Not Issued (Сертыфікат SSL не правайдарваны)
