...
---
# Акрэдасць Абілітып {#ability-visibility}
...
## Што такое Акурэчнасць Абілітып? {#what-is-ability-visibility}
...
## Узнікі Акурэчнасці {#visibility-levels}

### Public (Публічныя) {#public}
...
## Кіраванне Акурэчнасцю Абілітып {#managing-ability-visibility}

### Як дабраць да Наколення Акурэчнасці Абілітып {#accessing-ability-visibility-settings}
...
### Пагляд Дэтайляў Абілітып {#viewing-ability-details}
...
### Змена Узроўняў Акурэчнасці {#changing-visibility-levels}
...
### Паўтурная праца {#bulk-operations}
...
### Пазначаванне Абілітып Партнёрам {#assigning-abilities-to-partners}
...
### Адзысканне Даступу Партнёра {#revoking-partner-access}
...
## Unclassified Abilities (Невызнаныя Абілітып) {#unclassified-abilities}

Калі вы ўсталяеце знешнюю абілітып, якую Superdav AI Agent не разпізнавае, яна адзначаецца як **Unclassified**.

### Паведамленне Адміністратара для Unclassified Abilities {#admin-notice-for-unclassified-abilities}
...
### Пагляд Unclassified Abilities {#reviewing-unclassified-abilities}
...
### Чаму трэба класіфікаваць Unclassified Abilities? {#why-classify-unclassified-abilities}
...
## Акурэчнасць у Розных Паверхнях {#visibility-in-different-surfaces}
...
### Chat Interface (Чатавы інтэрфейс) {#chat-interface}
...
## Найлепшыя Практыкі Бяспекі {#security-best-practices}

### Прынцип Найменьшых Прывілегий {#principle-of-least-privilege}
...
### Рэгулярны Аудыт {#regular-audits}
...
### Лёгкі і Маніторынг {#logging-and-monitoring}
...
### Знешнія Абілітып {#third-party-abilities}
...
## Выяўленне Паಡ್чынкаў {#troubleshooting}
...
## Міграцыя з Легасі-рэжыму {#migration-from-legacy-mode}
