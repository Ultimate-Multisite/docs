...
---
# Наладжаванне шлюзу PayPal (v2) {#setting-up-the-paypal-gateway-v2}
...
## Актывацыя PayPal у вашай сетцы {#enabling-paypal-on-your-network}
...
## Выкарыстанне паказальнага мастака наладжавання {#using-the-guided-setup-wizard}
...
## Атрыманне API-усыкоўкаў PayPal {#getting-the-paypal-api-credentials}
