...
## Як праверыць, ці карыстальнік пад дадзеным планам і/або мае актыўную падпіску
...
## Выпраўленне праблем CORS з Font-Icons у мапіраваных домен значэннях
## Выпраўленне праблем CORS з Font-Icons у мапіраваных домен значэннях
