...
---
# Стваৰванне кастымава интеграцыі рэгістратара {#building-a-custom-registrar-integration}
...
### Неабязначальныя методы {#optional-methods}
...
### Канвенцыя па вяртанні значэння {#return-value-convention}
...
## Рэгістрацыя вашай функцыянальнасці {#registering-your-capability}
...
## Дадаванне паляў для ўвайസ്‌ткаў (Credentials) {#adding-credential-fields-to-the-wizard}
...
## Hooks для дзеянняў пасля рэгістрацыі {#hooks-for-post-registration-actions}
...
## Журналіраванне (Logging) {#logging}
