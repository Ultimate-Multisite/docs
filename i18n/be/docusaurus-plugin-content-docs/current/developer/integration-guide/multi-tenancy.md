...
## Паток пачатковай наладкі арандатара {#tenant-bootstrap-flow}
...
## SSO і REST-хукі {#sso-and-rest-hooks}
...
## URL-адрасы дзеянняў суверэннага кліента {#sovereign-customer-action-urls}
...
## Праверка міграцыі {#migration-verification}
...
## Выдаленне арандатара {#tenant-deletion}
...
## Састарэлы маршрутызатар базы даных {#deprecated-database-router}
