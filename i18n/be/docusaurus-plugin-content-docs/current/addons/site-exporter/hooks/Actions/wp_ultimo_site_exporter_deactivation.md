...
Дазваляе іншым часткам плагіна падключыць свае функцыі, якія спрацуюць пры адактывацыі.
...
Вызначана ў [`inc/class-hooks.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/class-hooks.php#L99) на 99-й кропцы.
