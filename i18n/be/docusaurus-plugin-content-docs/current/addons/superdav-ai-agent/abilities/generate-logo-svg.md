...
---
# Генерацыя SVG-логотыпу {#generate-logo-svg}
...
## Паводзіны санітызацыі SVG {#svg-sanitisation-behaviour}
...
## Прыклад выкарыстання {#usage-example}
