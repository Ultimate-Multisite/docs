...
Inafanya kazi baada ya kitu (object) kuhifadhiwa kwenye database.

## Vigezo {#parameters}

| Jina | Aina | Maelezo |
|------|------|-------------|
| $data | `array` | Data ya kitu (object) ambayo itahifadhiwa. |
| $this | `\Base_Model` | Tohari (instance) ya kitu hicho. |
| $new | `bool` | Kweli (True) ikiwa kitu hicho ni kipya. |
