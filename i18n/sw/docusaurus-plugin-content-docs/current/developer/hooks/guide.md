...
## Action Hooks (Hooks za Matukio)

### Customer Lifecycle (Mzunguko wa Maisha ya Mteja)

#### After Customer Creation (Baada ya Kuunda Mteja)
...
#### Customer Status Change (Mabadiliko ya Hali ya Mteja)
...
### Site Hooks (Hooks za Tovuti)

#### After Site Published (Baada ya Kuchapishwa kwa Tovuti)
...
#### Before Template Application (Kabla ya Kutumia Template)
...
### Membership Hooks (Hooks za Uanachama)

#### Status Transitions (Mabadiliko ya Hali)
...
### Payment Hooks (Hooks za Malipo)

#### Payment Completed / Failed (Malipo Yamekamilika / Yamefeli)
...
### Checkout Hooks (Hooks za Kukamilisha Ununuzi)

#### Before Processing / After Completion (Kabla ya Kuchakata / Baada ya Kukamilika)
...
## Filter Hooks (Hooks za Kuchuja)

### Pricing Filters (Hooks za Bei)

#### Cart Total (Jumla ya Kikapu)
...
### Template Filters (Hooks za Template)
...
### Limitation Filters (Hooks za Kuzuia/Kipunguzia)
...
### Gateway Filters (Hooks za Milango ya Malipo)
...
### Checkout Form Fields (Viwanja vya Fomu ya Checkout)
...
### Email Content (Maudhui ya Barua Pepe)
