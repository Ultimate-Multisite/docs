...
title: Kichujio - wu_country_get_administrative_division_name
...
| Name | Type | Maelezo |
|------|------|-------------|
| $name | `string` | Jina la sehemu hiyo. Kwa kawaida ni kitu kama jimbo, mkoa, eneo, n.k. |
| $country_code | `string` | Msimbo wa nchi wa herufi mbili wa ISO. |
| $state_code | `string` | Msimbo wa jimbo wa herufi mbili wa ISO. |
