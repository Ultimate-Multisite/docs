...
// Ongeza 5 kwenye kihesabu cha matumizi.
...
Ombi mbili yanayotokea kwa wakati mmoja yanaweza kusoma thamani moja na yote mawili kuandika tena matokeo yaliyoongezeka, na hivyo kupoteza hesabu moja. `increment_item()` inawapa kazi ya kufanya hesabu kwa injini ya database kwa taarifa moja ya `UPDATE ... SET column = column + ?`, na hivyo kufanya shughuli hiyo kuwa ya atomic (salama kwa wakati mmoja).
