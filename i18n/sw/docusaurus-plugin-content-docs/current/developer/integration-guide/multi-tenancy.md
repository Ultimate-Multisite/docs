...
## Mtiririko wa kuanzisha mpangaji {#tenant-bootstrap-flow}
...
## Hooks za SSO na REST {#sso-and-rest-hooks}
...
## URL za vitendo vya mteja huru {#sovereign-customer-action-urls}
...
## Uthibitishaji wa uhamishaji {#migration-verification}
...
## Kufuta mpangaji {#tenant-deletion}
...
## Router ya database iliyopitwa na wakati {#deprecated-database-router}
