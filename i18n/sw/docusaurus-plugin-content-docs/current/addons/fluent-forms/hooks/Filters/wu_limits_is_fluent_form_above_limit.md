...
title: Kichujio - wu_limits_is_fluent_form_above_limit
sidebar_label: wu_limits_is_fluent_form_above_limit
_i18n_hash: 8fd05176d097f0d8576b5656778bd633
---
# Filter: wu_limits_is_fluent_form_above_limit

Inachangia kuangalia kama aina fulani ya fomu inaruhusiwa kwenye mpango huu. Inaruhusu watengenezaji wa plugin kufiliri thamani inayorejeshwa.

## Vipengele {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $value | `bool` | Ikiwa aina ya fomu imepita kikomo au la |
| $form_type | `string` | Aina ya fomu inayopitiwa ukaguzi |
| $form_count | `int` | Idadi ya fomu kwa sasa |
| $quota | `int` | Kikomo kinachoruhusiwa |
