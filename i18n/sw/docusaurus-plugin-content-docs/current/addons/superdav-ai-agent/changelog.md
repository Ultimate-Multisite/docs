...
- **Milango ya idhini ya binadamu na rekodi za vikumbusho** — simamisha otomatiki kwa ukaguzi na epuka arifa zinazojirudia
...
- **Uwezo wa Validate Palette Contrast** — kagua jozi za rangi kwa ulinganifu wa WCAG kabla ya kuzitumia kwenye mandhari
- **Menyu za ukarimu** — Theme Builder sasa inaweza kutengeneza kurasa zilizopangwa za menyu za chakula na vinywaji kwa biashara za ukarimu
- **Uonyeshaji wa hakikisho la desktop na simu** — hakiki muundo wako kwenye vifaa vya desktop na simu wakati wa uteuzi wa mwelekeo wa muundo
...
- **Amri za WP-CLI** — zimerejesha alias za namespace zilizokosekana baada ya refactor ya awali
- **Otomatiki ya matukio** — hushughulikia kwa ustaarabu tovuti ambazo jedwali za otomatiki bado hazijaundwa
- **Uwezo wa memory-save** — sasa hutumia kiambishi sahihi cha namespace katika kijenzi cha maagizo ya mfumo
- **Matokeo ya zana ya Scalar** — sasa yanafungwa kwa usahihi kabla ya kurejeshwa kwa AI
- **Takwimu za matumizi** — sasa hushughulikia kwa usahihi muundo wa zamani wa ufunguo wa uwezo wakati wa kuboresha kutoka matoleo ya zamani
