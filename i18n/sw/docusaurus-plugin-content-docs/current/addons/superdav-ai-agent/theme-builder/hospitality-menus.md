...
- **Barları na Lounges** — menyu za vinywaji na viambatanishi
- **Magahawa ya Keki** — menyu za keki na mkate
- **Huduma za Uandaaji Chakula** — chaguo za menyu kwa ajili ya matukio
...
- **Vyakula vya Kuanzia** — viambatanishi na sahani ndogo
- **Chakula Kikuu** — milango mikuu ya chakula
- **Vyakula vya Kuambatana** — viambatanishi na mboga
- **Vitamu** — vitafunio vitamu
...
|-------|------|-------------|
| `name` | string | Jina la chakula au kinywaji |
| `description` | string | Maelezo ya kina ya kipengele |
| `price` | string | Bei (iliyofomatiwa na sarafu) |
| `dietary_info` | array | Sifa za lishe (Vegan, Gluten-Free, n.k.) |
...
1. Anaunda kurasa yenye muundo wa menyu
2. Anaiunda ili iendane na muundo wa tovuti yako
3. Anapanga vitu katika makundi
...
1. Kuhariri vitu vya menyu na bei
2. Kuongeza au kuondoa makundi
3. Kupanga upya vitu ndani ya makundi
...
- Umeandaliwa kwa makundi
- Unaweza kutafutwa na kufilterishwa
...
- Vitu maarufu kwenye ukurasa wa nyumbani
- Maalum ya kila siku kwenye upande (sidebar)
...
- **Vegan** — hakuna bidhaa za wanyama
- **Vegetarian** — hakuna nyama
- **Gluten-Free** — salama kwa wagonjwa wa ugonjwa wa celiac
- **Dairy-Free** — hakuna bidhaa za maziwa
- **Nut-Free** — hakuna karanga za miti au karanga za kavu
...
- **Nuts** — karanga za miti na karanga za kavu
- **Shellfish** — viwango vya baharini na malango
- **Fish** — aina zote za samaki
- **Dairy** — maziwa na bidhaa za maziwa
- **Eggs** — mayai ya kuku
- **Soy** — bidhaa za soya
...
1. Nenda kwenye ukurasa wa menyu
2. Bonyeza "Edit Menu"
3. Sasisha bei kwa vitu
...
1. Unda toleo jipya la menyu
2. Ongeza vitu vya msimu
3. Weka alama kwenye vitu kama "Seasonal"
...
1. Unda kundi la "Specials"
2. Ongeza vitu na tarehe za upatikanaji
3. Angazia maalum kwenye ukurasa wa nyumbani
...
1. **Uthibitishaji wa menyu kiotomatiki** — unatambua ikiwa wewe ni biashara ya chakula/vinywaji
2. **Uundaji wa kurasa za menyu** — unatengeneza kurasa za menyu zenye kitaalamu
3. **Kufanana na muundo** — menyu zinaendana na muundo wa tovuti yako
...
- **Bei thabiti** — sarafu na muundo wazi
...
- **Jumuisha viyenye mzio** — orodhesha kila wakati viyenye mzio
...
- **Lebo za lishe** — weka alama wazi chaguo za lishe
...
- [Discovery Interview](./discovery-interview.md) — panga muundo wa tovuti yako
