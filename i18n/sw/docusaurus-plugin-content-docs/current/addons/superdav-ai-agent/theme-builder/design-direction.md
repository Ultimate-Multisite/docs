...
- **Primary color** — rangi kuu ya brand inayotumika kwa vitufe (buttons), viungo (links), na sehemu za kuzingatia.
- **Secondary color** — rangi inayokamilisha rangi kuu kwa ajili ya mabadiliko.
- **Accent color** — rangi ya kutangaza kwa vipengele muhimu.
...
- **Heading font** — hutumika kwa vichwa vya habari na vichwa vya sehemu.
- **Body font** — hutumika kwa maandishi ya aya na maudhui.
- **Font sizes** — ukubwa wa fonti unaobadilika kwa ukubwa tofauti wa skrini.
...
- **Icons** — mtindo na ukubwa wa icon.
...
- Menyu kamili ya navigation.
- Mpangilio kamili na nguzo zote.
...
- Navigation inayobadilika (hamburger menu).
- Mpangilio wa nguzo moja.
...
|--------|-------|---------|
| **Mobile** | 375px | Simu ya potreti |
| **Tablet** | 768px | Tablet ya msimamo wima |
...
1. **Kurekebisha rangi** — badilisha rangi yoyote katika palette.
2. **Kubadilisha fonti** — chagua fonti tofauti.
3. **Kubadilisha nafasi** — rekebisha padding na margins.
...
- Muonekano wa desktop hubadilika mara moja.
- Muonekano wa simu hubadilika mara moja.
...
- **Muundo wa awali** — angalia nini kimebadilika.
...
1. **Kupitia muonekano wote wawili** — thibitisha kwamba desktop na simu zinaonekana vizuri.
2. **Kukagua rangi zote** — hakikisha kuna tofauti na uwezo wa kufikiwa (accessibility).
3. **Kujaribu tipografia** — thibitisha usomaji katika ukubwa wote.
...
1. Theme Builder inatengeneza theme yako nzima.
2. Theme inasakinishwa kwenye tovuti yako ya WordPress.
...
- **Thibitisha tofauti** — tumia [Validate Palette Contrast](../abilities/validate-palette-contrast.md) kwa ajili ya uwezo wa kufikiwa.
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — kukagua uwezo wa kufikiwa wa rangi.
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — kutengeneza logo maalum.
