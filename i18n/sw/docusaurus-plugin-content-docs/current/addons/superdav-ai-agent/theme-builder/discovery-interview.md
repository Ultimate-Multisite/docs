...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Inapendekezwa kwa picha za mandhari |
| **PNG** | `.png` | Inasaidia uwazi (transparency) |
...
- **Rangi kuu (Color palette)** — rangi kuu huchukuliwa na kutumika katika mandhari
- **Mtindo wa kuona (Visual style)** — wa kisasa, wa kienyeji, wa kiasi, wenye nguvu, n.k.
- **Hisia na hali (Mood and atmosphere)** — wa kitaalamu, wa ubunifu, wa kirafiki, wa kifahari, n.k.
...
- **Mood boards** — mkusanyiko wa picha zinazoonyesha esteti wako anayotaka
- **Picha za bidhaa** — ikiwa una bidhaa za kuonyesha
...
- **Picha zenye maandishi mengi** — skrini za picha zenye maandishi mengi
...
3. **Jumuisha aina tofauti** — mchanganyiko wa rangi, mtindo, na mada
...
- **Rangi kuu (Color palette)** — rangi kuu, za pili, na za kusisitiza
- **Fonti (Typography)** — familia za fonti kwa vichwa na maandishi ya mwili
- **Mtindo wa mpangilio (Layout style)** — nafasi, mpangilio, na mpangilio wa vipengele
...
1. Pitia mwelekeo wa ubunifu uliozaliwa
2. Toa maoni au ombi la marekebisho
...
- [Tools and Configuration](./tools.md) — zana na chaguo za usanidi zinazopatikana
