---
title: Orodha ya Mabadiliko ya Content Sync
sidebar_position: 99
...
* Jipya: Uchaguzi wa awali wa tovuti za watoto kwa tovuti za muundo (template sites).
* Jipya: Kuchukua media kutoka post_content kwa aina zote za chapisho.
* Jipya: Usawazishaji wa taksonomia (categories, tags, custom taxonomies).
* Kimebadilishwa: Jina limebadilishwa kutoka "Elementor Template Sync" na kuwa "Content Sync".
...
* Usawazishaji kamili wa media na kubadilisha ID kiotomatiki.
* Ushirikishwaji na mipangilio ya Ultimate Multisite.
* Usaidizi wa kutenga tovuti kupitia mipangilio ya mtandao (network settings).
* Kufuta cache ya Elementor baada ya usawazishaji.
* Uhifadhi wa taksonomia ya muundo (template taxonomy).
