...
## Mchakato unaopendekezwa (Recommended workflow) {#recommended-workflow}
...
## Milango ya Utthibitishaji (Verification gates) {#verification-gates}
...
## Tembelea ya Kwanza ya Uzalishaji (First production visit) {#first-production-visit}
