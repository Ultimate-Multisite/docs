...
Wijeti hii inatoa ripoti kuhusu matukio katika Ultimate Multisite. Matukio yanajumuisha usajili, kufuta uanachama, kuunda tovuti, kufuta tovuti, na shughuli nyingine.
...
![Chati ya Ukuaji wa MRR](/img/admin/um-dashboard-mrr.png)
...
![Kichaguzi cha kipindi cha tarehe na takwimu](/img/admin/um-dashboard-date-range.png)

Kipindi cha tarehe kinadhibiti muda wa taarifa zinazoonyeshwa na wijeti zilizo chini yake moja kwa moja, ikiwa ni pamoja na mapato, uanachama mpya, usajili kwa nchi, usajili kwa fomu, na tovuti zinazotembelewa zaidi.

![Wijeti za takwimu za dashibodi](/img/admin/um-dashboard-stats.png)

:::tip
Ili wijeti ya **Most Visited Sites** ifanye kazi, wezesha kuhesabu ziara katika **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
