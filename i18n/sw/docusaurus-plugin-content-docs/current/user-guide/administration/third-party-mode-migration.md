...
### Matoleo ya WordPress Kabla ya 7.0
...
### Hali ya Kiotomatiki (Auto Mode) (Chaguo la Kiima Kipya)
...
## Kubadilisha Hali Yako

### Kubadilisha kwa Hali ya Kiotomatiki (Auto Mode)
...
### Kubadilisha kwa Hali ya Mikono (Manual Mode)
...
### Kubadilisha kwa Hali ya Zamani (Legacy Mode)
...
## Faida za Hali ya Kiotomatiki (Auto Mode)

### Kugundua Kiotomatiki (Automatic Discovery)
...
### Uunganisho wa Asili (Native Integration)
...
### Usimamizi Rahisi (Simplified Management)
...
## Njia ya Uhamisho (Migration Path)

### Ikiwa Uko kwenye WordPress 6.x
...
### Ikiwa Uko kwenye WordPress 7.0+
...
### Uwezo haupakuliwi katika hali ya kiotomatiki
...
### Nataka kuendelea na hali ya zamani (legacy mode)
...
### Uwezo wangu maalum hawaonekani
...
### Ninapata taarifa za "uwezo ambao haujapangwa"
...
## Ufanano wa Hali ya Zamani (Backward Compatibility)
...
### Ratiba ya Kupunguzwa (Deprecation Timeline)
