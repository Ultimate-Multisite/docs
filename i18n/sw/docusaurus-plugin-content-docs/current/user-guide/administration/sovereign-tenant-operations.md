...
## Mabadiliko yanayotokea kwa washiriki (administrators)
...
## Kutembelea mteja mwenye uhakika (Visiting a sovereign tenant)
...
## Orodha ya ukaguzi la uendeshaji wa sehemu za mbali (Remote-site operations checklist)

Kabla ya kubadilisha mteja wenye uhakika au mteja wa sehemu ya mbali, thibitisha:

## Kufuku wa wateja unaowakilisha (Sovereign Tenants)
