...
## Maelekezo ya Kuweka Mpangilio

### 1. Washa CyberPanel API
...
### API Connection Refused (Muunganisho wa API Unakataa)
...
### Authentication Errors (Makosa ya Uthibitishaji)
...
### Domain Not Created (Nyanja Haikuundwa)
...
### SSL Certificate Not Issued (Cheti cha SSL Hakitolewi)
