---
title: 'Somo la 10: Siku ya Uzinduzi'
sidebar_position: 11
...
- [ ] Kuunganisha neno la eneo (Domain mapping) linafanya kazi -- jaribu kuunda tovuti na kuunganisha neno la eneo maalum
...
- [ ] Picha zote zina leseni sahihi (hakuna alama za maji za picha za biashara)
- [ ] Uendeshaji kwenye simu (Mobile responsiveness) unafanya kazi kwenye kila ukurasa wa template
...
- [ ] Bei ni sahihi (ya kila mwezi na ya mwaka)
- [ ] Ada za kuanzisha (Setup fees) zimepangishwa kwenye mipango sahihi
- [ ] Kipindi cha majaribio (Trial period) kinafanya kazi kwenye mpango wa Starter
...
- [ ] Mteja anapokea barua pepe ya kukaribishwa baada ya usajili
- [ ] Tovuti mpya inaundwa na template sahihi
...
- [ ] Barua pepe zote za mfumo zinatumia branding ya FitSite na lugha maalum ya afya
...
- [ ] Mfululizo wa barua pepe za kukaribishwa umepangishwa na kutibiwa
...
- [ ] Sera ya kurejesha pesa (Refund policy) imafafanishwa na kuandikwa
- [ ] Kitengo cha biashara kimepangishwa kupokea malipo
...
- Maoni ya kweli kuhusu uzoefu wa usajili na onboarding
- Ruhusa ya kutumia tovuti yao kama mfano wa kuonyesha
- Kuripoti makosa yoyote au matatizo wanayokutana nayo
...
- Badilisha payment gateway kuwa hali ya moja kwa moja (live mode)
- Chapisha tovuti yako ya masoko
...
1. **Badilisha kwa malipo ya moja kwa moja** -- zima hali ya majaribio kwenye payment gateway yako
2. **Thibitisha mara moja zaidi** -- fanya usajili kamili wa majaribio kwa malipo halisi (jirejeshe pesa baadaye)
3. **Fuata kwa makini** -- zingatia makosa, usajili ambao umefeli, au matatizo ya malipo
...
- **Matatizo ya payment gateway**: Kuwa na mawasiliano ya msaada ya mtoa huduma wako wa gateway
- **Matatizo ya cheti cha SSL**: Jua jinsi ya kuangalia na kurejesha cheti
- **Kushindwa kwa uwasilishaji wa barua pepe**: Jaribu kwamba barua pepe zinawafikia kweli (angalia folda za spam)
...
- **Utaratibu wa siku ya kutangaza** ili kuishi kwa kujiamini
- **Mpango wa dharura** kwa matatizo ya kawaida ya siku ya kuanzisha

---

**Inayofuata:** [Somo la 11: Kupata Wateja](lesson-11-customers) -- sasa FitSite imeishi, unawafanyia jinsi ya kuwafanya wamiliki wa studio za afya wasajili?
