---
title: 'Somada ya 9: Kuweka Bei kwa Faida'
sidebar_position: 10
...
- Tovuti ya afya ya kitaalamu ambayo ingakugharimu $2,000-$5,000 kuibuni kwa njia maalum
- Matengenezo yanayoendelea, masasisho, na usalama ambao hawahitaji kufikiria
- Vipengele maalum vya sekta ambayo waendeshi tovuti za jumla haziwezi kutoa
- Uaminifu wa jukwaa lililoundwa kwa ajili ya sekta yao
...
- **Kuajiri mtaalamu wa web**: $2,000-$5,000 kwa malipo ya awali + $50-$100/mwezi ya matengenezo
- **Wix/Squarespace**: $16-$45/mwezi lakini bila vipengele maalum vya afya, wanabiunda wenyewe
- **Kufanya kitu**: Kupoteza wanachama ambao hawawezi kuwapata mtandaoni
...
- **Starter**: Hakuna ada ya kukusanya (ondoa vikwazo vya kuingia)
- **Growth**: Ada ya kukusanya ya $99 (inajumuisha usanidi wa domain maalum na ushauri wa awali)
- **Pro**: Ada ya kukusanya ya $299 (inajumuisha usanidi wa maeneo mengi na simu ya usajili)
...
- **Jaribio la siku 7 bure** kwa mpango wa Starter tu
- Hakuna jaribio kwenye Growth na Pro (wateja hawa ni wa kujitolea zaidi na wanatarajia kulipa)
...
- **FITLAUNCH** -- 30% off kwa miezi 3 ya kwanza (kwa matangazo ya kuanzisha)
- **ANNUAL20** -- 20% off kwa mipango ya mwaka (ikiwa bado hakupunguzwa)
- **REFERRAL** -- Mwezi 1 bure (kwa marejeo ya wateja)

Nenda kwenye **Ultimate Multisite > Discount Codes** ili kuzibuni. Tazama [Creating Discount Codes](/user-guide/configuration/creating-discount-codes) kwa mwongozo kamili.

:::tip Usipunguzwe kwa Kawaida
...
1. Sanisha viwango vya kodi kwenye **Ultimate Multisite > Settings > Taxes**
2. Weka makundi ya kodi kwenye mipango yako
3. Hakikisha ankara inaonyesha kodi kwa usahihi
...
- **Kiwango cha kubadilika kwa mpango**: Ikiwa Starter inabadilika vizuri lakini Growth haifanyi, pengo kati yao linaweza kuwa kubwa sana
- **Kiwango cha kuboresha huduma (Upgrade rate)**: Ikiwa wateja wachache wanaboresha kutoka Starter hadi Growth, mpango wa Growth labda hauna thamani ya ziada ya kutosha
...
├── Ultimate Multisite (imepangishwa + imebrandishwa)
├── Platform Domain (fitsite.com + wildcard SSL)
├── Site Templates (Studio Essential, Gym Pro, Fitness Chain)
├── Products
│   ├── FitSite Starter ($49/mo au $468/yr) + jaribio la siku 7
│   ├── FitSite Growth ($99/mo au $948/yr) + ada ya kukusanya ya $99
│   ├── FitSite Pro ($199/mo au $1,908/yr) + ada ya kukusanya ya $299
│   └── Order Bumps + Discount Codes
├── Checkout Flow (na kitufe cha kubadilisha kipindi)
├── Branding (login, dashboard, emails, invoices, marketing site)
├── Customer Onboarding (Quick Start, emails, help resources)
├── Pricing Strategy
│   ├── Punguzo za mwaka (20% off)
│   ├── Ada za kukusanya za kimkakati
│   ├── Jaribio la siku 7 kwenye Starter
│   ├── Nambari za punguzo kwa kampeni na marejeo
│   └── Usanidi wa kodi
...
- **Kipindi cha jaribio** kwenye mpango wa kiwango cha chini kupunguza ugumu wa kujisajili
- **Nambari za punguzo za kimkakati** kwa kuanzishwa, marejeo, na kampeni
- **Usanidi wa kodi** kwa malipo yanayofuata kanuni
- **Mfumo wa kupitia bei** kwa uboreshaji endelevu

---

**Inayofuata:** [Somo la 10: Siku ya Kuanzishwa](lesson-10-launch) -- orodha ya kukagua kabla ya kuanzishwa na kuishi.
