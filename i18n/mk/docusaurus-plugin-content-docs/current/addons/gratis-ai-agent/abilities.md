...
---
# Референца за способности {#abilities-reference}
...
## Прилагодени типови објави {#custom-post-types}
...
## Прилагодени таксономии {#custom-taxonomies}
...
## Навигациски менија {#navigation-menus}
...
## Управување со опции {#options-management}
...
## Управување со содржина {#content-management}
...
## Визуелен преглед {#visual-review}
...
## Инсталирачки можности {#installable-abilities}
