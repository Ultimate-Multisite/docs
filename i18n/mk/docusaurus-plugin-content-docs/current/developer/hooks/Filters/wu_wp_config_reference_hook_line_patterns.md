...
---
# Филтер: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

Проверуваме три обрасци кога се обидуваме да утврдиме каде можеме да ги вметнеме нашите константи:
...
Дефинирано во [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) на линија 143
