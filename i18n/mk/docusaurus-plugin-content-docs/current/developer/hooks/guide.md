---
title: Водич за користење hooks
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Водич за користење Hooks {#hooks-usage-guide}

Ultimate Multisite обезбедува 200+ action hooks и 280+ filter hooks. Оваа страница ги опфаќа најчесто користените hooks со практични примери. За целосна автоматски генерирана референца, прелистајте ги другите страници во овој дел.

## Action Hooks {#action-hooks}

### Животен циклус на клиент {#customer-lifecycle}

#### По создавање клиент {#after-customer-creation}
...
#### Промена на статус на клиент {#customer-status-change}
...
### Hooks за сајт {#site-hooks}

#### Откако сајтот е објавен {#after-site-published}
...
#### Пред примена на шаблон {#before-template-application}
...
### Hooks за членство {#membership-hooks}

#### Премини на статус {#status-transitions}
...
### Hooks за плаќање {#payment-hooks}

#### Плаќање завршено / неуспешно {#payment-completed--failed}
...
### Hooks за наплата {#checkout-hooks}

#### Пред обработка / По завршување {#before-processing--after-completion}
...
### Филтри за цени {#pricing-filters}

#### Вкупно во кошничка {#cart-total}
...
### Филтри за шаблони {#template-filters}
...
### Филтри за ограничувања {#limitation-filters}
...
### Филтри за gateway {#gateway-filters}
...
### Полиња на формуларот за наплата {#checkout-form-fields}
...
### Содржина на е-пошта {#email-content}
