...
---
# Градење прилагодена интеграција со регистратор {#building-a-custom-registrar-integration}
...
### Незадолжителни методи {#optional-methods}
...
### Конвенција за повратна вредност {#return-value-convention}
...
## Регистрирање на вашата способност {#registering-your-capability}
...
## Додавање полиња за акредитиви во волшебникот {#adding-credential-fields-to-the-wizard}
...
## Hooks за дејства по регистрација {#hooks-for-post-registration-actions}
