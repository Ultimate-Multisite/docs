...
## Кога да го користите {#when-to-use-it}
...
## Конвенција за именување датотеки {#file-naming-convention}
...
## Каде да ја поставите датотеката {#where-to-place-the-file}
...
## Достапни hooks и филтри {#hooks-and-filters-available}
...
## Минимален пример {#minimal-example}
