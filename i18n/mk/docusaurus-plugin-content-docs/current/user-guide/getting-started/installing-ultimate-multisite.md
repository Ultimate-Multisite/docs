...
---
# Инсталирање на Ultimate Multisite {#installing-ultimate-multisite}
...
## Инсталирање на приклучокот (Plugin) {#installing-the-plugin}
...
## Воден процес на поставување (Setup Wizard) {#setup-wizard}
...
### Претходни проверки (Pre-install Checks) {#pre-install-checks}
...
### Инсталација (Installation) {#installation}
...
### Ваша компанија (Your Company) {#your-company}
...
### Стандарден содржина (Default Content) {#default-content}
...
### Препорачани приклучоци (Recommended Plugins) {#recommended-plugins}
