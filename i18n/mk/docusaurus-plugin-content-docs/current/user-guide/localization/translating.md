...
---
# Преведување на Ultimate Multisite {#translating-ultimate-multisite}
...
## Преводи на главниот плагион (Core Plugin Translations) {#core-plugin-translations}
...
## Преводи на дополнителни плагиони (Addon Translations) {#addon-translations}
...
## Локални преводи (Local Translations) {#local-translations}
...
### Користење Loco Translate {#using-loco-translate}
