...
## Параметри на телото на конечната точка (Endpoint body parameters) {#endpoint-body-parameters}
...
### **Членство (Membership)** {#membership}
...
## Создавање акција во Zapier {#creating-an-action-in-zapier}
...
### Создавање акција {#creating-an-action}
...
### Целосни параметри на конечната точка {#complete-endpoint-parameters}
