...
## Активирање на PayPal на вашата мрежа
...
## Користење на водичот за поставка (setup wizard)
...
## Придобивка на PayPal API податоци за пријава (Getting the PayPal API credentials)
