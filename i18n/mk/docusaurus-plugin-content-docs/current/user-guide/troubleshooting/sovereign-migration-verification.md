...
---
# Проверка на суверенска миграција {#sovereign-migration-verification}
...
## Команди за извршување {#commands-to-run}
...
### Давање на дозволи во базата на податоци не совпаѓа со хостот {#database-grants-do-not-match-the-host}
...
### Bedrock или локални инсталации не можат да се поврзаат {#bedrock-or-local-installs-cannot-connect}
...
### Асинхроноте ќешка за пуш не се испушта (drain) {#async-push-queue-does-not-drain}
...
### Бројот на корисниците на тенантот е погрешен {#tenant-user-count-is-wrong}
...
### Посетата преку SSO е одбиена {#sso-visit-is-rejected}
...
## Кога да повторите {#when-to-retry}
