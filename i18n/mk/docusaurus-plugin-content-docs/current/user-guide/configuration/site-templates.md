...
---
# Шаблони за сайтови (v2) {#site-templates-v2}
...
## Што е Site Template? {#what-is-a-site-template}
...
## Создавање и уредување на нов Site Template {#creating-and-editing-a-new-site-template}
...
### Прилагодување на содржината на шаблонот за сайт {#customizing-the-contents-of-a-site-template}
...
### Напредна опции {#advanced-options}
...
### Користење шаблони за сайт {#using-site-templates}
...
#### Мод 1: Поставување Шаблон за сайт {#mode-1-assign-site-template}
...
#### Режим 2: Избери достапен шаблон за локација {#mode-2-choose-available-site-template}
...
### Дефолт Мод: Избор на шаблон за сайт во форната за Плаќање (Checkout form) {#default-mode-site-template-selection-on-the-checkout-form}
...
### Опции за шаблони на сайтови {#site-template-options}
...
#### Овозможување на промена на шаблони {#allow-template-switching}
...
#### Овозможување на корисниците да го користат својот сайт како шаблони {#allow-users-to-use-their-site-as-templates}
...
#### Копирање медиуми на дуплирање на шаблони {#copy-media-on-template-duplication}
...
#### **Превенција на поискувачот за поискување на шаблони на сайтови** {#prevent-search-engines-from-indexing-site-templates}
...
## Предпрезаредување на шаблоните на сайтови со автомата пребарување и замена {#pre-populating-site-templates-with-auto-search-and-replace}
...
### Решение на проблемот со „шаблон полн со места за зачувување“ {#solving-the-template-full-of-placeholders-problem}
