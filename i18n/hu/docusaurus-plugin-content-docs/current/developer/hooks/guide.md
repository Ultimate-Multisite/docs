...
## Akció Hook-ok {#action-hooks}

### Ügyfél Életciklus {#customer-lifecycle}

#### Ügyfél Létrehozása Után {#after-customer-creation}
...
#### Ügyfél Státuszváltása {#customer-status-change}
...
### Oldal Hook-jai {#site-hooks}

#### Oldal Közzététele Után {#after-site-published}
...
#### Sablon Alkalmazása Előtt {#before-template-application}
...
### Tagság Hook-jai {#membership-hooks}

#### Státuszváltások {#status-transitions}
...
### Fizetési Hook-ok {#payment-hooks}

#### Fizetés Sikeres / Sikertelen {#payment-completed--failed}
...
### Checkout Hook-ok {#checkout-hooks}

#### Feldolgozás Előtt / Befejezése Után {#before-processing--after-completion}
...
## Passzív (Filter) Hook-ok {#filter-hooks}

### Árazási Passzív Hook-ok {#pricing-filters}

#### Kosár Összeg {#cart-total}
...
### Sablon Passzív Hook-ok {#template-filters}
...
### Korlátozási Passzív Hook-ok {#limitation-filters}
...
### Gateway Passzív Hook-ok {#gateway-filters}
...
### Checkout Formmező Passzív Hook-ok {#checkout-form-fields}
...
### E-mail Tartalom Passzív Hook-ok {#email-content}
