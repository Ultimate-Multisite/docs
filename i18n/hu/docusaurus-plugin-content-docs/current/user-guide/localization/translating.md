---
title: Az Ultimate Multisite fordítása
sidebar_position: 19
...
Ez a WordPress közösség szabványos fordítási rendszere. Amikor egy fordítás eléri a megfelelő jóváhagyási küszöböt, automatikusan eljut minden Ultimate Multisite felhasználóhoz a WordPress bővítményfrissítéseken keresztül.

**Szükségünk van a segítségedre!** Ha beszélsz angolul kívül más nyelven is, kérjük, fontold meg a fordításhoz való hozzájárulást. Néhány szöveg lefordítása is sokat segít. Így kezdheted el:

1. Látogass el a [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) oldalra
2. Válaszd ki a nyelvedet
3. Kattints a „Contribute Translation" (Fordítás hozzájárulása) gombra
4. Szükséged lesz egy ingyenes WordPress.org fiókra
...
1. Töltsd le a Poedit programot a [poedit.net](https://poedit.net) oldalról
2. Nyisd meg a `.pot` fájlt a `wp-content/plugins/ultimate-multisite/lang/` mappából
3. Fordítsd le a szövegeket a Poedit felületén
