...
## A WordPress Multisite {#the-wordpress-multisite}
...
#### Aldomain vs. alkönyvtár {#subdomain-vs-subdirectory}
...
#### Bővítmények és sablonok {#plugins-and-themes}
...
#### Felhasználók és adminisztrátorok {#users-and-administrators}
...
#### 1. eset: Egy ügynökség {#case-1-an-agency}
...
#### 2. eset: Niche szolgáltató {#case-2-niche-provider}
...
### Architektúra megfontolások {#architecture-considerations}
...
#### Osztott vs. dedikált tárhely {#shared-vs-dedicated-hosting}
...
#### Teljesítmény megfontolások {#performance-considerations}
...
#### Domain és SSL {#domain-and-ssl-1}
