...
#### A fizetési űrlap szerkesztő áttekintése
...
### Időszakválasztó kapcsoló hozzáadása
...
#### 1. lépés: Árváltozatok beállítása a termékeken
...
#### 2. lépés: Az Időszakválasztás mező hozzáadása a Checkout űrlaphoz
...
#### 3. lépés: A mező elhelyezése az Ártáblázat fölé
...
#### Számlázási időszak előválasztása URL-en keresztül
