...
## A regisztrációs űrlap használata: {#using-the-registration-form}
...
## Megosztható link használata: {#using-a-shareable-link}
...
### Regisztráció kézi fizetések használatával: {#registering-using-manual-payments}
