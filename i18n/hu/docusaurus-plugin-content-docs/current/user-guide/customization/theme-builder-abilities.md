...
## Block Téma Elépítése (Scaffolding) {#scaffold-block-theme}
...
### Hogyan hívják elő {#how-to-invoke}
...
### Elvárható kimenet {#expected-output}
...
### Elvárható kimenet {#expected-output-1}
...
## Munkafolyamat: Elépítés és Aktiválás {#workflow-scaffold-and-activate}
...
## Design Tokenek és Személyre szabás {#design-tokens-and-customization}
...
## Korlátozások és Megjegyzések {#limitations-and-notes}
