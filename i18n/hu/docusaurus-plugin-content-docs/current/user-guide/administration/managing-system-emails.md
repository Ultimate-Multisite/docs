---
title: Rendszer-e-mailek kezelése
sidebar_position: 13
...
![Settings - Emails fül](/img/admin/settings-emails.png)

Innen elérheted a **Rendszer e-mailek** oldalt, ahol az összes e-mail sablon látható.

![Rendszer e-mailek listája](/img/admin/system-emails-list.png)

Az egyes e-mail sablonokat a rendszer e-mail szerkesztővel is szerkesztheted:
...
Új e-mail sablonok importálásához:

1. Lépj a **Rendszer e-mailek** oldalra
2. Kattints az oldal tetején található **Reset & Import** gombra
...
1. **Törlés és újraimportálás** — Töröld a rendszer e-mailt, majd importáld újra (ez törli a küldési mutatókat)
2. **Visszaállítás az eszközzel** — Használd a **Reset & Import** eszközt, kapcsold be a **Reset** opciót, és válaszd ki a visszaállítani kívánt e-maileket

A Reset opció az ajánlott, mivel megőrzi a küldési mutatókat és az egyéb metaadatokat, miközben visszaállítja az alapértelmezett tartalmat.
