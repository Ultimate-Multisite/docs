...
### Átváltás az Elavult (Legacy) módra
...
### Automatikus Feldézés (Discovery)
...
### Ha WordPress 6.x verziót használ
...
### Ha WordPress 7.0+ verziót használ
...
### A képességek nem töltődnek be az auto módban
...
### Meg akarom tartani az elavult (Legacy) módot
...
### A saját képességeim nem láthatók
...
### "Osztályozatlan képesség" értesítéseket kapok
...
### Mege forduló telepítések esetén
...
### Saját (Custom) Képességek esetén
