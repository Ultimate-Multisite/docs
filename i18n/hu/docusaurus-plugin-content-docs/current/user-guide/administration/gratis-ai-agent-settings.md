...
## Beállítások elérése {#accessing-settings}

1. A WordPress admin felületén lépj a **Gratis AI Agent → Beállítások** menüpontra.
2. Kattints a **Speciális** fülre.

## Visszajelzési végpont konfigurálása {#feedback-endpoint-configuration}
...
### Várt JSON hasznos teher {#expected-json-payload}
...
### `triage_category` értékek {#triagecategory-values}
...
### Visszajelzésgyűjtés letiltása {#disabling-feedback-collection}
...
## Felügyelt Superdav szolgáltatás {#managed-superdav-service}
...
## Google Calendar konfiguráció {#google-calendar-configuration}
...
## TextBee SMS-értesítések {#textbee-sms-notifications}
...
### Funkciójelzők elérése {#accessing-feature-flags}

1. A WordPress admin felületén lépj a **Gratis AI Agent → Beállítások** menüpontra.
2. Kattints a **Funkciójelzők** fülre.

### Hozzáférés-vezérlési jelzők {#access-control-flags}
...
### Márkajelzési jelölők {#branding-flags}
...
### Automatizálási biztonsági jelölők {#automation-safety-flags}
...
### Módosítások alkalmazása {#applying-changes}
