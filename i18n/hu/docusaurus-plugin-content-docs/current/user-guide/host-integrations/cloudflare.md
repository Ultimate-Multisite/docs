...
### 1. Szerezd be a Cloudflare API Key-t
...
### 3. Add hozzá a konstansokat a wp-config.php fájlhoz
...
### Miben különbözik a szabványos Cloudflare-integrációtól
...
### Cloudflare Custom Hostnames beállítása
