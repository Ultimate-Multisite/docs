...
### 1. Szerezd meg a Cloudways API hitelesítő adataidat {#1-get-your-cloudways-api-credentials}
...
### 2. Szerezd meg a szerver- és alkalmazásazonosítóidat {#2-get-your-server-and-application-ids}
...
### SSL-tanúsítvány-kezelés {#ssl-certificate-management}
...
## Fontos — wildcard SSL buktató {#important--wildcard-ssl-pitfall}
...
### Ajánlott Cloudways SSL-beállítás egy Ultimate Multisite hálózathoz {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### SSL-tanúsítványokkal kapcsolatos problémák {#ssl-certificate-issues}
...
### Domain nincs hozzáadva {#domain-not-added}
