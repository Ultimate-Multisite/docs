...
### 1. Ellenőrizd a Closte API kulcsot {#1-verify-your-closte-api-key}
...
### 2. Integráció engedélyezése {#2-enable-the-integration}
...
## Domain rekord létrehozása {#domain-record-creation}
...
### DNS ellenőrzési időköz {#dns-check-interval}
