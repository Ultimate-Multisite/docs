...
### 1. cPanel hitelesítő adatok beszerzése {#1-get-your-cpanel-credentials}
...
### 2. Konstansok hozzáadása a wp-config.php fájlhoz {#2-add-constants-to-wp-configphp}
...
### 3. Az integráció engedélyezése {#3-enable-the-integration}
