...
## Az Regisztrációs Folyamat Megértése {#understanding-the-registration-flow}
...
## A FitSite Checkout Dizainozása {#designing-the-fitsite-checkout}

Navigáljon az **Ultimate Multisite > Checkout Forms** menüpontra, és hozzon létre egy új űrlapot.

### 1. Lépés: Csomagválasztás {#step-1-plan-selection}
...
### 2. Lépés: Sablonválasztás {#step-2-template-selection}
...
### 3. Lépés: Fiók Létrehozása {#step-3-account-creation}
...
### 4. Lépés: Oldaltartalom Beállítása {#step-4-site-setup}
...
### 5. Lépés: Fizetés {#step-5-payment}
...
### 6. Lépés: Megerősítés {#step-6-confirmation}
...
## Időszak Kiválasztó Kapcsoló Hozzáadása {#adding-a-period-selection-toggle}
...
## Fizetési Konfiguráció {#configuring-payment}
...
## A Folyamat Tesztelése {#testing-the-flow}
...
## A FitSite Hálózatáig {#the-fitsite-network-so-far}
...
## Amit Építettünk E Bölomban {#what-we-built-this-lesson}
