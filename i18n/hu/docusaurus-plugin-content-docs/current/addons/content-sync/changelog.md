---
title: Tartalom Szinkronizációs Changelog
sidebar_position: 99
...
* Új: Altoldal előselektálás a sablonoldalak esetén
* Új: Média kiemelése a post_content-ből minden bejegyzéstípus esetén
* Új: Taxonómia szinkronizálása (kategóriák, címkék, saját taxonómiák)
* Megváltozott: Nevezés megváltozása "Elementor Template Sync" címet "Content Sync" címmel
...
* Teljes média szinkronizálás automatikus azonosító újraazonosítással
* Beállítások integrációja az Ultimate Multisite-kal
* Oldal kizárás támogatása a hálózatbeállítások (network settings) segítségével
* Elementor cache törlése a szinkronizálás után
* Sablon taxonómia megőrzése
