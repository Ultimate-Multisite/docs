...
1. **Adjusting colors (Színek beállítása)** — módosíthat bármilyen színt a palettából
2. **Changing fonts (Betűtípusok megváltoztatása)** — válasszon más betűtípusokat
3. **Modifying spacing (Távolság módosítása)** — állítsa be a betöltést és az hézagot
...
- A desktop előnézet azonnal frissül
- A mobil előnézet azonnal frissül
...
- **Original design (Eredeti dizájn)** — láthatja, mi változott
...
1. **Review both previews (Ellenőrizze az mindkét előnézetet)** — győződjön meg róla, hogy a desktop és a mobil nézet jó
2. **Check all colors (Ellenőrizze az összes színt)** — biztosítsa a kontrasztot és az elérhetőséget
3. **Test typography (Tesztelje a tipográfiát)** — győződjön meg róla az olvasatosság minden méretben
...
1. A Theme Builder generálja az Ön teljes témáját
2. A téma települ az Ön WordPress oldalára
...
- **Verify contrast (Ellenőrizze a kontrasztot)** — használja a [Validate Palette Contrast](../abilities/validate-palette-contrast.md) elérhetőség ellenőrzéséhez
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — ellenőrizze a szín elérhetőségét
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — hozzon létre személyre szabott logókat
