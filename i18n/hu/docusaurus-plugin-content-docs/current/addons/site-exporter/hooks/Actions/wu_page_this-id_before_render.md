...
Elkülfődik a konkrét oldal renderelés előtt.

Használat: A dinamikus részt egy érvényes oldal azonosítóval kell cserélni, pl. add_action('wu_page_events_before_render', 'do_something_callback', 10, 2);
