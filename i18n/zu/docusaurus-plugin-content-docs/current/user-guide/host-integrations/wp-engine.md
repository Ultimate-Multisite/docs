...
### 2. Vumela Ukuhlanganiswa {#2-enable-the-integration}
...
### Ukuvumelanisa Kwamadomeyini {#domain-syncing}
...
### Ukusekelwa Kwama-Subdomain {#subdomain-support}
...
### Ama-Wildcard Domain {#wildcard-domains}
...
### Izitifiketi ze-SSL {#ssl-certificates}
...
### Idomeyini Ayengezwanga {#domain-not-added}
...
### Izinkinga Zama-Subdomain {#subdomain-issues}
