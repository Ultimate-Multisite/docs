...
### 2. Nika Ukuhlanganiswa Amandla {#2-enable-the-integration}
...
### Ukuvumelanisa Izizinda {#domain-syncing}
...
### Ukususwa Kwesizinda {#domain-removal}
...
### Ukuqinisekiswa kwe-API {#api-authentication}
