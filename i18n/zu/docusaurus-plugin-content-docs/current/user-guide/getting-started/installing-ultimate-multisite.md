...
Kusuka ku-**Dashboard Yomphathi Wenethiwekhi** yakho, iya ku-**Plugins → Engeza I-Plugin Entsha**.

![Ikhasi Lokwengeza I-Plugin Entsha Lomphathi Wenethiwekhi](/img/installation/add-new-plugin.png)

Sesha **"Ultimate Multisite"** (ngezimpawu zokucaphuna ukuze uthole okufanayo ncamashi) futhi izovela njengomphumela wokuqala. Chofoza **Faka Manje**.

![Imiphumela yokusesha ekhombisa i-Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Uma isifakiwe, chofoza **Network Activate** ukuze uvule i-plugin kuyo yonke inethiwekhi yakho.

![I-Plugin ifakiwe ngenkinobho ye-Network Activate](/img/installation/plugin-installed.png)

Ngemva kokuvulwa, uzoqondiswa ngokuzenzakalelayo ku-Setup Wizard.
...
![Ukuhlola ngaphambi kokufaka okubonisa izimfuneko zesistimu](/img/installation/wizard-pre-install-checks.png)

:::note Inkinobho ye-Network Activate (v2.6.1+)
Uma i-Ultimate Multisite ifakiwe kodwa **ingakavulwa kunethiwekhi** — ngokwesibonelo, uma uchofoze **Activate** (isayithi elilodwa) esikhundleni se-**Network Activate** esikrinini sama-plugin enethiwekhi — isinyathelo se-Pre-install Checks sizokuthola lokhu futhi sibonise inkinobho ye-**Network Activate**.
...
![Ukusetha kuqediwe - Isikrini sokuthi Sekulungile](/img/installation/wizard-ready.png)

![Dashboard Yomphathi Wenethiwekhi ene-Ultimate Multisite esebenzayo](/img/installation/network-dashboard.png)
