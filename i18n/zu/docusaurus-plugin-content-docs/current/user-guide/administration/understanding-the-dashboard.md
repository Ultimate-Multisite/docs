...
Le wijethi ibika ngezehlakalo kuyo yonke i-Ultimate Multisite. Izehlakalo zihlanganisa ukubhalisa, ukukhansela, ukwakhiwa kwamasayithi, ukusulwa, kanye neminye imisebenzi.
...
![Isikhethi sebanga losuku nezibalo](/img/admin/um-dashboard-date-range.png)

Ibanga losuku lilawula isikhathi solwazi oluboniswa amawijethi angaphansi ngqo, okuhlanganisa imali engenayo, ubulungu obusha, ukubhalisa ngokwezwe, ukubhalisa ngefomu, namasayithi avakashelwe kakhulu.

![Amawijethi ezibalo ze-dashboard](/img/admin/um-dashboard-stats.png)

:::tip
Ukuze wenze iwijethi ye-**Most Visited Sites** isebenze, vumela ukubalwa kokuvakasha ku-**Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
