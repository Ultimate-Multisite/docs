...
- **Yimaphi amakhono** atholakalayo kuma-agent
- **Lapho evezwa khona** (REST API, MCP, WooCommerce, njll.)
- **Ubani ongawafinyelela** (ngama-allow-list ozakwethu)
- **Indlela ahlukaniswa ngayo** (aziwayo uma kuqhathaniswa nangahlukanisiwe)
...
- Ama-endpoint e-REST API
- Amaseva e-MCP
- Ukuhlanganiswa kwe-WooCommerce
- Izixhumi zengxoxo
- Zonke izindima zabasebenzisi (ngezimvume ezifanele)
...
- Izixhumi zengxoxo
- Amaphaneli okuphatha
- Abasebenzisi abangene ngemvume kuphela
- Awavezwa nge-REST API noma ukuhlanganiswa kwangaphandle
...
- Kudinga ukufakwa okucacile kuhlu oluvunyelwe lozakwethu
- Atholakala nge-REST API ngemininingwane yokuqinisekisa yozakwethu
- Atholakala nge-MCP ngokuqinisekiswa kozakwethu
- Awatholakali kubasebenzisi abavamile
...
- Awavezwa nganoma iyiphi i-surface
- Awatholakali engxoxweni
...
- **Igama**: Isihlonzi sekhono
- **Incazelo**: Lokho ikhono elikwenzayo
- **Ukubonakala kwamanje**: Esidlangalaleni, Kwangaphakathi, Uzakwethu, noma Kukhutshaziwe
- **Uhlu oluvunyelwe lozakwethu**: Yibaphi ozakwethu abangafinyelela (uma ukubonakala kungokwabazakwethu)
...
1. Chofoza ikhono ohlwini
2. Khetha izinga elisha lokubonakala ku-dropdown
3. Uma ukhetha "Uzakwethu", engeza izihlonzi zozakwethu ohlwini oluvunyelwe
4. Chofoza **Londoloza**
...
1. Maka amabhokisi aseduze kwamakhono
...
3. Faka isihlonzi sozakwethu (ngokuvamile i-API key noma i-ID yenhlangano)
...
1. Iya kuthebhu ethi **Amakhono**
2. Thola ikhono elinokubonakala kozakwethu
3. Chofoza ukuze uhlele
...
1. Hlela ikhono
2. Susa umaka ebhokisini lozakwethu ohlwini oluvunyelwe
3. Chofoza **Londoloza**
...
2. Ngekhono ngalinye elingahlukanisiwe, uzobona:
   - Igama lekhono nencazelo
   - Umthombo (iyiphi i-plugin/addon eyilifakile)
   - Izinga lokubonakala eliphakanyisiwe
   - Ukuhlolwa kokuvikeleka

3. Khetha izinga lokubonakala:
   - **Esidlangalaleni**: Themba ikhono; liveze yonke indawo
   - **Kwangaphakathi**: Linganisela ekusetshenzisweni kwangaphakathi kuphela
   - **Uzakwethu**: Linganisela kozakwethu abathile
   - **Kukhutshaziwe**: Ungalisebenzisi leli khono
...
- **Kuthuthukisa ukuvikeleka**: Uvuma ngokucacile lokho okuvezwayo
- **Kuvimbela amaphutha**: Amakhono angahlukanisiwe akhutshazwa ngokuzenzakalelayo
...
**Amakhono angaphakathi** awavezwa nge-MCP.
...
- Ukuphathwa komkhiqizo
- Ukucutshungulwa kwe-oda
- Ukuxhumana nekhasimende
...
- Abaphathi babona wonke amakhono
...
- Hlola ukuthi i-plugin/addon inikwe amandla
- Vuselela ikhasi

**Angikwazi ukushintsha ukubonakala kwekhono**
- Qinisekisa ukuthi unezimvume zomphathi
- Hlola ukuthi ikhono alikhiywanga yi-plugin
- Zama ukukhubaza ama-plugin aphikisanayo

**Uzakwethu akakwazi ukufinyelela ikhono**
- Qinisekisa ukuthi uzakwethu usohlwini oluvunyelwe
- Hlola ukuthi ukubonakala kwekhono kusethwe ku-Uzakwethu
- Qinisekisa ukuthi imininingwane yokuqinisekisa yozakwethu ilungile
- Hlola amalogi e-API ngamaphutha okuqinisekisa

**Amakhono angahlukanisiwe aqhubeka nokuvela**
...
- Wonke amakhono akhona ahlukaniswa ngokuzenzakalelayo njenge-Asesidlangalaleni
- Buyekeza futhi ulungise ukubonakala njengoba kudingeka
- Akukho senzo esidingekayo ngaphandle uma ufuna ukukhawulela ukufinyelela
...
1. **Buyekeza amakhono akho**: Hlola wonke amakhono afakiwe
2. **Hlela izigaba zamakhono angahlukanisiwe**: Phendula ezazisweni zomphathi
3. **Setha ozakwethu**: Engeza ozakwethu uma usebenzisa ukubonakala kozakwethu
4. **Qapha ukusetshenziswa**: Landelela ukuthi yimaphi amakhono asetshenziswa kakhulu
5. **Bhala izinqumo**: Gcina amanothi ngokuthi kungani ukhethe izinga ngalinye lokubonakala
