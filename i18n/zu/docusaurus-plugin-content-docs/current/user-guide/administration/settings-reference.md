---
title: Ireferensi Yezilungiselelo
sidebar_position: 11
...
| Umhlinzeki | Inqubo yokusetha |
|---|---|
| **Anthropic Max** | Xhuma i-Account eyodwa noma eziningi ze-Anthropic Max ngenkinobho ye-OAuth. Sebenzisa enye indlela ye-OAuth eyenziwa ngesandla lapho isiphequluli esiku-sandbox singakwazi ukuqedela ukuqondisa kabusha ngokuzenzakalela. |
| **OpenAI ChatGPT/Codex** | Xhuma ama-Account e-ChatGPT ngenqubo efanayo yeqoqo le-OAuth. Imisebenzi esekelwa isixhumi ingasebenzisa izingcingo zamathuluzi ze-ChatGPT Codex ngemva kokuthi i-Account isixhunyiwe. |
| **Google AI Pro** | Xhuma ama-Account e-Google AI Pro nge-OAuth, bese uvuselela isixhumi uma uhlu lwama-Account lungabuyekezi ngokushesha. |

I-Cursor Pro ayiseyena umhlinzeki osekelwayo. Susa izithombe-skrini zangaphakathi ezindala, ama-runbook, noma izinyathelo zokuqalisa ezikhuluma ngezinkambu zokusetha ze-Cursor Pro noma izindlela zesixhumi.

Lapho wengeza noma ususa ama-Account omhlinzeki, faka ikheli le-imeyili elivumelekile le-Account evuselelwayo noma esuswayo bese ulondoloza izilungiselelo zomhlinzeki ngaphambi kokuhlola imisebenzi esekelwa isixhumi.
