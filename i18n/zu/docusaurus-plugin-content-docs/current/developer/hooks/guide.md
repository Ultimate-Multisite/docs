---
title: Umhlahlandlela Wokusetshenziswa Kwama-Hooks
sidebar_position: 1
...
## Ama-Action Hooks {#action-hooks}

### Umjikelezo Wempilo Yekhasimende {#customer-lifecycle}

#### Ngemva Kokwakhiwa Kwekhasimende {#after-customer-creation}
...
#### Ukushintsha Kwesimo Sekhasimende {#customer-status-change}
...
### Ama-Hooks Esayithi {#site-hooks}

#### Ngemva Kokushicilelwa Kwesayithi {#after-site-published}
...
#### Ngaphambi Kokusetshenziswa Kwe-Template {#before-template-application}
...
### Ama-Hooks Obulungu {#membership-hooks}

#### Ukuguquka Kwezimo {#status-transitions}
...
### Ama-Hooks Okukhokha {#payment-hooks}

#### Ukukhokha Kuqediwe / Kwehlulekile {#payment-completed--failed}
...
### Ama-Hooks E-Checkout {#checkout-hooks}

#### Ngaphambi Kokucubungula / Ngemva Kokuqedwa {#before-processing--after-completion}
...
### Ama-Hooks E-Domain {#domain-hooks}
...
## Ama-Filter Hooks {#filter-hooks}

### Ama-Filters Entengo {#pricing-filters}

#### Ingqikithi Yekalishi {#cart-total}
...
### Ama-Filters E-Template {#template-filters}
...
### Ama-Filters Emikhawulo {#limitation-filters}
...
### Ama-Filters E-Gateway {#gateway-filters}
...
### Izinkambu Zefomu Le-Checkout {#checkout-form-fields}
...
### Okuqukethwe Kwe-imeyili {#email-content}
