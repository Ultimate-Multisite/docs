---
id: wu_admin_notices
title: Isihlungi - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Uhlu lwezaziso zalelo paneli elithile. |
| $all_notices | `array` | Uhlu lwezaziso ezengeziwe, ezihlukaniswe ngepaneli. |
| $panel | `string` | Ipaneli yokuthola izaziso. |
