...
- **Ukuhlaziywa kwewebhusayithi** — khuhla futhi uhlaziye amawebhusayithi abancintisana nawe noma agqugquzelayo
- **Ukukhishwa komklamo** — thola imibala, amafonti, namaphethini esakhiwo
- **Isakhiwo sokuqukethwe** — qonda ukuhleleka kwamakhasi nobuhlakani bokulandelana
- **Ukutholwa kwezici** — thola ama-plugin nokusebenza
- **Ukuhlaziywa kokusebenza** — hlola isivinini sekhasi nokulungiselelwa
- **Ukuhlaziywa kwe-SEO** — buyekeza ama-meta tag nedatha ehlelekile

**Ukusetshenziswa:**

```
Hlaziya umklamo we-example.com futhi uwusebenzise njengogqozi lwesayithi lami.
```

**Lokho Elikukhiphayo:**

- Iphalethi yemibala nokusetshenziswa kwemibala
- I-typography (amafonti nosayizi)
- Isakhiwo sokuhlelwa nezikhala
- Amaphethini okuzulazula
- Ukuhleleka kokuqukethwe
- Ukusetshenziswa kwezithombe nemidiya
- Izinto ezisebenzisanayo
- Ukuphendula kumaselula

**Imikhawulo:**

- Alikwazi ukukuhla amasayithi avikelwe ngephasiwedi
- Lihlonipha i-robots.txt nezinqubomgomo zesayithi
- Lingase lingakuthathi okuqukethwe okuguqukayo
...
- Ukufundeka
- Ukulungiselelwa kwe-SEO
- Ukusetshenziswa kwamagama angukhiye
...
- Izincazelo zemikhiqizo
- Amakhasi ezinsizakalo
...
- Ukukhiqizwa kwe-Custom CSS
- Ukwakhiwa kwe-animation
- Umklamo wezinto ezisebenzisanayo
...
Amakhono ahambisana ne-Advanced angafaka:

- **Amathuluzi esistimu yamafayela** — hlola futhi ushintshe amafayela agunyaziwe ezindaweni ezethembekile
- **Amathuluzi esizindalwazi** — buza noma ubuyekeze idatha yesayithi lapho kugunyazwe ngokucacile
- **Amathuluzi e-WP-CLI** — sebenzisa imiyalo yokunakekela nokuhlola ye-WordPress
- **Amathuluzi e-REST dispatcher** — shayela ama-endpoint e-REST abhalisiwe ngezinhlelo zokusebenza zokuthumela ezilawulwayo
- **Amathuluzi okwakha ama-plugin** — sungula isakhiwo futhi uphindaphinde ikhodi ye-plugin
- **Amathuluzi e-Git snapshot** — dala ama-snapshot ngaphambi kwemisebenzi yonjiniyela enobungozi
- **Amathuluzi okuphatha abasebenzisi** — siza ukubuyekeza noma ukulungisa amarekhodi abasebenzisi lapho kuvunyelwe
- **Amathuluzi e-benchmark** — sebenzisa ama-benchmark okusebenza noma amakhono ukuze kubuyekezwe ukuthuthukiswa
...
1. Zulazula uye ku-**Gratis AI Agent → Settings**
2. Iya ku-**Theme Builder → Tools**
...
- **Ukukhuhla isayithi** — kudinga ukufinyelela ku-inthanethi
- **Ukuhlaziya** — kudinga ukuhlanganiswa ne-Google Analytics
- **Ukukhiqizwa kokuqukethwe** — kudinga API keys
...
1. Iya ku-**Gratis AI Agent → Settings → API Keys**
2. Faka imininingwane yokungena yethuluzi ngalinye
3. Hlola uxhumano
...
```
Hlaziya umklamo wesayithi lombangi wami ku-competitor.com
...
```
Khipha iphalethi yemibala ku-example.com futhi uyisebenzise njengogqozi.
```

```
Hlaziya isakhiwo sokuzulazula se-example.com bese usebenzisa ukuhleleka
okufanayo kusayithi lami.
```

```
Hlola ukuphendula kumaselula kwe-example.com futhi uqinisekise ukuthi isayithi lami
...
```
Qhathanisa imiklamo ye-site1.com ne-site2.com bese udala umklamo
...
- Sebenzisa ukuhlaziya ukuze uthole ugqozi, hhayi ukukopisha
...
3. **Khipha imibala** — sebenzisa amaphalethi emibala njengamaphuzu okuqala
...
3. **Qinisekisa amalungelo** — qinisekisa ukuthi ungasebenzisa okuqukethwe okukhishiwe
...
3. **Setha okulindelwe** — chaza imigomo yakho yokuklama
...
- Amasayithi amakhulu angase aphelelwe isikhathi
...
- [Amamenyu Ezivakashi](./hospitality-menus.md) — dala amakhasi emenyu
