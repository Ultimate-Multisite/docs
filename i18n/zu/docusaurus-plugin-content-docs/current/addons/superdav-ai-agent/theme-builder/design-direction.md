...
- **Umbala oyinhloko** — umbala oyinhloko webhrendi osetshenziselwa izinkinobho, izixhumanisi, nokugcizelela
- **Umbala wesibili** — umbala ohambisanayo wokuletha ukuhlukahluka
- **Umbala wokugcizelela** — umbala wokugqamisa izakhi ezibalulekile
...
- **Ifonti yezihloko** — isetshenziselwa izihloko zamakhasi nezihloko zezigaba
- **Ifonti yomzimba** — isetshenziselwa umbhalo wezigaba nokuqukethwe
- **Osayizi bamafonti** — osayizi abasabelayo bosayizi besikrini abahlukene
...
- **Ama-icons** — isitayela nosayizi wama-icon
...
- Imenyu yokuzulazula egcwele
- Isakhiwo esiphelele nawo wonke amakholomu
...
- Ukuzulazula okusabelayo (imenyu ye-hamburger)
- Isakhiwo sekholomu eyodwa
...
| Idivayisi | Ububanzi | Ukubuka kuqala |
|--------|-------|---------|
| **Mobile** | 375px | Ifoni emi mpo |
| **Tablet** | 768px | Ithebhulethi evundlile |
...
1. **Ukulungisa imibala** — shintsha noma yimuphi umbala kuphalethi
2. **Ukushintsha amafonti** — khetha izinhlobo zefonti ezihlukile
3. **Ukuguqula isikhala** — lungisa i-padding nama-margins
...
- Ukubuka kuqala kwe-desktop kubuyekezwa ngokushesha
- Ukubuka kuqala kwe-mobile kubuyekezwa ngokushesha
...
- **Ukuklama kwangempela** — bona okushintshile
...
1. **Buyekeza kokubili ukubuka kuqala** — qinisekisa ukuthi i-desktop ne-mobile kubukeka kahle
2. **Hlola yonke imibala** — qinisekisa ukugqama nokufinyeleleka
3. **Hlola i-typography** — qinisekisa ukufundeka kuwo wonke osayizi
...
1. Theme Builder ikhiqiza i-theme yakho ephelele
2. I-theme ifakwa kusayithi yakho ye-WordPress
...
- **Qinisekisa ukugqama** — sebenzisa [Validate Palette Contrast](../abilities/validate-palette-contrast.md) ukuze kufinyeleleke
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — hlola ukufinyeleleka kombala
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — dala ama-logo enziwe ngokwezifiso
