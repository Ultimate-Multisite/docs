...
title: Isihlungi - wu_apc_process_page_content
...
|------|------|-------------|
| $content | `string` | Okuqukethwe ngemva kokushintshwa. |
| $content_before_processing | `string` | Okuqukethwe ngaphambi kokushintshwa. |
