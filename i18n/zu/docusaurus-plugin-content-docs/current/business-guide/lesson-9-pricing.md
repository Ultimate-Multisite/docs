---
title: 'Isifundo 9: Ukubeka amanani ukuze kube nenzuzo'
sidebar_position: 10
...
- Iwebhusayithi yobungcweti ye-fitness ebingabiza u-$2,000-$5,000 ukwakhiwa ngokwezifiso
- Ukunakekelwa okuqhubekayo, izibuyekezo, nokuphepha abangadingi ukucabanga ngakho
- Izici eziqondene nomkhakha ama-builder ajwayelekile angazinikezi
- Ukuthembeka kwepulatifomu eyakhelwe imboni yabo
...
- **Ukuqasha umakhi wewebhu**: $2,000-$5,000 ekuqaleni + $50-$100/ngenyanga ukunakekela
- **Wix/Squarespace**: $16-$45/ngenyanga kodwa azikho izici eziqondene ne-fitness, bayazakhela bona
- **Ukungenzi lutho**: Amalungu alahlekile angakwazi ukubathola ku-inthanethi
...
| Uhlelo | Ngenyanga | Yonyaka (ngenyanga) | Ingqikithi Yonyaka | Okongiwe |
|------|---------|-------------------|--------------|---------|
| Starter | $49/ngenyanga | $39/ngenyanga | $468/ngonyaka | isaphulelo esingu-20% |
| Growth | $99/ngenyanga | $79/ngenyanga | $948/ngonyaka | isaphulelo esingu-20% |
| Pro | $199/ngenyanga | $159/ngenyanga | $1,908/ngonyaka | isaphulelo esingu-20% |
...
- **Starter**: Ayikho inkokhelo yokuqalisa (susa izithiyo zokungena)
- **Growth**: $99 inkokhelo yokuqalisa (ikhava ukumiswa kwe-domain yangokwezifiso nokubonisana kokuqala)
- **Pro**: $299 inkokhelo yokuqalisa (ikhava ukumiswa kwezindawo eziningi nocingo lokuqalisa)
...
- **Isivivinyo samahhala sezinsuku ezingu-7** ohlelweni lwe-Starter kuphela
- Akukho sivivinyo ku-Growth naku-Pro (lawa makhasimende azibophezele kakhulu futhi alindele ukukhokha)
...
- **FITLAUNCH** -- isaphulelo esingu-30% ezinyangeni zokuqala ezingu-3 (sokuphromotha ukwethula)
- **ANNUAL20** -- isaphulelo esingu-20% ezinhlelweni zonyaka (uma zingakancishiswa kakade)
- **REFERRAL** -- inyanga engu-1 mahhala (ngokudluliselwa kwamakhasimende)

Zulazula uye ku-**Ultimate Multisite > Amakhodi Esaphulelo** ukuze ukudale lokhu. Bheka [Ukudala Amakhodi Esaphulelo](/user-guide/configuration/creating-discount-codes) ukuze uthole umhlahlandlela ogcwele.

:::tip Unganikezi Isaphulelo Ngokuzenzakalelayo
...
1. Lungiselela amazinga entela ku-**Ultimate Multisite > Izilungiselelo > Izintela**
2. Sebenzisa izigaba zentela ezinhlelweni zakho
3. Qinisekisa ukuthi ama-invoice abonisa intela ngendlela efanele
...
- **Izinga lokuguquka ngohlelo**: Uma i-Starter iguquka kahle kodwa i-Growth ingaguquki, igebe phakathi kwazo lingase libe likhulu kakhulu
- **Izinga lokuthuthukela ezinhlelweni eziphezulu**: Uma amakhasimende ambalwa ethuthuka esuka ku-Starter eya ku-Growth, uhlelo lwe-Growth lungase lunganikezi ivelu eyengeziwe eyanele
...
├── Ultimate Multisite (kumisiwe + kubhrendiwe)
├── I-Domain Yepulatifomu (fitsite.com + wildcard SSL)
├── Izifanekiso Zamasayithi (Studio Essential, Gym Pro, Fitness Chain)
├── Imikhiqizo
│   ├── FitSite Starter ($49/ngenyanga noma $468/ngonyaka) + isivivinyo sezinsuku ezingu-7
│   ├── FitSite Growth ($99/ngenyanga noma $948/ngonyaka) + inkokhelo yokuqalisa engu-$99
│   ├── FitSite Pro ($199/ngenyanga noma $1,908/ngonyaka) + inkokhelo yokuqalisa engu-$299
│   └── Okungezwa Ku-oda + Amakhodi Esaphulelo
├── Ukugeleza Kokukhokha (neswishi yokukhetha isikhathi)
├── Ukubhrenda (login, Dashboard, ama-imeyili, ama-invoice, isayithi lokumaketha)
├── Ukuqalisa Amakhasimende (Ukuqala Ngokushesha, ama-imeyili, izinsiza zosizo)
├── Isu Lamanani
│   ├── Izaphulelo zonyaka (isaphulelo esingu-20%)
│   ├── Izimali zokuqalisa ezihlelekile
│   ├── Isivivinyo sezinsuku ezingu-7 ku-Starter
│   ├── Amakhodi esaphulelo emikhankaso nasekudluliselweni
│   └── Ukumiswa kwentela
...
- **Isikhathi sokuzama** ohlelweni lwezinga lokungena ukuze kuncishiswe ubunzima bokubhalisa
- **Amakhodi esaphulelo ahlelekile** okwethula, ukudluliselwa, nemikhankaso
- **Ukumiswa kwentela** kokukhokhisa okuhambisanayo
- **Uhlaka lokubuyekeza amanani** lokuthuthukisa okuqhubekayo

---

**Okulandelayo:** [Isifundo 10: Usuku Lokwethula](lesson-10-launch) -- uhlu lokuhlola lwangaphambi kokwethula nokuba bukhoma.
