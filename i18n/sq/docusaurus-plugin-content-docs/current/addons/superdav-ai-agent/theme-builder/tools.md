...
## Mjetet e disponueshme {#available-tools}

### Mjetet e Nivelit 1 (Gjithmonë të disponueshme) {#tier-1-tools-always-available}
...
#### Optimizuesi i përmbajtjes {#content-optimizer}
...
### Mjetet e Nivelit 3 (Premium) {#tier-3-tools-premium}

Mjetet e Nivelit 3 kërkojnë konfigurim shtesë ose veçori premium.

#### Gjeneratori i përmbajtjes me AI {#ai-content-generator}
...
#### Mjete të avancuara dizajni {#advanced-design-tools}
...
### Mjetet shoqëruese Advanced (Paketë e veçantë) {#advanced-companion-tools-separate-package}
...
## Konfigurimi i mjeteve {#tool-configuration}

### Aktivizimi i mjeteve {#enabling-tools}
...
### Lejet e mjeteve {#tool-permissions}
...
### API Keys dhe kredencialet {#api-keys-and-credentials}
...
### Instalimi i paketës shoqëruese Advanced {#installing-the-advanced-companion-package}
...
## Përdorimi i sd-ai-agent/site-scrape {#using-sd-ai-agentsite-scrape}
...
### Analizë specifike {#specific-analysis}
...
### Analizë krahasuese {#comparison-analysis}
...
## Kufizimet dhe konsideratat e mjeteve {#tool-limitations-and-considerations}

### Kufizimi i ritmit {#rate-limiting}
...
### Saktësia e përmbajtjes {#content-accuracy}
...
### Konsiderata ligjore dhe etike {#legal-and-ethical-considerations}
...
### Ndikimi në performancë {#performance-impact}
...
### Përdorimi i analizës së site {#using-site-analysis}
...
### Maksimizimi i efektivitetit të mjetit {#maximizing-tool-effectiveness}
...
### Site nuk mund të bëhet scrape {#site-wont-scrape}
...
### Analizë e paplotë {#incomplete-analysis}
...
### Performancë e ngadaltë {#slow-performance}
