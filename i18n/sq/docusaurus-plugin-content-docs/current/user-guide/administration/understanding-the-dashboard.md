...
## Widget-ët e Dashboard-it Rrjetit (Network Dashboard Widgets) {#network-dashboard-widgets}
...
### Hapat Fillestarë (First Steps) {#first-steps}
...
### Fluxi i Aktivitetit (Activity Stream) {#activity-stream}
...
### Lajme dhe Diskutime {#news-and-discussions}
...
## Dashboard i Ultimate Multisite {#ultimate-multisite-dashboard}
...
### Rritja e Ardhjes Mesore Vjetore (MRR) {#monthly-recurring-revenue-growth}
...
### Mbështetja për Rrëfesh Data {#date-range-support}
