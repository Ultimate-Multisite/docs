...
## Çfarë ndryshon për administratorët {#what-changes-for-administrators}
...
## Vizitimi i një tenanti soverin {#visiting-a-sovereign-tenant}
...
## Lista kontrolli për operacionet remote-site {#remote-site-operations-checklist}
...
## Fshirja e qirave soverane (sovereign tenants) {#deleting-sovereign-tenants}
