...
---
# Integrimi me CyberPanel {#cyberpanel-integration}
...
### 1. Aktivizo API-n CyberPanel {#1-enable-the-cyberpanel-api}
...
### 2. Shtoni Konstante në wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Aktivizo Integrimin {#3-enable-the-integration}
...
### 4. Verifikoni Lidhuritë {#4-verify-connectivity}
...
### Domain Mapping (Mapele e Domenit) {#domain-mapping}
...
### Auto-SSL (Auto-Certifikim SSL) {#auto-ssl}
...
### Email Forwarders (Rishituesit e Postave Elektronike) {#email-forwarders}
...
## Referenca për Konfigurim {#configuration-reference}
...
### Refuzimi i lidhjes API (API Connection Refused) {#api-connection-refused}
...
### Gabimet e autentifikimit (Authentication Errors) {#authentication-errors}
...
### Domeni nuk krijohet (Domain Not Created) {#domain-not-created}
...
### Certifikati SSL nuk lëshohet (SSL Certificate Not Issued) {#ssl-certificate-not-issued}
