...
---
# Shkulpet për Shte të Shteteve (v2)
...
## Çfarë është një Template i Shteve?
...
## Krijimi dhe Redaktimi i një Template të Ri i Shteve
...
### Personalizimi i përmbajtjes së një Modelit të Sitis
...
#### Mode 1: Ngarkimi i Modelit të Sitis
...
#### Mod 2: Zgjidh Template të Përshtatshëm të Disponueshëm
...
### Mode Paradatore: Zgjedhja e template-s së site në formularin e Checkout (Kasa)
...
### Opsioni të Templateve të Sijës së Vendit (Site Template Options)
...
#### Lejo Ndryshimin e Templateve (Allow Template Switching)
...
#### Lejo Përdoruesve të përdorin Vendin si template
...
#### Kopjo Media në Duplikat Templateve (Copy Media on Template Duplication)
...
#### **Pryndjeshja e Motorëve të Kërkimit nga Indeksimi i Templateve të Vendit (Prevent Search Engines from indexing Site Templates)**
...
## Përgatitja e Templateve të Vendit me kërkim dhe zëvendësim automatik (Pre-populating Site Templates with auto search-and-replace)
...
### Zgjidhja e problemit "shablon i plotë me placeholder-e"
