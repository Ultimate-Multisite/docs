...
## Dështime të zakonshme

### Leje të bazës së të dhënave nuk përputen me hostin
...
### Instalimet Bedrock ose lokale nuk mund të lidhen
...
### Këshilla asinkrone e push-it nuk lepohet (does not drain)
...
### Numri i përdoruesve të qirës është i gabuar
