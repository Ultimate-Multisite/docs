...
---
# Integrimi me GridPane {#gridpane-integration}
...
### 1. Merr Kredencat e API të GridPane-së {#1-get-your-gridpane-api-credentials}
...
### 2. Merr ID-të e Serverit dhe Siti {#2-get-your-server-and-site-ids}
...
## Menaxhimi i Konstanteve SUNRISE {#sunrise-constant-management}
...
### Probleme me Lidhurin në API {#api-connection-issues}
