...
### 1. Verifikoni Klavjet (API Key) të Closte-së
...
## Krijimi i Regjistrimit të Domenit
...
## Zgjidhje Probleme (Troubleshooting)

### Problemet me Lidhurin me API
