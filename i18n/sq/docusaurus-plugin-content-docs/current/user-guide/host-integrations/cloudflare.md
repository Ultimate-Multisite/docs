...
### 1. Merrni Klientin e API-së Cloudflare (Cloudflare API Key)
...
### 2. Merrni ID-në e Zonës (Zone ID)
...
## Hostname-t Personalizuar Cloudflare (Cloudflare Custom Hostnames)
...
### Si ndryshon nga integracioni standard i Cloudflare
...
### Konfigurimi i Hostname-ve Personalizuar Cloudflare
