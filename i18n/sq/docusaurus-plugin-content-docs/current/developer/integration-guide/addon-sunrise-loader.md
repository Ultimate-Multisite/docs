...
## Kur ta përdorni {#when-to-use-it}
...
## Konventa e emërtimit të skedarit {#file-naming-convention}
...
## Ku ta vendosni skedarin {#where-to-place-the-file}
...
## Hook-et dhe filtrat e disponueshëm {#hooks-and-filters-available}
...
## Shembull minimal {#minimal-example}
