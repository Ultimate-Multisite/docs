---
title: Shembuj të Avancuar Kodi
sidebar_position: 1
...
Dy kërkesa të njëkohshme mund të lexojnë të njëjtën vlerë dhe të dyja të shkruajnë mbrapsht të njëjtin rezultat të rritur, duke humbur një numërim. `increment_item()` ia delegon aritmetikën motorit të bazës së të dhënave me një deklaratë të vetme `UPDATE ... SET column = column + ?`, duke e bërë operacionin në thelb atomik.
