...
### 1. بەدەست دەهێنە مەرجەکانی API یەک لە GridPane-ی خۆت
...
### 2. مەرجەکانی Server و Site-ەکەت وەربگرە
...
### 3. خاڵانەکان زیاد بکە بە `wp-config.php`
...
### 4. یەکپارچوونی چالاک بکە (Enable the Integration)
