...
### 1. پاراستنی API Key ی Closte-ی خۆت (Verify Your Closte API Key)
...
### 2. چالاککردنەوەی Integration (Enable the Integration)
...
## دروستکردنی تۆماری دۆمە (Domain Record Creation)
...
### کێشەکانی پڕۆتۆکۆڵی SSL (SSL Certificate)
...
### ناو دامێنی نەکراوەتەوە (Domain Not Added)
...
### ماوەی تاقیکردنەوەی DNS (DNS Check Interval)
