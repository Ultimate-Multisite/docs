...
### ٢. چالاککردنی یەکگرتووکارییەکە (Enable the Integration)
...
### یەکگرتنی دامێنی (Domain Syncing)
...
### کێشەکانی بەڵگەنامی SSL (SSL Certificate Issues)
...
### دامەینەکە زیاد نەکراوە (Domain Not Added)
