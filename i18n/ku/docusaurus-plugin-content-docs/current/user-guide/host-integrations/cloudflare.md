...
### ۱. گرفتن کلید API Cloudflare خود
...
### ۲. گرفتن شناسه منطقه (Zone ID) خود
...
## ناوی میزبانە تایبەتەکانی Cloudflare (Cloudflare Custom Hostnames)
...
### جیاوازی لەگەڵ integrationی ستاندارد ی Cloudflare Custom Hostnames
...
### ڕێکخستنی Cloudflare Custom Hostnames
...
### کێشەکانی پرۆکسی (Proxying Issues)
