...
### ١. بەدەست دەهێنە مەرجەکانی API ی ServerPilot
...
### ٣. کۆنستانەکان زیاد بکە بۆ wp-config.php
...
### ٤. راکردنەوەی integrationەکە چالاک بکە
...
## ڕابتکەری و پشکنینی پڕۆتۆکۆڵی SSL (SSL Certificate Verification)
...
### کێشەکانی پڕۆتۆکۆڵی SSL (SSL Certificate Issues)
...
### ناوەکە زیاد نەکراوە (Domain Not Added)
...
### هەڵماتووی ناوەندی (Domain Removal)
