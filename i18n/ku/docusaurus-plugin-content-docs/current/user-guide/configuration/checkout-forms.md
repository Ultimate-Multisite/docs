...
#### گۆڕینی ویرتاچووی فۆرم (Checkout Form Editor Overview) {#checkout-form-editor-overview}
...
### گۆڕینی فۆرمێکی ویرتاچووی (Editing a Checkout Form) {#editing-a-checkout-form}
...
### زیادکردنی دکمه چنتەری هەڵبژاردن بۆ ماوەی کارکردن {#adding-a-period-selection-toggle}
...
#### هەنگاوی یەکەم: دیاریکردنی Price Variations لەسەر بەرهەمەکانت {#step-1-set-up-price-variations-on-your-products}
...
#### نحوه عملکرد در فرانت‌اند (Frontend) {#how-it-works-on-the-frontend}
...
#### پیش‌انتخاب یک دوره صورتحساب از طریق URL {#pre-selecting-a-billing-period-via-url}
...
### فیلد انتخاب قالب (The Template Selection Field) {#the-template-selection-field}
...
### دوو ناوچەی بنەڕەتی فۆرم (Checkout-form base domains) {#checkout-form-base-domains}
