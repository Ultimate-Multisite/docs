...
## Theme Builder Onboarding Flow چییە؟
...
## دەستپێکردنی Theme Builder Onboarding

### سیستەمی سەرەتایی (First-Run Setup)
...
### چالاککردن بە شێوەیەکی دەستکرد (Manual Activation)
...
## هەنگاوەکان بۆ Onboarding

### هەنگاوی یەکەم: هەڵبژاردنی Mode (Mode Selection)
...
### هەنگاوی دووەم: وردبینی سایت (Site Specification)
...
### مرحله ۳: تصمیمات سیستم طراحی (Design System Decisions)
...
### مرحله ۴: تولید قالب (Theme Generation)
...
### مرحله ۵: فعال‌سازی و تأیید (Activation and Verification)
...
## مشخصات سایت و حافظه site_brief
...
## مقایسه: روش قدیمی در مقابل جدید Onboarding
