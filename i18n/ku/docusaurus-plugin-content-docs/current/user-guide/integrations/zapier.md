...
## چۆن triggerیەکی نوێ دروست بکەیت {#how-to-create-a-new-trigger}
...
## چۆن Action دروست بکەین {#how-to-create-actions}
...
### ڕێکخستنی Action (Setting up the Action) {#setting-up-the-action}
