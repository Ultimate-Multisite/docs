---
title: Tomara guhertinan a Ultimate AI Connector ji bo endpointên lihevhatî
sidebar_position: 99
...
* Serrastkirin: Karta provider-a nû niha dema lêzêdekirinê bixwe fireh dibe; rakirina script cache dema nûkirina plugin.
* Serrastkirin: Namespace-a dynamic ya pola provider ji bo eval() û tevgera firehbûna xweber ji bo provider-ên nû hatine lêzêdekirin.
* Serrastkirin: Ji bo hevahengiya WordPress 6.9+ pêkhateyên stabîl ên Card/CardBody/CardHeader/CardDivider bi kar tîne (êdî ne ceribandinî ne).
* Serrastkirin: DragHandle ya nenaskirî bi îkona grip ya unicode hate guhertin ji bo kişandina provider ji bo rêzkirina nû.
