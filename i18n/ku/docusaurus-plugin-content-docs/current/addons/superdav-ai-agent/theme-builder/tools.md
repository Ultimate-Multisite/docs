...
- **Analîza malperê** — malperên hevrik an îlhamê scrape û analîz bike
- **Derxistina sêwiranê** — reng, font û şêweyên rêzkirinê nas bike
- **Avahiya naverokê** — rêxistin û hiyerarşiya rûpelê fam bike
- **Nasîna taybetmendiyan** — plugin û fonksiyonan nas bike
- **Analîza performansê** — leza rûpelê û optimîzasyonê kontrol bike
- **Analîza SEO** — meta tag û daneyên avahîdar binirxîne

**Bikaranîn:**

```
Sêwirana example.com analîz bike û wekî îlham ji bo malpera min bi kar bîne.
```

**Ew Çi Derxîne:**

- Paleta rengan û bikaranîna rengan
- Tîpografî (font û mezinahî)
- Avahiya rêzkirinê û valahî
- Şêweyên navigasyonê
- Rêxistina naverokê
- Bikaranîna wêne û medyayê
- Elementên interaktîf
- Bersivdariya mobîl

**Sînordarî:**

- Nikare malperên bi şîfre parastî scrape bike
- Rêgezên robots.txt û siyaseta malperê rêz dike
- Dibe ku naveroka dînamîk negire
...
- Çêkirina CSS ya xwerû
- Afirandina anîmasyonê
- Sêwirana elementên interaktîf
...
Kapasîteyên hevkar ên Advanced dikarin van tiştan bigirin:

- **Amûrên pergala pelan** — di hawîrdorên pêbawer de pelên pejirandî kontrol û biguherîne
- **Amûrên danegehê** — dema ku bi eşkere destûr hatibe dayîn, daneyên malperê bipirse an nû bike
- **Amûrên WP-CLI** — fermanên lênihêrîn û kontrola WordPress bixebitîne
- **Amûrên şanderê REST** — bi riya xebatên şandinê yên kontrolkirî bang li endpointên REST ên tomarkirî bike
- **Amûrên avakirina plugin** — skeletê kodê yê plugin çêbike û li ser wê dubare bixebite
- **Amûrên wêneyên Git** — berî karên pêşvebirîner ên bi xeter wêneyan çêbike
- **Amûrên rêvebirina bikarhêneran** — alîkarî bike ku tomarên bikarhêneran li cihên destûrdar bên nirxandin an sererastkirin
- **Amûrên benchmark** — ji bo nirxandina pêşvebirinê benchmarkên performansê an kapasîteyê bixebitîne
...
1. Biçe **Gratis AI Agent → Settings**
2. Biçe **Theme Builder → Tools**
...
- **Scraping-a malperê** — hewceyê gihîştina înternetê ye
- **Analîtîk** — hewceyê entegrasyona Google Analytics e
- **Çêkirina naverokê** — hewceyê mifteyên API ye
...
1. Biçe **Gratis AI Agent → Settings → API Keys**
2. Ji bo her amûrê pêbawernameyan binivîse
...
```
Sêwirana malpera hevrikê min li competitor.com analîz bike
...
```
Paleta rengan ji example.com derxe û wekî îlham bi kar bîne.
```

```
Avahiya navigasyonê ya example.com analîz bike û rêxistinek mîna wê
li malpera min bicîh bike.
```

```
Bersivdariya mobîl a example.com kontrol bike û piştrast bike ku malpera min
...
```
Sêwiranên site1.com û site2.com berhev bike û sêwiranek çêbike
...
- Analîzê ji bo îlhamê bi kar bînin, ne ji bo kopîkirinê
...
3. **Rengan derxînin** — paletên rengan wekî xalên destpêkê bi kar bînin
...
3. **Mafan piştrast bikin** — piştrast bikin ku hûn dikarin naveroka derxistî bi kar bînin
...
3. **Hêviyan diyar bikin** — armancên sêwirana xwe rave bikin
...
- Malperên mezin dikarin timeout bibin
...
- [Menuyên Mêvanperweriyê](./hospitality-menus.md) — rûpelên menuyê biafirînin
