...
## Amadekirina Malperê ya Pêşketî
...
## Jimêrê atomîk ê BerlinDB bi `increment_item()`
...
### Şopandina bikaranîna API li gorî endamtiyê
...
### Çima `increment_item()` li şûna `update_item()`
