...
เราเพิ่ม action แบบกำหนดเองนี้ขึ้นมา เพื่อให้เรามีจุดสำหรับเรียกใช้ (enqueue) สคริปต์และสไตล์ตามที่ต้องการ และมั่นใจได้ว่ามันจะโหลดเฉพาะในหน้าเพจที่ถูกต้องเท่านั้น

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $ | `\WU_Page` | หน้าแอดมินปัจจุบัน |
