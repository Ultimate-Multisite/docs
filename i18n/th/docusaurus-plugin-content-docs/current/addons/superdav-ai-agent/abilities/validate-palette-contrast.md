...
---
# ตรวจสอบความเปรียบต่างของสีในพาเลท (Validate Palette Contrast) {#validate-palette-contrast}
...
## รูปแบบข้อมูลนำเข้า (Input Format) {#input-format}
...
## ระดับ WCAG ที่ตรวจสอบ (WCAG Levels Checked) {#wcag-levels-checked}
...
## รูปแบบข้อมูลขาออก (Output Schema) {#output-schema}
...
### ฟิลด์ข้อมูลขาออก (Output Fields) {#output-fields}
...
## ตัวอย่างการใช้งาน (Usage Example) {#usage-example}
...
## คู่สีที่ล้มเหลวและข้อเสนอแนะ (Failing Pairs and Recommendations) {#failing-pairs-and-recommendations}
...
## ความสามารถที่เกี่ยวข้อง (Related Abilities) {#related-abilities}
