...
---
# ทักษะความสวยงามของระบบดีไซน์ (Design System Aesthetics Skill) {#design-system-aesthetics-skill}
...
## ความสวยงามของระบบดีไซน์คืออะไร? {#what-is-design-system-aesthetics}
...
## ทำไมต้องใช้ความสวยงามของระบบดีไซน์? {#why-use-design-system-aesthetics}
...
## การเรียกใช้ทักษะความสวยงามของระบบดีไซน์ {#triggering-the-design-system-aesthetics-skill}
...
## กระบวนการความสวยงามของระบบดีไซน์ {#the-design-system-aesthetics-process}

### ขั้นตอนที่ 1: ตัวอักษร (Typography) {#step-1-typography}
...
### ขั้นตอนที่ 4: ขอบและเงา (Borders and Shadows) {#step-4-borders-and-shadows}
...
### ขั้นตอนที่ 5: การเคลื่อนไหวและแอนิเมชัน (Motion and Animation) {#step-5-motion-and-animation}
...
## การนำความสวยงามของระบบดีไซน์ไปใช้ {#applying-design-system-aesthetics}

### การใช้งานอัตโนมัติ (Automatic Application) {#automatic-application}
...
### การใช้งานด้วยตนเอง (Manual Application) {#manual-application}
...
## การดูระบบดีไซน์ของคุณ {#viewing-your-design-system}

### ถาม Agent {#ask-the-agent}
...
### ดู theme.json {#view-themejson}

เปิด `/wp-content/themes/[theme-name]/theme.json` ในโปรแกรมแก้ไขข้อความเพื่อดูคำจำกัดความของโทเค็นดิบ

## การอัปเดตระบบดีไซน์ของคุณ {#updating-your-design-system}

### การอัปเดตอย่างรวดเร็ว (Quick Updates) {#quick-updates}
...
### การออกแบบใหม่ทั้งหมด (Full Redesign) {#full-redesign}
...
### การอัปเดตบางส่วน (Partial Updates) {#partial-updates}
...
## แนวทางปฏิบัติที่ดีที่สุดของระบบดีไซน์ (Design System Best Practices) {#design-system-best-practices}

### ความสม่ำเสมอ (Consistency) {#consistency-1}
...
### ความสามารถในการขยาย (Scalability) {#scalability}
...
## รูปแบบระบบดีไซน์ทั่วไป (Common Design System Patterns) {#common-design-system-patterns}

### Minimalist ทันสมัย (Modern Minimalist) {#modern-minimalist}
...
### องค์กรแบบมืออาชีพ (Professional Corporate) {#professional-corporate}
