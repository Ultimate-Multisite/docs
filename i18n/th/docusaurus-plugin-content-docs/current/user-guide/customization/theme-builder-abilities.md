...
## การสร้างโครง Block Theme (Scaffold Block Theme) {#scaffold-block-theme}
...
### วิธีเรียกใช้ (How to Invoke) {#how-to-invoke}
...
### ผลลัพธ์ที่คาดหวัง (Expected Output) {#expected-output}
...
### ผลลัพธ์ที่คาดหวัง (Expected Output) {#expected-output-1}
...
## Workflow: การสร้างโครงและการเปิดใช้งาน (Scaffold and Activate) {#workflow-scaffold-and-activate}
...
## ข้อจำกัดและหมายเหตุ (Limitations and Notes) {#limitations-and-notes}
