...
---
# วิซาร์ดตั้งค่า Multisite {#multisite-setup-wizard}
...
## วิซาร์ดจะปรากฏเมื่อใด? {#when-does-the-wizard-appear}
...
## ขั้นตอนที่ 1: ยินดีต้อนรับ {#step-1-welcome}
...
## ขั้นตอนที่ 2: การตั้งค่าเครือข่าย {#step-2-network-configuration}
...
### อีเมลผู้ดูแลเครือข่าย {#network-admin-email}
...
## ขั้นตอนที่ 3: การติดตั้ง {#step-3-installation}
...
## ขั้นตอนที่ 4: เสร็จสมบูรณ์ {#step-4-complete}
...
## การตั้งค่าด้วยตนเองสำรอง {#manual-setup-fallback}
...
### วิซาร์ดแจ้งว่า wp-config.php ไม่สามารถเขียนได้ {#the-wizard-says-wp-configphp-is-not-writable}
...
### เข้าถึงเว็บไซต์ไม่ได้หลังจากตั้งค่า (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### ปัญหาการยืนยันตัวตนหลังจากตั้งค่า {#authentication-issues-after-setup}
...
### ขั้นตอนหนึ่งล้มเหลวระหว่างการติดตั้ง {#a-step-failed-during-installation}
