...
## Theme Builder Onboarding Flow คืออะไร? {#what-is-the-theme-builder-onboarding-flow}
...
## วิธีเริ่มต้น Theme Builder Onboarding {#starting-the-theme-builder-onboarding}
...
### ขั้นตอนที่ 3: การตัดสินใจระบบดีไซน์ (Design System Decisions) {#step-3-design-system-decisions}
...
### ขั้นตอนที่ 4: การสร้างธีม (Theme Generation) {#step-4-theme-generation}
...
### ขั้นตอนที่ 5: การเปิดใช้งานและการตรวจสอบ (Activation and Verification) {#step-5-activation-and-verification}
...
## Site Specification และหน่วยความจำ site_brief {#site-specification-and-sitebrief-memory}
...
### การดู site_brief ของคุณ {#viewing-your-sitebrief}
...
## การปรับแต่งหลังการเริ่มต้นใช้งาน {#customizing-after-onboarding}

หลังจากที่ Theme Builder onboarding เสร็จสมบูรณ์แล้ว คุณสามารถ:

### ใช้ Design System Aesthetics Skill {#use-the-design-system-aesthetics-skill}
...
### แก้ไข theme.json โดยตรง {#edit-themejson-directly}
...
### สร้าง Custom Block Templates {#create-custom-block-templates}
...
## เปรียบเทียบ: แบบเก่า vs. แบบใหม่ {#comparison-old-vs-new-onboarding}
