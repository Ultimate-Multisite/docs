...
---
# การผสานระบบ Enhance Control Panel {#enhance-control-panel-integration}
...
## การขอข้อมูลรับรอง API {#getting-your-api-credentials}
...
### 2. รับ Organization ID {#2-get-your-organization-id}
...
### 3. รับ Server ID {#3-get-your-server-id}
...
### 4. รับ API URL {#4-get-your-api-url}
...
### ตั้งค่าผ่านตัวช่วยสร้างการผสานระบบ {#setup-via-integration-wizard}
...
## การตั้งค่า WordPress เพิ่มเติม {#additional-wordpress-configuration}
...
### เมื่อมีการแมปโดเมน {#when-a-domain-is-mapped}
...
### เมื่อมีการลบโดเมน {#when-a-domain-is-removed}
...
### หลังจากแมปโดเมน {#after-mapping-a-domain}
...
### ช่วงเวลาตรวจสอบ DNS {#dns-check-interval}
...
### ข้อผิดพลาดการยืนยันตัวตน {#authentication-errors}
