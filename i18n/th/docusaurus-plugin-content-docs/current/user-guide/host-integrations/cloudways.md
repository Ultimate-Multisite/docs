...
### 1. รับข้อมูลประจำตัว Cloudways API ของคุณ {#1-get-your-cloudways-api-credentials}
...
### 2. รับ Server ID และ Application ID ของคุณ {#2-get-your-server-and-application-ids}
...
## สำคัญ — ข้อผิดพลาดเกี่ยวกับ Wildcard SSL {#important--wildcard-ssl-pitfall}
