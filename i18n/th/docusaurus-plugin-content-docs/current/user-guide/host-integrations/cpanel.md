...
### 1. รับข้อมูลรับรอง cPanel ของคุณ {#1-get-your-cpanel-credentials}
...
### 2. เพิ่ม Constant ลงใน wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. เปิดใช้งานการผสานรวม {#3-enable-the-integration}
