...
### 1. รับข้อมูลรับรอง API ของ RunCloud {#1-get-your-runcloud-api-credentials}
...
### 2. รับ Server ID และ App ID {#2-get-your-server-and-app-ids}
...
### 3. เพิ่ม Constant ลงใน wp-config.php {#3-add-constants-to-wp-configphp}
