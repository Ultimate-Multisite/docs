...
นี่คือมุมมองเต็มของหน้า API settings:

![หน้า API settings แบบเต็ม](/img/config/settings-api-full.png)
...
## พารามิเตอร์ body ของ endpoint {#endpoint-body-parameters}
...
## การสร้าง action ใน Zapier {#creating-an-action-in-zapier}
...
### การสร้าง action {#creating-an-action}
...
### พารามิเตอร์ endpoint แบบเต็ม {#complete-endpoint-parameters}
