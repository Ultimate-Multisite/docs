...
---
# การตั้งค่า Stripe Gateway (v2) {#setting-up-the-stripe-gateway-v2}
...
## การเปิดใช้งาน Stripe {#enabling-stripe}
...
### Stripe กับ Stripe Checkout: {#stripe-vs-stripe-checkout}
...
## การตั้งค่า Stripe Webhook {#setting-up-stripe-webhook}
