...
## จะหา gateway ได้ที่ไหน: {#where-to-find-the-gateways}
...
### วิธีติดตั้ง WooCommerce add-on: {#how-to-install-the-woocommerce-add-on}
...
### วิธีติดตั้งส่วนเสริม GoCardless: {#how-to-install-the-gocardless-add-on}
...
### วิธีติดตั้งส่วนเสริม Payfast: {#how-to-install-the-payfast-add-on}
