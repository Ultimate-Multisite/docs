...
---
# การพัฒนา Gateway แบบกำหนดเอง {#custom-gateway-development}

คุณสามารถสร้าง gateway การชำระเงินแบบกำหนดเองได้โดยขยายคลาส `Base_Gateway`

## คลาส Gateway {#gateway-class}
...
## ลงทะเบียน Gateway {#register-the-gateway}
...
## ข้อมูลรับรองการต่ออายุสำหรับสมาชิกภาพแบบต่ออายุเป็นประจำ {#renewal-credentials-for-recurring-memberships}
...
## ความสามารถของผู้ให้บริการตัวเชื่อมต่อ AI {#ai-connector-provider-capabilities}
