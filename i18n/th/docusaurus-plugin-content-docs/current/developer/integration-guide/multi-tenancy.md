...
---
# การผสานรวมแบบ Multi-Tenancy {#multi-tenancy-integration}
...
## โฟลว์การเริ่มต้น tenant {#tenant-bootstrap-flow}
...
## SSO และ REST hooks {#sso-and-rest-hooks}
...
## URL การดำเนินการของลูกค้าแบบอธิปไตย {#sovereign-customer-action-urls}
...
## การตรวจสอบการย้ายข้อมูล {#migration-verification}
...
## ตัวกำหนดเส้นทางฐานข้อมูลที่เลิกใช้แล้ว {#deprecated-database-router}
