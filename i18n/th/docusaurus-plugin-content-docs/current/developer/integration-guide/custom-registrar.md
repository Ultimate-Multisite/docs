...
## Interface (ส่วนติดต่อ) {#the-interface}
...
### Optional methods (เมธอดทางเลือก) {#optional-methods}
...
### Return value convention (รูปแบบค่าที่ส่งกลับ) {#return-value-convention}
...
## การลงทะเบียน Capability ของคุณ {#registering-your-capability}
...
## การเพิ่มช่องข้อมูล Credential ใน Wizard {#adding-credential-fields-to-the-wizard}
...
## Hooks สำหรับการดำเนินการหลังการลงทะเบียน {#hooks-for-post-registration-actions}
...
## Logging (การบันทึกข้อมูล) {#logging}
