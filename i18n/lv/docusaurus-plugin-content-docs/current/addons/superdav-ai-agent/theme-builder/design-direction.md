...
- **Primārā krāsa** — galvenā zīmola krāsa, ko izmanto pogām, saitēm un akcentiem
- **Sekundārā krāsa** — papildinoša krāsa dažādībai
- **Akcenta krāsa** — izcelšanas krāsa svarīgiem elementiem
...
- **Virsrakstu fonts** — izmanto lapu nosaukumiem un sadaļu virsrakstiem
- **Pamatteksta fonts** — izmanto rindkopu tekstam un saturam
- **Fontu izmēri** — responsīvi izmēri dažādiem ekrāna izmēriem
...
- Pilna navigācijas izvēlne
- Pilns izkārtojums ar visām kolonnām
...
- Responsīva navigācija (hamburgera izvēlne)
...
| Ierīce | Platums | Priekšskatījums |
|--------|-------|---------|
| **Mobilā ierīce** | 375px | Tālrunis portreta orientācijā |
| **Planšetdators** | 768px | Planšetdators ainavas orientācijā |
...
1. **Krāsu pielāgošana** — mainiet jebkuru krāsu paletē
2. **Fontu maiņa** — izvēlieties citus burtveidolus
3. **Atstarpju modificēšana** — pielāgojiet iekšējās un ārējās atkāpes
...
- Darbvirsmas priekšskatījums atjauninās nekavējoties
- Mobilais priekšskatījums atjauninās nekavējoties
...
- **Sākotnējo dizainu** — skatiet, kas ir mainījies
...
1. **Pārskatiet abus priekšskatījumus** — pārliecinieties, ka darbvirsmas un mobilais skats izskatās labi
2. **Pārbaudiet visas krāsas** — nodrošiniet kontrastu un pieejamību
3. **Pārbaudiet tipogrāfiju** — pārliecinieties par salasāmību visos izmēros
...
1. Theme Builder ģenerē jūsu pilno tēmu
2. Tēma tiek instalēta jūsu WordPress vietnē
...
- **Pārbaudiet kontrastu** — izmantojiet [Paletes kontrasta validēšana](../abilities/validate-palette-contrast.md) pieejamībai
...
- [Paletes kontrasta validēšana](../abilities/validate-palette-contrast.md) — pārbaudiet krāsu pieejamību
- [Ģenerēt Logo SVG](../abilities/generate-logo-svg.md) — izveidojiet pielāgotus logotipus
