---
title: Satura sinhronizācijas izmaiņu žurnāls
sidebar_position: 99
...
* Jauns: Apakšvietnes iepriekšēja atlase veidņu vietnēm
* Jauns: Multivides izgūšana no post_content visiem ierakstu tipiem
* Jauns: Taksonomiju sinhronizēšana (kategorijas, birkas, pielāgotas taksonomijas)
* Mainīts: Pārdēvēts no "Elementor Template Sync" uz "Content Sync"
...
* Pilna multivides sinhronizācija ar automātisku ID pārkartēšanu
* Iestatījumu integrācija ar Ultimate Multisite
* Vietņu izslēgšanas atbalsts, izmantojot tīkla iestatījumus
* Elementor kešatmiņas notīrīšana pēc sinhronizācijas
* Veidņu taksonomiju saglabāšana
