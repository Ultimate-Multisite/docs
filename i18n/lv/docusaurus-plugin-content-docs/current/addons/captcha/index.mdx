...
## Cap Captcha: pašmitināta aizsardzība, kas vienkārši darbojas {#cap-captcha-self-hosted-protection-that-just-works}
...
## WooCommerce karšu testēšanas aizsardzība {#woocommerce-card-testing-protection}
...
## Joprojām nepieciešams Google reCAPTCHA vai hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Veidots mērogošanai {#built-for-scale}
...
## Vai man kaut kas jākonfigurē? {#do-i-need-to-configure-anything}
...
## Vai Cap Captcha nepieciešamas API atslēgas? {#do-i-need-api-keys-for-cap-captcha}

Nē. Cap Captcha ir pilnībā pašmitināts. Nav ārēju kontu, nav domēnu reģistrācijas, nav konfigurācijas galvassāpju.

## Vai tas palēninās manu checkout? {#will-this-slow-down-my-checkout}

Cap Captcha ir tikai 20 KB un fonā izpilda proof-of-work pārbaudes. Jūsu klienti nepamanīs nekādu aizkavi.

## Vai tas aizsargā pret karšu testēšanas uzbrukumiem? {#does-this-protect-against-card-testing-attacks}
...
## Vai dažādās vietnēs varu izmantot dažādus captcha nodrošinātājus? {#can-i-use-different-captcha-providers-on-different-sites}
...
## Pieprasījumu biežuma ierobežošana {#rate-limiting}
...
### Paplašināmība {#extensibility}

#### IP baltā saraksta filtrs {#ip-whitelist-filter}
...
#### Pirmsbloķēšanas darbība {#pre-block-action}
...
## Klienta IP noteikšana un uzticami starpniekserveri {#client-ip-detection--trusted-proxies}
...
### Uzticēšanās modelis {#trust-model}
...
#### Cloudflare galvenes uzticēšanās {#cloudflare-header-trust}
...
#### Uzticamo starpniekserveru konfigurācija {#trusted-proxy-configuration}
...
#### Automātiska noteikšana pirmajā iespējošanas reizē {#first-enable-auto-detection}
...
### Kāpēc tas ir svarīgi {#why-this-matters}
