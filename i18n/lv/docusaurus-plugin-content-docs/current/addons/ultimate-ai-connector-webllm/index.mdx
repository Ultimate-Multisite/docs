...
## Peldošs tērzēšanas logrīks {#floating-chat-widget}
...
### Admin joslas statusa indikators {#admin-bar-status-indicator}
...
### Kā iespējot vai atspējot logrīku {#how-to-enable-or-disable-the-widget}
...
### Automātiskās uzvednes darbība {#auto-prompt-behaviour}
...
## SharedWorker izpildlaiks {#sharedworker-runtime}
...
## apiFetch starpprogrammatūra {#apifetch-middleware}
...
### Tērzēšanas logrīks neparādās {#the-chat-widget-does-not-appear}
...
### Admin joslas indikators rāda "Kļūda" {#the-admin-bar-indicator-shows-error}
...
### Modeļa svari tiek lejupielādēti katru reizi {#model-weights-download-every-time}
