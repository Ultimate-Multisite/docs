---
title: '10. nodarbība: Palaišanas diena'
sidebar_position: 11
...
- [ ] Domēnu piesaiste darbojas -- pārbaudiet vietnes izveidi un pielāgota domēna piesaisti
...
- [ ] Visiem attēliem ir pareizas licences (nav stock foto ūdenszīmju)
- [ ] Mobilā pielāgojamība darbojas katrā veidnes lapā
...
- [ ] Cenas ir pareizas (mēneša un gada)
- [ ] Iestatīšanas maksas ir konfigurētas pareizajiem plāniem
- [ ] Izmēģinājuma periods darbojas Starter plānā
...
- [ ] Maksājums tiek apstrādāts veiksmīgi
- [ ] Klients pēc reģistrācijas saņem sveiciena e-pastu
- [ ] Jaunā vietne tiek izveidota ar pareizo veidni
...
- [ ] Visos sistēmas e-pastos tiek izmantota FitSite zīmolvedība un fitnesam specifiska valoda
...
- [ ] Sveiciena e-pastu secība ir konfigurēta un pārbaudīta
...
- [ ] Atmaksas politika ir definēta un dokumentēta
- [ ] Uzņēmējdarbības vienība ir izveidota maksājumu saņemšanai
...
- Godīgu atgriezenisko saiti par reģistrācijas un ievadapmācības pieredzi
- Atļauju izmantot viņu vietni kā demonstrācijas piemēru
- Ziņošanu par jebkādām kļūdām vai problēmām, ar kurām viņi saskaras
...
- Pārslēdziet maksājumu vārteju uz tiešo režīmu
- Publicējiet savu mārketinga vietni
...
1. **Pārslēdzieties uz tiešajiem maksājumiem** -- atspējojiet testa režīmu savā maksājumu vārtejā
2. **Pārbaudiet vēlreiz** -- veiciet pilnu testa reģistrāciju ar īstu maksājumu (pēc tam atmaksājiet sev)
3. **Rūpīgi uzraugiet** -- sekojiet kļūdām, neveiksmīgām reģistrācijām vai maksājumu problēmām
...
- **Maksājumu vārtejas problēmām**: Turiet gatavu savas vārtejas nodrošinātāja atbalsta kontaktinformāciju
- **SSL sertifikāta problēmām**: Ziniet, kā pārbaudīt un atjaunot sertifikātus
- **E-pastu piegādes kļūmēm**: Pārbaudiet, vai e-pasti patiešām pienāk (pārbaudiet surogātpasta mapes)
...
- **Palaišanas dienas procedūras**, lai sāktu darbu publiski ar pārliecību
- **Rezerves plānu** biežākajām palaišanas dienas problēmām

---

**Tālāk:** [11. nodarbība: Klientu atrašana](lesson-11-customers) -- tagad, kad FitSite ir tiešsaistē, kā panākt, lai fitnesa studiju īpašnieki reģistrētos?
