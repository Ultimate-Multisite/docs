...
## Kad to izmantot {#when-to-use-it}
...
## Failu nosaukumu konvencija {#file-naming-convention}
...
## Kur novietot failu {#where-to-place-the-file}
...
## Pieejamie āķi un filtri {#hooks-and-filters-available}
...
## Minimāls piemērs {#minimal-example}
