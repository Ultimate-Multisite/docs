...
## Nomnieka inicializācijas plūsma {#tenant-bootstrap-flow}
...
## SSO un REST āķi {#sso-and-rest-hooks}
...
## Suverēna klienta darbību URL {#sovereign-customer-action-urls}
...
## Migrācijas verifikācija {#migration-verification}
...
## Nomnieka dzēšana {#tenant-deletion}
...
## Novecojis datubāzes maršrutētājs {#deprecated-database-router}
