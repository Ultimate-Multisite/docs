...
title: Filtrs - wu_wp_config_reference_hook_line_patterns
...
Definēts [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) 143. rindā
