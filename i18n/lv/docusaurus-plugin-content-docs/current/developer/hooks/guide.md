...
### Klienta dzīves cikls {#customer-lifecycle}

#### Pēc klienta izveides {#after-customer-creation}
...
#### Klienta statusa maiņa {#customer-status-change}
...
### Vietnes hooks {#site-hooks}

#### Pēc vietnes publicēšanas {#after-site-published}
...
#### Pirms veidnes lietošanas {#before-template-application}
...
### Dalības hooks {#membership-hooks}

#### Statusa pārejas {#status-transitions}
...
### Maksājumu hooks {#payment-hooks}

#### Maksājums pabeigts / neizdevās {#payment-completed--failed}
...
#### Pirms apstrādes / pēc pabeigšanas {#before-processing--after-completion}
...
### Cenu filtri {#pricing-filters}

#### Groza kopsumma {#cart-total}
...
### Veidņu filtri {#template-filters}
...
### Ierobežojumu filtri {#limitation-filters}
...
### Gateway filtri {#gateway-filters}
...
### Checkout veidlapas lauki {#checkout-form-fields}
