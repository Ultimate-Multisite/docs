...
Divi vienlaicīgi pieprasījumi var nolasīt to pašu vērtību un abi ierakstīt atpakaļ to pašu palielināto rezultātu, zaudējot vienu skaitījumu. `increment_item()` deleģē aritmētiku datubāzes dzinējam ar vienu `UPDATE ... SET column = column + ?` priekšrakstu, padarot operāciju pēc būtības atomāru.
