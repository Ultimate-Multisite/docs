...
### 1. Apstiprini savu Clostes API kluči {#1-verify-your-closte-api-key}
...
### 2. Iespējini integrāciju {#2-enable-the-integration}
...
## Kļūdu likums (Troubleshooting) {#domain-record-creation}

### API savienojamības problēmas {#troubleshooting}
- Pārbaudiet, vai jūsu Closte API kluāvs ir pareizs
- Nodrošiniet, ka jūsu Closte kontam ir nepieciešami atļaujas

### SSL sertifikāta problēmas {#api-connection-issues}
...
### DNS pārbaudes intervāls {#domain-not-added}
