---
title: Sistēmas e-pastu pārvaldība
sidebar_position: 13
...
Tajā attēlā jūs varat piekļūt **System Emails** lapai, lai redzētu visus e-pasta šabļus.

![System Emails list](/img/admin/system-emails-list.png)

Jūs varat arī rediģēt individuālos e-pasta šabļus izmantojot sistēmas e-pasta redaktoru:
...
1. Navigieties uz **System Emails** lapu
2. Noklikšķiniet uz pogas **Reset & Import**, kas atrodas lapas augšdaļā
...
1. **Izvēlies un ievieci vēlreiz** — Izslēdz sistēmas e-pastu un ievieci to vēlreiz (tā izslēdz sūtīšanas metrikus)
2. **Atjauno ar rīku** — Izmantojiet **Reset & Import** rīku, ieslēdziet opciju **Reset** un izvēlieties e-pastus, ko vēlaties atjaunot

"Reset" opcija ir labākais, jo tā saglabā sūtīšanas metrikas un citu metadatus, lai atgūtu defaultajiem saturi.
