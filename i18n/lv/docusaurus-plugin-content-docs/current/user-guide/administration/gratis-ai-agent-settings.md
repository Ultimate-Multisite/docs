...
## Piekļuve iestatījumiem {#accessing-settings}

1. WordPress administrācijā dodieties uz **Gratis AI Agent → Iestatījumi**.
2. Noklikšķiniet uz cilnes **Papildu**.

## Atsauksmju endpoint konfigurācija {#feedback-endpoint-configuration}
...
### Sagaidāmā JSON slodze {#expected-json-payload}
...
### `triage_category` vērtības {#triagecategory-values}
...
### Atsauksmju vākšanas atspējošana {#disabling-feedback-collection}
...
## Pārvaldītais Superdav pakalpojums {#managed-superdav-service}
...
## Google Calendar konfigurācija {#google-calendar-configuration}
...
## TextBee SMS paziņojumi {#textbee-sms-notifications}
...
## Funkciju karodziņi {#feature-flags}
...
### Piekļuve funkciju karodziņiem {#accessing-feature-flags}

1. WordPress administrācijā dodieties uz **Gratis AI Agent → Iestatījumi**.
2. Noklikšķiniet uz cilnes **Funkciju karodziņi**.

### Piekļuves kontroles karodziņi {#access-control-flags}
...
### Zīmola karodziņi {#branding-flags}
...
### Automatizācijas drošības karodziņi {#automation-safety-flags}
...
### Izmaiņu piemērošana {#applying-changes}
