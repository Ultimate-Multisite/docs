---
title: Latviski tulkot Ultimate Multisite
sidebar_position: 19
...
Tas ir standarta WordPress savstarp komunītietes tulkojumus sistēma. Kad tulkojumi sasniedz pietiekamu apstiprinājuma līmeni, tie automātiski tiek izplatīti visiem Ultimate Multisite lietotājiem caur WordPress plugin atjauninājumus.

**Mums vajadzī jūsu palīdzību!** Ja jūs runāt valodu, kas nav angļu, lūdzu, apsveriet tulkojumus sniegšanu. Pat dažas frāzju tulkojumi palīdz. Lai sāktu:

1. Apmeklējiet [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Izvēlieties savu valodu
3. Nospressiet "Contribute Translation" (Sniedz tulkojumu)
4. Jums būs nepieciešams bezmaksas WordPress.org konts
...
1. Ielādējiet Poedit no [poedit.net](https://poedit.net)
2. Atveriet `.pot` failu no `wp-content/plugins/ultimate-multisite/lang/`
3. Tulkojiet stringus Poedita interfejsā
