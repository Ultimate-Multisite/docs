...
## Interneta meklēšanas ieslēgšana {#enabling-internet-search}
...
### API sils iegūšana Brave Search {#obtaining-a-brave-search-api-key}
...
### Izmantojuma ierobežojumi {#usage-limits}
...
### Tavily API svara iegūšana {#obtaining-a-tavily-api-key}
...
### Lietošanas ierobežojumi {#usage-limits-1}
...
## Interneta meklēšanas atslēgšana {#disabling-internet-search}
