---
title: Temu atbilstošas prasmes
sidebar_position: 27
...
- **Tēmas specifiskus dokumentus** — novirzīšanu par tēmas lietošanu un pielāgošanu
- **Bloku un shēmu references** — pieejami bloki, shēmas un dizaina opcijas
...
Bloka tēmas prasme sniedz novirzīšanu par:

- Šķēmu un shēmu rediģēšanu ar bloku redaktoru
- Bloku shēmām un atjauninajami blokiem strādāt
- Globālo stilu un theme.json iestatījumu pielāgošanu
- Tēmas blokiem un variacjami lietošanu
- Jūsu vietnes custom bloku shēmu izveidi
...
Klasiskās tēmas prasme sniedz novirzīšanu par:

Arbatot ar PHP šablonu un hookiem
Personalizēšanas veidoklis temā apkaļ (Customizer)
Widgetu lauku un puslapas izmantošana
CSS modifikators un bērnu tēmas attīstība
Temas hierarhijas un šablonu tagu sapratums
...
Kadence Blocks prasme sniedz norādījumus par:

- Kadences uzlabotu bloku bibliotētas lietošanu (Hero, Testimonials, Ceny, etc.)
- Kadence bloku iestatījumu un responsīvās opciju konfigurēšanu
- Uzvēršanu personalizētu layautus ar Kadences gridu un containeru blokiem
- Kadence blokiem integrāciju savas tēmas ar
- Kadences dizaina sistēmas un presetiju izmantošanu
...
Kadence Tēmas prasme sniedz norādījumus par:

- Kadences tēmas personalizāciju globalajiem stiliem un theme.json
- Kadences iekļaujušos bloku atvaļinājumiem un šablonu
- Kadence tēmas iestatījumu un opciju konfigurēšanu
- Personalizētu dizainu uzveidošanu ar Kadences dizaina sistēmu
- Kadences integrāciju populāru pluginu un rīku ar
...
1. Jūs izmantojat bloku tēmu ar aktīvu prasmi **Block Themes**.
...
**Klasiķu tēmām:**
> "Pievienot personīgu widgeta teritoriju sarakstā lietojot child theme."

**Kadence Blocks-am:**
> "Izveidot atsauksmes seksiooni izmantojot Kadence Testimonials bloku."

**Kadence Tēmas am:**
> "Apzināt tēmas plānu un navigācijas menu stila pielāgošanu."

Asistentas sniedz tēmas specifiskus ceļvedumus un koda piemērus, kas pielāgotas jūsu aktīvajai tēmā un plugins.

:::note
Tēmas zīmējamo prasmes ir automātiski pieejamas Superdav AI Agent v1.10.0 un jaunākās versijas. Nav nepieciešama papildu iestatījumi vai konfigurācija.
:::
