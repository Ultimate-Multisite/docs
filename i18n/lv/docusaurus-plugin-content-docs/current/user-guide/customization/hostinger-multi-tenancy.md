...
## Iestatījumu paziņojumi {#setup-notes}
...
## Konkrētās iespējas izmaiņas {#capability-specific-changes}
...
## Hostinger tenantu problēmu likums {#troubleshooting-hostinger-tenants}
