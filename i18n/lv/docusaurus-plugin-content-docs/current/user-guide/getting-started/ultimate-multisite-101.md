...
#### Subdomēns vs. Subdirektori {#subdomain-vs-subdirectory}
...
#### Plugins un Temas {#plugins-and-themes}
...
#### Lietotāji un administratorji {#users-and-administrators}
...
#### Vārds 1: Aģentūra {#case-1-an-agency}
...
#### Pārdevējs 2: Niche sniedzējs {#case-2-niche-provider}
...
#### 3. Pārdevēja WordPress vietnes hostings {#case-3-wordpress-web-hosting}
...
### Arhitektūras apsvērumi {#architecture-considerations}
...
#### Sadarbīts vs. Viena hostings (Shared vs. Dedicated Hosting) {#shared-vs-dedicated-hosting}
...
#### Veiktspējas ievērojumi {#performance-considerations}
...
#### Snapshots (Atkarbējumi) {#snapshots}
...
#### Īpaši skripti (External Scripts) {#external-scripts}
...
#### Domēns un SSL {#domain-and-ssl-1}
