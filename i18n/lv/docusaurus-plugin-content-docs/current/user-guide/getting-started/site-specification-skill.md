---
title: Vieta specifikācijas prasmes
sidebar_position: 18
...
- **Vietnes mērķis**: Kas jūsu vietne dara un kāpēc tā ir
- **Mērķauditorija**: Kurie cilvēki apmeklē jūsu vietni un ko viņiem vajadzī
- **Zīmola identitāte**: Jūsu krāsas, tonis un vizuālā stils
- **Biznesmērķi**: Kā izskatās veiksmība jūsu vietnē
- **Kontenta struktūra**: Kā jūsu vietne ir organizēta
...
- Jūsu vietnes mērķus un auditoriju
- Jūsu zīmola krāsas un tonis
...
- Ieteiktu funkcijas, kas atbilst jūsu vietnes mērķim
- Ieteiktu kontenta struktūras, kas atbilst jūsu mērķiem
...
```
"Ļaujiet man definēt vietnes specifikāciju"
```
...
```
Kas ir jūsu vietnes galvenais mērķis?
- E-komercijas veikals
- Bloga vai satura vietne
- Portfējs vai izvēles platforma (showcase)
- SaaS lietojums
- Savienība vai forum
- Cits: [aprakstīt]
```
...
- Patērētāji / vispārējais laika cilvēki
- Biznesprofesionāli
- Izdevēji / tehniskie lietotāji
- Studenti / izglītoti personās
- Cits: [aprakstīt]
...
- Galvenā krāsa: [krāsu izvēlne vai hex kodu]
- Sekundārā krāsa: [krāsu izvēlne vai hex kodu]
- Akcenta krāsa: [optīva]

Kā jūs aprakstētu savas brīvnieku toni?
...
- Generēt potenciālos klientus (leads)
- Pārdot produktus
- Izveidot savienību
- Uzlabot zināšanas
- Iestatīt autoritāti
...
Kas ir jūsu galvenais metriks?
- Ieņēmumi
- Lietotāju saikne (engagement)
- Satura pieejamība
- Konversijas
- Cits
```
...
- Plats (visas saturas vienā līmenī)
- Hierhiskais (kategorijas un apkategorijas)
- Kronoloģisks (bloga stils)
- Produktu balstīts (katalogi)
- Cits: [aprakstīt]

Kuru satura tipus jūs izmantojat?
- Bloga postas
- Produktu lapas
- Kasu pētījumi (case studies)
- Dokumentācija
- Video
- Cits
```
...
```
"Redzi man ko site brief?"
```

vai

```
"Kas jums zinām par manu siti brief?"
```
...
```
"Atjaunināt manu site brief: tagad mērķējam B2B klientus"
```

vai

```
"Atjaunināt manu site specifikāciju"
```
...
```
Jūs: "Pārveidot manu puslapas lapu"
...
```
Jūs: "Kas man vajadzētu pievienot?"
...
- Kad maināt auditoriju
- Kad pievienojat jaunas produktijas līnijas
...
- "Mēs mērķaudzi profesionālus, kuri novērtē kvalitāti paraugu nevis cenu"
...
Jūs varat arī veikt Site Specification nepalīdzoties, ja vēlaties:

- Uzlabot savu prasmi pēc sākotnējās iestatījumiem
...
- Jautājiet agenti "atcerēties man site brief" (`recall my site brief`)
- Pārbaudiet, vai atmiņa ir ieslēgta savos iestatījumos

**Es vēlos sākt no jauna `site_brief`**
- Jautājiet agentam: "Skaidroj manu site brief un sāk atjauno"
- Tad veiciet Site Specification vēlreiz

**Agentis sniedz ieteikumus, kas nepiemērojam savam site\_brief?**
- Jautājiet agentam: "Pārskati mani site briefu"
...
1. **Izmantojiet Theme Builder**: Izveidiet personalizētu tēmu, kas balstīta uz jūsu site\_brief
2. **Uzlabojiet dizainu**: Izmantojiet Design System Aesthetics prasmi, lai veicētu detaļas dizaina darbus
3. **Plānojiet saturu**: Lūdziet agentus par satura struktūras ieteikumiem
4. **Izveidojiet funkcijas**: Lūdzieties par funkcijām, kas atbildo jūsu biznesa mērķiem
