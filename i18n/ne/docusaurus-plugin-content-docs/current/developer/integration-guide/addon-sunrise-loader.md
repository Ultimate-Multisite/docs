...
## यसलाई कहिले प्रयोग गर्ने {#when-to-use-it}
...
## फाइल नामकरण परम्परा {#file-naming-convention}
...
## फाइल कहाँ राख्ने {#where-to-place-the-file}
...
## उपलब्ध hooks र filters {#hooks-and-filters-available}
