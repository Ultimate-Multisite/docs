...
दुईवटा simultaneous request ले एउटै मान पढ्न सक्छन् र दुवैले त्यही increment गरिएको परिणाम फेरि लेख्न सक्छन्, जसले एउटा count हराउँछ। `increment_item()` ले arithmetic लाई एकल `UPDATE ... SET column = column + ?` statement मार्फत database engine लाई सुम्पन्छ, जसले operation लाई स्वाभाविक रूपमा atomic बनाउँछ।
