...
title: फिल्टर - wu_wp_config_reference_hook_line_patterns
...
[`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) मा लाइन 143 मा परिभाषित गरिएको छ.
