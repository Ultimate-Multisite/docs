...
| नाम | प्रकार | विवरण |
|------|------|-------------|
| $notices | `array` | त्यो विशेष प्यानलका सूचनाहरूको सूची। |
| $all_notices | `array` | थपिएका सूचनाहरूको सूची, प्यानलअनुसार छुट्याइएको। |
| $panel | `string` | सूचनाहरू प्राप्त गर्ने प्यानल। |
