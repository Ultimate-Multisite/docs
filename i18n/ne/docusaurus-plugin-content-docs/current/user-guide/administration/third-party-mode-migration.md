...
---
# तेस्रो-पार्टी मोड माइग्रेशन {#third-party-mode-migration}
...
## के परिवर्तन भयो? {#what-changed}

### v1.12.0 अगाडि {#before-v1120}
...
## कसलाई असर गर्छ? {#who-is-affected}

### नयाँ इन्स्टलेसनहरू (WordPress 7.0+) {#new-installations-wordpress-70}

**कुनै कार्य गर्न आवश्यक छैन।** तेस्रो-पार्टी मोड स्वचालित रूपमा "auto" मा सेट हुन्छ, र क्षमताहरू डिबग आउट अफ द बक्स काम गर्छन्।

### विद्यमान इन्स्टलेसनहरू {#existing-installations}
...
### 7.0 भन्दा पहिलेका WordPress संस्करणहरू {#wordpress-versions-before-70}
...
## मोडहरू बुझ्ने {#understanding-the-modes}

### auto मोड (नयाँ डिफाल्ट) {#auto-mode-new-default}
...
### म्यानुअल मोड (Manual Mode) {#manual-mode}
...
### लेगेसी मोड (Legacy Mode) {#legacy-mode}
...
## आफ्नो वर्तमान मोड जाँच गर्ने {#checking-your-current-mode}

### एडमिन प्यानेल मार्फत {#via-admin-panel}
...
## आफ्नो मोड परिवर्तन गर्ने {#changing-your-mode}

### ऑटो मोडमा स्विच गर्ने (Switch to Auto Mode) {#switch-to-auto-mode}
...
### म्यानुअल मोडमा स्विच गर्ने (Switch to Manual Mode) {#switch-to-manual-mode}
...
### लेगेसी मोडमा स्विच गर्ने (Switch to Legacy Mode) {#switch-to-legacy-mode}
...
## Auto Mode का फाइदाहरू {#benefits-of-auto-mode}

### स्वचालित पत्ता लगाउने (Automatic Discovery) {#automatic-discovery}
...
### नेटिभ एकीकरण (Native Integration) {#native-integration}
...
### सरल व्यवस्थापन (Simplified Management) {#simplified-management}
...
### राम्रो कार्यसम्पादन (Better Performance) {#better-performance}

- क्षमताहरू cache गरिन्छ
- माग अनुसार Lazy-loaded हुन्छ
- WordPress 7.0+ को लागि अनुकूलित

## माइग्रेशन बाटो (Migration Path) {#migration-path}

### यदि तपाईं WordPress 6.x मा हुनुहुन्छ भने {#if-youre-on-wordpress-6x}
...
### यदि तपाईं WordPress 7.0+ मा हुनुहुन्छ भने {#if-youre-on-wordpress-70}
...
### Auto mode मा क्षमताहरू लोड हुँदैनन् {#abilities-arent-loading-in-auto-mode}
...
### म लेले लेगेसी मोड कायम राख्न चाहन्छु {#i-want-to-keep-legacy-mode}
...
### मेरो कस्टम क्षमताहरू देखाइँदैनन् {#my-custom-abilities-arent-showing}
...
### म "unclassified ability" सूचनाहरू प्राप्त गर्दैछु {#im-getting-unclassified-ability-notices}
...
## पुरानो अनुकूलता (Backward Compatibility) {#backward-compatibility}

### विद्यमान कन्फिगरेसनहरू {#existing-configurations}
...
### पुरानो गर्ने समयरेखा (Deprecation Timeline) {#deprecation-timeline}
...
## सर्वोत्तम अभ्यासहरू (Best Practices) {#best-practices}

### नयाँ स्थापनाहरूको लागि {#for-new-installations}
...
### विद्यमान स्थापनाहरूको लागि {#for-existing-installations}
...
### कस्टम क्षमताहरूको लागि {#for-custom-abilities}
...
## आगामी कदमहरू (Next Steps) {#next-steps}
