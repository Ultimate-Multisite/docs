...
## पूर्वशर्तहरू (Prerequisites) {#prerequisites}
...
### १. CyberPanel API सक्षम गर्नुहोस् {#1-enable-the-cyberpanel-api}
...
### २. wp-config.php मा स्थिरांक (Constants) थप्नुहोस् {#2-add-constants-to-wp-configphp}
...
### ३. एकीकरण (Integration) सक्षम गर्नुहोस् {#3-enable-the-integration}
...
### ४. कनेक्टिविटी प्रमाणित गर्नुहोस् {#4-verify-connectivity}
...
### इमेल फरवर्डरहरू (Email Forwarders) {#email-forwarders}
...
## कन्फिगरेसन सन्दर्भ {#configuration-reference}
...
### API Connection Refused (API कनेक्ट हुन अस्वीकार गरियो) {#api-connection-refused}
...
### Authentication Errors (प्रमाणीकरण त्रुटिहरू) {#authentication-errors}
...
### Domain Not Created (डोमेन सिर्जना गरिएको छैन) {#domain-not-created}
...
### SSL Certificate Not Issued (SSL प्रमाणपत्र जारी गरिएको छैन) {#ssl-certificate-not-issued}
