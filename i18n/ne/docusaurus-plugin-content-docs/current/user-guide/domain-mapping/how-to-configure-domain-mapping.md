...
## Domain mapping भनेको के हो? {#whats-domain-mapping}
...
### तपाईंको Ultimate Multisite Network मा domain mapping कसरी setup गर्ने {#how-to-setup-domain-mapping-on-your-ultimate-multisite-network}
...
### domain का DNS settings ठीकसँग configure भएका छन् भनी सुनिश्चित गर्ने {#making-sure-the-domain-dns-settings-are-properly-configured}
...
### Super Admin का रूपमा custom domain name mapping गर्ने {#mapping-custom-domain-name-as-super-admin}
...
### Subsite प्रयोगकर्ताका रूपमा custom डोमेन नाम mapping गर्ने {#mapping-custom-domain-name-as-subsite-user}
...
### डोमेन Syncing बारे {#about-domain-syncing}
