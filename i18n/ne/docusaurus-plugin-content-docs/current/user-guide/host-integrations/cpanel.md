...
### १. आफ्नो cPanel प्रमाणहरू प्राप्त गर्नुहोस् (Get Your cPanel Credentials) {#1-get-your-cpanel-credentials}
...
### २. wp-config.php मा स्थिरांकहरू थप्नुहोस् (Add Constants to wp-config.php) {#2-add-constants-to-wp-configphp}
...
### ३. एकीकरण सक्षम गर्नुहोस् (Enable the Integration) {#3-enable-the-integration}
