...
### १. आफ्नो ServerPilot API प्रमाणहरू प्राप्त गर्नुहोस् (Get Your ServerPilot API Credentials)
...
### २. आफ्नो App ID प्राप्त गर्नुहोस् (Get Your App ID)
...
## SSL प्रमाणपत्र प्रमाणीकरण (Verification)
