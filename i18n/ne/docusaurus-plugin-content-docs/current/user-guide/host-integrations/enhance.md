...
## आफ्नो API प्रमाणहरू प्राप्त गर्ने तरिका

### १. API टोकन सिर्जना गर्नुहोस्
...
### २. आफ्नो Organization ID प्राप्त गर्नुहोस्
...
### ३. आफ्नो Server ID प्राप्त गर्नुहोस्
...
### ४. आफ्नो API URL प्राप्त गर्नुहोस्
...
### आवश्यक स्थिरांकहरू (Required Constants)
...
### इन्टिग्रेशन विजार्ड मार्फत सेटअप गर्ने तरिका
...
### कनेक्शन परीक्षण गर्नुहोस् (Test the Connection)
...
### डोमेन म्याप गरेपछि (After Mapping a Domain)
...
### API कनेक्ट न हुनुको समस्याहरू (API Connection Issues)
...
### DNS जाँच अंतराल (DNS Check Interval)
...
### सामान्य प्रयोग गरिने Endpoints
...
### पूर्ण API कागजात (Full API Documentation)
...
## अतिरिक्त स्रोतहरू (Additional Resources)
