...
## Cap Captcha: Αυτοεξυπηρετούμενη Προστασία που Απλώς Λειτουργεί {#cap-captcha-self-hosted-protection-that-just-works}
...
## Προστασία από Card Testing στο WooCommerce {#woocommerce-card-testing-protection}
...
## Χρειάζεστε ακόμα Google reCAPTCHA ή hCaptcha; {#still-need-google-recaptcha-or-hcaptcha}
...
## Σχεδιασμένο για Κλίμακα {#built-for-scale}
...
## Χρειάζεται να ρυθμίσω κάτι; {#do-i-need-to-configure-anything}
...
## Χρειάζομαι API keys για το Cap Captcha; {#do-i-need-api-keys-for-cap-captcha}
...
## Θα επιβραδύνει το checkout μου; {#will-this-slow-down-my-checkout}
...
## Προστατεύει από επιθέσεις card testing; {#does-this-protect-against-card-testing-attacks}
...
## Μπορώ να χρησιμοποιήσω διαφορετικούς παρόχους captcha σε διαφορετικά sites; {#can-i-use-different-captcha-providers-on-different-sites}

Ο πάροχος captcha ρυθμίζεται σε όλο το δίκτυο, αλλά μπορείτε να ρυθμίσετε τα επίπεδα δυσκολίας με βάση τις ανάγκες σας.

## Είναι GDPR compliant; {#is-this-gdpr-compliant}
...
## Ανίχνευση IP του Πελάτη & Εμπιστευτικοί Proxies {#client-ip-detection--trusted-proxies}
...
#### Ρύθμιση Εμπιστευτικών Proxies {#trusted-proxy-configuration}
...
#### Αυτόματη Ανίχνευση κατά την Πρώτη Ενεργοποίηση {#first-enable-auto-detection}
...
### Γιατί Αυτό Είναι Σημαντικό {#why-this-matters}
