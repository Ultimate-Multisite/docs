...
## Αποτέλεσμα Επιστροφής (Return Value) {#return-value}
...
## Ετικέτα Πλοήγησης έναντι Τίτλου Σελίδας {#navigation-label-vs-page-title}
...
### Παράδειγμα 1: Απλό Μενού με Ετικέτα Πλοήγησης {#example-1-simple-menu-with-navigation-label}
...
### Παράδειγμα 2: Μενού για Συγκεκριμένη Τοποθεσία Θέματος {#example-2-menu-for-specific-theme-location}
...
## Σχετικές Λειτουργίες {#related-abilities}
...
## Σχετικές Λειτουργίες {#related-abilities-1}
