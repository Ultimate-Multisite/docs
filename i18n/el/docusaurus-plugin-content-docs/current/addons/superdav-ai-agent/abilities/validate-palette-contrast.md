...
---
# Επικύρωση Αντίθεσης Παλέτας Χρωμάτων {#validate-palette-contrast}
...
## Ελέγχονται τα Επίπεδα WCAG {#wcag-levels-checked}
...
## Ενσωμάτωση με Theme Builder {#integration-with-theme-builder}
...
## Ζεύγη που Αποτυγχάνουν και Προτάσεις {#failing-pairs-and-recommendations}
...
## Σχετικές Ικανότητες {#related-abilities}
