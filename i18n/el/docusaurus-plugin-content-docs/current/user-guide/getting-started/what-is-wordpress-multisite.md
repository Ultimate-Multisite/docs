...
---
# Τι είναι το WordPress Multisite; {#what-is-wordpress-multisite}
...
## Τι ακριβώς είναι το WordPress Multisite; {#what-exactly-is-wordpress-multisite}
...
## Subdomain ή Subdirectory; {#subdomain-or-subdirectory}
...
## Τι μοιράζονται οι υπο-ιστοσελίδες και τι όχι {#what-is-shared-among-subsites-and-what-is-not}
...
## Διαχείριση χρηστών στο WordPress Multisite {#user-management-on-wordpress-multisite}
...
## Θέματα απόδοσης {#performance-considerations}
