...
## Πότε Εμφανίζεται ο Οδηγός; {#when-does-the-wizard-appear}
...
## Βήμα 1: Καλωσόρισμα {#step-1-welcome}
...
## Βήμα 2: Ρύθμιση Δικτύου {#step-2-network-configuration}

Σε αυτό το βήμα καλείστε να διαμορφώσετε τις ρυθμίσεις του δικτύου σας.

### Δομή Ιστοτόπων {#site-structure}
...
### Email Διαχειριστή Δικτύου {#network-admin-email}
...
## Βήμα 3: Εγκατάσταση {#step-3-installation}
...
## Βήμα 4: Ολοκλήρωση {#step-4-complete}
...
## Εναλλακτική Χειροκίνητη Εγκατάσταση {#manual-setup-fallback}
...
### Ο οδηγός αναφέρει ότι το wp-config.php δεν είναι εγγράψιμο {#the-wizard-says-wp-configphp-is-not-writable}
...
### Οι ιστότοποι δεν είναι προσβάσιμοι μετά την εγκατάσταση (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Προβλήματα ταυτοποίησης μετά την εγκατάσταση {#authentication-issues-after-setup}
...
### Κάποιο βήμα απέτυχε κατά την εγκατάσταση {#a-step-failed-during-installation}
