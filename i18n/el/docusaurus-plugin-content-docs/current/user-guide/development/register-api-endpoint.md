...
## Παράμετροι body του endpoint {#endpoint-body-parameters}
...
## Δημιουργία ενέργειας στο Zapier {#creating-an-action-in-zapier}
...
### Δημιουργία ενέργειας {#creating-an-action}
...
### Πλήρεις παράμετροι endpoint {#complete-endpoint-parameters}
