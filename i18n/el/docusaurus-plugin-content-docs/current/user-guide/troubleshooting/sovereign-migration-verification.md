...
## Εντολές εκτέλεσης {#commands-to-run}
...
## Συνηθισμένες αποτυχίες {#common-failures}

### Οι επιτρεψεις βάσης δεδομένων δεν ταιριάζουν με τονโホสต์ (host) {#database-grants-do-not-match-the-host}
...
### Οι εγκαταστάσεις Bedrock ή τοπικού socket δεν μπορούν να συνδεθούν {#bedrock-or-local-installs-cannot-connect}
...
### Η ουρά push ασύγχρονης (Async push queue) δεν تخلیδίζεται {#async-push-queue-does-not-drain}
...
### Ο αριθμός των χρηστών του tenant είναι λάθος {#tenant-user-count-is-wrong}
...
### Η επίσκεψη SSO απορρίπτεται {#sso-visit-is-rejected}
...
## Πότε να δοκιμάσετε ξανά {#when-to-retry}
