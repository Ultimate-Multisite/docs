...
### 1. Δημιουργήστε το API Token του Hostinger σας
...
### 2. Βρείτε τον Αναγνωριστικό Λογαριασμού σας (Account ID)
...
### Addon Domains (Πρόσθετα Domains)
