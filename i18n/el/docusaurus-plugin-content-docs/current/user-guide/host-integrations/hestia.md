...
## Ρύθμιση (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Επαλήθευση της Ρύθμισης {#verifying-setup}
...
## Σημειώσεις & Συμβουλές {#notes--tips}
...
## Παράδειγμα Κλήσης API (cURL) {#example-api-call-curl}
