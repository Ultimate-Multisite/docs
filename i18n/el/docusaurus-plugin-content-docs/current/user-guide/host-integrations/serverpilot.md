...
### 1. Λήψη των Διαπιστευτηρίων API του ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Λήψη του App ID {#2-get-your-app-id}
...
## Επαλήθευση Πιστοποιητικού SSL {#ssl-certificate-verification}
...
### Αφαίρεση Domain {#domain-removal}
