...
## Πρότυπο κύριου αρχείου πρόσθετου
...
## Παράδειγμα προσαρμοσμένου μοντέλου
...
### SSO και URL διαχείρισης κύριου site
...
### Βασικά domains φόρμας checkout
...
### Αυτόματη δημιουργία εγγραφών domain
