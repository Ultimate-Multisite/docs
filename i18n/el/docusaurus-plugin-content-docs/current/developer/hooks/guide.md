...
#### Μετά την Δημοσίευση της Εμβãiς
...
#### Πριν την Εφαρμογή του Εμπρότυπου
...
#### Ολοκληρωμένη / Αποτυχημένη Πληρωμή
...
#### Πριν την Επεξεργασία / Μετά την Ολοκλήρωση
