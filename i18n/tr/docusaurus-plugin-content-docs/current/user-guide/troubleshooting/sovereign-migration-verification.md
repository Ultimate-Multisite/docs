...
### Veritabanı izinleri ana bilgisayarla eşleşmiyor
...
### Bedrock veya yerel kurulumlar bağlanamıyor
...
### Asenkron itme kuyruğu boşaltılmıyor (drain)
...
### Kiracı kullanıcı sayısı yanlış
