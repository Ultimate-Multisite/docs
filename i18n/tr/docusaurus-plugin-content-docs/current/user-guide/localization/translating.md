---
title: Ultimate Multisite'ı Çevirme
sidebar_position: 19
...
Bu, standart WordPress topluluk çeviri sistemidir. Çeviriler yeterli onay eşiğine ulaştığında, WordPress eklenti güncellemeleri aracılığıyla tüm Ultimate Multisite kullanıcılarına otomatik olarak dağıtılır.

**Yardımınıza ihtiyacımız var!** İngilizce dışında bir dil biliyorsanız, lütfen çevirilere katkıda bulunmayı düşünün. Birkaç metin parçasını çevirmek bile büyük fayda sağlar. Başlamak için:

1. [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) adresini ziyaret edin
2. Dilinizi seçin
3. "Contribute Translation" butonuna tıklayın
...
2. `wp-content/plugins/ultimate-multisite/lang/` klasöründeki `.pot` dosyasını açın
3. Poedit arayüzünde metinleri çevirin
