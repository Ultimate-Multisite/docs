...
### Bir Site Şablonunun içeriklerini özelleştirme
...
#### Mod 2: Kullanılabilir Site Şablonunu Seç
...
### Varsayılan Mod: Checkout formunda site şablonu seçimi
...
#### Kullanıcıların Sitelerini şablon olarak kullanmasına izin ver
...
#### Şablon Çoğaltmada Medyayı Kopyala
...
#### **Arama Motorlarının Site Şablonlarını indekslemesini önle**
...
## Otomatik arama ve değiştirme ile Site Şablonlarını önceden doldurma
