...
## Alt alan adı (Subdomain) {#subdomain}
...
## Alt dizin (Subdirectory) {#subdirectory}
...
## Süper Yönetici (Super Admin) {#super-admin}
...
## Alan Adı Eşleme (Domain Mapping) {#domain-mapping}
...
## Kalıcı Bağlantılar (Permalinks) {#permalinks}
...
## Ödeme Formu (Checkout Form) {#checkout-form}
