...
#### Alt Alan Adı (Subdomain) ve Alt Dizin (Subdirectory) {#subdomain-vs-subdirectory}
...
### Mimari Değerlendirmeler {#architecture-considerations}
...
#### Paylaşımlı ve Özel Hosting {#shared-vs-dedicated-hosting}
...
#### Harici Betikler {#external-scripts}
