...
### 1. CyberPanel API'sini Etkinleştirin
...
### E-posta Yönlendiricileri (Email Forwarders)
...
### API Bağlantısı Reddedildi (API Connection Refused)
...
### Alan Adı Oluşturulamadı (Domain Not Created)
...
### SSL Sertifikası Düzenlenmedi (SSL Certificate Not Issued)
