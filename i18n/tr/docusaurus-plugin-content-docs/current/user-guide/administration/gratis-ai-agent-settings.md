...
## Google Calendar Yapılandırması
...
### Özellik Bayraklarına Erişme

1. WordPress yöneticisinde **Gratis AI Agent → Settings** bölümüne gidin.
2. **Feature Flags** sekmesine tıklayın.

### Erişim Kontrolü Bayrakları
...
### Otomasyon Güvenliği İşaretleri
