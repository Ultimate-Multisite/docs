...
---
# Enhance Kontrol Paneli Entegrasyonu {#enhance-control-panel-integration}
...
### 1. API Token'ı Oluşturma {#1-create-an-api-token}
...
### Bir Domain Eşleştirildiğinde {#when-a-domain-is-mapped}
...
### Bir Domain Kaldırıldığında {#when-a-domain-is-removed}
...
### Domain Eşleştirdikten Sonra {#after-mapping-a-domain}
...
### Domain Eklenmiyor {#domain-not-added}
...
### Kullanılan Yaygın Uç Noktalar {#common-endpoints-used}
