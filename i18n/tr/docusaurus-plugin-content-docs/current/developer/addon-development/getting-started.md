 ...
 * Description: Ultimate Multisite için özel addon
 * Version: 1.0.0
 * Author: Your Name
 * Requires PHP: 7.4
...
add_action('plugins_loaded', function() {
    if (!class_exists('WP_Ultimo\WP_Ultimo')) {
        add_action('admin_notices', function() {
            ...
            echo 'My Addon, Ultimate Multisite eklentisinin kurulu ve etkin olmasını gerektirir.';
            echo '</p></div>';
        });
        return;
    }
...
class My_Addon {
    ...
    /**
     * Ödeme tamamlandığında işlemleri yönet
     */
...
/**
 * Özel Lead (Potansiyel Müşteri) modeli
 */
class Lead extends \WP_Ultimo\Models\Base_Model {
    ...
    /**
     * Lead'i (Potansiyel Müşteri) müşteriye dönüştür
     */
...
class Leads_Admin_Page extends \WP_Ultimo\Admin_Pages\Base_Admin_Page {
    ...
    public function register() {
        wu_register_admin_page($this->id, [
            'title' => __('Leadler', 'my-addon'),
            'menu_title' => __('Leadler', 'my-addon'),
    ...
    public function render() {
        ...
        wu_get_template('admin/leads-list', [
            'leads' => $leads,
            'page_title' => __('Leadleri Yönet', 'my-addon')
        ]);
    }
}
```

## Addonunuzu Test Etme
...
- Mevcut aksiyonlar ve filtreler için [Hooks Referansı](/developer/hooks)'nı gözden geçirin
- API entegrasyonu için [REST API Genel Bakış](/developer/rest-api/overview)'a bakın
- Başlangıç iskeleti olarak [Addon Şablonu](/addons/addon-template)'nu kullanın
