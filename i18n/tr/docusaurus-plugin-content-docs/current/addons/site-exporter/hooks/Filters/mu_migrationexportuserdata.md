...
Dışa aktarılacak veya içe aktarılacak varsayılan kullanıcı verisi kümesini filtreler.

## Parametreler {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $custom_user_data | `array` | Özel kullanıcı verisi dizisi. |
