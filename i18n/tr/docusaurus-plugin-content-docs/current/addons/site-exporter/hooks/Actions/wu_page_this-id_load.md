...
Eklenti geliştiricilerinin belirli bir sayfaya ek kancalar (hooks) eklemesine olanak tanır.
...
| $page_hook | `string\|\WP_Ultimo_Site_Exporter\Admin_Pages\Base_Admin_Page` | Bu sayfaya oluşturulan kanca (hook). |
