...
## Mövcud Rejimizi Yoxlamaq

### Admin Paneli vasitəsilə
...
## Auto Mode-un Üstünlikleri

### Awtomatiki Tapylmak (Automatic Discovery)
...
### Yerli Integrasiýa (Native Integration)
...
### Sederleşdirilen Dolandyryş (Simplified Management)
...
### Eger Siz WordPress 7.0+-de bolsaňyz
...
## Sorunlary Gözläp Çyrmak (Troubleshooting)

### Auto mode-da käbilikler ýüklenip bilmez
...
### Legacy mode-u saklamagy isledim
...
### "Sınıflandırılmamış yetenek" uyarıları alıyorum
