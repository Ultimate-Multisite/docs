...
### Üylyklaryň Täzelenmäden Expired-e Geçmegi
...
#### Avtomatiki Yenilený we Avtomatiki Yenilenme Olmadyk Üyelikler
...
### Otavazlanmalar nädip agyrylýar
...
## Blok Frontend Access (Önünji Bölüm Ýylyp Bilmek)
...
### Site Bloklandygynda Zyyaratlar Näme Görýärler
...
## Soraglar bölmesi: Sürişme döwründen soň site halaýan ýaly bolmagy

Eger üyeliği sonu geldikten soň site halka elýeterli bolup bilse, bu barlaglary şu görkeziji tertipde geçiriň:

### 1. Blok Önüni Elýeterlik (Block Frontend Access) Düşündirişini Barlap Geçiň
...
### 2. Önüni Bloklamagyň Önüni Barlap Geçiň (Frontend Block Grace Period)
...
### 3. Üylygy Status Hakykatda Değişdi Dipler Teyin Edin
...
### 4. Action Scheduler'ın Çalışıp Çalışmadığını Doğrulayın
...
### 5. Gateway Webhook Soraglaryny Barlamak (Auto-Renewing Memberships)
...
### 6. Siziň Ýatlaýan Wekilçiligini (Cron Seviyesinde) Barlap Gör
...
### 7. Üyeçligi Manual ýaly Ýerimleşdirmek (Manually Expire a Membership)
