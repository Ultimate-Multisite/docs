...
- **Müşderiniki** — Belirli müşderilere degişli saytlar
...
- **Site Title** — Täze sayt ady
- **Site URL** — Sayt domenini/ýolunuň (domain/path)
- **Site Type** — Bu müşderi sayty, şablon muallar, ýa-da adatdaky saytmydyr
...
- **Ziyarat limitleri** — Sayt üçin maksimum gizerlik sanyty
- **User hasabyna limitler** — Her bir user roly üçin limitler
- **Disk ulylygy** — Sayt üçin sazlama payy
- **Custom domain** — Bu sayçma üçin domen eşleşdirilmegini işleýärlik
- **Plugin we theme görnüşi** — Hangi pluginler we theme'ler görünjekdigini, ýatlaýan ýa-da önüni işjeýänleri nädip dolandyryp bilersiňiz
...
- Sayt bilen baglanyşykly **Mapped domains** (Eşleşdirilen domenler)
...
- Sayt üçin açyp/ýapmak we ýapmagyň üçin düwät (toggle button) bilen özleşdirmegi
- Sayt nüshanasyny üýtgetmek ýa-da eýe haklaryny başga birine bermek
- Sayt üçin surat/thumbnail goýmak (sayt şablonlarynda önümçilikde görkezilýär)
- Saytdy ömür boyu aradan aýyrmak

:::warning
Saytdy aradan aýyrmak geri gelip biljek zat däldir. Sayt we olki ähli maglumatlar ömür boyu aradan aýrylýar.
:::
