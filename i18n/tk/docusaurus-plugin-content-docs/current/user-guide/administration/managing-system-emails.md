---
title: Sistem E-poçtlarını Yönetmek
sidebar_position: 13
...
Oradan size ähli e-postanyň şablonlaryny görmegi üçin **System Emails** sagatyna geçip bilersiňiz.

![System Emails list](/img/admin/system-emails-list.png)

Siz hem sistem e-postasy redaktoryny ulanmagy bilen her bir e-postanyň şablonlaryny redaktir edip bilersiňiz:
...
Täze email şablonlaryny import etmek üçin:

1. **System Emails** sagatyna gidiň
2. Sagatanyň üstündäki **Reset & Import** düwmenine basyň
...
1. **Silip täze import etmek** — Sistem e-mailini silin ve onu bedel-deçe (bu göndermä metrikalaryny siler).
2. **Araç arkaly sıfırlamak** — **Reset & Import** aracyny isläň, **Reset** opsiyasyny açyň we sıfırlamak isleýän e-mailleri saýlaň.

Sıfırlamak (Reset) opsiyasy terbiylidir, sebäbi ol göndermä metrikalaryny we beýleki metadata'ları saklaýar we standart belli mahiyatlydyry.
