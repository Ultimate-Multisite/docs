...
## Feedback endpoint konfigurasiýasy
...
## Dolandyrylýan Superdav hyzmaty
...
## Google Calendar konfigurasiýasy
...
### Aýratynlyk baýdaklaryna girmek

1. WordPress admin-de **Gratis AI Agent → Settings** bölümine gidiň.
2. **Feature Flags** goýmasyna basyň.

### Elýeterlilik dolandyryş baýdaklary
...
### Awtomatlaşdyrma howpsuzlyk baýdaklary
