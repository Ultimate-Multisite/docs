---
title: Ultimate Multisite-yň terjimesi
sidebar_position: 19
...
Bu standart WordPress jemgyýetçiliginiň terjime ulgamy. Terjime kesgitli tasdiq derejesine ulaşanda, olar awtomatiki we WordPress plugin güncellemelari arkaly ähli Ultimate Multisite ulanyjylaryna ýatyrylýar.

**Bizden kömek gerek!** Eger siz İngyz dilinden başga bir dilde gürleşip bolsaňyz, terjime goşurlaryny kabul etmegi göz öňünde tutaň. Birnäçe satyny terjime etmek hem kömek edýär. Başlamak üçin:

1. [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) bilen tagaň
2. Öz dilini saýlaň
3. "Contribute Translation" (Terjime goşurlu) düwmenine basyň
4. Siz wep WordPress.org hasabyna ehtiyac duýarsyň
...
1. [poedit.net](https://poedit.net) dälinden Poedit-i indirip aluň
2. `wp-content/plugins/ultimate-multisite/lang/` diredegini açyň
3. Poedit aratynda tarjimalar üçin sözleri terjimeňiz
4. Saýlaň -- Poedit `.po` we `.mo` fayllaryny döredip berer
