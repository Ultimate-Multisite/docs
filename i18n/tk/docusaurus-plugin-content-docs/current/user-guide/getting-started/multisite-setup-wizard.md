...
### Ağ Yöneticisi E-postası (Network Admin Email)
...
## Manual Setup Fallback (Manual Kurmakda Alternatiwa)
...
## Troubleshooting (Sorynlylyk Üstüni)

### Wizard wp-config.php ýazyp bilmese diýip aýdýar
...
### Kurmakdan soň saytlara girilip bilmez (subdomainler)
...
### Kurmakdan soň autentifikasiýa meseleleri
...
### Kurmak dowamynda bir ädim ýitdi
