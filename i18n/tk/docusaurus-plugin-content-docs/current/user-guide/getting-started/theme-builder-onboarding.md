...
## Theme Builder Onboarding Flow Nedir?
...
## Theme Builder Onboarding'e Başlama
...
### Adım 1: Mod Seçimi (Mode Selection)
...
### Adım 2: Site Özellikleri (Site Specification)
...
### 3-nji ädim: Design System Kararlary
...
### 5-nji ädim: Aktivizasiýa we Barlaglaýyş
...
## Site Spesifikasiýasy we site_brief Hatary
...
### theme.json-y jogapkärlik bilen redaktir ediň
...
### Custom Block Template-leri döredip görüň
...
## Garaşdyrma: Köne we Täze Onboarding
