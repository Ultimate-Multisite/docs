...
---
# Closte Entegrasi {#closte-integration}
...
## Sorunlaryny Gözläp Bilmek (Troubleshooting) {#troubleshooting}
...
### Domen Goşulmady {#domain-not-added}
...
### DNS Barlamak Aralygy (DNS Check Interval) {#dns-check-interval}
