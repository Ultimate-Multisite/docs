...
### 1. Cloudways API Credentials-inizi Almaq
...
### 2. Server və Tətbiq ID-lərinizi Almaq
...
### 3. wp-config.php-ə Sabitləri Əlavə Etmək
...
## Aýratyn zat — Wildcard SSL Töweregi
...
### Ultimate Multisite ulgamy üçin Cloudways-de maslahat berilýän SSL görkezijisi
