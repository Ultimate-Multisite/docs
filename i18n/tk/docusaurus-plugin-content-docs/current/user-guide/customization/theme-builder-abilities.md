...
---
# Tema İnşa Etici Qabiliyyətləri: Scaffold və Aktivləşdirmə Blok Temaları {#theme-builder-abilities-scaffold-and-activate-block-themes}
...
## Blok Teması Scaffold Etmək (Scaffold Block Theme) {#scaffold-block-theme}
...
### Necə Çağırılır (How to Invoke) {#how-to-invoke}
...
### Gözlənilən Nəticə (Expected Output) {#expected-output}
...
### Beklenen netije {#expected-output-1}
...
## İşlemek arkasy: Skaffold etmek we aktiwalaşdyrmak {#workflow-scaffold-and-activate}
...
## Dizayn tokenlary we özelleşdirmek {#design-tokens-and-customization}
...
## Çykyşlar we Notatlar {#limitations-and-notes}
