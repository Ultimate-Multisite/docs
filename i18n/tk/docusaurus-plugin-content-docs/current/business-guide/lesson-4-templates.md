---
title: '4-nji sapak: Nişa şablonlaryny döretmek'
sidebar_position: 5
...
FitSite-a hasaba duran fitnes studiýasynyň eýesi şulary görmeli:

- Fitnes studiýasynyň websaýtyna meňzeýän baş sahypa
- Sapaklar, tertipler, tälimçiler we nyrhlar üçin eýýäm döredilen sahypalar
- Olaryň pudagyna laýyk şekiller we wagtlaýyn mazmun
- Fitnes üçin professional we brende laýyk duýulýan dizaýn
...
- **Baş sahypa** gahryman şekili, sapak tapawutlandyrmalary we herekete çagyryş bilen
- **Hakynda** sahypasy studiýanyň hekaýasy we missiýasy bilen
- **Sapaklar** sahypasy tertip ýerleşimi bilen
- **Tälimçiler** sahypasy profil kartlary bilen
...
- Studio Essential-daky hemme zat, üstesine:
- **Membership** sahypasy nyrh tablisasy bilen
- **Galereýa** sahypasy desga suratlary üçin
- Fitnes maslahatlary we täzelikleri üçin **Blog** bölümi
...
- Gym Pro-daky hemme zat, üstesine:
- Birnäçe desga sanawy bilen **Ýerleşýän ýerler** sahypasy
- **Franşiza/ýerleşiş** aşaky sahypa şablony
...
1. Fitnes kärhanalary üçin laýyk theme-i işjeňleşdiriň
2. Theme sazlamalaryny, reňkleri we tipografiýany sazlaň
3. Fitnese laýyk nawigasiýa bilen header we footer-i gurnaň
...
- Fitnes üçin tebigy okalýan **wagtlaýyn mazmun** ("[Studio Name]-a hoş geldiňiz", "Lorem ipsum" däl)
- Fitnes çärelerini görkezýän mugt stock photo saýtlaryndan **wagtlaýyn şekiller**
- Sahypa gurujy ýa-da blok redaktory arkaly **funksional ýerleşimler**
...
- Booking ýa-da tertipleşdiriş plugin-i (plan derejäňize degişli bolsa)
...
3. **Site Template** açaryny işjeňleşdiriň
...
- [ ] Ähli sahypalar dogry ýüklenýär we professional görünýär
- [ ] Wagtlaýyn mazmun peýdaly we nişa mahsus
- [ ] Şekiller laýyk we dogry ygtyýarnamaly
- [ ] Mobil uýgunlaşma ähli sahypalarda işleýär
- [ ] Nawigasiýa logiki we doly
- [ ] Habarlaşmak formalary işleýär
...
- Müşderilere özleşdirmekde ýol görkezýän **görkezme beriji wagtlaýyn mazmun**
- Şablonlaryň önümçilik üçin taýyndygyna göz ýetirmek üçin **hil barlag sanawy**

---

**Indiki:** [Sapak 5: Planlaryňyzy dizaýn etmek](lesson-5-plans) -- fitnes kärhanalarynyň hakykatda nähili işleýändigine laýyk product derejelerini döredýäris.
