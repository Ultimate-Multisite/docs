---
title: Öňdebaryjy kod mysallary
sidebar_position: 1
...
Iki birwagtdaky sorag şol bir bahany okap, ikisi hem şol bir artdyrylan netijäni yzyna ýazyp biler, netijede bir sanalma ýitirilýär. `increment_item()` arifmetikany maglumatlar bazasy hereketlendirijisine ýeke-täk `UPDATE ... SET column = column + ?` beýanaty bilen tabşyrýar, şonuň üçin amal tebigy ýagdaýda atomar bolýar.
