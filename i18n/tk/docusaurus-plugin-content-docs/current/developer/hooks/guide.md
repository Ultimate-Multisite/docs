---
title: Hooklary ulanmak boýunça gollanma
sidebar_position: 1
...
### Müşderiniň ýaşaýyş aýlawy {#customer-lifecycle}

#### Müşderi döredilenden soň {#after-customer-creation}
...
#### Müşderiniň ýagdaýynyň üýtgemegi {#customer-status-change}
...
### Saýt hook-lary {#site-hooks}

#### Saýt çap edilenden soň {#after-site-published}
...
#### Şablon ulanylmazdan öň {#before-template-application}
...
### Membership hook-lary {#membership-hooks}

#### Ýagdaý geçişleri {#status-transitions}
...
### Töleg hook-lary {#payment-hooks}

#### Töleg tamamlandy / başa barmady {#payment-completed--failed}
...
### Checkout hook-lary {#checkout-hooks}

#### Işlenmezden öň / Tamamlanandan soň {#before-processing--after-completion}
...
### Nyrh süzgüçleri {#pricing-filters}

#### Sebediň jemi {#cart-total}
...
### Şablon süzgüçleri {#template-filters}
...
### Çäklendirme süzgüçleri {#limitation-filters}
...
### Gateway süzgüçleri {#gateway-filters}
...
### Checkout form meýdanlary {#checkout-form-fields}
