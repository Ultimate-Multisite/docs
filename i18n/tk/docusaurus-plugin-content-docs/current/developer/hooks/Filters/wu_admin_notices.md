...
| Ady | Görnüşi | Beýany |
|------|------|-------------|
| $notices | `array` | Şol belli panel üçin habarnamalaryň sanawy. |
| $all_notices | `array` | Panel boýunça bölünen goşulan habarnamalaryň sanawy. |
| $panel | `string` | Habarnamalary almak üçin panel. |
