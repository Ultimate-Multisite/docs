...
|------|------|-------------|
| $notices | `array` | Lys van kennisgewings vir daardie spesifieke paneel. |
| $all_notices | `array` | Lys van kennisgewings wat bygevoeg is, gesegregeer per paneel. |
| $panel | `string` | Paneel om die kennisgewings uit te haal. |
