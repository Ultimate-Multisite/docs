...
- **Verifieer kontras** — gebruik [Validate Palette Contrast](../abilities/validate-palette-contrast.md) vir toeganklikheid
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — kontroleer kleurtoeganklikheid
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — skep aangepaste logo's
