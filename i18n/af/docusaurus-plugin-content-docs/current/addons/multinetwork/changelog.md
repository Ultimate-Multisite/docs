---
title: Multi-netwerk-veranderingslog
sidebar_position: 99
...
* Nuut: Netwerkmedia-kloning — werfmedia word korrek gedupliseer wanneer netwerke vanaf ’n sjabloon gekloon word.
* Regstelling: Netwerkkloning werk nou sonder die multi-tenancy addon; super admin-voorregte word ná kloning weer toegeken.
* Regstelling: Netwerkskepping is nou versoenbaar met WooCommerce en alle payment gateways.
* Regstelling: Poortnommer word nou ingesluit in terugval-domeingenerering.
* Regstelling: Template picker CSS na ’n geënqueue’de stylesheet geskuif vir korrekte weergawe op alle themes.
