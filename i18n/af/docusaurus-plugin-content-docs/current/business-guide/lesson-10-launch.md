...
- [ ] Domain mapping werk – toets die skep van 'n webwerf en die mapping van 'n aangepaste domein
...
- [ ] Alle beelde het korrekte lisensies (geen stock foto watermerke)
- [ ] Mobile responsiveness werk op elke template-bladsy
...
- [ ] Prysbepaling is korrek (maandeliks en jaarliks)
- [ ] Opstelgelde is op die regte planne geconfigureer
- [ ] Proefperiode werk op die Starter plan
...
- [ ] Betaling verwerk suksesvol
- [ ] Klant ontvang welkomst-e-pos ná aanmelding
- [ ] Nuwe webwerf word geskep met die korrekte template
...
- [ ] Alle stelsel-e-posse gebruik FitSite branding en gesondheids-spesifieke taal
...
- [ ] Welkomst-e-posreeks is geconfigureer en getoets
...
- [ ] Terugbetalingsbeleid is gedefinieer en gedokumenteer
- [ ] Besigheidsentiteit is opgerig vir die ontvang van betalings
...
- Eerlike terugvoer oor die aanmeld- en onboarding-ervaring
- Toestemming om hul webwerf as 'n vertoonvoorbeeld te gebruik
- Om enige bugs of probleme wat hulle raakontmoet, te rapporteer
...
- Skakel betalingshek na live-modus
- Publiseer jou marketingwebwerf
...
1. **Skakel oor na live betalings** – skakel toetsmodus op jou betalingshek uit
2. **Verifieer nogmaals** – doen 'n volledige toets-aanmelding met 'n werklike betaling (betaal jouself terug daarna)
3. **Monitor noukeurig** – kyk vir foute, mislukte aanmeldings of betalingsprobleme
...
- **Betalingshek-probleme**: Hou jou betalingshek-verskaffer se ondersteuningskontak gereed
- **SSL-sertifikaatprobleme**: Weet hoe om sertifikate te kontroleer en te vernuwe
- **E-poslewering-foute**: Toets dat e-posse eintlik aankom (kontroleer spammahouers)
...
- **Lanseringsdag-prosedures** om met selfvertroue live te gaan
- **'n Contingency plan** vir algemene lanseringdag-probleme

---

**Volgende:** [Les 11: Kliënte Vind](lesson-11-customers) — nou dat FitSite live is, hoe kry jy fitness-studio-eienaars om aan te meld?
