---
title: 'Les 9: Prysgstelling vir Wins'
sidebar_position: 10
...
- 'n Professionele fitnesswebwerf wat $2,000-$5,000 sou kos om op maat te bou
- Voortdurende instandhouding, opdaterings en sekuriteit wat hulle nie hoef te oorweeg nie
- Niche-spesifieke kenmerke wat algemene builders nie bied nie
- Die geloofwaardigheid van 'n platform wat vir hul industrie gebou is
...
- **Die huur van 'n webontwikkelaar**: $2,000-$5,000 eenmalig + $50-$100/maand instandhouding
- **Wix/Squarespace**: $16-$45/maand, maar geen fitness-spesifieke kenmerke nie, hulle bou dit self
- **Niks doen**: Verlore lede wat hulle aanlyn nie kan vind nie
...
| Plan | Maandeliks | Jaarliks (per maand) | Jaarlikse Totaal | Besparing |
|------|---------|-------------------|--------------|---------|
| Starter | $49/ma | $39/ma | $468/jaar | 20% afslag |
| Growth | $99/ma | $79/ma | $948/jaar | 20% afslag |
| Pro | $199/ma | $159/ma | $1,908/jaar | 20% afslag |
...
- **Starter**: Geen opstelgeld nie (verwyder drempels tot instap)
- **Growth**: $99 opstelgeld (dekke aangepaste domein-konfigurasie en aanvanklike konsultasie)
- **Pro**: $299 opstelgeld (dekke multi-lokasie opstel en onboarding-oproep)
...
- **7-dae gratis proefperiode** op Starter-plan slegs
- Geen proefperiode op Growth en Pro (hierdie kliënte is meer verbind en verwag om te betaal)
...
- **FITLAUNCH** -- 30% afslag op die eerste 3 maande (vir aanlooppromosie)
- **ANNUAL20** -- 20% afslag op jaarlikse planne (indien nie reeds afgekoop nie)
- **REFERRAL** -- 1 maand gratis (vir kliëntverwysings)

Navigeer na **Ultimate Multisite > Discount Codes** om hierdie te skep. Kyk na [Creating Discount Codes](/user-guide/configuration/creating-discount-codes) vir die volledige gids.

:::tip Moenie standaard afslag gee
...
1. Konfigureer belastingtariewe in **Ultimate Multisite > Settings > Taxes**
2. Pas belastingkategorieë by jou planne
3. Verseker dat fakture die belasting korrek toon
...
- **Konversiekoers per plan**: As Starter goed konverteer, maar Growth nie, mag die gaping tussen hulle te groot wees
- **Opgraderingskoers**: As min kliënte van Starter na Growth opgradeer, mag die Growth-plan nie genoeg bykomende waarde bied nie
...
├── Ultimate Multisite (gekonfigureer + gebrand)
├── Platform Domain (fitsite.com + wildcard SSL)
├── Site Templates (Studio Essential, Gym Pro, Fitness Chain)
├── Products
│   ├── FitSite Starter ($49/ma of $468/jaar) + 7-dae proefperiode
│   ├── FitSite Growth ($99/ma of $948/jaar) + $99 opstelgeld
│   ├── FitSite Pro ($199/ma of $1,908/jaar) + $299 opstelgeld
│   └── Order Bumps + Discount Codes
├── Checkout Flow (met period selection toggle)
├── Branding (login, dashboard, e-posse, fakture, marketingwebwerf)
├── Customer Onboarding (Quick Start, e-posse, hulpbronne)
├── Prysstrategie
│   ├── Jaarlikse afslag (20% afslag)
│   ├── Strategiese opstelgelde
│   ├── 7-dae proefperiode op Starter
│   ├── Kortingskodes vir veldtogte en verwysings
│   └── Belastingkonfigurasie
...
- **'n Proefperiode** op die instap-plan om registrasie-wrijving te verminder
- **Strategiese kortingskodes** vir aanloop, verwysings en veldtogte
- **Belastingkonfigurasie** vir nakomende fakturering
- **'n Prysing-herooptuigingsraamwerk** vir voortdurende optimalisering

---

**Volgende:** [Les 10: Aanloopdag](lesson-10-launch) -- die pre-aanloop-kontrolelys en live gaan.
