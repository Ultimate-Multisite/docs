...
## Lidmaatskap Status Lewensiklus
...
### Hoe Lidmaatskappe na Verbygeloop Verskuif
...
#### Outomaties Hernuwing teenoor Nie-Outomaties Hernuwing Lidmaatskappe
...
## Waflakking van Voorgrondtoegang
...
### Wat Besoekers Sien Wanneer 'n Webwerf Geblokkeer Is
...
### Wat Geblokkeer Word en Wanneer
...
## Probleemoplossing: Webwerwe Bly Toeganklik Ná Verloop

As webwerwe openbaar toeganklik bly nadat 'n lidmaatskap verbygeloop het, werk die volgende kontroles in volgorde deur:

### 1. Verifieer dat die Block Frontend Access Instelling Ingeskakel Is
...
### 2. Kontroleer die Frontend Block Grace Period
...
### 3. Bevestig dat die Lidmaatskap Status Werkelik Verander Het
...
### 4. Verifieer dat Action Scheduler Loop
...
### 5. Kontroleer op Hekwerk Webhook Probleeme (Outomaties-hernuwing Lidmaatskappe)
...
### 6. Kontroleer die Verloopgrasperiode (Cron Vlak)
...
### 7. Handmatig 'n Lidmaatskap Verbygeloop
