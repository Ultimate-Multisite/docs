---
title: Bestuur van Sisteem-E-posse
sidebar_position: 13
...
Van daar kan jy die **System Emails** bladsy bereik om al die e-pos-templates te sien.

![System Emails list](/img/admin/system-emails-list.png)

Jy kan ook individuele e-pos-templates redigeer met behulp van die sisteme-e-pos-redigeerder:
...
Om nuwe e-pos-templates te importeer:

1. Gaan na die **System Emails** bladsy
2. Klik op die **Reset & Import** knoppie bo-op die bladsy
...
1. **Verwyder en her-importeer** — Verwyder die sisteme-e-pos en importeer dit weer (dit wis stuurmetrieke)
2. **Herstel via die gereedskap** — Gebruik die **Reset & Import** gereedskap, skakel die **Reset** opsie, en kies die e-posse wat jy wil herstel

Die Herstel-opsie word verkies omdat dit stuurmetrieke en ander metadata behou terwyl dit die standaardinhoud herstel.
