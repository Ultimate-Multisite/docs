...
Dit is die standaard WordPress gemeenskapsvertalingsstelsel. Wanneer vertalings 'n voldoende goedkeuringsdrempel bereik, word dit outomaties aan alle Ultimate Multisite gebruikers versprei deur WordPress plugin-opdaterings.

**Ons het jou hulp nodig!** As jy 'n taal praat wat nie Engels is nie, wen asseblief oorweeg om vertalingsbydraes te lewer. Selfs die vertaling van 'n paar *strings* help. Om te begin:

1. Besoek [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Kies jou taal
3. Klik op "Contribute Translation"
4. Jy sal 'n gratis WordPress.org-rekening benodig
...
1. Laai Poedit van [poedit.net](https://poedit.net)
2. Maak die `.pot`-lêer uit `wp-content/plugins/ultimate-multisite/lang/` oop
3. Vertaal die *strings* in die Poedit-koppelvlak
