...
---
# Sovereign Migrasie Verifikasie {#sovereign-migration-verification}
...
## Kommando's om uit te voer {#commands-to-run}
...
## Algemene mislukking {#common-failures}

### Database-toestomme stem nie ooreen nie met die hoes {#database-grants-do-not-match-the-host}
...
### Bedrock of lokale installasies kan nie verbind nie {#bedrock-or-local-installs-cannot-connect}
...
### Asynkruis-push-rangskooie word nie leeggemaak nie {#async-push-queue-does-not-drain}
...
### Huurdergebruikersgetal is verkeerd {#tenant-user-count-is-wrong}
...
### SSO-besoek word afgewys {#sso-visit-is-rejected}
...
## Wanneer om te herhaal {#when-to-retry}
