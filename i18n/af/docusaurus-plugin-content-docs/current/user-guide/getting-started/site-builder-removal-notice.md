---
title: Verwydering van Site Builder Modus Kennisgewing
sidebar_position: 19
...
- Die skep van werwe uit sjablone
- Die konfigureer van basiese instellings
- Die kies van 'n tema
...
- Meer buigsame, agent-geleide opstelling
- Beter tema-aanpasopties
...
|---------|------------------------|------------------------|
| Opstelmetode | Wenner-vorm | Agent-gesprek |
| Tema-keuse | Voorgedefinieerde sjablone | Pasgemaakte generasie |
| Aanpassing | Beperkte opsies | Volledige ontwerpstelsel |
| Werf-brief | Nie gestoor nie | Permanente geheue |
...
1. Versoek: "Help me set up a new site"
2. Die Setup Assistant agent sal jou deur lei met:
   - Werfdoel en -doelwitte
   - Teikengehoor
   - Handelsmerk-identiteit
   - Tema-generasie
...
1. Jy kan dit soos is aanhou gebruik
2. Om die tema op te dateer, versoek: "Redesign my site"
...
1. Versoek: "Change my theme"
2. Die Setup Assistant agent sal:
   - Vra oor jou ontwerpvoorkeure
...
1. Kies 'n sjabloon
2. Kies 'n tema
3. Konfigureer basiese instellings
4. Klaar
```
...
2. Definieer jou teikengehoor
3. Kies ontwerpvoorkeure
4. Agent genereer pasgemaakte tema
5. Agent aktiveer tema
...
1. Versoek: "Help me set up a new site"
2. Beskryf die doel en ontwerp van jou oorspronklike werf
...
1. Kontroleer of jou tema steeds aktief is
2. Verifieer dat jou plugins ingeskakel is
...
- Jou bestaande werwe funksioneer aan
...
- **Site Specification Skill**: Definieer jou werfdoelwitte en -gehoor
- **Design System Aesthetics Skill**: Verfyn jou werf se visuele identiteit
