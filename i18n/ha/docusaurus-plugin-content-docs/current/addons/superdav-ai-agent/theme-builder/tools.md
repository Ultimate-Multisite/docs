...
- **Nazarin rukunin yanar gizo** — kwashe da nazartar rukunin yanar gizon masu fafatawa ko na ilhama
- **Ciro zane** — gano launuka, fonts, da tsarin shimfiɗa
- **Tsarin abun ciki** — fahimtar tsara shafi da matsayi
- **Gano fasali** — gano kari da ayyuka
- **Nazarin aiki** — duba saurin shafi da ingantawa
- **Nazarin SEO** — duba meta tags da bayanan da aka tsara

**Amfani:**

```
Nazari zanen example.com kuma yi amfani da shi a matsayin ilhama ga shafina.
```

**Abin da Yake Ciro:**

- Palet ɗin launi da amfani da launi
- Typography (fonts da girma)
- Tsarin shimfiɗa da tazara
- Tsarin kewayawa
- Tsara abun ciki
- Amfani da hotuna da kafofin watsa labarai
- Abubuwan mu'amala
- Dacewa da wayar hannu

**Iyakoki:**

- Ba zai iya kwashe shafukan da aka kare da kalmar sirri ba
- Yana girmama robots.txt da manufofin shafi
- Mai yiwuwa ba zai kama abun ciki mai canzawa ba
...
- Samar da CSS na musamman
- Ƙirƙirar animation
- Zanen abubuwan mu'amala
...
Iyawar aboki na Advanced na iya haɗawa da:

- **Kayan aikin tsarin fayil** — duba da gyara fayilolin da aka amince da su a muhallan amintattu
- **Kayan aikin database** — tambaya ko sabunta bayanan shafi idan an ba da izini a fili
- **Kayan aikin WP-CLI** — gudanar da umarnin kulawa da dubawa na WordPress
- **Kayan aikin mai rarraba REST** — kiran REST endpoints da aka yi rajista ta hanyoyin aikin dispatch masu sarrafawa
- **Kayan aikin ginin kari** — kafa tsari da yin maimaitawa kan lambar kari
- **Kayan aikin hoton Git** — ƙirƙirar hotuna kafin ayyukan masu haɓakawa masu haɗari
- **Kayan aikin sarrafa masu amfani** — taimakawa duba ko daidaita bayanan masu amfani inda aka yarda
- **Kayan aikin benchmark** — gudanar da benchmarks na aiki ko iyawa don bitar haɓakawa
...
1. Kewaya zuwa **Gratis AI Agent → Settings**
2. Je zuwa **Theme Builder → Tools**
...
- **Kwashe shafi** — yana buƙatar damar intanet
- **Analytics** — yana buƙatar haɗin Google Analytics
- **Samar da abun ciki** — yana buƙatar API keys
...
1. Je zuwa **Gratis AI Agent → Settings → API Keys**
2. Shigar da shaidun shiga ga kowane kayan aiki
3. Gwada haɗi
4. Ajiye cikin tsaro
...
```
Nazari zanen shafin mai fafatawa da ni a competitor.com
...
```
Ciro palet ɗin launi daga example.com kuma yi amfani da shi a matsayin ilhama.
```

```
Nazari tsarin kewayawa na example.com kuma aiwatar da irin wannan
tsari ga shafina.
```

```
Duba dacewar example.com da wayar hannu kuma tabbatar shafina
...
```
Kwatanta zanen site1.com da site2.com kuma ƙirƙiri zane
...
- Yi amfani da nazari don samun wahayi, ba kwafi ba
...
3. **Ciro launuka** — yi amfani da rukunin launuka a matsayin wuraren farawa
...
3. **Tabbatar da haƙƙoƙi** — tabbatar za ka iya amfani da abun ciki da aka ciro
...
3. **Saita tsammani** — bayyana burin ƙirarka
...
- [Menus na Hospitality](./hospitality-menus.md) — ƙirƙiri shafukan menu
