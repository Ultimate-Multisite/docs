...
- **Launin farko** — babban launin brand da ake amfani da shi don maɓallai, links, da ƙarin ado
- **Launin na biyu** — launi mai dacewa don bambanci
- **Launin accent** — launin haskakawa don muhimman abubuwa
...
- **Font na heading** — ana amfani da shi don taken shafuka da headings na sashe
- **Font na body** — ana amfani da shi don rubutun sakin layi da abun ciki
- **Girman font** — girma mai amsawa don girman allo daban-daban
...
- Cikakken menu na navigation
- Cikakken layout tare da dukkan ginshiƙai
...
- Navigation mai amsawa (hamburger menu)
- Layout na ginshiƙi ɗaya
...
| Na'ura | Faɗi | Preview |
|--------|-------|---------|
| **Mobile** | 375px | Wayar tsaye |
| **Tablet** | 768px | Tablet a kwance |
...
1. **Daidaita launuka** — canza kowane launi a cikin palette
2. **Canza fonts** — zaɓi typefaces daban-daban
3. **Gyara tazara** — daidaita padding da margins
...
- Preview na desktop yana sabuntawa nan take
- Preview na mobile yana sabuntawa nan take
...
- **Zane na asali** — ga abin da ya canza
...
1. **Duba previews biyu** — tabbatar desktop da mobile suna da kyau
2. **Duba duk launuka** — tabbatar da contrast da accessibility
3. **Gwada typography** — tabbatar da sauƙin karantawa a duk girma
...
1. Theme Builder yana samar da cikakken theme ɗinka
2. Ana shigar da theme a shafin WordPress ɗinka
...
- **Tabbatar da contrast** — yi amfani da [Validate Palette Contrast](../abilities/validate-palette-contrast.md) don accessibility
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — duba accessibility na launi
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — ƙirƙiri logos na musamman
