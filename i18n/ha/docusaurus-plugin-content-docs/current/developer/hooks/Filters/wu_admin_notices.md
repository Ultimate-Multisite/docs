...
| Suna | Nau'i | Bayani |
|------|------|-------------|
| $notices | `array` | Jerin sanarwa na wannan takamaiman panel. |
| $all_notices | `array` | Jerin sanarwar da aka ƙara, an raba su bisa panel. |
| $panel | `string` | Panel don dawo da sanarwar. |
