...
## Shawara ta Shiga Yanayi (Setup Instructions)

### 1. Samu Bayan Aiki na GridPane API
...
### 2. Samu ID na Server da Site ɗinka
...
### 3. Tambaya Constants zuwa wp-config.php
...
### 4. Shigar Yanayi (Enable the Integration)
