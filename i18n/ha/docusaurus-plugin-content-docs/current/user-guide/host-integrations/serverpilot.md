...
### 1. Samu Bayan Aiki (Credentials) na ServerPilot
...
### 2. Samu Bayan Aiki (App ID) na Kake
...
### 3. Ka Tambaya Bayan Aiki (Constants) zuwa wp-config.php
...
### 4. Shiga Haɗin Kai (Enable the Integration)
...
### Daidaitawa na Domain-saukar (Domain Syncing)
