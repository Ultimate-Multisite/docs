...
## هەنگاو 2: پێکهاتەی تۆڕ (Network Configuration)

ئەم هەنگاوە داوا دەکات کە ڕێکخستنی تایبەتمەندی تۆڕیەکەت بکەیت.

### پێکهاتەی سایت (Site Structure)
...
### Labalin Yanar Gizo (Network Title)
...
### Imelin Gudanar da Network Admin Email
...
## Mataki 3: Shigarwa (Installation)
...
## Shigar da Wajen Gaba (Manual Setup Fallback)
...
### Wajen gaba ya ce ba za rubuta cikin wp-config.php ba
...
### Ba za a samu damar shiga bayan an kammala shigarwa (subdomains)
...
### Matsalolin tabbatarwa bayan an kammala shigarwa
...
### Wata matalau ta yi nasara bayan an shigarwa
