...
## Gudanar da wuri (Hosting provider) {#hosting-provider}
...
## Subdomain (Wurin Shafi na Sauyi) {#subdomain}
...
## Subdirectory (Wurin Shafi na Lokaci) {#subdirectory}
...
## فرم تسویه حساب (Checkout Form) {#checkout-form}
