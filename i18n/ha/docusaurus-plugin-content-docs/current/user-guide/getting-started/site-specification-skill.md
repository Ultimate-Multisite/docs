---
title: Tsarin Wurin Gida Kwarewa
sidebar_position: 18
...
- **هدف سایت (Site purpose)**: سایت شما چه کاری انجام می‌دهد و چرا وجود دارد
- **مخاطب هدف (Target audience)**: چه کسانی از سایت شما بازدید می‌کنند و به چه چیزی نیاز دارند
- **هویت برند (Brand identity)**: رنگ‌ها، لحن و سبک بصری شما
- **اهداف تجاری (Business goals)**: موفقیت برای سایت شما چگونه به نظر می‌رسد
- **ساختار محتوا (Content structure)**: سایت شما چگونه سازماندهی شده است
...
- توصیه ساختارهای محتوایی که با اهداف شما مطابقت دارد
...
```
"Bari mu tsara bayanan gidan ko ina?"
```
...
```
Mene shi ne babban dalilin gidan ku?
- Kasuwancin sayarwa (E-commerce store)
- Blog ko wuri na bayanai (Blog or content site)
- Bayan tafiya ko nuna abubuwa (Portfolio or showcase)
- Wannan manhaja ta sabis (SaaS application)
- Alaka ko wuri na tattaunawa (Community or forum)
- Wani abu: [bayyana]
```
...
- Masu amfani / al'umma ta gaba (Consumers / general public)
- Mai kasuwanci (Business professionals)
- Masu gina manhajoji / masu amfani na fasaha (Developers / technical users)
- Makarantar su / malaman (Students / educators)
- Wani abu: [bayyana]
...
- Launi na farko: [wanda kake zaɓa ko code na hex]
- Launi na biyu: [wanda kake zaɓa ko code na hex]
- Launi na ƙarfafa (Accent color): [ko akwai]

Yaya za ka bayyana yanayin kimiyyar gidan ku?
- Mai kasuwanci / na kamfani (Professional / corporate)
- Mai ƙwarewa / fasaha (Creative / artistic)
- Mai wasa / mai sauƙi (Playful / casual)
- Mai sauƙi / zamani (Minimal / modern)
...
- Samar da masu neman aiki (Generate leads)
- Sayar da kayayyaki (Sell products)
- Gina alaka (Build community)
- Bayar da ilimi (Share knowledge)
- Gina amincewa (Establish authority)
- Wani abu: [bayyana]

Mene ne ma'aunin ku na farko?
- Kasuwanci (Revenue)
- Shirye-shiryen masu amfani (User engagement)
- Ilimi da aka samu a kan abubuwa (Content reach)
- Samar da ayyuka (Conversions)
- Wani abu
```
...
- Sauƙi (daga wuri ɗaya kowa) (Flat (all content at same level))
- Matsayin gaba da ƙasa (Categories and subcategories) (Hierarchical)
- Da farko zuwa ƙarshe (blog-style) (Chronological)
- Daga kayayyaki (catalog) (Product-based)
- Wani abu: [bayyana]

Wane nau'ikan abubuwa kake amfani da su?
- Labarai na blog (Blog posts)
- Shafin kayayyaki (Product pages)
- Bincike na rayuwa (Case studies)
- Bayan tafiya (Documentation)
- Bidiyo (Videos)
- Wani abu
```
...
- "ما متخصصانی را هدف قرار می‌دهیم که کیفیت را بر قیمت ترجیح می‌دهند"
...
شما همچنین می‌توانید اگر بخواهید:

- مشخصات سایت خود را بعد از تنظیم اولیه اصلاح کنید
...
- از نماینده بخواهید "خلاصه سایت من" را یادآوری کند (recall my site brief)
- بررسی کنید که آیا حافظه در تنظیمات شما فعال است یا خیر

**Ina fara da wani site\_brief na sabon**
- Yi tambayar agent: "Clear my site brief and start fresh" (Safi da tsarin site ɗin da na yi kuma fara daga farawa)
- Sannan gudanar da Site Specification sake

**Agent yana ba shawarwari da ba su dace da site\_brief ɗin na**
- Yi tambayar agent: "review my site brief" (Bincika site\_brief ɗin na)
...
1. **Yi Amfani da Theme Builder**: Ka samar da wani theme na musamman (custom theme) bisa ga site\_brief ɗin ka
2. **Gyara Zane (Design)**: Yi amfani da ƙwarewar Design System Aesthetics don aikin zane mai zurfi
3. **Tsara Abubuwan da Za su Yi (Plan Content)**: Ka tambaye agents don shawarwari kan yadda za a tsara abubuwan da za su kasance a cikin site
4. **Gina Abubuwa (Build Features)**: Ka buƙaci ƙarin abubuwa masu dacewa da burin kasuwancinka
