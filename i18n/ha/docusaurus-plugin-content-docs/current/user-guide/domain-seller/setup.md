...
### مرحله ۴ — وارد کردن TLDها (Top-Level Domains)
...
## تنظیم مجدد یک ارائه‌دهنده (Reconfiguring a provider)
...
### Idan ka ƙara wani mai samarwa na biyu
...
### Gudanar da TLD-suka kai (Syncing TLDs manually)
...
## Bayanai game da ikon masu samarwa (Provider capability notes)
