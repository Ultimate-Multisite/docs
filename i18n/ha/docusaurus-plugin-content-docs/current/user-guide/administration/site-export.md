...
### Sarar Haɗin Dukan Gida (Network Import Bundles)
...
#### Samar da Network Import Bundle
...
#### Wararewa daga Network Import Bundle
...
## Shigar ZIP na export wanda ke bi kansa (self-booting)
