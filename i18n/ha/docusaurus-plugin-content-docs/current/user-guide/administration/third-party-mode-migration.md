...
### حالت خودکار (Auto Mode) (پیش‌فرض جدید)
...
## Amfanin Auto Mode (Tsarin Awtomatiki)

### Samun Abubuwa Ta Awtomatiki (Automatic Discovery)
...
### Haɗin Kai Na Gaskiya (Native Integration)
...
### Gabaɗaya Maida Mene (Simplified Management)
...
### Inganci Na Aiki (Better Performance)
...
## Hanya Na Canza Tsarin (Migration Path)

### Idan Kake Amfani da WordPress 6.x
...
### Idan Kake Amfani da WordPress 7.0+
...
### Abubuwan da ake iya yi ba suke shiga a auto mode
...
### Ina so in ci gaba da legacy mode
...
### Iyakinsu ba abubuwan da na musamman ba su bayyana
...
### Ina samun saƙonnin "ability" ba a tsarshewa
...
## Compatibility na baya (Backward Compatibility)

### Tsarin da ya kasance da wuri (Existing Configurations)
...
### Lokacin da ake canza (Deprecation Timeline)
...
## Amfani da hanyoyin da suka fi kyau (Best Practices)
...
### Don installan da suka kasance a wurin
...
## Matakan da suka wuce (Next Steps)
