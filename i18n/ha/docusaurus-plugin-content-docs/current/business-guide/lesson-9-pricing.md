---
title: 'Darasi na 9: Tsara Farashi don Samun Riba'
sidebar_position: 10
...
- Gidan yanar gizo na fitness na ƙwararru wanda zai iya cin $2,000-$5,000 idan an gina shi na musamman
- Kulawa mai gudana, sabuntawa, da tsaro da ba sai sun damu da su ba
- Fasaloli na musamman ga niche waɗanda masu gini na gama-gari ba sa bayarwa
- Amincewar dandamali da aka gina don masana'antarsu
...
- **Hayar web developer**: $2,000-$5,000 a gaba + $50-$100/wata don kulawa
- **Wix/Squarespace**: $16-$45/wata amma babu fasalolin musamman na fitness, su ne za su gina shi da kansu
- **Rashin yin komai**: Rasa mambobi waɗanda ba za su iya samun su a yanar gizo ba
...
| Tsari | Wata-wata | Shekara-shekara (a wata) | Jimillar Shekara | Tanadi |
|------|---------|-------------------|--------------|---------|
| Starter | $49/wata | $39/wata | $468/shekara | rangwamen 20% |
| Growth | $99/wata | $79/wata | $948/shekara | rangwamen 20% |
| Pro | $199/wata | $159/wata | $1,908/shekara | rangwamen 20% |
...
- **Starter**: Babu kuɗin saitawa (cire shingen shiga)
- **Growth**: Kuɗin saitawa $99 (yana rufe daidaita custom domain da shawarar farko)
- **Pro**: Kuɗin saitawa $299 (yana rufe saitin wurare da yawa da kiran onboarding)
...
- **Gwajin kyauta na kwanaki 7** a kan tsarIn Starter kaɗai
- Babu gwaji a kan Growth da Pro (waɗannan abokan ciniki sun fi sadaukarwa kuma suna tsammanin biya)
...
- **FITLAUNCH** -- rangwamen 30% na watanni 3 na farko (don tallan ƙaddamarwa)
- **ANNUAL20** -- rangwamen 20% a kan tsare-tsaren shekara-shekara (idan ba a riga an yi rangwame ba)
- **REFERRAL** -- wata 1 kyauta (don turawar abokan ciniki)

Je zuwa **Ultimate Multisite > Lambobin Rangwame** don ƙirƙirar waɗannan. Duba [Ƙirƙirar Lambobin Rangwame](/user-guide/configuration/creating-discount-codes) don cikakken jagora.

:::tip Kada Ka Yi Rangwame ta Tsohuwa
...
1. Daidaita ƙimar haraji a **Ultimate Multisite > Settings > Taxes**
2. Aiwatar da rukunonin haraji ga tsare-tsarenka
3. Tabbatar da cewa takardun invoice suna nuna haraji daidai
...
- **Ƙimar juyawa ta tsari**: Idan Starter yana juyawa sosai amma Growth ba ya yi, tazarar da ke tsakaninsu na iya yin yawa
- **Ƙimar haɓakawa**: Idan ƙalilan ne ke haɓaka daga Starter zuwa Growth, tsarIn Growth na iya rashin isasshiyar ƙarin ƙima
...
├── Ultimate Multisite (an daidaita + an yi alama)
├── Domain na Dandamali (fitsite.com + wildcard SSL)
├── Samfuran Shafi (Studio Essential, Gym Pro, Fitness Chain)
├── Products
│   ├── FitSite Starter ($49/wata ko $468/shekara) + gwajin kwanaki 7
│   ├── FitSite Growth ($99/wata ko $948/shekara) + kuɗin saitawa $99
│   ├── FitSite Pro ($199/wata ko $1,908/shekara) + kuɗin saitawa $299
│   └── Order Bumps + Lambobin Rangwame
├── Gudanar Kammala Saye (tare da maɓallin zaɓin lokaci)
├── Alama (login, dashboard, imel, invoices, shafin talla)
├── Onboarding na Abokin Ciniki (Quick Start, imel, albarkatun taimako)
├── Dabarar Farashi
│   ├── Rangwamen shekara-shekara (rangwamen 20%)
│   ├── Kuɗin saitawa na dabara
│   ├── Gwajin kwanaki 7 a kan Starter
│   ├── Lambobin rangwame don kamfen da turawa
│   └── Daidaitawar haraji
...
- **Lokacin gwaji** a shirin matakin farko don rage cikas wajen yin rajista
- **Lambobin rangwame na dabaru** don ƙaddamarwa, turawa, da kamfe-kamfe
- **Saitin haraji** don lissafin kuɗi mai bin ƙa'ida
- **Tsarin bitar farashi** don ingantawa mai gudana

---

**Na gaba:** [Darasi na 10: Ranar Ƙaddamarwa](lesson-10-launch) -- jerin abubuwan dubawa kafin ƙaddamarwa da fara aiki.
