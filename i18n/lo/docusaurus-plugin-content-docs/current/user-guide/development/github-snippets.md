...
# ວິທີเพิ่ม snippet ในไฟล์ functions.php ของธีมคุณ {#how-to-add-the-snippet-on-your-themes-functionsphp-file}
...
# ວິທີสร้าง Must-Use Plugins (mu-plugins) {#how-to-create-must-use-plugins-mu-plugins}
