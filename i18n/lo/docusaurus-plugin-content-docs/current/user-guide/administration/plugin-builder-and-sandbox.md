...
## ການສ້າງ Plugin ຜ່ານ AI (Generating a Plugin via AI)
...
## ການຕັ້ງຄ່າ Sandbox (Sandbox Activation)
...
## ການຈັດການ Plugin ທີ່ສ້າງຂຶ້ນມາ (Generated Plugins)
...
## ການຕິດຕັ້ງ Plugin ທີ່ສ້າງຂຶ້ນມາໃສ່ເຄືອຂ່າຍ (Network)
