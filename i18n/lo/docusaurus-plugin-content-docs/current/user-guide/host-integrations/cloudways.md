...
### 1. ເອົາຂໍ້ມູນ API ຂອງ Cloudways ຂອງທ່ານ
...
### 2. ເອົາ Server ID ແລະ Application ID ຂອງທ່ານ
...
### 4. ຕັ້ງຄ່າການເຊື່ອມຕໍ່ (Enable the Integration)
...
### ການđồng bộ Domain (Domain Syncing)
...
### ການຈັດການใบรับรอง SSL (SSL Certificate Management)
...
## สำคัญ — ข้อควรระวังเกี่ยวกับ Wildcard SSL
