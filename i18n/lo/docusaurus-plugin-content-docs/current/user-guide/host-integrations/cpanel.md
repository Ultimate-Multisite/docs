...
---
# การเชื่อมต่อกับ cPanel {#cpanel-integration}
...
### 1. รับข้อมูลประจำตัว cPanel ของคุณ {#1-get-your-cpanel-credentials}
...
### 3. เปิดใช้งานการเชื่อมต่อ {#3-enable-the-integration}
...
## ข้อควรระวังที่สำคัญ {#important-notes}
...
### โดเมนไม่ถูกเพิ่ม (Domain Not Added) {#domain-not-added}
...
### ปัญหาเกี่ยวกับใบรับรอง SSL (SSL Certificate Issues) {#ssl-certificate-issues}
