...
### 1. รับข้อมูล API ของ ServerPilot ของคุณ {#1-get-your-serverpilot-api-credentials}
...
## ການກວດສອບໃບຢັ້ງຢືນ SSL (SSL Certificate Verification) {#ssl-certificate-verification}
...
### ໂດເມນບໍ່ໄດ້ຖືກເພີ່ມເຂົ້າໄປ (Domain Not Added) {#domain-not-added}
...
### การลบโดเมน (Domain Removal) {#domain-removal}
