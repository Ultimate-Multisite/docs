...
### 1. ດຶງເອົາ Cloudflare API Key ຂອງທ່ານ
...
### ມັນແຕກຕ່າງຈາກການເຊື່ອມຕໍ່ Cloudflare ປົກກະຕິແນວໃດ
...
### ການຕັ້ງຄ່າ Cloudflare Custom Hostnames
