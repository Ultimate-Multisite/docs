...
### ສ່ວນ Pricing Table (ຕາຕະລາງລາຄາ)
...
#### ຂັ້ນຕອນທີ 1: ຕັ້ງຄ່າ Price Variations ໃນຜະລິດຕະພັນຂອງທ່ານ
...
#### ຂັ້ນຕອນທີ 2: ເພີ່ມຊ່ອງ Period Selection ໃນແບບຟອມ checkout ຂອງທ່ານ
...
#### ขั้นตอนที่ 3: จัดตำแหน่งฟิลด์ให้อยู่เหนือตารางราคา
...
#### มันทำงานอย่างไรบนหน้าบ้าน (Frontend)
...
#### การเลือกช่วงเวลาเรียกเก็บเงินล่วงหน้าผ่าน URL
