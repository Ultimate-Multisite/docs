...
### ການໃຫ້ສິດໃນຖານະ Database ບໍ່ກົງກັບ host
...
### ການຕິດຕັ້ງ Bedrock ຫຼື local socket ບໍ່ສາມາດເຊື່ອມຕໍ່ໄດ້
...
### Async push queue ບໍ່ສາມາດດູດຂໍ້ມູນອອກໄດ້
...
## ເມື່ອໃດຄວນລອງໃໝ່ (When to retry)
