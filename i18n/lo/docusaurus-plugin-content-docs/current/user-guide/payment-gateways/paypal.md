...
## ການເປີດໃຊ້ PayPal ໃນເຄືອຂ່າຍຂອງທ່ານ {#enabling-paypal-on-your-network}
...
## การรับข้อมูล API ของ PayPal (Getting the PayPal API credentials) {#getting-the-paypal-api-credentials}
