...
## ကြိုတင်ပြင်ဆင်မှုများ (Prerequisites)
...
## အဆင့် ၂: Network Configuration (Network စနစ်ဖွဲ့စည်းမှု)

ဒီအဆင့်က သင့်ရဲ့ network settings တွေကို ဘယ်လို စီစဉ်မလဲဆိုတာ မေးပါလိမ့်မယ်။

### Site Structure (Site ဖွဲ့စည်းပုံ)
...
### ອີເມວຜູ້ບໍລິຫານເຄືອຂ່າຍ (Network Admin Email)
...
## ຂັ້ນຕອນທີ 3: ການຕິດຕັ້ງ (Installation)
...
## การตั้งค่าสำรองด้วยตนเอง (Manual Setup Fallback)
...
### wizard บอกว่า wp-config.php เขียนไม่ได้ (is not writable)
...
### เว็บไซต์เข้าไม่ได้หลังตั้งค่า (subdomains)
...
### ปัญหาการยืนยันตัวตนหลังตั้งค่า
...
### ขั้นตอนใดขั้นตอนหนึ่งล้มเหลวระหว่างการติดตั้ง
