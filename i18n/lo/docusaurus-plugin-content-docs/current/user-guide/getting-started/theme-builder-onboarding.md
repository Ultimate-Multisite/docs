...
## กระบวนการเริ่มต้นใช้งาน Theme Builder คืออะไร?
...
## การเริ่มต้น Theme Builder Onboarding
...
### ขั้นตอนที่ 3: การตัดสินใจเกี่ยวกับ Design System
...
### ขั้นตอนที่ 5: การเปิดใช้งานและการตรวจสอบ
...
## ข้อกำหนดของเว็บไซต์และหน่วยความจำ site_brief
...
### การดูสรุปข้อมูลเว็บไซต์ของคุณ (Viewing Your site_brief)
...
## การปรับแต่งหลังจากตั้งค่าเสร็จสิ้น (Customizing After Onboarding)

หลังจากที่การตั้งค่า Theme Builder เสร็จสมบูรณ์แล้ว คุณสามารถทำสิ่งเหล่านี้ได้:

### ใช้ทักษะด้านความสวยงามของ Design System (Use the Design System Aesthetics Skill)
...
### แก้ไขไฟล์ theme.json โดยตรง (Edit theme.json Directly)
...
### สร้างแม่แบบบล็อกที่กำหนดเอง (Create Custom Block Templates)
...
## การเปรียบเทียบ: แบบเก่ากับแบบใหม่ในการตั้งค่า (Comparison: Old vs. New Onboarding)
