...
## ការតំឡើងលើកដំបូង (First-run setup wizard)
...
### ขั้นตอนที่ 4 — นำเข้า TLDs (Top-Level Domains)
...
## บันทึกความสามารถของผู้ให้บริการ (Provider capability notes)
