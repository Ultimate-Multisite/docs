...
---
# ການປະສານງານຕົວສ້າງເວັບໄຊ v2 {#site-builder-orchestration-v2}
...
### 1. ການສ້າງແຜນ {#1-plan-generation}
...
### 2. ການຄົ້ນຫາປລັກອິນ {#2-plugin-discovery}
...
### 3. ການດຳເນີນການແຜນ {#3-plan-execution}
...
### 4. ການຕິດຕາມຄວາມຄືບໜ້າ {#4-progress-tracking}
...
### 5. ການຟື້ນຕົວຈາກຂໍ້ຜິດພາດ {#5-error-recovery}
...
## ຄວາມສາມາດຂອງແຜນເວັບໄຊ {#site-plan-abilities}
...
## ການປຽບທຽບ v1 ແລະ v2 {#comparing-v1-and-v2}
...
## ຄຳສັ່ງແຜນ WP-CLI {#wp-cli-plan-commands}
