...
---
# ຄວາມສາມາດໃນການຈັດການປລັກອິນ {#plugin-management-abilities}
...
## ພາບລວມຄວາມສາມາດ {#abilities-overview}
...
## API ຕົວຕິດຕັ້ງປລັກອິນ {#plugin-installer-api}
...
### ການລົງທະບຽນຕົວຈັດການການຕິດຕັ້ງແບບກຳນົດເອງ {#registering-a-custom-install-handler}
...
## ທະບຽນລະບົບນິເວດ {#ecosystem-registry}
...
## ການຜະສານກັບ HookScanner {#hookscanner-integration}
...
## ສະຖາປັດຕະຍະກຳງານ Async {#async-job-architecture}
