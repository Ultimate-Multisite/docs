...
---
# ການສ້າງການເຊື່ອມຕໍ່ Registrar ແບບກຳນົດເອງ {#building-a-custom-registrar-integration}
...
### Methods ທາງເລືອກ {#optional-methods}
...
### ຂໍ້ຕົກລົງຄ່າທີ່ສົ່ງກັບ {#return-value-convention}
...
## ການລົງທະບຽນ capability ຂອງທ່ານ {#registering-your-capability}
...
## ການເພີ່ມຊ່ອງຂໍ້ມູນ credential ໃສ່ wizard {#adding-credential-fields-to-the-wizard}
...
## Hooks ສຳລັບການກະທຳຫຼັງການລົງທະບຽນ {#hooks-for-post-registration-actions}
