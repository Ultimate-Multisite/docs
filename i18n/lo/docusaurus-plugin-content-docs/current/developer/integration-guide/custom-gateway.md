...
---
# ການພັດທະນາ Gateway ແບບກຳນົດເອງ {#custom-gateway-development}

ທ່ານສາມາດສ້າງ gateway ການຊຳລະເງິນແບບກຳນົດເອງໄດ້ໂດຍຂະຫຍາຍ class `Base_Gateway`.

## Class ຂອງ Gateway {#gateway-class}
...
## ລົງທະບຽນ Gateway {#register-the-gateway}
...
## ຂໍ້ມູນຢືນຢັນການຕໍ່ອາຍຸສຳລັບ membership ແບບເກີດຊ້ຳ {#renewal-credentials-for-recurring-memberships}
...
## ຄວາມສາມາດຂອງຜູ້ໃຫ້ບໍລິການ connector AI {#ai-connector-provider-capabilities}
