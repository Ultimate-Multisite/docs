---
title: ເລີ່ມຕົ້ນກັບການພັດທະນາສ່ວນເສີມ
sidebar_position: 1
_i18n_hash: 9e377a4aa16c5d3b119fbd631cb6126e
---
# ການພັດທະນາສ່ວນເສີມ {#addon-development}

## ໂຄງສ້າງສ່ວນເສີມ {#addon-structure}
...
## ແມ່ແບບໄຟລ໌ຫຼັກຂອງສ່ວນເສີມ {#main-addon-file-template}
...
## ຕົວຢ່າງແບບຈຳລອງກຳນົດເອງ {#custom-model-example}
...
## ການຜະສານໜ້າ Admin {#admin-page-integration}
...
## ການທົດສອບ Addon ຂອງທ່ານ {#testing-your-addon}
...
## ຈຸດຂະຫຍາຍຂອງ v2.13.0 {#v2130-extension-points}

Ultimate Multisite v2.13.0 ເພີ່ມຈຸດຂະຫຍາຍຫຼາຍຈຸດ ທີ່ເປັນປະໂຫຍດສຳລັບ addon ທີ່ຜະສານກັບ tenant ແບບມີອະທິປະໄຕ, ໂດເມນ checkout, ຫຼືການອັດຕະໂນມັດ DNS ຂອງຜູ້ໃຫ້ບໍລິການໂຮສ.

### URL ສຳລັບ SSO ແລະການຈັດການ site ຫຼັກ {#sso-and-main-site-management-urls}
...
### ໂດເມນຖານຂອງແບບຟອມ checkout {#checkout-form-base-domains}

ໃຊ້ `wu_checkout_form_base_domains` ເມື່ອ addon ຂອງທ່ານໃຫ້ໂດເມນຖານຮ່ວມເພີ່ມເຕີມ ທີ່ຄວນປະພຶດຄືກັບໂດເມນ **Site URL** ຂອງແບບຟອມ checkout ແທນການ map ແບບກຳນົດເອງຕໍ່ site:
...
Ultimate Multisite ປັບ host ເຫຼົ່ານີ້ໃຫ້ເປັນມາດຕະຖານ ແລະຂ້າມ record ໂດເມນທີ່ map ຕໍ່ site ອັດຕະໂນມັດສຳລັບພວກມັນ.

### ການສ້າງ record ໂດເມນອັດຕະໂນມັດ {#automatic-domain-record-creation}

ໃຊ້ `wu_should_create_domain_record_for_site` ເມື່ອ addon ຂອງທ່ານຕ້ອງການຢັບຢັ້ງ ຫຼືເລື່ອນການສ້າງ record ໂດເມນອັດຕະໂນມັດສຳລັບ site ທີ່ສ້າງໃໝ່:
...
ການຜະສານກັບຜູ້ໃຫ້ບໍລິການໂຮສທີ່ຟັງ `wu_add_subdomain` ສາມາດສ້າງ record DNS ຝັ່ງຜູ້ໃຫ້ບໍລິການເມື່ອ site ຖືກສ້າງ. ຖ້າບໍ່ມີການຜະສານໃດຖືກລົງທະບຽນສຳລັບ action ນັ້ນ, Ultimate Multisite ຈະຂ້າມ background job ທີ່ວ່າງເປົ່າ.

## ຂັ້ນຕອນຕໍ່ໄປ {#next-steps}

- ທົບທວນ [ອ້າງອີງ Hooks](/developer/hooks) ສຳລັບ actions ແລະ filters ທີ່ມີຢູ່
- ກວດເບິ່ງ [ພາບລວມ REST API](/developer/rest-api/overview) ສຳລັບການຜະສານ API
- ໃຊ້ [Addon Template](/addons/addon-template) ເປັນ scaffold ເລີ່ມຕົ້ນ
