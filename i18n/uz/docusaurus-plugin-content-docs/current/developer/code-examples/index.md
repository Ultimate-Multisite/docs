...
Bir vaqtdagi ikki so‘rov bir xil qiymatni o‘qib, ikkalasi ham bir xil oshirilgan natijani qayta yozishi mumkin, natijada bitta hisob yo‘qoladi. `increment_item()` arifmetikani yagona `UPDATE ... SET column = column + ?` bayonoti bilan ma’lumotlar bazasi dvigateliga topshiradi, bu esa operatsiyani tabiatan atomik qiladi.
