...
- **Asosiy rang** — tugmalar, havolalar va urg‘ular uchun ishlatiladigan asosiy brend rangi
- **Ikkilamchi rang** — xilma-xillik uchun qo‘shimcha rang
- **Urg‘u rangi** — muhim elementlarni ajratib ko‘rsatish rangi
...
- **Sarlavha shrifti** — sahifa sarlavhalari va bo‘lim sarlavhalari uchun ishlatiladi
- **Asosiy matn shrifti** — paragraf matni va kontent uchun ishlatiladi
- **Shrift o‘lchamlari** — turli ekran o‘lchamlari uchun moslashuvchan o‘lchamlar
...
- **Ikonkalar** — ikonka uslubi va o‘lchami
...
- Barcha ustunlar bilan to‘liq joylashuv
...
- Moslashuvchan navigatsiya (hamburger menyu)
- Bir ustunli joylashuv
...
| Qurilma | Kenglik | Oldindan ko‘rish |
|--------|-------|---------|
| **Mobil** | 375px | Vertikal telefon |
| **Planshet** | 768px | Gorizontal planshet |
...
1. **Ranglarni moslashtirish** — palitradagi istalgan rangni o‘zgartirish
2. **Shriftlarni o‘zgartirish** — boshqa shrift turlarini tanlash
3. **Oraliqlarni o‘zgartirish** — ichki va tashqi oraliqlarni moslashtirish
...
- Desktop oldindan ko‘rish darhol yangilanadi
- Mobil oldindan ko‘rish darhol yangilanadi
...
- **Asl dizayn** — nimalar o‘zgarganini ko‘ring
...
1. **Ikkala oldindan ko‘rishni ko‘rib chiqing** — desktop va mobil yaxshi ko‘rinishini tekshiring
2. **Barcha ranglarni tekshiring** — kontrast va accessibility talablariga mosligini ta’minlang
3. **Tipografiyani sinang** — barcha o‘lchamlarda o‘qilishi qulayligini tekshiring
...
1. Theme Builder to‘liq mavzuyingizni yaratadi
2. Mavzu WordPress saytingizga o‘rnatiladi
...
- **Kontrastni tekshiring** — accessibility uchun [Palitra kontrastini tekshirish](../abilities/validate-palette-contrast.md) dan foydalaning
...
- [Palitra kontrastini tekshirish](../abilities/validate-palette-contrast.md) — rang accessibilitysini tekshirish
- [Logo SVG yaratish](../abilities/generate-logo-svg.md) — maxsus logotiplar yaratish
