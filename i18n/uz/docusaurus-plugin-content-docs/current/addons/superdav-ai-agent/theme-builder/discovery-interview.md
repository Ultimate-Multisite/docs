...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Fotosuratlar uchun tavsiya etiladi |
| **PNG** | `.png` | Shaffoflikni qo'llab-quvvatlaydi |
...
- **Rang palitrasi** — ustun ranglar ajratib olinadi va theme ichida ishlatiladi
- **Vizual uslub** — zamonaviy, rustik, minimalist, yorqin va h.k.
- **Kayfiyat va muhit** — professional, ijodiy, do'stona, hashamatli va h.k.
...
- **Kayfiyat doskalari** — xohlagan estetikangizni ifodalovchi tasvirlar to'plamlari
- **Mahsulot fotosuratlari** — agar namoyish qilish uchun mahsulotlaringiz bo'lsa
...
- **Matni ko'p tasvirlar** — ko'p matnli skrinshotlar
...
3. **Turli xillik kiriting** — rang, uslub va mavzu aralashmasi
...
- **Rang palitrasi** — asosiy, ikkilamchi va urg'u ranglar
- **Tipografiya** — sarlavhalar va asosiy matn uchun shrift oilalari
- **Maket uslubi** — oraliqlar, tekislash va komponent joylashuvi
...
1. Yaratilgan dizayn yo'nalishini ko'rib chiqing
2. Fikr-mulohaza bering yoki tuzatishlarni so'rang
...
- [Vositalar va konfiguratsiya](./tools.md) — mavjud vositalar va konfiguratsiya variantlari
