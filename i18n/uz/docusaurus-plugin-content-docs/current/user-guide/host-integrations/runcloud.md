...
---
# RunCloud Integratsiyasi {#runcloud-integration}
...
### 1. RunCloud API Ma'lumotlaringizni Oling {#1-get-your-runcloud-api-credentials}
...
### 2. Server va Ilova ID'laringizni Oling {#2-get-your-server-and-app-ids}
...
### 3. wp-config.phpga Konstanta Qo'shing {#3-add-constants-to-wp-configphp}
