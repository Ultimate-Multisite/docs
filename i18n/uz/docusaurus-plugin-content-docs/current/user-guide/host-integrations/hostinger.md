...
---
# Hostinger (hPanel) Integratsiyasi {#hostinger-hpanel-integration}
...
### 1. Hostinger API Tokeningizni Oling {#1-generate-your-hostinger-api-token}
...
### 2. Hisob ID'ingizni Toping {#2-find-your-account-id}
