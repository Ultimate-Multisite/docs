---
title: Sistem elektron xatlarni boshqarish
sidebar_position: 13
...
Ushbu sahifadan siz barcha shablonlarni ko'rish uchun **System Emails** (Tizim Elektron Xatlari) sahifasiga kirishingiz mumkin.

![System Emails list](/img/admin/system-emails-list.png)

Shuningdek, tizim elektron xatlari redaktori yordamida individual shablonlarni tahrirlashingiz mumkin:
...
Yangi elektron shablonlarni import qilish uchun:

1. **System Emails** sahifasiga o'ting
2. Sahifa yuqorisidagi **Reset & Import** tugmasini bosing
...
1. **O'chirish va qayta import qilish** — tizim elektron pochta (email)ni o'chirib tashlang va uni yana import qiling (bu yuborish metrikalarini o'chiradi).
2. **Asosiy sozlamalarni vosita orqali qayta tiklash** — **Reset & Import** vositasidan foydalaning, **Reset** opsiyasini yoqing va qayta tiklamoqchi bo'lgan elektron pochtalarni tanlang.

Reset (Qayta tiklash) opsiyasi afzaldir, chunki u yuborish metrikalarini va boshqa ma'lumotlarni saqlab qoladi va faqat standart kontentni tiklaydi.
