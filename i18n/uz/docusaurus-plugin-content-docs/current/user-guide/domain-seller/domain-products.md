...
### Qo'llab-quvvatlanadigan TLDlar (Supported TLDs)
...
### Kirish narxi (Introductory pricing)

### WHOIS maxfiyligi (WHOIS privacy)
...
## Avtomatik yangilash (Auto-renewal)
...
## Admin: Domenni qo'lda ro'yxatdan o'tkazish
