---
title: Ultimate Multisite-ni tarjima qilish
sidebar_position: 19
...
Bu standart WordPress jamoatchilik tarjima tizimidir. Tarjimalar yetarli tasdiqlash chegarasiga yetganida, ular WordPress plugin yangilanishlari orqali barcha Ultimate Multisite foydalanuvchilari uchun avtomatik ravishda taqsimlanadi.

**Bizga yordam kerak!** Agar siz inglizdan boshqa tilda gapiradigan tilni bilasiz, tarjima taklif qilishni ko'rib chiqing. Bir nechta satrni tarjima qilish ham yordam beradi. Boshlash uchun:

1. [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) saytiga tashlang
2. O'zingizning tilini tanlang
3. "Contribute Translation" (Tarjima kiritish) tugmasini bosing
4. Sizga bepul WordPress.org hisobiga ega bo'lish kerak
...
1. [poedit.net](https://poedit.net) saytidan Poeditni yuklab oling
2. `wp-content/plugins/ultimate-multisite/lang/` papkasidagi `.pot` faylini oching
3. Poedit interfeysida matnlarni tarjima qiling
