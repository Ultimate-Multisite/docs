...
---
# வடிவமைப்புக் குறிக்கோள் (Design Direction) {#design-direction}
...
## வடிவமைப்புக் குறிக்கோள் கூறுகள் (Design Direction Components) {#design-direction-components}

### 1. வண்ணத் தட்டு (Color Palette) {#1-color-palette}
...
### 2. எழுத்து வடிவம் (Typography) {#2-typography}
...
### 3. அமைப்பு மற்றும் இடைவெளி (Layout and Spacing) {#3-layout-and-spacing}
...
### 4. காட்சி அம்சங்கள் (Visual Elements) {#4-visual-elements}
...
## முன்னோட்ட ரெண்டரிங் (Preview Rendering) {#preview-rendering}

### டெஸ்க்டாப் முன்னோட்டம் (Desktop Preview) {#desktop-preview}
...
### மொபைல் முன்னோட்டம் (Mobile Preview) {#mobile-preview}
...
### எல்லா திரைகளுக்கும் ஏற்ற இடைவெளிகள் (Responsive Breakpoints) {#responsive-breakpoints}
...
## உங்கள் வடிவமைப்பை செம்மைப்படுத்துதல் (Refining Your Design) {#refining-your-design}

### மாற்றங்களைச் செய்தல் (Making Adjustments) {#making-adjustments}
...
### முன்னோட்ட புதுப்பிப்புகள் (Preview Updates) {#preview-updates}
...
### ஒப்பீட்டுப் பார்வை (Comparison View) {#comparison-view}
...
## வடிவமைப்புக் குறிக்கோள் ஒப்புதல் (Design Direction Approval) {#design-direction-approval}
...
### முன்னோட்டம் புதுப்பிக்கவில்லை (Preview Not Updating) {#preview-not-updating}
...
### வண்ணங்கள் வேறு மாதிரி தெரிகின்றன (Colors Look Different) {#colors-look-different}
...
### எழுத்து வடிவம் சிக்கல்கள் (Typography Issues) {#typography-issues}
