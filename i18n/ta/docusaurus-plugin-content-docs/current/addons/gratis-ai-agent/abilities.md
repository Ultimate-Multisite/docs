...
---
# திறன்கள் குறிப்பு {#abilities-reference}
...
## தனிப்பயன் பதிவு வகைகள் {#custom-post-types}
...
## தனிப்பயன் வகைப்பாடுகள் {#custom-taxonomies}
...
## உலகளாவிய பாணிகள் {#global-styles}
...
## விருப்பங்கள் மேலாண்மை {#options-management}
...
## காட்சி மதிப்பாய்வு {#visual-review}
