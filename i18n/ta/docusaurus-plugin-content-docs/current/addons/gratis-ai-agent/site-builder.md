...
### 1. திட்ட உருவாக்கம் (Plan Generation) {#1-plan-generation}
...
### 2. Plugin கண்டுபிடிப்பு (Plugin Discovery) {#2-plugin-discovery}
...
### 3. திட்டத்தை செயல்படுத்துதல் (Plan Execution) {#3-plan-execution}
...
### 4. முன்னேற்றத்தைக் கண்காணித்தல் (Progress Tracking) {#4-progress-tracking}
...
### 5. பிழை மீட்பு (Error Recovery) {#5-error-recovery}
...
## v1 மற்றும் v2 ஒப்பீடு {#comparing-v1-and-v2}
