...
## எப்போது பயன்படுத்த வேண்டும் {#when-to-use-it}
...
## கோப்பு பெயரிடும் முறை (File naming convention) {#file-naming-convention}
...
## கோப்பை எங்கு வைக்க வேண்டும் {#where-to-place-the-file}
...
## கிடைக்கும் Hooks மற்றும் Filters {#hooks-and-filters-available}
...
## குறைந்தபட்ச உதாரணம் (Minimal example) {#minimal-example}
