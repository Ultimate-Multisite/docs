...
---
# தனிப்பயன் பதிவாளர் ஒருங்கிணைப்பை உருவாக்குதல்
...
### விருப்பமான methods (Optional methods)
...
### திரும்பும் மதிப்பு மரபு (Return value convention)
...
## உங்கள் capability-ஐப் பதிவு செய்தல் (Registering your capability)
...
## wizard-ல் credential fields சேர்ப்பது (Adding credential fields to the wizard)
...
## post-registration actions க்கான Hooks
