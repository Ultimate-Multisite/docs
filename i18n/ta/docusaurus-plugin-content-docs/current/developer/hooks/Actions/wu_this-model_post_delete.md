...
ஒரு ஆப்ஜெக்ட் டேட்டாபேஸில் சேமிக்கப்பட்ட பிறகு இந்த action இயங்கும்.

## அளவுருக்கள் (Parameters) {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $result | `bool` | ஆப்ஜெக்ட் வெற்றிகரமாக நீக்கப்பட்டிருந்தால் `True` என்று இருக்கும். |
| $this | `\Base_Model` | ஆப்ஜெக்ட் இன்ஸ்டன்ஸ். |
