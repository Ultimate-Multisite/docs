...
## Zapier-ல் action உருவாக்குதல் {#creating-an-action-in-zapier}
...
### Action உருவாக்குதல் {#creating-an-action}
...
### முழுமையான endpoint parameters {#complete-endpoint-parameters}
