...
## Block Theme-ஐ உருவாக்குதல் (Scaffold Block Theme) {#scaffold-block-theme}
...
### எப்படிப் பயன்படுத்துவது (How to Invoke) {#how-to-invoke}
...
### எதிர்பார்க்கப்படும் வெளியீடு (Expected Output) {#expected-output}
...
### எதிர்பார்க்கப்படும் வெளியீடு (Expected Output) {#expected-output-1}
...
## செயல்முறை: Scaffold மற்றும் Activate {#workflow-scaffold-and-activate}
...
## Design Tokens மற்றும் தனிப்பயனாக்கம் (Customization) {#design-tokens-and-customization}
...
## வரம்புகள் மற்றும் குறிப்புகள் (Limitations and Notes) {#limitations-and-notes}
