...
### 2. wp-config.php-இல் மாறிலிகளைச் சேர்த்தல்
...
### 4. இணைப்பைச் சரிபார்த்தல் (Verify Connectivity)
...
### டொமைன் மேப்பிங் (Domain Mapping)
...
### மின்னஞ்சல் ஃபார்வர்டர்கள் (Email Forwarders)
...
## உள்ளமைவு குறிப்பு (Configuration Reference)
