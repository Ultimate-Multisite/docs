...
---
# WordPress Multisite என்றால் என்ன? {#what-is-wordpress-multisite}
...
## WordPress Multisite என்றால் சரியாக என்ன? {#what-exactly-is-wordpress-multisite}
...
## Subdomain அல்லது Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites இடையே என்ன பகிரப்படுகிறது, என்ன பகிரப்படவில்லை {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite-ல் பயனர் மேலாண்மை {#user-management-on-wordpress-multisite}
...
## செயல்திறன் பரிசீலனைகள் {#performance-considerations}
