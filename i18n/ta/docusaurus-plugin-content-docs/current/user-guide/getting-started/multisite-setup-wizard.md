...
## Wizard எப்போது தோன்றும்? {#when-does-the-wizard-appear}
...
## படி 2: Network Configuration {#step-2-network-configuration}

இந்த படிநிலையில் உங்கள் network settings-ஐ configure செய்யுமாறு கேட்கப்படும்.

### Site அமைப்பு {#site-structure}
...
## படி 3: Installation {#step-3-installation}
...
## படி 4: Complete {#step-4-complete}
...
### wp-config.php writable இல்லை என்று wizard கூறுகிறது {#the-wizard-says-wp-configphp-is-not-writable}
...
### Setup-க்குப் பின் Sites அணுக முடியவில்லை (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Setup-க்குப் பின் Authentication சிக்கல்கள் {#authentication-issues-after-setup}
...
### Installation போது ஒரு படி தோல்வியடைந்தது {#a-step-failed-during-installation}
