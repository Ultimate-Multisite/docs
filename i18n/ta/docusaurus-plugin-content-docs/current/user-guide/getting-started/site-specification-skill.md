...
## Site Specification என்றால் என்ன? {#what-is-site-specification}
...
## Site Specification-ஐ ஏன் பயன்படுத்த வேண்டும்? {#why-use-site-specification}

### அமர்வுகளுக்கு இடையேயான நிலைத்தன்மை (Consistency Across Sessions) {#consistency-across-sessions}
...
### சிறந்த பரிந்துரைகள் (Better Recommendations) {#better-recommendations}
...
### விரைவான கற்றல் (Faster Onboarding) {#faster-onboarding}
...
## Site Specification-ஐத் தொடங்குதல் {#initiating-site-specification}

### Theme Builder Onboarding-லின் போது {#during-theme-builder-onboarding}
...
### கைகளால் தொடங்குதல் (Manual Initiation) {#manual-initiation}
...
## Site Specification செயல்முறை {#the-site-specification-process}

### படி 1: தளத்தின் நோக்கம் (Site Purpose) {#step-1-site-purpose}
...
### படி 2: இலக்கு பார்வையாளர்கள் (Target Audience) {#step-2-target-audience}
...
### படி 3: பிராண்ட் அடையாளம் (Brand Identity) {#step-3-brand-identity}
...
### படி 4: வணிக இலக்குகள் (Business Goals) {#step-4-business-goals}
...
### படி 5: உள்ளடக்க அமைப்பு (Content Structure) {#step-5-content-structure}
...
## உங்கள் site_brief நினைவகம் {#your-sitebrief-memory}
...
## உங்கள் site_brief-ஐப் பார்ப்பதும் புதுப்பிப்பதும் {#viewing-and-updating-your-sitebrief}

### உங்கள் site_brief-ஐப் பார்க்க {#view-your-sitebrief}
...
### உங்கள் site_brief-ஐப் புதுப்பித்தல் {#update-your-sitebrief}
...
## ஏஜென்ட்கள் site_brief-ஐ எப்படிப் பயன்படுத்துகின்றன {#how-agents-use-sitebrief}

### வடிவமைப்பு பரிந்துரைகள் (Design Recommendations) {#design-recommendations}
...
### அம்சப் பரிந்துரைகள் (Feature Suggestions) {#feature-suggestions}
...
### உள்ளடக்க அமைப்பு (Content Structure) {#content-structure}
...
### குறிப்பிட்டதாக இருங்கள் (Be Specific) {#be-specific}
...
### தவறாமல் புதுப்பிக்கவும் (Update Regularly) {#update-regularly}
...
### நிலையான சொற்களைப் பயன்படுத்துங்கள் (Use Consistent Terminology) {#use-consistent-terminology}
...
### சூழலைச் சேர்க்கவும் (Include Context) {#include-context}
...
## Theme Builder Onboarding உடன் உள்ள தொடர்பு {#relationship-to-theme-builder-onboarding}
