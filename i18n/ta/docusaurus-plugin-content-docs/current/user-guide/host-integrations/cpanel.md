...
### 1. உங்கள் cPanel சான்றுகளைப் பெறுங்கள் {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php-ல் Constants சேர்க்கவும் {#2-add-constants-to-wp-configphp}
...
### 3. ஒருங்கிணைப்பை இயக்குங்கள் {#3-enable-the-integration}
