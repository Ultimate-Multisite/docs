...
### 1. உங்கள் Cloudways API சான்றுகளைப் பெறுங்கள் {#1-get-your-cloudways-api-credentials}
...
### 2. உங்கள் Server மற்றும் Application IDs-ஐப் பெறுங்கள் {#2-get-your-server-and-application-ids}
...
### 3. wp-config.php-இல் Constants சேர்க்கவும் {#3-add-constants-to-wp-configphp}
...
### SSL சான்றிதழ் மேலாண்மை {#ssl-certificate-management}
...
## முக்கியம் — Wildcard SSL சிக்கல் {#important--wildcard-ssl-pitfall}
...
### Ultimate Multisite network-க்கான பரிந்துரைக்கப்பட்ட Cloudways SSL அமைப்பு {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
### SSL Certificate சிக்கல்கள் {#ssl-certificate-issues}
