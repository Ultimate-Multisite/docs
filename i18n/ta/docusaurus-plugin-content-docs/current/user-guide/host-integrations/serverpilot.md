...
### 1. உங்கள் ServerPilot API சான்றுகளைப் பெறுங்கள் {#1-get-your-serverpilot-api-credentials}
...
### 2. உங்கள் App ID-ஐப் பெறுங்கள் {#2-get-your-app-id}
...
### 3. wp-config.php-இல் Constant-களைச் சேர்க்கவும் {#3-add-constants-to-wp-configphp}
...
## SSL சான்றிதழ் சரிபார்ப்பு {#ssl-certificate-verification}
...
### Domain நீக்குதல் {#domain-removal}
