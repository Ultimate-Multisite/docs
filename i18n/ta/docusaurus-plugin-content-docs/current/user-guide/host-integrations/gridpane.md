...
### 1. உங்கள் GridPane API சான்றுகளைப் பெறுதல் {#1-get-your-gridpane-api-credentials}
...
### 2. உங்கள் Server மற்றும் Site ID-களைப் பெறுதல் {#2-get-your-server-and-site-ids}
...
### 3. wp-config.php-இல் Constant-களை சேர்த்தல் {#3-add-constants-to-wp-configphp}
...
### 4. ஒருங்கிணைப்பை செயல்படுத்துதல் {#4-enable-the-integration}
...
## SUNRISE Constant மேலாண்மை {#sunrise-constant-management}
