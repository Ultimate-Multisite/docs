...
---
# Hostinger (hPanel) ஒருங்கிணைப்பு
...
### 1. உங்கள் Hostinger API டோக்கனை உருவாக்குதல்
...
### 2. உங்கள் கணக்கு ID-ஐ கண்டறிதல்
...
### 3. wp-config.php-ல் மாறிலிகளைச் சேர்த்தல்
...
### 4. ஒருங்கிணைப்பை இயக்குதல் (Enable the Integration)
...
### Addon Domains (கூடுதல் டொமைன்கள்)
...
### API இணைப்புச் சிக்கல்கள் (API Connection Issues)
...
### டொமைன் சேர்க்கப்படவில்லை (Domain Not Added)
