...
---
# Enhance Control Panel Integration - ஒருங்கிணைப்பு வழிகாட்டி {#enhance-control-panel-integration}
...
### கணினி தேவைகள் {#system-requirements}
...
### API அணுகல் {#api-access}
API tokens உருவாக்க Enhance Control Panel-க்கு நிர்வாகி அணுகல் உங்களுக்கு இருக்க வேண்டும்.

## உங்கள் API Credentials பெறுதல் {#getting-your-api-credentials}

### 1. API Token உருவாக்கவும் {#1-create-an-api-token}
...
### 2. உங்கள் Organization ID பெறவும் {#2-get-your-organization-id}
...
### 3. உங்கள் Server ID பெறவும் {#3-get-your-server-id}
...
### 4. உங்கள் API URL பெறவும் {#4-get-your-api-url}
...
### தேவையான Constants {#required-constants}
...
### Integration Wizard மூலம் அமைப்பு {#setup-via-integration-wizard}
...
## கூடுதல் WordPress Configuration {#additional-wordpress-configuration}
...
### Domain Mapped செய்யப்படும்போது {#when-a-domain-is-mapped}
...
### Domain நீக்கப்படும்போது {#when-a-domain-is-removed}
...
### DNS மற்றும் SSL சோதனை {#dns-and-ssl-checking}
...
## அமைப்பை சரிபார்த்தல் {#verifying-setup}

### இணைப்பை சோதிக்கவும் {#test-the-connection}
...
### Domain Mapped செய்த பிறகு {#after-mapping-a-domain}
...
### DNS சோதனை இடைவெளி {#dns-check-interval}
...
### Authentication பிழைகள் {#authentication-errors}
...
### பயன்படுத்தப்படும் பொதுவான Endpoints {#common-endpoints-used}
...
### முழு API ஆவணம் {#full-api-documentation}
...
## கூடுதல் ஆதாரங்கள் {#additional-resources}
