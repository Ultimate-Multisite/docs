...
---
# Hestia Control Panel ஒருங்கிணைப்பு {#hestia-control-panel-integration}
...
## இது என்ன செய்கிறது {#what-it-does}
...
## கட்டமைப்பு (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## அமைப்பைச் சரிபார்த்தல் {#verifying-setup}
...
## குறிப்புகள் & உதவிக்குறிப்புகள் {#notes--tips}
...
## எடுத்துக்காட்டு API அழைப்பு (cURL) {#example-api-call-curl}
