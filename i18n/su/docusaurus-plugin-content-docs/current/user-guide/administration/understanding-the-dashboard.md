...
Widget ieu laporanna ngeunaan kajadian (events) di sakuliah Ultimate Multisite. Kajadianna kaasup pendaftar, pembatalan (cancellations), pembuatan situs (site creations), penghapusan (deletions), sareng kagiatan séjénna.
...
Rentang tanggal ngatur mangsa informasi anu dipidangkeun ku widget di handapna, kaasup pendapatan, anggota anyar, pendaftar dumasar nagara, pendaftar dumasar formulir, jeung situs anu paling loba dikunjungi.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
Supaya widget **Most Visited Sites** bisa dipaké, aktifkeun penghitungan kunjungan di **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
