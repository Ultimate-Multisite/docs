...
Ti dinya, anjeun bisa ngakses halaman **System Emails** pikeun ningali sadaya template email.

![System Emails list](/img/admin/system-emails-list.png)

Anjeun ogé bisa ngedit template email tunggal nganggo *system email editor*:
...
Kanggo ngimpor template email anyar:

1. Pindah ka halaman **System Emails**
2. Klik tombol **Reset & Import** di bagian luhur halaman
...
1. **Hapus je impor deui** — Hapus email sistem éta terus impor deui (ieu bakal ngahapus data kirimna)
2. **Ngatur ulang via alat** — Gunake alat **Reset & Import**, nyalakan opsi **Reset**, sarta pilih email anu rék diatur ulang

Opsi Reset leuwih dipikaresep sabab éta bisa ngajaga data kirim (*send metrics*) je metadata séjénna bari tetep ngabalikeun konten *default*.
