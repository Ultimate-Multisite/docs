...
- **Tujuan situs (Site purpose)**: Naonna nu dilakukeun ku situs anjeun jeung kunaon situs éta aya
- **Audiens target (Target audience)**: Saha waé anu ngunjungkeun situs anjeun jeung naon yénna butuh
- **Jati diri *brand* (Brand identity)**: Warna, nada (*tone*), jeung gaya visual anjeun
- **Tujuan bisnis (Business goals)**: Kumaha rupana kasuksés pikeun situs anjeun
- **Struktur konten (Content structure)**: Kumaha cara situs anjeun diatur
...
- Tujuan jeung audiens situs anjeun
- Warna jeung nada *brand* anjeun
...
- Ngusul fitur anu cocog jeung tujuan situs anjeun
- Ngarekomendasi struktur konten anu nyambung jeung tujuan anjeun
...
```
"Hayu urang tentuke spesifikasi situs abdi"
```
...
- Warna utama: [pilih warna atau kode hex]
- Warna sekunder: [pilih warna atau kode hex]
- Warna aksen: [opsional]

Kumaha carana anjeun ngagambarke nada merek anjeun?
...
- Datar (semua konten di level anu sarua)
- Hirarkis (kategori je subkategori)
- Kronologis (gaya blog)
- Berbasis produk (katalog)
- Lainnya: [jelaskan]

Tipe konten naon anu anjeun anggo?
- Postingan blog
- Halaman produk
...
```
"Baharuan site brief saya: ayeuna kita target pelanggan B2B"
```
...
```
Anjeun: "Rancang ulang halaman utama saya"
Agen: "Dumasar site brief anjeun, anjeun targetkeun wanita umur 25-45
kalayan nada anu hangat jeung artisanal. Abdi bakal ngadamel desain anu
...
```
Anjeun: "Fitur naon anu kudu abdi tambihan?"
Agen: "Kanggo toko e-commerce anu fokus kana loyalitas pelanggan,
abdi badalan: program loyalitas, ulasan pelanggan, buletin email,
...
- Lamun anjeun nambahan lini produk anyar
...
Anjeun ogé bisa ngajalankeun Site Specification sacara mandiri lamun anjeun hoyong:

- Ngaganti spesifikasi anjeun sanggeus persiapan awal
...
- Minta agent pikeun "recall my site brief"
- Periksa yén memory diaktifkeun dina pengaturan anjeun

**Abdi rék mulai deui je *site\_brief* anyar**
- Tanyake ka agen: "Hapus *site brief* abdi sareng mulai deui"
- Terus jalankan Site Specification deui

**Agenna ngajak saran anu teu cocog jeung *site\_brief* abdi**
- Tanyake ka agen pikeun "tinjau *site brief* abdi"
...
1. **Gunakan Theme Builder**: Buat tema kustom dumasar *site brief* anjeun
2. **Perbaiki Desain**: Gunakan kemampuan Design System Aesthetics pikeun gawé desain anu leuwih jéntré
3. **Rencanakan Konten**: Tanyake ka agen pikeun rekomendasi struktur konten
4. **Bangun Fitur**: Minta fitur anu selaras jeung tujuan bisnis anjeun
