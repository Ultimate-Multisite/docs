---
title: Ngamimitkeun Ultimate Multisite
sidebar_position: 12
...
Ti **Dashboard Admin Jaringan** anjeun, buka **Plugins → Tambahkeun Plugin Anyar**.

![Halaman Network Admin Add New Plugin](/img/installation/add-new-plugin.png)

Milarian **"Ultimate Multisite"** (dikalangan tanda kutip pikeun cocog persis) sareng éta bakal muncul salaku hasil kahiji. Klik **Install Now**.

![Hasil panyalidikan nembongkeun Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Saatos dianggo, klik **Network Activate** pikeun ngaktipkeun plugin dina sakumna jaringan anjeun.

![Plugin dianggo kalayan tombol Network Activate](/img/installation/plugin-installed.png)

Saatos diaktipkeun, anjeun bakal otomatis diarahkan ka Setup Wizard.
...
![Setup réngse - Layar Siap](/img/installation/wizard-ready.png)

![Dashboard Admin Jaringan kalayan Ultimate Multisite diaktipkeun](/img/installation/network-dashboard.png)

Teruskeun sareng bersenang-senang!
