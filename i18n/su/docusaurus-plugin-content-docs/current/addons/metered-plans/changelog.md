---
title: Catetan Parobahan Rencana Dumasar Pamakean
sidebar_position: 99
...
- Anyar: Panegakan konektor diwangun deui kalayan panemuan wates dinamis jeung write-through, mastikeun akurasi real-time di sakuliah sadaya konektor
- Perbaikan: Pamajuan tabel database ayeuna leres saluyu jeung définisi skéma BerlinDB, nyegah kagagalan pamajuan dina pamasangan anyar
- Perbaikan: Callback pamajuan database dirobah kana format anu leres, ngarengsekeun kagagalan pamajuan anu jempé
- Perbaikan: Nilai fraksional ayeuna ditarima dina widang input AI Usage Overage Markup
