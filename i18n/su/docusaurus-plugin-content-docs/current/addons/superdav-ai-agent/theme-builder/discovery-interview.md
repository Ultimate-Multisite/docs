...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Disarankeun pikeun poto |
| **PNG** | `.png` | Ngadukung transparansi |
...
- **Palet warna** — warna dominan dicokot jeung dipaké dina theme
- **Gaya visual** — modern, rustic, minimalis, caang, jsb.
- **Mood jeung suasana** — profésional, kréatif, ramah, méwah, jsb.
...
- **Mood board** — kumpulan gambar anu ngagambarkeun éstétika anu dipikahayang
- **Poto produk** — lamun anjeun boga produk pikeun dipintonkeun
...
- **Gambar loba téks** — screenshot anu loba téks
...
3. **Asupkeun rupa-rupa** — campuran warna, gaya, jeung poko bahasan
...
- **Palet warna** — warna primér, sékundér, jeung aksén
- **Tipografi** — kulawarga font pikeun judul jeung téks awak
- **Gaya layout** — jarak, panyaluyuan, jeung susunan komponén
...
1. Tinjau arah desain anu dihasilkeun
2. Pasihan eupan balik atawa ménta panyaluyuan
...
- [Pakakas jeung Konfigurasi](./tools.md) — pakakas anu aya jeung pilihan konfigurasi
