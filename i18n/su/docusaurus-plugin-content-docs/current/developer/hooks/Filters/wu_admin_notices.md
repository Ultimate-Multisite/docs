...
|------|------|-------------|
| $notices | `array` | Daptar notices pikeun panel éta. |
| $all_notices | `array` | Daptar notices anu ditambahkeun, dipisahkeun dumasar panel. |
| $panel | `string` | Panel pikeun nyokot notices. |
