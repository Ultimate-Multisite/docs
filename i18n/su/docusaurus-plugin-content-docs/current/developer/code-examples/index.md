...
Dua pamundut sakaligus bisa maca nilai anu sarua jeung duanana nulis deui hasil anu geus ditambahan anu sarua, sahingga leungit hiji hitungan. `increment_item()` masrahkeun aritmetika ka mesin database ku hiji pernyataan `UPDATE ... SET column = column + ?`, ngajadikeun operasi éta sacara alami atomik.
