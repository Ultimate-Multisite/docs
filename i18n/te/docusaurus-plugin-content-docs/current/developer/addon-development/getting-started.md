...
---
# యాడ్‌ఆన్ అభివృద్ధి {#addon-development}

## యాడ్‌ఆన్ నిర్మాణం {#addon-structure}
...
## ప్రధాన యాడ్‌ఆన్ ఫైల్ టెంప్లేట్ {#main-addon-file-template}
...
## అనుకూల మోడల్ ఉదాహరణ {#custom-model-example}
...
## నిర్వాహక పేజీ సమీకరణ {#admin-page-integration}
...
### SSO మరియు main-site నిర్వహణ URLలు {#sso-and-main-site-management-urls}
...
### Checkout-form base domainలు {#checkout-form-base-domains}
