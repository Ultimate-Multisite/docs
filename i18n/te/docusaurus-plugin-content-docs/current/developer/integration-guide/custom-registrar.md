...
---
# కస్టమ్ రిజిస్ట్రార్ ఇంటిగ్రేషన్‌ను నిర్మించడం {#building-a-custom-registrar-integration}
...
## ఇంటర్‌ఫేస్ (The interface) {#the-interface}
...
### ఐచ్ఛిక methods (Optional methods) {#optional-methods}
...
### రిటర్న్ విలువ కన్వెన్షన్ (Return value convention) {#return-value-convention}
...
## మీ capability ను రిజిస్టర్ చేయడం (Registering your capability) {#registering-your-capability}
...
## విజర్డ్‌కు credential fields జోడించడం (Adding credential fields to the wizard) {#adding-credential-fields-to-the-wizard}
...
## పోస్ట్-రిజిస్ట్రేషన్ చర్యల కోసం hooks (Hooks for post-registration actions) {#hooks-for-post-registration-actions}
