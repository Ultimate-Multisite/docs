...
## ఎప్పుడు ఉపయోగించాలి {#when-to-use-it}
...
## ఫైల్ పేరు పెట్టే విధానం (File naming convention) {#file-naming-convention}
...
## ఫైల్‌ను ఎక్కడ ఉంచాలి {#where-to-place-the-file}
...
## అందుబాటులో ఉన్న Hooks మరియు Filters {#hooks-and-filters-available}
...
## కనిష్ట ఉదాహరణ (Minimal example) {#minimal-example}
