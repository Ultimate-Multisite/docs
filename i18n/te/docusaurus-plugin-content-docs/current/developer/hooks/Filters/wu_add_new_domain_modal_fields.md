...
కొత్త డొమైన్ మోడల్‌లోని ఫీల్డ్స్‌ను ఫిల్టర్ చేస్తుంది.

యాడ్-ఆన్‌లు (ఉదాహరణకు, Domain Seller) డొమైన్ రిజిస్ట్రేషన్ ఫీల్డ్స్‌ను మార్చడానికి లేదా భర్తీ చేయడానికి ఇది అనుమతిస్తుంది.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $fields | `array` | ఫారం ఫీల్డ్స్. |
