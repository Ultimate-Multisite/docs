...
API Settings పేజీ యొక్క పూర్తి దృశ్యం ఇక్కడ ఉంది:

![API Settings పూర్తి పేజీ](/img/config/settings-api-full.png)
...
## Zapier లో action సృష్టించడం {#creating-an-action-in-zapier}
...
### Action సృష్టించడం {#creating-an-action}
