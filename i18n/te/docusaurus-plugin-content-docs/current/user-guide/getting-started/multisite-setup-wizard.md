...
---
# మల్టీసైట్ సెటప్ విజార్డ్ {#multisite-setup-wizard}
...
## విజార్డ్ ఎప్పుడు కనిపిస్తుంది? {#when-does-the-wizard-appear}
...
## స్టెప్ 1: స్వాగతం {#step-1-welcome}
...
## స్టెప్ 2: నెట్‌వర్క్ కాన్ఫిగరేషన్ {#step-2-network-configuration}

ఈ స్టెప్‌లో మీ నెట్‌వర్క్ సెట్టింగ్స్ కాన్ఫిగర్ చేయమని అడుగుతుంది.

### సైట్ స్ట్రక్చర్ {#site-structure}
...
### నెట్‌వర్క్ టైటిల్ {#network-title}
...
### నెట్‌వర్క్ అడ్మిన్ ఇమెయిల్ {#network-admin-email}
...
## స్టెప్ 3: ఇన్‌స్టాలేషన్ {#step-3-installation}
...
## స్టెప్ 4: పూర్తయింది {#step-4-complete}
...
## మాన్యువల్ సెటప్ ఫాల్‌బ్యాక్ {#manual-setup-fallback}
...
### విజార్డ్ wp-config.php writable కాదని చెప్తోంది {#the-wizard-says-wp-configphp-is-not-writable}
...
### సెటప్ తర్వాత సైట్‌లు యాక్సెస్ కావడం లేదు (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### సెటప్ తర్వాత అథెంటికేషన్ సమస్యలు {#authentication-issues-after-setup}
...
### ఇన్‌స్టాలేషన్ సమయంలో ఒక స్టెప్ విఫలమైంది {#a-step-failed-during-installation}
