...
---
# WordPress Multisite అంటే ఏమిటి? {#what-is-wordpress-multisite}
...
## WordPress Multisite అంటే సరిగ్గా ఏమిటి? {#what-exactly-is-wordpress-multisite}
...
## Subdomain లేదా Subdirectory? {#subdomain-or-subdirectory}
...
## Subsites మధ్య ఏమి షేర్ అవుతుంది మరియు ఏమి అవ్వదు {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite లో User management {#user-management-on-wordpress-multisite}
...
## Performance పరిగణనలు {#performance-considerations}
