...
## Theme Builder Onboarding Flow అంటే ఏమిటి? {#what-is-the-theme-builder-onboarding-flow}
...
## Theme Builder Onboarding ప్రారంభించడం {#starting-the-theme-builder-onboarding}

### మొదటిసారి సెటప్ (First-Run Setup) {#first-run-setup}
...
## Onboarding దశలు {#the-onboarding-steps}

### దశ 1: మోడ్ ఎంపిక (Mode Selection) {#step-1-mode-selection}
...
### దశ 2: సైట్ వివరాలు (Site Specification) {#step-2-site-specification}
...
### దశ 3: డిజైన్ సిస్టమ్ నిర్ణయాలు (Design System Decisions) {#step-3-design-system-decisions}
...
### దశ 4: థీమ్ జనరేషన్ (Theme Generation) {#step-4-theme-generation}
...
### దశ 5: యాక్టివేషన్ మరియు ధృవీకరణ (Activation and Verification) {#step-5-activation-and-verification}
...
## Site Specification మరియు site_brief మెమరీ {#site-specification-and-sitebrief-memory}
...
### site_brief ఎందుకు ముఖ్యం (Why site_brief Matters) {#why-sitebrief-matters}
...
### మీ site_briefను వీక్షించడం (Viewing Your site_brief) {#viewing-your-sitebrief}
...
## Onboarding తర్వాత కస్టమైజేషన్ (Customizing After Onboarding) {#customizing-after-onboarding}

Theme Builder onboarding పూర్తయిన తర్వాత, మీరు చేయగలిగేవి:

### Design System Aesthetics Skill ఉపయోగించడం {#use-the-design-system-aesthetics-skill}
...
### theme.json ను నేరుగా ఎడిట్ చేయడం (Edit theme.json Directly) {#edit-themejson-directly}
...
### కస్టమ్ బ్లాక్ టెంప్లేట్‌లను సృష్టించడం (Create Custom Block Templates) {#create-custom-block-templates}
...
## పోలిక: పాత vs. కొత్త Onboarding (Comparison: Old vs. New Onboarding) {#comparison-old-vs-new-onboarding}
...
## తదుపరి దశలు (Next Steps) {#next-steps}
