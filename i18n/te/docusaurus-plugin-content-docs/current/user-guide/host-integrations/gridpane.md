...
### 1. మీ GridPane API క్రెడెన్షియల్స్ పొందండి {#1-get-your-gridpane-api-credentials}
...
### 2. మీ Server మరియు Site IDs పొందండి {#2-get-your-server-and-site-ids}
...
### 3. wp-config.php కు Constants జోడించండి {#3-add-constants-to-wp-configphp}
...
### 4. ఇంటిగ్రేషన్ ఎనేబుల్ చేయండి {#4-enable-the-integration}
...
## SUNRISE Constant మేనేజ్‌మెంట్ {#sunrise-constant-management}
