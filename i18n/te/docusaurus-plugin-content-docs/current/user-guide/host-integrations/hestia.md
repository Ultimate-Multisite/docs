...
---
# Hestia Control Panel ఇంటిగ్రేషన్ {#hestia-control-panel-integration}
...
## కాన్ఫిగరేషన్ (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## సెటప్ వెరిఫికేషన్ {#verifying-setup}
...
## ఉదాహరణ API కాల్ (cURL) {#example-api-call-curl}
