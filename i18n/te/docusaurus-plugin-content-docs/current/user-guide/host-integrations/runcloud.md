...
---
# RunCloud ఇంటిగ్రేషన్ {#runcloud-integration}
...
### 1. మీ RunCloud API క్రెడెన్షియల్స్ పొందండి {#1-get-your-runcloud-api-credentials}
...
### 2. మీ Server మరియు App IDలు పొందండి {#2-get-your-server-and-app-ids}
