...
---
# Enhance Control Panel ఇంటిగ్రేషన్ {#enhance-control-panel-integration}
...
### API యాక్సెస్ {#api-access}
API tokens సృష్టించడానికి మీకు Enhance Control Panel కు administrator యాక్సెస్ ఉండాలి.

## మీ API Credentials పొందడం {#getting-your-api-credentials}

### 1. API Token సృష్టించండి {#1-create-an-api-token}
...
### 2. మీ Organization ID పొందండి {#2-get-your-organization-id}
...
### 3. మీ Server ID పొందండి {#3-get-your-server-id}
...
### 4. మీ API URL పొందండి {#4-get-your-api-url}
...
### అవసరమైన Constants {#required-constants}
...
### Integration Wizard ద్వారా సెటప్ {#setup-via-integration-wizard}
...
## అదనపు WordPress కాన్ఫిగరేషన్ {#additional-wordpress-configuration}
...
### .htaccess కాన్ఫిగరేషన్ {#htaccess-configuration}
...
### డొమైన్ మ్యాప్ అయినప్పుడు {#when-a-domain-is-mapped}
...
### డొమైన్ తొలగించినప్పుడు {#when-a-domain-is-removed}
...
### DNS మరియు SSL చెకింగ్ {#dns-and-ssl-checking}
...
## సెటప్ వెరిఫై చేయడం {#verifying-setup}

### కనెక్షన్ టెస్ట్ చేయండి {#test-the-connection}
...
### డొమైన్ మ్యాప్ చేసిన తర్వాత {#after-mapping-a-domain}
...
### ఉపయోగించే సాధారణ Endpoints {#common-endpoints-used}
...
### పూర్తి API Documentation {#full-api-documentation}
