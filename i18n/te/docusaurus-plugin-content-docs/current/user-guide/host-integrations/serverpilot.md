...
### 1. మీ ServerPilot API క్రెడెన్షియల్స్ పొందండి {#1-get-your-serverpilot-api-credentials}
...
### 2. మీ App ID పొందండి {#2-get-your-app-id}
...
### 3. wp-config.php కి Constants జోడించండి {#3-add-constants-to-wp-configphp}
...
### డొమైన్ సింకింగ్ {#domain-syncing}
...
### SSL సర్టిఫికేట్ మేనేజ్‌మెంట్ {#ssl-certificate-management}
...
## SSL సర్టిఫికేట్ వెరిఫికేషన్ {#ssl-certificate-verification}
...
### డొమైన్ తొలగింపు {#domain-removal}
