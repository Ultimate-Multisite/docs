...
---
# cPanel ఇంటిగ్రేషన్ {#cpanel-integration}
...
### 1. మీ cPanel క్రెడెన్షియల్స్ పొందండి {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php కు Constants జోడించండి {#2-add-constants-to-wp-configphp}
