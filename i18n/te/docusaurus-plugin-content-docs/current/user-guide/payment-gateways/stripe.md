...
---
# Stripe Gateway సెటప్ చేయడం (v2) {#setting-up-the-stripe-gateway-v2}
...
## Stripe ఎనేబుల్ చేయడం {#enabling-stripe}
...
## Stripe Webhook సెటప్ చేయడం {#setting-up-stripe-webhook}
