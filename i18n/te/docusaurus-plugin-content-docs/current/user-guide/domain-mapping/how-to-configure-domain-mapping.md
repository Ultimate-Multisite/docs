...
---
# డొమైన్ మ్యాపింగ్‌ను ఎలా కాన్ఫిగర్ చేయాలి (v2)
...
### మీ Ultimate Multisite నెట్‌వర్క్‌లో డొమైన్ మ్యాపింగ్‌ను ఎలా సెటప్ చేయాలి
...
### డొమైన్ DNS సెట్టింగ్స్ సరిగా కాన్ఫిగర్ చేయబడ్డాయని నిర్ధారించుకోవడం
...
### Super Admin గా కస్టమ్ డొమైన్ పేరును మ్యాప్ చేయడం
...
### Subsite user‌గా custom domain name mapping చేయడం
