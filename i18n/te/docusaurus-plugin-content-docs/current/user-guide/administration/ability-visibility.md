...
---
# Ability Visibility (సామర్థ్య దృశ్యమానం) {#ability-visibility}
...
## Ability Visibility అంటే ఏమిటి? {#what-is-ability-visibility}
...
## Visibility Levels (దృశ్యమాన స్థాయిలు) {#visibility-levels}

### Public (పబ్లిక్) {#public}
...
## Ability Visibility ను నిర్వహించడం {#managing-ability-visibility}

### Ability Visibility సెట్టింగ్‌లను యాక్సెస్ చేయడం {#accessing-ability-visibility-settings}
...
### Ability వివరాలను చూడటం {#viewing-ability-details}
...
### Visibility Levels మార్చడం {#changing-visibility-levels}
...
### Bulk Operations (బల్క్ ఆపరేషన్లు) {#bulk-operations}
...
### భాగస్వాములకు సామర్థ్యాలు కేటాయించడం {#assigning-abilities-to-partners}
...
### భాగస్వామి యాక్సెస్‌ను రద్దు చేయడం {#revoking-partner-access}
...
## Unclassified Abilities (వర్గీకరించని సామర్థ్యాలు) {#unclassified-abilities}

మీరు Superdav AI Agent గుర్తించని థర్డ్-పార్టీ ability ను ఇన్‌స్టాల్ చేసినప్పుడు, అది **Unclassified** గా గుర్తించబడుతుంది.

### Unclassified Abilities కోసం అడ్మిన్ నోటీసు {#admin-notice-for-unclassified-abilities}
...
### Unclassified Abilities ను సమీక్షించడం {#reviewing-unclassified-abilities}
...
### Unclassified Abilities ను వర్గీకరించడం ఎందుకు? {#why-classify-unclassified-abilities}
...
## Different Surfaces లో Visibility (వివిధ ఇంటర్‌ఫేస్‌లలో దృశ్యమానం) {#visibility-in-different-surfaces}
...
## Security Best Practices (భద్రతా ఉత్తమ పద్ధతులు) {#security-best-practices}

### Principle of Least Privilege (కనిష్ట అధికార సూత్రం) {#principle-of-least-privilege}
...
### Regular Audits (నియమమైన ఆడిట్‌లు) {#regular-audits}
...
### Logging and Monitoring (లాగింగ్ మరియు పర్యవేక్షణ) {#logging-and-monitoring}
...
### Third-Party Abilities (థర్డ్-పార్టీ సామర్థ్యాలు) {#third-party-abilities}
...
## Troubleshooting (సమస్య పరిష్కారం) {#troubleshooting}
...
## Migration from Legacy Mode (పాత మోడ్ నుండి మైగ్రేషన్) {#migration-from-legacy-mode}
...
## Next Steps (తదుపరి చర్యలు) {#next-steps}
