...
## నావిగేషన్ లేబుల్ vs పేజీ శీర్షిక (Navigation Label vs Page Title)
...
## వినియోగ ఉదాహరణలు (Usage Examples)

### ఉదాహరణ 1: నావిగేషన్ లేబుల్‌తో సాధారణ మెనూ (Simple Menu with Navigation Label)
...
### ఉదాహరణ 2: నిర్దిష్ట థీమ్ లొకేషన్ కోసం మెనూ (Menu for Specific Theme Location)
...
## థీమ్ బిల్డర్‌తో అనుసంధానం (Integration with Theme Builder)
...
## సంబంధిత ఫీచర్లు (Related Abilities)
