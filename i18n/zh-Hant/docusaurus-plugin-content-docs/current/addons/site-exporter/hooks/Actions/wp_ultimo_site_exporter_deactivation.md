...
讓插件的其他部分可以在停用時掛載（或執行）相關的程式碼或功能。
...
定義於 [`inc/class-hooks.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-site-exporter/blob/main/inc/class-hooks.php#L99) 的第 99 行
