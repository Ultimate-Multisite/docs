...
讓插件的其他部分可以在此處附加它們的啟用（activation）程序。
...
定義於 [`inc/class-hooks.php`](https://github.com/Ultimate-Multisite/ultimate-multisite-payfast/blob/main/inc/class-hooks.php#L83) 的第 83 行
