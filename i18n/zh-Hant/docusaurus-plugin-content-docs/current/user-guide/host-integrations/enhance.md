...
## 取得 API 憑證 {#getting-your-api-credentials}

### 1. 建立 API Token {#1-create-an-api-token}
...
### 2. 取得 Organization ID {#2-get-your-organization-id}
...
### 3. 取得 Server ID {#3-get-your-server-id}
...
### 4. 取得 API URL {#4-get-your-api-url}
...
### 透過整合精靈設定 {#setup-via-integration-wizard}
...
### 當網域被對應時 {#when-a-domain-is-mapped}
...
### 當網域被移除時 {#when-a-domain-is-removed}
...
### DNS 與 SSL 檢查 {#dns-and-ssl-checking}
