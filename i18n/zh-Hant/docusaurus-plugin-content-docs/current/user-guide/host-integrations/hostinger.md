...
---
# Hostinger (hPanel) 整合 {#hostinger-hpanel-integration}
...
### 1. 生成您的 Hostinger API Token {#1-generate-your-hostinger-api-token}
...
### 2. 尋找您的帳戶 ID {#2-find-your-account-id}
...
### 4. 啟用整合功能 {#4-enable-the-integration}
...
### 附加網域 (Addon Domains) {#addon-domains}
