...
## WordPress Multisite 到底是什麼？ {#what-exactly-is-wordpress-multisite}
...
## 子網域還是子目錄？ {#subdomain-or-subdirectory}
...
## 子網站之間共用和不共用的內容 {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite 的使用者管理 {#user-management-on-wordpress-multisite}
