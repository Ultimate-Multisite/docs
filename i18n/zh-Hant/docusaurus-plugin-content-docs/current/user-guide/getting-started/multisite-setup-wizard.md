...
## 精靈何時會出現？ {#when-does-the-wizard-appear}
...
## 步驟 2：網路設定 {#step-2-network-configuration}
...
### 精靈顯示 wp-config.php 不可寫入 {#the-wizard-says-wp-configphp-is-not-writable}
...
### 設定後網站無法存取（子網域） {#sites-are-not-accessible-after-setup-subdomains}
...
### 設定後發生驗證問題 {#authentication-issues-after-setup}
...
### 安裝過程中某個步驟失敗 {#a-step-failed-during-installation}
