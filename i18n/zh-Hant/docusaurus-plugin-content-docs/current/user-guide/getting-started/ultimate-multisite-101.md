...
## WordPress Multisite 是什麼 {#the-wordpress-multisite}
...
#### 子網域 vs. 子目錄 {#subdomain-vs-subdirectory}
...
#### 使用者和管理員 {#users-and-administrators}
...
#### 情境 2：垂直市場供應商 {#case-2-niche-provider}
...
#### 共享主機 vs. 專用主機 {#shared-vs-dedicated-hosting}
