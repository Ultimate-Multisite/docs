...
## 啟用網路搜尋 {#enabling-internet-search}
...
### 如何取得 Brave Search API Key {#obtaining-a-brave-search-api-key}
...
### 如何取得 Tavily API Key {#obtaining-a-tavily-api-key}
...
## 停用網路搜尋 {#disabling-internet-search}
