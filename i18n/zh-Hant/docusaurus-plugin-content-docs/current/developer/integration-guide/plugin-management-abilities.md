...
## 外掛安裝程式 API {#plugin-installer-api}
...
### 註冊自訂安裝處理器 {#registering-a-custom-install-handler}
...
## 生態系統註冊表 (Ecosystem Registry) {#ecosystem-registry}
...
## 異步任務架構 (Async Job Architecture) {#async-job-architecture}
