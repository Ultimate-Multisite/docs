...
### الأساليب الاختيارية (Optional methods)
...
### اتفاقية قيمة الإرجاع (Return value convention)
...
## تسجيل الإضافة (Registering your capability)
...
## إضافة حقول بيانات الاعتماد إلى المعالج (Adding credential fields to the wizard)
...
## خطافات الإجراءات بعد التسجيل (Hooks for post-registration actions)
