...
title: الإجراء - wu_mcp_adapter_initialized
sidebar_label: wu_mcp_adapter_initialized
_i18n_hash: 0d5224ab7efaa954ce3d5b5c20e7f8c1
---
# Action: wu_mcp_adapter_initialized

يتم إطلاقه بعد تهيئة محول MCP.

يتيح للملحقات والقوالب الأخرى تسجيل قدراتهم الخاصة.

## Parameters {#parameters}

| الاسم | النوع | الوصف |
|------|------|-------------|
| $mcp_adapter | `\MCP_Adapter` | مثيل محول MCP. |
