---
title: دليل استخدام الخطافات
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# دليل استخدام الHooks {#hooks-usage-guide}

يقدم Ultimate Multisite أكثر من 200 Hook إجراء وأكثر من 280 Hook فلتر. تغطي هذه الصفحة أكثر الHooks استخدامًا مع أمثلة عملية. للحصول على مرجع كامل مُولَّد تلقائيًا، تصفح الصفحات الأخرى في هذا القسم.

## الHooks الإجراءية {#action-hooks}

### دورة حياة العميل {#customer-lifecycle}

#### بعد إنشاء العميل {#after-customer-creation}
...
#### تغيير حالة العميل {#customer-status-change}
...
### الHooks للموقع {#site-hooks}

#### بعد نشر الموقع {#after-site-published}
...
#### قبل تطبيق القالب {#before-template-application}
...
### الHooks للعضوية {#membership-hooks}

#### انتقالات الحالة {#status-transitions}
...
### الHooks للمدفوعات {#payment-hooks}

#### الدفع مكتمل / فشل {#payment-completed--failed}
...
### الHooks للطلب {#checkout-hooks}

#### قبل المعالجة / بعد الاكتمال {#before-processing--after-completion}
...
## الHooks الفلاتر {#filter-hooks}

### فلاتر التسعير {#pricing-filters}
...
### فلاتر القوالب {#template-filters}
...
### فلاتر القيود {#limitation-filters}
...
### حقول نموذج الدفع {#checkout-form-fields}
...
### محتوى البريد الإلكتروني {#email-content}
