...
| الاسم | النوع | الوصف |
|------|------|-------------|
| $notices | `array` | قائمة الإشعارات لهذا اللوحة المحددة. |
| $all_notices | `array` | قائمة الإشعارات المضافة، مفصولة حسب اللوحة. |
| $panel | `string` | اللوحة لاسترجاع الإشعارات. |
