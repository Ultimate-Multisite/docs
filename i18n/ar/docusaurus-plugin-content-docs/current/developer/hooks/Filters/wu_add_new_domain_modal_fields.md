...
title: فلتر - wu_add_new_domain_modal_fields
...
يُرشّح الحقول لمدال إضافة نطاق جديد.

يسمح للإضافات (مثل Domain Seller) بتعديل أو استبدال حقول تسجيل النطاق.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $fields | `array` | حقول النموذج. |
