...
---
# التحقق من تباين لوحة الألوان {#validate-palette-contrast}
...
### المعلمات (Parameters) {#parameters}
...
## مستويات WCAG التي يتم التحقق منها {#wcag-levels-checked}
...
## مخطط الإخراج (Output Schema) {#output-schema}
...
### حقول الإخراج (Output Fields) {#output-fields}
...
## الأزواج الفاشلة والتوصيات {#failing-pairs-and-recommendations}
...
## الوظائف ذات الصلة (Related Abilities) {#related-abilities}
