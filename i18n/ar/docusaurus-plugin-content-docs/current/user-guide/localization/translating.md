---
title: ترجمة Ultimate Multisite
sidebar_position: 19
...
هذا هو نظام الترجمة القياسي لمجتمع WordPress. عندما تصل الترجمات إلى حد موافقة كافٍ، يتم توزيعها تلقائيًا على جميع مستخدمي Ultimate Multisite عبر تحديثات الإضافة في WordPress.

**نحتاج إلى مساعدتك!** إذا كنت تتحدث لغة غير الإنجليزية، يرجى النظر في المساهمة بالترجمات. حتى ترجمة بعض السلاسل تساعد. للبدء:

1. قم بزيارة [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. اختر لغتك
3. انقر على "المساهمة في الترجمة"
4. ستحتاج إلى حساب مجاني على WordPress.org
...
1. قم بتحميل Poedit من [poedit.net](https://poedit.net)
2. افتح ملف `.pot` من `wp-content/plugins/ultimate-multisite/lang/`
3. ترجم السلاسل في واجهة Poedit
