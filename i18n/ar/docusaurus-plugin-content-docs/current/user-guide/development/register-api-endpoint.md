...
## معلمات جسم الطلب {#endpoint-body-parameters}
...
## إنشاء إجراء في Zapier {#creating-an-action-in-zapier}
...
### إنشاء إجراء {#creating-an-action}
...
### معلمات نقطة النهاية الكاملة {#complete-endpoint-parameters}
