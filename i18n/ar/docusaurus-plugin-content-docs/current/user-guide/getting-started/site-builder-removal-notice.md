...
### وضع بناء الموقع (Site Builder Mode) (القديم)
...
## إذا كنت تستخدم وضع بناء الموقع
...
### الانتقال إلى وكيل المساعد في الإعداد (Setup Assistant Agent)
...
## مقارنة: بناء الموقع مقابل المساعد في الإعداد
...
### وضع بناء الموقع (Site Builder Mode)
...
### وكيل المساعد في الإعداد (Setup Assistant Agent)
...
## مزايا وكيل المساعد في الإعداد (Setup Assistant Agent)
...
### لا أجد وضع بناء الموقع (Site Builder mode)
...
### أريد إعادة إنشاء موقع من بناء الموقع
...
### موقعي القديم الذي تم إنشاؤه بواسطة بناء الموقع لا يعمل
...
### هل ما زال بإمكاني استخدام قوالب بناء الموقع القديمة؟
