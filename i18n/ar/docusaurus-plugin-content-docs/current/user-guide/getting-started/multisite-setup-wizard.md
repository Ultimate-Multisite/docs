...
---
# معالج إعداد شبكة متعددة المواقع {#multisite-setup-wizard}
...
## متى يظهر المعالج؟ {#when-does-the-wizard-appear}
...
## الخطوة 1: الترحيب {#step-1-welcome}
...
## الخطوة 2: تكوين الشبكة {#step-2-network-configuration}
...
### بريد المسؤول عن الشبكة {#network-admin-email}
...
## الخطوة 3: التثبيت {#step-3-installation}
...
## الخطوة 4: إكمال {#step-4-complete}
...
## بديل الإعداد اليدوي {#manual-setup-fallback}
...
### يقول المعالج أن wp-config.php غير قابل للكتابة {#the-wizard-says-wp-configphp-is-not-writable}
...
### لا يمكن الوصول إلى المواقع بعد الإعداد (النطاقات الفرعية) {#sites-are-not-accessible-after-setup-subdomains}
...
### مشاكل المصادقة بعد الإعداد {#authentication-issues-after-setup}
...
### فشل خطوة أثناء التثبيت {#a-step-failed-during-installation}
