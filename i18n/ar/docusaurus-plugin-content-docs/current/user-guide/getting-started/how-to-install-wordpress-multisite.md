...
---
# كيف أقوم بتثبيت ووردبريس متعدد المواقع؟ {#how-do-i-install-wordpress-multisite}
...
## المشكلات الشائعة: {#add-a-trailing-slash-to-wp-admin}

### 1\. يمكنني إنشاء مواقع جديدة لكن لا يمكن الوصول إليها. {#common-problems}
