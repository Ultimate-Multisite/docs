...
### كيف تنتقل العضويات إلى حالة "منتهية" (Expired)
...
#### العضويات المتجددة تلقائيًا مقابل غير المتجددة تلقائيًا
...
## حظر الوصول إلى الواجهة الأمامية (Block Frontend Access)
...
## استكشاف الأخطاء وإصلاحها: بقاء المواقع متاحة بعد انتهاء الصلاحية

إذا ظلت المواقع متاحة للجمهور بعد انتهاء صلاحية العضوية، فقم بالمرور عبر هذه الفحوصات بالترتيب:

### 1. التحقق من تفعيل إعداد Block Frontend Access
...
### 2. التحقق من فترة السماح بحظر الواجهة الأمامية (Frontend Block Grace Period)
...
### 3. التأكد من أن حالة العضوية قد تغيرت بالفعل
...
### 4. التحقق من تشغيل Action Scheduler
...
### 5. التحقق من مشاكل Webhook الخاصة بالبوابة (العضويات المتجددة تلقائيًا)
...
### 6. التحقق من فترة السماح لانتهاء الصلاحية (مستوى Cron)
...
## مرجع المطور (Developer Reference)
