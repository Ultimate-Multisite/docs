...
### 1. تفعيل واجهة برمجة تطبيقات CyberPanel
...
### التوفير التلقائي لشهادات SSL (Auto-SSL)
...
### النطاق البديل www (www Subdomain)
...
### إعادة توجيه البريد الإلكتروني (Email Forwarders)
...
### رفض اتصال واجهة برمجة التطبيقات (API Connection Refused)
...
### لم يتم إنشاء النطاق (Domain Not Created)
...
### لم يتم إصدار شهادة SSL (SSL Certificate Not Issued)
