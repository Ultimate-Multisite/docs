...
### 1. الحصول على بيانات اعتماد API لـ ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. الحصول على معرف التطبيق (App ID) {#2-get-your-app-id}
...
## التحقق من شهادة SSL {#ssl-certificate-verification}
...
### مشاكل الاتصال بالـ API {#api-connection-issues}
