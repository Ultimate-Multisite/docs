...
## الحصول على بيانات اعتماد API الخاصة بك {#getting-your-api-credentials}

### 1. إنشاء رمز API {#1-create-an-api-token}
...
### 2. الحصول على معرف المنظمة {#2-get-your-organization-id}
...
### 3. الحصول على معرف الخادم {#3-get-your-server-id}
...
### 4. الحصول على عنوان URL للـ API {#4-get-your-api-url}
...
### الثوابت المطلوبة {#required-constants}
...
### إعداد عبر معالج التكامل {#setup-via-integration-wizard}
...
## تكوين WordPress الإضافي {#additional-wordpress-configuration}
...
### تكوين .htaccess {#htaccess-configuration}
...
### عند تعيين نطاق {#when-a-domain-is-mapped}
...
### عند إزالة نطاق {#when-a-domain-is-removed}
...
### فحص DNS و SSL {#dns-and-ssl-checking}
...
## التحقق من الإعداد {#verifying-setup}

### اختبار الاتصال {#test-the-connection}
...
### بعد تعيين نطاق {#after-mapping-a-domain}
...
### فاصل فحص DNS {#dns-check-interval}
...
### النقاط النهائية المشتركة المستخدمة {#common-endpoints-used}
...
### وثائق API الكاملة {#full-api-documentation}
