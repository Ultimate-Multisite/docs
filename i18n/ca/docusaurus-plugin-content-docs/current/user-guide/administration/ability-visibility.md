...
## Què són les Visibilitats d'Habilitats? {#what-is-ability-visibility}
...
## Niveells de Visibilitat {#visibility-levels}

### Públic (Public) {#public}
...
### Deshabilitat (Disabled) {#disabled}
...
## Gestió de la Visibilitat d'Habilitats {#managing-ability-visibility}

### Accedament a la Configuració de Visibilitat d'Habilitats {#accessing-ability-visibility-settings}
...
### Veure Detalls de l'Habilitat {#viewing-ability-details}
...
### Canviar Nivels de Visibilitat {#changing-visibility-levels}
...
### Operacions en Llotges (Bulk Operations) {#bulk-operations}
...
### Assignar Habilitats als Socis {#assigning-abilities-to-partners}
...
### Revocar Accés de Soci {#revoking-partner-access}
...
## Habilitats No Classificades (Unclassified Abilities) {#unclassified-abilities}

Quan instal·les una habilitat de terceres parts que Superdav AI Agent no reconeix, es marca com a **Unclassified**.

### Avís d'Administració per a Habilitats No Classificades {#admin-notice-for-unclassified-abilities}
...
### Revisar Habilitats No Classificades {#reviewing-unclassified-abilities}
...
### Per què Classificar Habilitats No Classificades? {#why-classify-unclassified-abilities}
...
## Visibilitat en Diferents Superfícies {#visibility-in-different-surfaces}
...
### Serveis MCP (MCP Servers) {#mcp-servers}
...
### Integració de WooCommerce {#woocommerce-integration}
...
### Interfície de Xat (Chat Interface) {#chat-interface}
...
## Mejores Pràctiques de Seguretat {#security-best-practices}

### Principi del Mínim Privilegi {#principle-of-least-privilege}
...
### Auditories Regulars {#regular-audits}
...
### Registre i Monitorització (Logging and Monitoring) {#logging-and-monitoring}
...
### Habilitats de Terceres Parts {#third-party-abilities}
...
## Migració del Mode Legacy {#migration-from-legacy-mode}
