...
## Cicle vital de l'estat de la membresia
...
### Com transiciona les membresdies a "Expired"
...
#### Membresdies amb renovació automàtica vs. sense renovació automàtica
...
### Què veuen els visitants quan un lloc està bloquejat
...
## Resolució de problemes: Llocs que es mantenen accessibles després de l'expiració
...
### 1. Verifica que la configuració Block Frontend Access estigui habilitada
...
### 2. Comprova el Frontend Block Grace Period
...
### 3. Confirma que l'estat de la membresia ha canviat realment
...
### 4. Verifica que Action Scheduler estigui executant
...
### 5. Comprova problemes amb els webhooks de la passarela (Membresdies amb renovació automàtica)
...
### 6. Comprova el període de gràcia d'expiració (Nivell del Cron)
...
### 7. Expirar manualment una membresia
...
## Referència per a desenvolupadors
