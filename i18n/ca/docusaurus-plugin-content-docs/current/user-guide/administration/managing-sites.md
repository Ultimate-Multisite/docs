...
## Visualització de Sites {#viewing-sites}
...
## Afegir un Site nou {#adding-a-new-site}
...
## Gestió d'un Site existent {#managing-an-existing-site}
...
### Barra lateral dreta {#right-sidebar}
