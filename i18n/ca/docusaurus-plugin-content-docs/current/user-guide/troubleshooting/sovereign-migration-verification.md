...
### Els grants de la base de dades no coincideixen amb l'host
...
### Les instal·lacions Bedrock o locals no poden connectar-se
...
### La cola asíncrona de *push* no es drena
...
### El compte d'usuari del tenant és incorrecte
