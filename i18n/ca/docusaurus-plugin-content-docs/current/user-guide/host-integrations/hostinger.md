...
---
# Integració amb Hostinger (hPanel)
...
### 1. Genera el teu token API de Hostinger
...
### 3. Afegir constants a wp-config.php
...
### Domèns addicionals (Addon Domains)
...
- [Documentació d'Ultimate Multisite](/docs)
