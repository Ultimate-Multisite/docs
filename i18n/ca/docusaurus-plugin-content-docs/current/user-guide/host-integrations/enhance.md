...
---
# Millorar la integració amb el painel de control {#enhance-control-panel-integration}
...
### Requeriments del sistema {#system-requirements}
...
### Accés API {#api-access}
Has de tenir accés d'administrador al Painel de Control Enhance per crear tokens API.

## Obtenció de les teves credencials API {#getting-your-api-credentials}

### 1. Crear un token API {#1-create-an-api-token}
...
### 2. Obtén el teu Organization ID {#2-get-your-organization-id}
...
### 3. Obtén el teu Server ID {#3-get-your-server-id}
...
### 4. Obtén l'URL de ta API {#4-get-your-api-url}
...
### Constantes requerides {#required-constants}
...
### Configuració mitjançant el Wizard d'Integració {#setup-via-integration-wizard}
...
## Configuració Adicional de WordPress {#additional-wordpress-configuration}
...
### Configuració de .htaccess {#htaccess-configuration}
...
### Constantes de Cookie {#cookie-constants}
...
### Quan es Mapeia un Dominio {#when-a-domain-is-mapped}
...
### Quan es Repara un Dominio {#when-a-domain-is-removed}
...
### Comprobació de DNS i SSL {#dns-and-ssl-checking}
...
### Probar la Conexió {#test-the-connection}
...
### Després d'Mapejar un Domini {#after-mapping-a-domain}
...
### Problemes amb la Conexió API {#api-connection-issues}
...
### Análisis de registros (Logs) {#log-analysis}
...
### Endpoints comunes utilizados {#common-endpoints-used}
...
### Documentación Completa de la API {#full-api-documentation}
