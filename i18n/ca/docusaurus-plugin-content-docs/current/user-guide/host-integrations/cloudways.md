...
### 1. Obtén les credencials API de Cloudways
...
### 2. Obtén els IDs del servidor i de l'aplicació
...
## Important — El problema del comodinal SSL
...
### Configuració SSL recomanada de Cloudways per a una xarxa Ultimate Multisite
