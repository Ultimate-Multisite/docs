---
title: Diari de canvis de Content Sync
sidebar_position: 99
...
* Nou: Preselecció de llocs fills per a les països de plantilla
* Nou: Extracció de multimèdia de post_content per a tots els tipus de publicació
* Nou: Sincronització de taxònomes (categories, etiquetes, taxònomes personalitzats)
* Canviat: Nombrat de "Elementor Template Sync" a "Content Sync"
...
* Sincronització completa de multimèdia amb remaptege automàtic d'ID
* Integració de configuració amb Ultimate Multisite
* Suport per a l'exclusió de llocs mitjançant les configuracions de la xarxa
* Casament de cache d'Elementor després de la sincronització
* Conservació de taxònomes de plantilla
