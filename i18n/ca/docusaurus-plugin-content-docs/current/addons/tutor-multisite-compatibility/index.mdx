...
# Compatibilitat de Tutor Multisite {#tutor-multisite-compatibility}
...
## Funcionalitat traslladada del plugin MU {#functionality-moved-from-mu-plugin}
...
## Gestió de la base de dades {#database-management}
...
### Taules afectades {#affected-tables}
...
### Interfície d'administració {#admin-interface}
