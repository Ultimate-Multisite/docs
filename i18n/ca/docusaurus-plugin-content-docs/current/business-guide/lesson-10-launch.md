...
## Llista de Revisió Pre-Lançament {#pre-launch-checklist}
...
### Plans i Productes {#plans-and-products}
...
### Flux de Pagament (*Checkout Flow*) {#checkout-flow}
...
### Legal i Negoci {#legal-and-business}
...
## Lançament Suau vs. Lançament Oficial {#soft-launch-vs-hard-launch}

Considera un lançament de dues fases:

### Fase 1: Lançament Suau {#phase-1-soft-launch}
...
### Fase 2: Lançament Oficial {#phase-2-public-launch}
...
## Accions del Dia del Lançament {#launch-day-actions}
...
## Què pot anar malbé {#what-can-go-wrong}
