---
title: 'Lliurada 11: Troballar clients'
sidebar_position: 12
...
- **Saps exactament on estan els teus clients** — comunitats, esdeveniments i canals específics
...
- **Sense web**: Prospect fort — necessiten el que tu ofereixes
...
- Fes referència al seu negoci específic per nom
- Indica un problema concret amb la seva actual presència web (o la manca d'ella)
- Mostra'ls com és FitSite (enllaç a una demo o a un site exposició)
- Ofereix una prova gratuïta o una demo
...
- **Grups de Facebook** per a propietaris de gimnàsiums, managers de centres, empresaris de fitness
- **Comunitats de Reddit** com r/personaltraining, r/fitnessindustry
...
1. **Contribueix de manera genuïna** — respon a preguntes, comparteix observacions sobre gestionar un negoci de fitness en línia
2. **Establir credibilitat** — converteix-te en algú que entén la intersecció entre el fitness i la presència web
...
- "Com obtenir més membres de gimnàsium amb el teu site web"
- "Les millors funcionalitats de site web per a centres de fitness"
- "¿Necessiten els *personal trainers* un site web?"
- "Com mostrar el teu horari de classes en línia"
...
- **Empreses de *booking* (reservatives)** — ells resoleuen l'horar, tu resolis la presència web
- **Proveïdors d'equipament de fitness** — venen als mateixos clients
- **Consultors de negocis per a professionals del fitness** — els aconsellen sobre marketing i creixement
- **Associacions de negocis locals** — cambres de comerç, grups de petits empresaris
...
- **Fires i exposicions** — *stand* o *networking* de participants
- **Congressos** — oportunitats de parla que estableixen autoritat
- **Encontres locals de fitness** — més petits però molt més dirigits
- **Webinars en línia** — "Com construir la presència en línia del teu centre de fitness"
...
- Mostra els sitos web dels clients a la teva pàgina de marketing
- Crea *case studies*: "Com [Nom del Centre] va obtenir un 30% més de reserves amb el seu FitSite"
...
1. Instala l'addon [AffiliateWP](/addons/affiliatewp) si és possible, o configura un sistema senzill de seguiment de derivacions
...
- **Cost per adquisició**: Quanta inversió (temps i diners) has gastat per obtenir cada client?
- **Tasa de conversió**: Què percentatge de prospects de cada canal es registren?
- **Qualitat del client**: Els clients de certs canals es queden més temps o actualitzen més?
...
- **Mes 7-12**: 50-100+ clients, les derivacions i la cerca orgànica es tornen significatives
...
- **Estratègia de participació comunitária** per construir credibilitat
- **Temes de marketing de contingut** que atrauen els propietaris de centres de fitness
- **Un programa de derivació** per capitalitzar el boca a boca
- **Marqueter de seguiment** per mesurar el que funciona

---

**Pròxima:** [Aula 12: Gestionar el Negoci](lesson-12-operations) — les operacions del dia a dia per gestionar una plataforma web de nich.
