...
## Per què són importants els templates de nich {#why-niche-templates-matter}
...
## Planificació dels templates {#planning-your-templates}
...
## Creació d'un site template {#building-a-template-site}
...
### Pas 1: Crear el site template {#step-1-create-the-template-site}
...
### Pas 2: Instal·lar i configurar el tema {#step-2-install-and-configure-the-theme}
...
### Pas 3: Crear les pàgines {#step-3-create-the-pages}
...
### Pas 4: Configurar els plugins {#step-4-configure-plugins}
...
### Pas 5: Marcar com a Template {#step-5-mark-as-template}
...
## Llista de verificació de qualitat del template {#template-quality-checklist}
