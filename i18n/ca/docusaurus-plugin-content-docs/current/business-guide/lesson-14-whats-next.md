---
title: 'Lliurada 14: Què hi ve després'
sidebar_position: 15
...
- **Escoles de artes marcials** -- classificació de cinturons, informació de torneig, jerarquia de classes
- **Estudi de dansa** -- horaris de recital, galeries de representacions, informació de vestuari
...
- **Integració de reserva de classes** -- integració més profunda amb plataformes de reserva populars
- **Portal de membres** -- una àrea de connexió per als membres del gimnàs amb horaris i recursos
...
- **Professionals de la salut** -- quiropractics, fisioterapeutes, nutricionistes
...
1. Els necessiten per als seus website però tenen dificultats per obtenir uns bons?
2. Poden pagar una subscripció mensual?
3. Parlen entre si?

Cada nou niche necessita:

- Nous templates dissenyats per a aquesta indústria
- Noves estructures de plans que reflecteixin les necessitats d'aquesta indústria
- Nous canals de marketing i adquisició
- Nou contingut d'onboarding i coneixement de suport
...
- `fitsite.com` -- estudi de fitness
- `menusite.com` -- restaurants
- `lawsite.com` -- despatxos d'advocats
...
Un FitSite amb 200 clients a $89 ARPU:

- **MRR**: $17.800
- **ARR**: $213.600
- **Preu potencial de venda**: $640.000 - $1.068.000
...
1. **Elegir un niche** amb necessitats clares, capacitat de pagament i comunitat
2. **Validar** abans de construir
3. **Construir una plataforma adaptada** amb templates, plans i marca específics del niche
4. **Crear una experiència fluida** des de l'alta fins a l'onboarding
5. **Prebater per valor** amb nivells estratègics, proves i descompte
6. **Llançar de manera metòdica** amb un *soft launch* i una llista de verificació
7. **Adquirir clients** mitjançant canals específics del niche
8. **Gestionar operacions** amb rutines sostenibles
9. **Escalar** l'infraestructura, els ingressos i l'equip mentre creixes
...
El moment millor per començar era ahir. El segon moment millor és ara.
