...
### Dotičeni korisnički resursi baze podataka ne odgovaraju hostu {#database-grants-do-not-match-the-host}
...
### Asinhna redosled za push nije ispraznjen (Async push queue does not drain) {#async-push-queue-does-not-drain}
...
### Broj korisnika najma je pogrešan {#tenant-user-count-is-wrong}
