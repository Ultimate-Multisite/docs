---
title: Prevođenje Ultimate Multisite
sidebar_position: 19
...
Ovo je standardni sistem za prevođenje zajednice WordPressa. Kada prevodi dosegnu dovoljnu razinu odobrenja, automatski se distribuiraju svim korisnicima Ultimate Multisite-a putem ažuriranja plugin-a WordPressa.

**Potrebna nam je vaša pomoć!** Ako govorite jezik osim engleskog, molimo vas da razmislite o doprinosu prevoda. Čak i prevod nekoliko tekstualnih fraza pomaže. Da počnete:
...
3. Kliknite na "Contribute Translation" (Doprinesi prevod)
4. Treba vam besplatni račun na WordPress.org
...
1. Preuzmite Poedit sa [poedit.net](https://poedit.net)
2. Otvorite `.pot` fajl iz `wp-content/plugins/ultimate-multisite/lang/`
3. Prevedite tekstualne fraze u Poedit interfejsu
