...
### Connection Refused (Odbijanje konekcije API-ja)
...
### Authentication Errors (Greške autentifikacije)
...
### Domain Not Created (Domen nije kreiran)
...
### SSL Certificate Not Issued (SSL certifikat nije izdat)
