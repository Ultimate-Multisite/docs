...
- Poslovanja se očekuje da imaju web prisutnost
- Većina trenutnih web stranica u industriji je lošeg kvaliteta
- Opšti alati za izradu ne rješavaju njihove specifične potrebe
- Kreiranje po narudžbi je previše skupo za tipičnu veličinu poslovanja
...
- Dovoljno razvijeni da imaju marketinški budžet
- Naviknuti na plaćanje pretplate za softver (sistemi za rezervacije, obrada plaćanja, itd.)
- Funkcioniraju na nivou gdje je plaćanje od $49-$199 mjesečno razumno poslovno plaćanje
...
- Industrijska udruženja, konferencije ili sajmovi
- Aktivne online zajednice (Facebook grupe, forumi, subredditi)
- Lokalno povezivanje gdje vlasnici poslovanja dijele preporuke
...
- Industrijama u kojima ste radili ili za koje ste pravili web stranice
...
- Pretražite na Googleu "[industrija] web builder" i vidite šta postoji
- Pregledajte industrijske forume radi pritužbi o web prisutnosti
...
- **Veličina tržišta**: Koliko poslovanja postoji u ovoj niši? (Počnite sa svojom državom/regijom)
...
- Kako ste dobili svoju trenutnu web stranicu?
- Što biste željeli da radi, a što ne radi?
- Za šta trenutno plaćate?
- Da li biste bili zainteresovani za platformu napravljenu specifično za [vašu nišu]?
...
| Kriterijum | Procjena |
|-----------|------------|
| Potreban su web sajtovi, ali im je teško | Da — većina studija je generička ili zastarjela |
| Mogu si priuštiti pretplatu | Da — već plaćaju $50-$200 mjesečno za softver za rezervacije |
| Komuniciraju među sobom | Da — aktivne zajednice, industrijski događaji, lokalne mreže |
| Veličina tržišta | 100.000+ objekata samo u SAD-u |
| Panorama konkurencije | Postoji malo platformi za web sajtove specifično za nišu |
...
- **Restorani i kafe** — meniji, rezervacije, radno vrijeme, integracija dostave
- **Agenti nekretnina** — oglasi, profili agenata, vodiči po kvartima
- **Advokatske firme** — oblasti prakse, biografije advokata, rezervacija konsultacija
- **Crkve i neprofitne organizacije** — događaji, propovijedi, donacije, zajednica
- **Građevinski radnici** (vodoinstalateri, električari, HVAC) — područja usluga, rezervacije, recenzije
- **Saloni i spa centri** — usluge, rezervacije, profili stilista, galerije
- **Veterinarske klinike** — usluge, portali za ljubimce, rezervacija termina
- **Muzičke škole** — profili instruktora, raspored časova, informacije o recitalima
...
- **Validacija FitSite-a**: potvrđeno da fitnes studiji ispunjavaju sve kriterije
- **Alternativne niše**: lista drugih vertikala na koje možete primijeniti ovaj okvir

---

**Sljedeće:** [Lekcija 3: Postavljanje vaše mreže](lesson-3-setting-up) — instaliraćemo Ultimate Multisite i konfigurisaćemo temelje za FitSite.
