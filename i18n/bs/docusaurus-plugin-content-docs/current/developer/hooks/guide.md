---
title: Vodič za korištenje hookova
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Vodič za korištenje hook-ova {#hooks-usage-guide}

Ultimate Multisite nudi preko 200 action hook-ova i preko 280 filter hook-ova. Na ovoj stranici pokrivamo najčešće korištene hook-ove s praktičnim primjerima. Za kompletan, automatski generirani referencijalni pregled, pregledajte druge stranice u ovom odjeljku.

## Action Hook-ovi {#action-hooks}

### Životni ciklus korisnika {#customer-lifecycle}

#### Nakon kreiranja korisnika {#after-customer-creation}
...
### Hook-ovi za lokacije/sajtove {#site-hooks}

#### Nakon objavljivanja lokacije {#after-site-published}
...
#### Prije primjene šablona {#before-template-application}
...
### Hook-ovi za članstvo {#membership-hooks}

#### Promjena statusa {#status-transitions}
...
### Hook-ovi za plaćanje {#payment-hooks}

#### Završeno / Neuspješno plaćanje {#payment-completed--failed}
...
### Hook-ovi za naplatu (Checkout) {#checkout-hooks}

#### Prije obrade / Nakon završetka {#before-processing--after-completion}
...
### Hook-ovi za domene {#domain-hooks}
...
## Filter Hook-ovi {#filter-hooks}

### Filteri za cijene {#pricing-filters}

#### Ukupni iznos u košarici {#cart-total}
...
### Filteri za šablone {#template-filters}
...
### Filteri ograničenja {#limitation-filters}
...
### Filteri za pristupne točke (Gateway) {#gateway-filters}
...
### Polja obrasca za naplatu {#checkout-form-fields}
