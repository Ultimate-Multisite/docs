...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Preporučuje se za fotografije |
| **PNG** | `.png` | Podržava transparentnost |
...
- **Paletu boja** — dominantne boje se izvlače i koriste u temi
- **Vizuelni stil** — modern, rustikalni, minimalistički, živahan, itd.
- **Raspoloženje i atmosfera** — profesionalan, kreativan, prijateljski, luksuzan, itd.
...
- **Mood boardovi** — kolekcije slika koje predstavljaju vaš željeni izgled
- **Fotografije proizvoda** — ako imate proizvode koje želite prikazati
...
- **Slike sa puno teksta** — snimke zaslita sa mnogo teksta
...
3. **Uključite raznolikost** — mješavina boja, stila i predmeta
...
- **Tipografiju** — fontovi za naslove i tekst tijela
- **Stil rasporeda** — razmak, poravnanje i aranžman komponenti
...
1. Pregledajte generisani dizajnerski smjer
...
- [Tools and Configuration](./tools.md) — dostupni alati i opcije konfiguracije
