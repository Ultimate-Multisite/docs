...
| Uređaj | Širina | Predgled |
|--------|-------|---------|
| **Mobilni** | 375px | Portretni telefon |
| **Tablet** | 768px | Pejzažni tablet |
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — provjera pristupačnosti boja
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — kreiranje prilagođenih logoa
