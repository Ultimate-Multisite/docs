...
## Site Specification kyun istemal karein?

### Sessions mein consistency (Musawwaton ka qayam rehna)
...
### Manual Initiation (Haath se shuru karna)
...
### Step 1: Site Purpose (Site ka maqsad)
...
### Step 2: Target Audience (Nishana audience)
...
### Step 3: Brand Identity (Brand ki pehchaan)
...
### Step 4: Business Goals (Business ke maqsad)
...
### Step 5: Content Structure (Content ka tanzeem)
...
## Agents site_brief ka istemal kaise karte hain

### Design Recommendations (Design ke liye mashware)
...
### Feature Suggestions (Features ke liye mashware)
...
### Content Structure (Content ka tanzeem)
...
## Best Practices (Behtareen tareeqe)
...
### Waqt-waqay update karein (Update Regularly)
...
### Consistent terminology istemal karein
...
## Theme Builder Onboarding se talluq
