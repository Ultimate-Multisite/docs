...
## Theme Builder Onboarding Flow کیا ہے؟
...
## Theme Builder Onboarding شروع کرنا

### پہلی بار سیٹ اپ (First-Run Setup)
...
### مرحلہ 1: موڈ کا انتخاب (Mode Selection)
...
### مرحلہ 2: سائٹ کی تفصیلات (Site Specification)
...
### مرحلہ 3: ڈیزائن سسٹم کے فیصلے (Design System Decisions)
...
### مرحلہ 4: تھیم کی تیاری (Theme Generation)
...
### مرحلہ 5: فعال کرنا اور تصدیق (Activation and Verification)
...
## Site Specification اور site_brief Memory
...
## Onboarding کے بعد کسٹمائزیشن

Theme Builder onboarding مکمل ہونے کے بعد، آپ یہ کر سکتے ہیں:

### Design System Aesthetics Skill کا استعمال کرنا
...
### theme.json کو براہ راست ایڈٹ کرنا
...
## موازنہ: پرانا بمقابلہ نیا Onboarding
