...
---
# WordPress Multisite کیا ہے؟ {#what-is-wordpress-multisite}
...
## WordPress Multisite دراصل کیا ہے؟ {#what-exactly-is-wordpress-multisite}
...
## Subdomain یا Subdirectory؟ {#subdomain-or-subdirectory}
...
## Subsites میں کیا شیئر ہوتا ہے اور کیا نہیں {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite پر User Management {#user-management-on-wordpress-multisite}
