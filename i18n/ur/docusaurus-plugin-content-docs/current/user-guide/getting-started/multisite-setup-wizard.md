...
## وزرڈ کب ظاہر ہوتا ہے؟ {#when-does-the-wizard-appear}
...
## مرحلہ 1: خوش آمدید {#step-1-welcome}
...
## مرحلہ 2: نیٹ ورک کنفیگریشن {#step-2-network-configuration}

یہ مرحلہ آپ سے آپ کی نیٹ ورک سیٹنگز کنفیگر کرنے کے لیے کہتا ہے۔

### سائٹ کا ڈھانچہ {#site-structure}
...
### نیٹ ورک کا عنوان {#network-title}
...
### نیٹ ورک ایڈمن ای میل {#network-admin-email}
...
## مرحلہ 3: انسٹالیشن {#step-3-installation}
...
## دستی سیٹ اپ کا متبادل {#manual-setup-fallback}
...
### وزرڈ کہتا ہے کہ wp-config.php قابل تحریر نہیں ہے {#the-wizard-says-wp-configphp-is-not-writable}
...
### سیٹ اپ کے بعد سائٹس قابل رسائی نہیں ہیں (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### سیٹ اپ کے بعد تصدیقی مسائل {#authentication-issues-after-setup}
...
### انسٹالیشن کے دوران کوئی مرحلہ ناکام ہو گیا {#a-step-failed-during-installation}
