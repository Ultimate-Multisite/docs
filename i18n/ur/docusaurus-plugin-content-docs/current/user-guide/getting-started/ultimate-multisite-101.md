...
#### Subdomain بمقابلہ Subdirectory {#subdomain-vs-subdirectory}
...
#### پلگ انز اور تھیمز {#plugins-and-themes}
...
#### صارفین اور ایڈمنسٹریٹرز {#users-and-administrators}
...
#### صورت 1: ایک ایجنسی {#case-1-an-agency}
...
#### صورت 2: مخصوص شعبے کا فراہم کنندہ {#case-2-niche-provider}
...
#### صورت 3: WordPress ویب ہوسٹنگ {#case-3-wordpress-web-hosting}
...
### تعمیراتی تحفظات {#architecture-considerations}
...
#### بیرونی اسکرپٹس {#external-scripts}
