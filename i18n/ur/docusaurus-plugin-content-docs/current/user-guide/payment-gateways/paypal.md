...
---
# PayPal گیٹ وے کی ترتیب (v2) {#setting-up-the-paypal-gateway-v2}
...
## رہنمائی والے سیٹ اپ وزرڈ کا استعمال {#using-the-guided-setup-wizard}
...
## PayPal API اسناد حاصل کرنا {#getting-the-paypal-api-credentials}
