...
یہاں API settings صفحے کا مکمل منظر ہے:

![API settings کا مکمل صفحہ](/img/config/settings-api-full.png)
...
## Endpoint کے body parameters {#endpoint-body-parameters}
...
## Zapier میں action بنانا {#creating-an-action-in-zapier}
...
### Action بنانا {#creating-an-action}
...
### مکمل endpoint parameters {#complete-endpoint-parameters}
