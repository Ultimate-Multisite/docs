...
## What Are Theme-Aware Skills? (Theme-Aware Skills کیا ہیں؟)
...
## Available Theme-Aware Skills (دستیاب Theme-Aware Skills)

### Block Themes (بلاک تھیمز)
...
## How Skills Are Selected (Skills کا انتخاب کیسے ہوتا ہے)
...
### Switching Themes (themes تبدیل کرنا)
...
## Using Theme-Aware Skills (Theme-Aware Skills کا استعمال)
...
### Example Prompts (مثال کے prompts)
