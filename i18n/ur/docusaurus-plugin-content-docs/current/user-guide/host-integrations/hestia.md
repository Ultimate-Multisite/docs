...
---
# Hestia Control Panel انٹیگریشن {#hestia-control-panel-integration}
...
## ترتیب (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## API کال کی مثال (cURL) {#example-api-call-curl}
