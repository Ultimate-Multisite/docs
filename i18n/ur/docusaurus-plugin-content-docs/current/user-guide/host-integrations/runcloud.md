...
### 1. اپنی RunCloud API اسناد حاصل کریں {#1-get-your-runcloud-api-credentials}
...
### 2. اپنی Server اور App IDs حاصل کریں {#2-get-your-server-and-app-ids}
...
### 4. انٹیگریشن کو فعال کریں {#4-enable-the-integration}
