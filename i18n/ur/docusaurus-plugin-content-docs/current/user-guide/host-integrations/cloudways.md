...
## Setup ہدایات {#setup-instructions}

### 1. اپنی Cloudways API credentials حاصل کریں {#1-get-your-cloudways-api-credentials}
...
### 2. اپنے Server اور Application IDs حاصل کریں {#2-get-your-server-and-application-ids}
...
## اہم — Wildcard SSL خطرہ {#important--wildcard-ssl-pitfall}
...
### Ultimate Multisite network کے لیے recommended Cloudways SSL setup {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
