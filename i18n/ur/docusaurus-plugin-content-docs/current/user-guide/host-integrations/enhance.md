...
### API رسائی {#api-access}
API ٹوکنز بنانے کے لیے آپ کے پاس Enhance Control Panel کا ایڈمنسٹریٹر ایکسیس ہونا ضروری ہے۔

## اپنی API اسناد حاصل کرنا {#getting-your-api-credentials}

### 1. API ٹوکن بنائیں {#1-create-an-api-token}
...
### 2. اپنی Organization ID حاصل کریں {#2-get-your-organization-id}
...
### 3. اپنی Server ID حاصل کریں {#3-get-your-server-id}
...
### ضروری Constants {#required-constants}
...
### انٹیگریشن وزرڈ کے ذریعے سیٹ اپ {#setup-via-integration-wizard}
...
## اضافی WordPress کنفیگریشن {#additional-wordpress-configuration}
...
### .htaccess کنفیگریشن {#htaccess-configuration}
...
### جب ڈومین میپ ہوتا ہے {#when-a-domain-is-mapped}
...
### جب ڈومین ہٹایا جاتا ہے {#when-a-domain-is-removed}
...
### DNS اور SSL کی جانچ {#dns-and-ssl-checking}
...
## سیٹ اپ کی تصدیق {#verifying-setup}

### کنکشن ٹیسٹ کریں {#test-the-connection}
...
### ڈومین میپ کرنے کے بعد {#after-mapping-a-domain}
...
### DNS چیک انٹرول {#dns-check-interval}
...
### Authentication کی خرابیاں {#authentication-errors}
...
### استعمال ہونے والے عام Endpoints {#common-endpoints-used}
...
### مکمل API دستاویزات {#full-api-documentation}
