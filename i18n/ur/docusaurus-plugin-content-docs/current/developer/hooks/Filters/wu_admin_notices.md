...
| نام | قسم | تفصیل |
|------|------|-------------|
| $notices | `array` | اس مخصوص پینل کے نوٹس کی فہرست۔ |
| $all_notices | `array` | شامل کیے گئے نوٹس کی فہرست، جو پینل کے حساب سے الگ کیے گئے ہیں۔ |
| $panel | `string` | وہ پینل جہاں سے نوٹس حاصل کرنے ہیں۔ |
