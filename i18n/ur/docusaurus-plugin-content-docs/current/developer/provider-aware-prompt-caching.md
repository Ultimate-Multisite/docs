...
### کیش شدہ پرامپٹ بنانا (Creating a Cached Prompt)
...
### کیش شدہ پرامپٹ استعمال کرنا (Using a Cached Prompt)
...
### Gemini کے لیے بہترین طریقے (Best Practices for Gemini)
...
### کیشنگ کو فعال کرنا (Enabling Caching)
...
### کیش کے استعمال کی نگرانی کرنا (Monitoring Cache Usage)
...
### Azure OpenAI کے لیے بہترین طریقے (Best Practices for Azure OpenAI)
...
### OpenRouter کیشنگ استعمال کرنا (Using OpenRouter Caching)
...
### فراہم کنندہ کے مخصوص آپشنز (Provider-Specific Options)
...
### OpenRouter کے لیے بہترین طریقے (Best Practices for OpenRouter)
...
### Vertex Anthropic کیشنگ استعمال کرنا (Using Vertex Anthropic Caching)
...
### کیش کنٹرول کی اقسام (Cache Control Types)
...
### Vertex Anthropic کے لیے بہترین طریقے (Best Practices for Vertex Anthropic)
...
## فراہم کنندہ کے درمیان کیشنگ کی حکمت عملی (Cross-Provider Caching Strategy)

### متحد کنفیگریشن (Unified Configuration)
...
### فراہم کنندہ کی شناخت (Provider Detection)
...
### فال بیک حکمت عملی (Fallback Strategy)
...
## لاگت کو بہتر بنانا (Cost Optimization)

### بچت کا حساب لگانا (Calculate Savings)
...
### بہتری کے نکات (Optimization Tips)
...
### کیش استعمال نہیں ہو رہا (Cache not being used)
...
### کیش بنانے میں ناکامی (Cache creation failing)
...
### غیر متوقع اخراجات (Unexpected costs)
...
## فراہم کنندہ کا موازنہ (Provider Comparison)
