...
---
# تبدیلیوں کا ریکارڈ (Changelog) {#changelog}

## 1.9.0 — جاری کیا گیا: 2026-04-28 {#190--released-on-2026-04-28}
...
### بہتر کیا گیا (Improved) {#improved}
...
## 1.4.0 — جاری کیا گیا: 2026-04-09 {#140--released-on-2026-04-09}

### نئی خصوصیات (New) {#new-1}
