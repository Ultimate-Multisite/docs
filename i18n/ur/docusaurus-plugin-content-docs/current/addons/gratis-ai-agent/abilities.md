...
## حسبِ ضرورت پوسٹ اقسام {#custom-post-types}
...
## حسبِ ضرورت Taxonomies {#custom-taxonomies}
...
## نیویگیشن مینو {#navigation-menus}
...
## قابلِ نصب صلاحیتیں {#installable-abilities}
