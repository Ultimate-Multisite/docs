...
## دستیاب Tools {#available-tools}

### Tier 1 Tools (ہمیشہ دستیاب) {#tier-1-tools-always-available}
...
### Tier 2 Tools (اختیاری) {#tier-2-tools-optional}
...
### Advanced Companion Tools (علیحدہ Package) {#advanced-companion-tools-separate-package}
...
### Tools کو فعال کرنا {#enabling-tools}
...
### API Keys اور Credentials {#api-keys-and-credentials}
...
### Advanced Companion Package انسٹال کرنا {#installing-the-advanced-companion-package}
...
## sd-ai-agent/site-scrape کا استعمال {#using-sd-ai-agentsite-scrape}
...
## Tool Limitations and Considerations {#tool-limitations-and-considerations}
...
### قانونی اور اخلاقی امور {#legal-and-ethical-considerations}
...
### Site Analysis کا استعمال {#using-site-analysis}
...
### اخلاقی Scraping {#ethical-scraping}
...
### Tool کی مؤثریت کو زیادہ سے زیادہ کرنا {#maximizing-tool-effectiveness}
...
### Site Scrape نہیں ہو رہا {#site-wont-scrape}
...
### نامکمل تجزیہ {#incomplete-analysis}
