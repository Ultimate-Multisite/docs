...
- Validera och sanera all inkommande payload-data innan du agerar på den.
- Returnera lämpliga HTTP-statuskoder (200 för framgång, 400 för felaktiga förfrågningar).
