---
title: Översätta Ultimate Multisite
sidebar_position: 19
...
Det här är WordPress standardsystem för gemenskapsöversättningar. När översättningar når en tillräcklig godkännandenivå distribueras de automatiskt till alla Ultimate Multisite-användare via WordPress pluginuppdateringar.

**Vi behöver din hjälp!** Om du talar ett annat språk än engelska, överväg gärna att bidra med översättningar. Även om du bara översätter några få strängar gör det nytta. Så här kommer du igång:

1. Besök [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Välj ditt språk
3. Klicka på "Contribute Translation"
4. Du behöver ett kostnadsfritt WordPress.org-konto
...
1. Ladda ner Poedit från [poedit.net](https://poedit.net)
2. Öppna `.pot`-filen från `wp-content/plugins/ultimate-multisite/lang/`
3. Översätt strängarna i Poedits gränssnitt
