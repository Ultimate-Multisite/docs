...
## Vad ändras för administratörer {#what-changes-for-administrators}
...
## Besökande av en suverän hyresgäst {#visiting-a-sovereign-tenant}
...
## Kontrolllista för fjärrplatsoperationer {#remote-site-operations-checklist}

Innan du ändrar en suverän eller fjärrplatshyresgäst, bekräfta:

## Radera suveräna tenants {#deleting-sovereign-tenants}
