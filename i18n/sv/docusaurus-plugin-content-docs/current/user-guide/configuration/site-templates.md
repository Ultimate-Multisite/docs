...
## Skapa och redigera en ny Site Template
...
### Anpassa innehållet i en Site Template
...
#### Läge 2: Välj tillgänglig Site Template
...
### Standardläge: Val av Site Template i Checkout-formuläret
...
#### Tillåt användare att använda sin webbplats som mallar
...
#### Kopiera media vid duplicering av mall
