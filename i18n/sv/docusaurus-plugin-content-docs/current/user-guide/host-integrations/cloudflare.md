...
### 1. Hämta din Cloudflare API-nyckel {#1-get-your-cloudflare-api-key}
...
### 2. Hämta ditt Zone ID {#2-get-your-zone-id}
...
### Hantering av subdomäner {#subdomain-management}
...
### Visning av DNS-poster {#dns-record-display}
...
### Hur det skiljer sig från standardintegrationen med Cloudflare {#how-it-differs-from-the-standard-cloudflare-integration}
...
### Konfigurera Cloudflare Custom Hostnames {#setting-up-cloudflare-custom-hostnames}
...
### Subdomän inte tillagd {#subdomain-not-added}
...
### Proxying-problem {#proxying-issues}
