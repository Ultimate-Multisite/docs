...
| Enhet | Bredd | Förhandsvisning |
|--------|-------|---------|
| **Mobil** | 375px | Porträtttelefon |
| **Surfplatta** | 768px | Landskapsorienterad surfplatta |
...
- **Verifiera kontrasten** — använd [Validate Palette Contrast](../abilities/validate-palette-contrast.md) för tillgänglighet
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — kontrollera färgtillgänglighet
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — skapa anpassade logotyper
