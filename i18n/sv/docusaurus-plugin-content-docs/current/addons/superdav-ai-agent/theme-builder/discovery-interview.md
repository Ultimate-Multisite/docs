...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Rekommenderas för fotografier |
| **PNG** | `.png` | Stöder transparens |
...
- **Färgpalett** — dominerande färger plockas ut och används i temat
- **Visuell stil** — modern, rustik, minimalistisk, livlig, etc.
- **Stämningsläge och atmosfär** — professionell, kreativ, vänlig, lyxig, etc.
...
- **Moodboards** — samlingar av bilder som representerar din önskade estetik
- **Produktbilder** — om du har produkter att visa upp
...
- **Texttunga bilder** — skärmdumpar med mycket text
...
3. **Inkludera variation** — en blandning av färg, stil och motiv
...
- **Färgpalett** — primära, sekundära och accentfärger
- **Typografi** — typsnittsfamiljer för rubriker och brödtext
- **Layoutstil** — avstånd, justering och komponentarrangemang
...
1. Granska den genererade designriktningen
2. Ge feedback eller begär justeringar
...
- [Tools and Configuration](./tools.md) — tillgängliga verktyg och konfigurationsalternativ
