...
* Nytt: Förvalda underwebbplatser för mallwebbplatser
* Nytt: Extraktion av media från post_content för alla innehållstyper
* Nytt: Synkronisering av taksonomier (kategorier, taggar, anpassade taksonomier)
* Ändrat: Bytt namn från "Elementor Template Sync" till "Content Sync"
...
* Fullständig mediasynkronisering med automatisk ID-ommappning
* Integrering av inställningar med Ultimate Multisite
* Stöd för att exkludera sajter via nätverksinställningar
* Rensa Elementor-cache efter synkronisering
* Bevarande av taksonomier för mallar
