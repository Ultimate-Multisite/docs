...
Iki ni uburyo bwo guhindura bw'umuganda w'Umuganda (WordPress) w'ubwujgwa. Iyo ubindura zishobora kugera ku gihe cy'ubwumvikane, zihindurwa mu buryo bwo gukoresha n'abantu bose bashobora gukoresha Ultimate Multisite binyuze mu gihe cy'ubushobozi bw'Umuganda.

**Turimo ubufasha wanyu!** He ugiye mu kinyarwanda cyangwa uburyo bwo guhindura bukwiye, nshobora kwibanda ku gukoresha ubindura. Icyo gusa gishobora gushyira umuhombo. Kugenzura:

1. Gukoresha [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Gutera igice cy'urasi (language) rwawe
3. Gukoresha "Contribute Translation"
4. Uziho uburyo bwo gushyira aka konto cy'Umuganda (WordPress.org) cyane
...
1. Download Poedit ku [poedit.net](https://poedit.net)
2. Gukoresha ifayile `.pot` y'uko `wp-content/plugins/ultimate-multisite/lang/`
3. Handika amagambo (strings) mu interface ya Poedit
