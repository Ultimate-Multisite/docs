...
---
# Urugero ku Gukoresha Site Builder Mode
...
## Iyo Wari Ugiye Gukoresha Site Builder Mode

### Sites Yawe Zishobora Gutera
...
### Gukoresha Setup Assistant Agent
...
## Urugero: Site Builder vs. Setup Assistant
...
## Gutera ku Setup Assistant Agent
...
### Ku bw'ibyo bishobora (For Existing Sites)
...
### Ku bw'ibyo bishobora (For Theme Changes)
...
## Icyemezo cy'ibintu (Key Differences)
...
## Icyemezo cy'ibintu (Benefits of Setup Assistant Agent)

### Ubwujobozi bwiza (More Flexible)
...
### Uburyo bwo gukoresha bwiza (Better Customization)
...
### Ubwujobozi bwihariye (Persistent Memory)
...
### Uburyo bwo gukora bwihariye (Integrated Workflow)
...
## Gukoresha ibintu by'ubwujobozi (Troubleshooting)

### Nta site ya Site Builder mode

Site Builder mode yagizeye. Usa Setup Assistant agent:

"Nshibujwe kugira uburyo mushya"

### Nshaka kubaka umuryo w'umuryo w'umuryo ku gukoresha Site Builder
...
### Umuryo wako w'Site Builder uyu munsi n'ubwujumbura bwawe n'ubwo bishobora gukora
...
### Nshobora gukoresha templates za Site Builder za mbere?
