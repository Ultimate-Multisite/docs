...
## Icyo Gishobora Kwibuka Mu gihe runaka? {#when-does-the-wizard-appear}
...
## Icyo Gishobora Kwibuka (Prerequisites) {#prerequisites}
...
## Icyemezo 1: Urugero (Welcome) {#step-1-welcome}
...
## Icyemezo 2: Uburyo bwo Gutera Umuganda (Network Configuration) {#step-2-network-configuration}

Icyemezo cyo gishobora kuguha ko ugomba gukora ibyo by'umwihariko mu gutera amakuru y'Umuganda (network settings).

### Ubushobozi bw'Uburyo bwo Gutera Umusaruro (Site Structure) {#site-structure}
...
### Umuco w'Ubwoko (Network Title) {#network-title}
...
### Email ya Umuko w'Ubwoko (Network Admin Email) {#network-admin-email}
...
## Icyemezo 3: Gutera (Installation) {#step-3-installation}
...
## Etappe ya 4: Gukemura {#step-4-complete}
...
## Uburyo bwo gutera umuntu (Manual Setup Fallback) {#manual-setup-fallback}
...
## Gukoresha uburyo bwo gutera umuntu (Troubleshooting) {#troubleshooting}

### Icyemezo cy'wizard cyamukira ko wp-config.php siho cyangwa sihoro {#the-wizard-says-wp-configphp-is-not-writable}
...
### Sites sihoro cyangwa sihoro arizo (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Icyemezo cy'authentication nyuma y'gukora {#authentication-issues-after-setup}
...
### Icyemezo cy'umugambi cyashoboye gukora mu gihe cy'gukora {#a-step-failed-during-installation}
