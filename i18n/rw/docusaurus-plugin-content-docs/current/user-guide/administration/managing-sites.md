...
- **Customer-owned** — Sites yashobora abakoresha b'abakoresha b'umukono
...
- **Site Title** — Izina ry'izi site shya shya
- **Site URL** — Domain/path ya site
- **Site Type** — Iyo ni site y'umukono, template, cyangwa site yakomeye
...
- **Visit limits** — Icyo ni ukomeye cy'ubwumvikane bwa site
- **User account limits** — Icyo ni ukomeye cy'ubwumvikane ku ruhande rw'umuntu (per user role)
- **Disk space** — Ubushobozi bw'ubwumvikane bwa sita
- **Custom domain** — Gukoresha uburyo bwo gukoresha domain yose kuri site y'izi
- **Plugin and theme visibility** — Guhindura ibyo plugins n'themes shobora kubona, gufata (hide), cyangwa gufasha (pre-activate)
...
- **Mapped domains** zikoreshwa n'site
...
- **Gukora/Kugira gukora site** bishobora gukorwa ku button ya toggle
- **Gukoresha site type** cyangwa gukoresha umuntu wese (reassign ownership)
- **Gukora sita image/thumbnail** (izwiho mu gihe cyo gukoresha templates za site)
- **Kugira gukorwa site** mu buryo bw'umwihariko

:::warning
Kugira gukorwa site ni ikintu cy'umwihariko. Site yose n'ubwoko bwo site bishobora guhagararirwa mu gihe cyose.
:::
