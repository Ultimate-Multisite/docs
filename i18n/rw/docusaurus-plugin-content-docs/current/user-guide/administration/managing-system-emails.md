---
title: Gukemura Email za System
sidebar_position: 13
...
Kugenda hano, uza kumenya ipfupi y'System Emails page kugira ngo ubone email templates nyose:

![System Emails list](/img/admin/system-emails-list.png)

Ushobora kandi gukora ibindi ku email templates zikomeye cyangwa ugukoresha system email editor kugira ngo uzi uko yifashishijwe:
...
Kugira ngo uburyo bwo gukoresha email templates zishya:

1. Genda ku System Emails page
2. Gukora kuri button ya **Reset & Import** y'ingenzi ku gihe cy'page
...
1. **Gusubiza no Gukoresha (Delete and re-import)** — Gusubiza system email kenshi gukoresha cyane (iki gikorwa kigabanya send metrics)
2. **Guhindura bishobora mu tool** — Gukoresha **Reset & Import** tool, gukoresha option ya **Reset**, kandi ukwibanda emails ugiye guhindura

Option ya Reset ni yiza cyane kubera ko ituma ibyo byo bikomeye (send metrics) n'ibindi byo bifite umwanya bwo kwerekana, mu gihe cy'ubwoko runaka.
