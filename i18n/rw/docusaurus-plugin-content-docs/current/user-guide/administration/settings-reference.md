...
## Gutanga raporo z’amakosa na telemetry {#error-reporting-and-telemetry}
...
## Imiterere ya Import/Export {#importexport-settings}
...
## Umuburo w’amafaranga make ya Domain Seller HostAfrica {#domain-seller-hostafrica-balance-warning}
...
## Imiterere y’imihuza ya AI provider {#ai-provider-connector-settings}
