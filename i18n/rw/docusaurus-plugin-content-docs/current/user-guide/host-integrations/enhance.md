...
### Ingozi z'Umucozo (System Requirements)
...
### Gukira Uburyo bishobora ku Ubwumvikane (Integration Wizard)
...
## Uburyo Bwo Gukora Icyemezo Cy'WordPress (Additional WordPress Configuration)
...
### Gukoresha .htaccess Configuration
...
### Icyemezo cy'Cookie (Cookie Constants)
...
## Icyemezo Cy'Uburyo Bwo Gukora (How It Works)

### Iyo Domain Ikenye (When a Domain is Mapped)
...
### Iyo Domain Iragurwa (When a Domain is Removed)
...
## Gukora Icyemezo (Verifying Setup)

### Gutera Urugendo (Test the Connection)
...
### Icyo mu Ubushobozi bw'API Connection Issues
...
### Icyo Cy'Ubutabera (Domain Not Added)
...
### Icyo Cy'SSL Certificate Issues
...
### Uburyo bwo guhindura (Authentication Errors)
...
## API Reference (Uburyo bwo guhindura uburyo bwo gukoresha API)
...
### Endpoints Zishobora Gukoreshwa (Common Endpoints Used)
...
### Uburyo bwo guhindura uburyo bwo gukoresha API (Full API Documentation)
Uburyo bwose bwo guhindura uburyo bwo gukoresha API: [https://apidocs.enhance.com](https://apidocs.enhance.com)

## Uburyo bwo Gukora Icyemezo (Best Practices)
...
## Icyiciro cyo gukoresha ibindi (Additional Resources)
