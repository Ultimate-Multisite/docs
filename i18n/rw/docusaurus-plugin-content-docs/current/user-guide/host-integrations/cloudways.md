...
## Inshingano zo Gukora (Setup Instructions)

### 1. Gukoresha Uburyo bwo API Credentials yawe ya Cloudways
...
### 2. Gukoresha ID yawe ya Server na Application
...
### 3. Gutera Icyemezo mu wp-config.php
...
### 4. Gukoresha Icyemezo (Enable the Integration)
...
### Gukoresha Domains (Domain Syncing)
...
### Uporoko rwa SSL Certificate (SSL Certificate Management)
...
## Icyemezo — Ubushobozi bwo SSL ya Wildcard ku Cloudways
...
### Ubushobozi bwo SSL ku Cloudways kugira ngo Urugendo rwa Ultimate Multisite ryitokeze
...
### Icyemezo cyo Gutangira n'API Connection Issues
