...
## Inshingiro yo gukora (Setup Instructions) {#setup-instructions}

### 1. Gukoresha ubutaka bwawe bwo cPanel {#1-get-your-cpanel-credentials}
...
### 2. Gufasha ibyo byo mu wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Gukoresha Icyishwe (Enable the Integration) {#3-enable-the-integration}
...
## Uburyo Bwo Gutera {#how-it-works}

### Addon Domains (Domains Zishobora Kubyara) {#addon-domains}
...
## Gutera Icyemezo (Troubleshooting) {#troubleshooting}
