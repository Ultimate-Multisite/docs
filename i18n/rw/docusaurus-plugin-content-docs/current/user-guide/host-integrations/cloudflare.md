...
## Inama y'Ubwihutiriramo

### 1. Gukoresha API Key yawe ya Cloudflare
...
### 3. Gutera Amakuru mu wp-config.php
...
## Icyo Kintu Cyiza Cyabone

### Umuco w'ubwoko (Subdomain Management)
...
### Uburyo bwo gukunda ibintu ku itangira (How it differs from the standard Cloudflare integration)
...
### Guhindura Cloudflare Custom Hostnames
