...
## Inshingano zo Gutangira (Setup Instructions)

### 1. Gukoresha Amakuru ya ServerPilot API
...
### 3. Gutangira Amakuru mu wp-config.php
...
### 4. Gutangira Umuhagariko (Enable the Integration)
...
## Icyemezo cyo Guhagarika (How It Works)

### Umuhagariko w'ibindi (Domain Syncing)
...
### Gukoresha SSL Certificate Management
...
## Gukoresha SSL Certificate Verification
...
### Icyemezo ku Gutangira mu API Connection Issues
...
### Icyemezo ku SSL Certificate Issues
...
### Domain Ntari Yagira Mu Giciro (Domain Not Added)
