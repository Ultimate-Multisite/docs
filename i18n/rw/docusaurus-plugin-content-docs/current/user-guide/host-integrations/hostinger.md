...
---
# Urugererine (hPanel) Integration
...
## Inshingano z'Urugererine

### 1. Gukora Token ya API ya Hostinger Yawe
...
### 2. Gutangira Umukono W'Ubwumuri Bwawe
...
### 3. Gutera Inyandiko ku wp-config.php
...
### 4. Gukoresha Integration (Enable the Integration)
...
### Addon Domains (Domains Zishobora Kumenya)
...
## Gukora Icyo Cyiza (Troubleshooting)
...
### Domain Itashoboraga Kurushwa (Domain Not Added)
...
### Icyemezo cy'SSL Certificate (SSL Certificate Issues)
