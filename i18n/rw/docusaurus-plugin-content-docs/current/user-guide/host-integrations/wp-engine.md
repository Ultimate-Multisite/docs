...
## Inshingiro z'Urugerer (Setup Instructions)

### 1. Gukora Icyemezo ku Plugin ya WP Engine
...
### 2. Gukora Urugerer (Enable the Integration)
...
## Uburyo Bwo Gukora (How It Works)
...
### Wildcard Domains (Domains zishobora guhindurwa)
...
### SSL Certificates (Certificates za SSL)
...
## Guhagarara Icyo Hari Ikibazo (Troubleshooting)
