...
## Icyiciro cy'Ubwumelera (Features)
...
## Inshuro z'Ubwumelera (Setup Instructions)

### 1. Gushyira Uburyo bwo gukoresha API Key yawe ya Closte
...
### 2. Gukora Ubwumelera (Enable the Integration)
...
## Gukora Icyemezo cy'Urundi (Domain Record Creation)
...
### Domain Itarashyirwe (Domain Not Added)
...
### Icyubahiro ry'DNS Check Interval
