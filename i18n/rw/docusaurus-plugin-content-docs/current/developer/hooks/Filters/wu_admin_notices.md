---
id: wu_admin_notices
title: Akayunguruzo - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Urutonde rwa notices z’iyo panel yihariye. |
| $all_notices | `array` | Urutonde rwa notices zongerwamo, zatandukanijwe hakurikijwe panel. |
| $panel | `string` | Panel yo kugaruramo notices. |
