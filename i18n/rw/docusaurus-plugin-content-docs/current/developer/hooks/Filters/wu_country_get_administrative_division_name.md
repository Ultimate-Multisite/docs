...
title: Akayunguruzo - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Izina ry’igice. Akenshi riba ari nk’intara, province, akarere, n’ibindi. |
| $country_code | `string` | Kode ya ISO y’inyuguti ebyiri y’igihugu. |
| $state_code | `string` | Kode ya ISO y’inyuguti ebyiri ya state. |
