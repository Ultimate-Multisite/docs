---
title: Ingero za kode ziteye imbere
sidebar_position: 1
...
Requests ebyiri zibereye icyarimwe zishobora gusoma agaciro kamwe, zombi zigashyiramo igisubizo kimwe cyongeweho, bigatuma count imwe itakara. `increment_item()` iha database engine inshingano zo gukora imibare ikoresheje interuro imwe ya `UPDATE ... SET column = column + ?`, bigatuma icyo gikorwa kiba atomic muri kamere yacyo.
