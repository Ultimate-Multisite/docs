---
title: 'Isomo rya 9: Gushyiraho ibiciro hagamijwe inyungu'
sidebar_position: 10
...
- Urubuga rwa fitness rw'umwuga rwari gutwara $2,000-$5,000 kurwubaka rwihariye
- Kubungabunga, kuvugurura, n'umutekano bihoraho batagomba gutekerezaho
- Ibiranga byihariye ku cyiciro cyabo generic builders badatanga
- Icyizere cy'urubuga rwubakiwe inganda zabo
...
- **Guha akazi web developer**: $2,000-$5,000 mbere + $50-$100/ukwezi yo kubungabunga
- **Wix/Squarespace**: $16-$45/ukwezi ariko nta biranga byihariye bya fitness, babyiyubakira ubwabo
- **Kutagira icyo bakora**: Abanyamuryango babuze kubera ko batabasha kubasanga online
...
| Gahunda | Ku kwezi | Umwaka (ku kwezi) | Igiteranyo cy'Umwaka | Kuzigama |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mo | $39/mo | $468/year | 20% igabanyijwe |
| Growth | $99/mo | $79/mo | $948/year | 20% igabanyijwe |
| Pro | $199/mo | $159/mo | $1,908/year | 20% igabanyijwe |
...
- **Starter**: Nta mafaranga yo gutangiza (kuraho inzitizi zo gutangira)
- **Growth**: $99 amafaranga yo gutangiza (yishyura ishyirwaho rya custom domain n'inama y'ibanze)
- **Pro**: $299 amafaranga yo gutangiza (yishyura ishyirwaho ry'ahantu henshi n'ikiganiro cyo kwakira umukiriya)
...
- **Igerageza ry'ubuntu ry'iminsi 7** kuri gahunda ya Starter gusa
- Nta igerageza kuri Growth na Pro (aba bakiriya baba biyemeje kurushaho kandi biteze kwishyura)
...
- **FITLAUNCH** -- 30% igabanyijwe ku mezi 3 ya mbere (ku bukangurambaga bwo gutangiza)
- **ANNUAL20** -- 20% igabanyijwe kuri gahunda z'umwaka (niba bitaragabanyijwe)
- **REFERRAL** -- Ukwezi 1 k'ubuntu (ku bo abakiriya bazanye)

Jya kuri **Ultimate Multisite > Kode z'Igabanyirizwa** kugira ngo uzikore. Reba [Gukora Kode z'Igabanyirizwa](/user-guide/configuration/creating-discount-codes) ku muyobozi wuzuye.

:::tip Ntugatange Igabanyirizwa Mburabuzi
...
1. Tunganya ibipimo by'imisoro muri **Ultimate Multisite > Igenamiterere > Imisoro**
2. Shyira ibyiciro by'imisoro kuri gahunda zawe
3. Menya neza ko inyemezabuguzi zigaragaza umusoro neza
...
- **Igipimo cyo guhinduka umukiriya kuri buri gahunda**: Niba Starter ihindura neza ariko Growth ntibikore, ikinyuranyo hagati yabyo gishobora kuba kinini cyane
- **Igipimo cyo kuzamura gahunda**: Niba abakiriya bake ari bo bava kuri Starter bajya kuri Growth, gahunda ya Growth ishobora kuba idatanga agaciro k'inyongera gahagije
...
├── Ultimate Multisite (byatunganyijwe + byahawe ishusho y'ikirango)
├── Domain y'Urubuga (fitsite.com + wildcard SSL)
├── Inyandikorugero za Site (Studio Essential, Gym Pro, Fitness Chain)
├── Products
│   ├── FitSite Starter ($49/mo cyangwa $468/yr) + igerageza ry'iminsi 7
│   ├── FitSite Growth ($99/mo cyangwa $948/yr) + $99 amafaranga yo gutangiza
│   ├── FitSite Pro ($199/mo cyangwa $1,908/yr) + $299 amafaranga yo gutangiza
│   └── Order Bumps + Kode z'Igabanyirizwa
├── Uruhererekane rwo Kwishyura (rurimo toggle yo guhitamo igihe)
├── Ishusho y'Ikirango (kwinjira, dashboard, emails, inyemezabuguzi, site yo kwamamaza)
├── Kwakira Umukiriya (Gutangira Vuba, emails, ibikoresho by'ubufasha)
├── Ingamba z'Ibiciro
│   ├── Amagabanyirizwa y'umwaka (20% igabanyijwe)
│   ├── Amafaranga yo gutangiza yateguwe mu ngamba
│   ├── Igerageza ry'iminsi 7 kuri Starter
│   ├── Kode z'igabanyirizwa z'ubukangurambaga n'abazanywe n'abakiriya
│   └── Itunganya ry'imisoro
...
- **Igihe cy’igerageza** kuri plan yo ku rwego rwo gutangira kugira ngo kugabanya inzitizi zo kwiyandikisha
- **Kode z’igabanyirizwa z’ingenzi mu ngamba** zo gutangiza, referrals, na campaigns
- **Igenamiterere ry’imisoro** kugira ngo kwishyuza kubahirize amategeko
- **Urwego rwo gusuzuma ibiciro** rwo gukomeza kunoza

---

**Ibikurikira:** [Isomo rya 10: Umunsi wo Gutangiza](lesson-10-launch) -- urutonde rw’ibisuzumwa mbere yo gutangiza no kujya live.
