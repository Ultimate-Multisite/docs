...
- **Isesengura ry’urubuga** — gukurura no gusesengura imbuga z’abahanganye cyangwa izitanga igitekerezo
- **Gukuramo igishushanyo** — kumenya amabara, imyandikire, n’imiterere y’imitunganyirize
- **Imiterere y’ibikubiyemo** — gusobanukirwa uko amapaji atunganijwe n’inzego zayo
- **Kumenya ibiranga imikorere** — kumenya plugins n’imikorere
- **Isesengura ry’umuvuduko n’imikorere** — kugenzura umuvuduko w’ipaji n’itunganywa ryayo
- **Isesengura rya SEO** — gusuzuma meta tags n’amakuru afite imiterere

**Imikoreshereze:**

```
Sesengura igishushanyo cya example.com maze ugikoreshe nk’igitekerezo cy’urubuga rwanjye.
```

**Ibyo Ikuramo:**

- Urutonde rw’amabara n’uko amabara akoreshwa
- Imyandikire (fonts n’ingano)
- Imiterere y’imitunganyirize n’intera hagati y’ibice
- Uburyo bwo kugendagenda
- Uko ibikubiyemo bitunganijwe
- Amashusho n’imikoreshereze y’ibitangazamakuru
- Ibintu bikorana n’umukoresha
- Uko bikora kuri telefoni

**Imipaka:**

- Ntishobora gukurura imbuga zirinzwe n’ijambo ry’ibanga
- Yubahiriza robots.txt na politiki z’urubuga
- Ishobora kudafata ibikubiyemo bihinduka
...
- Uburyo bwo gusomeka
- Itunganywa rya SEO
- Imikoreshereze y’amagambo shingiro
...
- Gutanga Custom CSS
- Gukora animation
- Gutegura ibintu bikorana n’umukoresha
...
Ubushobozi bwa Advanced companion bushobora kubamo:

- **Ibikoresho bya filesystem** — gusuzuma no guhindura amadosiye yemerewe mu bidukikije byizewe
- **Ibikoresho bya database** — kubaza cyangwa kuvugurura amakuru y’urubuga iyo byemewe ku buryo bweruye
- **Ibikoresho bya WP-CLI** — gukoresha amategeko yo kubungabunga no gusuzuma WordPress
- **Ibikoresho bya REST dispatcher** — guhamagara REST endpoints zanditswe binyuze mu mikorere igenzurwa yo kohereza
- **Ibikoresho byo kubaka plugin** — gutangiza ishingiro no kunoza code ya plugin
- **Ibikoresho bya Git snapshot** — gukora snapshots mbere y’ibikorwa by’abatekinisiye bishobora guteza ibyago
- **Ibikoresho byo gucunga abakoresha** — gufasha gusuzuma cyangwa guhindura records z’abakoresha aho byemewe
- **Ibikoresho bya benchmark** — gukoresha benchmarks z’imikorere cyangwa z’ubushobozi hagamijwe isuzuma ry’iterambere
...
1. Jya kuri **Gratis AI Agent → Settings**
2. Jya kuri **Theme Builder → Tools**
...
- **Gukurura amakuru y’urubuga** — bisaba kugera kuri internet
- **Isesengura** — bisaba guhuza na Google Analytics
- **Gutanga ibikubiyemo** — bisaba API keys
...
1. Jya kuri **Gratis AI Agent → Settings → API Keys**
2. Injiza ibyangombwa bya buri gikoresho
3. Gerageza ihuza
...
```
Sesengura igishushanyo cy’urubuga rw’uwo duhanganye kuri competitor.com
...
```
Kuramo urutonde rw’amabara muri example.com maze urukoreshe nk’igitekerezo.
```

```
Sesengura imiterere yo kugendagenda ya example.com kandi ukoreshe imitunganyirize isa na yo
ku rubuga rwanjye.
```

```
Genzura uko example.com ikora kuri telefoni kandi wizere ko urubuga rwanjye
rukora neza kimwe.
```
...
```
Gereranya ibishushanyo bya site1.com na site2.com maze ukore igishushanyo
...
- Koresha isesengura nk'inkomoko y'ibitekerezo, si ugukoporora
...
3. **Kuramo amabara** — koresha amatsinda y'amabara nk'aho uhera
...
3. **Genzura uburenganzira** — menya neza ko ushobora gukoresha ibirimo byakuweho
...
3. **Shyiraho ibyitezwe** — sobanura intego zawe z'igishushanyo
...
- Imbuga nini zishobora kurangiza igihe cyagenwe
...
- [Menus z'Ubwakiranyi](./hospitality-menus.md) — kora paji za menu
