---
title: Urutonde rw’impinduka rwa Ultimate AI Connector ku mpera zihujwe
sidebar_position: 99
...
* Gukosora: Provider card nshya ubu ihita yaguka iyo yongewe; gukuraho cache ya script igihe plugin ivugururwa.
* Gukosora: Dynamic provider class namespace ya eval() n’imyitwarire yo guhita yaguka ku batanga serivisi bashya bongewe.
* Gukosora: Ikoresha components za Card/CardBody/CardHeader/CardDivider zihamye (zitakiri iz’igerageza) kugira ngo ihuze na WordPress 6.9+.
* Gukosora: Yasimbuje DragHandle idasobanuwe unicode grip icon yo gukurura provider kugira ngo uhindure urutonde.
