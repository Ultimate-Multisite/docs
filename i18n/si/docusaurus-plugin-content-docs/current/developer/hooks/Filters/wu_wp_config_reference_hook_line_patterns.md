...
title: පෙරහන - wu_wp_config_reference_hook_line_patterns
...
[`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) හි 143 වන පේළියේ අර්ථ දක්වා ඇත.
