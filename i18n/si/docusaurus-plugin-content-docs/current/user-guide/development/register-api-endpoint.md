...
## Zapier හි ක්‍රියාවක් (Action) නිර්මාණය කිරීම {#creating-an-action-in-zapier}
...
### ක්‍රියාවක් නිර්මාණය කිරීම {#creating-an-action}
...
### සම්පූර්ණ අවසාන ලක්ෂ්‍යพරාමිතීන් (Complete endpoint parameters) {#complete-endpoint-parameters}
