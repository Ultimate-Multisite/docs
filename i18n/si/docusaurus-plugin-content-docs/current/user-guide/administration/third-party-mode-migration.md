...
### අතින් ක්‍රියාත්මක කරන මාදිලිය (Manual Mode)
...
## ඔබේ වත්මන් මාදිලිය පරීක්ෂා කිරීම

### පරිපාලක පැනලය හරහා (Via Admin Panel)
...
## ඔබේ මාදිලිය වෙනස් කිරීම

### Auto Mode වෙත මාරු වීම
...
## Auto Mode හි ප්‍රතිලාභ

### ස්වයංක්‍රීය සොයාගැනීම (Automatic Discovery)
...
### දේශීය ඒකාබද්ධතාව (Native Integration)
...
### සරල කළ කළමනාකරණය (Simplified Management)
...
### වඩා හොඳ කාර්ය සාධනය (Better Performance)

- Abilities cache කර ඇත
- අවශ්‍ය වූ විට Lazy-loaded වේ
- WordPress 7.0+ සඳහා ප්‍රශස්ත කර ඇත

## සංක්‍රමණ මාර්ගය (Migration Path)

### ඔබ WordPress 6.x හි සිටී නම්
...
### auto mode හි abilities load නොවේ නම්
...
### මට legacy mode එක තබා ගැනීමට අවශ්‍ය නම්
...
### මගේ කස්ටම් හැකියාවන් පෙන්වන්නේ නැහැ
...
### මට "unclassified ability" (වර්ගීකරණය නොකළ හැකියාව) පිළිබඳ දැනුම්දීම් ලැබෙනවා
...
## පසුගාමී අනුකූලතාව (Backward Compatibility)

### පවතින සැකසුම් (Existing Configurations)
...
### අත්හැරීමේ කාලරට (Deprecation Timeline)
...
### නව ස්ථාපනයන් සඳහා (For New Installations)
...
### පවතින ස්ථාපනයන් සඳහා (For Existing Installations)
...
### කස්ටම් හැකියාවන් සඳහා (For Custom Abilities)
