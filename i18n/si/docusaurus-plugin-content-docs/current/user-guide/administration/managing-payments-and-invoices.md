...
### සාමාන්‍ය ගෙවීම් විකල්ප (General Payment Options)
...
### ගෙවීම් ගේට්වේ (Payment Gateways)
...
### Sandbox Mode (සැන්ඩ්බොක් මාදිලිය)
