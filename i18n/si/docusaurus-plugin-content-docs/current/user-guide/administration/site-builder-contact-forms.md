...
---
# වෙබ් අඩවි ගොඩනැගීමේ සම්බන්ධතා පෝරම (Site Builder Contact Forms) {#site-builder-contact-forms}
...
## සම්බන්ධතා පෝරමක් නිර්මාණය කිරීම (Creating a Contact Form) {#creating-a-contact-form}
...
## ජනනය කරන ලද කෙටි කේතය භාවිතා කිරීම (Using the Generated Shortcode) {#using-the-generated-shortcode}
...
## Contact Form එක වෙනස් කිරීම (Customizing the Contact Form) {#customizing-the-contact-form}

Site Builder මගින් contact form එක නිර්මාණය කිරීමෙන් පසුවත්, ඔබට එය තවදුරටත් වෙනස් කළ හැකියි:

### Chat Interface හරහා {#via-the-chat-interface}
...
### Form Plugin එකේ Admin Interface හරහා {#via-the-form-plugins-admin-interface}
...
## Form Plugins සහ අනුකූලතාවය (Form Plugins and Compatibility) {#form-plugins-and-compatibility}
...
## Email Notifications (විද්‍යුත් තැපැල් දැනුම්දීම්) {#email-notifications}
...
## උදාහරණ භාවිත අවස්ථා (Example Use Cases) {#example-use-cases}

### සරල සම්බන්ධතා පෝරමය (Simple Contact Form) {#simple-contact-form}

> "නම, විද්‍යුත් තැපැල් ලිපිනය සහ පණිවිඩ ක්ෂේත්‍ර සහිත සරල සම්බන්ධතා පෝරමයක් සාදන්න."

### බහු-පියවර පෝරමය (Multi-Step Form) {#multi-step-form}

> "සම්බන්ධතා තොරතුරු සඳහා පළමු පියවරක් සහ පණිවිඩය සහ මනාප සම්බන්ධතා ක්‍රමය සඳහා දෙවන පියවරක් සහිත සම්බන්ධතා පෝරමයක් සාදන්න."

### කොන්දේසි සහිත පෝරමය (Form with Conditional Logic) {#form-with-conditional-logic}

> "වෙබ් අඩවියේ ඇති 드롭다운 එකේ පරිශීලකයාගේ තේරීම මත වෙනස් වන ක්ෂේත්‍ර පෙන්වන සම්බන්ධතා පෝරමයක් සාදන්න."

### ගොනු උඩුගත කිරීම සහිත පෝරමය (Form with File Upload) {#form-with-file-upload}
