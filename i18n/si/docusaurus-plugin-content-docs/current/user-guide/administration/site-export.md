...
### నెట్‌వర్క్ ఇంపోర్ట్ బండ్‌లు (Network Import Bundles)
...
#### నెట్‌వర్క్ ఇంపోర్ట్ బండల్‌ను రూపొందించడం (Generating a Network Import Bundle)
...
#### Network Import Bundle එකකින් ප්‍රතිසාධනය කිරීම (Restoring from a Network Import Bundle)
...
## ස්වයංක්‍රීයව ආරම්භ වන export ZIP එකක් ස්ථාපනය කිරීම (Installing a self-booting export ZIP)
