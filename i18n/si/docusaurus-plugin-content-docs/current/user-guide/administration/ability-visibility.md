...
## දෘශ්‍යතා මට්ටම් (Visibility Levels)
...
## හැකියාවන් දෘශ්‍යතාව කළමනාකරණය කිරීම

### හැකියාවන් දෘශ්‍යතා සැකසුම් වෙත පිවිසීම
...
## සහකරු අවසර ලේඛනය (Partner Allow-List)
...
### හැකියාවන් සහ සහකරුවන් සම්බන්ධ කිරීම
...
### Partnerr ප්‍රවේශය ඉවත් කිරීම (Revoking Partner Access)
...
## වර්ගීකරණය නොකළ abilities (Unclassified Abilities)

Superdav AI Agent හඳුනා නොගන්නා තුන්වන පාර්ශවීය ability එකක් ඔබ ස්ථාපනය කරන විට, එය **Unclassified** ලෙස සලකුණු කෙරේ.

### Unclassified Abilities සඳහා පරිපාලක දැනුම්දීම (Admin Notice for Unclassified Abilities)
...
### Unclassified Abilities සමාලෝචනය කිරීම (Reviewing Unclassified Abilities)
...
### Unclassified Abilities වර්ගීකරණය කරන්නේ ඇයි? (Why Classify Unclassified Abilities?)
...
## විවිධ මතුපිට වල දෘශ්‍යතාව (Visibility in Different Surfaces)
...
### WooCommerce ඒකාබද්ධ කිරීම (WooCommerce Integration)
...
### චැට් අතුරුමුහුණත (Chat Interface)
...
## ආරක්ෂක හොඳම භාවිතයන් (Security Best Practices)

### අවම වරප්‍රසාද මූලධර්මය (Principle of Least Privilege)
...
### නිත්‍යානුකූල විගණනයන් (Regular Audits)
...
### ලොග් කිරීම සහ නිරීක්ෂණය (Logging and Monitoring)
...
### තුන්වන පාර්ශවීය හැකියාවන් (Third-Party Abilities)
...
## පැරණි මාදිලියෙන් සංක්‍රමණය (Migration from Legacy Mode)
