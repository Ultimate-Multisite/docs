...
### 1. CyberPanel API සක්‍රීය කරන්න
...
### 3. ඒකාබද්ධ කිරීම සක්‍රීය කරන්න (Enable the Integration)
...
### 4. සම්බන්ධතාවය තහවුරු කරන්න (Verify Connectivity)
...
### Domain Mapping (ප්‍රධාන නාමය සිතියම් කිරීම)
...
### www Subdomain (www උප-ප්‍රධාන නාමය)
...
### Email Forwarders (ඊමේල් ඉදිරියට යවන්නන්)
...
## සැකසුම් විස්තරය (Configuration Reference)
...
### API සම්බන්ධතාව ප්‍රතික්ෂේප කිරීම (API Connection Refused)
...
### ડોමේන් නිර්මාණය නොවීම (Domain Not Created)
...
### SSL සහතිකයක් නිකුත් නොවීම (SSL Certificate Not Issued)
