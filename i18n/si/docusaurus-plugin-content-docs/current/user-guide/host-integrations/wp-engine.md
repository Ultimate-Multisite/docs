...
### 1. WP Engine Plugin සත්‍යාපනය කිරීම (Verify WP Engine Plugin)
...
### 2. ඒකාබද්ධ කිරීම සක්‍රීය කිරීම (Enable the Integration)
...
### ඩොමේන් සමමුහුර්ත කිරීම (Domain Syncing)
...
### උප-ඩොමේන් සහාය (Subdomain Support)
...
### වයිල්ඩ්කාඩ් ડોමේන් (Wildcard Domains)
