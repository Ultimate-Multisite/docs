...
## සැකසීම (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
පහත අගයන් ලබා දෙන්න:
...
## උදාහරණ API ඇමතීම (cURL) {#example-api-call-curl}
