...
## စနစ်တကျ တည်ဆောက်နည်းများ (Setup Instructions)

### ၁။ သင့် Cloudflare API Key ကို ရယူပါ
...
### ၃။ wp-config.php ထဲသို့ Constant များ ထည့်သွင်းပါ
...
### ၄။ ပေါင်းစပ်မှုကို အသက်သွင်းပါ (Enable the Integration)
...
### DNS වාර්තා ප්‍රදර්ශනය (DNS Record Display)
...
## Cloudflare කස්ටම් හෝස්ට් නම් (Cloudflare Custom Hostnames)
...
### සම්මත Cloudflare ඒකාබද්ධ කිරීමෙන් එය වෙනස් වන්නේ කෙසේද
...
### Cloudflare Custom Hostnames සැකසීම
