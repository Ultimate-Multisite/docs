...
### 1. ඔබේ Cloudways API Credentials ලබා ගැනීම
...
### 2. ඔබේ Server සහ Application IDs ලබා ගැනීම
...
### 3. wp-config.php වල Constants එකතු කිරීම
...
### Ultimate Multisite ජාල සඳහා නිර්දේශිත Cloudways SSL සැකසුම
