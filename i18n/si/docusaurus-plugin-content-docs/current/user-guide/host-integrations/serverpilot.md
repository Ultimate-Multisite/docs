...
---
# සර්වර්පයිලොට් (ServerPilot) ඒකාබද්ධ කිරීම {#serverpilot-integration}
...
### 1. ඔබේ ServerPilot API තොරතුරු ලබා ගැනීම {#1-get-your-serverpilot-api-credentials}
...
### 2. ඔබේ App ID ලබා ගැනීම {#2-get-your-app-id}
...
### 3. wp-config.php වල Constant එකතු කිරීම {#3-add-constants-to-wp-configphp}
...
### 4. ඒකාබද්ධතාව සක්‍රීය කිරීම (Enable the Integration) {#4-enable-the-integration}
...
## SSL සහතික සත්‍යාපනය (SSL Certificate Verification) {#ssl-certificate-verification}
...
### ડોමේන් එකක් එකතු නොවීම (Domain Not Added) {#domain-not-added}
...
### ડોમેન ඉවත් කිරීම (Domain Removal) {#domain-removal}
