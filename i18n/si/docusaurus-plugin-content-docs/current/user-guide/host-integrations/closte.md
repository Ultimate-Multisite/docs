...
### 1. ඔබේ Closte API Key තහවුරු කරන්න (Verify Your Closte API Key)
...
### 2. සම්බන්ධතාවය සක්‍රීය කරන්න (Enable the Integration)
...
## වෙබ් අඩවි වාර්තා නිර්මාණය (Domain Record Creation)
...
### DNS පරීක්ෂණ කාල පරාසය (DNS Check Interval)
