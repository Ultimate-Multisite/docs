...
### 1. ඔබේ RunCloud API තොරතුරු ලබා ගැනීම (Get Your RunCloud API Credentials)
...
### 2. ඔබේ සේවාදායක ID සහ යෙදුම් ID ලබා ගැනීම (Get Your Server and App IDs)
...
### 3. wp-config.php හි නියතයන් එක් කිරීම (Add Constants to wp-config.php)
...
### 4. ඒකාබද්ධතාව සක්‍රිය කිරීම (Enable the Integration)
...
### SSL Certificate ගැටළු (SSL Certificate Issues)
...
### Domain එක එකතු නොවීම (Domain Not Added)
