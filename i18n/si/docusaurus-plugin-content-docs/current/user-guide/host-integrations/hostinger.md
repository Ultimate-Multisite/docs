...
### 1. ඔබේ Hostinger API Token එක ජනනය කරන්න {#1-generate-your-hostinger-api-token}
...
### 2. ඔබේ ගිණුම් ID සොයා ගන්න {#2-find-your-account-id}
...
### 3. wp-config.php හි Constant එකතු කරන්න {#3-add-constants-to-wp-configphp}
...
### Addon Domains (අමතර ડોමේන්) {#addon-domains}
...
### Subdomains (උප ડોමේන්) {#subdomains}
...
### ඩොමේනය එකතු කර නොමැත (Domain Not Added) {#domain-not-added}
...
### SSL සහතික ප්‍රශ්න (SSL Certificate Issues) {#ssl-certificate-issues}
