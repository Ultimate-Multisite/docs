...
---
# තේමාව ගොඩනැගීමේ හැකියාවන්: Scaffold සහ Activate Block Themes {#theme-builder-abilities-scaffold-and-activate-block-themes}
...
## Block Theme Scaffold කිරීම {#scaffold-block-theme}
...
### ක්‍රියාත්මක කරන ආකාරය {#how-to-invoke}
...
### අපේක්ෂිත ප්‍රතිදානය {#expected-output}
...
### မျှော်လင့်ထားတဲ့ အကျိုးရလဒ် (Expected Output) {#expected-output-1}
...
## လုပ်ငန်းစဉ် (Workflow): Scaffold လုပ်ပြီး Activate လုပ်ခြင်း {#workflow-scaffold-and-activate}
...
## Design Tokens နဲ့ Customization (ဒီဇိုင်းဆိုင်ရာ အစိတ်အပိုင်းတွေနဲ့ ပြုပြင်မှု) {#design-tokens-and-customization}
...
## ကန့်သတ်ချက်များနှင့် မှတ်ချက်များ (Limitations and Notes) {#limitations-and-notes}
