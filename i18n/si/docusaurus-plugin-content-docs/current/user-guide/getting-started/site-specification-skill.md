...
## Site Specification කියන්නේ මොකක්ද?
...
## Site Specification භාවිතා කළ යුත්තේ ඇයි?

### සැසි අතර ස්ථාවරත්වය (Consistency Across Sessions)
...
### වඩා හොඳ නිර්දේශ (Better Recommendations)
...
### අතින් ආරම්භ කිරීම (Manual Initiation)
...
## වෙබ් අඩවි විස්තර කිරීමේ ක්‍රියාවලිය (The Site Specification Process)

### පියවර 1: වෙබ් අඩවියේ අරමුණ (Site Purpose)
...
### පියවර 2: ඉලක්කගත ප්‍රේක්ෂකයින් (Target Audience)
...
### පියවර 3: වෙළඳ නාම අනන්‍යතාව (Brand Identity)
...
### පියවර 4: ව්‍යාපාරික අරමුණු (Business Goals)
...
### පියවර 5: අන්තර්ගත ව්‍යුහය (Content Structure)
...
## ඔබේ site_brief මතකය (Your site_brief Memory)
...
## ඔබේ වෙබ් අඩවිය බැලීම සහ යාවත්කාලීන කිරීම

### ඔබේ site_brief එක බැලීම
...
### ඔබේ site_brief එක යාවත්කාලීන කිරීම
...
## Agents මගින් site_brief භාවිතා කරන ආකාරය

### නිර්මාණ යෝජනා (Design Recommendations)
...
### විශේෂාංග යෝජනා (Feature Suggestions)
...
### අන්තර්ගත ව්‍යුහය (Content Structure)
...
### නිරන්තරයෙන් යාවත්කාලීන කරන්න (Update Regularly)
...
### ස්ථාවර නාමකරණය භාවිතා කරන්න (Use Consistent Terminology)
...
### සන්දර්භය ඇතුළත් කරන්න (Include Context)
...
## Theme Builder Onboarding සමඟ සම්බන්ධතාවය (Relationship to Theme Builder Onboarding)
