...
## පියවර 1: සාදරයෙන් පිළිගනිමු (Welcome)
...
## පියවර 2: ජාල සැකසුම් (Network Configuration)

මෙම පියවර මගින් ඔබගේ ජාල සැකසුම් වින්‍යාස කිරීමට ඔබට ඉල්ලා සිටී.

### වෙබ් අඩවි ව්‍යුහය (Site Structure)
...
### ජාල පරිපාලක විද්‍යුත් තැපෑල (Network Admin Email)
...
## පියවර 3: ස්ථාපනය (Step 3: Installation)
...
## අතින් සැකසීමේ විකල්ප විසඳුම (Manual Setup Fallback)
...
### වීසාර්ඩ් එක පවසන්නේ wp-config.php ලිවීමට නොහැකි බවයි
...
### ස්ථාපනය කිරීමෙන් පසු වෙබ් අඩවි වලට ප්‍රවේශ විය නොහැකි වීම (subdomains)
...
### ස්ථාපනය කිරීමෙන් පසු අනුභවීකරණ ගැටළු (Authentication issues after setup)
...
### ස්ථාපන අතරතුර පියවරක් අසාර්ථක වීම
