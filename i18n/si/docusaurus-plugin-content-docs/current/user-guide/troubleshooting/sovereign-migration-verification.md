...
## ක්‍රියාත්මක කළ යුතු විධාන (Commands to run)
...
### දත්ත සමුදා අනුමැතිය සත්කාරකයාට නොගැලපේ (Database grants do not match the host)
...
### Bedrock හෝ දේශීය ස්ථාපන සම්බන්ධ විය නොහැක (Bedrock or local installs cannot connect)
...
### Asynch push රැකියා පේළිය බැහැර නොවේ (Async push queue does not drain)
...
### කුලීකුව පරිශීලක ගණන වැරදියි (Tenant user count is wrong)
...
### SSO පිවිසුම ප්‍රතික්ෂේප වේ (SSO visit is rejected)
