...
## ඔබේ ජාලයේ PayPal සක්‍රීය කිරීම {#enabling-paypal-on-your-network}
...
## මඟ පෙන්වන සැකසුම් වැඩසටහන භාවිතා කිරීම {#using-the-guided-setup-wizard}
...
## PayPal API ක්‍රෙඩන්ෂල් ලබා ගැනීම (Getting the PayPal API credentials) {#getting-the-paypal-api-credentials}
