...
## Navigeerimissilt vs lehe pealkiri {#navigation-label-vs-page-title}
...
## Kasutusnäited {#usage-examples}

### Näide 1: lihtne menüü navigeerimissildiga {#example-1-simple-menu-with-navigation-label}
...
### Näide 2: menüü konkreetse Theme asukoha jaoks {#example-2-menu-for-specific-theme-location}
...
## Integreerimine Theme Builderiga {#integration-with-theme-builder}
...
## Seotud võimed {#related-abilities-1}
