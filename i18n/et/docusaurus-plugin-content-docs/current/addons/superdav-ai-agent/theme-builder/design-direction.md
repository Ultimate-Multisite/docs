...
- **Põhivärv** — peamine brändivärv, mida kasutatakse nuppude, linkide ja aktsentide jaoks
- **Teisene värv** — täiendav värv vahelduse loomiseks
- **Aktsentvärv** — esiletõstevärv oluliste elementide jaoks
...
- **Pealkirjafont** — kasutatakse lehepealkirjade ja jaotiste pealkirjade jaoks
- **Põhiteksti font** — kasutatakse lõiguteksti ja sisu jaoks
- **Fondisuurused** — eri ekraanisuurustele kohanduv suurus
...
- **Ikoonid** — ikoonide stiil ja suurus
...
- Täielik navigeerimismenüü
- Täielik paigutus kõigi veergudega
...
- Responsiivne navigeerimine (hamburger-menüü)
- Ühe veeruga paigutus
...
| Seade | Laius | Eelvaade |
|--------|-------|---------|
| **Mobiil** | 375px | Püstpaigutusega telefon |
| **Tahvelarvuti** | 768px | Rõhtpaigutusega tahvelarvuti |
...
1. **Värvide kohandamine** — muuda paletis mis tahes värvi
2. **Fontide muutmine** — vali teistsugused kirjatüübid
3. **Vahede muutmine** — kohanda sisemisi ja väliseid veeriseid
...
- Desktop-eelvaade uueneb kohe
- Mobiilieelvaade uueneb kohe
...
- **Algne kujundus** — vaata, mis muutus
...
1. **Vaata üle mõlemad eelvaated** — kontrolli, et desktop ja mobiil näeksid head välja
2. **Kontrolli kõiki värve** — taga kontrast ja ligipääsetavus
3. **Testi tüpograafiat** — kontrolli loetavust kõigis suurustes
...
1. Theme Builder genereerib sinu täieliku teema
2. Teema paigaldatakse sinu WordPress saidile
...
- **Kontrolli kontrasti** — kasuta ligipääsetavuse jaoks tööriista [Validate Palette Contrast](../abilities/validate-palette-contrast.md)
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — kontrolli värvide ligipääsetavust
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — loo kohandatud logosid
