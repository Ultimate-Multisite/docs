---
title: Ultimate Multisite'i installimine
sidebar_position: 12
...
Minge oma **võrguhalduri armatuurlaudadel** jaotisse **Lisandmoodulid → Lisa uus lisandmoodul**.

![Võrguhalduri "Lisa uus lisandmoodul" leht](/img/installation/add-new-plugin.png)

Otsige üles "**Ultimate Multisite**" (kasutage täpse vaste jaoks jutumärke) ja see kuvatakse esimese tulemusena. Klõpsake nuppu **Paalda kohe**.

![Otsingutulemused, kus on näha Ultimate Multisite](/img/installation/search-ultimate-multisite.png)

Kui paigaldamine on lõppenud, klõpsake nuppu **Võrgus aktiveeri**, et aktiveerida lisandmoodul kogu teie võrgus.

![Paigaldatud lisandmoodul koos nupuga "Võrgus aktiveeri"](/img/installation/plugin-installed.png)

Pärast aktiveerimist suunatakse teid automaatselt seadistusviisardi juurde.
...
![Eelpaigalduste kontrollid, mis näitavad süsteeminõudeid](/img/installation/wizard-pre-install-checks.png)

:::note Nupp "Võrgus aktiveeri" (v2.6.1+)
Kui Ultimate Multisite on paigaldatud, kuid **pole veel võrgus aktiveeritud** – näiteks kui klõpsasite lisandmoodulite lehel nuppu **Aktiveeri** (üksik veebisait) selle asemel, et klõpsata nupule **Võrgus aktiveeri** –, tuvastab eelpaigalduste kontrollide samm selle ja kuvab nupu **Võrgus aktiveeri**.
...
![Seadistus on lõpetatud – valmis ekraan](/img/installation/wizard-ready.png)

![Võrguhalduri armatuurlaud, kus Ultimate Multisite on aktiivne](/img/installation/network-dashboard.png)
