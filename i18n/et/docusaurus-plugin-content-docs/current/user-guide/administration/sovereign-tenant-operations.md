...
## Mis muutub administratiorile? {#what-changes-for-administrators}
...
## Suvereenise paigutuse külastamine {#visiting-a-sovereign-tenant}
...
## Kaugjuhatud paigutuste operaatsioonide kontrolljuht (checklist) {#remote-site-operations-checklist}
...
## Väljaomandajate (sovereign tenants) eemaldamine {#deleting-sovereign-tenants}
