...
1. Kanda [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Valige oma keel
3. Klõpsake "Contribute Translation" (Tõlgituse katkenduse lahendamine)
4. Kui teil on vaja, vajate tasuta WordPress.org konti
...
1. Losta Poedit [poedit.net]ist
2. Avage `.pot` fail `wp-content/plugins/ultimate-multisite/lang/` paigutustest
3. Tõlke stringid Poediti kasutajaliideses
