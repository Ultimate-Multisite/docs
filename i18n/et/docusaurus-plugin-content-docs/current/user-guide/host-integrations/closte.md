...
### 1. Kontrollige oma Closte API-käiku {#1-verify-your-closte-api-key}
...
### 2. Lülitage integreerimine sisse {#2-enable-the-integration}
...
## Domeeniregistri loomine {#domain-record-creation}
...
### SSL sertifikaadidega probleemid {#ssl-certificate-issues}
...
### DNS kontrolli intervall {#dns-check-interval}
