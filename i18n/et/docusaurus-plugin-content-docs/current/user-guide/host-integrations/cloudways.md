...
---
# Cloudways Integreerimine {#cloudways-integration}
...
## Seadistused {#requirements}

### 1. Päästa oma Cloudways API kinnitused {#setup-instructions}
...
### 2. Päästa oma serveri ja rakenduse ID-d {#1-get-your-cloudways-api-credentials}
...
### 3. Lisage konstantsid wp-config.php'le {#2-get-your-server-and-application-ids}
...
### 4. Lülitage integreerimine sisse {#3-add-constants-to-wp-configphp}
...
## Kuidas see toimib {#4-enable-the-integration}

### Domeenid synkronimine {#how-it-works}
...
### SSL-sertifikaadi haldamine {#domain-syncing}
...
## Lisakohjad {#ssl-certificate-management}
...
## Oluline — Wildcard SSL probleem {#extra-domains}
...
### soovitatav Cloudways SSL-seadistus Ultimate Multisite võrku jaoks {#important--wildcard-ssl-pitfall}
...
## Probleemide lahendamine {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}

### API ühenduse probleemid {#troubleshooting}
...
### Domeen ei lisatud {#ssl-certificate-issues}
