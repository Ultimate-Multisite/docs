...
Kaks samaaegset päringut võivad lugeda sama väärtuse ja mõlemad kirjutada tagasi sama suurendatud tulemuse, kaotades ühe loenduse. `increment_item()` delegeerib aritmeetika andmebaasimootorile ühe `UPDATE ... SET column = column + ?` lausega, muutes toimingu olemuslikult atomaarseks.
