...
Kontrollime kolme mustrit, kui püüame välja selgitada, kuhu saame oma konstante sisestada:
...
Määratletud failis [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) real 143
