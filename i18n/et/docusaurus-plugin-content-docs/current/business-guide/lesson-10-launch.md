---
title: 'Õppetund 10: Käivitamispäev'
sidebar_position: 11
...
- [ ] Domeeni kaardistamine töötab -- testi saidi loomist ja kohandatud domeeni kaardistamist
...
- [ ] Kõik pildid on nõuetekohaselt litsentsitud (ilma stock-fotode vesimärkideta)
- [ ] Mobiilne kohanduvus töötab igal mallilehel
...
- [ ] Hinnastus on korrektne (kuu- ja aastapõhine)
- [ ] Seadistustasud on õigetele pakettidele seadistatud
- [ ] Prooviperiood töötab Starter paketil
...
- [ ] Klient saab pärast registreerumist tervitusmeili
- [ ] Uus sait luuakse õige malliga
...
- [ ] Kõik süsteemimeilid kasutavad FitSite’i brändingut ja fitnessispetsiifilist keelt
...
- [ ] Tervitusmeilide jada on seadistatud ja testitud
...
- [ ] Tagasimaksepoliitika on määratletud ja dokumenteeritud
- [ ] Äriüksus on maksete vastuvõtmiseks loodud
...
- Aus tagasiside registreerumise ja sisseelamise kogemuse kohta
- Luba kasutada nende saiti näidisena
- Kõigist vigadest või probleemidest teatamine, millega nad kokku puutuvad
...
- Lülita maksevärav live-režiimi
- Avalda oma turundussait
...
1. **Lülita live-maksed sisse** -- keela oma makseväravas testrežiim
2. **Kontrolli veel üks kord** -- tee täielik testregistreerimine päris maksega (tagasta endale pärast raha)
3. **Jälgi tähelepanelikult** -- jälgi vigu, ebaõnnestunud registreerumisi või makseprobleeme
...
- **Maksevärava probleemid**: hoia oma maksevärava pakkuja toe kontakt käepärast
- **SSL-sertifikaadi probleemid**: tea, kuidas sertifikaate kontrollida ja uuendada
- **Meilide kohaletoimetamise tõrked**: testi, et meilid päriselt kohale jõuaksid (kontrolli rämpspostikaustu)
...
- **Käivitamispäeva protseduurid**, et enesekindlalt live’i minna
- **Varuplaan** levinud käivitamispäeva probleemide jaoks

---

**Järgmine:** [Õppetund 11: klientide leidmine](lesson-11-customers) -- nüüd, kui FitSite on live’is, kuidas panna fitnessistuudio omanikke registreeruma?
