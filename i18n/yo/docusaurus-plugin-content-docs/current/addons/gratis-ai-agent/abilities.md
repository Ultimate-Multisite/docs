...
## Àwọn Custom Post Types {#custom-post-types}
...
## Àwọn Custom Taxonomies {#custom-taxonomies}
...
## Àwọn Global Styles {#global-styles}
...
## Àwọn Menu Ìtòsọ́nà {#navigation-menus}
...
## Ìṣàkóso Àwọn Options {#options-management}
...
## Ìṣàkóso Àkóónú {#content-management}
...
## Àwọn Agbára Tí A Lè Fi Sórí Ẹ̀rọ {#installable-abilities}
