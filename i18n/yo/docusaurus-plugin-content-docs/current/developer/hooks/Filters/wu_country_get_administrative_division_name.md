...
title: Àlẹmọ - wu_country_get_administrative_division_name
...
| Orúkọ | Iru | Àpèjúwe |
|------|------|-------------|
| $name | `string` | Orúkọ ìpín náà. Nígbà púpọ̀, ó máa ń rí bí state, province, region, àti bẹ́ẹ̀ bẹ́ẹ̀ lọ. |
| $country_code | `string` | Kóòdù ISO onílẹ́tà méjì fún orílẹ̀-èdè náà. |
| $state_code | `string` | Kóòdù ISO onílẹ́tà méjì fún state náà. |
