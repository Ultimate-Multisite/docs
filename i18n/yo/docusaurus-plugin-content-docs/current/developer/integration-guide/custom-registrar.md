...
### Àwọn method àṣàyàn {#optional-methods}
...
### Ìlànà iye tí a dá padà {#return-value-convention}
...
## Fíforúkọsílẹ̀ capability rẹ {#registering-your-capability}
...
## Fífi àwọn field credential kún wizard {#adding-credential-fields-to-the-wizard}
...
## Àwọn hook fún àwọn ìṣe lẹ́yìn-registration {#hooks-for-post-registration-actions}
