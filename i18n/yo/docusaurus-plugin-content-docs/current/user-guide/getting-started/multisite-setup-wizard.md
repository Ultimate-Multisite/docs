...
## Nígbà Wo Ni Olùrànlọ́wọ́ Yóò Farahàn? {#when-does-the-wizard-appear}
...
## Àwọn Ohun Tó Gbọdọ̀ Wà Ṣáájú {#prerequisites}
...
## Ìgbésẹ̀ 1: Káàbọ̀ {#step-1-welcome}
...
## Ìgbésẹ̀ 2: Ìṣètò Nẹ́tíwọ́ọ̀kì {#step-2-network-configuration}

Ìgbésẹ̀ yìí béèrè pé kí o ṣètò àwọn ìṣètò nẹ́tíwọ́ọ̀kì rẹ.

### Ìgbékálẹ̀ Site {#site-structure}
...
### Àkọlé Nẹ́tíwọ́ọ̀kì {#network-title}
...
### Ímeèlì Alákóso Nẹ́tíwọ́ọ̀kì {#network-admin-email}
...
## Ìgbésẹ̀ 3: Ìfíṣọ́ọ̀nù {#step-3-installation}
...
## Ìgbésẹ̀ 4: Parí {#step-4-complete}
...
## Yípadà Sí Ìṣètò Pẹ̀lú Ọwọ́ {#manual-setup-fallback}
...
### Olùrànlọ́wọ́ náà sọ pé wp-config.php kì í ṣe èyí tí a lè kọ sí {#the-wizard-says-wp-configphp-is-not-writable}
...
### Àwọn site kò ṣeé wọlé sí lẹ́yìn ìṣètò (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Ìṣòro authentication lẹ́yìn setup {#authentication-issues-after-setup}
...
### Ìgbésẹ̀ kan kuna nígbà fifi sori {#a-step-failed-during-installation}
