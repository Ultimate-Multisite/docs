...
#### Àwọn Àfikún àti Àwọn Akori {#plugins-and-themes}
...
#### Àwọn Olùlò àti Àwọn Olùṣàkóso {#users-and-administrators}
...
#### Àwọn Ojúewé Aláìyípadà {#static-pages}
...
### Àwọn Ọ̀nà Ìlò {#use-cases}

#### Ọ̀ràn 1: Ilé-iṣẹ́ aṣojú {#case-1-an-agency}
...
#### Ọ̀ràn 2: Olùpèsè fún àgbègbè ìmọ̀ pàtó {#case-2-niche-provider}
...
#### Ọ̀ràn 3: Ìgbéléwọ̀n Wẹẹbu WordPress {#case-3-wordpress-web-hosting}
...
### Àwọn Ìròyìn Nípa Àgbékalẹ̀ {#architecture-considerations}
...
#### Hosting Pipín vs. Hosting Tí A Yà Sọ́tọ̀ {#shared-vs-dedicated-hosting}
...
#### Àwọn Ìròyìn Nípa Iṣẹ́-ṣiṣe {#performance-considerations}
...
#### Àwọn Scripts Ita {#external-scripts}
...
#### Domain àti SSL {#domain-and-ssl-1}
