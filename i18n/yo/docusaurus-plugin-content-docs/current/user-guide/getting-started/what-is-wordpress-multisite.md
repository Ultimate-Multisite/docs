...
## Kí Gan-an ni WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## Subdomain tàbí Subdirectory? {#subdomain-or-subdirectory}
...
## Ohun tí a pín láàárín subsites àti ohun tí a kò pín {#what-is-shared-among-subsites-and-what-is-not}
...
## Ìṣàkóso aṣàmúlò lórí WordPress Multisite {#user-management-on-wordpress-multisite}
...
## Àwọn ohun ìrònú nípa iṣẹ́-ṣiṣe {#performance-considerations}
