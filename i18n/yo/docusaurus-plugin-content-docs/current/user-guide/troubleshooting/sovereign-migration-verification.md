...
## Àwọn àṣẹ láti ṣiṣẹ́ {#commands-to-run}
...
## Àwọn ìkùnà tí ó wọ́pọ̀ {#common-failures}

### Àwọn ìyọ̀nda ibi ìpamọ́-dátà kò bá host mu {#database-grants-do-not-match-the-host}
...
### Bedrock tàbí àwọn ìfisí agbègbè kò lè sopọ̀ {#bedrock-or-local-installs-cannot-connect}
...
### Ìlà push async kò ṣofo {#async-push-queue-does-not-drain}
...
### Ìyẹ̀ àwọn olumulo ayálégbé kò tọ́ {#tenant-user-count-is-wrong}
...
### A kọ ìbẹ̀wò SSO {#sso-visit-is-rejected}
...
## Ìgbà wo ni a tún gbìyànjú {#when-to-retry}
