...
### Ṣíṣàfikún field náà sí fọ́ọ̀mù checkout {#adding-the-field-to-a-checkout-form}
...
### Àwọn aṣayan field {#field-options}
...
### Àwọn field ìkànsí registrant {#registrant-contact-fields}
...
### URL site tí a dá sílẹ̀ laifọwọyi {#auto-generated-site-url}
...
## Ìṣàkóso DNS oníbàárà {#customer-dns-management}
...
### Àwọn record type tí a ṣe àtìlẹ́yìn {#supported-record-types}
...
### Àwọn provider wo ni ń ṣe àtìlẹ́yìn fún ìṣàkóso DNS? {#which-providers-support-dns-management}
...
### Àwọn record DNS aiyipada {#default-dns-records}
...
### Admin: wíwo àti ṣíṣàtúnṣe DNS {#admin-viewing-and-editing-dns}
