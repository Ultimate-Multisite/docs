...
### 1. Gba Àwọn Ẹ̀rí cPanel Rẹ {#1-get-your-cpanel-credentials}
...
### Àwọn Addon Domains {#addon-domains}
...
## Ìṣàwárí àti Ìtọ́jú Ìṣòro {#troubleshooting}
...
### Àwọn Ìṣòro Certificate SSL {#ssl-certificate-issues}
