...
### 1. Ṣàyẹ̀wò WPMU DEV Hosting {#1-verify-wpmu-dev-hosting}
...
### 2. Mu Ìṣàkóso Náà Ṣiṣẹ́ {#2-enable-the-integration}
...
### Ìmúdọ́gba Domain {#domain-syncing}
...
### Ìjẹ́rìísí API {#api-authentication}
