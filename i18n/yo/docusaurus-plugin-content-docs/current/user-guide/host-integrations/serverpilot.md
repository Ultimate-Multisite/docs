...
### 1. Gba Àwọn ServerPilot API Credentials Rẹ {#1-get-your-serverpilot-api-credentials}
...
### 2. Gba App ID Rẹ {#2-get-your-app-id}
...
### Ìṣàkóso SSL Certificate {#ssl-certificate-management}
...
## Ìjẹ́rìísí SSL Certificate {#ssl-certificate-verification}
...
### Domain Kò Fi Kún Un {#domain-not-added}
...
### Yíyọ Domain Kúrò {#domain-removal}
