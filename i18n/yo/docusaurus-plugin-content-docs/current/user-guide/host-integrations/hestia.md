...
## Àwọn Ohun Tó Gbọdọ̀ Wà Tẹ́lẹ̀ {#prerequisites}
...
## Ìṣètò (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Ṣíṣàyẹ̀wò Ìṣètò {#verifying-setup}
...
## Àwọn Àkọsílẹ̀ & Ìmọ̀ràn {#notes--tips}
...
## Àpẹẹrẹ Ìpè API (cURL) {#example-api-call-curl}
