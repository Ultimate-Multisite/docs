...
## Awọn Ohun Tí A Nilo {#requirements}

### Awọn Ohun Tí Eto Nilo {#system-requirements}
...
### Wiwọle API {#api-access}
O gbọdọ ni wiwọle alakoso si Enhance Control Panel lati ṣẹda awọn token API.

## Gbigba Awọn Iwe-ẹri API Rẹ {#getting-your-api-credentials}

### 1. Ṣẹda API Token Kan {#1-create-an-api-token}
...
### 2. Gba Organization ID Rẹ {#2-get-your-organization-id}
...
### 3. Gba Server ID Rẹ {#3-get-your-server-id}
...
### 4. Gba API URL Rẹ {#4-get-your-api-url}
...
### Awọn Constant Tí A Nilo {#required-constants}
...
### Eto Nipasẹ Integration Wizard {#setup-via-integration-wizard}
...
## Iṣeto WordPress Afikun {#additional-wordpress-configuration}
...
### Iṣeto .htaccess {#htaccess-configuration}
...
### Awọn Constant Cookie {#cookie-constants}
...
## Bii Ó Ṣe Nṣiṣẹ {#how-it-works}

### Nigbati A Ba Ṣe Maapu Domain Kan {#when-a-domain-is-mapped}
...
### Nigbati A Ba Yọ Domain Kan Kuro {#when-a-domain-is-removed}
...
### Ṣiṣayẹwo DNS ati SSL {#dns-and-ssl-checking}
...
## Jẹrisi Eto {#verifying-setup}

### Ṣe Idanwo Asopọ naa {#test-the-connection}
...
### Lẹ́yìn Ṣíṣe Mapping Domain Kan {#after-mapping-a-domain}
...
### A Kò Fi Domain Kún {#domain-not-added}
...
### Àárín Àkókò Ṣíṣàyẹ̀wò DNS {#dns-check-interval}
...
### Àwọn Àṣìṣe Ìjẹ́rìísí {#authentication-errors}
...
### Àwọn Endpoint Tí A Máa Ń Lo {#common-endpoints-used}
...
### Ìwé API Kíkún {#full-api-documentation}
...
## Àwọn Ohun Èlò Àfikún {#additional-resources}
