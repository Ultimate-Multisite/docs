...
## Àwọn Ìtọ́nisọ́nà Setup {#setup-instructions}

### 1. Ṣàyẹ̀wò Closte API Key Rẹ {#1-verify-your-closte-api-key}
...
## Ṣíṣe Domain Record {#domain-record-creation}
...
### Àwọn Ìṣòro Ìbásopọ̀ API {#api-connection-issues}
...
### A Kò Fi Domain Kún Un {#domain-not-added}
...
### Àárín Àsìkò Ìṣàyẹ̀wò DNS {#dns-check-interval}
