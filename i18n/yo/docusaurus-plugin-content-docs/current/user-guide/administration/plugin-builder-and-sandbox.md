---
title: Olùkọ́ Plugin & Àyíká Ìdánwò
sidebar_position: 21
...
Àwọn ọ̀nà lílò rẹ̀ pẹlu:

- Ṣíṣẹ̀dá àwọn àfikún ìrànwọ́ kékeré láìsí ìkópa olùdàgbàsókè.
...
> "Ṣẹ̀dá àfikún kan tí ó fi ìkìlọ̀ admin àdáni kún Dashboard."

AI náà yóò:

1. Ṣe kóòdù PHP àfikún náà ní lílo ìṣẹ̀dá kóòdù tí a ṣètò.
2. Fìdí àbájáde náà múlẹ̀ fún àwọn àṣìṣe syntax àti àwọn àpẹẹrẹ tí kò ní ààbò.
3. Fi àfikún tí a ṣẹ̀dá pamọ́ sí ibi ìpamọ́ ààyè ìdánwò ààbò.
4. Dá ìmúdájú padà pẹ̀lú slug àfikún àti bọ́tìnì **Muu ṣiṣẹ́ nínú Ààyè Ìdánwò Ààbò**.
...
- Ń ṣiṣẹ́ àfikún náà nínú àyíká WordPress tí ó dá wà (wp-env).
- Ń gba àwọn àṣìṣe PHP, ìkìlọ̀, tàbí ìjà hook èyíkéyìí.
- Ń ròyìn àbájáde mímuu ṣiṣẹ́ padà nínú ojú-ìbánisọ̀rọ̀.

Láti muu àfikún ṣiṣẹ́ nínú ààyè ìdánwò ààbò, tẹ bọ́tìnì **Muu ṣiṣẹ́ nínú Ààyè Ìdánwò Ààbò** nínú ìdáhùn ìbánisọ̀rọ̀ AI, tàbí lo àṣẹ slash:
...
| Ìṣe | Àpèjúwe |
|---|---|
| **Wo orísun** | Ṣàyẹ̀wò gbogbo kóòdù PHP àfikún náà. |
| **Tún muu ṣiṣẹ́ nínú ààyè ìdánwò ààbò** | Tún ṣàyẹ̀wò mímuu ṣiṣẹ́ nínú ààyè ìdánwò ààbò. |
| **Fi sori nẹ́tíwọ́ọ̀kì** | Gbé àfikún náà jáde sí nẹ́tíwọ́ọ̀kì alààyè (ó nílò ìmúdájú ọwọ́). |
| **Ṣe ìmúdójúìwọ̀n** | Pèsè ẹ̀dà tuntun nípasẹ̀ AI, kí ó rọ́pò kóòdù tó wà tẹ́lẹ̀. |
| **Paarẹ́** | Yọ àfikún náà kúrò ní ibi ìpamọ́ ààyè ìdánwò ààbò. Ó kọ́kọ́ dá a dúró lórí gbogbo àwọn aaye wẹẹbu. |
...
1. Lọ sí **Gratis AI Agent → Olùkọ́ Àfikún → Ṣàkóso Àwọn Àfikún**.
2. Tẹ **Fi sori Nẹ́tíwọ́ọ̀kì** lẹ́gbẹ̀ẹ́ àfikún tí o fẹ́ gbé jáde.
3. Jẹ́rìí ìjíròrò náà. A fi àfikún náà sí `wp-content/plugins/` a sì muu ṣiṣẹ́ fún nẹ́tíwọ́ọ̀kì.

Ní ọ̀nà mìíràn, lo àṣẹ slash nínú ojú-ìbánisọ̀rọ̀:
...
> "Ṣe ìmúdójúìwọ̀n àfikún dashboard-notice kí ó lè fi ìkìlọ̀ hàn fún àwọn administrators nìkan."
...
- Àwọn hook action tí a forúkọsílẹ̀ (àwọn ìpè `add_action`).
- Àwọn hook filter tí a forúkọsílẹ̀ (àwọn ìpè `add_filter`).
- Hook èyíkéyìí tí a rí nínú àwọn dependency àfikún (ó fo àwọn directory `vendor/` àti `node_modules/`).
...
- Àwọn àfikún pẹ̀lú àwọn ìpè function tó léwu (fún àpẹẹrẹ, `eval`, `exec`, `system`) ni a máa samisi nígbà ìfìdímúlẹ̀, wọn kò sì ní jẹ́ mímuu ṣiṣẹ́.
