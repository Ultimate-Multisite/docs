...
زمانی فعال می‌شود که زمینه (context) شبکه فعلی تغییر کند.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $new_network_id | `int` | شناسه شبکه‌ای که به آن سوئیچ می‌شود. |
| $old_network_id | `int` | شناسه شبکه قبلی که فعال بود. |
