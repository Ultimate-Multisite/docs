...
## رابط (The interface) {#the-interface}
...
### متدهای اختیاری {#optional-methods}
...
### قرارداد مقدار بازگشتی (Return value convention) {#return-value-convention}
...
## ثبت قابلیت شما (Registering your capability) {#registering-your-capability}
...
## افزودن فیلدهای اعتبارنامه به ویزارد (Adding credential fields to the wizard) {#adding-credential-fields-to-the-wizard}
...
## هوک‌ها برای اقدامات پس از ثبت (Hooks for post-registration actions) {#hooks-for-post-registration-actions}
