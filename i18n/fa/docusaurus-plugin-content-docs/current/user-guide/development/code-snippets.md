...
---
# قطعه کدها برای نسخه ۲ {#code-snippets-for-v2}
...
## رفع مشکلات CORS با آیکون‌های فونتی در دامنه‌های مپ‌شده {#fixing-cors-issues-with-font-icons-in-mapped-domains}
## رفع مشکلات CORS با آیکون‌های فونتی در دامنه‌های مپ‌شده {#fixing-cors-issues-with-font-icons-in-mapped-domains-1}
