...
### 1. دریافت اعتبارنامه‌های API Cloudways خود
...
### 2. دریافت شناسه‌های سرور و اپلیکیشن خود
...
### 3. افزودن ثابت‌ها به wp-config.php
...
### راه‌اندازی پیشنهادی SSL در Cloudways برای یک شبکه Ultimate Multisite
