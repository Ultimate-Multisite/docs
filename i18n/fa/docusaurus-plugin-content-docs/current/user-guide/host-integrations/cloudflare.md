...
### 1. کلید API Cloudflare خود را دریافت کنید
...
### 2. شناسهٔ Zone خود را دریافت کنید
...
### 3. ثابت‌ها را به wp-config.php اضافه کنید
...
### راه‌اندازی Cloudflare Custom Hostnames
