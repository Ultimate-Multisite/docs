...
## درگاه‌ها را کجا پیدا کنید: {#where-to-find-the-gateways}
...
### نحوهٔ نصب افزونهٔ WooCommerce: {#how-to-install-the-woocommerce-add-on}
...
### نحوه نصب افزونه GoCardless: {#how-to-install-the-gocardless-add-on}
...
### نحوه نصب افزونه Payfast: {#how-to-install-the-payfast-add-on}
