...
## چگونه یک Trigger جدید ایجاد کنیم {#how-to-create-a-new-trigger}
...
## چگونه Actions ایجاد کنیم {#how-to-create-actions}
...
### راه‌اندازی Action {#setting-up-the-action}
