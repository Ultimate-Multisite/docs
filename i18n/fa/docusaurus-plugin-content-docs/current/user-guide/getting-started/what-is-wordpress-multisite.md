...
---
# چندسایتی وردپرس چیست؟ {#what-is-wordpress-multisite}
...
## چندسایتی وردپرس دقیقاً چیست؟ {#what-exactly-is-wordpress-multisite}
...
## زیردامنه یا زیرپوشه؟ {#subdomain-or-subdirectory}
...
## چه چیزهایی بین زیرسایت‌ها مشترک است و چه چیزهایی نیست {#what-is-shared-among-subsites-and-what-is-not}
...
## مدیریت کاربران در چندسایتی وردپرس {#user-management-on-wordpress-multisite}
