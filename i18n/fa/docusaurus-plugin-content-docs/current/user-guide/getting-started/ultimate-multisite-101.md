...
---
# آشنایی با Ultimate Multisite {#ultimate-multisite-101}
...
## WordPress Multisite چیست؟ {#the-wordpress-multisite}
...
#### Subdomain در مقابل Subdirectory {#subdomain-vs-subdirectory}
...
#### پلاگین‌ها و قالب‌ها {#plugins-and-themes}
...
#### کاربران و مدیران {#users-and-administrators}
...
#### پیوندهای یکتا (Permalinks) {#permalinks}
...
#### مورد ۳: هاستینگ وب وردپرس {#case-3-wordpress-web-hosting}
...
#### هاستینگ اشتراکی در مقابل اختصاصی {#shared-vs-dedicated-hosting}
