...
---
# راهنمای راه‌اندازی چندسایتی {#multisite-setup-wizard}
...
## راهنما چه زمانی نمایش داده می‌شود؟ {#when-does-the-wizard-appear}
...
## مرحله ۱: خوش‌آمدگویی {#step-1-welcome}
...
## مرحله ۲: پیکربندی شبکه {#step-2-network-configuration}
...
## راه‌اندازی دستی جایگزین {#manual-setup-fallback}
...
### راهنما می‌گوید wp-config.php قابل نوشتن نیست {#the-wizard-says-wp-configphp-is-not-writable}
...
### سایت‌ها پس از راه‌اندازی قابل دسترسی نیستند (زیردامنه‌ها) {#sites-are-not-accessible-after-setup-subdomains}
...
### مشکلات احراز هویت پس از راه‌اندازی {#authentication-issues-after-setup}
...
### یک مرحله در حین نصب با خطا مواجه شد {#a-step-failed-during-installation}
