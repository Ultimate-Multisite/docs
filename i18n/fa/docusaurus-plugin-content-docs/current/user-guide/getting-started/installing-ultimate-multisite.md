...
## نصب افزونه {#installing-the-plugin}
...
## Setup Wizard (ویزارد پیکربندی) {#setup-wizard}
...
### محتوای پیش‌فرض {#default-content}
...
### افزونه‌های پیشنهادی {#recommended-plugins}
