...
## جریان آشناسازی Theme Builder چیست؟
...
### مرحله ۳: تصمیمات سیستم طراحی (Design System)
...
## سفارشی‌سازی پس از آشناسازی

پس از تکمیل آشناسازی Theme Builder، شما می‌توانید:

### استفاده از مهارت زیبایی‌شناسی سیستم طراحی (Design System Aesthetics Skill)
...
## مقایسه: آشناسازی قدیمی در مقابل جدید
