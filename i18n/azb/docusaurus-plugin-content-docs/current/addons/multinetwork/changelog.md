...
* Yeni: Ağ medya klonlama — ağlar şablonlardan klonlanırken site medyası doğru şekilde çoğaltılır.
* Düzeltme: Ağ klonlama artık çok kiracılı eklenti olmadan çalışıyor; klonlamadan sonra süper yönetici yetkileri yeniden veriliyor.
* Düzeltme: Ağ oluşturma artık WooCommerce ve tüm ödeme ağ geçitleriyle uyumlu.
* Düzeltme: Yedek alan adı oluşturulmasına port numarası artık dahil ediliyor.
