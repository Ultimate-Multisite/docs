...
3. **Enable floating chat widget** seçeneğini açın veya kapatın.
4. Ayarları kaydedin.
...
### Yüzen Sohbet Widget'ını Etkinleştir {#enable-floating-chat-widget}
...
### Otomatik Komut Davranışı (Auto-Prompt Behaviour) {#auto-prompt-behaviour}
