...
## Hesap menüsünün konumunu değiştirme
...
## Kullanıcının belirli bir plana sahip olup olmadığını ve/veya aktif bir aboneliği olup olmadığını kontrol etme
...
## Eşlenmiş alan adlarında Font-Icons ile CORS sorunlarını giderme
## Eşlenmiş alan adlarında Font-Icons ile CORS sorunlarını giderme
