...
#### Subdomain (Alt Alan Adı) vs. Subdirectory (Alt Dizin)
...
#### Plugins ve Themes (Eklentiler ve Temalar)
...
### (Continuation - Assuming the text continues the technical discussion)
