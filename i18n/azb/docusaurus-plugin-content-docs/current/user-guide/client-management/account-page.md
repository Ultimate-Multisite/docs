...
## Account صفحه‌سی {#the-account-page}
...
### عضویتینیزین اومومی باخیشی: {#your-membership-overview}
...
### صورت‌حساب آدرسینی یئنیله‌مه: {#updating-the-billing-address}
...
### سایت شابلونونو دئییشدیرمه: {#changing-the-site-template}
...
### اؤزل دامین‌لرین آرتیریلماسی: {#adding-custom-domains}
...
### شفره‌نین دَییشدیریلمه‌سی: {#changing-password}
