...
---
# سایت قالب‌لارین‌دا اوتوماتیک آختارما و عوض ائتمه (v2) {#auto-search-and-replace-in-site-templates-v2}
...
## **«یئر توتان‌لارلا دولو قالب» مسئله‌سینی حل ائتمک** {#solving-the-template-full-of-placeholders-problem}
