...
## Mengimpor Template Email Baru {#importing-new-email-templates}
...
1. Buka halaman **System Emails**
2. Klik tombol **Reset & Import** di bagian atas halaman
3. Aktifkan opsi **Import Emails** untuk melihat template yang tersedia
4. Pilih template yang ingin Anda impor dan konfirmasi

## Mereset Template Email {#resetting-email-templates}
