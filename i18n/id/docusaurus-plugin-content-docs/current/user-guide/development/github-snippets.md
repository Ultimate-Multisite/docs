...
---
# Cara menggunakan snippet Ultimate Multisite dari repositori GitHub kami {#how-to-use-ultimate-multisite-snippets-on-our-github-repository}
...
# Cara menambahkan snippet di file functions.php tema Anda {#how-to-add-the-snippet-on-your-themes-functionsphp-file}
...
# Cara membuat Must-Use Plugins (mu-plugins) {#how-to-create-must-use-plugins-mu-plugins}
