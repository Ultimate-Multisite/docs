...
---
# Templat Situs (v2) {#site-templates-v2}
...
## Apa itu Templat Situs? {#what-is-a-site-template}
...
## Membuat dan Mengedit Templat Situs baru {#creating-and-editing-a-new-site-template}
...
### Menyesuaikan konten Templat Situs {#customizing-the-contents-of-a-site-template}
...
### Menggunakan Templat Situs {#using-site-templates}
...
#### Mode 1: Tetapkan Templat Situs {#mode-1-assign-site-template}
...
#### Mode 2: Pilih Templat Situs yang Tersedia {#mode-2-choose-available-site-template}
...
### Mode Default: pemilihan templat situs pada formulir Checkout {#default-mode-site-template-selection-on-the-checkout-form}
...
### Opsi Templat Situs {#site-template-options}
...
#### Izinkan Penggantian Templat {#allow-template-switching}
...
#### Izinkan Pengguna menggunakan Situs mereka sebagai templat {#allow-users-to-use-their-site-as-templates}
...
#### Salin Media saat Duplikasi Templat {#copy-media-on-template-duplication}
...
#### **Cegah Mesin Pencari mengindeks Templat Situs** {#prevent-search-engines-from-indexing-site-templates}
...
## Mengisi Templat Situs sebelumnya dengan pencarian-dan-penggantian otomatis {#pre-populating-site-templates-with-auto-search-and-replace}
...
### Mengatasi masalah "templat penuh dengan placeholder" {#solving-the-template-full-of-placeholders-problem}
