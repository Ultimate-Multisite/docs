---
title: 'Pelajaran 10: Hari Peluncuran'
sidebar_position: 11
...
- [ ] Pemetaan domain berfungsi — uji coba membuat situs dan memetakan domain kustom
...
- [ ] Semua gambar memiliki lisensi yang benar (tidak ada watermark foto stok)
- [ ] Responsivitas mobile berfungsi di setiap halaman template
...
- [ ] Harga sudah benar (bulanan dan tahunan)
- [ ] Biaya setup sudah dikonfigurasi pada paket yang tepat
- [ ] Masa percobaan berfungsi pada paket Starter
...
- [ ] Pelanggan menerima email selamat datang setelah mendaftar
- [ ] Situs baru dibuat dengan template yang benar
...
- [ ] Semua email sistem menggunakan branding FitSite dan bahasa spesifik kebugaran
...
- [ ] Urutan email selamat datang sudah dikonfigurasi dan diuji
...
- [ ] Kebijakan pengembalian dana (Refund policy) sudah ditentukan dan didokumentasikan
- [ ] Entitas bisnis sudah disiapkan untuk menerima pembayaran
...
- Umpan balik jujur mengenai pengalaman pendaftaran dan onboarding
- Izin untuk menggunakan situs mereka sebagai contoh pameran
- Pelaporan bug atau masalah apa pun yang mereka temui
...
- Ubah payment gateway ke mode live
- Publikasikan situs pemasaran Anda
...
1. **Beralih ke pembayaran live** — nonaktifkan mode uji coba pada payment gateway Anda
2. **Verifikasi sekali lagi** — lakukan pendaftaran uji coba penuh dengan pembayaran nyata (kembalikan dana kepada diri sendiri setelahnya)
3. **Pantau dengan cermat** — waspadai kesalahan, pendaftaran yang gagal, atau masalah pembayaran
...
- **Masalah payment gateway**: Siapkan kontak dukungan penyedia gateway Anda
- **Masalah sertifikat SSL**: Ketahui cara memeriksa dan memperbarui sertifikat
- **Kegagalan pengiriman email**: Uji bahwa email benar-benar tiba (periksa folder spam)
...
- **Prosedur hari peluncuran** untuk meluncurkan dengan percaya diri
- **Rencana darurat** untuk masalah umum hari peluncuran

---

**Selanjutnya:** [Pelajaran 11: Menemukan Pelanggan](lesson-11-customers) — sekarang FitSite sudah live, bagaimana cara Anda mendapatkan pemilik studio kebugaran untuk mendaftar?
