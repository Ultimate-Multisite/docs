...
|--------|-------|---------|
| **Seluler** | 375px | Ponsel potret |
| **Tablet** | 768px | Tablet lanskap |
...
- **Verifikasi kontras** — gunakan [Validate Palette Contrast](../abilities/validate-palette-contrast.md) untuk aksesibilitas
...
- [Validate Palette Contrast](../abilities/validate-palette-contrast.md) — periksa aksesibilitas warna
- [Generate Logo SVG](../abilities/generate-logo-svg.md) — buat logo kustom
