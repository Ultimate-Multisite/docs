...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Direkomendasikan untuk foto |
...
- **Palet warna** — warna dominan diekstrak dan digunakan dalam tema
- **Gaya visual** — modern, pedesaan (*rustic*), minimalis, cerah, dll.
- **Suasana dan atmosfer** — profesional, kreatif, ramah, mewah, dll.
...
- **Mood board** — kumpulan gambar yang mewakili estetika yang Anda inginkan
- **Foto produk** — jika Anda memiliki produk untuk ditampilkan
...
- **Gambar yang padat teks** — tangkapan layar dengan banyak teks
...
3. **Sertakan variasi** — campuran warna, gaya, dan subjek
...
- **Palet warna** — warna primer, sekunder, dan aksen
- **Tipografi** — keluarga font untuk judul dan teks isi
- **Gaya tata letak** — spasi, perataan, dan penataan komponen
...
1. Tinjau arah desain yang dihasilkan
2. Berikan umpan balik atau minta penyesuaian
...
- [Tools and Configuration](./tools.md) — alat dan opsi konfigurasi yang tersedia
