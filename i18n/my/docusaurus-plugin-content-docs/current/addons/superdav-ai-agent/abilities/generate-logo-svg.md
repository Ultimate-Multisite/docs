...
## Output Format (ထုတ်ပေးသည့် ပုံစံ) {#output-format}
...
## SVG Sanitisation Behaviour (SVG ကို သန့်စင်ခြင်း လုပ်ဆောင်ပုံ) {#svg-sanitisation-behaviour}
...
## Usage Example (အသုံးပြုပုံ ဥပမာ) {#usage-example}
...
## Integration with Theme Builder (Theme Builder နှင့် ပေါင်းစပ်အသုံးပြုခြင်း) {#integration-with-theme-builder}
...
## Best Practices (အကောင်းဆုံး အလေ့အကျင့်များ) {#best-practices}
...
## Limitations (ကန့်သတ်ချက်များ) {#limitations}
...
## Related Abilities (ဆက်စပ် စွမ်းရည်များ) {#related-abilities}
