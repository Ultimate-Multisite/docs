...
## ပြန်ရရှိသည့် တန်ဖိုး (Return Value) {#return-value}
...
## လမ်းညွှန်အမည် (Navigation Label) နှင့် စာမျက်နှာခေါင်းစဉ် (Page Title) {#navigation-label-vs-page-title}
...
## အသုံးပြုမှု ဥပမာများ {#usage-examples}

### ဥပမာ ၁- လမ်းညွှန်အမည်ပါ ရိုးရှင်းသော မီနူး {#example-1-simple-menu-with-navigation-label}
...
### ဥပမာ ၂- သီးသန့် Theme Location အတွက် မီနူး {#example-2-menu-for-specific-theme-location}
...
## ဆက်စပ် လုပ်ဆောင်ချက်များ (Related Abilities) {#related-abilities}
...
## ကန့်သတ်ချက်များ (Limitations) {#limitations}
...
## ဆက်စပ် လုပ်ဆောင်ချက်များ (Related Abilities) {#related-abilities-1}
