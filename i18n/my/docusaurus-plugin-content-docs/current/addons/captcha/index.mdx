...
## Cap Captcha: ကိုယ်ပိုင် server ပေါ်မှာ တည်ရှိတဲ့၊ အလုပ်လုပ်ရလွယ်ကူတဲ့ အကာအကွယ်စနစ် {#cap-captcha-self-hosted-protection-that-just-works}
...
## WooCommerce Card Testing အကာအကွယ် {#woocommerce-card-testing-protection}
...
## Google reCAPTCHA ဒါမှမဟုတ် hCaptcha လိုအပ်သေးလား? {#still-need-google-recaptcha-or-hcaptcha}
...
## ကြီးမားတဲ့ စနစ်အတွက် တည်ဆောက်ထားခြင်း {#built-for-scale}
...
## စနစ်ထည့်သွင်းခြင်း (Installation) {#installation}
...
## မကြာခဏ မေးလေ့ရှိတဲ့ မေးခွန်းများ {#frequently-asked-questions}

## ဘာများ configure လုပ်ရမလဲ? {#do-i-need-to-configure-anything}
...
## Cap Captcha အတွက် API key တွေ လိုပါသလား? {#do-i-need-api-keys-for-cap-captcha}
...
## ဒါက checkout လုပ်တာကို နှေးကွေးစေမှာလား? {#will-this-slow-down-my-checkout}
...
## ဒါက card testing တိုက်ခိုက်မှုတွေကို ကာကွယ်ပေးသလား? {#does-this-protect-against-card-testing-attacks}
...
## မတူညီတဲ့ site တွေမှာ မတူညီတဲ့ captcha provider တွေ သုံးလို့ရလား? {#can-i-use-different-captcha-providers-on-different-sites}
...
## ဒါက GDPR နဲ့ ကိုက်ညီသလား? {#is-this-gdpr-compliant}
...
### စနစ်ထည့်သွင်းခြင်း (Configuration) {#configuration}
...
### ချဲ့ထွင်နိုင်မှု (Extensibility) {#extensibility}
...
### ယုံကြည်မှုပုံစံ (Trust Model) {#trust-model}
...
### စနစ်ထည့်သွင်းခြင်း (Configuration) {#configuration-1}
...
#### ပထမဆုံး enable လုပ်တဲ့အခါ အလိုအလျောက် သိရှိခြင်း (First-Enable Auto-Detection) {#first-enable-auto-detection}
...
### ဘာကြောင့် အရေးပါသလဲ {#why-this-matters}
