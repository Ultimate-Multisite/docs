...
အရာဝတ္ထုတစ်ခုကို database ထဲမှာ သိမ်းဆည်းပြီးတဲ့အခါမှာ အလုပ်လုပ်တဲ့ Action တစ်ခုပါ။

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $result | `bool` | Object ကို အောင်မြင်စွာ ဖျက်နိုင်ခဲ့ရင် True ဖြစ်ပါတယ်။ |
| $this | `\Base_Model` | Object ရဲ့ ပုံစံ (instance) ကို ကိုယ်စားပြုပါတယ်။ |
