...
## စနစ်ထည့်သွင်းခြင်း လမ်းညွှန် {#setup-instructions}

### ၁။ သင့် RunCloud API အထောက်အထားများ ရယူခြင်း {#1-get-your-runcloud-api-credentials}
...
### ၂။ သင့် Server နှင့် App ID များ ရယူခြင်း {#2-get-your-server-and-app-ids}
...
### ၄။ ပေါင်းစည်းမှုကို ဖွင့်ခြင်း {#4-enable-the-integration}
...
### Domain ထည့်သွင်း၍ မရခြင်း {#domain-not-added}
