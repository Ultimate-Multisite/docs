...
## တပ်ဆင်ခြင်း လမ်းညွှန်ချက်များ {#setup-instructions}

### ၁။ သင့် ServerPilot API Credentials များ ရယူခြင်း {#1-get-your-serverpilot-api-credentials}
...
### ၂။ သင့် App ID ရယူခြင်း {#2-get-your-app-id}
...
### ၃။ wp-config.php တွင် Constant များ ထည့်သွင်းခြင်း {#3-add-constants-to-wp-configphp}
...
### ၄။ ပေါင်းစပ်မှုကို ဖွင့်ခြင်း {#4-enable-the-integration}
...
### Domain Sync လုပ်ခြင်း {#domain-syncing}
...
## SSL Certificate အတည်ပြုခြင်း {#ssl-certificate-verification}
...
### Domain မထည့်သွင်းရသေးခြင်း {#domain-not-added}
...
### Domain ဖယ်ရှားခြင်း {#domain-removal}
