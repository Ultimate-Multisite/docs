...
### 1. သင်၏ Cloudflare API Key ကို ရယူပါ
...
### 3. wp-config.php တွင် Constant များ ထည့်ပါ
...
### စံ Cloudflare ပေါင်းစည်းမှုနှင့် မည်သို့ကွာခြားသနည်း
...
### Cloudflare Custom Hostnames ကို တပ်ဆင်ခြင်း
...
### Subdomain မထည့်သွင်းနိုင်ခြင်း
