...
## တပ်ဆင်ခြင်း လမ်းညွှန် {#setup-instructions}

### ၁။ သင်၏ GridPane API အထောက်အထားများ ရယူခြင်း {#1-get-your-gridpane-api-credentials}
...
### ၂။ သင်၏ Server နှင့် Site ID များ ရယူခြင်း {#2-get-your-server-and-site-ids}
...
### ၄။ ပေါင်းစည်းခြင်းကို ဖွင့်ခြင်း {#4-enable-the-integration}
...
## SUNRISE Constant စီမံခန့်ခွဲခြင်း {#sunrise-constant-management}
