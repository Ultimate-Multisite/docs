...
---
# Enhance Control Panel ချိတ်ဆက်မှု {#enhance-control-panel-integration}
...
### စနစ်ဆိုင်ရာ လိုအပ်ချက်များ {#system-requirements}
...
## သင့် API Credentials များ ရယူခြင်း {#getting-your-api-credentials}

### ၁။ API Token ဖန်တီးခြင်း {#1-create-an-api-token}
...
### ၂။ သင့် Organization ID ရယူခြင်း {#2-get-your-organization-id}
...
### ၃။ သင့် Server ID ရယူခြင်း {#3-get-your-server-id}
...
### ၄။ သင့် API URL ရယူခြင်း {#4-get-your-api-url}
...
### လိုအပ်သော Constants များ {#required-constants}
...
### Integration Wizard မှတဆင့် Setup လုပ်ခြင်း {#setup-via-integration-wizard}
...
## နောက်ထပ် WordPress Configuration {#additional-wordpress-configuration}
...
### Domain Map လုပ်တဲ့အခါ {#when-a-domain-is-mapped}
...
### Domain ဖယ်ရှားတဲ့အခါ {#when-a-domain-is-removed}
...
### DNS နှင့် SSL စစ်ဆေးခြင်း {#dns-and-ssl-checking}
...
## Setup စစ်ဆေးခြင်း {#verifying-setup}

### Connection စမ်းသပ်ခြင်း {#test-the-connection}
...
### Domain Map လုပ်ပြီးနောက် {#after-mapping-a-domain}
...
### API Connection ပြဿနာများ {#api-connection-issues}
...
### အသုံးပြုသော Common Endpoints များ {#common-endpoints-used}
...
### API Documentation အပြည့်အစုံ {#full-api-documentation}
API documentation အပြည့်အစုံ: [https://apidocs.enhance.com](https://apidocs.enhance.com)

## အကောင်းဆုံး လုပ်ထုံးလုပ်နည်းများ {#best-practices}
...
## နောက်ထပ် အရင်းအမြစ်များ {#additional-resources}
