...
### ၁။ Hostinger API Token ကို ထုတ်ပေးခြင်း
...
### ၃။ wp-config.php တွင် Constants များ ထည့်ခြင်း
...
### ၄။ Integration ကို ဖွင့်ပေးခြင်း
