...
## တပ်ဆင်မှု လမ်းညွှန် {#setup-instructions}

### ၁။ သင့် cPanel အထောက်အထားများ ရယူပါ {#1-get-your-cpanel-credentials}
...
### ၂။ wp-config.php တွင် Constant များ ထည့်သွင်းပါ {#2-add-constants-to-wp-configphp}
...
### ၃။ ပေါင်းစည်းမှုကို ဖွင့်ပါ {#3-enable-the-integration}
...
### Addon Domain များ {#addon-domains}
