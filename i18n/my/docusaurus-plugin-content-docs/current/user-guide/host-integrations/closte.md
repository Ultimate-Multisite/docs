...
### ၁။ သင်၏ Closte API Key ကို အတည်ပြုခြင်း {#1-verify-your-closte-api-key}
...
### ၂။ ပေါင်းစပ်မှုကို ဖွင့်ခြင်း {#2-enable-the-integration}
...
## Domain Record ဖန်တီးခြင်း {#domain-record-creation}
