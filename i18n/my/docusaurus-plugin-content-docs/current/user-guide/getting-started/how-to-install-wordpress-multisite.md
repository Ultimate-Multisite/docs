...
---
# WordPress Multisite ကို ဘယ်လို ထည့်သွင်းရမလဲ? {#how-do-i-install-wordpress-multisite}
...
# /wp-admin ရဲ့နောက်မှာ trailing slash ထည့်ပေးတယ် {#add-a-trailing-slash-to-wp-admin}
...
## ဖြစ်တတ်တဲ့ ပြဿနာများ: {#common-problems}

### 1\. ဆိုက်အသစ်တွေ ဖန်တီးလို့ရပေမယ့် access လုပ်လို့မရဘူး။ {#1-i-can-create-new-sites-but-they-are-not-accessible}
