...
## Theme Builder စတင်အသုံးပြုမှု လမ်းညွှန်မှုဆိုတာ ဘာလဲ။
...
## Theme Builder စတင်အသုံးပြုခြင်း

### ပထမဆုံးအကြိမ် စနစ်တကျ တည်ဆောက်ခြင်း (First-Run Setup)
...
### ကိုယ်တိုင် စတင်ခြင်း (Manual Activation)
...
## စတင်အသုံးပြုမှု အဆင့်များ

### အဆင့် ၁- ပုံစံရွေးချယ်ခြင်း (Mode Selection)
...
### အဆင့် ၂- ဝက်ဘ်ဆိုဒ် အသေးစိတ်သတ်မှတ်ခြင်း (Site Specification)
...
### အဆင့် ၃- ဒီဇိုင်းစနစ် ဆုံးဖြတ်ချက်များ (Design System Decisions)
...
### အဆင့် ၄- Theme ဖန်တီးခြင်း (Theme Generation)
...
### အဆင့် ၅- အသက်သွင်းခြင်းနှင့် စစ်ဆေးခြင်း (Activation and Verification)
...
## Site Specification နှင့် site_brief မှတ်ဉာဏ်
...
### site_brief ဘာကြောင့် အရေးပါသလဲ
...
### သင့် site_brief ကို ကြည့်ရှုခြင်း
...
## စတင်အသုံးပြုပြီးနောက် စိတ်ကြိုက်ပြင်ဆင်ခြင်း (Customizing After Onboarding)

Theme Builder စတင်အသုံးပြုမှု လမ်းညွှန်မှု ပြီးဆုံးသွားပြီးနောက်မှာ သင်လုပ်နိုင်တာတွေကတော့-

### Design System Aesthetics Skill ကို အသုံးပြုခြင်း
...
### theme.json ကို တိုက်ရိုက်တည်းဖြတ်ခြင်း (Edit theme.json Directly)
...
### စိတ်ကြိုက် Block Templates များ ဖန်တီးခြင်း (Create Custom Block Templates)
...
## နှိုင်းယှဉ်ချက်- အရင်ပုံစံ vs. အသစ်ပုံစံ (Comparison: Old vs. New Onboarding)
