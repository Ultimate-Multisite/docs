...
---
# Ultimate Multisite ကို တပ်ဆင်ခြင်း {#installing-ultimate-multisite}
...
## ပလပ်အင်ကို တပ်ဆင်ခြင်း {#installing-the-plugin}

Ultimate Multisite သည် [WordPress.org](https://wordpress.org/plugins/ultimate-multisite/) တွင် အခမဲ့ ရရှိနိုင်သည်။
...
**"Ultimate Multisite"** (အတိတိကျကို ရှာရန်အတွက် အပိုအကွပ်ပါ) ဖြင့် ရှာပြီး ပထမဆုံးရလဒ်အဖြစ်ပေါ်လာလိမ့်မည်။ **Install Now** ကိုနှိပ်ပါ။
...
Setup Wizard သည် ၁၀ မိနစ်ခန့်တွင် Ultimate Multisite ကို စီမံဆောင်ရန်အတွက် သင်တို့ကို လမ်းညွှန်ပေးလိမ့်မည်။
...
### တပ်ဆင်ခြင်းမပြုမီ စစ်ဆေးမှုများ {#pre-install-checks}

ဤအဆင့်တွင် သင်၏ စနစ်သတင်းနှင့် WordPress အထောက်အထားကို Ultimate Multisite ၏ လိုအပ်ချက်များကို ဖြည့်ဆည်းနိုင်သည် ဟုတ်မဟုတ် စစ်ဆေးသည်။ အရာအားလုံး ကောင်းမွန်နေပါက **Go to the Next Step** ကိုနှိပ်ပါ။
...
Ultimate Multisite ကို တပ်ဆင်ထားသော်လည်း **စကေးတက်ကြွမရှိသေးပါက**—ဥပမာအားဖြင့်၊ network plugins မျက်နှာပြင်မှ **Activate** (တစ်ခုစီ site) ကို နှိပ်ပြီး **Network Activate** ကို နှိပ်ခြင်း မဟုတ်ပါက—တပ်ဆင်ခြင်းမပြုမီ စစ်ဆေးမှုအဆင့်တွင် ဤသို့တွေ့ရှိပြီး **Network Activate** ခလုတ်ကို ပြသလိမ့်မည်။
...
installer သည် လိုအပ်သော database table များအား ဖန်တီးပြီး Ultimate Multisite လုပ်ဆောင်နိုင်စေရန် `sunrise.php` ဖိုင်ကို တပ်ဆင်လိမ့်မည်။ ဆက်လက်လုပ်ဆောင်ရန် **Install** ကိုနှိပ်ပါ။

![database table များနှင့် sunrise.php တို့ကို ပြသော တပ်ဆင်ခြင်းအဆင့်](/img/installation/wizard-installation.png)

### သင်၏ကုမ္ပဏီ {#your-company}
...
ပြီးပြီ! သင်၏ Ultimate Multisite တပ်ဆင်မှု ပြီးစီးသွားသည်။ ယခု သင်သည် **Network Admin Dashboard** မှ သင်၏ Website as a Service ပလပ်ဖောင်းကို တည်ဆောက်ရန် စတင်နိုင်သည်။

![Setup ပြီးဆုံး - အဆင်သင့်ရှိသော မျက်နှာပြင်](/img/installation/wizard-ready.png)

![Network Admin Dashboard နှင့် Ultimate Multisite တက်ကြွနေသည်](/img/installation/network-dashboard.png)
