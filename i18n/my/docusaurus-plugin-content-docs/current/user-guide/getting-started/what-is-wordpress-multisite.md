...
---
# WordPress Multisite ဆိုတာ ဘာလဲ? {#what-is-wordpress-multisite}
...
## WordPress Multisite ဆိုတာ အတိအကျ ဘာလဲ? {#what-exactly-is-wordpress-multisite}
...
## Subdomain ဒါမှမဟုတ် Subdirectory? {#subdomain-or-subdirectory}
...
## Subsite တွေကြား ဘာတွေ မျှဝေပြီး ဘာတွေ မမျှဝေဘူးလဲ {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite မှာ User စီမံခန့်ခွဲမှု {#user-management-on-wordpress-multisite}
...
## Performance ထည့်သွင်းစဉ်းစားချက်များ {#performance-considerations}
