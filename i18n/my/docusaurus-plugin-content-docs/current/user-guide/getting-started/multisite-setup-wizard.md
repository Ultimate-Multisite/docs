...
## Wizard က ဘယ်အချိန်မှာ ပေါ်လာမလဲ? {#when-does-the-wizard-appear}
...
## အဆင့် ၁: ကြိုဆိုခြင်း {#step-1-welcome}
...
## အဆင့် ၂: Network Configuration {#step-2-network-configuration}
...
## အဆင့် ၃: Installation {#step-3-installation}
...
## အဆင့် ၄: ပြီးဆုံးခြင်း {#step-4-complete}
...
### Wizard က wp-config.php ရေးသားလို့မရဘူးလို့ ပြောနေတယ် {#the-wizard-says-wp-configphp-is-not-writable}
...
### Setup ပြီးနောက် site တွေကို ဝင်လို့မရဘူး (subdomain များ) {#sites-are-not-accessible-after-setup-subdomains}
...
### Setup ပြီးနောက် authentication ပြဿနာများ {#authentication-issues-after-setup}
...
### Installation အတွင်း အဆင့်တစ်ခု fail ဖြစ်သွားတယ် {#a-step-failed-during-installation}
