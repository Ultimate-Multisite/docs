...
## Endpoint body parameters များ {#endpoint-body-parameters}
...
## Zapier မှာ action တစ်ခု ဖန်တီးခြင်း {#creating-an-action-in-zapier}
...
### Action တစ်ခု ဖန်တီးခြင်း {#creating-an-action}
...
### Endpoint parameter အပြည့်အစုံ {#complete-endpoint-parameters}
