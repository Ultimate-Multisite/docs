...
---
# Ultimate Multisite code snippet များကို ကျွန်ုပ်တို့ GitHub repository တွင် အသုံးပြုနည်း {#how-to-use-ultimate-multisite-snippets-on-our-github-repository}
...
ဤဆောင်းပါးတွင် ဤ code များကို မည်သို့အသုံးပြုရမည်၊ အထူးသဖြင့် မည်သည့်နေရာတွင် ထားရမည်ကို ပြသပေးပါမည်။
...
Code ထည့်သွင်းရန် နည်းလမ်း ၂ ခု ရှိပါသည်
  ...
  1. သင့် theme ၏ functions.php file တွင်

  2. Must-Use Plugins (mu-plugins)

# သင့် theme ၏ functions.php file တွင် snippet ထည့်သွင်းနည်း {#how-to-add-the-snippet-on-your-themes-functionsphp-file}

  1. သင့် WordPress Network admin dashboard သို့ ဝင်ရောက်ပြီး Themes > Theme Editor သို့ သွားပါ (အောက်ပါ screenshot ကို ကြည့်ပါ)။

  2. "Edit Themes" စာမျက်နှာတွင်၊ သင့်စခရင်၏ ညာဘက်အပေါ်ထောင့်ရှိ dropdown field တွင် သင်အသုံးပြုနေသော theme ကို ရွေးချယ်ထားကြောင်း သေချာပါစေ (အောက်ပါ screenshot တွင် #3)။

  3. File ကို ဖွင့်ရန် "Theme Files" အပိုင်းအောက်ရှိ functions.php file ကို နှိပ်ပါ။ အောက်ဆုံးသို့ scroll ဆင်းပြီး GitHub repository မှ ရရှိသော Ultimate Multisite snippet ကို paste လုပ်ပါ။

<!-- Screenshot unavailable: WordPress Theme Editor showing functions.php file editing -->

# Must-Use Plugins (mu-plugins) ဖန်တီးနည်း {#how-to-create-must-use-plugins-mu-plugins}
