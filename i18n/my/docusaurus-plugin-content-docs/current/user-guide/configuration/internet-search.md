...
## Internet Search ကို ဖွင့်ခြင်း (Enabling Internet Search)
...
### Brave Search API Key ရယူခြင်း (Obtaining a Brave Search API Key)
...
### အသုံးပြုမှု ကန့်သတ်ချက်များ (Usage Limits)
...
### Tavily API Key ရယူခြင်း (Obtaining a Tavily API Key)
...
## Internet Search ကို ပိတ်ခြင်း (Disabling Internet Search)
