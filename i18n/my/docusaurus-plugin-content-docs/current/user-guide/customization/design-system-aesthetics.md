...
## Design System Aesthetics ဆိုတာ ဘာလဲ။ {#what-is-design-system-aesthetics}
...
## Design System Aesthetics ကို ဘာကြောင့် သုံးသင့်သလဲ။ {#why-use-design-system-aesthetics}

### တသမတ်ကျမှု (Consistency) {#consistency}
...
### စွမ်းဆောင်ရည် (Efficiency) {#efficiency}
...
### ပြောင်းလွယ်ပြင်လွယ်ရှိမှု (Flexibility) {#flexibility}
...
## Design System Aesthetics Skill ကို စတင်အသုံးပြုခြင်း {#triggering-the-design-system-aesthetics-skill}

### ကိုယ်တိုင်စတင်ခြင်း (Manual Activation) {#manual-activation}
...
## The Design System Aesthetics လုပ်ငန်းစဉ် {#the-design-system-aesthetics-process}

### အဆင့် ၁: Typography {#step-1-typography}
...
### အဆင့် ၂: Color Palette {#step-2-color-palette}
...
### အဆင့် ၃: Spacing {#step-3-spacing}
...
### အဆင့် ၄: Borders and Shadows {#step-4-borders-and-shadows}
...
### အဆင့် ၅: Motion and Animation {#step-5-motion-and-animation}
...
## Design System Aesthetics ကို အသုံးပြုခြင်း {#applying-design-system-aesthetics}

### အလိုအလျောက် အသုံးပြုခြင်း (Automatic Application) {#automatic-application}
...
### ကိုယ်တိုင်အသုံးပြုခြင်း (Manual Application) {#manual-application}
...
## သင့်ရဲ့ Design System ကို ကြည့်ရှုခြင်း {#viewing-your-design-system}

### Agent ကို မေးမြန်းခြင်း {#ask-the-agent}
...
### theme.json ကို ကြည့်ရှုခြင်း {#view-themejson}
...
## သင့်ရဲ့ Design System ကို Update လုပ်ခြင်း {#updating-your-design-system}

### လျင်မြန်စွာ Update လုပ်ခြင်း (Quick Updates) {#quick-updates}
...
### အပြည့်အဝ ပြန်လည်ဒီဇိုင်းဆွဲခြင်း (Full Redesign) {#full-redesign}
...
### တစ်စိတ်တစ်ပိုင်း Update လုပ်ခြင်း (Partial Updates) {#partial-updates}
...
## Design System အကောင်းဆုံး အလေ့အကျင့်များ (Best Practices) {#design-system-best-practices}

### တသမတ်ကျမှု (Consistency) {#consistency-1}
...
### ချဲ့ထွင်နိုင်မှု (Scalability) {#scalability}
...
### စာရွက်စာတမ်းပြုစုခြင်း (Documentation) {#documentation}
...
## အဖြစ်များတဲ့ Design System ပုံစံများ (Common Design System Patterns) {#common-design-system-patterns}

### ခေတ်မီ ရိုးရှင်းမှု (Modern Minimalist) {#modern-minimalist}
...
### နွေးထွေးပြီး ရင်းနှီးမှုရှိခြင်း (Warm and Friendly) {#warm-and-friendly}
...
### ကျွမ်းကျင်တဲ့ Corporate ပုံစံ (Professional Corporate) {#professional-corporate}
...
### တီထွင်ဖန်တီးမှုနဲ့ ရဲရင့်ခြင်း (Creative and Bold) {#creative-and-bold}
