...
## အသုံးပြုရမည့် Command များ {#commands-to-run}
...
## အဖြစ်များသော အမှားများ {#common-failures}

### Database grants များ မတူညီခြင်း {#database-grants-do-not-match-the-host}
...
### Bedrock သို့မဟုတ် local installs များ ချိတ်ဆက်၍ မရခြင်း {#bedrock-or-local-installs-cannot-connect}
...
### Async push queue သည် drain မလုပ်ခြင်း {#async-push-queue-does-not-drain}
...
### Tenant user count မှားနေခြင်း {#tenant-user-count-is-wrong}
...
### SSO visit ကို ငြင်းပယ်ခံရခြင်း {#sso-visit-is-rejected}
...
## ပြန်လည်ကြိုးစားရမည့်အချိန် {#when-to-retry}
