...
## ဖွဲ့စည်းတည်ဆောက်မှု ညွှန်ကြားချက်များ

### ၁။ CyberPanel API ကို ဖွင့်ပါ
...
### ၂။ wp-config.php တွင် Constants များ ထည့်ပါ
