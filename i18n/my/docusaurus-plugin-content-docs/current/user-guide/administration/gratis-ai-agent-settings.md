...
## ဆက်တင်များကို ဝင်ရောက်ခြင်း {#accessing-settings}

1. WordPress admin တွင် **Gratis AI Agent → Settings** သို့ သွားပါ။
2. **Advanced** tab ကို နှိပ်ပါ။

## Feedback Endpoint ပြင်ဆင်သတ်မှတ်မှု {#feedback-endpoint-configuration}
...
### မျှော်မှန်းထားသော JSON Payload {#expected-json-payload}
...
### `triage_category` တန်ဖိုးများ {#triagecategory-values}
...
### Feedback စုဆောင်းမှုကို ပိတ်ခြင်း {#disabling-feedback-collection}
...
## စီမံထားသော Superdav ဝန်ဆောင်မှု {#managed-superdav-service}
...
## Google Calendar ပြင်ဆင်သတ်မှတ်မှု {#google-calendar-configuration}
...
## TextBee SMS အသိပေးချက်များ {#textbee-sms-notifications}
...
## Feature Flag များ {#feature-flags}
...
### Feature Flag များကို ဝင်ရောက်ခြင်း {#accessing-feature-flags}

1. WordPress admin တွင် **Gratis AI Agent → Settings** သို့ သွားပါ။
2. **Feature Flags** tab ကို နှိပ်ပါ။

### ဝင်ရောက်ခွင့် ထိန်းချုပ်မှု Flag များ {#access-control-flags}
...
### အမှတ်တံဆိပ် အလံများ {#branding-flags}
...
### အလိုအလျောက်လုပ်ဆောင်မှု လုံခြုံရေး အလံများ {#automation-safety-flags}
...
### ပြောင်းလဲမှုများ အသုံးချခြင်း {#applying-changes}
