...
## လိုအပ်သော ခွင့်ပြုချက်များ {#required-permissions}
...
## Site တစ်ခုကို ZIP အဖြစ် Export လုပ်ခြင်း {#exporting-a-site-to-a-zip}
...
## Export ထဲမှာ ဘာတွေ ပါဝင်သလဲ {#what-the-export-includes}
...
## ZIP တစ်ခုကနေ Site တစ်ခုကို Import လုပ်ခြင်း {#importing-a-site-from-a-zip}
...
## ကန့်သတ်ချက်များနှင့် တွဲဖက်အသုံးပြုနိုင်မှု အချက်များ {#limitations-and-compatibility-notes}
