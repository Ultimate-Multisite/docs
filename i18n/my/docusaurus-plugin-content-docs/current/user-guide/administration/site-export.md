...
---
# Site Export (ဆိုဒ် အချက်အလက် ထုတ်ယူခြင်း)
...
## Exporting one site (ဆိုဒ်တစ်ခုကို ထုတ်ယူခြင်း)
...
## Exporting the whole network (network တစ်ခုလုံးကို ထုတ်ယူခြင်း)
...
### Network Import Bundles (Network တင်သွင်းမှု အစုအဝေးများ)
...
#### Generating a Network Import Bundle (Network Import Bundle တစ်ခု ဖန်တီးခြင်း)
...
#### Restoring from a Network Import Bundle (Network Import Bundle မှ ပြန်လည်ရရှိစေခြင်း)
...
## Installing a self-booting export ZIP (self-booting export ZIP တစ်ခု ထည့်သွင်းခြင်း)
