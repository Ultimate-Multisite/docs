...
## အဖွဲ့ဝင်အဆင့် အခြေအနေ ဘဝသံသရာ (Membership Status Lifecycle)
...
### အဖွဲ့ဝင်အဆင့်များ မည်သို့ Expired ဖြစ်သို့ ပြောင်းလဲသနည်း
...
#### Auto-Renewing နှင့် Non-Auto-Renewing အဖွဲ့ဝင်အဆင့်များ
...
### စမ်းသပ်ကာလများ မည်သို့ ပြီးဆုံးသနည်း
...
## Frontend ဝင်ရောက်ခွင့် ပိတ်ဆို့ခြင်း (Block Frontend Access)
...
### Setting ကို စနစ်တကျ သတ်မှတ်ခြင်း (Configuring the Setting)
...
### Site ပိတ်ဆို့သည့်အခါ ဧည့်သည်များ မြင်ရသည်များ
...
### မည်သည့်အရာကို မည်သည့်အချိန်တွင် ပိတ်ဆို့သနည်း
...
## Troubleshooting: သက်တမ်းကုန်ဆုံးပြီးနောက် Site များ ဆက်လက် ဝင်ရောက်နိုင်နေခြင်း
...
### 1. Block Frontend Access Setting ကို ဖွင့်ထားကြောင်း အတည်ပြုပါ
...
### 2. Frontend Block Grace Period ကို စစ်ဆေးပါ
...
### 3. Membership Status သည် အမှန်တကယ် ပြောင်းလဲသွားကြောင်း အတည်ပြုပါ
...
### 4. Action Scheduler အလုပ်လုပ်ခြင်း ရှိမရှိ စစ်ဆေးပါ
...
### 5. Gateway Webhook ပြဿနာများ စစ်ဆေးပါ (Auto-Renewing Memberships)
...
### 6. Expiration Grace Period (Cron Level) ကို စစ်ဆေးပါ
...
### 7. အဖွဲ့ဝင်အဆင့်ကို ကိုယ်တိုင် Expire လုပ်ခြင်း
