...
---
# Domain Mapping (v2) ကို ပြင်ဆင်သတ်မှတ်နည်း
...
### သင်၏ Ultimate Multisite Network တွင် domain mapping ကို စတင်သတ်မှတ်နည်း
...
### domain ၏ DNS settings များ မှန်ကန်စွာ ပြင်ဆင်ထားကြောင်း သေချာစေရန်
...
### Super Admin အဖြစ် custom domain name ကို ချိတ်ဆက်သတ်မှတ်ခြင်း
...
### Subsite user အဖြစ် custom ဒိုမိန်းအမည် map လုပ်ခြင်း
