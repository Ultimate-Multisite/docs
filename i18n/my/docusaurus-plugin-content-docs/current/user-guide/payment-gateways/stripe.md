...
## Stripe ကို ဖွင့်ခြင်း {#enabling-stripe}
...
### Stripe နှင့် Stripe Checkout ကွာခြားချက်: {#stripe-vs-stripe-checkout}
...
## Stripe Webhook ပြင်ဆင်ခြင်း {#setting-up-stripe-webhook}
