...
---
# ငွေပေးချေမှု လက်ခံခြင်း (v2) {#getting-paid-v2}
...
## အခြေခံ ဆက်တင်များ {#basic-settings}
...
## Gateway များကို ရှာနိုင်သည့်နေရာ- {#where-to-find-the-gateways}
...
### WooCommerce add-on ကို ထည့်သွင်းနည်း- {#how-to-install-the-woocommerce-add-on}
...
### GoCardless အက်ဒ်အွန်ကို ထည့်သွင်းနည်း: {#how-to-install-the-gocardless-add-on}
...
### Payfast အက်ဒ်အွန်ကို ထည့်သွင်းနည်း: {#how-to-install-the-payfast-add-on}
