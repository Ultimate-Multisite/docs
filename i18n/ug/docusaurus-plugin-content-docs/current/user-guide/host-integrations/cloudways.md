...
### 4. İnteqrasiyanı Aktiv Etmək {#4-enable-the-integration}
...
### Domain Syncing (Domendir Səhmlənməsi) {#domain-syncing}
...
### SSL Certificate Management (SSL Sertifikatının İdarə Edilməsi) {#ssl-certificate-management}
...
## مهم — تله گواهی SSL وایلدکارد {#important--wildcard-ssl-pitfall}
