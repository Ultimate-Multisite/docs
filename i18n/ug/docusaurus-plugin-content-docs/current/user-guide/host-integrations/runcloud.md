...
### 1. RunCloud API Sertifikatlaringizi Almagyňyz
...
### 2. Server we App IDlaringizi Almagyňyz
...
### 3. wp-config.php-e Sabitleri Goşmagyňyz
...
### 4. Integrasiýany Aktiw Etmek (Enable the Integration)
