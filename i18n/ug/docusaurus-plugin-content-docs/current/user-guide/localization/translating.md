...
Bu standart WordPress jamoatchiligi tarjima tizimidir. Tarjimalar yetarli tasdiqlash chegarasiga yetganda, ular WordPress plugin yangilanishlari orqali barcha Ultimate Multisite foydalanuvchilari uchun avtomatik tarqatiladi.

**Bizga yordam kerak!** Agar siz inglizdan boshqa tilni biladigan bo'lsangiz, tarjima qila olishingiz mumkin. Bir nechta matnni tarjima qilish ham yordam beradi. Boshlash uchun:

1. [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/) saytiga kiring
2. O'zingizning tilini tanlang
3. "Contribute Translation" (Tarjima hissasini qo'shish) tugmasini bosing
4. Sizga WordPress.org uchun bepul akkaunt kerak bo'ladi
...
1. [poedit.net](https://poedit.net) saytından Poedit-i yükləyin
2. `wp-content/plugins/ultimate-multisite/lang/` içindən `.pot` faylını açın
3. Poedit interfeysində olan stringləri tərcümə edin
