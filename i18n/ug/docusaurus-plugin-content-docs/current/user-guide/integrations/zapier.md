...
## Yeni Bir Trigger (Tetikleyici) Nasıl Oluşturulur {#how-to-create-a-new-trigger}
...
## چۆنیەتی دروستکردنی Actions (اکشنەکان) {#how-to-create-actions}
...
### ڕێکخستنی Action (اکشنەکە) {#setting-up-the-action}
