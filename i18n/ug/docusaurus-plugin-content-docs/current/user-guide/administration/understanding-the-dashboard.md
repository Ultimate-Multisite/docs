...
## Network Dashboard Widget'ları (Ağ Paneli Widget'ları)
...
### رشد درآمد تکرارشونده ماهانه (Monthly Recurring Revenue Growth)
...
### پشتیبانی محدوده تاریخ (Date-range Support)
