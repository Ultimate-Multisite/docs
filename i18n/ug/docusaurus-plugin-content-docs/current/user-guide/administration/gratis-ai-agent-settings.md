...
---
# Gratis AI Agent تەڭشەكلىرى {#gratis-ai-agent-settings}
...
## تەڭشەكلەرگە كىرىش {#accessing-settings}

1. WordPress باشقۇرۇش بېتىدە **Gratis AI Agent → تەڭشەكلەر** گە كىرىڭ.
2. **ئىلغار** بەتكۈچىنى چېكىڭ.

## ئىنكاس ئاخىرقى نۇقتىسى سەپلىمىسى {#feedback-endpoint-configuration}
...
### كۈتۈلىدىغان JSON يۈكى {#expected-json-payload}
...
### `triage_category` قىممەتلىرى {#triagecategory-values}
...
### سالاھىيەت دەلىللەش {#authentication}
...
### ئىنكاس توپلاشنى چەكلەش {#disabling-feedback-collection}
...
## باشقۇرۇلىدىغان Superdav مۇلازىمىتى {#managed-superdav-service}
...
## Google Calendar سەپلىمىسى {#google-calendar-configuration}
...
## TextBee SMS ئۇقتۇرۇشلىرى {#textbee-sms-notifications}
...
## ئىقتىدار بايراقلىرى {#feature-flags}
...
### ئىقتىدار بايراقلىرىغا كىرىش {#accessing-feature-flags}

1. WordPress باشقۇرۇش بېتىدە **Gratis AI Agent → تەڭشەكلەر** گە كىرىڭ.
2. **ئىقتىدار بايراقلىرى** بەتكۈچىنى چېكىڭ.

### زىيارەت كونترول بايراقلىرى {#access-control-flags}
...
### ماركا بايراقلىرى {#branding-flags}
...
### ئاپتوماتلاشتۇرۇش بىخەتەرلىك بايراقلىرى {#automation-safety-flags}
...
### ئۆزگەرتىشلەرنى قوللىنىش {#applying-changes}
