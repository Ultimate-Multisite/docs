...
#### Checkout Form Editor Genel Bakış {#checkout-form-editor-overview}
...
### Bir Checkout Formu Düzenleme {#editing-a-checkout-form}
...
### Narahatçylyk caryhanasy (The Pricing Table Field) {#the-pricing-table-field}
...
### Dönem Seçimi Anahtarını Ekleme {#adding-a-period-selection-toggle}
...
#### Adım 1: Ürünlerinizde Fiyat Varyasyonlarını Ayarlayın {#step-1-set-up-price-variations-on-your-products}
...
#### Adım 2: Dönem Seçimi Alanını Ödeme Formunuza Ekleyin {#step-2-add-the-period-selection-field-to-your-checkout-form}
...
#### üçüncü adım: Alanı Fiyat Tablosunun Üstüne Yerleştirme {#step-3-position-the-field-above-the-pricing-table}
...
#### Ön Yüzde Nasıl Çalışır {#how-it-works-on-the-frontend}
...
#### URL Üzerinden Fatura Dönemi Ön Seçimi Yapma {#pre-selecting-a-billing-period-via-url}
...
### Şablon Seçim Alanı (The Template Selection Field) {#the-template-selection-field}
...
#### Alanı manuel olarak ekleme {#adding-the-field-manually}
...
### Checkout-form bazası domenləri {#checkout-form-base-domains}
...
#### Field-i silmək {#removing-the-field}
