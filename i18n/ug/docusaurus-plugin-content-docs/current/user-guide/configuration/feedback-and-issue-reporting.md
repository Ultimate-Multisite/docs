...
## Boshqa Qismga Yoqlash Tugmasi (Thumbs-Down Button)
...
## Fikr Berish Riza Modali (Feedback Consent Modal)
...
## Avtomatik Prompt Fikr Berish Bannersi (Auto-Prompt Feedback Banner)
...
## /report-issue Slash Buyrug'i (Slash Command)
...
## AI-Assisted Triage (Yapay Zeka Destekli Ön Eleme)
...
## Settings > Advanced {#settings-advanced} (Ayarlar > Gelişmiş)
