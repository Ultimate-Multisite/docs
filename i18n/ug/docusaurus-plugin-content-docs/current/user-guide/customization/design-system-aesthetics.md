---
title: تصميم سیستمی جماليات مهارت
sidebar_position: 21
...
۱. `theme.json` قالب شما را با تمام توکن‌ها به‌روزرسانی می‌کند
...
۱. **سایتinizi inceleyin**: Yeni tasarımı görmek için sitenizi ziyaret edin
۲. **আরও পরিমার্জন করুন**: আপনার দক্ষতা ব্যবহার করে আরও পরিবর্তন করুন
৩. **টেমপ্লেট তৈরি করুন**: আপনার ডিজাইন টোকেনগুলো ব্যবহার করে কাস্টম ব্লক টেমপ্লেট তৈরি করুন
৪. **নথিভুক্ত করুন**: আপনার ডিজাইন সিস্টেমটি দলের সদস্যদের সাথে শেয়ার করুন
