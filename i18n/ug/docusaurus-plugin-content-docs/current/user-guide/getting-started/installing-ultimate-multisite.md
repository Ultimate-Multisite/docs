...
## پلاگىننىڭ قۇرۇلۇشى {#installing-the-plugin}
...
## قۇرۇلۇش يۆلەكچىسى {#setup-wizard}
...
### ئالدىن تەكشۈرۈش {#pre-install-checks}
...
### سىزنىڭ شىركىتىىڭىز {#your-company}
...
### ئادەتتىكى ئۇقۇم {#default-content}
...
### تەۋسىيە قىلىنغان پلاگىنلار {#recommended-plugins}
