...
---
# WordPress Multisite چیست؟ {#what-is-wordpress-multisite}
...
## دقیقاً وردپرس چندسایت چیست؟ {#what-exactly-is-wordpress-multisite}
...
## زیردامنه یا زیردایرکتوری؟ {#subdomain-or-subdirectory}
...
## چی لە نێوان سایتە بچووکەکان هاوبەش دەبن و چی نییە {#what-is-shared-among-subsites-and-what-is-not}
