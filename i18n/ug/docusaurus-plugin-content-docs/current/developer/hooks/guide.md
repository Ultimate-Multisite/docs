---
title: Hooks ئىشلىتىش قوللانمىسى
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Hooks ئىشلىتىش قوللانمىسى {#hooks-usage-guide}

Ultimate Multisite 200+ action hooks ۋە 280+ filter hooks تەمىنلەيدۇ. بۇ بەت ئەمەلىي مىساللار بىلەن ئەڭ كۆپ ئىشلىتىلىدىغان hooks نى ئۆز ئىچىگە ئالىدۇ. تولۇق ئاپتوماتىك ھاسىل قىلىنغان پايدىلىنىش ماتېرىيالى ئۈچۈن، بۇ بۆلەكتىكى باشقا بەتلەرنى كۆرۈڭ.

## Action Hooks {#action-hooks}

### خېرىدار ھايات دەۋرى {#customer-lifecycle}

#### خېرىدار قۇرۇلغاندىن كېيىن {#after-customer-creation}
...
#### خېرىدار ھالىتى ئۆزگىرىشى {#customer-status-change}
...
### تور بېكەت Hooks {#site-hooks}

#### تور بېكەت ئېلان قىلىنغاندىن كېيىن {#after-site-published}
...
#### قېلىپ قوللىنىشتىن بۇرۇن {#before-template-application}
...
### ئەزالىق Hooks {#membership-hooks}

#### ھالەت ئۆتۈشلىرى {#status-transitions}
...
### چىقىم Hooks {#payment-hooks}

#### چىقىم تاماملاندى / مەغلۇپ بولدى {#payment-completed--failed}
...
### ھېسابات قىلىش Hooks {#checkout-hooks}

#### بىر تەرەپ قىلىشتىن بۇرۇن / تاماملانغاندىن كېيىن {#before-processing--after-completion}
...
### باھا Filters {#pricing-filters}

#### ھارۋا جەمئىي سوممىسى {#cart-total}
...
### قېلىپ Filters {#template-filters}
...
### چەكلىمە Filters {#limitation-filters}
...
### Checkout جەدۋەل بۆلەكلىرى {#checkout-form-fields}
