...
title: سۈزگۈچ - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | تارماق رايون نامى. ئادەتتە شىتات، ئۆلكە، رايون قاتارلىقلارغا ئوخشايدۇ. |
| $country_code | `string` | دۆلەت ئۈچۈن ئىككى ھەرپلىك ISO كودى. |
| $state_code | `string` | شىتات ئۈچۈن ئىككى ھەرپلىك ISO كودى. |
