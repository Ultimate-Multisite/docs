...
بىرلا ۋاقىتتا كەلگەن ئىككى تەلەپ ئوخشاش قىممەتنى ئوقۇپ، ھەر ئىككىسى ئوخشاش ئاشۇرۇلغان نەتىجىنى قايتا يېزىپ، بىر ھېسابنى يوقىتىپ قويۇشى مۇمكىن. `increment_item()` ھېسابلاشنى بىرلا `UPDATE ... SET column = column + ?` جۈملىسى بىلەن ساندان ماتورىغا تاپشۇرىدۇ، شۇڭا مەشغۇلات ئەسلىدىنلا ئاتوملۇق بولىدۇ.
