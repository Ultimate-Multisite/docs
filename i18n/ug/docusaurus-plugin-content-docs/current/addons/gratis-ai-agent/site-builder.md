...
---
# تور بېكەت قۇرغۇچنى ماسلاشتۇرۇپ باشقۇرۇش v2 {#site-builder-orchestration-v2}
...
### 1. پىلان ھاسىل قىلىش {#1-plan-generation}
...
### 2. Plugin بايقاش {#2-plugin-discovery}
...
### 3. پىلان ئىجرا قىلىش {#3-plan-execution}
...
### 4. ئىلگىرىلەشنى ئىزلاش {#4-progress-tracking}
...
### 5. خاتالىقتىن ئەسلىگە كېلىش {#5-error-recovery}
...
## تور بېكەت پىلانى ئىقتىدارلىرى {#site-plan-abilities}
...
## v1 بىلەن v2 نى سېلىشتۇرۇش {#comparing-v1-and-v2}
...
## WP-CLI پىلان بۇيرۇقلىرى {#wp-cli-plan-commands}
