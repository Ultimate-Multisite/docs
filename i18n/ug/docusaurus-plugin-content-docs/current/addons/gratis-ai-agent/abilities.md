...
---
# ئىقتىدارلار قوللانمىسى {#abilities-reference}
...
## ئىختىيارى يازما تۈرلىرى {#custom-post-types}
...
## ئىختىيارى Taxonomy لار {#custom-taxonomies}
...
## لايىھە سىستېمىسى {#design-system}
...
## ئومۇمىي ئۇسلۇبلار {#global-styles}
...
## يولباشلاش تىزىملىكلىرى {#navigation-menus}
...
## تاللانمىلارنى باشقۇرۇش {#options-management}
...
## مەزمۇن باشقۇرۇش {#content-management}
...
## كۆرۈنمە تەكشۈرۈش {#visual-review}
...
## ئورنىتىلىدىغان ئىقتىدارلار {#installable-abilities}
