...
## Стъпка 2: Network Configuration
...
### Wizard-ът казва, че wp-config.php не е записваем
...
### Сайтовете не са достъпни след настройката (поддомейни)
...
### Проблеми с автентикацията след настройката
...
### Етапът се провали по време на инсталацията
