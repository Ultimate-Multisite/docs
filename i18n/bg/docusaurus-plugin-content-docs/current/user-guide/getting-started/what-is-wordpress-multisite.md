...
---
# Какво е WordPress Multisite? {#what-is-wordpress-multisite}
...
## Какво точно е WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## Поддомейн или поддиректория? {#subdomain-or-subdirectory}
...
## Супер Администраторът {#the-super-admin}
...
## Какво се споделя между подсайтовете и какво не се споделя {#what-is-shared-among-subsites-and-what-is-not}
...
## Управление на потребителите в WordPress Multisite {#user-management-on-wordpress-multisite}
...
## Съображения за производителността {#performance-considerations}
