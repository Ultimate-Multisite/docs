...
## Параметри на тялото на ендпойнт-а {#endpoint-body-parameters}
...
### **Membership (Членска карта)** {#membership}
...
## Създаване на действие в Zapier {#creating-an-action-in-zapier}
...
### Създаване на действие {#creating-an-action}
...
### Пълни параметри на ендпойнт-а {#complete-endpoint-parameters}
