...
## Промяна на позицията на елемента в менюто "Account"
...
## Как да проверите дали потребителят е под определен план и/или има активна абонаментна подписка
...
## Отстраняване на CORS проблеми с Font-Icons в мапирани домейни
## Отстраняване на CORS проблеми с Font-Icons в мапирани домейни
