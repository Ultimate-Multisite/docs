...
---
# Проверка на суверенна миграция {#sovereign-migration-verification}
...
## Команди за изпълнение {#commands-to-run}
...
## Чести грешки {#common-failures}

### Даните за базата данни не съвпадат с хоста {#database-grants-do-not-match-the-host}
...
### Bedrock или локални инсталации не могат да се свържат {#bedrock-or-local-installs-cannot-connect}
...
### Асинх원은 push куите не се източват (drain) {#async-push-queue-does-not-drain}
...
### Броят потребители на арендатора е невярчен {#tenant-user-count-is-wrong}
...
### Посещението чрез SSO е отхвърлено {#sso-visit-is-rejected}
...
## Кога да опитате отново {#when-to-retry}
