...
## Преглед на способностите (Abilities Overview) {#abilities-overview}
...
## Списък с забранени настройки за Options Management {#options-management-safety-blocklist}
