...
---
# Валидиране на контраста на палитрата {#validate-palette-contrast}
...
## Формат на входните данни {#input-format}
...
## Проверявани нива WCAG {#wcag-levels-checked}
...
### Полета на изхода {#output-fields}
...
## Несъответстващи двойки и препоръки {#failing-pairs-and-recommendations}
...
## Свързани функции {#related-abilities}
