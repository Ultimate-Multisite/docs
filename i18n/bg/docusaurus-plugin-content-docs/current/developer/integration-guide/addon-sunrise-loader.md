...
## Кога да го използвате {#when-to-use-it}
...
## Конвенция за именопис на файловете {#file-naming-convention}
...
## Къде да поставите файла {#where-to-place-the-file}
...
## Достъпни хукове и филтри {#hooks-and-filters-available}
