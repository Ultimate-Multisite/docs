...
### Регистриране на персонализиран обработчик за инсталиране
...
## Архитектура на асинхронните задачи
