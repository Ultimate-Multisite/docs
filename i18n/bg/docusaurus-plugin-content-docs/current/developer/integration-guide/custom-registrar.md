...
### Конвенция за връщани стойности
...
## Регистриране на вашата функционалност
...
## Добавяне на полета за потребителски данни към wizard-а
...
## Hooks за действия след регистрация
