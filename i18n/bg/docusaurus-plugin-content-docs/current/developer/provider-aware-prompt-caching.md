...
---
# Кеширане на промптове, съзнателно към доставчика {#provider-aware-prompt-caching}
...
### Създаване на кеширан промпт {#creating-a-cached-prompt}
...
### Използване на кеширан промпт {#using-a-cached-prompt}
...
### Жизнен цикъл на кеша {#cache-lifecycle}
...
### Най-добри практики за Gemini {#best-practices-for-gemini}
...
## Azure OpenAI: Кеширане на промптове {#azure-openai-prompt-caching}
...
### Включване на кеширането {#enabling-caching}
...
### Наблюдаване на използването на кеша {#monitoring-cache-usage}
...
### Най-добри практики за Azure OpenAI {#best-practices-for-azure-openai}
...
## OpenRouter: Кеширане специфично за доставчика {#openrouter-provider-specific-caching}
...
### Използване на кеширането на OpenRouter {#using-openrouter-caching}
...
### Опции специфични за доставчика {#provider-specific-options}
...
### Най-добри практики за OpenRouter {#best-practices-for-openrouter}
...
## Vertex Anthropic: Кеширане на промптове с контрол на кеша {#vertex-anthropic-prompt-caching-with-cache-control}
...
### Използване на кеширането на Vertex Anthropic {#using-vertex-anthropic-caching}
...
### Типове контрол на кеша {#cache-control-types}
...
### Наблюдаване на използването на кеша {#monitoring-cache-usage-1}
...
### Най-добри практики за Vertex Anthropic {#best-practices-for-vertex-anthropic}
...
## Стратегия за кеширане между доставчици {#cross-provider-caching-strategy}

### Унифицирана конфигурация {#unified-configuration}
...
### Определяне на доставчика {#provider-detection}
...
### Стратегия за отказ (Fallback Strategy) {#fallback-strategy}
...
## Оптимизация на разходите {#cost-optimization}

### Изчисляване на спестяванията {#calculate-savings}
...
### Съвети за оптимизация {#optimization-tips}
...
### Кешът не се използва {#cache-not-being-used}
...
### Неуспешно създаване на кеш {#cache-creation-failing}
...
### Неочаквани разходи {#unexpected-costs}
...
## Сравнение на доставчиците {#provider-comparison}
