---
title: Напреднали примери за код
sidebar_position: 1
...
// Добавяне на 5 към брояч за използване.
$memberships->increment_item( 42, 'api_calls', 5 );

// Декраментиране (изваждане на 1).
...
Две едновременни заявки могат да прочетат едно и също стойност и и двете да запишат същата увеличена стойност, губейки един брой. `increment_item()` делегира аритметиката на база данни с едно изявление `UPDATE ... SET column = column + ?`, което прави операциято по същество атомарна.
