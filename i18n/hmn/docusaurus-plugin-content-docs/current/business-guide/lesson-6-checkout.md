...
## Бид хаана байсан бэ? (Where We Left Off)
...
## Бүртгэлийн Flow-г ойлгох (Understanding the Registration Flow)
...
## FitSite Checkout-ийг загварчлах (Designing the FitSite Checkout)

**Ultimate Multisite > Checkout Forms** руу орж, шинэ form үүсгээрэй.

### Алхам 1: Төлөвлөгөө сонгох (Plan Selection)
...
### ជំហានទី ២៖ ការជ្រើសរើស Template (Template Selection)
...
### ជំហានទី ៣៖ ការបង្កើតគណនី (Account Creation)
...
### ជំហានទី ៤៖ ការរៀបចំគេហទំព័រ (Site Setup)
...
### ជំហានទី ៥៖ ការបង់ប្រាក់ (Payment)
...
### ជំហានទី ៦៖ ការបញ្ជាក់ (Confirmation)
...
## ការបន្ថែម Toggle សម្រាប់ជ្រើសរើសរយៈពេល (Adding a Period Selection Toggle)
...
## ང་ཚོས་འདིར་བྱས་པ་རེད། (What We Built This Lesson)
