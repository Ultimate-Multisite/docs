...
## ປະເພດຜະລິດຕະພັນ (Product Type) {#product-type}
...
## ການຈັດການຜະລິດຕະພັນ (Managing Products) {#managing-products}
...
## Бүтээгдэхүүн нэмэх (Adding Products) {#adding-products}
...
### Тайлалбар (Description) {#description}
...
### Үнийн төрөл (Pricing Type) {#pricing-type}
...
### ຮູບພາບຜະລິດຕະພັນ (Product Image) {#product-image}
...
### ຕົວເລືອກຜະລິດຕະພັນ (Product Options) {#product-options}
...
#### ຍົກລະດັບຂຶ້ນ ແລະ ລົງ (Up & Downgrades) {#up--downgrades}
...
#### ຄວາມແຕກຕ່າງຂອງລາຄາ (Price Variations) {#price-variations}
...
#### סוגי פוסט (Post Types) {#post-types}
...
#### ການຣີເຊັດຂໍ້ຈຳກັດ (Reset Limitations) {#reset-limitations}
...
## ແກ້ໄຂ, ສ້າງຄືນ, ຫຼື ລຶບຜະລິດຕະພັນ (Edit, Duplicate, or Delete Product) {#edit-duplicate-or-delete-product}
