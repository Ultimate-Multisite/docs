...
#### ພາບລວມຂອງ Checkout Form Editor
...
### The Pricing Table Field (ລາຄາຕາຕະລາງ)
...
### Thambahan Txiv Neegjaeb (Adding a Period Selection Toggle)
...
#### Step 1: Tsim Cov Price Variations Rau Neeg Tua
...
#### Step 2: Tsim Period Selection Field Rau Forms Checkout
...
#### ຂັ້ນຕອນທີ 3: ວາງຊ່ອງຂໍ້ມູນໄວ້ຂ້າງເທິງຕາຕະລາງລາຄາ
...
#### ມັນເຮັດວຽກແນວໃດໃນ Frontend (ໜ້າເວັບ)
...
#### ການເລືອກໄລຍະເວລາເກັບເງິນລ່ວງລ່ວງໜ້າຜ່ານ URL
...
### ຊ່ອງຂໍ້ມູນການເລືອກ Template (Template Selection Field)
...
#### ການເພີ່ມຊ່ອງຂໍ້ມູນດ້ວຍຕົນເອງ (Adding the field manually)
