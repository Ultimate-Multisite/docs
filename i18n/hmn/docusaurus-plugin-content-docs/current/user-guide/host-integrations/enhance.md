...
## ການໄດ້ມາເຊິ່ງ API Credentials ຂອງທ່ານ
...
### 2. ຮັບ Organization ID ຂອງເຈົ້າ
...
### Required Constants (ຄ່າທີ່ຕ້ອງມີ)
...
### ຕັ້ງຄ່າຜ່ານ Integration Wizard (ຜູ້ຊ່ວຍຕັ້ງຄ່າ)
...
### ເມື່ອມີ Domain ຖືກแมપ (When a Domain is Mapped)
...
## ການຢືນຢັນການຕັ້ງຄ່າ (Verifying Setup)

### ທົດສອບການເຊື່ອມຕໍ່ (Test the Connection)
...
### ຂໍ້ຜິດພາດໃນການຢືນຢັນ (Authentication Errors)
...
## API Reference (ຂໍ້ມູນອ້າງອີງ API)

### ການຢືນຢັນ (Authentication)
ການຮ້ອງຂໍ API ທັງໝົດໃຊ້ Bearer token authentication:
```
Authorization: Bearer YOUR_TOKEN_HERE
```

### Endpoints ທີ່ໃຊ້ທົ່ວໄປ
...
## Additional Resources (Tswv Qhia Zoo)
