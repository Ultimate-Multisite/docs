...
### 1. Lấy thông tin API của RunCloud (Get Your RunCloud API Credentials)
...
### 2. Lấy ID Server và App của bạn (Get Your Server and App IDs)
...
### 3. Thêm các hằng số vào wp-config.php (Add Constants to wp-config.php)
...
### 4. Kích hoạt tích hợp (Enable the Integration)
