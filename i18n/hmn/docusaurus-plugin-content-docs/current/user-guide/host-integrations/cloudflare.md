...
### 1. Таны Cloudflare API Key-г авах
...
### 3. wp-config.php руу тогтмол утгуудыг нэмэх
...
### Subdomain Удирдах (Subdomain Management)
...
### Стандарт Cloudflare integration-тэй ялгаатай байдал
