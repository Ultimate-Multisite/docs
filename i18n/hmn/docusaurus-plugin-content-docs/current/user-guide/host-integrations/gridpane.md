...
### 1. ດຶງຂໍ້ມູນ API Credentials ຂອງ GridPane
...
### 2. ດຶງ Server ID ແລະ Site ID ຂອງທ່ານ
...
### 3. ເພີ່ມ Constants ໃນ wp-config.php
...
## Асуудал Олох (Troubleshooting)

### API Connection Асуудал
