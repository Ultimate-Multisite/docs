...
## Ultimate Multisite ໄດ້ປ່ຽນຈາກຄອບຄົວການປ່ອຍ (releases) ເກົ່າຂອງມັນ 1.x ມາເປັນຄອບຄົວ 2.x ແລ້ວ.
