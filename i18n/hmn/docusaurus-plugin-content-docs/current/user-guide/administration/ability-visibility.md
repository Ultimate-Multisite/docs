...
### ចូលទៅមើលការកំណត់ការមើលឃើញសមត្ថភាព (Accessing Ability Visibility Settings)
...
### មើលព័ត៌មានលម្អិតនៃសមត្ថភាព (Viewing Ability Details)
...
### ប្រតិបត្តិការច្រើន (Bulk Operations)
...
### ການຍົກເລີກການເຂົ້າເຖິງຂອງຄູ່ຮ່ວມງານ
...
## Unclassified Abilities (Ability ທີ່ບໍ່ໄດ້ຈັດປະເພດ)
...
### Admin Notice ສຳລັບ Unclassified Abilities
...
### ການທົບທວນ Unclassified Abilities
...
### ເປັນຫຍັງຕ້ອງ Classify Unclassified Abilities?
