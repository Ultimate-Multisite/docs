...
#### Авто-салгагдах болон Авто-салгагдахгүй гишүүдийн хуваарь (Memberships)
...
## Frontend Access-ийг Хүлээн Зөвшөөрөх (Block)
...
### 3. ກວດສອບວ່າສະຖານະສະມາຊິກໄດ້ປ່ຽນແປງແທ້ຫຼືບໍ່
...
### 4. ກວດສອບວ່າ Action Scheduler ກຳລັງເຮັດວຽກຢູ່ບໍ່
...
### 5. ກວດສອບບັນຫາ Gateway Webhook (Auto-Renewing Memberships)
...
### 6. ກວດສອບໄລຍະເວລາຜ່ານຂອງ Expiration (Cron Level)
...
### 7. ມື້ໝົດສະເໝີສະມາຊິກ (Manually Expire a Membership)
...
## ເອກະສານອ້າງອີງສຳລັບນັກພັດທະນາ (Developer Reference)
