...
### ທາງເລືອກການຈ່າຍເງິນທົ່ວໄປ (General Payment Options) {#general-payment-options}
...
### ປະຕູການຈ່າຍເງິນ (Payment Gateways) {#payment-gateways}
...
### ໂໝດ Sandbox (Sandbox Mode) {#sandbox-mode}
...
## ການເບິ່ງການຈ່າຍເງິນ (Viewing Payments) {#viewing-payments}
