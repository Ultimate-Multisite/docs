...
## ການສ້າງ Block Theme (Scaffold Block Theme) {#scaffold-block-theme}
...
### ວິທີໃຊ້ງານ (How to Invoke) {#how-to-invoke}
...
### ຜົນລັບທີ່ຄາດຫວັງ (Expected Output) {#expected-output}
...
### မျှော်လင့်ထားတဲ့ အကျိုးရလဒ်များ {#expected-output-1}
...
## လုပ်ဆောင်ပုံ အဆင့်များ- Scaffold လုပ်ပြီး Activate လုပ်ခြင်း {#workflow-scaffold-and-activate}
...
## Design Tokens နဲ့ Customization {#design-tokens-and-customization}
...
## ကန့်သတ်ချက်များနှင့် မှတ်စုများ {#limitations-and-notes}
