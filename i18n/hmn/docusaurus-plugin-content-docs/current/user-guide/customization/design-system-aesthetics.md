...
---
# ជំនាញ Aesthetics ຂອງ Design System {#design-system-aesthetics-skill}
...
## Design System Aesthetics ជាអ្វី? {#what-is-design-system-aesthetics}
...
## ហេតុអ្វីបានជាត្រូវប្រើ Design System Aesthetics? {#why-use-design-system-aesthetics}
...
### ប្រសិទ្ធភាព (Efficiency) {#efficiency}
...
### ភាពបត់បែន (Flexibility) {#flexibility}
...
## ការបង្កឱ្យមាន Design System Aesthetics Skill {#triggering-the-design-system-aesthetics-skill}

### ការបើកដំណើរការដោយដៃ (Manual Activation) {#manual-activation}
...
### ការផ្តល់យោបល់ដោយស្វ័យប្រវត្តិ (Automatic Suggestions) {#automatic-suggestions}
...
## គំរូការរចនា (The Design System Aesthetics Process) {#the-design-system-aesthetics-process}

### ជំហានទី ១៖ ពុម្ពអក្សរ (Typography) {#step-1-typography}
...
### ជំហានទី ២៖ ប៉ាលីត្រពណ៌ (Color Palette) {#step-2-color-palette}
...
### ជំហានទី ៣៖ ចន្លោះ (Spacing) {#step-3-spacing}
...
### Step 4: Borders and Shadows (Đường viền và Bóng đổ) {#step-4-borders-and-shadows}
...
### Step 5: Motion and Animation (Chuyển động và Hoạt ảnh) {#step-5-motion-and-animation}
...
## Áp dụng Thẩm mỹ Hệ thống Thiết kế (Applying Design System Aesthetics) {#applying-design-system-aesthetics}

### Automatic Application (Áp dụng Tự động) {#automatic-application}
...
### Manual Application (Áp dụng Thủ công) {#manual-application}

Bạn cũng có thể chỉnh sửa trực tiếp `theme.json`:

## Kuj Tshawm Su Design System (Viewing Your Design System) {#viewing-your-design-system}

### Kuj Tshawm Su Agent (Ask the Agent) {#ask-the-agent}
...
### Tshawm theme.json (View theme.json) {#view-themejson}

Tso `/wp-content/themes/[theme-name]/theme.json` mus ua text editor los tshawm cov token raw.

## Ua Txhawb Cov Design System (Updating Your Design System) {#updating-your-design-system}

### Ua Txhawb Tsis Tsoom (Quick Updates) {#quick-updates}
...
### Ua Tshawm Cov Design System Tam Pov (Full Redesign) {#full-redesign}
...
### Ua Txhawb Cov Design System Tsis Tsoom (Partial Updates) {#partial-updates}
...
## Kev Tshawm Cov Design System Tsis Tsoom (Design System Best Practices) {#design-system-best-practices}

### Kev Tsim Cov Tsim (Consistency) {#consistency-1}
...
### Kev Tsim Cov Ntxiv (Naming) {#naming}
...
### Kev Tsim Cov Sib Muaj (Scalability) {#scalability}
...
## Các Mẫu Thiết Kế Hệ Thống Chung {#common-design-system-patterns}
