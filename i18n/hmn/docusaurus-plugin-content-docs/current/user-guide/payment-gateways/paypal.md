...
---
# ຕັ້ງຄ່າ PayPal Gateway (v2) {#setting-up-the-paypal-gateway-v2}
...
## ການເປີດໃຊ້ PayPal ໃນເຄືອຂ່າຍຂອງເຈົ້າ {#enabling-paypal-on-your-network}
...
## ການໃຊ້ setup wizard ແນະນຳ {#using-the-guided-setup-wizard}
...
## Luj tshawm hav PayPal API credentials {#getting-the-paypal-api-credentials}
