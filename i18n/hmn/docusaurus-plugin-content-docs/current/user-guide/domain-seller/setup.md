...
## ການຕັ້ງຄ່າ wizard ຄັ້ງທຳອິດ (First-run setup wizard)
...
### ຂັ້ນຕອນທີ 1 — ເລືອກ provider (Choose a provider)
...
### ຂັ້ນຕອນທີ 2 — ໃສ່ຂໍ້ມູນການເຂົ້າສູ່ລະບົບ (Enter credentials)
...
### ຂັ້ນຕອນທີ 3 — ທົດສອບການເຊື່ອມຕໍ່
...
### ຂັ້ນຕອນທີ 5 — ສ້າງຜະລິດຕະພັນໂດເມນ
