...
## Theme Builder Onboarding Flow කියන්නේ මොකක්ද? {#what-is-the-theme-builder-onboarding-flow}
...
## Theme Builder Onboarding පටන් ගන්න {#starting-the-theme-builder-onboarding}

### පළමු වතාවේ setup එක (First-Run Setup) {#first-run-setup}
...
### අතින් කරන activation එක (Manual Activation) {#manual-activation}
...
## Onboarding පියවර (The Onboarding Steps) {#the-onboarding-steps}

### පියවර 1: Mode තෝරා ගැනීම (Mode Selection) {#step-1-mode-selection}
...
### පියවර 2: වෙබ් අඩවියේ විස්තර (Site Specification) {#step-2-site-specification}
...
### Step 3: Design System Decisions (Bước 3: Quyết định Hệ thống Thiết kế) {#step-3-design-system-decisions}
...
### Step 4: Theme Generation (Bước 4: Tạo Theme) {#step-4-theme-generation}
...
### Step 5: Activation and Verification (Bước 5: Kích hoạt và Xác minh) {#step-5-activation-and-verification}
...
## Site Specification and site_brief Memory (Thông số Trang web và Bộ nhớ site_brief) {#site-specification-and-sitebrief-memory}
...
### Why site_brief Matters (Tại sao site_brief lại quan trọng) {#why-sitebrief-matters}
...
### ປົກຮັກສາຄວາມສອດຄ່ອງຂອງການອອກແບບໃນເວລາປ່ຽນແປງ {#viewing-your-sitebrief}
...
### ການເບິ່ງສະຫຼຸບຂອງເວັບໄຊຂອງທ່ານ (Viewing Your site_brief) {#customizing-after-onboarding}
...
## ການປັບແຕ່ງຫຼັງຈາກເລີ່ມຕົ້ນ (Customizing After Onboarding) {#use-the-design-system-aesthetics-skill}

ຫຼັງຈາກການສອນ Theme Builder ສໍາເລັດ, ເຈົ້າສາມາດ:

### ໃຊ້ທັກສະ Design System Aesthetics Skill {#edit-themejson-directly}
...
### ແກ້ໄຂ theme.json ໂດຍກົງ {#create-custom-block-templates}
...
### ສ້າງ Custom Block Templates {#comparison-old-vs-new-onboarding}
...
## ການປຽບທຽບ: ເກົ່າ vs. ໃໝ່ໃນການສອນ (Comparison: Old vs. New Onboarding) {#troubleshooting}
...
## ການແກ້ໄຂບັນຫາ (Troubleshooting) {#next-steps}
