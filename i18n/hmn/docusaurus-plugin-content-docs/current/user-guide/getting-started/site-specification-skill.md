...
## ហេតុអ្វីបានជាត្រូវប្រើ Site Specification?

### ការស៊ីសង្វាក់គ្នាឆ្លងវគ្គ (Consistency Across Sessions)
...
### ការផ្តល់អនុសាសន៍កាន់តែល្អ (Better Recommendations)
...
### ការចាប់ផ្តើមប្រើប្រាស់កាន់តែលឿន (Faster Onboarding)

Agent ថ្មី (ឬ Agent ក្នុងវគ្គថ្មី) អាចឆាប់យល់បានដោយអាន site_brief របស់អ្នកជំនួសឱ្យការសួរសំណួរដើម្បីពន្យល់។

## ការចាប់ផ្តើម Site Specification

### ក្នុងអំឡុងពេល Onboarding Theme Builder
...
### ការចាប់ផ្តើមដោយដៃ (Manual Initiation)
...
## ຂັ້ນຕອນການເຮັດ Site Specification

### ຂັ້ນຕອນທີ 1: ຈຸດປະສົງຂອງເວັບໄຊ (Site Purpose)
...
### ຂັ້ນຕອນທີ 2: ກຸ່ມເປົ້າໝາຍ (Target Audience)
...
### ຂັ້ນຕອນທີ 3: ຮູບແບບແບຣນ (Brand Identity)
...
### ຂັ້ນຕອນທີ 4: ເປົ້າໝາຍທາງທຸລະກິດ (Business Goals)
...
### ຂັ້ນຕອນທີ 5: ໂຄງສ້າງເນື້ອຫາ (Content Structure)
...
## ຊ່ອງຈຳຂອງ site_brief ຂອງເຈົ້າ (Your site_brief Memory)
...
## Xem và Cập nhật tóm tắt trang web của bạn (site_brief)

### Xem tóm tắt trang web của bạn
...
### Cập nhật tóm tắt trang web của bạn
...
## Trợ lý sử dụng tóm tắt trang web như thế nào
...
## Kev Ua Zoo Hauv Kev Tsiagana (Best Practices)

### Yog Koj Yuav Txhob Cuag Kev Zoo (Be Specific)
...
### Tsoom Kev Zoo Thim Hauv Kev Ua Zoo (Update Regularly)
...
### Siv Kev Hloov Neeg Ua Zoo (Use Consistent Terminology)
...
### Tiv Thaiv Kev Hloov Neeg Ua Zoo (Include Context)
...
## Kev Puaj Kev Zoo (Relationship to Theme Builder Onboarding)
...
## Kev Tswv Kev Zoo (Troubleshooting)
...
## Cov qhov uas yuav ua los (Next Steps)
