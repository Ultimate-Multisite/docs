...
## The Super Admin (Quản trị viên Siêu cấp) {#the-super-admin}
...
## subsites တွေကြား ဘာတွေ တူညီပြီး ဘာတွေ မတူညီဘူးလဲ {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress Multisite မှာ User management {#user-management-on-wordpress-multisite}
