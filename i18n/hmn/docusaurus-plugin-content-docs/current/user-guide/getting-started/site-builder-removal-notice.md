...
## មានអ្វីកើតឡើង? {#what-happened}

### Site Builder Mode (ចាស់) {#site-builder-mode-legacy}
...
### អ្វីដែលបានមកជំនួសវា? {#what-replaced-it}
...
## ប្រសិនបើអ្នកធ្លាប់ប្រើ Site Builder Mode {#if-you-were-using-site-builder-mode}

### Site របស់អ្នកគឺមានសុវត្ថិភាព {#your-sites-are-safe}
...
### ផ្លាស់ប្តូរទៅ Setup Assistant Agent {#migrate-to-setup-assistant-agent}
...
## ការប្រៀបធៀប: Site Builder vs. Setup Assistant {#comparison-site-builder-vs-setup-assistant}
...
## ការផ្លាស់ប្តូរទៅ Setup Assistant Agent {#migrating-to-setup-assistant-agent}

### សម្រាប់ Site ថ្មី {#for-new-sites}
...
### ສຳລັບໄຊທ໌ທີ່ມີຢູ່ແລ້ວ {#for-existing-sites}
...
### ສຳລັບການປ່ຽນແປງ Theme {#for-theme-changes}
...
## ຄວາມແຕກຕ່າງທີ່ສຳຄັນ {#key-differences}
...
### ང་གིས་ Site Builder ནས་བཟོ་མཚམས་དུ་ཡིག་ཆ་ໃໝ່བསྐྲུན་ཆོག་པ། {#troubleshooting}
...
### Site Builder དང་པོ་ཚོས་བཟོ་མས་ལས་བྱེད་མི་ཆོག་པ་རེད། {#i-cant-find-site-builder-mode}
...
### Site Builder template ཚུ་ གཏམ་ཁ་ནས་བཟོ་མི་ཆོག་པ་རེད། {#i-want-to-recreate-a-site-from-site-builder}
...
## མཇུག་བསྡུར་ (Next Steps) {#my-existing-site-builder-site-isnt-working}
...
## འབྲེལ་བའི་ཚོར་བ་ (Related Topics) {#can-i-still-use-my-old-site-builder-templates}
