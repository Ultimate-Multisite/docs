...
|------|------|-------------|
| $notices | `array` | Daim ntawv teev cov notices rau panel ntawd. |
| $all_notices | `array` | Daim ntawv teev cov notices uas tau ntxiv, muab cais raws panel. |
| $panel | `string` | Panel uas yuav mus muab cov notices. |
