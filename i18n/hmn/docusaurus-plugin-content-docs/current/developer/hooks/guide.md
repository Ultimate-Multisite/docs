---
title: Phau ntawv qhia kev siv Hooks
sidebar_position: 1
...
### Lub Neej Ua Haujlwm Ntawm Tus Neeg Siv Khoom {#customer-lifecycle}

#### Tom Qab Tsim Tus Neeg Siv Khoom {#after-customer-creation}
...
#### Kev Hloov Tus Neeg Siv Khoom Li Status {#customer-status-change}
...
#### Tom Qab Site Luam Tawm {#after-site-published}
...
#### Ua Ntej Siv Template {#before-template-application}
...
#### Kev Hloov Status {#status-transitions}
...
#### Payment Ua Tiav / Ua Tsis Tiav {#payment-completed--failed}
...
#### Ua Ntej Ua Txheej Txheem / Tom Qab Ua Tiav {#before-processing--after-completion}
