---
title: Imizekelo yeKhowudi ePhambili
sidebar_position: 1
...
Izicelo ezimbini ezenzeka ngaxeshanye zinokufunda ixabiso elifanayo kwaye zombini zibhale kwakhona isiphumo esifanayo esinyusiweyo, zilahlekelwe libalo elinye. `increment_item()` idlulisela izibalo kwi-injini yedatabase ngesivakalisi esinye se-`UPDATE ... SET column = column + ?`, nto leyo eyenza umsebenzi ube yi-atomic ngokwendalo.
