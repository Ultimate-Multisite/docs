---
title: Isikhokelo sokuSetyenziswa kwee-Hooks
sidebar_position: 1
...
## Ii-Hooks ze-Action {#action-hooks}

### Umjikelo Wobomi Bomthengi {#customer-lifecycle}

#### Emva Kokudalwa Komthengi {#after-customer-creation}
...
#### Utshintsho Lwesimo Somthengi {#customer-status-change}
...
### Ii-Hooks ze-Site {#site-hooks}

#### Emva Kokupapashwa kwe-Site {#after-site-published}
...
#### Phambi Kokufakwa kwe-Template {#before-template-application}
...
### Ii-Hooks Zobulungu {#membership-hooks}

#### Utshintsho Lwesimo {#status-transitions}
...
### Ii-Hooks Zentlawulo {#payment-hooks}

#### Intlawulo Igqityiwe / Ayiphumelelanga {#payment-completed--failed}
...
### Ii-Hooks ze-Checkout {#checkout-hooks}

#### Phambi Kokulungiswa / Emva Kokugqitywa {#before-processing--after-completion}
...
### Ii-Hooks ze-Domain {#domain-hooks}
...
## Ii-Hooks ze-Filter {#filter-hooks}

### Ii-Filter zamaxabiso {#pricing-filters}

#### Itotali ye-Cart {#cart-total}
...
### Ii-Filter ze-Template {#template-filters}
...
### Ii-Filter zeMida {#limitation-filters}
...
### Ii-Filter ze-Gateway {#gateway-filters}
...
### Iifildi zeFom ye-Checkout {#checkout-form-fields}
...
### Umxholo we-Email {#email-content}
