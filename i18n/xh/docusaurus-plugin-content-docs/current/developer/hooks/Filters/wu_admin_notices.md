---
id: wu_admin_notices
title: Isihluzi - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Uluhlu lwezaziso zale panel ithile. |
| $all_notices | `array` | Uluhlu lwezaziso ezongeziweyo, ezahlulwe ngokwe-panel. |
| $panel | `string` | I-panel yokufumana izaziso. |
