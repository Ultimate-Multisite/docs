---
title: Iimveliso zeedomeyini namaxabiso
sidebar_position: 2
...
3. Seta uhlobo lwemveliso ku-**Domain**
4. Qwalasela ithebhu ethi **Iisetingi ze-domain** (jonga ngezantsi)
5. Gcina
...
Faka uluhlu lwee-TLD ezahlulwe ngeekoma (umz., `.com, .net, .org`) ukuze udale **imveliso ethile ye-TLD** esebenza kuphela kwezo zandiso.
...
| Imowudi | Isebenza njani |
|---|---|
| **Ipesenti** | Yongeza ipesenti ngaphezulu kwendleko yehowuliseyili. Ukunyuswa kwe-20% kwi-domain yehowuliseyili eyi-$10 kunika $12. |
...
| Isetingi | Ukuziphatha |
|---|---|
| **Kukhubazekile** | Ubumfihlo be-WHOIS abunikezelwa okanye buvulwe nanini na. |
| **Busoloko Buqukiwe** | Ubumfihlo be-WHOIS buvulwa ngokuzenzekelayo ekubhaliseni ngaphandle kwentlawulo. |
| **Ukhetho Lomthengi** | Ibhokisi yokukhetha ivela ngexesha lokugqiba intlawulo. Seta **Ixabiso lobumfihlo** ukuze uhlawulise ngonyaka, okanye ulishiye ku-$0 ukuze ulinikezele simahla. |

Kwi-Namecheap, ubumfihlo be-WHOIS busebenzisa i-WhoisGuard (isoloko isimahla). Kwi-OpenSRS, busebenzisa inkonzo yobumfihlo ye-OpenSRS (isenokuba neendleko kwihowuliseyili).
...
- **Ukulungelelanisa ngesandla:** Iisetingi › Domain Seller › Lungelelanisa ii-TLD (ngomboneleli ngamnye)
- **Ukulungelelanisa ngokuzenzekelayo:** Kuqhuba yonke imihla ngomsebenzi we-cron ocwangcisiweyo kubo bonke ababoneleli abaqwalaselweyo

Emva kokulungelelanisa, yiya kwithebhu yeeSethingi ze-Domain kuyo nayiphi na imveliso ye-domain kwaye usebenzise umkhethi we-TLD ukuze ubone ii-TLD ezifumanekayo namaxabiso azo ehlelo lehowuliseyili angoku.
...
- Xa ubulungu buhlaziywa kwaye i-domain idityanisiwe, ukuhlaziywa kwe-domain kufakwa ngokuzenzekelayo emgceni
- Iinzame zokuhlaziya zisebenzisa igateway yentlawulo esebenzayo yomthengi
- Ukuhlaziywa okungaphumelelanga kuzanywa kwakhona ngokuzenzekelayo ngokunyuka kwexesha lokulinda
- Izaziso ze-imeyile zithunyelwa kwiihlaziyo eziphumeleleyo, ukusilela, kunye nokuphelelwa okusondeleyo

Ii-ID zeethempleyithi ze-imeyile zeziganeko zomjikelo wobomi be-domain:

| Isiganeko | I-ID yethempleyithi |
|---|---|
| I-domain ibhalisiwe | `domain_registered` |
| I-domain ihlaziyiwe | `domain_renewed` |
| Ukuhlaziya kusilele | `domain_renewal_failed` |
| I-domain iza kuphelelwa kungekudala | `domain_expiring_soon` |
...
1. Yiya ku-**Network Admin › Ultimate Multisite › Bhalisa i-Domain**
2. Khetha umthengi uze ufake igama le-domain
3. Gcwalisa iinkcukacha zoqhagamshelwano zomregistrant (igama, idilesi, ifowuni)
4. Cofa **Bhalisa**

Irekhodi le-domain liyadalwa kwaye linxulunyaniswa ne-Account yomthengi.
