---
title: Ukukhenketha kwiPhaneli yoLawulo
sidebar_position: 16
...
Nanku umbono opheleleyo we-dashboard:

![Ultimate Multisite Dashboard iphepha elipheleleyo](/img/admin/um-dashboard-full.png)

Kwaye icandelo elisezantsi le-dashboard:

![Ultimate Multisite Dashboard icandelo elisezantsi](/img/admin/um-dashboard-bottom.png)

Nanku kwakhona umbono opheleleyo we-network dashboard:
...
Iisetingi ze-AI connector zidwelisa amaqela e-OAuth provider axhaswayo ngoku: Anthropic Max, OpenAI ChatGPT/Codex, kunye ne-Google AI Pro. Ikhadi ngalinye le-provider livumela ii-super admin ukuba zidibanise ii-account, zihlaziye ii-account ezigciniweyo, zisuse ii-account nge-imeyile, kwaye zisebenzise i-manual OAuth fallback xa imeko ye-sandbox ivimba i-browser redirect. Iinketho zokuseta i-Cursor Pro zisusiwe kwi-admin panel.

Ii-account ze-ChatGPT/Codex zixhasa ukusetyenziswa kwezixhobo ezixhaswa yi-connector apho umsebenzi uvumela izixhobo, ngoko ii-workflow ze-admin ezixhomekeke kwimisebenzi exhaswa yi-connector zingasebenzisa ukuziphatha kwesixhobo se-Codex emva kokuba i-OpenAI account idityanisiwe.

![Iphepha leSettings](/img/admin/settings-general.png)

Nanku umbono opheleleyo wephepha leesetingi ngokubanzi:

![Settings ngokubanzi iphepha elipheleleyo](/img/admin/settings-general-full.png)

Kwaye iphepha leesetingi zee-imeyile:

![Settings zee-imeyile iphepha elipheleleyo](/img/admin/settings-emails-full.png)

Kwaye iphepha leesetingi zeentlawulo:

![Settings zeentlawulo iphepha elipheleleyo](/img/admin/settings-payments-full.png)

Kwaye icandelo elisezantsi leesetingi zeentlawulo:

![Settings zeentlawulo icandelo elisezantsi](/img/admin/settings-payments-bottom.png)

Kwaye iphepha leesetingi zee-site:
...
![Uluhlu lweeWebhooks](/img/admin/webhooks-list.png)
