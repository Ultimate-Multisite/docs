...
3. Khetha umxholo onganyanzelekanga ukuba ubandakanywe, njengokulayishiweyo, ii-plugins, kunye nee-themes, xa ezo ndlela zikho.
4. Qalisa i-export uze ulinde inkqubo igqitywe. Ii-site ezinkulu zingadinga ukugqitywa ngasemva phambi kokuba i-ZIP ilunge.
5. Khuphela i-ZIP egqityiweyo kuluhlu lwee-exports.
...
- Umxholo wedathabheyisi kunye noqwalaselo lwe-site ekhethiweyo.
- Iifayile zemidiya ezilayishiweyo xa okulayishiweyo kuqukiwe.
- Ii-plugins kunye nee-themes xa ezo ndlela zikhethiweyo.
- Imetadata ye-import esetyenziswa sisixhobo se-Export & Import ukwakha kwakhona i-site kufakelo ekujoliswe kulo.
...
3. Faka i-URL yokutshintsha ukuba i-site kufuneka isebenzise idilesi entsha, okanye ushiye umhlaba ungenanto ukuze kugcinwe i-URL yoqobo.
4. Khetha ukuba uyicime na i-ZIP elayishiweyo emva kokuba i-import igqityiwe.
5. Cofa **Begin Import**.
6. Jonga i-import esalindileyo de igqitywe. Sebenzisa **Cancel Import** kuphela ukuba kufuneka uyimise inkqubo phambi kokugqitywa.
7. Hlola i-site engenisiweyo ngaphambi kokuvumela itrafikhi eqhelekileyo okanye ukufikelela kwabathengi.
...
- Ufakelo lwe-WordPress ekujoliswe kulo kufuneka luqhube iinguqulelo ezihambelanayo ze-WordPress, PHP, Ultimate Multisite, plugin, kunye ne-theme.
- I-import ye-site enye ithatha indawo ye-site ekujoliswe kuyo. Ayisiso isixhobo sokudibanisa.
- Ukuhanjiswa kwe-multisite-to-single-site kunye ne-single-site-to-multisite kuxhaswa kuphela xa imeko-bume ekujoliswe kuyo inokusebenzisa ii-plugins, ii-themes, ii-URLs, kunye namacandelo afunekayo e-Ultimate Multisite e-site ethunyelwe ngaphandle.
- Gcina i-ZIP iyimfihlo. Inokuqulatha umxholo wedathabheyisi, iifayile ezilayishiweyo, kunye neenkcukacha zoqwalaselo ezivela kwi-site ethunyelwe ngaphandle.

Ngeendlela ezindala ze-export ezikwinqanaba lenethiwekhi, bona [Site Export](/user-guide/administration/site-export).
