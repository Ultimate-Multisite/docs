...
## Iimfuno Zangaphambili {#prerequisites}
...
## Uqwalaselo (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Amanqaku & Iingcebiso {#notes--tips}
...
## Umzekelo Wobizo lwe-API (cURL) {#example-api-call-curl}
