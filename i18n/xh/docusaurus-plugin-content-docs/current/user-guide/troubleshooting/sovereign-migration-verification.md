...
## Imiyalelo emayiqhutywe {#commands-to-run}
...
## Iintsilelo eziqhelekileyo {#common-failures}

### Iimvume zedatabase azihambelani nehost {#database-grants-do-not-match-the-host}
...
### Ufakelo lweBedrock okanye lwasekuhlaleni alukwazi ukudibanisa {#bedrock-or-local-installs-cannot-connect}
...
### Umgca wokutyhala we-async awupheli {#async-push-queue-does-not-drain}
...
### Inani labasebenzisi bomqeshi alichanekanga {#tenant-user-count-is-wrong}
...
### Utyelelo lwe-SSO luyaliwa {#sso-visit-is-rejected}
