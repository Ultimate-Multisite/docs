---
title: Iimenyu Zokwamkela Iindwendwe
sidebar_position: 3
...
- **Iibha neeLounges** — iimenyu zeziselo nezidlo zokuqalisa
- **Iibhakery** — iimenyu zee-pastry nesonka
- **Iinkonzo zokutya zemisitho** — iinketho zemenyu yemisitho
...
- **Izidlo zokuqalisa** — iziqalisi nezitya ezincinci
- **Izidlo eziphambili** — iikhosi eziphambili
- **Izongezo** — izikhapha-zidlo nemifuno
- **Iidessert** — izimuncumuncu
...
|-------|------|-------------|
| `name` | string | Igama lesitya okanye lesiselo |
| `description` | string | Inkcazo eneenkcukacha yento |
| `price` | string | Ixabiso (lifomathwe ngemali) |
| `dietary_info` | array | Iimpawu zokutya (Vegan, Gluten-Free, njl.) |
...
```
Yenza imenyu yendawo yokutyela yendawo yam yokutyela yamaTaliyane enezidlo zokuqalisa,
...
1. Idala iphepha lemenyu elicwangciswe kakuhle
2. Iyila ukuze lihambelane ne-theme ye-site yakho
3. Ilungelelanisa izinto ngokweendidi
...
1. Ukuhlela izinto zemenyu namaxabiso
2. Ukongeza okanye ukususa iindidi
3. Ukuhlengahlengisa ngokutsha izinto ngaphakathi kweendidi
...
- Ilungelelaniswe ngokwedidi
- Iyakhangeleka kwaye iyahluzwa
...
- Izinto eziphambili kwiphepha lasekhaya
- Izipesheli zemihla ngemihla kwi-sidebar
...
- Ifomathi yobungcali
- Umgangatho olungele ukuprintwa
...
- **Vegan** — akukho mveliso yezilwanyana
- **Vegetarian** — akukho nyama
- **Gluten-Free** — ikhuselekile kwisifo se-celiac
- **Dairy-Free** — akukho mveliso zobisi
- **Nut-Free** — akukho mandongomane emithi okanye amandongomane
...
- **Nuts** — amandongomane emithi namandongomane
- **Shellfish** — ii-crustaceans nee-mollusks
- **Fish** — zonke iintlobo zeentlanzi
- **Dairy** — ubisi nemveliso zobisi
- **Eggs** — amaqanda enkukhu
- **Soy** — iimveliso zesoya
...
1. Yiya kwiphepha lemenyu
2. Cofa "Hlela iMenyu"
3. Hlaziya amaxabiso ezinto
4. Gcina utshintsho
...
1. Yenza inguqulelo entsha yemenyu
2. Yongeza izinto zonyaka
3. Phawula izinto njenge-"Seasonal"
...
1. Yenza udidi lwe-"Specials"
2. Yongeza izinto ezinemihla yokufumaneka
3. Gqamisa izipesheli kwiphepha lasekhaya
...
1. **Ukufumanisa imenyu ngokuzenzekelayo** — ichonga ukuba ulikhishini lokutya/leziselo
2. **Ukudala iphepha lemenyu** — ivelisa amaphepha emenyu obungcali
3. **Ukuhambelana koyilo** — iimenyu zihambelana ne-theme ye-site yakho
...
- **Amaxabiso angaguquguqukiyo** — imali nefomathi ecacileyo
...
- **Faka izinto ezibangela ukwaliwa** — soloko udwelisa izinto ezibangela ukwaliwa
...
- **Iileyibhile zokutya** — phawula ngokucacileyo iinketho zokutya
...
- [Udliwano-ndlebe lokuFumanisa](./discovery-interview.md) — cwangcisa ulwakhiwo lwesayithi yakho
