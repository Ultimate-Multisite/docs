...
- **Amasango okuvunywa ngumntu neerekhodi zezikhumbuzo** — nqumamisa ii-automation ukuze zihlolwe kwaye kuthintelwe izaziso eziphindaphindiweyo
...
- **Isakhono seValidate Palette Contrast** — jonga izibini zemibala ngokuthobela i-WCAG ngaphambi kokuzisebenzisa kwi-theme
- **Iimenyu zoshishino lokwamkela iindwendwe** — Theme Builder ngoku inokwenza amaphepha emenyu yokutya neziselo acwangcisiweyo kumashishini okwamkela iindwendwe
- **Ukunikezelwa komboniso wangaphambili kwi-desktop nakwiselfowuni** — bona uyilo lwakho kwangaphambili kwizixhobo ze-desktop nezefowuni ngexesha lokukhetha indlela yoyilo
...
- **Imiyalelo yeWP-CLI** — kubuyiselwe ii-alias ze-namespace ebezingekho emva kohlengahlengiso lwangaphambili
- **I-automation yeziganeko** — iphatha ngobunono iisayithi apho iitafile ze-automation zingekadalwa
- **isakhono se-memory-save** — ngoku sisebenzisa isimaphambili se-namespace esichanekileyo kumakhi womyalelo wenkqubo
- **Iziphumo zesixhobo se-scalar** — ngoku zisongelwe ngokuchanekileyo ngaphambi kokubuyiselwa kwi-AI
- **Iinkcukacha-manani zokusetyenziswa** — ngoku ziphatha ngokuchanekileyo ifomathi yesitshixo sesakhono selifa xa kunyuselwa ukusuka kwiinguqulelo ezindala
