---
title: Ho na le litlhahlo tsa ho tsamaea le lits'e mo le system emails
sidebar_position: 13
...
Ho tloha ho lona, u ka u fihla page ea **System Emails** ho bona templates hantle tsa emails.

![System Emails list](/img/admin/system-emails-list.png)

U ka u fetola templates e kholo ea email ka ho sebelisa editor ea system email:
...
Ho importela litlhaloso tse ntlha:

1. Laela la peje **System Emails**
2. Leela le **Reset & Import** button e le teng teng le matla a page
...
1. **Faka le fana ka mofuta o refa** — Faka email ya sistema pele u fana ka mofuta o refa (o faka metrics ya ho fana).

2. **Rea ka mofuta o tsamaisang** — Usa mofuta o **Reset & Import**, fana le tshepa (toggle) mofuta oa **Reset**, le selekela emails joae u batla ho reka pele.

Mofuta oa Reset o hlophiswe ka ho ba le metrik ya ho fana le metadata e mengata, e leng hore o reke seo se fanaeng sa tloha (default content).
