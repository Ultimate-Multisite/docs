...
## Fa'aopo site ena site {#exporting-one-site}
...
## Fa'aopo whole network {#exporting-the-whole-network}
...
#### Fa'aopo Network Import Bundle {#generating-a-network-import-bundle}
...
#### Goala ho Baola ka Bundle e Ho Fetola (Restoring from a Network Import Bundle) {#restoring-from-a-network-import-bundle}
...
## Ho Installela ZIP e Ho Fetola Se Se E Ho Fetola (Installing a self-booting export ZIP) {#installing-a-self-booting-export-zip}
