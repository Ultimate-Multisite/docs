...
## Boitshwaro ba Setsope (Setup Instructions)
...
### Ho Dira Certificate ea SSL (SSL Certificate Management)
...
## Ho Fetola/Ho Tsoela Certificate ea SSL (SSL Certificate Verification)
...
## Ho Abala (Troubleshooting)

### Moruo oa API (API Connection Issues)
...
### Moruo oa Certificate ea SSL (SSL Certificate Issues)
...
### Domain Ha Abala (Domain Not Added)
