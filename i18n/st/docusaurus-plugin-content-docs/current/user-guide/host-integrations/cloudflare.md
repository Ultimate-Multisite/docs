...
## Boitshwaro (Setup Instructions)

### 1. Get API Key ya Cloudflare
...
### 3. Add Constants mo wp-config.php
...
## Ho Baola (How It Works)

### Management a Subdomain
...
### Ho Ba Leano la DNS (DNS Record Display)
...
## Leano la Hostnames ea Cloudflare (Cloudflare Custom Hostnames)
...
## Go bona Lefatsa (Troubleshooting)

### Morero wa Leletsi la API
...
### Matlala a Mabotse (Proxying Issues)
