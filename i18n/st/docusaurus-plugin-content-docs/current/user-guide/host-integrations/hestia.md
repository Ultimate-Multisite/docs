...
## Fa'amalosia (Wizard → Integrations → Hestia) {#prerequisites}
...
## Ho lula Setup {#configuration-wizard--integrations--hestia}
...
## Litsoalo & Lehetseng (Notes & Tips) {#verifying-setup}
...
## Litsoalo ea API (cURL) {#notes--tips}
...
## Goalo bo Thaba (Troubleshooting) {#example-api-call-curl}
...
## Ho Litso (References) {#troubleshooting}
