...
## Boitlhokwa (Setup Instructions)

### 1. Ho tloha API Key ya hau ya Closte
...
### 2. Ho fetola Integration (Enable the Integration)
...
## Ho Fetola Record ya Domain (Domain Record Creation)
...
## Ho Fetola Matlha (Troubleshooting)

### Morero wa Leano la API (API Connection Issues)
...
### Matlha a SSL Certificate (SSL Certificate Issues)
...
### Domain E Ntšhobo (Domain Not Added)
...
### Nako ea Ho Tsamaea Records ya DNS (DNS Check Interval)
