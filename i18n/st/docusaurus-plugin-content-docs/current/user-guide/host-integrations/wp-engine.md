...
## Litshuo tsa Ho Set (Setup Instructions) {#setup-instructions}

### 1. Goela Plugin ya WP Engine {#1-verify-wp-engine-plugin}
...
### 2. Enable Ho Integration {#2-enable-the-integration}
...
## Ee Etsa Kae (How It Works) {#how-it-works}
...
## Aiga Fa'aoniga Muamua (Important Notes) {#subdomain-support}
...
## Aiga Fa'amalosia (Troubleshooting) {#ssl-certificates}
...
### Domain Not Added {#api-connection-issues}
...
### Subdomain Issues {#domain-not-added}
