---
title: Hoetsope ea Domain le Hoetsope
sidebar_position: 2
...
2. I le **Add New**
3. Fa'aopo o le tsetsetsetse o le produkta i le **Domain**
4. Fa'aopo o le tab **Domain Settings** (fa'amalosia i le fa'atatau)
5. Save
...
Fa'amalosia le lista o TLDs (e.g., `.com, .net, .org`) ma fa'aopo o se produkta **TLD-specific product** o le a fa'atatau i tousi o fe'esoasoani.
...
| Mode | O le a ia fa'aopoina |
|---|---|
| **Percentage** | Fa'aopo o se percentage i le wholesale cost. Se 20% markup i le domain o $10 wholesale e fa'aopo ai $12. |
...
| Setso | Ho ba leloboha |
|---|---|
| **Disabled** | WHOIS privacy ha se fetse ho fana ka kapa ho ba leloboha. |
| **Always Included** | WHOIS privacy e fetse ho ba leloboha ka tsela e fetang ya tsotso e fetang e fetse ka ntlha ya boikotso. |
| **Customer Choice** | Se sebedise se fetse se fetse mo morao a leba. Setse **Privacy price** se fetse ho ba leloboha ka tsela e fetang, kapa se fetse ka $0 ho fana ka e fetang ka tsotso e fetang. |

Ho Namecheap, WHOIS privacy e fetse e fetse ka WhoisGuard (e fetse e fetse). Ho OpenSRS, e fetse e fetse liphoso tsa litswalo tsa OpenSRS (ha se fetse ho na le tsotso ka tsela ya mofuta o fetang).
...
1. La le **Network Admin › Ultimate Multisite › Register Domain**
2. Select the customer le fana le leena la domain
3. Fill in details tsa boipuo sa mo fana (leena, leena, le phone)
4. Click **Register**

Ho fana le record sa domain ho fana le ho kapa la mo fana.
