...
## Ha U Na Le U Na Site Builder Mode
...
### Fetola Ho Ba Le Setup Assistant Agent
...
## Ho Batla Ho Ba Le Setup Assistant Agent
...
## Litlhoko tsa Setup Assistant Agent
...
## Ho hlalosa problems (Troubleshooting)

### Ha ke ka hapa Site Builder mode

Site Builder mode e fetileng. Ho sebelisa Setup Assistant agent:

"Bopola ho fana ka set up seboetse"

### Ke batla ke ke le site seboetse se Site Builder se fetola
...
### Le site e fetola sa seboetse seboetse sefetola
...
### Ke fetola ka seboetse sa hau sefetola?
