---
title: Mehlala e Tsoetseng Pele ea Khoutu
sidebar_position: 1
...
Dikopo tse pedi tse etsahalang ka nako e le nngwe di ka bala boleng bo tshwanang mme ka bobedi tsa ngola hape sephetho se le seng se ekeditsweng, tsa lahlehelwa ke palo e le nngwe. `increment_item()` e nehelana ka dipalo ho motjhini wa database ka polelo e le nngwe ya `UPDATE ... SET column = column + ?`, e etsang hore tshebetso e be atomic ka tlhaho.
