...
title: Sefe - wu_country_get_administrative_division_name
...
|------|------|-------------|
| $name | `string` | Lebitso la karolo. Hangata ntho e kang state, province, region, jj. |
| $country_code | `string` | Khoutu ya ISO ya ditlhaku tse pedi bakeng sa naha. |
| $state_code | `string` | Khoutu ya ISO ya ditlhaku tse pedi bakeng sa state. |
