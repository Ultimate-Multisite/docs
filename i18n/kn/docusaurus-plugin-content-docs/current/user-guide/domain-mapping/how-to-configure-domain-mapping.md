...
---
# ಡೊಮೇನ್ ಮ್ಯಾಪಿಂಗ್ ಅನ್ನು ಹೇಗೆ ಸಂರಚಿಸುವುದು (v2) {#how-to-configure-domain-mapping-v2}
...
## ಡೊಮೇನ್ ಮ್ಯಾಪಿಂಗ್ ಎಂದರೇನು? {#whats-domain-mapping}
...
### ನಿಮ್ಮ Ultimate Multisite ಜಾಲದಲ್ಲಿ ಡೊಮೇನ್ ಮ್ಯಾಪಿಂಗ್ ಅನ್ನು ಹೇಗೆ ಸೆಟಪ್ ಮಾಡುವುದು {#how-to-setup-domain-mapping-on-your-ultimate-multisite-network}
...
### ಡೊಮೇನ್ DNS ಸೆಟ್ಟಿಂಗ್‌ಗಳು ಸರಿಯಾಗಿ ಸಂರಚಿಸಲ್ಪಟ್ಟಿವೆ ಎಂಬುದನ್ನು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳುವುದು {#making-sure-the-domain-dns-settings-are-properly-configured}
...
### Super Admin ಆಗಿ ಕಸ್ಟಮ್ ಡೊಮೇನ್ ಹೆಸರನ್ನು ಮ್ಯಾಪ್ ಮಾಡುವುದು {#mapping-custom-domain-name-as-super-admin}
...
### Subsite user ಆಗಿ custom domain name mapping ಮಾಡುವುದು {#mapping-custom-domain-name-as-subsite-user}
...
### Domain Syncing ಬಗ್ಗೆ {#about-domain-syncing}
