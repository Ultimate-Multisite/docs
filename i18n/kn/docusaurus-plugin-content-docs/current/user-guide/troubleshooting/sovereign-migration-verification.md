...
## ನಡೆಸಬೇಕಾದ ಕಮಾಂಡ್‌ಗಳು (Commands to run) {#commands-to-run}
...
## ಸಾಮಾನ್ಯ ವೈಫಲ್ಯಗಳು (Common failures) {#common-failures}

### ಡೇಟಾಬೇಸ್ ಗ್ರಾಂಟ್‌ಗಳು ಹೋಸ್ಟ್‌ನೊಂದಿಗೆ ಹೊಂದಿಕೆಯಾಗುವುದಿಲ್ಲ (Database grants do not match the host) {#database-grants-do-not-match-the-host}
...
### ಬೆಡ್‌ proceed (Bedrock) ಅಥವಾ ಸ್ಥಳೀಯ ಅಳವಡಿಕೆಗಳು ಸಂಪರ್ಕಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ (Bedrock or local installs cannot connect) {#bedrock-or-local-installs-cannot-connect}
...
### ಅಸಿನ್ခ್ ಪುಶ್ ಕ್ಯೂ ಖಾಲಿಯಾಗುತ್ತಿಲ್ಲ (Async push queue does not drain) {#async-push-queue-does-not-drain}
...
### ಟೆಂಟೆಂಟ್ ಬಳಕೆದಾರರ ಸಂಖ್ಯೆ ತಪ್ಪಾಗಿದೆ (Tenant user count is wrong) {#tenant-user-count-is-wrong}
...
### SSO ಭೇಟಿ ತಿರಸ್ಕರಿಸಲ್ಪಟ್ಟಿದೆ (SSO visit is rejected) {#sso-visit-is-rejected}
...
## తిరిగి ప్రయత్నించాల్సిన సమయం {#when-to-retry}
