...
---
# RunCloud ಇಂಟಿಗ್ರೇಶನ್ {#runcloud-integration}
...
### 1. ನಿಮ್ಮ RunCloud API ಪ್ರಮಾಣಪತ್ರಗಳನ್ನು ಪಡೆಯಿರಿ {#1-get-your-runcloud-api-credentials}
...
### 2. ನಿಮ್ಮ Server ಮತ್ತು App ID ಗಳನ್ನು ಪಡೆಯಿರಿ {#2-get-your-server-and-app-ids}
...
### 4. ಇಂಟಿಗ್ರೇಶನ್ ಸಕ್ರಿಯಗೊಳಿಸಿ {#4-enable-the-integration}
...
### SSL ಸರ್ಟಿಫಿಕೇಟ್ ಸಮಸ್ಯೆಗಳು {#ssl-certificate-issues}
...
### ಡೊಮೈನ್ ಸೇರಿಸಲಾಗಲಿಲ್ಲ {#domain-not-added}
