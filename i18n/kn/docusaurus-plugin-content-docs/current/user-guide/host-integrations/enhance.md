...
---
# Enhance Control Panel ಸಮನ್ವಯ {#enhance-control-panel-integration}
...
### ಸಿಸ್ಟಮ್ ಅವಶ್ಯಕತೆಗಳು {#system-requirements}
...
### API ಪ್ರವೇಶ {#api-access}
API ಟೋಕನ್‌ಗಳನ್ನು ರಚಿಸಲು ನಿಮಗೆ Enhance Control Panel ಗೆ ನಿರ್ವಾಹಕ ಪ್ರವೇಶ ಇರಬೇಕು.

## ನಿಮ್ಮ API ರುಜುವಾತುಗಳನ್ನು ಪಡೆಯುವುದು {#getting-your-api-credentials}

### 1. API ಟೋಕನ್ ರಚಿಸಿ {#1-create-an-api-token}
...
### 2. ನಿಮ್ಮ Organization ID ಪಡೆಯಿರಿ {#2-get-your-organization-id}
...
### 3. ನಿಮ್ಮ Server ID ಪಡೆಯಿರಿ {#3-get-your-server-id}
...
### 4. ನಿಮ್ಮ API URL ಪಡೆಯಿರಿ {#4-get-your-api-url}
...
### ಅಗತ್ಯ Constants {#required-constants}
...
### Integration Wizard ಮೂಲಕ ಸೆಟಪ್ {#setup-via-integration-wizard}
...
## ಹೆಚ್ಚುವರಿ WordPress ಕಾನ್ಫಿಗರೇಶನ್ {#additional-wordpress-configuration}
...
### .htaccess ಕಾನ್ಫಿಗರೇಶನ್ {#htaccess-configuration}
...
### ಡೊಮೇನ್ ಮ್ಯಾಪ್ ಆದಾಗ {#when-a-domain-is-mapped}
...
### ಡೊಮೇನ್ ತೆಗೆದಾಗ {#when-a-domain-is-removed}
...
### DNS ಮತ್ತು SSL ಪರಿಶೀಲನೆ {#dns-and-ssl-checking}
...
## ಸೆಟಪ್ ಪರಿಶೀಲನೆ {#verifying-setup}

### ಸಂಪರ್ಕ ಪರೀಕ್ಷಿಸಿ {#test-the-connection}
...
### ಡೊಮೇನ್ ಮ್ಯಾಪ್ ಮಾಡಿದ ನಂತರ {#after-mapping-a-domain}
...
### ಡೊಮೇನ್ ಸೇರಿಸಲಾಗಲಿಲ್ಲ {#domain-not-added}
...
### DNS ಪರಿಶೀಲನಾ ಮಧ್ಯಂತರ {#dns-check-interval}
...
### ದೃಢೀಕರಣ ದೋಷಗಳು {#authentication-errors}
...
### ಬಳಸಲಾದ ಸಾಮಾನ್ಯ Endpoints {#common-endpoints-used}
...
### ಸಂಪೂರ್ಣ API ದಸ್ತಾವೇಜನೆ {#full-api-documentation}
