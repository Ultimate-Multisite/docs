...
## ಕಾನ್ಫಿಗರೇಶನ್ (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## ಟಿಪ್ಪಣಿಗಳು ಮತ್ತು ಸಲಹೆಗಳು {#notes--tips}
...
## API ಕರೆಯ ಉದಾಹರಣೆ (cURL) {#example-api-call-curl}
