...
### 1. ನಿಮ್ಮ Hostinger API ಟೋಕನ್ ರಚಿಸಿ {#1-generate-your-hostinger-api-token}
...
### 2. ನಿಮ್ಮ Account ID ಹುಡುಕಿ {#2-find-your-account-id}
...
### 4. integration ಅನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ {#4-enable-the-integration}
