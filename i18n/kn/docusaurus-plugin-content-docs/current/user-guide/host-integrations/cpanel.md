...
---
# cPanel ಸಂಯೋಜನೆ {#cpanel-integration}
...
### 1. ನಿಮ್ಮ cPanel ಕ್ರೆಡೆನ್ಶಿಯಲ್‌ಗಳನ್ನು ಪಡೆಯಿರಿ {#1-get-your-cpanel-credentials}
...
### 2. wp-config.php ಗೆ Constants ಸೇರಿಸಿ {#2-add-constants-to-wp-configphp}
...
### 3. ಸಂಯೋಜನೆಯನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ {#3-enable-the-integration}
...
## ಮಹತ್ವದ ಟಿಪ್ಪಣಿಗಳು {#important-notes}
...
### SSL Certificate ಸಮಸ್ಯೆಗಳು {#ssl-certificate-issues}
