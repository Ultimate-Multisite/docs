...
## ಅಗತ್ಯ ಅನುಮತಿಗಳು (Required permissions)
...
## site ಅನ್ನು ZIP ಆಗಿ export ಮಾಡುವುದು
...
## export ನಲ್ಲಿ ಏನಿದೆ (What the export includes)
...
## ZIP ನಿಂದ site ಅನ್ನು import ಮಾಡುವುದು
...
## ಮಿತಿಗಳು ಮತ್ತು compatibility ಟಿಪ್ಪಣಿಗಳು (Limitations and compatibility notes)
