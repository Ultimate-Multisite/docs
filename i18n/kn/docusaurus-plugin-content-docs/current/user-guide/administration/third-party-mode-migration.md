...
## ಯಾರು ಬಾಧಿತರಾಗುತ್ತಾರೆ?

### ಹೊಸ Installation (WordPress 7.0+)
...
### 7.0 ಕ್ಕಿಂತ ಹಳೆಯ WordPress version ಗಾಗಿ
...
## Modes ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು

### Auto Mode (ಹೊಸ Default)
...
## ನಿಮ್ಮ ಪ್ರಸ್ತುತ Mode ಅನ್ನು ಪರಿಶೀಲಿಸುವುದು
...
## ನಿಮ್ಮ Mode ಅನ್ನು ಬದಲಾಯಿಸುವುದು

### Auto Mode ಗೆ ಬದಲಾಯಿಸುವುದು
...
## Auto Mode ನ ಪ್ರಯೋಜನಗಳು

### ಸ್ವಯಂಚಾಲಿತ Discovery
...
### ಸರಳೀಕೃತ ನಿರ್ವಹಣೆ (Simplified Management)
...
### ಉತ್ತಮ ಕಾರ್ಯಕ್ಷಮತೆ (Better Performance)
...
### ನೀವು WordPress 6.x ನಲ್ಲಿ ಇದ್ದರೆ
...
### ನೀವು WordPress 7.0+ ನಲ್ಲಿ ಇದ್ದರೆ
...
### auto mode ನಲ್ಲಿ abilities ಲೋಡ್ ಆಗುತ್ತಿಲ್ಲ
...
### ನಾನು legacy mode ಅನ್ನು ಉಳಿಸಲು ಬಯಸುತ್ತೇನೆ
...
### ನನ್ನ custom abilities ಕಾಣಿಸುತ್ತಿಲ್ಲ
...
### ನನಗೆ "unclassified ability" notices ಬರುತ್ತಿವೆ
