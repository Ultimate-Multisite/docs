...
## Site Specification ಅನ್ನು ಏಕೆ ಬಳಸಬೇಕು?

### ಸೆಷನ್‌ಗಳಾದ್ಯಂತ ಸ್ಥಿರತೆ (Consistency Across Sessions)
...
### ಉತ್ತಮ ಶಿಫಾರಸುಗಳು (Better Recommendations)
...
### ವೇಗದ ಆನ್‌ಬೋರ್ಡಿಂಗ್ (Faster Onboarding)
...
## Site Specification ಅನ್ನು ಪ್ರಾರಂಭಿಸುವುದು

### Theme Builder ಆನ್‌ಬೋರ್ಡಿಂಗ್ ಸಮಯದಲ್ಲಿ
...
### ಕೈಯಾರೆ ಪ್ರಾರಂಭಿಸುವುದು (Manual Initiation)
...
## Site Specification ಪ್ರಕ್ರಿಯೆ

### ಹಂತ 1: ಸೈಟ್ ಉದ್ದೇಶ (Site Purpose)
...
### ಹಂತ 2: ಗುರಿ ಪ್ರೇಕ್ಷಕರು (Target Audience)
...
### ಹಂತ 3: ಬ್ರ್ಯಾಂಡ್ ಗುರುತು (Brand Identity)
...
### ಹಂತ 4: ವ್ಯಾಪಾರ ಗುರಿಗಳು (Business Goals)
...
### ಹಂತ 5: ಕಂಟೆಂಟ್ ರಚನೆ (Content Structure)
...
## ನಿಮ್ಮ site_brief ನೆನಪು (Your site_brief Memory)
...
## ನಿಮ್ಮ site_brief ಅನ್ನು ನೋಡುವುದು ಮತ್ತು ಅಪ್ಡೇಟ್ ಮಾಡುವುದು

### ನಿಮ್ಮ site_brief ಅನ್ನು ನೋಡುವುದು
...
### ನಿಮ್ಮ site_brief ಅನ್ನು ಅಪ್ಡೇಟ್ ಮಾಡುವುದು
...
## ಏಜೆಂಟ್‌ಗಳು site_brief ಅನ್ನು ಹೇಗೆ ಬಳಸುತ್ತವೆ

### ವಿನ್ಯಾಸ ಶಿಫಾರಸುಗಳು (Design Recommendations)
...
### ವೈಶಿಷ್ಟ್ಯಗಳ ಸಲಹೆಗಳು (Feature Suggestions)
...
### ಕಂಟೆಂಟ್ ರಚನೆ (Content Structure)
...
### ನಿಯಮಿತವಾಗಿ ಅಪ್ಡೇಟ್ ಮಾಡಿ (Update Regularly)
...
### ಸ್ಥಿರವಾದ ಪದಜಾಲವನ್ನು ಬಳಸಿ (Use Consistent Terminology)
...
### ಸಂದರ್ಭವನ್ನು ಸೇರಿಸಿ (Include Context)
...
## Theme Builder Onboarding ಗೆ ಸಂಬಂಧ
