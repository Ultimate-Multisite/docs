...
## Theme Builder Onboarding Flow ಎಂದರೇನು?
...
## Theme Builder Onboarding ಅನ್ನು ಪ್ರಾರಂಭಿಸುವುದು

### ಮೊದಲ ಬಾರಿಯ ಸೆಟಪ್ (First-Run Setup)
...
### ಕೈಯಾರೆ ಸಕ್ರಿಯಗೊಳಿಸುವಿಕೆ (Manual Activation)
...
### ಹಂತ 1: ಮೋಡ್ ಆಯ್ಕೆ (Mode Selection)
...
### ಹಂತ 2: ಸೈಟ್ ವಿವರಣೆ (Site Specification)
...
### ಹಂತ 3: ವಿನ್ಯಾಸ ವ್ಯವಸ್ಥೆ ನಿರ್ಧಾರಗಳು (Design System Decisions)
...
### ಹಂತ 4: ಥೀಮ್ ರಚನೆ (Theme Generation)
...
### ಹಂತ 5: ಸಕ್ರಿಯಗೊಳಿಸುವಿಕೆ ಮತ್ತು ಪರಿಶೀಲನೆ (Activation and Verification)
...
## Site Specification ಮತ್ತು site_brief Memory
...
### ನಿಮ್ಮ site_brief ಅನ್ನು ವೀಕ್ಷಿಸುವುದು
...
## Onboarding ನಂತರ ಕಸ್ಟಮೈಸ್ ಮಾಡುವುದು

Theme Builder onboarding ಪೂರ್ಣಗೊಂಡ ನಂತರ, ನೀವು:

### Design System Aesthetics Skill ಅನ್ನು ಬಳಸಿ
...
### theme.json ಅನ್ನು ನೇರವಾಗಿ ಸಂಪಾದಿಸಿ
...
### ಕಸ್ಟಮ್ ಬ್ಲಾಕ್ ಟೆಂಪ್ಲೇಟ್‌ಗಳನ್ನು ರಚಿಸಿ
