...
## ಎಂಡ್‌ಪಾಯಿಂಟ್ ಬಾಡಿ ಪ್ಯಾರಾಮೀಟರ್‌ಗಳು {#endpoint-body-parameters}
...
## Zapier ನಲ್ಲಿ ಆಕ್ಷನ್ ರಚಿಸುವುದು {#creating-an-action-in-zapier}
...
### ಆಕ್ಷನ್ ರಚಿಸುವುದು {#creating-an-action}
...
### ಸಂಪೂರ್ಣ ಎಂಡ್‌ಪಾಯಿಂಟ್ ಪ್ಯಾರಾಮೀಟರ್‌ಗಳು {#complete-endpoint-parameters}
