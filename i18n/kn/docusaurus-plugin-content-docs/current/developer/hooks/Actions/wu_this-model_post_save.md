...
ಒಂದು ಆಬ್ಜೆಕ್ಟ್ (object) ಡೇಟಾಬೇಸ್‌ನಲ್ಲಿ ಸ್ಟೋರ್ ಆದ ನಂತರ ಇದು ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $data | `array` | ಸ್ಟೋರ್ ಆಗಲಿರುವ ಆಬ್ಜೆಕ್ಟ್ ಡೇಟಾ. |
| $this | `\Base_Model` | ಆಬ್ಜೆಕ್ಟ್‌ನ ಉದಾಹರಣೆ (instance). |
| $new | `bool` | ಆಬ್ಜೆಕ್ಟ್ ಹೊಸದಾಗಿದ್ದರೆ (new) ನಿಜ (True). |
