...
## ಇದನ್ನು ಯಾವಾಗ ಬಳಸಬೇಕು {#when-to-use-it}
...
## ಫೈಲ್ ಹೆಸರಿಸುವ ನಿಯಮ (File naming convention) {#file-naming-convention}
...
## ಫೈಲ್ ಅನ್ನು ಎಲ್ಲಿ ಇಡಬೇಕು (Where to place the file) {#where-to-place-the-file}
...
## ಲಭ್ಯವಿರುವ hooks ಮತ್ತು filters {#hooks-and-filters-available}
...
## ಕನಿಷ್ಠ ಉದಾಹರಣೆ (Minimal example) {#minimal-example}
