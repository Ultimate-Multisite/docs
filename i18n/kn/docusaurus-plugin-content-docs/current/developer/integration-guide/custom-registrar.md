...
---
# ಕಸ್ಟಮ್ ರಿಜಿಸ್ಟ್ರಾರ್ ಏಕೀಕರಣವನ್ನು ನಿರ್ಮಿಸುವುದು {#building-a-custom-registrar-integration}
...
## ಇಂಟರ್‌ಫೇಸ್ (The interface) {#the-interface}
...
### ಐಚ್ಛಿಕ ವಿಧಾನಗಳು (Optional methods) {#optional-methods}
...
### ಮರಳಿ ನೀಡುವ ಮೌಲ್ಯದ ನಿಯಮ (Return value convention) {#return-value-convention}
...
## ನಿಮ್ಮ ಸಾಮರ್ಥ್ಯವನ್ನು ನೋಂದಾಯಿಸುವುದು (Registering your capability) {#registering-your-capability}
...
## ವಿಜಾರ್ಡ್‌ಗೆ credential ಕ್ಷೇತ್ರಗಳನ್ನು ಸೇರಿಸುವುದು (Adding credential fields to the wizard) {#adding-credential-fields-to-the-wizard}
...
## ನೋಂದಣಿ ನಂತರದ ಕ್ರಿಯೆಗಳಿಗಾಗಿ ಹುಕ್‌ಗಳು (Hooks for post-registration actions) {#hooks-for-post-registration-actions}
