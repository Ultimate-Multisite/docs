---
title: 'Piwulang 9: Nemtokake Rega kanggo Bathi'
sidebar_position: 10
...
- Situs web fitness profesional sing yen digawe khusus bisa regane $2,000-$5,000
- Pangopènan, pembaruan, lan keamanan terus-terusan sing ora perlu padha pikirake
- Fitur khusus ceruk sing ora ditawakake pembangun umum
- Kredibilitas saka platform sing dibangun kanggo industri dheweke
...
- **Nyewa pangembang web**: $2,000-$5,000 ing ngarep + pangopènan $50-$100/sasi
- **Wix/Squarespace**: $16-$45/sasi nanging ora ana fitur khusus fitness, lan kudu dibangun dhewe
- **Ora nindakake apa-apa**: Kelangan anggota sing ora bisa nemokake dheweke online
...
| Paket | Saben sasi | Tahunan (saben sasi) | Total Tahunan | Pangiritan |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mo | $39/mo | $468/year | diskon 20% |
| Growth | $99/mo | $79/mo | $948/year | diskon 20% |
| Pro | $199/mo | $159/mo | $1,908/year | diskon 20% |
...
- **Starter**: Ora ana ragad panyiyapan (nyuda alangan kanggo mlebu)
- **Growth**: Ragad panyiyapan $99 (nutupi konfigurasi domain khusus lan konsultasi wiwitan)
- **Pro**: Ragad panyiyapan $299 (nutupi panyiyapan pirang-pirang lokasi lan telpon pangancani wiwitan)
...
- **Uji coba gratis 7 dina** mung ing paket Starter
- Ora ana uji coba ing Growth lan Pro (pelanggan iki luwih nduweni komitmen lan ngarepake kanggo mbayar)
...
- **FITLAUNCH** -- diskon 30% kanggo 3 sasi pisanan (kanggo promosi peluncuran)
- **ANNUAL20** -- diskon 20% kanggo paket tahunan (yen durung didiskon)
- **REFERRAL** -- gratis 1 sasi (kanggo rujukan pelanggan)

Bukak **Ultimate Multisite > Kode Diskon** kanggo nggawe iki. Deleng [Nggawe Kode Diskon](/user-guide/configuration/creating-discount-codes) kanggo pandhuan lengkap.

:::tip Aja Menehi Diskon kanthi Gawan
...
1. Konfigurasi tarif pajeg ing **Ultimate Multisite > Setelan > Pajeg**
2. Terapake kategori pajeg menyang paket sampeyan
3. Pesthekake faktur nampilake pajeg kanthi bener
...
- **Tingkat konversi miturut paket**: Yen Starter konversine apik nanging Growth ora, celah ing antarane bisa uga kegedhen
- **Tingkat upgrade**: Yen mung sithik pelanggan sing upgrade saka Starter menyang Growth, paket Growth bisa uga durung menehi nilai tambahan sing cukup
...
├── Ultimate Multisite (dikonfigurasi + diwenehi merek)
├── Domain Platform (fitsite.com + wildcard SSL)
├── Cithakan Situs (Studio Essential, Gym Pro, Fitness Chain)
├── Produk
│   ├── FitSite Starter ($49/mo utawa $468/yr) + uji coba 7 dina
│   ├── FitSite Growth ($99/mo utawa $948/yr) + ragad panyiyapan $99
│   ├── FitSite Pro ($199/mo utawa $1,908/yr) + ragad panyiyapan $299
│   └── Tambahan Pesenan + Kode Diskon
├── Alur Pambayaran (kanthi toggle pilihan periode)
├── Pambentukan Merek (login, Dashboard, email, faktur, situs pemasaran)
├── Pangancani Pelanggan Wiwitan (Wiwitan Cepet, email, sumber pitulungan)
├── Strategi Pangregan
│   ├── Diskon tahunan (diskon 20%)
│   ├── Ragad panyiyapan strategis
│   ├── Uji coba 7 dina ing Starter
│   ├── Kode diskon kanggo kampanye lan rujukan
│   └── Konfigurasi pajeg
...
- **Periode uji coba** ing paket tingkat wiwitan kanggo nyuda alangan nalika ndhaptar
- **Kode diskon strategis** kanggo peluncuran, rujukan, lan kampanye
- **Konfigurasi pajak** kanggo tagihan sing manut aturan
- **Kerangka tinjauan rega** kanggo optimasi sing terus lumaku

---

**Sabanjure:** [Wulangan 10: Dina Peluncuran](lesson-10-launch) -- daftar priksa sadurunge peluncuran lan wiwit live.
