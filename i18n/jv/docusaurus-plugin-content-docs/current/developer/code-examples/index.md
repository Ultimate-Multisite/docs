---
title: Tuladha Kode Tingkat Lanjut
sidebar_position: 1
...
Loro panjaluk bebarengan bisa maca nilai sing padha lan loro-lorone nulis bali asil sing wis ditambahake sing padha, saéngga kelangan siji itungan. `increment_item()` masrahake aritmetika marang mesin basis data nganggo siji pratelan `UPDATE ... SET column = column + ?`, nggawe operasi kasebut kanthi alami atomik.
