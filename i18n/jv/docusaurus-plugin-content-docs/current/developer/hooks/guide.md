---
title: Pandhuan Panggunaan Hooks
sidebar_position: 1
...
### Siklus Urip Pelanggan {#customer-lifecycle}

#### Sawisé Pelanggan Digawe {#after-customer-creation}
...
#### Owah-owahan Status Pelanggan {#customer-status-change}
...
#### Sawisé Situs Dipublikasi {#after-site-published}
...
#### Sadurungé Penerapan Template {#before-template-application}
...
### Hooks Keanggotaan {#membership-hooks}
...
### Hooks Pembayaran {#payment-hooks}

#### Pembayaran Rampung / Gagal {#payment-completed--failed}
...
#### Sadurungé Diproses / Sawisé Rampung {#before-processing--after-completion}
...
### Filter Rega {#pricing-filters}

#### Total Kréta {#cart-total}
...
### Field Formulir Checkout {#checkout-form-fields}
