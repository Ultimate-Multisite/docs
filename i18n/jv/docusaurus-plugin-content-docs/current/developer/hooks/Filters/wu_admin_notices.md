---
id: wu_admin_notices
title: Saringan - wu_admin_notices
...
|------|------|-------------|
| $notices | `array` | Dhaptar wara-wara kanggo panel tartamtu kuwi. |
| $all_notices | `array` | Dhaptar wara-wara sing ditambahake, dipisahake miturut panel. |
| $panel | `string` | Panel kanggo njupuk wara-wara. |
