...
### 1. Dapatkan Kredensial API ServerPilot Sampeyan {#1-get-your-serverpilot-api-credentials}
...
### 2. Dapatkan App ID Sampeyan {#2-get-your-app-id}
...
### 3. Tambah Konstanta menyang wp-config.php {#3-add-constants-to-wp-configphp}
