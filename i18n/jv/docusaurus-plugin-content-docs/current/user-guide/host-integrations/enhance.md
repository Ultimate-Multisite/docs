...
---
# Nambah Integrasi Control Panel {#enhance-control-panel-integration}
...
## Nggoleki Kredensial API Sampeyan {#getting-your-api-credentials}
...
### 2. Entuk Organization ID Sampeyan {#2-get-your-organization-id}
...
### 3. Entuk Server ID Sampeyan {#3-get-your-server-id}
...
### 4. Entuk API URL Sampeyan {#4-get-your-api-url}
...
### Konstanta sing Diwajibake {#required-constants}
...
### Setup liwat Integration Wizard {#setup-via-integration-wizard}
...
### Nalika Domain Dipet {#when-a-domain-is-mapped}
...
## Referensi API (API Reference) {#api-reference}
...
### Endpoint Umum sing Digunakake {#common-endpoints-used}
