...
---
# Migrasi Mode Pihak Ketiga (Third-Party Mode Migration) {#third-party-mode-migration}
...
## Sapa Sing Kena Dampak? {#who-is-affected}
...
### Instalasi Sing Wis Ana {#existing-installations}
...
### Versi WordPress Sadurunge 7.0 {#wordpress-versions-before-70}
...
## Ngerti Mode-Mode Kasebut {#understanding-the-modes}
...
## Mengecek Mode Kamu Sekarang {#checking-your-current-mode}
...
## Mengubah Mode Kamu {#changing-your-mode}
...
### Manajemen Lebih Gampang {#simplified-management}
...
### Performa Luwih Apik {#better-performance}
...
### Yen sampeyan lagi nganggo WordPress 6.x {#if-youre-on-wordpress-6x}
...
### Yen sampeyan lagi nganggo WordPress 7.0+ {#if-youre-on-wordpress-70}
...
### Kemampuan ora muncul pas mode auto {#abilities-arent-loading-in-auto-mode}
...
### Aku pengin tetep nganggo mode legacy {#i-want-to-keep-legacy-mode}
...
### Kemampuan kustomku ora muncul {#my-custom-abilities-arent-showing}
...
### Aku dapat notifikasi "ability tidak diklasifikasikan" {#im-getting-unclassified-ability-notices}
