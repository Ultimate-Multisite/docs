...
Saka kono, sampeyan bisa akses halaman **System Emails** kanggo ndelok kabeh templat email.

![System Emails list](/img/admin/system-emails-list.png)

Sampeyan uga bisa ngedit templat email per individu nganggo editor email sistem:
...
Kanggo impor templat email anyar:

1. Tuju menyang halaman **System Emails**
2. Klik tombol **Reset & Import** ing pucuk halaman
...
1. **Hapus lan impor maneh** — Hapus email sistem lan impor maneh (iki bakal ngapus data ukur pengiriman).
2. **Reset liwat alat** — Gunakake alat **Reset & Import**, onokake opsi **Reset**, lan pilih email sing arep di-*reset*.

Opsi Reset luwih disaran amarga iki njaga data ukur pengiriman (*send metrics*) lan metadata liyane nalika konten *default* dipulihake.
