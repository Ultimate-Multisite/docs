...
## Instalasi Plugin {#installing-the-plugin}
...
### Pamariksaan Pra-instalasi {#pre-install-checks}
...
### Perusahaan Sampeyan {#your-company}
...
### Konten Standar {#default-content}
...
### Plugin Sing Disaranake {#recommended-plugins}
