...
## Langkah 1: Selamat Datang (Welcome)
...
## Langkah 2: Konfigurasi Jaringan (Network Configuration)
...
### Wizard ngomong `wp-config.php` ora bisa ditulis
...
### Situs ora bisa diakses sawise setup (subdomain)
...
### Masalah otentikasi sawise setup
...
### Salah siji langkah gagal nalika instalasi
