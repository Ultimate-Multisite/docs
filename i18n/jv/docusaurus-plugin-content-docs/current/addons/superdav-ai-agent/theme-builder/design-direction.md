...
| Piranti | Ambane | Pratinjau |
|--------|-------|---------|
| **Mobile** | 375px | Telpon potret |
...
- **Verifikasi kontras** — gunakake [Validasi Kontras Palet](../abilities/validate-palette-contrast.md) kanggo aksesibilitas
...
- [Validasi Kontras Palet](../abilities/validate-palette-contrast.md) — priksa aksesibilitas werna
- [Gawe Logo SVG](../abilities/generate-logo-svg.md) — nggawe logo khusus
