...
---
# Filtru: wu_wp_config_reference_hook_line_patterns {#filter-wuwpconfigreferencehooklinepatterns}

Aħna niċċekkjaw tliet mudelli meta nippruvaw insibu fejn nistgħu ndaħħlu l-kostanti tagħna:
...
Iddefinit f’[`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) fil-linja 143
