...
|------|------|-------------|
| $notices | `array` | Lista ta' notifiki għal dak il-panel partikolari. |
| $all_notices | `array` | Lista ta' notifiki miżjuda, separati skont il-panel. |
| $panel | `string` | Panel biex jiġu rkuprati n-notifiki. |
