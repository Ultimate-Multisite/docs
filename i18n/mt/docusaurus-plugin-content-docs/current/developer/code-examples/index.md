---
title: Eżempji Avvanzati ta' Kodiċi
sidebar_position: 1
...
Żewġ talbiet simultanji jistgħu jaqraw l-istess valur u t-tnejn jiktbu lura l-istess riżultat inkrementat, u b'hekk jintilef għadd wieħed. `increment_item()` jiddelega l-aritmetika lill-magna tad-database b'dikjarazzjoni waħda `UPDATE ... SET column = column + ?`, u jagħmel l-operazzjoni intrinsikament atomika.
