---
title: Kif tibda bl-iżvilupp ta’ Addon
sidebar_position: 1
...
```
my-addon/
├── my-addon.php                 # Fajl ewlieni tal-estensjoni
├── inc/
│   ├── class-my-addon.php       # Klassi ewlenija taż-żieda
│   ├── admin-pages/             # Interfaċċa tal-amministrazzjoni
│   ├── models/                  # Mudelli tad-dejta personalizzati
│   └── integrations/            # Integrazzjonijiet ta’ partijiet terzi
├── assets/
│   ├── js/
│   └── css/
...
- Uża l-[Mudell tal-Addon](/addons/addon-template) bħala scaffold inizjali
