---
title: Ttrasliż tal-Ultimate Multisite
sidebar_position: 19
...
Dan huwa sistema tat-traduzzjoni standard tal-komunità ta WordPress. Meta l-traduzzjonijiet jilħqu għal threshold ta approvizzjoni addejjat, huma jiġu distribwiti awtomatikament għall-koll tal-utenti ta Ultimate Multisite permezz tal-aggiornamenti tal-plugin ta WordPress.

**Nifuna bżonn għallna!** Jekk tħaddem b'lingwa oħra min l-Ingliż, jidherja li tfattah kontributi tal-traduzzjoni. Meta traduzzjonijiet qasira hija tfidiq. Biex tibda:

1. Visita [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/ultimate-multisite/)
2. Sigla l-lingwa tiegħek
3. Iċċakka "Contribute Translation" (Kontribuis Traduzzjoni)
4. Tiddir bżonn kont WordPress.org free
...
1. הורד את Poedit מ-[poedit.net](https://poedit.net)
2. פתח את קובץ ה`.pot` מתוך `wp-content/plugins/ultimate-multisite/lang/`
3. תרגם את המחרוזות (strings) בממשק של Poedit
