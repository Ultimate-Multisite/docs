...
### 1. Iġib il-Credentials API tal-Cloudways {#1-get-your-cloudways-api-credentials}
...
### 2. Iġib id-Server u l-Application IDs tiegħek {#2-get-your-server-and-application-ids}
...
## Come Funziona (How It Works) {#how-it-works}

### Sincronizzazzjoni tal-Domini (Domain Syncing) {#domain-syncing}
...
### Ażżurament tal-Certifikat SSL (SSL Certificate Management) {#ssl-certificate-management}
...
## Domini Esterni (Extra Domains) {#extra-domains}
...
## Importanti — Il-Pitfall ta SSL Wildcard {#important--wildcard-ssl-pitfall}
...
### Setup SSL Rekommandi ta Cloudways għal rete Ultimate Multisite {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
## Problemi biex tiġi sorwali (Troubleshooting) {#troubleshooting}

### Problemi bejn konnessjoni API {#api-connection-issues}
...
### Problemi Certifikat SSL {#ssl-certificate-issues}
...
### Domini Mġobbien {#domain-not-added}
