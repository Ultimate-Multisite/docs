...
## Istruzzjonijiet ta l-setup

### 1. Ottien il-Credentials tal-cPanel tiegħek
...
### 2. Aggiungi i Konstanti għal wp-config.php
...
### Addon Domains (Dominji Aggiuntivi)
...
### Problemi maħsori (SSL Certificate Issues)
