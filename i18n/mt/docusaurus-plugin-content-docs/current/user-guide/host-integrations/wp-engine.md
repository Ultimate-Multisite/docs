...
## Istruzzjonijiet ta' Isettabbilizzjoni (Setup) {#setup-instructions}

### 1. Verifika il-Plugin ta' WP Engine {#1-verify-wp-engine-plugin}
...
### 2. Attiva l-Integrà {#2-enable-the-integration}
...
### Sinc tal-Domain {#domain-syncing}
...
## Nota Importanti {#subdomain-support}

### Domini Wildcard (Wildcard Domains) {#important-notes}
...
### Certifikat SSL {#wildcard-domains}
...
## Problemi (Troubleshooting) {#ssl-certificates}

### Problemi ma jkunx jinkludi l-API {#troubleshooting}
...
### Domain ma jkunx jinkludi {#api-connection-issues}
...
### Problemi subdomini {#domain-not-added}
