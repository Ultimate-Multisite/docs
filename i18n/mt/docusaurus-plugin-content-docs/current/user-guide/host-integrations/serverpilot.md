...
## Istruzzjonijiet ta' Isettabbilizzazzjoni {#setup-instructions}

### 1. Iġib il-Credentials tal-API ta' ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Iġib l-App ID tiegħek {#2-get-your-app-id}
...
### 4. Iżgħal l-Integrazzjoni {#4-enable-the-integration}
...
### Sincronizzazzjoni tal-Domain {#domain-syncing}
...
### Aġġustament tal-Certifikat SSL (SSL Certificate Management) {#ssl-certificate-management}
...
## Verifikazzjoni tal-Certifikat SSL (SSL Certificate Verification) {#ssl-certificate-verification}
...
### Problemi ta Konezzjoni API (API Connection Issues) {#api-connection-issues}
...
### Problemi tal-Certifikat SSL (SSL Certificate Issues) {#ssl-certificate-issues}
...
### D-Dominio Ma Għda (Domain Not Added) {#domain-not-added}
...
### Aġġuri tad-domeni (Domain Removal) {#domain-removal}
