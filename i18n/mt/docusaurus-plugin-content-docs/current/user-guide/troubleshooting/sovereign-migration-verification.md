...
### Grantijiet tal-database ma jidukqux mal-host
...
### Bedrock jew installazzjonijiet lokali ma jistgħux jiġu konnessi
...
### Il-async push queue ma jiġi sfumata (drain)
...
### Il-numru ta'utenti tal-tenant huwa xieq
