---
title: Il-ġestjoni tal-email sistemi
sidebar_position: 13
...
Minħabba dan, tista' tipprovvidi għall-pagina **System Emails** biex tara kull template ta l-email.

![System Emails list](/img/admin/system-emails-list.png)

Tista' tustomizza wkoll templates ta l-email individwali biex tista' uża l-editor tal-email systemiku:
...
Biex ti importi templates ta l-email ġodda:

1. Irrivi għall-pagina **System Emails**
2. Iċ클ik fuq bix-xojr **Reset & Import** f'top tal-pagina
...
1. **Elimina u riimporta** — Elimina l-email systemiku u importali għal-ġdid (dan jiddeleb metrics ta l-invitazzjoni)
2. **Resetta tramite il tool** — Uża il-tool **Reset & Import**, attiva l-opzjoni **Reset**, u sseħħi l-email li tista' traddem

L-opzjoni Reset hija preferita biex tiġi rispettata metrics ta l-invitazzjoni u metadata oħra wa jgħidha l-kontenut difiċjar.
