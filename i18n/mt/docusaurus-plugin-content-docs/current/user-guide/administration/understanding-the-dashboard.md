...
Dan widget jgħid dwar l-eventi li qed jiġu avvenuti f'Ultimate Multisite. L-eventi inklużi iscrizioni, annullamenti, kreaw siti, eliminazzjonijiet u aktar operazzjonijiet.
...
Il-perjodu ta'data jgovern il-perjodu tal-informazzjoni li tura bil-widget li qabel, inklu rapportann, membership ewlieni, registrazzjonijiet b'pajjiż, registrazzjonijiet b'form u is-siti li żieru flimkien.

![Dashboard statistics widgets](/img/admin/um-dashboard-stats.png)

:::tip
Biex jgħandu il-widget **Most Visited Sites**, attivaw l-counting tal-visita f **Ultimate Multisite → Settings → Sites → Enable Visits Limitation and Counting**.
:::
