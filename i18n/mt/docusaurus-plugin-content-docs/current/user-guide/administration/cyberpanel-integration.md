...
## Istruzioni per l'installazione (Setup Instructions) {#setup-instructions}

### 1. Abilita l'API di CyberPanel {#1-enable-the-cyberpanel-api}
...
### 2. Aggiungi le Costanti a wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Abilita l'Integrazione {#3-enable-the-integration}
...
### 4. Verifica la Connessione {#4-verify-connectivity}
...
## Referenza ta Konfigurazzjoni {#configuration-reference}
...
## Problemi taċċettar (Troubleshooting) {#troubleshooting}
