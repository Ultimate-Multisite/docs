...
## Exportazzjoni tal-network kollha
...
#### Generazzjoni ta Network Import Bundle
...
#### Restawli min Network Import Bundle
...
## Installazzjoni ta ZIP esportat li jiddebit biex jiġi boot (self-booting export ZIP)
