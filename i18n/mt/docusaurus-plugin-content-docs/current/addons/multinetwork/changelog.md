---
title: Reġistru tal-bidliet ta’ Multi-Netwerk
sidebar_position: 99
...
* Ġdid: Klonazzjoni tal-media tan-netwerk — il-media tas-sit tiġi duplikata b'mod korrett meta jiġu klonati netwerks minn mudell.
* Tiswija: Il-klonazzjoni tan-netwerk issa taħdem mingħajr l-add-on ta' multi-tenancy; il-privileġġi ta' super admin jerġgħu jingħataw wara l-klonu.
* Tiswija: Il-ħolqien tan-netwerk issa huwa kompatibbli ma' WooCommerce u l-gateways kollha tal-ħlas.
* Tiswija: In-numru tal-port issa huwa inkluż fil-ġenerazzjoni tad-domain fallback.
* Tiswija: Is-CSS tal-għażla tal-mudell tmexxa għal stylesheet enqueued għal rendering korrett fuq it-themes kollha.
