---
title: Reġistru tal-Bidliet tal-Pjanijiet Imkejla
sidebar_position: 99
...
- Ġdid: infurzar tal-konnettur mibni mill-ġdid b’skoperta dinamika tal-limiti u write-through, biex tiġi żgurata preċiżjoni f’ħin reali fuq il-konnetturi kollha
- Tiswija: l-aġġornamenti tat-tabelli tad-database issa huma allinjati b’mod korrett mad-definizzjonijiet tal-iskema BerlinDB, u jipprevjenu fallimenti ta’ aġġornament fuq installazzjonijiet ġodda
- Tiswija: callbacks tal-aġġornament tad-database ikkonvertiti għall-format korrett, u jsolvu fallimenti siekta tal-aġġornament
- Tiswija: valuri frazzjonali issa huma aċċettati fil-field tal-input AI Usage Overage Markup
...
* Ġenerazzjoni awtomatika tal-fatturi
