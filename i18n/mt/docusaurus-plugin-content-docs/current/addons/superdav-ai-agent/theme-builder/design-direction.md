...
- **Kulur primarju** — il-kulur prinċipali tal-marka użat għal buttuni, links, u aċċenti
- **Kulur sekondarju** — kulur komplementari għall-varjetà
- **Kulur ta' aċċent** — kulur ta' enfasi għal elementi importanti
...
- **Font tal-intestaturi** — użat għat-titli tal-paġni u l-intestaturi tas-sezzjonijiet
- **Font tal-korp** — użat għat-test tal-paragrafi u l-kontenut
- **Daqsijiet tal-font** — daqsijiet reattivi għal daqsijiet differenti tal-iskrin
...
- Menu tan-navigazzjoni sħiħ
- Layout komplut bil-kolonni kollha
...
- Navigazzjoni reattiva (menu hamburger)
- Layout b'kolonna waħda
...
| Apparat | Wisa' | Preview |
|--------|-------|---------|
| **Mobile** | 375px | Telefown vertikali |
| **Tablet** | 768px | Tablet orizzontali |
...
1. **Taġġusta l-kuluri** — ibdel kwalunkwe kulur fil-paletta
2. **Tbiddel il-fonts** — agħżel typefaces differenti
3. **Timmodifika l-ispazjar** — aġġusta l-padding u l-marġini
...
- Il-preview tad-desktop jiġi aġġornat minnufih
- Il-preview tal-mobile jiġi aġġornat minnufih
...
- **Disinn oriġinali** — ara x'inbidel
...
1. **Irrevedi ż-żewġ previews** — ivverifika li d-desktop u l-mobile jidhru tajbin
2. **Iċċekkja l-kuluri kollha** — żgura kuntrast u aċċessibbiltà
3. **Ittestja t-tipografija** — ivverifika l-leġġibbiltà fid-daqsijiet kollha
...
1. Theme Builder jiġġenera t-theme kompluta tiegħek
2. It-theme tiġi installata fuq is-sit WordPress tiegħek
...
- **Ivverifika l-kuntrast** — uża [Ivvalida l-Kuntrast tal-Paletta](../abilities/validate-palette-contrast.md) għall-aċċessibbiltà
...
- [Ivvalida l-Kuntrast tal-Paletta](../abilities/validate-palette-contrast.md) — iċċekkja l-aċċessibbiltà tal-kulur
- [Iġġenera Logo SVG](../abilities/generate-logo-svg.md) — oħloq logos personalizzati
