---
title: 'Lezzjoni 10: Jum it-Tnedija'
sidebar_position: 11
...
- [ ] Il-mappjar tad-domain jaħdem -- ittestja billi toħloq sit u timmappja domain personalizzat
...
- [ ] L-immaġnijiet kollha għandhom liċenzja xierqa (l-ebda watermarks ta' ritratti stock)
- [ ] Ir-risponsività fuq il-mobile taħdem fuq kull paġna tal-mudell
...
- [ ] Il-prezzijiet huma korretti (kull xahar u annwali)
- [ ] It-tariffi tas-setup huma kkonfigurati fuq il-pjanijiet it-tajba
- [ ] Il-perjodu ta' prova jaħdem fuq il-pjan Starter
...
- [ ] Il-klijent jirċievi email ta' merħba wara r-reġistrazzjoni
- [ ] Sit ġdid jinħoloq bil-mudell korrett
...
- [ ] L-emails kollha tas-sistema jużaw il-branding ta' FitSite u lingwa speċifika għall-fitness
...
- [ ] Is-sekwenza tal-email ta' merħba hija kkonfigurata u ttestjata
...
- [ ] Il-politika ta' rifużjoni hija definita u ddokumentata
- [ ] L-entità tan-negozju hija stabbilita biex tirċievi pagamenti
...
- Feedback onest dwar l-esperjenza tar-reġistrazzjoni u tal-onboarding
- Permess biex tuża s-sit tagħhom bħala eżempju ta' showcase
- Rappurtar ta' kwalunkwe bugs jew problemi li jiltaqgħu magħhom
...
- Aqleb il-gateway tal-ħlas għall-modalità live
- Ippubblika s-sit tal-marketing tiegħek
...
1. **Aqleb għal pagamenti live** -- iddiżattiva l-modalità ta' test fuq il-gateway tal-ħlas tiegħek
2. **Ivverifika darba oħra** -- agħmel reġistrazzjoni ta' test kompluta b'ħlas reali (irrimborsa lilek innifsek wara)
3. **Immonitorja mill-qrib** -- oqgħod attent għal żbalji, reġistrazzjonijiet falluti, jew problemi ta' ħlas
...
- **Problemi bil-gateway tal-ħlas**: Żomm il-kuntatt tal-appoġġ tal-fornitur tal-gateway tiegħek lest
- **Problemi biċ-ċertifikat SSL**: Kun af kif tiċċekkja u ġġedded iċ-ċertifikati
- **Fallimenti fil-kunsinna tal-email**: Ittestja li l-emails tassew jaslu (iċċekkja l-folders tal-ispam)
...
- **Proċeduri għal jum it-tnedija** biex tniedi live b'kunfidenza
- **Pjan ta' kontinġenza** għal problemi komuni ta' jum it-tnedija

---

**Li jmiss:** [Lezzjoni 11: Kif Issib Klijenti](lesson-11-customers) -- issa li FitSite huwa live, kif iġġib lis-sidien ta' studios tal-fitness biex jirreġistraw?
