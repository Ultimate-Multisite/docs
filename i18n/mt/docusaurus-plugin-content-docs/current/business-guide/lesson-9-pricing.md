---
title: 'Lezzjoni 9: Ipprezzar għall-Qligħ'
sidebar_position: 10
...
- Sit web professjonali għall-fitness li kieku jiswa $2,000-$5,000 biex jinbena apposta
- Manutenzjoni kontinwa, aġġornamenti, u sigurtà li ma jkollhomx għalfejn jaħsbu dwarhom
- Karatteristiċi speċifiċi għan-niċċa li bennejja ġeneriċi ma joffrux
- Il-kredibbiltà ta’ pjattaforma mibnija għall-industrija tagħhom
...
- **Li jimpjega żviluppatur tal-web**: $2,000-$5,000 bil-quddiem + $50-$100/xahar manutenzjoni
- **Wix/Squarespace**: $16-$45/xahar iżda mingħajr karatteristiċi speċifiċi għall-fitness, jibnuh huma stess
- **Li ma jagħmel xejn**: Membri mitlufa li ma jistgħux isibuhom online
...
| Pjan | Kull xahar | Annwali (fix-xahar) | Total Annwali | Tfaddil |
|------|---------|-------------------|--------------|---------|
| Starter | $49/xahar | $39/xahar | $468/sena | 20% skont |
| Growth | $99/xahar | $79/xahar | $948/sena | 20% skont |
| Pro | $199/xahar | $159/xahar | $1,908/sena | 20% skont |
...
- **Starter**: L-ebda tariffa ta’ setup (neħħi l-ostakli għad-dħul)
- **Growth**: Tariffa ta’ setup ta’ $99 (tkopri konfigurazzjoni ta’ domain personalizzat u konsultazzjoni inizjali)
- **Pro**: Tariffa ta’ setup ta’ $299 (tkopri setup għal postijiet multipli u telefonata ta’ onboarding)
...
- **Prova b’xejn ta’ 7 ijiem** fuq il-pjan Starter biss
- L-ebda prova fuq Growth u Pro (dawn il-klijenti huma aktar impenjati u jistennew li jħallsu)
...
- **FITLAUNCH** -- 30% skont għall-ewwel 3 xhur (għal promozzjoni tat-tnedija)
- **ANNUAL20** -- 20% skont fuq pjanijiet annwali (jekk mhumiex diġà skontati)
- **REFERRAL** -- Xahar b’xejn (għal referenzi tal-klijenti)

Mur għal **Ultimate Multisite > Kodiċijiet ta’ Skont** biex toħloqhom. Ara [Il-Ħolqien ta’ Kodiċijiet ta’ Skont](/user-guide/configuration/creating-discount-codes) għall-gwida sħiħa.
...
1. Ikkonfigura r-rati tat-taxxa f’**Ultimate Multisite > Settings > Taxes**
2. Applika kategoriji tat-taxxa għall-pjanijiet tiegħek
3. Kun żgur li l-invoices juru t-taxxa b’mod korrett
...
- **Rata ta’ konverżjoni skont il-pjan**: Jekk Starter jikkonverti tajjeb iżda Growth le, id-distakk bejniethom jista’ jkun kbir wisq
- **Rata ta’ titjib għal pjan ogħla**: Jekk ftit klijenti jitilgħu minn Starter għal Growth, il-pjan Growth jista’ ma joffrix biżżejjed valur addizzjonali
...
- **Perjodu ta' prova** fuq il-pjan tal-livell bażiku biex titnaqqas il-frizzjoni tar-reġistrazzjoni
- **Kodiċijiet ta' skont strateġiċi** għat-tnedija, referenzi, u kampanji
- **Konfigurazzjoni tat-taxxa** għal billing konformi
- **Qafas ta' reviżjoni tal-ipprezzar** għal ottimizzazzjoni kontinwa

---

**Li jmiss:** [Lezzjoni 10: Jum it-Tnedija](lesson-10-launch) -- il-lista ta' kontroll ta' qabel it-tnedija u l-pubblikazzjoni.
