...
## Conheça os Seus Números {#know-your-numbers}
...
### Migração de Alojamento {#hosting-migration}
...
## Automatizar Operações {#automating-operations}
...
### Automação de Email {#email-automation}
...
## Aumentar a Receita {#increasing-revenue}

O crescimento não se resume a mais clientes. Também se trata de mais receita por cliente.

### Upselling para Clientes Existentes {#upselling-existing-customers}
...
### Aumentar Preços {#raising-prices}
...
## Construir uma Equipa {#building-a-team}
