...
Filtra o conjunto padrão de dados do utilizador a exportar/importar.

## Parâmetros

| Nome | Tipo | Descrição |
|------|------|-------------|
| $custom_user_data | `array` | O array de dados personalizados do utilizador. |
