...
Disparado quando uma compra de domínio está a ser processada após a conclusão do checkout.
...
| $checkout_data | `array&lt;string,mixed&gt;` | Dados completos do checkout do formulário de inscrição. |
