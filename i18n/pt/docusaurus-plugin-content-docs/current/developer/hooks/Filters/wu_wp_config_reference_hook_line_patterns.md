...
Verificamos três padrões ao tentar perceber onde podemos injetar as nossas constantes:
...
Definido em [`inc/helpers/class-wp-config.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/helpers/class-wp-config.php#L143) na linha 143
