...
Filtra os metadados antes de serem serializados para serem armazenados na base de dados.

## Parâmetros {#parameters}

| Nome | Tipo | Descrição |
|------|------|-------------|
| $meta | `array` | Os metadados que serão armazenados, não serializadosserializados. |
