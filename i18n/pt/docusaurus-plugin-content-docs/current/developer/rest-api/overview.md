...
---
# Referência da REST API {#rest-api-reference}
...
### 3. API de associações {#3-memberships-api}
...
## Ponto de extremidade de registo {#registration-endpoint}
...
## Pontos de extremidade de locatários soberanos {#sovereign-tenant-endpoints}
