...
## Modelo de Ficheiro Principal do Addon
...
## Integração de Página de Administração
...
### URLs de SSO e gestão do site principal
...
### Criação automática de registos de domínio
