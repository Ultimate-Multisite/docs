...
- Verifique sempre as assinaturas de webhook usando HMAC ou um segredo partilhado
- Use um `permission_callback` na sua rota REST — nunca o defina como `__return_true` em produção
- Valide e sanitize todos os dados de payload recebidos antes de agir sobre eles
- Devolva códigos de estado HTTP apropriados (200 para sucesso, 400 para pedidos inválidos)
