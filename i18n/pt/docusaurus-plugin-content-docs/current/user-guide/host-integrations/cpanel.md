...
---
# Integração com cPanel {#cpanel-integration}
...
### 1. Obtenha suas Credenciais do cPanel {#1-get-your-cpanel-credentials}
...
### 2. Adicione as Constantes ao wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Habilite a Integração {#3-enable-the-integration}
...
### Subdomínios (Subdomains) {#subdomains}
