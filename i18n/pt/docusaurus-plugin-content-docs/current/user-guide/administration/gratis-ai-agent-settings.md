...
### Aceder aos sinalizadores de funcionalidades

1. No administrador do WordPress, vá a **Gratis AI Agent → Configurações**.
2. Clique no separador **Sinalizadores de funcionalidades**.

### Sinalizadores de controlo de acesso
...
### Sinalizadores de Segurança da Automatização
