...
## Habilitando a Busca na Internet {#enabling-internet-search}
...
### Obtendo uma Chave de API do Brave Search {#obtaining-a-brave-search-api-key}
...
### Obtendo uma Chave de API do Tavily {#obtaining-a-tavily-api-key}
...
## Desabilitando a Busca na Internet {#disabling-internet-search}
