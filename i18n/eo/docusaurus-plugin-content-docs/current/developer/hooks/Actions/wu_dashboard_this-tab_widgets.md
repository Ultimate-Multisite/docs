...
title: 'Ago - wu_dashboard_{$this->tab}_widgets'
...
Permesas al programistoj de plugin aldoni fenestraĵojn al la Reta Dashboard-panelo.
...
Difinita en [`inc/admin-pages/class-dashboard-admin-page.php`](https://github.com/Ultimate-Multisite/ultimate-multisite/blob/main/inc/admin-pages/class-dashboard-admin-page.php#L214) ĉe linio 214
