...
Du samtempaj petoj povas legi la saman valoron kaj ambaŭ reskribi la saman pliigitan rezulton, perdante unu kalkulon. `increment_item()` delegas la aritmetikon al la datumbaza motoro per unu sola instrukcio `UPDATE ... SET column = column + ?`, igante la operacion esence atoma.
