...
### Aliri Funkciajn Flagojn

1. En la WordPress-administrilo, iru al **Gratis AI Agent → Agordoj**.
2. Alklaku la langeton **Funkciaj Flagoj**.

### Alirkontrolaj Flagoj
