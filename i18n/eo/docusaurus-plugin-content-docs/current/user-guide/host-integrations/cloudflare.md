...
### 1. Akcepte Vian Cloudflare API-Clavon
...
### 3. Aggivi Konstantaĵojn al wp-config.php
...
## Nomenoj Personalisaj de Cloudflare (Cloudflare Custom Hostnames)
...
### Kiel ĝi diferencas de la standarda integracio
...
### Montado de Nomenoj Personalisaj de Cloudflare
...
## Problemofankto (Troubleshooting)
