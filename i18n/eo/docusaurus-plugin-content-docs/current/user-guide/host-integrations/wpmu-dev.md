...
---
# Integrado WPMU DEV {#wpmu-dev-integration}
...
## Monti Instruoj {#setup-instructions}

### 1. Verifi WPMU DEV Aloĝadon {#1-verify-wpmu-dev-hosting}
...
### 2. Aktivuji la Integracion {#2-enable-the-integration}
...
### SSL-Sertifikatoj Laĉo {#ssl-certificate-management}
...
### Domeno Eliminado {#domain-removal}
...
### API Autentigo {#api-authentication}
...
### Problemo kun API Konektado {#api-connection-issues}
...
### Problemo kun SSL Certifoj {#ssl-certificate-issues}
