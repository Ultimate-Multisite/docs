...
## Kion Ĝi Farakteras {#what-it-does}
...
## Konfigurado (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Verifigi la Montadon {#verifying-setup}
...
## Ekzemplo API-vokado (cURL) {#example-api-call-curl}
...
## Problemoj resolviĝo (Troubleshooting) {#troubleshooting}
