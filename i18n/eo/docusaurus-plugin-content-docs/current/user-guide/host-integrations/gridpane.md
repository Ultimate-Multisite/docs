...
### 1. Akcepte Vian GridPane API Credencojn
...
### 2. Akcepte Vian Server kaj Site ID'n
...
### 3. Aggigev Vian Konstanto al wp-config.php
...
## Maneĝo de la Konstanto SUNRISE
...
## Problemaĵoj (Troubleshooting)

### Problemojn kun konekto per API
...
### Problemojn kun sertifikato SSL
