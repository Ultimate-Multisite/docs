...
### 1. Akcepte Vian Cloudways API Credencojn {#1-get-your-cloudways-api-credentials}
...
### 2. Akcepte Vian Servern kaj Aplikaĵn Identigojn {#2-get-your-server-and-application-ids}
...
### 3. Ado de Konstantaĵoj al wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Aktivi la Integretan {#4-enable-the-integration}
...
### Domeno Sincronado {#domain-syncing}
...
### SSL-Sertifikato Administrado {#ssl-certificate-management}
...
## Importanta — Kriso pri Wildcard SSL {#important--wildcard-ssl-pitfall}
...
### Rekomandita Cloudways SSL montro por Ultimate Multisite reto {#recommended-cloudways-ssl-setup-for-an-ultimate-multisite-network}
...
## Problemoj pri diagnostiko {#troubleshooting}
...
### Problemajn kun SSL Sertifikatoj {#ssl-certificate-issues}
