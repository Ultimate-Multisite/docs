...
## Cap Captcha: Memgastigata protekto, kiu simple funkcias {#cap-captcha-self-hosted-protection-that-just-works}
...
## WooCommerce protekto kontraŭ karttestado {#woocommerce-card-testing-protection}
...
## Ĉu ankoraŭ bezonas Google reCAPTCHA aŭ hCaptcha? {#still-need-google-recaptcha-or-hcaptcha}
...
## Konstruita por skalo {#built-for-scale}
...
## Ĉu mi bezonas konfiguri ion? {#do-i-need-to-configure-anything}
...
## Ĉu mi bezonas API-ŝlosilojn por Cap Captcha? {#do-i-need-api-keys-for-cap-captcha}

Ne. Cap Captcha estas tute memgastigata. Neniuj eksteraj kontoj, neniu domajna registrado, neniuj agordaj kapdoloroj.

## Ĉu ĉi tio malrapidigos mian checkout? {#will-this-slow-down-my-checkout}

Cap Captcha estas nur 20KB kaj rulas pruvo-de-laborajn defiojn fone. Viaj klientoj ne rimarkos ajnan prokraston.

## Ĉu ĉi tio protektas kontraŭ karttestaj atakoj? {#does-this-protect-against-card-testing-attacks}
...
## Ĉu mi povas uzi malsamajn captcha-provizantojn ĉe malsamaj retejoj? {#can-i-use-different-captcha-providers-on-different-sites}

La captcha-provizanto estas agordita tutrete, sed vi povas alĝustigi malfacilecajn agordojn laŭ viaj bezonoj.

## Ĉu ĉi tio konformas al GDPR? {#is-this-gdpr-compliant}
...
## Imposta limigado {#rate-limiting}
...
### Etendebleco {#extensibility}

#### IP-permeslista filtrilo {#ip-whitelist-filter}
...
#### Antaŭbloka ago {#pre-block-action}
...
## Klienta IP-detekto kaj fidindaj prokuriloj {#client-ip-detection--trusted-proxies}
...
#### Fido al Cloudflare Header {#cloudflare-header-trust}
...
#### Agordo de Fidata Prokurilo {#trusted-proxy-configuration}
...
#### Aŭtomata Detekto ĉe Unua Ebligo {#first-enable-auto-detection}
...
### Kial Ĉi Tio Gravas {#why-this-matters}
