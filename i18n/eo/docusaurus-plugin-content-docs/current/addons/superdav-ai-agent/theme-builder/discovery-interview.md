...
|--------|-----------|---------|
| **JPEG** | `.jpg`, `.jpeg` | Rekomendita por fotoj |
| **PNG** | `.png` | Subtenas travideblecon |
...
- **Kolorpaletro** — dominaj koloroj estas eltiritaj kaj uzataj en la etoso
- **Vida stilo** — moderna, rustika, minimumisma, vigla, ktp.
- **Humoro kaj atmosfero** — profesia, kreiva, amika, luksa, ktp.
...
- **Humortabuloj** — kolektoj de bildoj reprezentantaj vian deziratan estetikon
- **Produktaj fotoj** — se vi havas produktojn por montri
...
- **Tekst-pezaj bildoj** — ekrankopioj kun multe da teksto
...
3. **Inkluzivu variecon** — miksaĵo de koloro, stilo kaj temo
...
- **Kolorpaletro** — ĉefaj, duarangaj kaj akcentaj koloroj
- **Tipografio** — tiparfamilioj por titoloj kaj korpa teksto
- **Aranĝa stilo** — interspacado, vicigo kaj komponanta aranĝo
...
1. Reviziu la generitan dezajnan direkton
2. Provizu reagojn aŭ petu ĝustigojn
...
- [Iloj kaj Agordo](./tools.md) — disponeblaj iloj kaj agordaj opcioj
