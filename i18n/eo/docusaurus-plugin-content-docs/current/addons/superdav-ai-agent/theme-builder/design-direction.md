...
- **Ĉefa koloro** — ĉefa markokoloro uzata por butonoj, ligiloj kaj akcentoj
- **Duaranga koloro** — kompletiga koloro por varieco
- **Akcenta koloro** — emfaza koloro por gravaj elementoj
...
- **Titola tiparo** — uzata por paĝotitoloj kaj sekciaj kapoj
- **Korpa tiparo** — uzata por alineoteksto kaj enhavo
- **Tipargrandoj** — respondema grandigo por malsamaj ekrangrandoj
...
- **Piktogramoj** — piktograma stilo kaj grandigo
...
- Plena naviga menuo
- Kompleta aranĝo kun ĉiuj kolumnoj
...
- Respondema navigado (hamburga menuo)
- Unukolumna aranĝo
...
| Aparato | Larĝo | Antaŭvido |
|--------|-------|---------|
| **Poŝtelefono** | 375px | Vertikala telefono |
| **Tabulkomputilo** | 768px | Horizontala tabulkomputilo |
...
1. **Alĝustigi kolorojn** — ŝanĝu ajnan koloron en la paletro
2. **Ŝanĝi tiparojn** — elektu malsamajn tiparojn
3. **Modifi interspacadon** — alĝustigu internajn kaj eksterajn marĝenojn
...
- Labortabla antaŭvido tuj ĝisdatiĝas
- Poŝtelefona antaŭvido tuj ĝisdatiĝas
...
- **Origina dezajno** — vidu kio ŝanĝiĝis
...
1. **Reviziu ambaŭ antaŭvidojn** — kontrolu ke labortablo kaj poŝtelefono aspektas bone
2. **Kontrolu ĉiujn kolorojn** — certigu kontraston kaj alireblecon
3. **Testu tipografion** — kontrolu legeblecon ĉe ĉiuj grandoj
...
1. Theme Builder generas vian kompletan theme
2. La theme estas instalita sur via WordPress site
...
- **Kontrolu kontraston** — uzu [Validigi Paletran Kontraston](../abilities/validate-palette-contrast.md) por alirebleco
...
- [Validigi Paletran Kontraston](../abilities/validate-palette-contrast.md) — kontrolu koloran alireblecon
- [Generi Logo SVG](../abilities/generate-logo-svg.md) — kreu proprajn emblemojn
