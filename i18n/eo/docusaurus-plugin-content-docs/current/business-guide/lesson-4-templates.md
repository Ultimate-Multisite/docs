---
title: 'Leciono 4: Konstruado de niĉaj ŝablonoj'
sidebar_position: 5
...
Posedanto de taŭgeca studio, kiu registriĝas al FitSite, devus vidi:

- Ĉefpaĝon kiu aspektas kiel retejo de taŭgeca studio
- Paĝojn por klasoj, horaroj, trejnistoj, kaj prezoj jam kreitajn
- Bildaron kaj anstataŭigan enhavon kiu kongruas kun ilia industrio
- Dezajnon kiu sentiĝas profesia kaj markokonforma por taŭgeco
...
- **Ĉefpaĝo** kun heroa bildo, klasaj elstaraĵoj, kaj alvoko al ago
- **Pri** paĝo kun studia rakonto kaj misio
- **Klasoj** paĝo kun horara aranĝo
- **Trejnistoj** paĝo kun profilkartoj
...
- Ĉio en Studio Essential, plus:
- **Membreco** paĝo kun preztabelo
- **Galerio** paĝo por instalaĵaj fotoj
- **Blogo** sekcio por taŭgecaj konsiloj kaj novaĵoj
...
- Ĉio en Gym Pro, plus:
- **Lokoj** paĝo kun pluraj instalaĵaj listoj
- **Franĉizo/loko** subpaĝa ŝablono
...
1. Aktivigu Theme taŭgan por taŭgecaj entreprenoj
2. Agordu la Theme-agordojn, kolorojn, kaj tipografion
3. Starigu la kapon kaj piedon kun taŭgece taŭga navigado
...
- **Anstataŭiga enhavo** kiu legiĝas nature por taŭgeco ("Bonvenon al [Nomo de Studio]" ne "Lorem ipsum")
- **Anstataŭigaj bildoj** el senpagaj stokfotaj retejoj montrantaj taŭgecajn aktivecojn
- **Funkciaj aranĝoj** uzante la paĝkonstruilon aŭ blokan redaktilon
...
- Rezerva aŭ horarplana plugin (se aplikebla al via plana nivelo)
...
3. Ebligu la baskulon **Reteja Ŝablono**
...
- [ ] Ĉiuj paĝoj ŝargiĝas ĝuste kaj aspektas profesiaj
- [ ] Anstataŭiga enhavo estas helpema kaj niĉspecifa
- [ ] Bildoj estas taŭgaj kaj ĝuste licencitaj
- [ ] Poŝtelefona respondemo funkcias en ĉiuj paĝoj
- [ ] Navigado estas logika kaj kompleta
- [ ] Kontaktformularoj funkcias
...
- **Instruan anstataŭigan enhavon** kiu gvidas klientojn tra personigo
- **Kvalitan kontrolliston** por certigi ke ŝablonoj estas pretaj por produktado

---

**Sekve:** [Leciono 5: Dezajni Viajn Planojn](lesson-5-plans) -- ni kreas produktajn nivelojn, kiuj kongruas kun kiel taŭgecaj entreprenoj efektive funkcias.
