...
- [ ] Domajna mapado funkcias -- testu krei retejon kaj mapi propran domajnon
...
- [ ] Ĉiuj bildoj estas ĝuste licencitaj (neniuj akvomarkoj de stokaj fotoj)
- [ ] Poŝtelefona adaptebleco funkcias sur ĉiu ŝablona paĝo
...
- [ ] Prezado estas ĝusta (monata kaj jara)
- [ ] Starigaj kotizoj estas agorditaj ĉe la ĝustaj planoj
- [ ] Provperiodo funkcias ĉe la Starter-plano
...
- [ ] Pago traktiĝas sukcese
- [ ] Kliento ricevas bonvenigan retpoŝton post aliĝo
- [ ] Nova retejo estas kreita kun la ĝusta ŝablono
...
- [ ] Ĉiuj sistemaj retpoŝtoj uzas la markadon de FitSite kaj taŭgec-specifan lingvaĵon
...
- [ ] Bonveniga retpoŝta sinsekvo estas agordita kaj testita
...
- [ ] Repaga politiko estas difinita kaj dokumentita
- [ ] Komerca ento estas starigita por ricevi pagojn
...
- Honesta reago pri la aliĝa kaj enkonduka sperto
- Permeso uzi ilian retejon kiel montroekzemplon
- Raportado de iuj cimoj aŭ problemoj, kiujn ili renkontas
...
- Ŝaltu pagopordegon al viva reĝimo
- Publikigu vian merkatan retejon
...
1. **Ŝaltu al vivaj pagoj** -- malŝaltu testan reĝimon ĉe via pagopordego
2. **Kontrolu ankoraŭ unu fojon** -- faru kompletan testan aliĝon kun vera pago (repagu al vi poste)
3. **Proksime monitoru** -- atentu erarojn, malsukcesajn aliĝojn, aŭ pagproblemojn
...
- **Problemoj kun pagopordego**: Havu preta la subtenkontakton de via pordega provizanto
- **Problemoj pri SSL-atestilo**: Sciu kiel kontroli kaj renovigi atestilojn
- **Malsukcesoj de retpoŝta livero**: Testu, ke retpoŝtoj efektive alvenas (kontrolu spamdosierujojn)
...
- **Lanĉotagaj proceduroj** por viviĝi kun memfido
- **Rezerva plano** por oftaj lanĉotagaj problemoj

---

**Sekva:** [Leciono 11: Trovi Klientojn](lesson-11-customers) -- nun kiam FitSite estas viva, kiel vi igas posedantojn de taŭgecaj studioj aliĝi?
