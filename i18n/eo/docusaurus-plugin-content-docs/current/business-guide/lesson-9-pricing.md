---
title: 'Leciono 9: Prezado por Profito'
sidebar_position: 10
...
- Profesian taŭgecan retejon kiu kostus $2,000-$5,000 konstrui laŭmende
- Daŭran prizorgadon, ĝisdatigojn, kaj sekurecon pri kiuj ili ne devas pensi
- Niĉospecifajn funkciojn kiujn ĝeneralaj konstruiloj ne ofertas
- La kredindecon de platformo konstruita por ilia industrio
...
- **Dungi retprogramiston**: $2,000-$5,000 antaŭpage + $50-$100/monate por prizorgado
- **Wix/Squarespace**: $16-$45/monate sed sen taŭgecospecifaj funkcioj; ili konstruas ĝin mem
- **Fari nenion**: Perditaj membroj kiuj ne povas trovi ilin rete
...
| Plano | Monate | Jare (monate) | Jara Sumo | Ŝparo |
|------|---------|-------------------|--------------|---------|
| Starter | $49/mo | $39/mo | $468/year | 20% rabato |
| Growth | $99/mo | $79/mo | $948/year | 20% rabato |
| Pro | $199/mo | $159/mo | $1,908/year | 20% rabato |
...
- **Starter**: Neniu agorda kotizo (forigu barojn al eniro)
- **Growth**: $99 agorda kotizo (kovras konfiguradon de propra domajno kaj komencan konsulton)
- **Pro**: $299 agorda kotizo (kovras plur-lokan agordon kaj enkondukan vokon)
...
- **7-taga senpaga provo** nur en la Starter-plano
- Neniu provo en Growth kaj Pro (ĉi tiuj klientoj estas pli engaĝitaj kaj atendas pagi)
...
- **FITLAUNCH** -- 30% rabato por la unuaj 3 monatoj (por lanĉa reklamo)
- **ANNUAL20** -- 20% rabato por jaraj planoj (se ne jam rabatitaj)
- **REFERRAL** -- 1 monato senpage (por klientaj referencoj)

Iru al **Ultimate Multisite > Discount Codes** por krei ĉi tiujn. Vidu [Krei Rabattkodojn](/user-guide/configuration/creating-discount-codes) por la plena gvidilo.

:::tip Ne Rabatu Defaŭlte
...
1. Konfiguru impostajn tarifojn en **Ultimate Multisite > Settings > Taxes**
2. Apliku impostajn kategoriojn al viaj planoj
3. Certigu ke fakturoj montras imposton ĝuste
...
- **Konvertiĝa proporcio laŭ plano**: Se Starter bone konvertas sed Growth ne, la interspaco inter ili eble estas tro granda
- **Ĝisdatiga proporcio**: Se malmultaj klientoj ĝisdatigas de Starter al Growth, la Growth-plano eble ne ofertas sufiĉe da aldona valoro
...
├── Ultimate Multisite (konfigurita + markigita)
├── Platforma Domajno (fitsite.com + ĵokero SSL)
├── Retejaj Ŝablonoj (Studio Essential, Gym Pro, Fitness Chain)
├── Produktoj
│   ├── FitSite Starter ($49/mo or $468/yr) + 7-taga provo
│   ├── FitSite Growth ($99/mo or $948/yr) + $99 agorda kotizo
│   ├── FitSite Pro ($199/mo or $1,908/yr) + $299 agorda kotizo
│   └── Mendaj Aldonoj + Rabattkodoj
├── Kasproceza Fluo (kun perioda elekta baskulo)
├── Markigo (ensaluto, Dashboard, retpoŝtoj, fakturoj, merkatiga retejo)
├── Klienta Enkonduko (Rapida Komenco, retpoŝtoj, helpaj rimedoj)
├── Preziga Strategio
│   ├── Jaraj rabatoj (20% rabato)
│   ├── Strategiaj agordaj kotizoj
│   ├── 7-taga provo en Starter
│   ├── Rabattkodoj por kampanjoj kaj referencoj
│   └── Imposta konfigurado
...
- **Prova periodo** ĉe la enirnivela plano por redukti aliĝan frikcion
- **Strategiaj rabatkodoj** por lanĉo, rekomendoj, kaj kampanjoj
- **Imposta agordo** por konforma fakturado
- **Kadro por revizio de prezado** por daŭra optimumigo

---

**Sekva:** [Leciono 10: Lanĉotago](lesson-10-launch) -- la antaŭlanĉa kontrolisto kaj ekfunkciigo.
