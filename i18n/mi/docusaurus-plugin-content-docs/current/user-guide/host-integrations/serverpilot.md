...
### 1. Whakaue Iro API Credentials o tō ServerPilot
...
### 3. Whakawārie Constants ki wp-config.php
...
## He aha e pēhea ia mahi? (How It Works)

### Whakawhiti Domain (Domain Syncing)
...
### Whakawātea Certificate SSL (SSL Certificate Management)
...
## Whakawātea/Whakamārama Certificate SSL (SSL Certificate Verification)
...
## Whakamārama/Whakawātea (Troubleshooting)

### Ngā Whainga o te Konektanga API (API Connection Issues)
...
### Ngā Whainga o te Certificate SSL (SSL Certificate Issues)
...
### Domain Ei Whakawāhia (Domain Not Added)
