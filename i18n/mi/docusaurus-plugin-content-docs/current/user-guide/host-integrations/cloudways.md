...
### 1. Whakahaere i Ngā Credentials API o Cloudways {#1-get-your-cloudways-api-credentials}
...
### 2. Whakahaere i Ngā Server ID me Application IDs {#2-get-your-server-and-application-ids}
...
### 3. Whakahaere i Ngā Constants i wp-config.php {#3-add-constants-to-wp-configphp}
...
### 4. Whakawhanaungatanga te Whakahaere (Enable the Integration) {#4-enable-the-integration}
...
## He aha i te mahi ana? (How It Works) {#how-it-works}

### Whakawhanaungatanga Domain (Domain Syncing) {#domain-syncing}
...
### Whakahaere Certificate SSL (SSL Certificate Management) {#ssl-certificate-management}
...
### Ngā Whaingaro SSL Certificate {#ssl-certificate-issues}
...
### Domain E Whakawārie {#domain-not-added}
