...
## Whakamahi Whakahaere (Setup Instructions) {#setup-instructions}

### 1. Whakaue Iro API RunCloud Kōrero {#1-get-your-runcloud-api-credentials}
...
### 2. Whakaue Iro Server me App IDs {#2-get-your-server-and-app-ids}
...
## Whakamāoa (Troubleshooting) {#troubleshooting}

### Ngā Whainga API Connection {#api-connection-issues}
...
### Domain Aua Whakawātea {#domain-not-added}
