...
### 1. Titiro i tō API Key o Closte
...
## Whakawāhi Domain Record (Domain Record Creation)
...
### Ngā Whainga Whakamahi API (API Connection Issues)
...
### Domain Ka Korea Whakawhiti (Domain Not Added)
...
### Ngā Whainga Whakawhiti DNS (DNS Check Interval)
