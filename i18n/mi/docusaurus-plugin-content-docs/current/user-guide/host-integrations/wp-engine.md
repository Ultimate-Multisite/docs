...
## Wāhi Whakawhanaungatanga (Requirements)
...
### 2. Whakawhanaungatanga (Enable the Integration)
...
### Whakawhanake Domain (Domain Syncing)
...
## Ngā Tohutohu Whakamahinga Whakamahalata (Important Notes)

### Domain Whakawhiti (Wildcard Domains)
...
### Sertifikati SSL (SSL Certificates)
...
### Ngā Whainga Whakawhiti API (API Connection Issues)
...
### Domain Aua Whakawhanainga (Domain Not Added)
...
### Ngā Whainga Subdomain (Subdomain Issues)
