...
### 1. Whakawātea i ngā Credentials API o tō GridPane
...
### 2. Whakawātea i ngā Server ID me Site IDs o koe
...
### 3. Whakawātea i ngā Constants ki wp-config.php
...
### 4. Whakawhanaungatanga i te Integration
