...
### 1. Whakawātea Tō API Key o Cloudflare
...
### 4. Whakawhanaungatanga te Whakawhiti (Enable the Integration)
...
## He aha ia mahi ana (How It Works)

### Whakawhiti Subdomain (Subdomain Management)
...
### Whakaritenga DNS Record Display
...
## Ngā Pātai Whakamahalata (Important Notes)
...
### Ngā Wāhi Whakamārama (Proxying Issues)
