...
## Whakarite i te Fōme Pōwhakaritenga: {#using-the-registration-form}
...
## Whakarite i te Link Whakawhiti (Using a Shareable Link): {#using-a-shareable-link}
...
### Whai whakaae using Manual Payments (Whai whakaae mō te Rautiki): {#registering-using-manual-payments}
