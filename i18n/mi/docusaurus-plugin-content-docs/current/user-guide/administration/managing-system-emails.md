...
I tēnei wā, e taea ai koe te whai i te puta mai o te **System Emails** page kia whakaatu i ngā template email katoa.

![System Emails list](/img/admin/system-emails-list.png)

E taea ai hoki i a koe te whakawhiti i ngā template email i roto i te whakamārama email system:
...
Mō te import o template email hou:

1. Pāpā i te **System Emails** page
2. Whakawhiti i te button **Reset & Import** i runga i te pēpi o te page
...
1. **Delete me import mō** — Whakawā i te system email me whakamahi i a ia mō atu (he ka whakatū i ngā metrics o te whakawhiti)
2. **Reset via the tool** — Whakawhiti i te tool **Reset & Import**, whakawhiti i te option **Reset**, me select i ngā emails kua whakarāua koe

Ko te option Reset he tino pai, ā, e pēnei i te mea e whaiaro ai ngā metrics o te whakawhiti me ngā metadata hou, i roto i te whakatū i te mea hou.
