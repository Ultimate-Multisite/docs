...
## He aha ngā pēnei whakahaupūatanga mō ngā admin {#what-changes-for-administrators}
...
## Pito i te tenant souverain {#visiting-a-sovereign-tenant}
...
## Whakawhiti operatāinga mō te wāhi whānui (Remote-site operations checklist) {#remote-site-operations-checklist}
...
## Whakamutunga o ngā tenant souverain (sovereign tenants) {#deleting-sovereign-tenants}
