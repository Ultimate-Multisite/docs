...
title: Tātari - wu_apc_process_page_content
...
|------|------|-------------|
| $content | `string` | Te ihirangi i muri i ngā whakakapinga. |
| $content_before_processing | `string` | Te ihirangi i mua i ngā whakakapinga. |
