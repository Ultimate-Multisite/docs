...
### Регистровање прилагођеног руковаоца инсталацијом
...
## Архитектура асинхроних послова
