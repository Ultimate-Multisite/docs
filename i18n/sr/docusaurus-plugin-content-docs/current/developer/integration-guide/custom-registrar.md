---
title: Израда прилагођене интеграције регистратора
sidebar_position: 10
...
| Метода | Откључава |
|---|---|
| `supports_whois_privacy(): bool` | WHOIS privacy опција у подешавањима производа |
...
Први аргумент за `add_capability()` је **ID провајдера** — slug малим словима који се користи за идентификацију вашег регистрара у подешавањима, конфигурацији производа и каналима евиденције. Користите нешто јединствено (нпр. slug ваше компаније).
...
Акредитиви се чувају као мрежне опције користећи ID-еве поља као кључеве. Преузмите их у својој capability класи помоћу `wu_get_setting('my_registrar_api_key')`.
...
Евиденције се појављују под **Администрација мреже › Ultimate Multisite › Евиденције › domain-seller-my-registrar**.
