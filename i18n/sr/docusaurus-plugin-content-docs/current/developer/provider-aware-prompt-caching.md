...
---
# Кеширање промптова свесно провајдера
...
## Azure OpenAI: кеширање промптова
...
### Најбоље праксе за Azure OpenAI
...
### Опције специфичне за провајдера
...
### Коришћење Vertex Anthropic кеширања
...
### Најбоље праксе за Vertex Anthropic
...
## Стратегија кеширања између провајдера

### Јединствена конфигурација
