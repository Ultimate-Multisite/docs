---
title: Водич за коришћење кукица
sidebar_position: 1
...
### Животни циклус корисника {#customer-lifecycle}

#### Након креирања корисника {#after-customer-creation}
...
#### Промена статуса корисника {#customer-status-change}
...
### Hooks за сајтове {#site-hooks}

#### Након објављивања сајта {#after-site-published}
...
#### Пре примене шаблона {#before-template-application}
...
### Hooks за чланство {#membership-hooks}

#### Прелази статуса {#status-transitions}
...
### Hooks за плаћање {#payment-hooks}

#### Плаћање завршено / неуспело {#payment-completed--failed}
...
### Hooks за checkout {#checkout-hooks}

#### Пре обраде / након завршетка {#before-processing--after-completion}
...
### Филтери цена {#pricing-filters}

#### Укупно у корпи {#cart-total}
...
### Филтери шаблона {#template-filters}
...
### Филтери ограничења {#limitation-filters}
...
### Филтери gateway {#gateway-filters}
...
### Поља checkout обрасца {#checkout-form-fields}
