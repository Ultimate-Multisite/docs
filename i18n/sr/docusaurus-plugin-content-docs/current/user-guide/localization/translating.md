...
## Преводи основних плагина (Core Plugin) {#core-plugin-translations}
...
## Преводи додатка (Addon Translations) {#addon-translations}
...
### Коришћење Poedit-а {#using-poedit}
...
### Коришћење Loco Translate {#using-loco-translate}
