...
---
# Слање имејлова и обавештења (v2) {#sending-emails-and-broadcasts-v2}
...
## Додајте admin обавештења на dashboard ваших клијената помоћу обавештења {#add-admin-notices-to-your-customers-dashboard-with-broadcasts}
...
## Пошаљите имејлове својим клијентима {#send-emails-to-your-customers}
...
## Системски имејлови {#system-emails}
...
### Ресетовање и увоз {#resetting--importing}
...
#### Како увести системске имејлове {#how-to-import-system-emails}
...
#### Ресетовање системских имејлова {#reseting-system-emails}
