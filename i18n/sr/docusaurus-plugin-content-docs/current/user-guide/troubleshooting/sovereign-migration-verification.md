...
---
# Provera migracije suverenog stanara {#sovereign-migration-verification}
...
## Komande za izvršavanje {#commands-to-run}
...
## Česte neusaglawości {#common-failures}

### Dotičeni dozvole baze podataka se ne poklapaju sa hostom {#database-grants-do-not-match-the-host}
...
### Bedrock ili lokal instalacije ne mogu da se povežu {#bedrock-or-local-installs-cannot-connect}
...
### Asinhna redosled za push nije ispraznjen (drain) {#async-push-queue-does-not-drain}
...
### Broj korisnika stanara je pogrešan {#tenant-user-count-is-wrong}
...
### Poseta putem SSO je odbijena {#sso-visit-is-rejected}
...
## Kada ponovo pokušati {#when-to-retry}
