...
### 1. Dobijte svoje Cloudways API kredencijale
...
### 2. Dobijte ID servera i aplikacije
...
## Važno — Zamka oko Wildcard SSL-a
...
### Preporučena konfiguracija Cloudways SSL-a za Ultimate Multisite mrežu
