...
---
# Operacije suverenog najmesta (Sovereign Tenant Operations) {#sovereign-tenant-operations}
...
## Posetnja suverenom najmestu (Visiting a sovereign tenant) {#visiting-a-sovereign-tenant}
...
## Provera operacija za udaljene lokacije (Remote-site operations checklist) {#remote-site-operations-checklist}
...
## Бдење суверенних најмча (Deleting sovereign tenants) {#deleting-sovereign-tenants}
