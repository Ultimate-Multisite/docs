...
### Використання кешованого промпту
...
## Azure OpenAI: Кешування промптів
...
### Найкращі практики для Azure OpenAI
...
### Використання кешування OpenRouter
...
### Найкращі практики для OpenRouter
...
### Використання кешування Vertex Anthropic
...
### Найкращі практики для Vertex Anthropic
...
## Стратегія кешування між провайдерами
...
### Стратегія відмовостійкості (Fallback)
