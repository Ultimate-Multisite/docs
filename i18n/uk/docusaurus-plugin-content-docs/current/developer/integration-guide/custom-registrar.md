...
---
# Створення власної інтеграції реєстратора доменів {#building-a-custom-registrar-integration}
...
### Необов'язкові методи {#optional-methods}
...
### Конвенція значення повернення {#return-value-convention}
...
## Реєстрація вашої можливості {#registering-your-capability}
...
## Додавання полів облікових даних до візарда {#adding-credential-fields-to-the-wizard}
...
## Хуки для дій після реєстрації {#hooks-for-post-registration-actions}
