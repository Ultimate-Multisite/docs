...
## API для встановлення плагінів {#plugin-installer-api}
...
### Реєстрація користувацького обробника встановлення {#registering-a-custom-install-handler}
...
## Реєстр екосистеми {#ecosystem-registry}
...
## Інтеграція HookScanner {#hookscanner-integration}
...
## Архітектура асинхронних завдань {#async-job-architecture}
