...
## Хуки дій (Action Hooks)

### Життєвий цикл клієнта

#### Після створення клієнта
...
### Хуки оформлення замовлення

#### Перед обробкою / Після завершення
...
### Поля форми оформлення замовлення
