---
title: Посібник із використання хуків
sidebar_position: 1
_i18n_hash: 6da56fd5e6cd83c2056ce9cb7fbb4453
---
# Посібник із використання хуків {#hooks-usage-guide}

Ultimate Multisite надає понад 200 хуків дій та понад 280 хуків фільтрів. На цій сторінці ми розглянули найбільш часто використовувані хуки з практичними прикладами. Щоб отримати повний згенерований довідник, перегляньте інші сторінки цього розділу.

## Хуки дій (Action Hooks) {#action-hooks}

### Життєвий цикл клієнта {#customer-lifecycle}

#### Після створення клієнта {#after-customer-creation}
...
#### Зміна статусу клієнта {#customer-status-change}
...
### Хуки сайту {#site-hooks}

#### Після публікації сайту {#after-site-published}
...
#### Перед застосуванням шаблону {#before-template-application}
...
### Хуки членства {#membership-hooks}

#### Переходи статусів {#status-transitions}
...
### Хуки платежів {#payment-hooks}

#### Платіж завершено / Не вдалося {#payment-completed--failed}
...
### Хуки оформлення замовлення {#checkout-hooks}

#### Перед обробкою / Після завершення {#before-processing--after-completion}
...
## Хуки фільтрів (Filter Hooks) {#filter-hooks}

### Фільтри ціноутворення {#pricing-filters}

#### Загальна сума кошика {#cart-total}
...
### Фільтри шаблонів {#template-filters}
...
### Фільтри обмежень {#limitation-filters}
...
### Фільтри шлюзів {#gateway-filters}
...
### Поля форми оформлення замовлення {#checkout-form-fields}
...
### Контент електронної пошти {#email-content}
