...
### 2. Додавання констант до wp-config.php
...
### Зіставлення доменів (Domain Mapping)
...
### Email Forwarders (Переадресація електронної пошти)
...
### Відмовлено у підключенні API (API Connection Refused)
...
### Домен не створено (Domain Not Created)
...
### SSL-сертифікат не видано (SSL Certificate Not Issued)
