...
---
# Налаштування константи Sunrise зі значенням true на Closte {#setting-the-sunrise-constant-to-true-on-closte}
...
## На панелі керування Closte {#on-the-closte-dashboard}
