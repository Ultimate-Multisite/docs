...
---
# Інтеграція з ServerPilot {#serverpilot-integration}
...
### 1. Отримайте API-дані ServerPilot {#1-get-your-serverpilot-api-credentials}
...
### 2. Отримайте App ID {#2-get-your-app-id}
...
### Видалення домену {#domain-removal}
