...
---
# Інтеграція з cPanel {#cpanel-integration}
...
### 1. Отримайте облікові дані cPanel {#1-get-your-cpanel-credentials}
...
### 2. Додайте константи до wp-config.php {#2-add-constants-to-wp-configphp}
...
### 3. Увімкніть інтеграцію {#3-enable-the-integration}
...
### Додаткові домени {#addon-domains}
