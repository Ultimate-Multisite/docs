...
## Що робить ця інтеграція {#what-it-does}
...
## Налаштування (Wizard → Integrations → Hestia) {#configuration-wizard--integrations--hestia}
...
## Приклад API-запиту (cURL) {#example-api-call-curl}
