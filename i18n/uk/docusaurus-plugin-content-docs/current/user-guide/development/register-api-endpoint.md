...
## Параметри тіла запиту {#endpoint-body-parameters}
...
## Створення дії в Zapier {#creating-an-action-in-zapier}
...
### Створення дії {#creating-an-action}
...
### Повний перелік параметрів ендпоінта {#complete-endpoint-parameters}
