...
---
# Фрагменти коду для v2 {#code-snippets-for-v2}
...
## Виправлення проблем CORS із шрифтовими іконками на прив'язаних доменах {#fixing-cors-issues-with-font-icons-in-mapped-domains}
## Виправлення проблем CORS із шрифтовими іконками на прив'язаних доменах {#fixing-cors-issues-with-font-icons-in-mapped-domains-1}
