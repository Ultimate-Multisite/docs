...
---
# Майстер налаштування мережі сайтів {#multisite-setup-wizard}
...
## Коли з'являється майстер? {#when-does-the-wizard-appear}
...
## Крок 1: Привітання {#step-1-welcome}
...
## Крок 2: Конфігурація мережі {#step-2-network-configuration}

На цьому кроці вам потрібно налаштувати параметри мережі.

### Структура сайтів {#site-structure}
...
### Email адміністратора мережі {#network-admin-email}
...
## Крок 3: Встановлення {#step-3-installation}
...
## Крок 4: Завершення {#step-4-complete}
...
## Резервний варіант ручного налаштування {#manual-setup-fallback}
...
### Майстер повідомляє, що wp-config.php недоступний для запису {#the-wizard-says-wp-configphp-is-not-writable}
...
### Сайти недоступні після налаштування (піддомени) {#sites-are-not-accessible-after-setup-subdomains}
...
### Проблеми з автентифікацією після налаштування {#authentication-issues-after-setup}
...
### Крок не вдався під час встановлення {#a-step-failed-during-installation}
