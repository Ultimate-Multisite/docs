...
---
# Функція визначення специфікації сайту
...
## Що таке визначення специфікації сайту?
...
## Навіщо використовувати визначення специфікації сайту?
...
## Ініціалізація визначення специфікації сайту

### Під час онбордингу Theme Builder
...
## Процес визначення специфікації сайту
...
## Перегляд та оновлення site_brief
...
## Зв'язок з онбордингом Theme Builder
