...
## Що таке процес онбордингу Theme Builder?
...
## Початок онбордингу Theme Builder
...
### Крок 3: Рішення щодо дизайн-системи
...
## Специфікація сайту та пам'ять site_brief
...
## Кастомізація після онбордингу

Після завершення онбордингу Theme Builder ви можете:

### Використовувати навик Design System Aesthetics
...
### Створювати кастомні блочні шаблони
...
## Порівняння: Старий vs. Новий онбординг
