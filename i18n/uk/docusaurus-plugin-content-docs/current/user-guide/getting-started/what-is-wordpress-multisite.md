...
---
# Що таке WordPress Multisite? {#what-is-wordpress-multisite}
...
## Що саме таке WordPress Multisite? {#what-exactly-is-wordpress-multisite}
...
## Піддомен чи підкаталог? {#subdomain-or-subdirectory}
...
## Що є спільним для підсайтів, а що — ні {#what-is-shared-among-subsites-and-what-is-not}
...
## Керування користувачами в WordPress Multisite {#user-management-on-wordpress-multisite}
