...
#### Піддомени vs. підкаталоги {#subdomain-vs-subdirectory}
...
#### Плагіни та теми {#plugins-and-themes}
...
#### Користувачі та адміністратори {#users-and-administrators}
...
### Архітектурні міркування {#architecture-considerations}
...
#### Спільний vs. виділений хостинг {#shared-vs-dedicated-hosting}
...
#### Зовнішні скрипти {#external-scripts}
