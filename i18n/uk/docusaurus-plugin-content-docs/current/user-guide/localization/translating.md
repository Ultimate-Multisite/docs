...
## Переклади основного плагіна {#core-plugin-translations}
...
## Переклади addon-ів {#addon-translations}
...
### Використання Loco Translate {#using-loco-translate}
