...
## ক'ত ব্যৱহাৰ কৰিব {#when-to-use-it}
...
## ফাইলৰ নামৰ নিয়ম (File naming convention) {#file-naming-convention}
...
## ফাইলটো ক'ত থব {#where-to-place-the-file}
...
## উপলব্ধ Hooks আৰু filters {#hooks-and-filters-available}
...
## ন্যূনতম উদাহৰণ (Minimal example) {#minimal-example}
