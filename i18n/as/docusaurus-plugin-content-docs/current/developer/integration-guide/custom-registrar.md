...
### Optional methods (ঐচ্ছিক পদ্ধতিসমূহ)
...
### Return value convention (ফলাফলৰ মানকীকৰণ)
...
## Registering your capability (আপোনাৰ capability ৰেজিষ্টাৰ কৰা)
...
## Adding credential fields to the wizard (wizard-ত credential field যোগ কৰা)
...
## Hooks for post-registration actions (প্ৰৱন্দনাৰ পিছৰ কাৰ্য্যৰ বাবে hooks)
