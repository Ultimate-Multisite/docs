...
title: কাৰ্য - wu_model_post_save
sidebar_label: wu_model_post_save
_i18n_hash: dd2afb7dda9751cf6d2e2f8e0ff2b428
---
# Action: wu_model_post_save

Database-ত কোনো object সেৱল হোৱাৰ পিছত এইটো কাৰ্য কৰে।

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $model | `string` | মডেলৰ স্লাগটো। |
| $data | `array` | যি object data সেৱল হ'ব, তাক serialise কৰা হৈছে। |
| $data_unserialized | `array` | যি object data সেৱল হ'ব। |
| $this | `\Base_Model` | object-টোৰ প্ৰতিলিপি। |
