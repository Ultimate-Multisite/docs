...
|------|------|-------------|
| $notices | `array` | সেই বিশেষ প্যানেলটোৰ বাবে নোটিচৰ তালিকা। |
| $all_notices | `array` | প্যানেল অনুসৰি পৃথক কৰা নোটিচৰ তালিকা। |
| $panel | `string` | নোটিচটো পুনৰুদ্ধাৰ কৰিবলগীয়া প্যানেল। |
