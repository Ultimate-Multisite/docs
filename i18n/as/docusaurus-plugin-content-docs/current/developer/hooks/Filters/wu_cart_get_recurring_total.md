...
title: ফিল্টাৰ - wu_cart_get_recurring_total
...
ই "recurring amount" (পুনৰাবৃত্ত হোৱা ধনৰ পৰিমাণ) মুঠ পৰিমাণটোক ফিল্টাৰ কৰে।

## প্যারামিটাৰসমূহ {#parameters}

| Name | Type | বৰ্ণনা |
|------|------|-------------|
| $total | `float` | পুনৰাবৃত্ত হোৱা ধনৰ পৰিমাণ। |
