...
|------|------|-------------|
| $should_display_admin_menu | `bool` | যদি আমি পৃষ্ঠাগুলি প্ৰদৰ্শন কৰিব বিচাৰোঁ। |
| $network_active | `bool` | প্লাগইনটো নেটৱৰ্ক এডমিনৰ বাবে active আছে নে নাই পৰীক্ষা কৰে। |
