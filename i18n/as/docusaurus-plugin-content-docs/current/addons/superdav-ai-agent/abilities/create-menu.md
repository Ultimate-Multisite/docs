...
## নেভিগেশ্বন লেবেল বনাম পেজৰ টাইটেল (Navigation Label vs Page Title)
...
## ব্যৱহাৰৰ উদাহৰণ (Usage Examples)

### উদাহৰণ ১: নেভিগেশ্বন লেবেলসহ সৰল মেনু (Simple Menu with Navigation Label)
...
### উদাহৰণ ২: নিৰ্দিষ্ট থীম স্থানৰ বাবে মেনু (Menu for Specific Theme Location)
...
## Theme Builder লগত সংহতি (Integration with Theme Builder)
...
## সম্পৰ্কিত ক্ষমতা (Related Abilities)
