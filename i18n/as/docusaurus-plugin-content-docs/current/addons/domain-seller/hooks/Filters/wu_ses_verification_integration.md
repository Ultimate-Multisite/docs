...
ফিল্টাৰ: আন কোডক SES ইন্টিগ্ৰেচন অবজেক্ট যোগ কৰিবলৈ অনুমতি দিয়ে।

উভতি অহা অবজেক্টটোৱে তলৰ ফাংচনবোৰ (methods) ৰূপায়ণ কৰিব লাগিব:
...
|------|------|-------------|
| $integration | `object\|null` | SES ইন্টিগ্ৰেচন অবজেক্ট, অথবা null। |
