...
title: ফিল্টৰ - wu_limits_is_fluent_form_above_limit
...
| Name | Type | বৰ্ণনা |
|------|------|-------------|
| $value | `bool` | যদি ফৰ্মৰ ধৰণ সীমাৰ ওপৰত আছে নে নাই। |
| $form_type | `string` | পৰীক্ষা কৰা ফৰ্মৰ ধৰণ। |
| $form_count | `int` | বৰ্তমানৰ ফৰ্মৰ সংখ্যা। |
| $quota | `int` | অনুমতি দিয়া কোটা। |
