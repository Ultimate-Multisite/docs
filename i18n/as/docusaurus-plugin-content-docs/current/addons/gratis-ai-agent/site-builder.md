...
### ১. প্ৰিকল্পনা সৃষ্টি (Plan Generation) {#1-plan-generation}
...
### ২. প্লাগইনৰ আৱিষ্কাৰ (Plugin Discovery) {#2-plugin-discovery}
...
### ৩. প্ৰিকল্পনা কাৰ্যকৰী কৰা (Plan Execution) {#3-plan-execution}
...
### ৪. প্ৰগতিৰ মটৱা (Progress Tracking) {#4-progress-tracking}
...
### ৫. ভুল শুধৰাই আগুৱাকোৱা (Error Recovery) {#5-error-recovery}
...
## v1 আৰু v2 ৰ তুলনা {#comparing-v1-and-v2}
