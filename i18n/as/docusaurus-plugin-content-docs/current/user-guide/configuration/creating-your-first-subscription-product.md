...
## Managing Products (প্ৰডাক্ট ব্যৱস্থাপনা)
...
## Adding Products (প্ৰডাক্ট যোগ কৰা)
...
### Pricing Type (মূল্য নিৰ্ধাৰণৰ ধৰণ)
...
### Product Options (প্ৰডাক্ট বিকল্প)
...
#### Up & Downgrades (উন্নত আৰু নিম্ন স্তৰলৈ যোৱা)
