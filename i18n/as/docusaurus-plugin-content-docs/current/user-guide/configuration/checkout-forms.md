...
---
# চেকআউট ফৰ্মসমূহ {#checkout-forms}
...
#### চেকআউট ফৰ্ম সম্পাদকৰ অৱলোকন {#checkout-form-editor-overview}
...
### এটা চেকআউট ফৰ্ম সম্পাদনা কৰা {#editing-a-checkout-form}
...
### মূল্য নিৰ্ধাৰণ টেবুল ক্ষেত্ৰ {#the-pricing-table-field}
...
### সময়সীমা বাছনি Toggle যোগ কৰা {#adding-a-period-selection-toggle}
...
#### ধাপ ১: আপোনাৰ সামগ্ৰীসমূহত মূল্য ভিন্নতা ছেট আপ কৰক {#step-1-set-up-price-variations-on-your-products}
...
#### ধাপ ২: আপোনাৰ Checkout ফৰ্মত সময়সীমা বাছনি ক্ষেত্ৰ যোগ কৰক {#step-2-add-the-period-selection-field-to-your-checkout-form}
...
#### ধাপ ৩: ক্ষেত্ৰটো Pricing Table-ৰ ওপৰত অৱস্থান দিয়ক {#step-3-position-the-field-above-the-pricing-table}
...
#### Frontend-ত ই কেনেকৈ কাম কৰে {#how-it-works-on-the-frontend}
...
#### URL-ৰ জৰিয়তে বিলিং সময়সীমা আগতে বাছনি কৰা {#pre-selecting-a-billing-period-via-url}
...
### Template বাছনি ক্ষেত্ৰ {#the-template-selection-field}
...
#### ক্ষেত্ৰটো হাতেৰে যোগ কৰা {#adding-the-field-manually}
...
#### field আঁতৰোৱা {#removing-the-field}
