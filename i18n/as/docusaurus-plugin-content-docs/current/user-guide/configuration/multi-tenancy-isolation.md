...
---
# বহু-ভাড়া ব্যবস্থা বিচ্ছিন্নতা (Multi-Tenancy Isolation) {#multi-tenancy-isolation}
...
## প্রোভিশনিং ক্রম (Provisioning order) {#provisioning-order}
...
## সার্বভৌম গ্রাহক ব্যবস্থাপনা প্রবাহ (Sovereign customer management flows) {#sovereign-customer-management-flows}
