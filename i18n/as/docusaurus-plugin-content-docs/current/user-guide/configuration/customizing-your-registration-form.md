...
---
# আপোনাৰ পঞ্জীয়ন ফৰ্ম কাষ্টমাইজ কৰা {#customizing-your-registration-form}
...
## লগইন আৰু পঞ্জীয়ন পৃষ্ঠাসমূহ: {#login-and-registration-pages}
...
## একাধিক পঞ্জীয়ন ফৰ্ম ব্যৱহাৰ কৰা: {#using-multiple-registration-forms}
...
### Checkout Form সম্পাদনা কৰা: {#editing-a-checkout-form}
...
## URL parameter-ৰ জৰিয়তে পণ্য আৰু template আগতীয়াকৈ বাছনি কৰা: {#pre-selecting-products-and-templates-via-url-parameters}
