...
---
# পৰিশোধ আৰু ইনভয়েছ व्यवस्थापन {#managing-payments-and-invoices}

## Payment Settings (পৰিৱৰ্তনৰ সেটিং) {#payment-settings}
...
### General Payment Options (সাধাৰণ পৰিশোধ বিকল্প) {#general-payment-options}
...
### Payment Gateways (পৰিৱৰ্তন গেটৱে) {#payment-gateways}
...
### Sandbox Mode (ছাণ্ডবক্স মোড) {#sandbox-mode}
...
## Viewing Payments (পৰিৱৰ্তন দেখা) {#viewing-payments}
