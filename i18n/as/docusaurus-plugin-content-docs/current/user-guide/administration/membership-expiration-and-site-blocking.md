...
## Membership Status Lifecycle (মেম্বৰশ্বিপৰ স্থিতিৰ জীৱনচক্ৰ)
...
### How Memberships Transition to Expired (মেম্বৰশ্বিপবোৰ কেনেকৈ মেয়াদোত্তৰ হয়)
...
#### Auto-Renewing vs. Non-Auto-Renewing Memberships (স্বয়ংক্রিয় পুনৰীক্ষণ বনাম স্বয়ংক্রিয় পুনৰীক্ষণ নোহোৱা মেম্বৰশ্বিপ)
...
### How Trials End (ট্রায়েল কেনেকৈ শেষ হয়)
...
## Block Frontend Access (ফ্ৰণ্টএণ্ড প্ৰৱেশ বাধা দিয়া)
...
### Configuring the Setting (সেটিং কনফিগাৰ কৰা)
...
### What Visitors See When a Site Is Blocked (সাইট ব্লক হোৱাৰ লগে লগে ভ্ৰমণকাৰীসকলে কি দেখে)
...
### What Gets Blocked and When (কি ব্লক হয় আৰু ক'ৰবাত)
...
## Troubleshooting: Sites Remaining Accessible After Expiration (সমস্যা সমাধান: মেয়াদোত্তৰ হোৱাৰ পিছতো সাইট উপলব্ধ থকা)

যদি মেম্বৰশ্বিপ মেয়াদোত্তৰ হোৱাৰ পিছতো সাইটবোৰ publicভাৱে উপলব্ধ থাকে, তেন্তে এই চেকিংবোৰ ক্ৰম অনুসৰি কৰক:

### 1. Verify the Block Frontend Access Setting Is Enabled (Block Frontend Access সেটিং সক্ষম হৈ আছে বুলি পৰীক্ষা কৰক)
...
### 2. Check the Frontend Block Grace Period (ফ্ৰণ্টএণ্ড ব্লক সুবিধাৰ সময়কাল পৰীক্ষা কৰক)
...
### 3. Confirm the Membership Status Has Actually Changed (মেম্বৰশ্বিপৰ স্থিতি ખৰদিয় সলনি হৈছে বুলি নিশ্চিত কৰক)
...
### 4. Verify Action Scheduler Is Running (Action Scheduler চলি আছে বুলি পৰীক্ষা কৰক)
...
### 5. Check for Gateway Webhook Issues (Auto-Renewing Memberships) (গেটৱে webhook সমস্যা পৰীক্ষা কৰক)
...
### 6. Check the Expiration Grace Period (Cron Level) (মেয়াদোত্তৰ সুবিধাৰ সময়কাল পৰীক্ষা কৰক)
...
### 7. Manually Expire a Membership (মেম্বৰশ্বিপ হাতেৰে মেয়াদোত্তৰ কৰা)
