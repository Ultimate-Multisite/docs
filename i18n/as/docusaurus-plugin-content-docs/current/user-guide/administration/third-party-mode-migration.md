...
## আপোনাৰ বৰ্তমান মোড পৰীক্ষা কৰা
...
### স্বয়ংক্রিয় আৱিষ্কাৰ (Automatic Discovery)
...
### সহজ ব্যৱস্থাপনা (Simplified Management)
...
### উন্নত কাৰ্য্যক্ষমতা (Better Performance)
...
### মই "unclassified ability" notices পাই আছো
