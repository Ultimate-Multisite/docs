...
---
# সাইট স্পেসিফিকেশন স্কিল {#site-specification-skill}
...
## Site Specification কি? {#what-is-site-specification}
...
## Site Specification কিয় ব্যৱহাৰ কৰিব লাগে? {#why-use-site-specification}

### সেশনৰ মাজত ধ্ৰুততা (Consistency Across Sessions) {#consistency-across-sessions}
...
### উন্নত পৰামৰ্শ (Better Recommendations) {#better-recommendations}
...
### দ্ৰুত শিক্ষণ (Faster Onboarding) {#faster-onboarding}

নতুন agent (বা নতুন সেশনৰ agent) সকলে স্পষ্টীকৰণমূলক প্ৰশ্ন কৰাৰ পৰিৱৰ্তে আপোনাৰ site_brief পঢ়ি সোনকালে কামত লাগিব পাৰে।

## Site Specification আৰম্ভ কৰা {#initiating-site-specification}

### Theme Builder Onboardingৰ সময়ত {#during-theme-builder-onboarding}
...
### হাতেৰে আৰম্ভ কৰা (Manual Initiation) {#manual-initiation}
...
## Site Specification প্ৰক্ৰিয়া {#the-site-specification-process}

### Step 1: Site Purpose (সাইটৰ উদ্দেশ্য) {#step-1-site-purpose}
...
### Step 2: Target Audience (লক্ষ্য শ্রোতা) {#step-2-target-audience}
...
### Step 3: Brand Identity (ব্ৰেণ্ডৰ পৰিচয়) {#step-3-brand-identity}
...
### Step 4: Business Goals (ব্যৱসায়িক লক্ষ্য) {#step-4-business-goals}
...
### Step 5: Content Structure (বিষয়বস্তুৰ গঠন) {#step-5-content-structure}
...
## আপোনাৰ site_brief মেম’ৰি {#your-sitebrief-memory}
...
## site_brief দেখা আৰু আপডেট কৰা {#viewing-and-updating-your-sitebrief}

### আপোনাৰ site_brief দেখা {#view-your-sitebrief}
...
### আপোনাৰ site_brief আপডেট কৰা {#update-your-sitebrief}
...
## agent-সকলে site_brief কেনেকৈ ব্যৱহাৰ কৰে {#how-agents-use-sitebrief}

### ডিজাইনৰ পৰামৰ্শ (Design Recommendations) {#design-recommendations}
...
### বৈশিষ্ট্যৰ পৰামৰ্শ (Feature Suggestions) {#feature-suggestions}
...
### বিষয়বস্তুৰ গঠন (Content Structure) {#content-structure}
...
## উত্তম অভ্যাসসমূহ (Best Practices) {#best-practices}

### সুনির্দিষ্ট হ'ব (Be Specific) {#be-specific}
...
### নিয়মীয়াকৈ আপডেট কৰক (Update Regularly) {#update-regularly}
...
### সামঞ্জস্যপূৰ্ণ শব্দভাণ্ডাৰ ব্যৱহাৰ কৰক (Use Consistent Terminology) {#use-consistent-terminology}
...
### পৰিৱেশ যোগ কৰক (Include Context) {#include-context}
...
## Theme Builder Onboardingৰ সৈতে সম্পৰ্ক {#relationship-to-theme-builder-onboarding}
