...
## Theme Builder Onboarding Flow কি?
...
## Theme Builder Onboarding আৰম্ভ কৰা

### প্ৰথমবাৰৰ ছেটআপ (First-Run Setup)
...
### হাতেৰে অ্যাক্টিভেট কৰা (Manual Activation)
...
## Onboardingৰ পদক্ষেপসমূহ (The Onboarding Steps)

### Step 1: মোড নিৰ্বাচন (Mode Selection)
...
### Step 2: সাইটৰ বিৱৰণ (Site Specification)
...
### Step 3: ডিজাইন ছিষ্টেমৰ সিদ্ধান্ত (Design System Decisions)
...
### Step 4: থিম জেনারেচন (Theme Generation)
...
### Step 5: অ্যাক্টিভেশ্যন আৰু পৰীক্ষা (Activation and Verification)
...
## Site Specification আৰু site_brief Memory
...
## Onboardingৰ পাছত কাস্টমাইজ কৰা (Customizing After Onboarding)

Theme Builder onboarding সম্পূৰ্ণ হোৱাৰ পাছত, আপুনি:

### Design System Aesthetics Skill ব্যৱহাৰ কৰা
...
### theme.json পোনপটীয়াকৈ সম্পাদনা কৰা (Edit theme.json Directly)
...
### কাস্টম ব্লক টেমপ্লেট সৃষ্টি কৰা (Create Custom Block Templates)
...
## তুলনা: পুৰণি বনাম নতুন Onboarding (Comparison: Old vs. New Onboarding)
