...
## Wizard ক'ত দেখুৱাই? {#when-does-the-wizard-appear}
...
### Wizard-এ কোৱা হ'ল যে wp-config.php writable নহয় {#the-wizard-says-wp-configphp-is-not-writable}
...
### Setup হোৱাৰ পিছত site সমূহ অ্যাক্সেছ কৰিব নোৱাৰা (subdomains) {#sites-are-not-accessible-after-setup-subdomains}
...
### Setup হোৱাৰ পিছত authentication সমস্যা {#authentication-issues-after-setup}
...
### Installation চলাকালীন এটা ধাপ বিফল হ'ল {#a-step-failed-during-installation}
