...
---
# পাঠ ১২: ব্যৱসায় চলোৱা {#lesson-12-running-the-business}
...
## দৈনিক কাৰ্য্যকলাপ {#daily-operations}
...
### গ্রাহক সহায় (Customer Support) {#customer-support}
...
### সহায়ৰ স্তৰ (Support Tiers) {#support-tiers}
...
## বিলিং কাৰ্য্যকলাপ (Billing Operations) {#billing-operations}

### পুনৰাবৃত্ত भुक्ताনি (Recurring Payments) {#recurring-payments}
...
### মেম্বৰশ্বিপ ব্যৱস্থাপনা (Managing Memberships) {#managing-memberships}
...
## প্লেটফৰ্ম মেইনটেনেঞ্চ (Platform Maintenance) {#platform-maintenance}

### WordPress আৰু Plugin আপডেট {#wordpress-and-plugin-updates}
...
### কাৰ্য্যক্ষমতা (Performance) {#performance}
...
## গ্রাহক জীৱনচক্ৰ ব্যৱস্থাপনা (Customer Lifecycle Management) {#customer-lifecycle-management}

### চৰ্ণ হ্ৰাস কৰা (Reducing Churn) {#reducing-churn}
...
### আপগ্রেড উৎসাহিত কৰা (Encouraging Upgrades) {#encouraging-upgrades}
...
### পুনৰ লাভ কৰাৰ অভিযান (Win-Back Campaigns) {#win-back-campaigns}
...
## সাপ্তাহিক আৰু মাহেকীয়া ৰুটিন (Weekly and Monthly Routines) {#weekly-and-monthly-routines}

### সাপ্তাহিক (Weekly) {#weekly}
