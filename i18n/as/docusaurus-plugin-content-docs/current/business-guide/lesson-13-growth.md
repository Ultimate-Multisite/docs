...
## আপোনাৰ সংখ্যাবোৰ জনাওক (Know Your Numbers)

ডাঙৰ হোৱাৰ আগতে, আপুনি ক’ত থিয় হৈ আছে সেয়া বুজি লওক:

### মূল সূচকসমূহ (Key Metrics)
...
## Infra-structure ডাঙৰ কৰা (Scaling Infrastructure)

### ক’ৰ সময়ত ডাঙৰ কৰিব লাগে (When to Scale)
...
### হোস্টিং স্থানান্তৰ (Hosting Migration)
...
## কাৰ্য্যকলাপ স্বয়ংক্রিয় কৰা (Automating Operations)
...
### নতুন আয়ৰ উৎস (New Revenue Streams)
...
## এটা দল গঢ়ি তোলা (Building a Team)
...
## বৃদ্ধিৰ মাইলফলকসমূহ (Growth Milestones)
