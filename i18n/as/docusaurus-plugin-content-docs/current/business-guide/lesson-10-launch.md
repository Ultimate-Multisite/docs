...
---
# পাঠ ১০: লঞ্চ দিন {#lesson-10-launch-day}
...
## প্ৰি-লঞ্চ চেকলিষ্ট {#pre-launch-checklist}

প্ৰতিটো আইটেমৰ ওপৰেৰে গৈক। কোনোবাটাও এৰি নিদিব।

### Platfrom Infrastructure (প্ৰণালীৰ ভেটি) {#platform-infrastructure}
...
### Plans and Products (প্লেন আৰু প্ৰডাক্ট) {#plans-and-products}
...
### Checkout Flow (প্ৰক্ৰিয়াৰ ধাৰা) {#checkout-flow}
...
### Onboarding (প্ৰশিক্ষণ) {#onboarding}
...
### Legal and Business (আইন আৰু ব্যৱসায়) {#legal-and-business}
...
## Soft Launch বনাম Hard Launch {#soft-launch-vs-hard-launch}
...
## লঞ্চ দিনৰ কাৰ্য্যসমূহ {#launch-day-actions}
...
## কি ভুল হ'ব পাৰে {#what-can-go-wrong}
...
## এই পাঠত আমি কি কি সজা লৈ গ'লোঁ {#what-we-built-this-lesson}
