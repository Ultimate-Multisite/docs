...
## 일반적인 실패 사례 {#common-failures}

### 데이터베이스 권한이 호스트와 일치하지 않음 {#database-grants-do-not-match-the-host}
...
### Bedrock 또는 로컬 설치에서 연결할 수 없음 {#bedrock-or-local-installs-cannot-connect}
