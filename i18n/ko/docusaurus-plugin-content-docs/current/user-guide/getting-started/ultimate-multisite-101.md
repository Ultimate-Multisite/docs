...
#### 하위 도메인 vs. 하위 디렉터리 {#subdomain-vs-subdirectory}
...
#### Plugins와 Themes {#plugins-and-themes}
...
#### 사용자와 관리자 {#users-and-administrators}
...
#### 사례 2: 틈새 제공업체 {#case-2-niche-provider}
...
### 아키텍처 고려 사항 {#architecture-considerations}

포괄적인 가이드는 아니지만, 다음 항목들은 Ultimate Multisite 설치를 지원하기 위한 올바른 기술 선택에 지침이 될 것입니다.

#### 공유 Hosting vs. 전용 Hosting {#shared-vs-dedicated-hosting}
