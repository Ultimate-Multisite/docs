...
## 테마 빌더 온보딩 과정이란 무엇인가요? {#what-is-the-theme-builder-onboarding-flow}
...
## 테마 빌더 온보딩 시작하기 {#starting-the-theme-builder-onboarding}

### 첫 실행 설정 {#first-run-setup}
...
## 온보딩 단계 {#the-onboarding-steps}

### 1단계: 모드 선택 {#step-1-mode-selection}
...
### 2단계: 사이트 사양 지정 {#step-2-site-specification}
...
### 3단계: 디자인 시스템 결정 {#step-3-design-system-decisions}
...
### 4단계: 테마 생성 {#step-4-theme-generation}
...
### 5단계: 활성화 및 확인 {#step-5-activation-and-verification}
...
## 사이트 사양 지정 및 site_brief 메모리 {#site-specification-and-sitebrief-memory}
...
### site_brief가 중요한 이유 {#why-sitebrief-matters}
...
### site_brief 확인하기 {#viewing-your-sitebrief}
...
## 온보딩 후 맞춤 설정하기 {#customizing-after-onboarding}

테마 빌더 온보딩이 완료된 후에는 다음 작업을 수행할 수 있습니다.

### 디자인 시스템 미학(Design System Aesthetics) 스킬 사용 {#use-the-design-system-aesthetics-skill}
...
### theme.json 직접 편집하기 {#edit-themejson-directly}
...
### 사용자 지정 블록 템플릿 생성하기 {#create-custom-block-templates}
...
## 비교: 이전 vs. 새로운 온보딩 {#comparison-old-vs-new-onboarding}
