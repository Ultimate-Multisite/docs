...
## WordPress 멀티사이트가 정확히 무엇인가요? {#what-exactly-is-wordpress-multisite}
...
## 서브도메인인가 서브디렉터리인가? {#subdomain-or-subdirectory}
...
## 서브사이트 간에 공유되는 것과 공유되지 않는 것 {#what-is-shared-among-subsites-and-what-is-not}
...
## WordPress 멀티사이트에서의 사용자 관리 {#user-management-on-wordpress-multisite}
