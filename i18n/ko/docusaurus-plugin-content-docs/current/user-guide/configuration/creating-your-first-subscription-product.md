---
title: 첫 번째 구독 제품 만들기
sidebar_position: 6
_i18n_hash: 0df17700c38413389d0678786906ad26
---
# 첫 번째 구독 제품 만들기 (v2)

_**중요 안내: 이 문서는 Ultimate Multisite 버전 2.x 사용자만을 위한 것입니다. 버전 1.x를 사용 중이라면**_ **_**이 문서를 참조하세요**_**._

네트워크를 운영하고 잠재 고객에게 서비스를 판매하기 시작하려면 다양한 구독 옵션이 필요합니다. 이 제품들을 어떻게 만들까요? 제공할 수 있는 제품 유형은 무엇일까요? 이 문서에서는 제품에 대해 알아야 할 모든 내용을 다룹니다.
