...
체크아웃 폼은 새로운 고객을 유치할 때 다양한 접근 방식을 실험할 수 있는 쉽고 유연한 방법입니다.

Ultimate Multisite 2.0은 원하는 만큼 많은 폼을 만들 수 있는 체크아웃 폼 편집기를 제공하며, 다양한 필드와 제공되는 제품 등을 포함할 수 있습니다.
...
새 폼을 만들려면 페이지 상단의 **Add Checkout Form**을 클릭하세요.
...
다양한 목적을 위해 체크아웃 폼을 만들 수 있습니다. 이 예제에서는 회원가입 폼을 다룰 것입니다.
...
_**주의:** username, email, password, site title, site URL, order summary, payment, submit button은 체크아웃 폼을 만들 때 필수 필드입니다._
