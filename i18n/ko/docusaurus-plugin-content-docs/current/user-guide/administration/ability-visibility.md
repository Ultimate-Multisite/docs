...
## 기능 가시성이란? {#what-is-ability-visibility}
...
## 기능 가시성 관리 {#managing-ability-visibility}

### 기능 가시성 설정 접근하기 {#accessing-ability-visibility-settings}

1. **WordPress 관리자** → **Superdav AI Agent** → **설정**으로 이동합니다.
2. **기능(Abilities)** 탭을 클릭합니다.
3. 설치된 모든 기능과 해당 가시성 수준 목록을 볼 수 있습니다.

### 기능 세부 정보 보기 {#viewing-ability-details}
...
### 가시성 수준 변경하기 {#changing-visibility-levels}
...
### 일괄 작업 (Bulk Operations) {#bulk-operations}
...
## 파트너 허용 목록 (Partner Allow-List) {#partner-allow-list}

**파트너 허용 목록**은 어떤 외부 파트너가 Partner 레벨의 기능에 접근할 수 있는지 제어합니다.

### 파트너 추가하기 {#adding-partners}
...
### 파트너에게 기능 할당하기 {#assigning-abilities-to-partners}
...
### 파트너 접근 권한 취소하기 {#revoking-partner-access}
...
## 미분류 기능 (Unclassified Abilities) {#unclassified-abilities}

Superdav AI Agent가 인식하지 못하는 타사 기능을 설치하면 **미분류(Unclassified)**로 표시됩니다.

### 미분류 기능에 대한 관리자 알림 {#admin-notice-for-unclassified-abilities}
...
### 미분류 기능 검토하기 {#reviewing-unclassified-abilities}
...
### 미분류 기능을 분류해야 하는 이유? {#why-classify-unclassified-abilities}
...
## 다양한 인터페이스에서의 가시성 {#visibility-in-different-surfaces}
...
### 최소 권한의 원칙 (Principle of Least Privilege) {#principle-of-least-privilege}

- 기능 사용을 허용하는 가장 제한적인 가시성으로 설정합니다.
- 민감한 작업에는 Partner 가시성을 사용합니다.
- 사용하지 않는 기능은 비활성화합니다.

### 정기 감사 (Regular Audits) {#regular-audits}
...
### 타사 기능 (Third-Party Abilities) {#third-party-abilities}
...
## 레거시 모드에서 마이그레이션하기 {#migration-from-legacy-mode}
