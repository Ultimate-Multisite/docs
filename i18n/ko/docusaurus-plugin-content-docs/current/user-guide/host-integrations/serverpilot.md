...
---
# ServerPilot 통합 {#serverpilot-integration}
...
### 1. ServerPilot API 자격 증명 가져오기 {#1-get-your-serverpilot-api-credentials}
1. ServerPilot 대시보드에 로그인합니다  
2. "Account" > "API"로 이동합니다  
3. 아직 없으시면 새 API 키를 생성합니다  
4. 클라이언트 ID와 API 키를 복사합니다

### 2. 앱 ID 가져오기 {#2-get-your-app-id}
...
## SSL 인증서 검증 {#ssl-certificate-verification}
