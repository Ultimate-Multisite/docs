...
## API 자격 증명 가져오기 {#getting-your-api-credentials}

### 1. API 토큰 생성 {#1-create-an-api-token}
...
### 2. 조직 ID 가져오기 {#2-get-your-organization-id}
...
### 3. 서버 ID 가져오기 {#3-get-your-server-id}
...
### 4. API URL 가져오기 {#4-get-your-api-url}
...
### 통합 마법사를 통한 설정 {#setup-via-integration-wizard}
...
## 추가 WordPress 구성 {#additional-wordpress-configuration}
...
### .htaccess 구성 {#htaccess-configuration}
...
### 도메인이 매핑될 때 {#when-a-domain-is-mapped}
...
### 도메인이 제거될 때 {#when-a-domain-is-removed}
...
### DNS 및 SSL 확인 {#dns-and-ssl-checking}
...
### 도메인 매핑 후 {#after-mapping-a-domain}
...
### 일반적으로 사용되는 엔드포인트 {#common-endpoints-used}
...
### 전체 API 문서 {#full-api-documentation}
