...
---
# Hostinger (hPanel) 통합 {#hostinger-hpanel-integration}
...
### 1. Hostinger API 토큰 생성 {#1-generate-your-hostinger-api-token}
...
### 2. 계정 ID 찾기 {#2-find-your-account-id}
...
### 4. 통합 기능 활성화 {#4-enable-the-integration}
