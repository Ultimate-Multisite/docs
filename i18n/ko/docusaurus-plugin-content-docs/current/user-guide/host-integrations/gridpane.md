...
### 1. GridPane API 자격 증명 가져오기 {#1-get-your-gridpane-api-credentials}
1. GridPane 대시보드에 로그인하세요.
2. 'Settings' > 'API'로 이동하세요.
3. 아직 API 키가 없으면 생성하세요.
4. API 키를 복사하세요.

### 2. 서버 및 사이트 ID 가져오기 {#2-get-your-server-and-site-ids}
...
## SUNRISE 상수 관리 {#sunrise-constant-management}
