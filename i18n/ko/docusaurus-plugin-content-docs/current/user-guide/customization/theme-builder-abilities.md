...
## 블록 테마 뼈대 생성 (Scaffold Block Theme) {#scaffold-block-theme}
...
## 테마 활성화 (Activate Theme) {#activate-theme}

**activate-theme** 기능은 사이트를 새로 뼈대 생성된 테마 또는 기존 블록 테마로 전환합니다.

### 사용 방법 {#how-to-invoke-1}
...
## 워크플로우: 뼈대 생성 및 활성화 {#workflow-scaffold-and-activate}
...
## 디자인 토큰 및 사용자 정의 {#design-tokens-and-customization}
...
## 제한 사항 및 참고 사항 {#limitations-and-notes}
