...
1. 'ultimate-multisite-mailchimp'을 '/wp-content/plugins/' 디렉터리에 업로드하세요.
2. WordPress 네트워크 관리자의 'Plugins' 메뉴를 통해 플러그인을 활성화하세요.
...
_Add your Mailchimp API key on_ _**Ultimate Multisite 설정 -> Add-on Settings -> Mailchimp**_
