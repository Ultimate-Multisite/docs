...
## 내비게이션 레이블 vs 페이지 제목 {#navigation-label-vs-page-title}
...
### 예시 1: 내비게이션 레이블이 있는 간단한 메뉴 {#example-1-simple-menu-with-navigation-label}
...
### 예시 2: 특정 테마 위치를 위한 메뉴 {#example-2-menu-for-specific-theme-location}
