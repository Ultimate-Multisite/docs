...
title: 액션 - wu_multi_tenancy_init
sidebar_label: wu_multi_tenancy_init
_i18n_hash: d36b0a14ef482ff6731ffe6c85582c6a
---
# Action: wu_multi_tenancy_init

Multi-Tenancy 애드온이 완전히 초기화된 후에 발생합니다.

## Parameters {#parameters}

| Name | Type | Description |
|------|------|-------------|
| $addon | `\WP_Ultimo_Multi_Tenancy` | 애드온 인스턴스. phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- wu_는 WP Ultimo의 표준 접두사입니다. |
