...
### 고객 수명 주기 {#customer-lifecycle}

#### 고객 생성 후 {#after-customer-creation}
...
#### 고객 상태 변경 {#customer-status-change}
...
#### 템플릿 적용 전 {#before-template-application}
...
#### 결제 완료 / 실패 {#payment-completed--failed}
...
### 체크아웃 훅 {#checkout-hooks}

#### 처리 전 / 완료 후 {#before-processing--after-completion}
...
### 체크아웃 폼 필드 {#checkout-form-fields}
