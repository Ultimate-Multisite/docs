...
ٻه ساڳئي وقت واريون درخواستون ساڳي قيمت پڙهي سگهن ٿيون ۽ ٻئي ساڳيو وڌايل نتيجو واپس لکي سگهن ٿيون، جنهن سان هڪ ڳڻپ ضايع ٿي وڃي ٿي. `increment_item()` حساب ڪتاب کي ڊيٽابيس انجڻ حوالي ڪري ٿو، هڪ ئي `UPDATE ... SET column = column + ?` بيان سان، جنهن سان عمل فطري طور ائٽامڪ بڻجي وڃي ٿو.
