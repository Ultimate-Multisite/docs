...
hosting integration سيٽ اپ لاءِ wizard سيڪشنن کي فلٽر ڪري ٿو.

addons کي wizard سيڪشن شامل ڪرڻ، هٽائڻ، يا تبديل ڪرڻ جي اجازت ڏئي ٿو.

## پيرا ميٽر {#parameters}

| نالو | قسم | وضاحت |
|------|------|-------------|
| $sections | `array` | Wizard سيڪشن. |
| $integration | `\WP_Ultimo\Integrations\Host_Providers\Base_Host_Provider\|\WP_Ultimo\Integrations\Integration` | اها integration جيڪا configure ٿي رهي آهي. |
