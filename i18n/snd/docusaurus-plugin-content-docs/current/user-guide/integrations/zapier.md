...
## نئين Trigger کي ڪيئن banaيو {#how-to-create-a-new-trigger}
...
## Actions ڪيئن ٺاهيون {#how-to-create-actions}
...
### Action جو ترتیب ڏيڻ (Setting up the Action) {#setting-up-the-action}
