...
## چلائڻ وارن ڪمنڊز {#commands-to-run}
...
### ڊيٽا بيس گرانٽس مطابق نه آهن {#database-grants-do-not-match-the-host}
...
### Bedrock يا لوڪل انستل ڪنهن سان کان جڙيل نه ٿي سگهن {#bedrock-or-local-installs-cannot-connect}
...
### ايسنڪ پش ڪيو نه صاف ٿيو (Async push queue does not drain) {#async-push-queue-does-not-drain}
...
### ليونٽ جي صارف گن غلط آهي {#tenant-user-count-is-wrong}
...
### SSO وزيت رد ڪئي وڃي ٿي {#sso-visit-is-rejected}
...
## دوبارہ کوشش کب کرنی ہے {#when-to-retry}
