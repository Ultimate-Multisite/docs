...
### خود بخود گهرجي (Automatic Discovery)
...
### قدري مربوط ٿيڻ (Native Integration)
...
### سڌو سنوارڻ (Simplified Management)
...
### मेरो कस्टम صلاحیتون ڏس نه آڻيندي ن آهن
...
## Backward Compatibility (پچھلا سازگار ٿيڻ)
...
### Deprecation Timeline (ڪامياب ٿيڻ جو وقت)
