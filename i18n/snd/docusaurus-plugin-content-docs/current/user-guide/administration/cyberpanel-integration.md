...
## ضروري شروعاتيون (Prerequisites) {#prerequisites}
...
### 2. wp-config.php میں کنسٹنٹس شامل کریں {#2-add-constants-to-wp-configphp}
...
## Configuration Reference (تنظيمي مرڪزي معلومات) {#configuration-reference}
...
## Important Notes (اهمائي نوٽس) {#important-notes}
...
### API Connection Refused (API कनेक्ट गर्न अस्वीकार गरियो) {#api-connection-refused}
