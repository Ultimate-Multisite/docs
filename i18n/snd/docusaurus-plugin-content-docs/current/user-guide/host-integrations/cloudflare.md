...
### 1. پنهنجو Cloudflare API Key حاصل ڪريو
...
### 3. wp-config.php ۾ ڪنستان شامل ڪريو
...
### سوبڊومين مانيجمنٽ (Subdomain Management)
...
## ڪلاؤڈفليئر ڪسٹم هوسناما (Cloudflare Custom Hostnames)
...
### اها standard Cloudflare انٹیگريشن کان ڪيئن مختلف آهي
...
### Cloudflare Custom Hostnames کي ترتیب ڏيڻ (Setting up Cloudflare Custom Hostnames)
...
### پراکسی جي مسئلاڪات (Proxying Issues)
