...
## ترتیب جو تعليمات (Setup Instructions)

### 1. WP Engine Plugin جي تصديق ڪريو (Verify WP Engine Plugin)
...
### 2. انٽيغريشن کي فعال ڪريو (Enable the Integration)
...
### سبڊومين سپورٽ (Subdomain Support)
...
### وائلڊ ڪيٽل دومينز (Wildcard Domains)
...
### SSL سرٽيفڪيٽس (SSL Certificates)
