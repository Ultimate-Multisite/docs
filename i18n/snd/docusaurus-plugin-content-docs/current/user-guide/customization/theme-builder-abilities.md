...
## بلاڪ ٿيمين جنريٽ ڪرڻ (Scaffold Block Theme)
...
### ڪيئن استعمال ڪجي (How to Invoke)
...
### توقع ڪيل نتيجو (Expected Output)
...
## ٿيم کي فعال ڪرڻ (Activate Theme)
...
### توقع ڪيل نتيجي (Expected Output)
...
## ڪم ڪندڙ عمل (Workflow: Scaffold and Activate)
...
## Design Tokens ۽ تخصيص (Design Tokens and Customization)
