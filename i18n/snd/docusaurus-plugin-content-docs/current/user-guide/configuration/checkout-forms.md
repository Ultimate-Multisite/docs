...
### پرائسنگ ٽيبل فیلڊ (The Pricing Table Field)
...
### Period Selection Toggle شامل ڪرڻ
...
#### قدم 1: پنهنجي پروڊڪٽس تي Price Variations مقرر ڪريو
...
#### قدم 2: Period Selection فیلڊ کي پنهنجي Checkout Form ۾ شامل ڪريو
...
#### قدم 3: فیلڈ کي پرائسنگ تيبل کان اوچتو رکجو (Position the Field Above the Pricing Table)
...
#### فرونت اينڊ تي هي ڪيئن کام ڪري ٿو (How It Works on the Frontend)
...
#### URL جي ذريعي بلنگ پيري جو پيچ سلبيڪل ڪرڻ (Pre-selecting a Billing Period via URL)
...
### ٽيمپليٽ سلبيڪل فیلڊ (The Template Selection Field)
...
#### فیلڊ کي ماني طور تي شامل ڪرڻ (Adding the field manually)
