...
## نئی سائٹ ٹیمپلیٹ بنانا اور ایڈٹ کرنا {#creating-and-editing-a-new-site-template}
...
### साइट टेम्प्लेटको प्रयोग गर्ने (Using Site Templates) {#using-site-templates}
...
#### موڈ 2: دستیاب سائٹ ٹیمپلیٹ کا انتخاب کریں {#mode-2-choose-available-site-template}
...
### Default Mode: Checkout form تي سيت ٽيملٽ چونڊڻ {#default-mode-site-template-selection-on-the-checkout-form}
...
### সাইট টেমপ্লেট অপশনসমূহ {#site-template-options}
...
#### টেমপ্লেট পরিবর্তন করার অনুমতি দিন (Allow Template Switching) {#allow-template-switching}
...
#### ব্যবহারকারীদের তাদের সাইটকে টেমপ্লেট হিসেবে ব্যবহার করার অনুমতি দিন (Allow Users to use their Site as templates) {#allow-users-to-use-their-site-as-templates}
...
#### টেমপ্লেট ডুপ্লিকেশনের সময় মিডিয়া কপি করুন (Copy Media on Template Duplication) {#copy-media-on-template-duplication}
...
#### **সার্চ ইঞ্জিনগুলোকে সাইট টেমপ্লেট ইনডেক্সিং থেকে বিরত রাখুন (Prevent Search Engines from indexing Site Templates)** {#prevent-search-engines-from-indexing-site-templates}
...
## অটো সার্চ-অ্যান্ড-রিপ্লেস দিয়ে সাইট টেমপ্লেট প্রি-পপুলেট করা (Pre-populating Site Templates with auto search-and-replace) {#pre-populating-site-templates-with-auto-search-and-replace}
...
### "placeholder ৰ ভৰি পৰা টেমপ্লেট" সমস্যাটো সমাধান কৰা {#solving-the-template-full-of-placeholders-problem}
