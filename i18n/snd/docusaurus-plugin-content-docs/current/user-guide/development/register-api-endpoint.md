...
## Zapier ۾ عمل (action) پيدا ڪرڻ {#creating-an-action-in-zapier}
...
### عمل پيدا ڪرڻ {#creating-an-action}
...
### كامل اينڊپوائنٽ پارامائٽرس (Complete endpoint parameters) {#complete-endpoint-parameters}
